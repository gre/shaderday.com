...
}`}}),he=2,me="stripes",ge=400,ye=0,xe=60,be=24,we=1,_e=({time:e})=>Object(le.jsx)(pe.Node,{shader:Se.node,uniforms:{time:e}}),Se=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),Ee=3,ze="zephyr",Te=({time:e})=>Object(le.jsx)(pe.Node,{shader:Ie.node,uniforms:{time:e}}),Ie=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}});var Re=r("q1tI"),Pe=r.n(Re);const Ae=pe.Shaders.create({InitGameOfLife:{frag:pe.GLSL`
  precision highp float;
  uniform float seed;
  // i
  varying vec2 uv;
  ...
  }`}}),Oe=Pe.a.memo((({tick:e,size:t,refreshEveryTicks:r})=>e%(r||1/0)===0?Object(le.jsx)(pe.Node,{shader:Ae.InitGameOfLife,uniforms:{seed:Math.random()},width:t,height:t,backbuffering:!0,sync:!0}):Object(le.jsx)(pe.Node,{shader:Ae.GameOfLife,width:t,height:t,backbuffering:!0,sync:!0,uniforms:{t:pe.Uniform.Backbuffer,size:t}}))),Ce=4,De="Ray of Life";let Le;const je=({time:e})=>{Le||(Le=e);const t=e-Le,r=Math.floor(10*t),o=r+25,i=10*(1+Math.floor(r/50)),n=10*(1+Math.floor(o/50));return Object(le.jsx)(Ne,{time:e,a:Object(le.jsx)(pe.NearestCopy,{children:Object(le.jsx)(Oe,{refreshEveryTicks:50,tick:r,size:i})}),b:Object(le.jsx)(pe.NearestCopy,{children:Object(le.jsx)(Oe,{refreshEveryTicks:50,tick:o,size:n})})})},Ne=({a:e,b:t,time:r})=>Object(le.jsx)(pe.Node,{uniforms:{a:e,b:t,time:r},shader:ke.main}),ke=pe.Shaders.create({main:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Ue=5,Me="Here We Go Again",qe=({time:e})=>Object(le.jsx)(pe.Node,{shader:Be.node,uniforms:{time:e}}),Be=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    sqrt(vec3(1. - shad));
  gl_FragColor = vec4(c,1.0);
}`}}),Fe=6,Ge="Bestagons",He=({time:e})=>Object(le.jsx)(pe.Node,{shader:Ve.node,uniforms:{time:e}}),Ve=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),Xe=7,Ye="Worms party",Ke=({time:e})=>Object(le.jsx)(pe.Node,{shader:$e.node,uniforms:{time:e}}),$e=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    sqrt(vec3(1. - shad));
  gl_FragColor = vec4(c,1.0);
}`}}),We=8,Qe="moontains",Ze=({time:e})=>Object(le.jsx)(pe.Node,{shader:Je.node,uniforms:{time:e}}),Je=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),et=9,tt="Virus",rt=400,ot=16.3,it=26,nt=24,at=.8,st=({time:e})=>Object(le.jsx)(pe.Node,{shader:ct.node,uniforms:{time:e}}),ct=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),lt=10,pt="ring",ft=({time:e})=>Object(le.jsx)(pe.Node,{shader:ut.node,uniforms:{time:e}}),ut=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),dt=11,vt="magic mouse",ht=({time:e})=>Object(le.jsx)(pe.Node,{shader:mt.node,uniforms:{time:e}}),mt=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),gt=12,yt="floor is lava",xt=({time:e})=>Object(le.jsx)(pe.Node,{shader:bt.node,uniforms:{time:e}}),bt=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),wt=13,_t="chip",St=({time:e})=>Object(le.jsx)(pe.Node,{shader:Et.node,uniforms:{time:e}}),Et=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
`}}),zt=14,Tt="seizure",It=({time:e})=>Object(le.jsx)(pe.Node,{shader:Rt.node,uniforms:{time:e}}),Rt=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Pt=pe.Shaders.create({blur1D:{frag:pe.GLSL`precision highp float;
varying vec2 uv;
uniform sampler2D t;
...
}`}});var At=({width:e,height:t,pixelRatio:r,direction:o,children:i})=>Object(le.jsx)(pe.Node,{shader:Pt.blur1D,width:e,height:t,pixelRatio:r,uniforms:{direction:o,resolution:pe.Uniform.Resolution,t:i}});const Ot=Math.sqrt(2)/2;var Ct=(e,t,r)=>{const o=2*t*Math.ceil(e/2)/r;switch((e-1)%4){case 0:return[o,0];case 1:return[0,o];case 2:return[o*Ot,o*Ot];case 3:return[o*Ot,-o*Ot]}};const Dt=({width:e,height:t,pixelRatio:r,factor:o,children:i,passes:n,directionForPass:a})=>{const s=c=>c<=0?i:Object(le.jsx)(At,{width:e,height:t,pixelRatio:r,direction:a(c,o,n),children:s(c-1)});return s(n)};Dt.defaultProps={passes:2,directionForPass:Ct};var Lt=Dt;const jt=pe.Shaders.create({blur1D:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
...
}`}});var Nt=({width:e,height:t,map:r,pixelRatio:o,direction:i,children:n})=>Object(le.jsx)(pe.Node,{shader:jt.blur1D,width:e,height:t,pixelRatio:o,uniforms:{direction:i,resolution:pe.Uniform.Resolution,t:n,map:r}});const kt=({width:e,height:t,map:r,pixelRatio:o,factor:i,children:n,passes:a,directionForPass:s})=>{const c=l=>l<=0?n:Object(le.jsx)(Nt,{width:e,height:t,map:r,pixelRatio:o,direction:s(l,i,a),children:c(l-1)});return c(a)};kt.defaultProps={passes:2,directionForPass:Ct};const Ut=15,Mt="parametric",qt=({time:e})=>Object(le.jsx)(pe.LinearCopy,{children:Object(le.jsx)(Ft,{persistence:.98+.02*Math.cos(e)+-.8*Math.exp(-e),children:Object(le.jsx)(Lt,{passes:4,factor:.2,children:Object(le.jsx)(Bt,{time:e})})})}),Bt=({time:e})=>Object(le.jsx)(pe.Node,{shader:Gt.node,uniforms:{time:e}}),Ft=({children:e,persistence:t})=>Object(le.jsx)(pe.Node,{shader:Gt.persistence,backbuffering:!0,uniforms:{t:e,back:pe.Uniform.Backbuffer,persistence:t}}),Gt=pe.Shaders.create({persistence:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),Ht=16,Vt="reuleaux",Xt=({time:e})=>Object(le.jsx)(pe.Node,{shader:Yt.node,uniforms:{time:e}}),Yt=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    color(0.5 * time);
  gl_FragColor = vec4(c, 1.0);
}`}}),Kt=17,$t="screws",Wt=({time:e})=>Object(le.jsx)(pe.Node,{shader:Qt.node,uniforms:{time:e}}),Qt=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),Zt=18,Jt="queen",er=({time:e})=>Object(le.jsx)(pe.Node,{shader:tr.node,uniforms:{time:e}}),tr=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
}`}}),rr=19,or="they were six",ir=({time:e})=>Object(le.jsx)(pe.Node,{shader:nr.node,uniforms:{time:e}}),nr=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),ar=20,sr="trippy tiles",cr=({time:e})=>Object(le.jsx)(pe.LinearCopy,{children:Object(le.jsx)(lr,{persistence:.85,children:Object(le.jsx)(pe.Node,{shader:pr.node,uniforms:{time:e}})})}),lr=({children:e,persistence:t})=>Object(le.jsx)(pe.Node,{shader:pr.persistence,backbuffering:!0,uniforms:{t:e,back:pe.Uniform.Backbuffer,persistence:t}}),pr=pe.Shaders.create({persistence:{frag:pe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),fr=21,ur="HODL",dr=({time:e})=>Object(le.jsx)(pe.LinearCopy,{children:Object(le.jsx)(vr,{persistence:Math.min(.99,.015*e),time:e,children:Object(le.jsx)(pe.Node,{shader:hr.node,uniforms:{time:e}})})}),vr=({children:e,persistence:t,time:r})=>Object(le.jsx)(pe.Node,{shader:hr.shakePersistence,backbuffering:!0,uniforms:{t:e,back:pe.Uniform.Backbuffer,persistence:t,time:r}}),hr=pe.Shaders.create({shakePersistence:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform sampler2D t, back;
uniform float time;
...
}`}}),mr=22,gr="atoms",yr=({time:e})=>Object(le.jsx)(pe.Node,{shader:xr.node,uniforms:{time:e,t:"/images/einstein-tongue-out.jpg"}}),xr=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D t;
...
void main() {
...
}`}}),br=23,wr="Hexacubes",_r=({time:e})=>Object(le.jsx)(pe.Node,{shader:Sr.node,uniforms:{time:e}}),Sr=pe.Shaders.create({node:{frag:pe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform float time;
  const float PI = ${Math.PI};
  ...
  void main() {
    ...
    gl_FragColor = vec4(c, 1.0);
      ...
      `}}),Er=24,zr="dark cubes",Tr=({time:e})=>Object(le.jsx)(pe.Node,{shader:Ir.node,uniforms:{time:e}}),Ir=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),Rr=25,Pr="Mandelbrot",Ar=({time:e})=>Object(le.jsx)(pe.LinearCopy,{children:Object(le.jsx)(Or,{persistence:.9,children:Object(le.jsx)(Lt,{passes:4,factor:.1,children:Object(le.jsx)(pe.Node,{shader:Cr.node,uniforms:{time:e}})})})}),Or=({children:e,persistence:t})=>Object(le.jsx)(pe.Node,{shader:Cr.persistence,backbuffering:!0,uniforms:{t:e,back:pe.Uniform.Backbuffer,persistence:t}}),Cr=pe.Shaders.create({persistence:{frag:pe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Dr=26,Lr="fumes",jr=({time:e})=>Object(le.jsx)(pe.LinearCopy,{children:Object(le.jsx)(Nr,{persistence:.9,children:Object(le.jsx)(Lt,{passes:4,factor:Math.min(.6,.01*e),children:Object(le.jsx)(pe.Node,{shader:kr.node,uniforms:{time:e}})})})}),Nr=({children:e,persistence:t})=>Object(le.jsx)(pe.Node,{shader:kr.persistence,backbuffering:!0,uniforms:{t:e,back:pe.Uniform.Backbuffer,persistence:t}}),kr=pe.Shaders.create({persistence:{frag:pe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Ur=27,Mr="real burning ship",qr=400,Br=0,Fr=60,Gr=12,Hr=2,Vr=({time:e})=>Object(le.jsx)(pe.LinearCopy,{children:Object(le.jsx)(Xr,{persistence:.8+.05*Math.random(),time:e,children:Object(le.jsx)(pe.Node,{shader:Yr.node,uniforms:{time:e}})})}),Xr=({children:e,persistence:t,time:r})=>Object(le.jsx)(pe.Node,{shader:Yr.persistence,backbuffering:!0,uniforms:{t:e,back:pe.Uniform.Backbuffer,persistence:t,time:r}}),Yr=pe.Shaders.create({persistence:{frag:pe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Kr=28,$r="No, I'M Batman",Wr=({time:e})=>Object(le.jsx)(pe.LinearCopy,{children:Object(le.jsx)(Qr,{persistence:.5+.48*Math.min(1,e/60),children:Object(le.jsx)(pe.Node,{shader:Zr.node,uniforms:{time:e}})})}),Qr=({children:e,persistence:t})=>Object(le.jsx)(pe.Node,{shader:Zr.persistence,backbuffering:!0,uniforms:{t:e,back:pe.Uniform.Backbuffer,persistence:t}}),Zr=pe.Shaders.create({persistence:{frag:pe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Jr=29,eo="sdBitcoin(p)",to=({time:e})=>Object(le.jsx)(pe.Node,{shader:ro.node,uniforms:{time:e}}),ro=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),oo=30,io="21 millions",no=({time:e})=>Object(le.jsx)(pe.Node,{shader:ao.node,uniforms:{time:e,numberInCirculation:18557031}}),ao=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),so=31,co="alien tower",lo=({time:e})=>Object(le.jsx)(pe.Node,{shader:po.node,uniforms:{time:e,numberInCirculation:18557031}}),po=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform float numberInCirculation;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),fo=32,uo="GoL valley";let vo;const ho=({time:e})=>{vo||(vo=e);const t=e-vo,r=Math.floor(12*t);return Object(le.jsx)(pe.Node,{shader:mo.node,uniforms:{time:e,t:Object(le.jsx)(Oe,{refreshEveryTicks:100,tick:r,size:100})}})},mo=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D t;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),go=33,yo="x(x+32y)%(tN+1)%n";const xo=({time:e})=>Object(le.jsx)(pe.Node,{shader:bo.node,uniforms:{time:e}}),bo=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),wo=34,_o="\u230a2cos(x)sin(y+t)\u230b%7";const So=({time:e})=>Object(le.jsx)(pe.Node,{shader:Eo.node,uniforms:{time:e}}),Eo=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
#define PI ${Math.PI}
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),zo=35,To="aie confiance",Io=({time:e})=>Object(le.jsx)(pe.LinearCopy,{children:Object(le.jsx)(Ro,{persistence:.6,children:Object(le.jsx)(pe.Node,{shader:Po.node,uniforms:{time:e}})})}),Ro=({children:e,persistence:t})=>Object(le.jsx)(pe.Node,{shader:Po.persistence,backbuffering:!0,uniforms:{t:e,back:pe.Uniform.Backbuffer,persistence:t}}),Po=pe.Shaders.create({persistence:{frag:pe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Ao=36,Oo="crois en moi",Co=({time:e})=>Object(le.jsx)(pe.LinearCopy,{children:Object(le.jsx)(Do,{children:Object(le.jsx)(pe.Node,{shader:Lo.node,uniforms:{time:e}})})}),Do=({children:e,persistence:t})=>Object(le.jsx)(pe.Node,{shader:Lo.persistence,backbuffering:!0,uniforms:{t:e,back:pe.Uniform.Backbuffer,persistence:t}}),Lo=pe.Shaders.create({persistence:{frag:pe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),jo=37,No="sdBrick",ko=({time:e})=>Object(le.jsx)(pe.Node,{shader:Uo.node,uniforms:{time:e}}),Uo=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Mo=38,qo="Golden mandelbulb",Bo=({time:e})=>Object(le.jsx)(pe.LinearCopy,{children:Object(le.jsx)(Fo,{persistence:.5,children:Object(le.jsx)(pe.Node,{shader:Go.node,uniforms:{time:e}})})}),Fo=({children:e,persistence:t})=>Object(le.jsx)(pe.Node,{shader:Go.persistence,backbuffering:!0,uniforms:{t:e,back:pe.Uniform.Backbuffer,persistence:t}}),Go=pe.Shaders.create({persistence:{frag:pe.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  clr /= 4.;
  gl_FragColor = vec4(clr, 1.0);
}`}}),Ho=39,Vo="metaballs",Xo=({time:e})=>Object(le.jsx)(pe.Node,{shader:Yo.node,uniforms:{time:e}}),Yo=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  clr /= 4.;
  gl_FragColor = vec4(clr, 1.0);
}`}}),Ko=40,$o="pen-o-plasma",Wo=({time:e})=>Object(le.jsx)(pe.Node,{shader:Qo.node,uniforms:{time:e}}),Qo=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(clr, 1.0);
}`}}),Zo=41,Jo="reflection",ei=({time:e})=>Object(le.jsx)(pe.Node,{shader:ti.node,uniforms:{time:e}}),ti=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),ri=42,oi="reflection party",ii=({time:e})=>Object(le.jsx)(pe.Node,{shader:ni.node,uniforms:{time:e}}),ni=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c = mix(c, reflection(p, n, 10.), glossy);
  gl_FragColor = vec4(c, 1.0);
}`}}),ai=43,si="irreconcilable queens",ci=({time:e})=>Object(le.jsx)(pe.LinearCopy,{children:Object(le.jsx)(li,{persistence:.4,children:Object(le.jsx)(pe.Node,{shader:pi.node,uniforms:{time:e}})})}),li=({children:e,persistence:t})=>Object(le.jsx)(pe.Node,{shader:pi.persistence,backbuffering:!0,uniforms:{t:e,back:pe.Uniform.Backbuffer,persistence:t}}),pi=pe.Shaders.create({persistence:{frag:pe.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),fi=44,ui="royal meeting",di=({time:e})=>Object(le.jsx)(pe.Node,{shader:vi.node,uniforms:{time:e}}),vi=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
#define PI ${Math.PI}
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),hi=45,mi="wood pawns army",gi=({time:e})=>Object(le.jsx)(pe.Node,{shader:yi.node,uniforms:{time:e,wood:"/images/seamless-wood-background-1.jpg"}}),yi=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),xi=46,bi="Bank of Bicoin",wi=({time:e})=>Object(le.jsx)(pe.Node,{shader:_i.node,uniforms:{time:e}}),_i=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),Si=47,Ei="glow experiment",zi=({time:e})=>Object(le.jsx)(pe.Node,{shader:Ti.node,uniforms:{time:e}}),Ti=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Ii=48,Ri="Starry Night",Pi=({time:e})=>Object(le.jsx)(pe.Node,{shader:Ai.node,uniforms:{time:e,img:"/images/seamless-wood2.jpg"}}),Ai=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(clr, 1.0);
}`}}),Oi=49,Ci="chinese lantern",Di=400,Li=0,ji=20,Ni=24,ki=1.1,Ui=({time:e})=>Object(le.jsx)(pe.LinearCopy,{children:Object(le.jsx)(Mi,{persistence:.8,children:Object(le.jsx)(pe.Node,{shader:qi.node,uniforms:{time:e}})})}),Mi=({children:e,persistence:t})=>Object(le.jsx)(pe.Node,{shader:qi.persistence,backbuffering:!0,uniforms:{t:e,back:pe.Uniform.Backbuffer,persistence:t}}),qi=pe.Shaders.create({persistence:{frag:pe.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  clr += c;
  gl_FragColor = vec4(clr, 1.0);
}`}}),Bi=50,Fi="jumpy rooks",Gi=({time:e})=>Object(le.jsx)(pe.Node,{shader:Hi.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),Hi=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),Vi=51,Xi="symmetry chess",Yi=400,Ki=0,$i=20,Wi=24,Qi=1,Zi=({time:e})=>Object(le.jsx)(pe.Node,{shader:Ji.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),Ji=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),en=52,tn="knights dance",rn=({time:e})=>Object(le.jsx)(pe.Node,{shader:on.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),on=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),nn=53,an="cross waves",sn=({time:e})=>Object(le.jsx)(pe.Node,{shader:cn.node,uniforms:{time:e}}),cn=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  */
}`}}),ln=54,pn="chess set",fn=({time:e})=>Object(le.jsx)(pe.Node,{shader:un.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),un=pe.Shaders.create({node:{frag:pe.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  color = vec4(c, 1.0);
}`}}),dn=55,vn="cube d'or",hn=400,mn=0,gn=20,yn=24,xn=1,bn=({time:e})=>Object(le.jsx)(pe.Node,{shader:wn.node,uniforms:{time:e}}),wn=pe.Shaders.create({node:{frag:pe.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  #endif
  color = vec4(c, 1.0);
}`}}),_n=56,Sn="jade forest",En=({time:e})=>Object(le.jsx)(pe.Node,{shader:zn.node,uniforms:{time:e}}),zn=pe.Shaders.create({node:{frag:pe.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  color = vec4(c, 1.0);
}`}}),Tn=57,In="Virus v2",Rn=400,Pn=0,An=20,On=24,Cn=.8,Dn=({time:e})=>Object(le.jsx)(pe.Node,{shader:Ln.node,uniforms:{time:e}}),Ln=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  `}}),$n=({children:e,persistence:t})=>Object(le.jsx)(pe.Node,{shader:Kn.persistence,backbuffering:!0,uniforms:{t:e,back:pe.Uniform.Backbuffer,persistence:t}}),Wn=59,Qn="Pixels 256",Zn="There will be only 256 patterns generated by this single fragment shader.",Jn=({time:e,n:t,exporting:r})=>Object(le.jsx)(ea,{n:t+1+(r?0:Math.floor(e))}),ea=Pe.a.memo((({n:e})=>{const t=new Nn.a(e%256),r=t.random(),o=t.random(),i=t.random(),n=t.random(),a=t.random(),s=t.random();return Object(le.jsx)(pe.Node,{shader:ta.node,uniforms:{s1:r,s2:o,s3:i,s4:n,s5:a,s6:s}})})),ta=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),ra=60,oa="bitcoin",ia=({time:e})=>Object(le.jsx)(pe.Node,{shader:na.node,uniforms:{time:e}}),na=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}});pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c = inBound *
    sqrt(vec3(1. - shad));
  gl_FragColor = vec4(c,1.0);
}`}}),pe.Shaders.create({main:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;

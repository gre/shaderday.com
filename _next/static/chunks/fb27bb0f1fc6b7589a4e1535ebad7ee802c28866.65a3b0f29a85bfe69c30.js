...
}`}}).copy;t.default=i},MAJC:function(e,t,r){"use strict";e.exports=function(e){return"undefined"!==typeof e&&null!==e&&("object"===typeof e||"function"===typeof e)}},Ni9w:function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;t.default=class{constructor(){var e,t,r;r=[],(t="_loaders")in(e=this)?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r}add(e){this._loaders.push(e),this._loaders.sort(((e,t)=>("number"===typeof t.priority?t.priority:0)-("number"===typeof e.priority?e.priority:0)))}remove(e){const t=this._loaders.indexOf(e);-1!==t&&this._loaders.splice(t,1)}get(){return this._loaders}}},O8XB:function(e,t,r){"use strict";(function(e,n){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var o,i,a,s,c,l=p(r("tbvF")),f=p(r("Ytbt")),u=p(r("zqV6"));function p(e){return e&&e.__esModule?e:{default:e}}"undefined"===typeof e&&(n.Buffer=(i=o=class{},c=t=>t instanceof e,(s="isBuffer")in(a=o)?Object.defineProperty(a,s,{value:c,enumerable:!0,configurable:!0,writable:!0}):a[s]=c,i));t.default=(e,t,r,n)=>{const o="undefined"!==typeof WebGLRenderingContext&&e instanceof WebGLRenderingContext;let i=r.dtype,a=r.shape.slice(),s=e.getParameter(e.MAX_TEXTURE_SIZE);if(a[0]<0||a[0]>s||a[1]<0||a[1]>s)throw new Error("gl-react: Invalid texture size");let c=function(e,t){return 3===e.length?1===t[2]&&t[1]===e[0]*e[2]&&t[0]===e[2]:1===t[0]&&t[1]===e[0]}(a,r.stride.slice()),p=0;"float32"===i?p=e.FLOAT:"float64"===i?(p=e.FLOAT,c=!1,i="float32"):"uint8"===i?p=e.UNSIGNED_BYTE:(p=e.UNSIGNED_BYTE,c=!1,i="uint8");let d,h=0,v=0;if(2===a.length)v=h=e.LUMINANCE,a=[a[0],a[1],1],r=(0,l.default)(r.data,a,[r.stride[0],r.stride[1],1],r.offset);else{if(3!==a.length)throw new Error("gl-texture2d: Invalid shape for texture");if(1===a[2])v=h=e.ALPHA,o||(n=!1);else if(2===a[2])v=h=e.LUMINANCE_ALPHA,o||(n=!1);else if(3===a[2])h=e.RGB,v=o?e.RGB:e.RGB32F;else{if(4!==a[2])throw new Error("gl-texture2d: Invalid shape for pixel coords");h=e.RGBA,v=o?e.RGBA:e.RGBA32F}}p!==e.FLOAT||n||(p=e.UNSIGNED_BYTE,c=!1);let m,g=r.size;if(c)d=0===r.offset&&r.data.length===g?r.data:r.data.subarray(r.offset,r.offset+g);else{let t=[a[2],a[2]*a[0],1];if("float32"!==i&&"float64"!==i||p!==e.UNSIGNED_BYTE){m=u.default.malloc(g,i);let e=(0,l.default)(m,a,t,0);f.default.assign(e,r)}else{m=u.default.malloc(g,"uint8"),function(e,t){f.default.muls(e,t,255)}((0,l.default)(m,a,t,0),r)}d=m.subarray(0,g)}e.texImage2D(e.TEXTURE_2D,0,v,a[0],a[1],0,h,p,d),m&&u.default.free(m)}}).call(this,r("HDXh").Buffer,r("ntbh"))},OTww:function(e,t,r){"use strict";(function(e){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var n,o=(n=r("Ni9w"))&&n.__esModule?n:{default:n};const i="undefined"===typeof window?e:window,a="__webglTextureLoader_registry";var s=i[a]||(i[a]=new o.default);t.default=s}).call(this,r("ntbh"))},QLaP:function(e,t,r){"use strict";e.exports=function(e,t,r,n,o,i,a,s){if(!e){var c;if(void 0===t)c=new Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else{var l=[r,n,o,i,a,s],f=0;(c=new Error(t.replace(/%s/g,(function(){return l[f++]})))).name="Invariant Violation"}throw c.framesToPop=1,c}}},QM7d:function(e,t,r){"use strict";var n=r("033R");function o(){this.argTypes=[],this.shimArgs=[],this.arrayArgs=[],this.arrayBlockIndices=[],this.scalarArgs=[],this.offsetArgs=[],this.offsetArgIndex=[],this.indexArgs=[],this.shapeArgs=[],this.funcName="",this.pre=null,this.body=null,this.post=null,this.debug=!1}e.exports=function(e){var t=new o;t.pre=e.pre,t.body=e.body,t.post=e.post;var r=e.args.slice(0);t.argTypes=r;for(var i=0;i<r.length;++i){var a=r[i];if("array"===a||"object"===typeof a&&a.blockIndices){if(t.argTypes[i]="array",t.arrayArgs.push(i),t.arrayBlockIndices.push(a.blockIndices?a.blockIndices:0),t.shimArgs.push("array"+i),i<t.pre.args.length&&t.pre.args[i].count>0)throw new Error("cwise: pre() block may not reference array args");if(i<t.post.args.length&&t.post.args[i].count>0)throw new Error("cwise: post() block may not reference array args")}else if("scalar"===a)t.scalarArgs.push(i),t.shimArgs.push("scalar"+i);else if("index"===a){if(t.indexArgs.push(i),i<t.pre.args.length&&t.pre.args[i].count>0)throw new Error("cwise: pre() block may not reference array index");if(i<t.body.args.length&&t.body.args[i].lvalue)throw new Error("cwise: body() block may not write to array index");if(i<t.post.args.length&&t.post.args[i].count>0)throw new Error("cwise: post() block may not reference array index")}else if("shape"===a){if(t.shapeArgs.push(i),i<t.pre.args.length&&t.pre.args[i].lvalue)throw new Error("cwise: pre() block may not write to array shape");if(i<t.body.args.length&&t.body.args[i].lvalue)throw new Error("cwise: body() block may not write to array shape");if(i<t.post.args.length&&t.post.args[i].lvalue)throw new Error("cwise: post() block may not write to array shape")}else{if("object"!==typeof a||!a.offset)throw new Error("cwise: Unknown argument type "+r[i]);t.argTypes[i]="offset",t.offsetArgs.push({array:a.array,offset:a.offset}),t.offsetArgIndex.push(i)}}if(t.arrayArgs.length<=0)throw new Error("cwise: No array arguments specified");if(t.pre.args.length>r.length)throw new Error("cwise: Too many arguments in pre() block");if(t.body.args.length>r.length)throw new Error("cwise: Too many arguments in body() block");if(t.post.args.length>r.length)throw new Error("cwise: Too many arguments in post() block");return t.debug=!!e.printCode||!!e.debug,t.funcName=e.funcName||"cwise",t.blockSize=e.blockSize||64,n(t)}},R9Te:function(e,t,r){"use strict";var n=r("CyWo"),o=r("z08I"),i=r("+0iv"),a=r("vCtr");function s(e){return"__proto__"!==e&&"constructor"!==e&&"prototype"!==e}e.exports=function(e,t,r){if(!a(e))return e;if(Array.isArray(t)&&(t=[].concat.apply([],t).join(".")),"string"!==typeof t)return e;for(var c=n(t,{sep:".",brackets:!0}).filter(s),l=c.length,f=-1,u=e;++f<l;){var p=c[f];f===l-1?i(u[p])&&i(r)?u[p]=o({},u[p],r):u[p]=r:(a(u[p])||(u[p]={}),u=u[p])}return e}},RjOF:function(e,t,r){"use strict";var n,o="";e.exports=function(e,t){if("string"!==typeof e)throw new TypeError("expected a string");if(1===t)return e;if(2===t)return e+e;var r=e.length*t;if(n!==e||"undefined"===typeof n)n=e,o="";else if(o.length>=r)return o.substr(0,r);for(;r>o.length&&t>1;)1&t&&(o+=e),t>>=1,e+=e;return o=(o+=e).substr(0,r)}},Ry8g:function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;t.default=e=>{const t=e.getExtension("WEBGL_lose_context");t&&t.loseContext()}},SMLl:function(e,t,r){"use strict";var n=r("RjOF");e.exports=function(e,t,r){return n(r="undefined"!==typeof r?r+"":" ",t)+e}},TBio:function(e,t,r){"use strict";var n=r("F16p");function o(e,t,r){var n,o,i=e.length,a=t.arrayArgs.length,s=t.indexArgs.length>0,c=[],l=[],f=0,u=0;for(n=0;n<i;++n)l.push(["i",n,"=0"].join(""));for(o=0;o<a;++o)for(n=0;n<i;++n)u=f,f=e[n],0===n?l.push(["d",o,"s",n,"=t",o,"p",f].join("")):l.push(["d",o,"s",n,"=(t",o,"p",f,"-s",u,"*t",o,"p",u,")"].join(""));for(l.length>0&&c.push("var "+l.join(",")),n=i-1;n>=0;--n)f=e[n],c.push(["for(i",n,"=0;i",n,"<s",f,";++i",n,"){"].join(""));for(c.push(r),n=0;n<i;++n){for(u=f,f=e[n],o=0;o<a;++o)c.push(["p",o,"+=d",o,"s",n].join(""));s&&(n>0&&c.push(["index[",u,"]-=s",u].join("")),c.push(["++index[",f,"]"].join(""))),c.push("}")}return c.join("\n")}function i(e,t,r){for(var n=e.body,o=[],i=[],a=0;a<e.args.length;++a){var s=e.args[a];if(!(s.count<=0)){var c=new RegExp(s.name,"g"),l="",f=t.arrayArgs.indexOf(a);switch(t.argTypes[a]){case"offset":var u=t.offsetArgIndex.indexOf(a);f=t.offsetArgs[u].array,l="+q"+u;case"array":l="p"+f+l;var p="l"+a,d="a"+f;if(0===t.arrayBlockIndices[f])1===s.count?"generic"===r[f]?s.lvalue?(o.push(["var ",p,"=",d,".get(",l,")"].join("")),n=n.replace(c,p),i.push([d,".set(",l,",",p,")"].join(""))):n=n.replace(c,[d,".get(",l,")"].join("")):n=n.replace(c,[d,"[",l,"]"].join("")):"generic"===r[f]?(o.push(["var ",p,"=",d,".get(",l,")"].join("")),n=n.replace(c,p),s.lvalue&&i.push([d,".set(",l,",",p,")"].join(""))):(o.push(["var ",p,"=",d,"[",l,"]"].join("")),n=n.replace(c,p),s.lvalue&&i.push([d,"[",l,"]=",p].join("")));else{for(var h=[s.name],v=[l],m=0;m<Math.abs(t.arrayBlockIndices[f]);m++)h.push("\\s*\\[([^\\]]+)\\]"),v.push("$"+(m+1)+"*t"+f+"b"+m);if(c=new RegExp(h.join(""),"g"),l=v.join("+"),"generic"===r[f])throw new Error("cwise: Generic arrays not supported in combination with blocks!");n=n.replace(c,[d,"[",l,"]"].join(""))}break;case"scalar":n=n.replace(c,"Y"+t.scalarArgs.indexOf(a));break;case"index":n=n.replace(c,"index");break;case"shape":n=n.replace(c,"shape")}}}return[o.join("\n"),n,i.join("\n")].join("\n").trim()}function a(e){for(var t=new Array(e.length),r=!0,n=0;n<e.length;++n){var o=e[n],i=o.match(/\d+/);i=i?i[0]:"",0===o.charAt(0)?t[n]="u"+o.charAt(1)+i:t[n]=o.charAt(0)+i,n>0&&(r=r&&t[n]===t[n-1])}return r?t[0]:t.join("")}e.exports=function(e,t){for(var r=t[1].length-Math.abs(e.arrayBlockIndices[0])|0,s=new Array(e.arrayArgs.length),c=new Array(e.arrayArgs.length),l=0;l<e.arrayArgs.length;++l)c[l]=t[2*l],s[l]=t[2*l+1];var f=[],u=[],p=[],d=[],h=[];for(l=0;l<e.arrayArgs.length;++l){e.arrayBlockIndices[l]<0?(p.push(0),d.push(r),f.push(r),u.push(r+e.arrayBlockIndices[l])):(p.push(e.arrayBlockIndices[l]),d.push(e.arrayBlockIndices[l]+r),f.push(0),u.push(e.arrayBlockIndices[l]));for(var v=[],m=0;m<s[l].length;m++)p[l]<=s[l][m]&&s[l][m]<d[l]&&v.push(s[l][m]-p[l]);h.push(v)}var g=["SS"],y=["'use strict'"],b=[];for(m=0;m<r;++m)b.push(["s",m,"=SS[",m,"]"].join(""));for(l=0;l<e.arrayArgs.length;++l){g.push("a"+l),g.push("t"+l),g.push("p"+l);for(m=0;m<r;++m)b.push(["t",l,"p",m,"=t",l,"[",p[l]+m,"]"].join(""));for(m=0;m<Math.abs(e.arrayBlockIndices[l]);++m)b.push(["t",l,"b",m,"=t",l,"[",f[l]+m,"]"].join(""))}for(l=0;l<e.scalarArgs.length;++l)g.push("Y"+l);if(e.shapeArgs.length>0&&b.push("shape=SS.slice(0)"),e.indexArgs.length>0){var x=new Array(r);for(l=0;l<r;++l)x[l]="0";b.push(["index=[",x.join(","),"]"].join(""))}for(l=0;l<e.offsetArgs.length;++l){var w=e.offsetArgs[l],_=[];for(m=0;m<w.offset.length;++m)0!==w.offset[m]&&(1===w.offset[m]?_.push(["t",w.array,"p",m].join("")):_.push([w.offset[m],"*t",w.array,"p",m].join("")));0===_.length?b.push("q"+l+"=0"):b.push(["q",l,"=",_.join("+")].join(""))}var E=n([].concat(e.pre.thisVars).concat(e.body.thisVars).concat(e.post.thisVars));for((b=b.concat(E)).length>0&&y.push("var "+b.join(",")),l=0;l<e.arrayArgs.length;++l)y.push("p"+l+"|=0");e.pre.body.length>3&&y.push(i(e.pre,e,c));var S=i(e.body,e,c),O=function(e){for(var t=0,r=e[0].length;t<r;){for(var n=1;n<e.length;++n)if(e[n][t]!==e[0][t])return t;++t}return t}(h);O<r?y.push(function(e,t,r,n){for(var i=t.length,a=r.arrayArgs.length,s=r.blockSize,c=r.indexArgs.length>0,l=[],f=0;f<a;++f)l.push(["var offset",f,"=p",f].join(""));for(f=e;f<i;++f)l.push(["for(var j"+f+"=SS[",t[f],"]|0;j",f,">0;){"].join("")),l.push(["if(j",f,"<",s,"){"].join("")),l.push(["s",t[f],"=j",f].join("")),l.push(["j",f,"=0"].join("")),l.push(["}else{s",t[f],"=",s].join("")),l.push(["j",f,"-=",s,"}"].join("")),c&&l.push(["index[",t[f],"]=j",f].join(""));for(f=0;f<a;++f){for(var u=["offset"+f],p=e;p<i;++p)u.push(["j",p,"*t",f,"p",t[p]].join(""));l.push(["p",f,"=(",u.join("+"),")"].join(""))}for(l.push(o(t,r,n)),f=e;f<i;++f)l.push("}");return l.join("\n")}(O,h[0],e,S)):y.push(o(h[0],e,S)),e.post.body.length>3&&y.push(i(e.post,e,c)),e.debug&&console.log("-----Generated cwise routine for ",t,":\n"+y.join("\n")+"\n----------");var R=[e.funcName||"unnamed","_cwise_loop_",s[0].join("s"),"m",O,a(c)].join("");return new Function(["function ",R,"(",g.join(","),"){",y.join("\n"),"} return ",R].join(""))()}},TGEO:function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),Object.defineProperty(t,"WebGLTextureLoader",{enumerable:!0,get:function(){return n.default}}),Object.defineProperty(t,"WebGLTextureLoaderAsyncHashCache",{enumerable:!0,get:function(){return o.default}}),Object.defineProperty(t,"WebGLTextureLoaderSyncHashCache",{enumerable:!0,get:function(){return i.default}}),Object.defineProperty(t,"LoadersRegistry",{enumerable:!0,get:function(){return a.default}}),Object.defineProperty(t,"LoaderResolver",{enumerable:!0,get:function(){return s.default}}),Object.defineProperty(t,"globalRegistry",{enumerable:!0,get:function(){return c.default}});var n=l(r("HbIt")),o=l(r("cDsr")),i=l(r("VYxY")),a=l(r("Ni9w")),s=l(r("LhdL")),c=l(r("OTww"));function l(e){return e&&e.__esModule?e:{default:e}}},TKux:function(e,t,r){"use strict";r.d(t,"b",(function(){return Ts})),r.d(t,"c",(function(){return zs})),r.d(t,"a",(function(){return Cs}));var n={};r.r(n),r.d(n,"n",(function(){return ge})),r.d(n,"title",(function(){return ye})),r.d(n,"Shader",(function(){return be}));var o={};r.r(o),r.d(o,"n",(function(){return we})),r.d(o,"title",(function(){return _e})),r.d(o,"exportSize",(function(){return Ee})),r.d(o,"exportStart",(function(){return Se})),r.d(o,"exportEnd",(function(){return Oe})),r.d(o,"exportFramePerSecond",(function(){return Re})),r.d(o,"exportSpeed",(function(){return Te})),r.d(o,"Shader",(function(){return ze}));var i={};r.r(i),r.d(i,"n",(function(){return Pe})),r.d(i,"title",(function(){return Ie})),r.d(i,"Shader",(function(){return je}));var a={};r.r(a),r.d(a,"n",(function(){return Me})),r.d(a,"title",(function(){return Ue})),r.d(a,"Shader",(function(){return Fe}));var s={};r.r(s),r.d(s,"n",(function(){return Ge})),r.d(s,"title",(function(){return He})),r.d(s,"Shader",(function(){return Ve}));var c={};r.r(c),r.d(c,"n",(function(){return Xe})),r.d(c,"title",(function(){return Ke})),r.d(c,"Shader",(function(){return Ye}));var l={};r.r(l),r.d(l,"n",(function(){return Ze})),r.d(l,"title",(function(){return Je})),r.d(l,"Shader",(function(){return et}));var f={};r.r(f),r.d(f,"n",(function(){return rt})),r.d(f,"title",(function(){return nt})),r.d(f,"Shader",(function(){return ot}));var u={};r.r(u),r.d(u,"n",(function(){return at})),r.d(u,"title",(function(){return st})),r.d(u,"exportSize",(function(){return ct})),r.d(u,"exportStart",(function(){return lt})),r.d(u,"exportEnd",(function(){return ft})),r.d(u,"exportFramePerSecond",(function(){return ut})),r.d(u,"exportSpeed",(function(){return pt})),r.d(u,"Shader",(function(){return dt}));var p={};r.r(p),r.d(p,"n",(function(){return vt})),r.d(p,"title",(function(){return mt})),r.d(p,"Shader",(function(){return gt}));var d={};r.r(d),r.d(d,"n",(function(){return bt})),r.d(d,"title",(function(){return xt})),r.d(d,"Shader",(function(){return wt}));var h={};r.r(h),r.d(h,"n",(function(){return Et})),r.d(h,"title",(function(){return St})),r.d(h,"Shader",(function(){return Ot}));var v={};r.r(v),r.d(v,"n",(function(){return Tt})),r.d(v,"title",(function(){return zt})),r.d(v,"Shader",(function(){return Ct}));var m={};r.r(m),r.d(m,"n",(function(){return It})),r.d(m,"title",(function(){return jt})),r.d(m,"Shader",(function(){return At}));var g={};r.r(g),r.d(g,"n",(function(){return Gt})),r.d(g,"title",(function(){return Ht})),r.d(g,"Shader",(function(){return Vt}));var y={};r.r(y),r.d(y,"n",(function(){return Yt})),r.d(y,"title",(function(){return Qt})),r.d(y,"Shader",(function(){return Zt}));var b={};r.r(b),r.d(b,"n",(function(){return er})),r.d(b,"title",(function(){return tr})),r.d(b,"Shader",(function(){return rr}));var x={};r.r(x),r.d(x,"n",(function(){return or})),r.d(x,"title",(function(){return ir})),r.d(x,"Shader",(function(){return ar}));var w={};r.r(w),r.d(w,"n",(function(){return cr})),r.d(w,"title",(function(){return lr})),r.d(w,"Shader",(function(){return fr}));var _={};r.r(_),r.d(_,"n",(function(){return pr})),r.d(_,"title",(function(){return dr})),r.d(_,"Shader",(function(){return hr}));var E={};r.r(E),r.d(E,"n",(function(){return gr})),r.d(E,"title",(function(){return yr})),r.d(E,"Shader",(function(){return br}));var S={};r.r(S),r.d(S,"n",(function(){return _r})),r.d(S,"title",(function(){return Er})),r.d(S,"Shader",(function(){return Sr}));var O={};r.r(O),r.d(O,"n",(function(){return Rr})),r.d(O,"title",(function(){return Tr})),r.d(O,"Shader",(function(){return zr}));var R={};r.r(R),r.d(R,"n",(function(){return Pr})),r.d(R,"title",(function(){return Ir})),r.d(R,"Shader",(function(){return jr}));var T={};r.r(T),r.d(T,"n",(function(){return kr})),r.d(T,"title",(function(){return Dr})),r.d(T,"Shader",(function(){return Lr}));var z={};r.r(z),r.d(z,"n",(function(){return Ur})),r.d(z,"title",(function(){return Br})),r.d(z,"Shader",(function(){return Fr}));var C={};r.r(C),r.d(C,"n",(function(){return Gr})),r.d(C,"title",(function(){return Hr})),r.d(C,"exportSize",(function(){return Vr})),r.d(C,"exportStart",(function(){return Wr})),r.d(C,"exportEnd",(function(){return Xr})),r.d(C,"exportFramePerSecond",(function(){return Kr})),r.d(C,"exportSpeed",(function(){return Yr})),r.d(C,"Shader",(function(){return Qr}));var P={};r.r(P),r.d(P,"n",(function(){return en})),r.d(P,"title",(function(){return tn})),r.d(P,"Shader",(function(){return rn}));var I={};r.r(I),r.d(I,"n",(function(){return an})),r.d(I,"title",(function(){return sn})),r.d(I,"Shader",(function(){return cn}));var j={};r.r(j),r.d(j,"n",(function(){return fn})),r.d(j,"title",(function(){return un})),r.d(j,"Shader",(function(){return pn}));var A={};r.r(A),r.d(A,"n",(function(){return hn})),r.d(A,"title",(function(){return vn})),r.d(A,"Shader",(function(){return mn}));var k={};r.r(k),r.d(k,"n",(function(){return yn})),r.d(k,"title",(function(){return bn})),r.d(k,"Shader",(function(){return wn}));var D={};r.r(D),r.d(D,"n",(function(){return En})),r.d(D,"title",(function(){return Sn})),r.d(D,"Shader",(function(){return On}));var L={};r.r(L),r.d(L,"n",(function(){return Tn})),r.d(L,"title",(function(){return zn})),r.d(L,"Shader",(function(){return Cn}));var N={};r.r(N),r.d(N,"n",(function(){return In})),r.d(N,"title",(function(){return jn})),r.d(N,"Shader",(function(){return An}));var M={};r.r(M),r.d(M,"n",(function(){return Ln})),r.d(M,"title",(function(){return Nn})),r.d(M,"Shader",(function(){return Mn}));var U={};r.r(U),r.d(U,"n",(function(){return Fn})),r.d(U,"title",(function(){return qn})),r.d(U,"Shader",(function(){return $n}));var B={};r.r(B),r.d(B,"n",(function(){return Hn})),r.d(B,"title",(function(){return Vn})),r.d(B,"Shader",(function(){return Wn}));var F={};r.r(F),r.d(F,"n",(function(){return Yn})),r.d(F,"title",(function(){return Qn})),r.d(F,"Shader",(function(){return Zn}));var q={};r.r(q),r.d(q,"n",(function(){return eo})),r.d(q,"title",(function(){return to})),r.d(q,"Shader",(function(){return ro}));var $={};r.r($),r.d($,"n",(function(){return oo})),r.d($,"title",(function(){return io})),r.d($,"Shader",(function(){return ao}));var G={};r.r(G),r.d(G,"n",(function(){return co})),r.d(G,"title",(function(){return lo})),r.d(G,"Shader",(function(){return fo}));var H={};r.r(H),r.d(H,"n",(function(){return po})),r.d(H,"title",(function(){return ho})),r.d(H,"Shader",(function(){return vo}));var V={};r.r(V),r.d(V,"n",(function(){return yo})),r.d(V,"title",(function(){return bo})),r.d(V,"Shader",(function(){return xo}));var W={};r.r(W),r.d(W,"n",(function(){return _o})),r.d(W,"title",(function(){return Eo})),r.d(W,"Shader",(function(){return So}));var X={};r.r(X),r.d(X,"n",(function(){return Ro})),r.d(X,"title",(function(){return To})),r.d(X,"Shader",(function(){return zo}));var K={};r.r(K),r.d(K,"n",(function(){return Po})),r.d(K,"title",(function(){return Io})),r.d(K,"Shader",(function(){return jo}));var Y={};r.r(Y),r.d(Y,"n",(function(){return ko})),r.d(Y,"title",(function(){return Do})),r.d(Y,"Shader",(function(){return Lo}));var Q={};r.r(Q),r.d(Q,"n",(function(){return Mo})),r.d(Q,"title",(function(){return Uo})),r.d(Q,"exportSize",(function(){return Bo})),r.d(Q,"exportStart",(function(){return Fo})),r.d(Q,"exportEnd",(function(){return qo})),r.d(Q,"exportFramePerSecond",(function(){return $o})),r.d(Q,"exportSpeed",(function(){return Go})),r.d(Q,"Shader",(function(){return Ho}));var Z={};r.r(Z),r.d(Z,"n",(function(){return Xo})),r.d(Z,"title",(function(){return Ko})),r.d(Z,"Shader",(function(){return Yo}));var J={};r.r(J),r.d(J,"n",(function(){return Zo})),r.d(J,"title",(function(){return Jo})),r.d(J,"exportSize",(function(){return ei})),r.d(J,"exportStart",(function(){return ti})),r.d(J,"exportEnd",(function(){return ri})),r.d(J,"exportFramePerSecond",(function(){return ni})),r.d(J,"exportSpeed",(function(){return oi})),r.d(J,"Shader",(function(){return ii}));var ee={};r.r(ee),r.d(ee,"n",(function(){return si})),r.d(ee,"title",(function(){return ci})),r.d(ee,"Shader",(function(){return li}));var te={};r.r(te),r.d(te,"n",(function(){return ui})),r.d(te,"title",(function(){return pi})),r.d(te,"Shader",(function(){return di}));var re={};r.r(re),r.d(re,"n",(function(){return vi})),r.d(re,"title",(function(){return mi})),r.d(re,"Shader",(function(){return gi}));var ne={};r.r(ne),r.d(ne,"n",(function(){return bi})),r.d(ne,"title",(function(){return xi})),r.d(ne,"exportSize",(function(){return wi})),r.d(ne,"exportStart",(function(){return _i})),r.d(ne,"exportEnd",(function(){return Ei})),r.d(ne,"exportFramePerSecond",(function(){return Si})),r.d(ne,"exportSpeed",(function(){return Oi})),r.d(ne,"Shader",(function(){return Ri}));var oe={};r.r(oe),r.d(oe,"n",(function(){return zi})),r.d(oe,"title",(function(){return Ci})),r.d(oe,"Shader",(function(){return Pi}));var ie={};r.r(ie),r.d(ie,"n",(function(){return ji})),r.d(ie,"title",(function(){return Ai})),r.d(ie,"exportSize",(function(){return ki})),r.d(ie,"exportStart",(function(){return Di})),r.d(ie,"exportEnd",(function(){return Li})),r.d(ie,"exportFramePerSecond",(function(){return Ni})),r.d(ie,"exportSpeed",(function(){return Mi})),r.d(ie,"Shader",(function(){return Ui}));var ae={};r.r(ae),r.d(ae,"exportSize",(function(){return $i})),r.d(ae,"exportStart",(function(){return Gi})),r.d(ae,"exportEnd",(function(){return Hi})),r.d(ae,"exportFramePerSecond",(function(){return Vi})),r.d(ae,"exportSpeed",(function(){return Wi})),r.d(ae,"exportMP4vb",(function(){return Xi})),r.d(ae,"n",(function(){return Ki})),r.d(ae,"title",(function(){return Yi})),r.d(ae,"nfts",(function(){return Qi})),r.d(ae,"Shader",(function(){return Ji}));var se={};r.r(se),r.d(se,"n",(function(){return ra})),r.d(se,"title",(function(){return na})),r.d(se,"description",(function(){return oa})),r.d(se,"Shader",(function(){return ia}));var ce={};r.r(ce),r.d(ce,"n",(function(){return ca})),r.d(ce,"title",(function(){return la})),r.d(ce,"Shader",(function(){return fa}));var le={};r.r(le),r.d(le,"n",(function(){return pa})),r.d(le,"title",(function(){return da})),r.d(le,"exportEnd",(function(){return ha})),r.d(le,"exportFramePerSecond",(function(){return va})),r.d(le,"preload",(function(){return ma})),r.d(le,"Shader",(function(){return ga}));var fe={};r.r(fe),r.d(fe,"n",(function(){return ba})),r.d(fe,"title",(function(){return xa})),r.d(fe,"exportEnd",(function(){return wa})),r.d(fe,"exportFramePerSecond",(function(){return _a})),r.d(fe,"exportSpeed",(function(){return Ea})),r.d(fe,"Logic",(function(){return Sa})),r.d(fe,"Shader",(function(){return Ca}));var ue={};r.r(ue),r.d(ue,"n",(function(){return ja})),r.d(ue,"title",(function(){return Aa})),r.d(ue,"exportSize",(function(){return ka})),r.d(ue,"exportStart",(function(){return Da})),r.d(ue,"exportEnd",(function(){return La})),r.d(ue,"exportFramePerSecond",(function(){return Na})),r.d(ue,"exportSpeed",(function(){return Ma})),r.d(ue,"exportMP4vb",(function(){return Ua})),r.d(ue,"Logic",(function(){return Fa})),r.d(ue,"Shader",(function(){return Ha}));var pe={};r.r(pe),r.d(pe,"n",(function(){return Wa})),r.d(pe,"title",(function(){return Xa})),r.d(pe,"exportEnd",(function(){return Ka})),r.d(pe,"nfts",(function(){return Ya})),r.d(pe,"Shader",(function(){return Qa}));var de={};r.r(de),r.d(de,"n",(function(){return Ja})),r.d(de,"title",(function(){return es})),r.d(de,"exportSize",(function(){return ts})),r.d(de,"exportStart",(function(){return rs})),r.d(de,"exportEnd",(function(){return ns})),r.d(de,"exportFramePerSecond",(function(){return os})),r.d(de,"exportSpeed",(function(){return is})),r.d(de,"exportSkipFrame",(function(){return as})),r.d(de,"exportPaletteGenOnce",(function(){return ss})),r.d(de,"exportPaletteSize",(function(){return cs})),r.d(de,"nfts",(function(){return ls})),r.d(de,"Shader",(function(){return fs}));var he={};r.r(he),r.d(he,"n",(function(){return ds})),r.d(he,"title",(function(){return hs})),r.d(he,"exportSize",(function(){return vs})),r.d(he,"exportStart",(function(){return ms})),r.d(he,"exportEnd",(function(){return gs})),r.d(he,"exportFramePerSecond",(function(){return ys})),r.d(he,"exportSpeed",(function(){return bs})),r.d(he,"exportSkipFrame",(function(){return xs})),r.d(he,"exportPaletteGenOnce",(function(){return ws})),r.d(he,"exportPaletteSize",(function(){return _s})),r.d(he,"Shader",(function(){return Es}));var ve=r("nKUr"),me=r("rr/c");const ge=1,ye="Hello 2020",be=({time:e})=>Object(ve.jsx)(me.Node,{shader:xe.day001,uniforms:{time:e}}),xe=me.Shaders.create({day001:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
float vingt (vec2 p) {
...
}`}}),we=2,_e="stripes",Ee=400,Se=0,Oe=60,Re=24,Te=1,ze=({time:e})=>Object(ve.jsx)(me.Node,{shader:Ce.node,uniforms:{time:e}}),Ce=me.Shaders.create({node:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),Pe=3,Ie="zephyr",je=({time:e})=>Object(ve.jsx)(me.Node,{shader:Ae.node,uniforms:{time:e}}),Ae=me.Shaders.create({node:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}});var ke=r("q1tI"),De=r.n(ke);const Le=me.Shaders.create({InitGameOfLife:{frag:me.GLSL`
  precision highp float;
  uniform float seed;
  // i
  varying vec2 uv;
  ...
  }`}}),Ne=De.a.memo((({tick:e,size:t,refreshEveryTicks:r})=>e%(r||1/0)===0?Object(ve.jsx)(me.Node,{shader:Le.InitGameOfLife,uniforms:{seed:Math.random()},width:t,height:t,backbuffering:!0,sync:!0}):Object(ve.jsx)(me.Node,{shader:Le.GameOfLife,width:t,height:t,backbuffering:!0,sync:!0,uniforms:{t:me.Uniform.Backbuffer,size:t}}))),Me=4,Ue="Ray of Life";let Be;const Fe=({time:e})=>{Be||(Be=e);const t=e-Be,r=Math.floor(10*t),n=r+25,o=10*(1+Math.floor(r/50)),i=10*(1+Math.floor(n/50));return Object(ve.jsx)(qe,{time:e,a:Object(ve.jsx)(me.NearestCopy,{children:Object(ve.jsx)(Ne,{refreshEveryTicks:50,tick:r,size:o})}),b:Object(ve.jsx)(me.NearestCopy,{children:Object(ve.jsx)(Ne,{refreshEveryTicks:50,tick:n,size:i})})})},qe=({a:e,b:t,time:r})=>Object(ve.jsx)(me.Node,{uniforms:{a:e,b:t,time:r},shader:$e.main}),$e=me.Shaders.create({main:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Ge=5,He="Here We Go Again",Ve=({time:e})=>Object(ve.jsx)(me.Node,{shader:We.node,uniforms:{time:e}}),We=me.Shaders.create({node:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    sqrt(vec3(1. - shad));
  gl_FragColor = vec4(c,1.0);
}`}}),Xe=6,Ke="Bestagons",Ye=({time:e})=>Object(ve.jsx)(me.Node,{shader:Qe.node,uniforms:{time:e}}),Qe=me.Shaders.create({node:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),Ze=7,Je="Worms party",et=({time:e})=>Object(ve.jsx)(me.Node,{shader:tt.node,uniforms:{time:e}}),tt=me.Shaders.create({node:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    sqrt(vec3(1. - shad));
  gl_FragColor = vec4(c,1.0);
}`}}),rt=8,nt="moontains",ot=({time:e})=>Object(ve.jsx)(me.Node,{shader:it.node,uniforms:{time:e}}),it=me.Shaders.create({node:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),at=9,st="Virus",ct=400,lt=16.3,ft=26,ut=24,pt=.8,dt=({time:e})=>Object(ve.jsx)(me.Node,{shader:ht.node,uniforms:{time:e}}),ht=me.Shaders.create({node:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),vt=10,mt="ring",gt=({time:e})=>Object(ve.jsx)(me.Node,{shader:yt.node,uniforms:{time:e}}),yt=me.Shaders.create({node:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),bt=11,xt="magic mouse",wt=({time:e})=>Object(ve.jsx)(me.Node,{shader:_t.node,uniforms:{time:e}}),_t=me.Shaders.create({node:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Et=12,St="floor is lava",Ot=({time:e})=>Object(ve.jsx)(me.Node,{shader:Rt.node,uniforms:{time:e}}),Rt=me.Shaders.create({node:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Tt=13,zt="chip",Ct=({time:e})=>Object(ve.jsx)(me.Node,{shader:Pt.node,uniforms:{time:e}}),Pt=me.Shaders.create({node:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
`}}),It=14,jt="seizure",At=({time:e})=>Object(ve.jsx)(me.Node,{shader:kt.node,uniforms:{time:e}}),kt=me.Shaders.create({node:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Dt=me.Shaders.create({blur1D:{frag:me.GLSL`precision highp float;
varying vec2 uv;
uniform sampler2D t;
...
}`}});var Lt=({width:e,height:t,pixelRatio:r,direction:n,children:o})=>Object(ve.jsx)(me.Node,{shader:Dt.blur1D,width:e,height:t,pixelRatio:r,uniforms:{direction:n,resolution:me.Uniform.Resolution,t:o}});const Nt=Math.sqrt(2)/2;var Mt=(e,t,r)=>{const n=2*t*Math.ceil(e/2)/r;switch((e-1)%4){case 0:return[n,0];case 1:return[0,n];case 2:return[n*Nt,n*Nt];case 3:return[n*Nt,-n*Nt]}};const Ut=({width:e,height:t,pixelRatio:r,factor:n,children:o,passes:i,directionForPass:a})=>{const s=c=>c<=0?o:Object(ve.jsx)(Lt,{width:e,height:t,pixelRatio:r,direction:a(c,n,i),children:s(c-1)});return s(i)};Ut.defaultProps={passes:2,directionForPass:Mt};var Bt=Ut;const Ft=me.Shaders.create({blur1D:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
...
}`}});var qt=({width:e,height:t,map:r,pixelRatio:n,direction:o,children:i})=>Object(ve.jsx)(me.Node,{shader:Ft.blur1D,width:e,height:t,pixelRatio:n,uniforms:{direction:o,resolution:me.Uniform.Resolution,t:i,map:r}});const $t=({width:e,height:t,map:r,pixelRatio:n,factor:o,children:i,passes:a,directionForPass:s})=>{const c=l=>l<=0?i:Object(ve.jsx)(qt,{width:e,height:t,map:r,pixelRatio:n,direction:s(l,o,a),children:c(l-1)});return c(a)};$t.defaultProps={passes:2,directionForPass:Mt};const Gt=15,Ht="parametric",Vt=({time:e})=>Object(ve.jsx)(me.LinearCopy,{children:Object(ve.jsx)(Xt,{persistence:.98+.02*Math.cos(e)+-.8*Math.exp(-e),children:Object(ve.jsx)(Bt,{passes:4,factor:.2,children:Object(ve.jsx)(Wt,{time:e})})})}),Wt=({time:e})=>Object(ve.jsx)(me.Node,{shader:Kt.node,uniforms:{time:e}}),Xt=({children:e,persistence:t})=>Object(ve.jsx)(me.Node,{shader:Kt.persistence,backbuffering:!0,uniforms:{t:e,back:me.Uniform.Backbuffer,persistence:t}}),Kt=me.Shaders.create({persistence:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),Yt=16,Qt="reuleaux",Zt=({time:e})=>Object(ve.jsx)(me.Node,{shader:Jt.node,uniforms:{time:e}}),Jt=me.Shaders.create({node:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    color(0.5 * time);
  gl_FragColor = vec4(c, 1.0);
}`}}),er=17,tr="screws",rr=({time:e})=>Object(ve.jsx)(me.Node,{shader:nr.node,uniforms:{time:e}}),nr=me.Shaders.create({node:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),or=18,ir="queen",ar=({time:e})=>Object(ve.jsx)(me.Node,{shader:sr.node,uniforms:{time:e}}),sr=me.Shaders.create({node:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
}`}}),cr=19,lr="they were six",fr=({time:e})=>Object(ve.jsx)(me.Node,{shader:ur.node,uniforms:{time:e}}),ur=me.Shaders.create({node:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),pr=20,dr="trippy tiles",hr=({time:e})=>Object(ve.jsx)(me.LinearCopy,{children:Object(ve.jsx)(vr,{persistence:.85,children:Object(ve.jsx)(me.Node,{shader:mr.node,uniforms:{time:e}})})}),vr=({children:e,persistence:t})=>Object(ve.jsx)(me.Node,{shader:mr.persistence,backbuffering:!0,uniforms:{t:e,back:me.Uniform.Backbuffer,persistence:t}}),mr=me.Shaders.create({persistence:{frag:me.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),gr=21,yr="HODL",br=({time:e})=>Object(ve.jsx)(me.LinearCopy,{children:Object(ve.jsx)(xr,{persistence:Math.min(.99,.015*e),time:e,children:Object(ve.jsx)(me.Node,{shader:wr.node,uniforms:{time:e}})})}),xr=({children:e,persistence:t,time:r})=>Object(ve.jsx)(me.Node,{shader:wr.shakePersistence,backbuffering:!0,uniforms:{t:e,back:me.Uniform.Backbuffer,persistence:t,time:r}}),wr=me.Shaders.create({shakePersistence:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform sampler2D t, back;
uniform float time;
...
}`}}),_r=22,Er="atoms",Sr=({time:e})=>Object(ve.jsx)(me.Node,{shader:Or.node,uniforms:{time:e,t:"/images/einstein-tongue-out.jpg"}}),Or=me.Shaders.create({node:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D t;
...
void main() {
...
}`}}),Rr=23,Tr="Hexacubes",zr=({time:e})=>Object(ve.jsx)(me.Node,{shader:Cr.node,uniforms:{time:e}}),Cr=me.Shaders.create({node:{frag:me.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform float time;
  const float PI = ${Math.PI};
  ...
  void main() {
    ...
    gl_FragColor = vec4(c, 1.0);
      ...
      `}}),Pr=24,Ir="dark cubes",jr=({time:e})=>Object(ve.jsx)(me.Node,{shader:Ar.node,uniforms:{time:e}}),Ar=me.Shaders.create({node:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),kr=25,Dr="Mandelbrot",Lr=({time:e})=>Object(ve.jsx)(me.LinearCopy,{children:Object(ve.jsx)(Nr,{persistence:.9,children:Object(ve.jsx)(Bt,{passes:4,factor:.1,children:Object(ve.jsx)(me.Node,{shader:Mr.node,uniforms:{time:e}})})})}),Nr=({children:e,persistence:t})=>Object(ve.jsx)(me.Node,{shader:Mr.persistence,backbuffering:!0,uniforms:{t:e,back:me.Uniform.Backbuffer,persistence:t}}),Mr=me.Shaders.create({persistence:{frag:me.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Ur=26,Br="fumes",Fr=({time:e})=>Object(ve.jsx)(me.LinearCopy,{children:Object(ve.jsx)(qr,{persistence:.9,children:Object(ve.jsx)(Bt,{passes:4,factor:Math.min(.6,.01*e),children:Object(ve.jsx)(me.Node,{shader:$r.node,uniforms:{time:e}})})})}),qr=({children:e,persistence:t})=>Object(ve.jsx)(me.Node,{shader:$r.persistence,backbuffering:!0,uniforms:{t:e,back:me.Uniform.Backbuffer,persistence:t}}),$r=me.Shaders.create({persistence:{frag:me.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Gr=27,Hr="real burning ship",Vr=400,Wr=0,Xr=60,Kr=12,Yr=2,Qr=({time:e})=>Object(ve.jsx)(me.LinearCopy,{children:Object(ve.jsx)(Zr,{persistence:.8+.05*Math.random(),time:e,children:Object(ve.jsx)(me.Node,{shader:Jr.node,uniforms:{time:e}})})}),Zr=({children:e,persistence:t,time:r})=>Object(ve.jsx)(me.Node,{shader:Jr.persistence,backbuffering:!0,uniforms:{t:e,back:me.Uniform.Backbuffer,persistence:t,time:r}}),Jr=me.Shaders.create({persistence:{frag:me.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),en=28,tn="No, I'M Batman",rn=({time:e})=>Object(ve.jsx)(me.LinearCopy,{children:Object(ve.jsx)(nn,{persistence:.5+.48*Math.min(1,e/60),children:Object(ve.jsx)(me.Node,{shader:on.node,uniforms:{time:e}})})}),nn=({children:e,persistence:t})=>Object(ve.jsx)(me.Node,{shader:on.persistence,backbuffering:!0,uniforms:{t:e,back:me.Uniform.Backbuffer,persistence:t}}),on=me.Shaders.create({persistence:{frag:me.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),an=29,sn="sdBitcoin(p)",cn=({time:e})=>Object(ve.jsx)(me.Node,{shader:ln.node,uniforms:{time:e}}),ln=me.Shaders.create({node:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),fn=30,un="21 millions",pn=({time:e})=>Object(ve.jsx)(me.Node,{shader:dn.node,uniforms:{time:e,numberInCirculation:18557031}}),dn=me.Shaders.create({node:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),hn=31,vn="alien tower",mn=({time:e})=>Object(ve.jsx)(me.Node,{shader:gn.node,uniforms:{time:e,numberInCirculation:18557031}}),gn=me.Shaders.create({node:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform float numberInCirculation;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),yn=32,bn="GoL valley";let xn;const wn=({time:e})=>{xn||(xn=e);const t=e-xn,r=Math.floor(12*t);return Object(ve.jsx)(me.Node,{shader:_n.node,uniforms:{time:e,t:Object(ve.jsx)(Ne,{refreshEveryTicks:100,tick:r,size:100})}})},_n=me.Shaders.create({node:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D t;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),En=33,Sn="x(x+32y)%(tN+1)%n";const On=({time:e})=>Object(ve.jsx)(me.Node,{shader:Rn.node,uniforms:{time:e}}),Rn=me.Shaders.create({node:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Tn=34,zn="\u230a2cos(x)sin(y+t)\u230b%7";const Cn=({time:e})=>Object(ve.jsx)(me.Node,{shader:Pn.node,uniforms:{time:e}}),Pn=me.Shaders.create({node:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
#define PI ${Math.PI}
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),In=35,jn="aie confiance",An=({time:e})=>Object(ve.jsx)(me.LinearCopy,{children:Object(ve.jsx)(kn,{persistence:.6,children:Object(ve.jsx)(me.Node,{shader:Dn.node,uniforms:{time:e}})})}),kn=({children:e,persistence:t})=>Object(ve.jsx)(me.Node,{shader:Dn.persistence,backbuffering:!0,uniforms:{t:e,back:me.Uniform.Backbuffer,persistence:t}}),Dn=me.Shaders.create({persistence:{frag:me.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Ln=36,Nn="crois en moi",Mn=({time:e})=>Object(ve.jsx)(me.LinearCopy,{children:Object(ve.jsx)(Un,{children:Object(ve.jsx)(me.Node,{shader:Bn.node,uniforms:{time:e}})})}),Un=({children:e,persistence:t})=>Object(ve.jsx)(me.Node,{shader:Bn.persistence,backbuffering:!0,uniforms:{t:e,back:me.Uniform.Backbuffer,persistence:t}}),Bn=me.Shaders.create({persistence:{frag:me.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Fn=37,qn="sdBrick",$n=({time:e})=>Object(ve.jsx)(me.Node,{shader:Gn.node,uniforms:{time:e}}),Gn=me.Shaders.create({node:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Hn=38,Vn="Golden mandelbulb",Wn=({time:e})=>Object(ve.jsx)(me.LinearCopy,{children:Object(ve.jsx)(Xn,{persistence:.5,children:Object(ve.jsx)(me.Node,{shader:Kn.node,uniforms:{time:e}})})}),Xn=({children:e,persistence:t})=>Object(ve.jsx)(me.Node,{shader:Kn.persistence,backbuffering:!0,uniforms:{t:e,back:me.Uniform.Backbuffer,persistence:t}}),Kn=me.Shaders.create({persistence:{frag:me.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  clr /= 4.;
  gl_FragColor = vec4(clr, 1.0);
}`}}),Yn=39,Qn="metaballs",Zn=({time:e})=>Object(ve.jsx)(me.Node,{shader:Jn.node,uniforms:{time:e}}),Jn=me.Shaders.create({node:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  clr /= 4.;
  gl_FragColor = vec4(clr, 1.0);
}`}}),eo=40,to="pen-o-plasma",ro=({time:e})=>Object(ve.jsx)(me.Node,{shader:no.node,uniforms:{time:e}}),no=me.Shaders.create({node:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(clr, 1.0);
}`}}),oo=41,io="reflection",ao=({time:e})=>Object(ve.jsx)(me.Node,{shader:so.node,uniforms:{time:e}}),so=me.Shaders.create({node:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),co=42,lo="reflection party",fo=({time:e})=>Object(ve.jsx)(me.Node,{shader:uo.node,uniforms:{time:e}}),uo=me.Shaders.create({node:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c = mix(c, reflection(p, n, 10.), glossy);
  gl_FragColor = vec4(c, 1.0);
}`}}),po=43,ho="irreconcilable queens",vo=({time:e})=>Object(ve.jsx)(me.LinearCopy,{children:Object(ve.jsx)(mo,{persistence:.4,children:Object(ve.jsx)(me.Node,{shader:go.node,uniforms:{time:e}})})}),mo=({children:e,persistence:t})=>Object(ve.jsx)(me.Node,{shader:go.persistence,backbuffering:!0,uniforms:{t:e,back:me.Uniform.Backbuffer,persistence:t}}),go=me.Shaders.create({persistence:{frag:me.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),yo=44,bo="royal meeting",xo=({time:e})=>Object(ve.jsx)(me.Node,{shader:wo.node,uniforms:{time:e}}),wo=me.Shaders.create({node:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
#define PI ${Math.PI}
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),_o=45,Eo="wood pawns army",So=({time:e})=>Object(ve.jsx)(me.Node,{shader:Oo.node,uniforms:{time:e,wood:"/images/seamless-wood-background-1.jpg"}}),Oo=me.Shaders.create({node:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),Ro=46,To="Bank of Bicoin",zo=({time:e})=>Object(ve.jsx)(me.Node,{shader:Co.node,uniforms:{time:e}}),Co=me.Shaders.create({node:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),Po=47,Io="glow experiment",jo=({time:e})=>Object(ve.jsx)(me.Node,{shader:Ao.node,uniforms:{time:e}}),Ao=me.Shaders.create({node:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),ko=48,Do="Starry Night",Lo=({time:e})=>Object(ve.jsx)(me.Node,{shader:No.node,uniforms:{time:e,img:"/images/seamless-wood2.jpg"}}),No=me.Shaders.create({node:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(clr, 1.0);
}`}}),Mo=49,Uo="chinese lantern",Bo=400,Fo=0,qo=20,$o=24,Go=1.1,Ho=({time:e})=>Object(ve.jsx)(me.LinearCopy,{children:Object(ve.jsx)(Vo,{persistence:.8,children:Object(ve.jsx)(me.Node,{shader:Wo.node,uniforms:{time:e}})})}),Vo=({children:e,persistence:t})=>Object(ve.jsx)(me.Node,{shader:Wo.persistence,backbuffering:!0,uniforms:{t:e,back:me.Uniform.Backbuffer,persistence:t}}),Wo=me.Shaders.create({persistence:{frag:me.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  clr += c;
  gl_FragColor = vec4(clr, 1.0);
}`}}),Xo=50,Ko="jumpy rooks",Yo=({time:e})=>Object(ve.jsx)(me.Node,{shader:Qo.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),Qo=me.Shaders.create({node:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),Zo=51,Jo="symmetry chess",ei=400,ti=0,ri=20,ni=24,oi=1,ii=({time:e})=>Object(ve.jsx)(me.Node,{shader:ai.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),ai=me.Shaders.create({node:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),si=52,ci="knights dance",li=({time:e})=>Object(ve.jsx)(me.Node,{shader:fi.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),fi=me.Shaders.create({node:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),ui=53,pi="cross waves",di=({time:e})=>Object(ve.jsx)(me.Node,{shader:hi.node,uniforms:{time:e}}),hi=me.Shaders.create({node:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  */
}`}}),vi=54,mi="chess set",gi=({time:e})=>Object(ve.jsx)(me.Node,{shader:yi.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),yi=me.Shaders.create({node:{frag:me.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  color = vec4(c, 1.0);
}`}}),bi=55,xi="cube d'or",wi=400,_i=0,Ei=20,Si=24,Oi=1,Ri=({time:e})=>Object(ve.jsx)(me.Node,{shader:Ti.node,uniforms:{time:e}}),Ti=me.Shaders.create({node:{frag:me.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  #endif
  color = vec4(c, 1.0);
}`}}),zi=56,Ci="jade forest",Pi=({time:e})=>Object(ve.jsx)(me.Node,{shader:Ii.node,uniforms:{time:e}}),Ii=me.Shaders.create({node:{frag:me.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  color = vec4(c, 1.0);
}`}}),ji=57,Ai="Virus v2",ki=400,Di=0,Li=20,Ni=24,Mi=.8,Ui=({time:e})=>Object(ve.jsx)(me.Node,{shader:Bi.node,uniforms:{time:e}}),Bi=me.Shaders.create({node:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}});var Fi=r("005v"),qi=r.n(Fi);const $i=400,Gi=0,Hi=30,Vi=20,Wi=1,Xi="5M",Ki=58,Yi="Mandelglitch",Qi=[{url:"https://ethblock.art/create/17",text:"Mint on ethblock.art"},{url:"https://ghostmarket.io/asset/pha/ghost/3008841254969814369262311336331954453497120774334547905246474374493804042898/",text:"ghostmarket.io: 400 KCAL"},{url:"https://www.hicetnunc.xyz/objkt/3063",text:"hicetnunc.xyz: Mandelglitch #1 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3068",text:"hicetnunc.xyz: Mandelglitch #2 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3071",text:"hicetnunc.xyz: Mandelglitch #3 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3072",text:"hicetnunc.xyz: Mandelglitch #4 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3073",text:"hicetnunc.xyz: Mandelglitch #5 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3077",text:"hicetnunc.xyz: Mandelglitch #6 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3088",text:"hicetnunc.xyz: Mandelglitch #7 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3574",text:"hicetnunc.xyz: Mandelglitch #8 (5 XTZ)"}];const Zi=e=>e<.5?2*e*e:(4-2*e)*e-1;const Ji=({time:e,n:t,exporting:r})=>{const n=Object(ke.useMemo)((()=>function(e,t=0){const r=e?3:50,n=new qi.a(t);return Array(r).fill(null).map((()=>Array(12).fill(null).map((()=>n.random()))))}(r,t)),[t,r]),o=e/10%n.length,i=Math.floor(o),a=o-i;let[s,c,l,f,u,p,d,h,v,m,g,y]=(b=n[i%n.length],x=n[(i+1)%n.length],w=Zi(a),b.map(((e,t)=>e*(1-w)+x[t]*w)));var b,x,w;return l=Zi(l),Object(ve.jsx)(me.LinearCopy,{children:Object(ve.jsx)(ta,{persistence:r?0:.8,children:Object(ve.jsx)(me.Node,{shader:ea.main,uniforms:{aa:r?2:0,time:e,resolution:me.Uniform.Resolution,travel:s,love:c,dark:l,rot:r?2*Math.PI/Hi:.1,s1:f,s2:u,s3:p,s4:d,s5:h,s6:v,s7:m,s8:g,s9:y}})})})},ea=me.Shaders.create({persistence:{frag:me.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  `}}),ta=({children:e,persistence:t})=>Object(ve.jsx)(me.Node,{shader:ea.persistence,backbuffering:!0,uniforms:{t:e,back:me.Uniform.Backbuffer,persistence:t}}),ra=59,na="Pixels 256",oa="There will be only 256 patterns generated by this single fragment shader.",ia=({time:e,n:t,exporting:r})=>Object(ve.jsx)(aa,{n:t+1+(r?0:Math.floor(e))}),aa=De.a.memo((({n:e})=>{const t=new qi.a(e%256),r=t.random(),n=t.random(),o=t.random(),i=t.random(),a=t.random(),s=t.random();return Object(ve.jsx)(me.Node,{shader:sa.node,uniforms:{s1:r,s2:n,s3:o,s4:i,s5:a,s6:s}})})),sa=me.Shaders.create({node:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),ca=60,la="Bitcoin rainbow",fa=({time:e})=>Object(ve.jsx)(me.Node,{shader:ua.node,uniforms:{time:e}}),ua=me.Shaders.create({node:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),pa=61,da="Binance gradients",ha=1,va=30,ma=["/images/shaders/binance.dist.png"],ga=({time:e})=>Object(ve.jsx)(me.Node,{shader:ya.node,uniforms:{time:e,image:"/images/shaders/binance.dist.png"}}),ya=me.Shaders.create({node:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),ba=62,xa="Overgrowth",wa=20,_a=40,Ea=1,Sa=({generation:e,size:t,n:r})=>Object(ve.jsx)(me.Node,{width:t,height:t,shader:Pa.logic,uniforms:{generation:e,prev:me.Uniform.Backbuffer,size:t,seed:r/100},backbuffering:!0}),Oa=De.a.memo(Sa),Ra=({time:e,generation:t,n:r})=>Object(ve.jsx)(me.Node,{shader:Pa.render,uniforms:{time:e,logic:Object(ve.jsx)(Oa,{generation:t,size:140,n:r})},uniformsOptions:{logic:{interpolation:"nearest"}}}),Ta=De.a.memo(Ra),za=1e3*Math.random(),Ca=({time:e,n:t})=>Object(ve.jsx)(Ta,{n:t+za,time:e,generation:Math.floor(30*e)},t),Pa=me.Shaders.create({logic:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
...
`}});var Ia=r("AJhG");const ja=63,Aa="Relics",ka=400,Da=2,La=4,Na=20,Ma=1,Ua="5M",Ba={colors:[.7,.55,.4],logicSize:80,amp:1,base:2,persistance:.89,delta:.5,seed:0};console.log(Object.keys(Ba).map((e=>String(Ba[e]))).join("_"));const Fa=({g:e,size:t,seed:r,amp:n,base:o,persistance:i,delta:a})=>Object(ve.jsx)(me.Node,{width:t,height:t,shader:Va.logic,uniforms:{amp:n,base:o,g:e,prev:me.Uniform.Backbuffer,size:t,seed:r,persistance:i,delta:a},backbuffering:!0},t),qa=De.a.memo(Fa),$a=({g:e,colors:t,amp:r,base:n,persistance:o,delta:i,logicSize:a,seed:s})=>Object(ve.jsx)(me.Node,{shader:Va.render,uniforms:{colors:t,logic:Object(ve.jsx)(qa,{amp:r,base:n,g:e,size:a,seed:s,persistance:o,delta:i})},uniformsOptions:{logic:{interpolation:"nearest"}}}),Ga=De.a.memo($a),Ha=({time:e})=>{const{colors:t,logicSize:r,amp:n,base:o,persistance:i,delta:a,seed:s}=Object(Ia.b)(Ba);return Object(ve.jsx)(Ga,{amp:n,base:o,g:Math.floor(20*e)%40,colors:t,persistance:i,delta:a,seed:s,logicSize:r})},Va=me.Shaders.create({logic:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform sampler2D prev;
uniform float g;
...
`}}),Wa=64,Xa="Intersection",Ka=8*Math.PI,Ya=[{url:"https://www.hicetnunc.xyz/objkt/28592",text:"hic et nunc NFT"}],Qa=({time:e})=>Object(ve.jsx)(me.Node,{shader:Za.render,uniforms:{resolution:me.Uniform.Resolution,time:e}}),Za=me.Shaders.create({render:{frag:me.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform vec2 resolution;
...
`}}),Ja=65,es="Duality",ts=800,rs=4,ns=8,os=30,is=1,as=3,ss=!0,cs=16,ls=[{url:"https://hicetnunc.xyz/objkt/64326",text:"hic et nunc NFT"}],fs=({time:e})=>Object(ve.jsx)(me.NearestCopy,{children:Object(ve.jsx)(us,{persistence:.3,children:Object(ve.jsx)(me.Node,{shader:ps.render,uniforms:{resolution:me.Uniform.Resolution,time:e}})})}),us=({children:e,persistence:t})=>Object(ve.jsx)(me.Node,{shader:ps.persistence,backbuffering:!0,uniforms:{t:e,back:me.Uniform.Backbuffer,persistence:t}}),ps=me.Shaders.create({persistence:{frag:me.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),ds=66,hs="hicetnunc",vs=800,ms=2,gs=ms+8,ys=30,bs=1,xs=7,ws=!0,_s=16,Es=({time:e})=>Object(ve.jsx)(me.NearestCopy,{children:Object(ve.jsx)(Ss,{persistence:.5,children:Object(ve.jsx)(me.Node,{shader:Os.render,uniforms:{resolution:me.Uniform.Resolution,time:e,freq:2}})})}),Ss=({children:e,persistence:t})=>Object(ve.jsx)(me.Node,{shader:Os.persistence,backbuffering:!0,uniforms:{t:e,back:me.Uniform.Backbuffer,persistence:t}}),Os=me.Shaders.create({persistence:{frag:me.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Rs=(me.Shaders.create({persistence:{frag:me.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;

...
`}}),Nc=72,Mc="Planet Hole",Uc=640,Bc=0,Fc=20,qc=24,$c=1,Gc=!1,Hc=256,Vc=({time:e,n:t})=>{const r=new Xi.a(t),n=.2+3*r.random()*r.random(),o=.2+10*r.random()*r.random(),i=r.random(),a=[i+.2-.5*r.random(),i+.02-.1*r.random(),i-.02+.1*r.random()];return Object(we.jsx)(_e.Node,{shader:Wc.node,uniforms:{resolution:_e.Uniform.Resolution,time:e,a:n,b:o,c:a}})},Wc=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;

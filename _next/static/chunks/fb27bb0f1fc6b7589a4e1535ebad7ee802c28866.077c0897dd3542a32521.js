...
`}}),Ha=64,Va="Intersection",Wa=8*Math.PI,Xa=[{url:"https://www.hicetnunc.xyz/objkt/28592",text:"hic et nunc NFT"}],Ka=({time:e})=>Object(de.jsx)(he.Node,{shader:Ya.render,uniforms:{resolution:he.Uniform.Resolution,time:e}}),Ya=he.Shaders.create({render:{frag:he.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform vec2 resolution;
...
`}}),Qa=(he.Shaders.create({persistence:{frag:he.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),he.Shaders.create({persistence:{frag:he.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;

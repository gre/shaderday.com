...
}`}}).copy;t.default=i},MAJC:function(e,t,r){"use strict";e.exports=function(e){return"undefined"!==typeof e&&null!==e&&("object"===typeof e||"function"===typeof e)}},Ni9w:function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;t.default=class{constructor(){var e,t,r;r=[],(t="_loaders")in(e=this)?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r}add(e){this._loaders.push(e),this._loaders.sort(((e,t)=>("number"===typeof t.priority?t.priority:0)-("number"===typeof e.priority?e.priority:0)))}remove(e){const t=this._loaders.indexOf(e);-1!==t&&this._loaders.splice(t,1)}get(){return this._loaders}}},O8XB:function(e,t,r){"use strict";(function(e,n){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var o,i,a,s,c,l=p(r("tbvF")),f=p(r("Ytbt")),u=p(r("zqV6"));function p(e){return e&&e.__esModule?e:{default:e}}"undefined"===typeof e&&(n.Buffer=(i=o=class{},c=t=>t instanceof e,(s="isBuffer")in(a=o)?Object.defineProperty(a,s,{value:c,enumerable:!0,configurable:!0,writable:!0}):a[s]=c,i));t.default=(e,t,r,n)=>{const o="undefined"!==typeof WebGLRenderingContext&&e instanceof WebGLRenderingContext;let i=r.dtype,a=r.shape.slice(),s=e.getParameter(e.MAX_TEXTURE_SIZE);if(a[0]<0||a[0]>s||a[1]<0||a[1]>s)throw new Error("gl-react: Invalid texture size");let c=function(e,t){return 3===e.length?1===t[2]&&t[1]===e[0]*e[2]&&t[0]===e[2]:1===t[0]&&t[1]===e[0]}(a,r.stride.slice()),p=0;"float32"===i?p=e.FLOAT:"float64"===i?(p=e.FLOAT,c=!1,i="float32"):"uint8"===i?p=e.UNSIGNED_BYTE:(p=e.UNSIGNED_BYTE,c=!1,i="uint8");let d,h=0,v=0;if(2===a.length)v=h=e.LUMINANCE,a=[a[0],a[1],1],r=(0,l.default)(r.data,a,[r.stride[0],r.stride[1],1],r.offset);else{if(3!==a.length)throw new Error("gl-texture2d: Invalid shape for texture");if(1===a[2])v=h=e.ALPHA,o||(n=!1);else if(2===a[2])v=h=e.LUMINANCE_ALPHA,o||(n=!1);else if(3===a[2])h=e.RGB,v=o?e.RGB:e.RGB32F;else{if(4!==a[2])throw new Error("gl-texture2d: Invalid shape for pixel coords");h=e.RGBA,v=o?e.RGBA:e.RGBA32F}}p!==e.FLOAT||n||(p=e.UNSIGNED_BYTE,c=!1);let m,g=r.size;if(c)d=0===r.offset&&r.data.length===g?r.data:r.data.subarray(r.offset,r.offset+g);else{let t=[a[2],a[2]*a[0],1];if("float32"!==i&&"float64"!==i||p!==e.UNSIGNED_BYTE){m=u.default.malloc(g,i);let e=(0,l.default)(m,a,t,0);f.default.assign(e,r)}else{m=u.default.malloc(g,"uint8"),function(e,t){f.default.muls(e,t,255)}((0,l.default)(m,a,t,0),r)}d=m.subarray(0,g)}e.texImage2D(e.TEXTURE_2D,0,v,a[0],a[1],0,h,p,d),m&&u.default.free(m)}}).call(this,r("HDXh").Buffer,r("ntbh"))},OTww:function(e,t,r){"use strict";(function(e){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var n,o=(n=r("Ni9w"))&&n.__esModule?n:{default:n};const i="undefined"===typeof window?e:window,a="__webglTextureLoader_registry";var s=i[a]||(i[a]=new o.default);t.default=s}).call(this,r("ntbh"))},QLaP:function(e,t,r){"use strict";e.exports=function(e,t,r,n,o,i,a,s){if(!e){var c;if(void 0===t)c=new Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else{var l=[r,n,o,i,a,s],f=0;(c=new Error(t.replace(/%s/g,(function(){return l[f++]})))).name="Invariant Violation"}throw c.framesToPop=1,c}}},QM7d:function(e,t,r){"use strict";var n=r("033R");function o(){this.argTypes=[],this.shimArgs=[],this.arrayArgs=[],this.arrayBlockIndices=[],this.scalarArgs=[],this.offsetArgs=[],this.offsetArgIndex=[],this.indexArgs=[],this.shapeArgs=[],this.funcName="",this.pre=null,this.body=null,this.post=null,this.debug=!1}e.exports=function(e){var t=new o;t.pre=e.pre,t.body=e.body,t.post=e.post;var r=e.args.slice(0);t.argTypes=r;for(var i=0;i<r.length;++i){var a=r[i];if("array"===a||"object"===typeof a&&a.blockIndices){if(t.argTypes[i]="array",t.arrayArgs.push(i),t.arrayBlockIndices.push(a.blockIndices?a.blockIndices:0),t.shimArgs.push("array"+i),i<t.pre.args.length&&t.pre.args[i].count>0)throw new Error("cwise: pre() block may not reference array args");if(i<t.post.args.length&&t.post.args[i].count>0)throw new Error("cwise: post() block may not reference array args")}else if("scalar"===a)t.scalarArgs.push(i),t.shimArgs.push("scalar"+i);else if("index"===a){if(t.indexArgs.push(i),i<t.pre.args.length&&t.pre.args[i].count>0)throw new Error("cwise: pre() block may not reference array index");if(i<t.body.args.length&&t.body.args[i].lvalue)throw new Error("cwise: body() block may not write to array index");if(i<t.post.args.length&&t.post.args[i].count>0)throw new Error("cwise: post() block may not reference array index")}else if("shape"===a){if(t.shapeArgs.push(i),i<t.pre.args.length&&t.pre.args[i].lvalue)throw new Error("cwise: pre() block may not write to array shape");if(i<t.body.args.length&&t.body.args[i].lvalue)throw new Error("cwise: body() block may not write to array shape");if(i<t.post.args.length&&t.post.args[i].lvalue)throw new Error("cwise: post() block may not write to array shape")}else{if("object"!==typeof a||!a.offset)throw new Error("cwise: Unknown argument type "+r[i]);t.argTypes[i]="offset",t.offsetArgs.push({array:a.array,offset:a.offset}),t.offsetArgIndex.push(i)}}if(t.arrayArgs.length<=0)throw new Error("cwise: No array arguments specified");if(t.pre.args.length>r.length)throw new Error("cwise: Too many arguments in pre() block");if(t.body.args.length>r.length)throw new Error("cwise: Too many arguments in body() block");if(t.post.args.length>r.length)throw new Error("cwise: Too many arguments in post() block");return t.debug=!!e.printCode||!!e.debug,t.funcName=e.funcName||"cwise",t.blockSize=e.blockSize||64,n(t)}},R9Te:function(e,t,r){"use strict";var n=r("CyWo"),o=r("z08I"),i=r("+0iv"),a=r("vCtr");function s(e){return"__proto__"!==e&&"constructor"!==e&&"prototype"!==e}e.exports=function(e,t,r){if(!a(e))return e;if(Array.isArray(t)&&(t=[].concat.apply([],t).join(".")),"string"!==typeof t)return e;for(var c=n(t,{sep:".",brackets:!0}).filter(s),l=c.length,f=-1,u=e;++f<l;){var p=c[f];f===l-1?i(u[p])&&i(r)?u[p]=o({},u[p],r):u[p]=r:(a(u[p])||(u[p]={}),u=u[p])}return e}},RjOF:function(e,t,r){"use strict";var n,o="";e.exports=function(e,t){if("string"!==typeof e)throw new TypeError("expected a string");if(1===t)return e;if(2===t)return e+e;var r=e.length*t;if(n!==e||"undefined"===typeof n)n=e,o="";else if(o.length>=r)return o.substr(0,r);for(;r>o.length&&t>1;)1&t&&(o+=e),t>>=1,e+=e;return o=(o+=e).substr(0,r)}},Ry8g:function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;t.default=e=>{const t=e.getExtension("WEBGL_lose_context");t&&t.loseContext()}},SMLl:function(e,t,r){"use strict";var n=r("RjOF");e.exports=function(e,t,r){return n(r="undefined"!==typeof r?r+"":" ",t)+e}},TBio:function(e,t,r){"use strict";var n=r("F16p");function o(e,t,r){var n,o,i=e.length,a=t.arrayArgs.length,s=t.indexArgs.length>0,c=[],l=[],f=0,u=0;for(n=0;n<i;++n)l.push(["i",n,"=0"].join(""));for(o=0;o<a;++o)for(n=0;n<i;++n)u=f,f=e[n],0===n?l.push(["d",o,"s",n,"=t",o,"p",f].join("")):l.push(["d",o,"s",n,"=(t",o,"p",f,"-s",u,"*t",o,"p",u,")"].join(""));for(l.length>0&&c.push("var "+l.join(",")),n=i-1;n>=0;--n)f=e[n],c.push(["for(i",n,"=0;i",n,"<s",f,";++i",n,"){"].join(""));for(c.push(r),n=0;n<i;++n){for(u=f,f=e[n],o=0;o<a;++o)c.push(["p",o,"+=d",o,"s",n].join(""));s&&(n>0&&c.push(["index[",u,"]-=s",u].join("")),c.push(["++index[",f,"]"].join(""))),c.push("}")}return c.join("\n")}function i(e,t,r){for(var n=e.body,o=[],i=[],a=0;a<e.args.length;++a){var s=e.args[a];if(!(s.count<=0)){var c=new RegExp(s.name,"g"),l="",f=t.arrayArgs.indexOf(a);switch(t.argTypes[a]){case"offset":var u=t.offsetArgIndex.indexOf(a);f=t.offsetArgs[u].array,l="+q"+u;case"array":l="p"+f+l;var p="l"+a,d="a"+f;if(0===t.arrayBlockIndices[f])1===s.count?"generic"===r[f]?s.lvalue?(o.push(["var ",p,"=",d,".get(",l,")"].join("")),n=n.replace(c,p),i.push([d,".set(",l,",",p,")"].join(""))):n=n.replace(c,[d,".get(",l,")"].join("")):n=n.replace(c,[d,"[",l,"]"].join("")):"generic"===r[f]?(o.push(["var ",p,"=",d,".get(",l,")"].join("")),n=n.replace(c,p),s.lvalue&&i.push([d,".set(",l,",",p,")"].join(""))):(o.push(["var ",p,"=",d,"[",l,"]"].join("")),n=n.replace(c,p),s.lvalue&&i.push([d,"[",l,"]=",p].join("")));else{for(var h=[s.name],v=[l],m=0;m<Math.abs(t.arrayBlockIndices[f]);m++)h.push("\\s*\\[([^\\]]+)\\]"),v.push("$"+(m+1)+"*t"+f+"b"+m);if(c=new RegExp(h.join(""),"g"),l=v.join("+"),"generic"===r[f])throw new Error("cwise: Generic arrays not supported in combination with blocks!");n=n.replace(c,[d,"[",l,"]"].join(""))}break;case"scalar":n=n.replace(c,"Y"+t.scalarArgs.indexOf(a));break;case"index":n=n.replace(c,"index");break;case"shape":n=n.replace(c,"shape")}}}return[o.join("\n"),n,i.join("\n")].join("\n").trim()}function a(e){for(var t=new Array(e.length),r=!0,n=0;n<e.length;++n){var o=e[n],i=o.match(/\d+/);i=i?i[0]:"",0===o.charAt(0)?t[n]="u"+o.charAt(1)+i:t[n]=o.charAt(0)+i,n>0&&(r=r&&t[n]===t[n-1])}return r?t[0]:t.join("")}e.exports=function(e,t){for(var r=t[1].length-Math.abs(e.arrayBlockIndices[0])|0,s=new Array(e.arrayArgs.length),c=new Array(e.arrayArgs.length),l=0;l<e.arrayArgs.length;++l)c[l]=t[2*l],s[l]=t[2*l+1];var f=[],u=[],p=[],d=[],h=[];for(l=0;l<e.arrayArgs.length;++l){e.arrayBlockIndices[l]<0?(p.push(0),d.push(r),f.push(r),u.push(r+e.arrayBlockIndices[l])):(p.push(e.arrayBlockIndices[l]),d.push(e.arrayBlockIndices[l]+r),f.push(0),u.push(e.arrayBlockIndices[l]));for(var v=[],m=0;m<s[l].length;m++)p[l]<=s[l][m]&&s[l][m]<d[l]&&v.push(s[l][m]-p[l]);h.push(v)}var g=["SS"],y=["'use strict'"],b=[];for(m=0;m<r;++m)b.push(["s",m,"=SS[",m,"]"].join(""));for(l=0;l<e.arrayArgs.length;++l){g.push("a"+l),g.push("t"+l),g.push("p"+l);for(m=0;m<r;++m)b.push(["t",l,"p",m,"=t",l,"[",p[l]+m,"]"].join(""));for(m=0;m<Math.abs(e.arrayBlockIndices[l]);++m)b.push(["t",l,"b",m,"=t",l,"[",f[l]+m,"]"].join(""))}for(l=0;l<e.scalarArgs.length;++l)g.push("Y"+l);if(e.shapeArgs.length>0&&b.push("shape=SS.slice(0)"),e.indexArgs.length>0){var x=new Array(r);for(l=0;l<r;++l)x[l]="0";b.push(["index=[",x.join(","),"]"].join(""))}for(l=0;l<e.offsetArgs.length;++l){var w=e.offsetArgs[l],_=[];for(m=0;m<w.offset.length;++m)0!==w.offset[m]&&(1===w.offset[m]?_.push(["t",w.array,"p",m].join("")):_.push([w.offset[m],"*t",w.array,"p",m].join("")));0===_.length?b.push("q"+l+"=0"):b.push(["q",l,"=",_.join("+")].join(""))}var E=n([].concat(e.pre.thisVars).concat(e.body.thisVars).concat(e.post.thisVars));for((b=b.concat(E)).length>0&&y.push("var "+b.join(",")),l=0;l<e.arrayArgs.length;++l)y.push("p"+l+"|=0");e.pre.body.length>3&&y.push(i(e.pre,e,c));var S=i(e.body,e,c),O=function(e){for(var t=0,r=e[0].length;t<r;){for(var n=1;n<e.length;++n)if(e[n][t]!==e[0][t])return t;++t}return t}(h);O<r?y.push(function(e,t,r,n){for(var i=t.length,a=r.arrayArgs.length,s=r.blockSize,c=r.indexArgs.length>0,l=[],f=0;f<a;++f)l.push(["var offset",f,"=p",f].join(""));for(f=e;f<i;++f)l.push(["for(var j"+f+"=SS[",t[f],"]|0;j",f,">0;){"].join("")),l.push(["if(j",f,"<",s,"){"].join("")),l.push(["s",t[f],"=j",f].join("")),l.push(["j",f,"=0"].join("")),l.push(["}else{s",t[f],"=",s].join("")),l.push(["j",f,"-=",s,"}"].join("")),c&&l.push(["index[",t[f],"]=j",f].join(""));for(f=0;f<a;++f){for(var u=["offset"+f],p=e;p<i;++p)u.push(["j",p,"*t",f,"p",t[p]].join(""));l.push(["p",f,"=(",u.join("+"),")"].join(""))}for(l.push(o(t,r,n)),f=e;f<i;++f)l.push("}");return l.join("\n")}(O,h[0],e,S)):y.push(o(h[0],e,S)),e.post.body.length>3&&y.push(i(e.post,e,c)),e.debug&&console.log("-----Generated cwise routine for ",t,":\n"+y.join("\n")+"\n----------");var R=[e.funcName||"unnamed","_cwise_loop_",s[0].join("s"),"m",O,a(c)].join("");return new Function(["function ",R,"(",g.join(","),"){",y.join("\n"),"} return ",R].join(""))()}},TGEO:function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),Object.defineProperty(t,"WebGLTextureLoader",{enumerable:!0,get:function(){return n.default}}),Object.defineProperty(t,"WebGLTextureLoaderAsyncHashCache",{enumerable:!0,get:function(){return o.default}}),Object.defineProperty(t,"WebGLTextureLoaderSyncHashCache",{enumerable:!0,get:function(){return i.default}}),Object.defineProperty(t,"LoadersRegistry",{enumerable:!0,get:function(){return a.default}}),Object.defineProperty(t,"LoaderResolver",{enumerable:!0,get:function(){return s.default}}),Object.defineProperty(t,"globalRegistry",{enumerable:!0,get:function(){return c.default}});var n=l(r("HbIt")),o=l(r("cDsr")),i=l(r("VYxY")),a=l(r("Ni9w")),s=l(r("LhdL")),c=l(r("OTww"));function l(e){return e&&e.__esModule?e:{default:e}}},TKux:function(e,t,r){"use strict";r.d(t,"b",(function(){return Nc})),r.d(t,"c",(function(){return Mc})),r.d(t,"a",(function(){return Uc}));var n={};r.r(n),r.d(n,"n",(function(){return _e})),r.d(n,"title",(function(){return Ee})),r.d(n,"Shader",(function(){return Se}));var o={};r.r(o),r.d(o,"n",(function(){return Re})),r.d(o,"title",(function(){return Te})),r.d(o,"exportSize",(function(){return ze})),r.d(o,"exportStart",(function(){return Pe})),r.d(o,"exportEnd",(function(){return Ce})),r.d(o,"exportFramePerSecond",(function(){return Ie})),r.d(o,"exportSpeed",(function(){return je})),r.d(o,"Shader",(function(){return Ae}));var i={};r.r(i),r.d(i,"n",(function(){return De})),r.d(i,"title",(function(){return Le})),r.d(i,"Shader",(function(){return Ne}));var a={};r.r(a),r.d(a,"n",(function(){return $e})),r.d(a,"title",(function(){return Ge})),r.d(a,"Shader",(function(){return Ve}));var s={};r.r(s),r.d(s,"n",(function(){return Ke})),r.d(s,"title",(function(){return Ye})),r.d(s,"Shader",(function(){return Qe}));var c={};r.r(c),r.d(c,"n",(function(){return Je})),r.d(c,"title",(function(){return et})),r.d(c,"Shader",(function(){return tt}));var l={};r.r(l),r.d(l,"n",(function(){return nt})),r.d(l,"title",(function(){return ot})),r.d(l,"Shader",(function(){return it}));var f={};r.r(f),r.d(f,"n",(function(){return st})),r.d(f,"title",(function(){return ct})),r.d(f,"Shader",(function(){return lt}));var u={};r.r(u),r.d(u,"n",(function(){return ut})),r.d(u,"title",(function(){return pt})),r.d(u,"exportSize",(function(){return dt})),r.d(u,"exportStart",(function(){return ht})),r.d(u,"exportEnd",(function(){return vt})),r.d(u,"exportFramePerSecond",(function(){return mt})),r.d(u,"exportSpeed",(function(){return gt})),r.d(u,"Shader",(function(){return yt}));var p={};r.r(p),r.d(p,"n",(function(){return xt})),r.d(p,"title",(function(){return wt})),r.d(p,"Shader",(function(){return _t}));var d={};r.r(d),r.d(d,"n",(function(){return St})),r.d(d,"title",(function(){return Ot})),r.d(d,"Shader",(function(){return Rt}));var h={};r.r(h),r.d(h,"n",(function(){return zt})),r.d(h,"title",(function(){return Pt})),r.d(h,"Shader",(function(){return Ct}));var v={};r.r(v),r.d(v,"n",(function(){return jt})),r.d(v,"title",(function(){return At})),r.d(v,"Shader",(function(){return kt}));var m={};r.r(m),r.d(m,"n",(function(){return Lt})),r.d(m,"title",(function(){return Nt})),r.d(m,"Shader",(function(){return Mt}));var g={};r.r(g),r.d(g,"n",(function(){return Kt})),r.d(g,"title",(function(){return Yt})),r.d(g,"Shader",(function(){return Qt}));var y={};r.r(y),r.d(y,"n",(function(){return tr})),r.d(y,"title",(function(){return rr})),r.d(y,"Shader",(function(){return nr}));var b={};r.r(b),r.d(b,"n",(function(){return ir})),r.d(b,"title",(function(){return ar})),r.d(b,"Shader",(function(){return sr}));var x={};r.r(x),r.d(x,"n",(function(){return lr})),r.d(x,"title",(function(){return fr})),r.d(x,"Shader",(function(){return ur}));var w={};r.r(w),r.d(w,"n",(function(){return dr})),r.d(w,"title",(function(){return hr})),r.d(w,"Shader",(function(){return vr}));var _={};r.r(_),r.d(_,"n",(function(){return gr})),r.d(_,"title",(function(){return yr})),r.d(_,"Shader",(function(){return br}));var E={};r.r(E),r.d(E,"n",(function(){return _r})),r.d(E,"title",(function(){return Er})),r.d(E,"Shader",(function(){return Sr}));var S={};r.r(S),r.d(S,"n",(function(){return Tr})),r.d(S,"title",(function(){return zr})),r.d(S,"Shader",(function(){return Pr}));var O={};r.r(O),r.d(O,"n",(function(){return Ir})),r.d(O,"title",(function(){return jr})),r.d(O,"Shader",(function(){return Ar}));var R={};r.r(R),r.d(R,"n",(function(){return Dr})),r.d(R,"title",(function(){return Lr})),r.d(R,"Shader",(function(){return Nr}));var T={};r.r(T),r.d(T,"n",(function(){return Ur})),r.d(T,"title",(function(){return Br})),r.d(T,"Shader",(function(){return Fr}));var z={};r.r(z),r.d(z,"n",(function(){return Gr})),r.d(z,"title",(function(){return Hr})),r.d(z,"Shader",(function(){return Vr}));var P={};r.r(P),r.d(P,"n",(function(){return Kr})),r.d(P,"title",(function(){return Yr})),r.d(P,"exportSize",(function(){return Qr})),r.d(P,"exportStart",(function(){return Zr})),r.d(P,"exportEnd",(function(){return Jr})),r.d(P,"exportFramePerSecond",(function(){return en})),r.d(P,"exportSpeed",(function(){return tn})),r.d(P,"Shader",(function(){return rn}));var C={};r.r(C),r.d(C,"n",(function(){return an})),r.d(C,"title",(function(){return sn})),r.d(C,"Shader",(function(){return cn}));var I={};r.r(I),r.d(I,"n",(function(){return un})),r.d(I,"title",(function(){return pn})),r.d(I,"Shader",(function(){return dn}));var j={};r.r(j),r.d(j,"n",(function(){return vn})),r.d(j,"title",(function(){return mn})),r.d(j,"Shader",(function(){return gn}));var A={};r.r(A),r.d(A,"n",(function(){return bn})),r.d(A,"title",(function(){return xn})),r.d(A,"Shader",(function(){return wn}));var k={};r.r(k),r.d(k,"n",(function(){return En})),r.d(k,"title",(function(){return Sn})),r.d(k,"Shader",(function(){return Rn}));var D={};r.r(D),r.d(D,"n",(function(){return zn})),r.d(D,"title",(function(){return Pn})),r.d(D,"Shader",(function(){return Cn}));var L={};r.r(L),r.d(L,"n",(function(){return jn})),r.d(L,"title",(function(){return An})),r.d(L,"Shader",(function(){return kn}));var N={};r.r(N),r.d(N,"n",(function(){return Ln})),r.d(N,"title",(function(){return Nn})),r.d(N,"Shader",(function(){return Mn}));var M={};r.r(M),r.d(M,"n",(function(){return Fn})),r.d(M,"title",(function(){return qn})),r.d(M,"Shader",(function(){return $n}));var U={};r.r(U),r.d(U,"n",(function(){return Vn})),r.d(U,"title",(function(){return Wn})),r.d(U,"Shader",(function(){return Xn}));var B={};r.r(B),r.d(B,"n",(function(){return Yn})),r.d(B,"title",(function(){return Qn})),r.d(B,"Shader",(function(){return Zn}));var F={};r.r(F),r.d(F,"n",(function(){return to})),r.d(F,"title",(function(){return ro})),r.d(F,"Shader",(function(){return no}));var q={};r.r(q),r.d(q,"n",(function(){return io})),r.d(q,"title",(function(){return ao})),r.d(q,"Shader",(function(){return so}));var $={};r.r($),r.d($,"n",(function(){return lo})),r.d($,"title",(function(){return fo})),r.d($,"Shader",(function(){return uo}));var G={};r.r(G),r.d(G,"n",(function(){return ho})),r.d(G,"title",(function(){return vo})),r.d(G,"Shader",(function(){return mo}));var H={};r.r(H),r.d(H,"n",(function(){return yo})),r.d(H,"title",(function(){return bo})),r.d(H,"Shader",(function(){return xo}));var V={};r.r(V),r.d(V,"n",(function(){return Eo})),r.d(V,"title",(function(){return So})),r.d(V,"Shader",(function(){return Oo}));var W={};r.r(W),r.d(W,"n",(function(){return To})),r.d(W,"title",(function(){return zo})),r.d(W,"Shader",(function(){return Po}));var X={};r.r(X),r.d(X,"n",(function(){return Io})),r.d(X,"title",(function(){return jo})),r.d(X,"Shader",(function(){return Ao}));var K={};r.r(K),r.d(K,"n",(function(){return Do})),r.d(K,"title",(function(){return Lo})),r.d(K,"Shader",(function(){return No}));var Y={};r.r(Y),r.d(Y,"n",(function(){return Uo})),r.d(Y,"title",(function(){return Bo})),r.d(Y,"Shader",(function(){return Fo}));var Q={};r.r(Q),r.d(Q,"n",(function(){return $o})),r.d(Q,"title",(function(){return Go})),r.d(Q,"exportSize",(function(){return Ho})),r.d(Q,"exportStart",(function(){return Vo})),r.d(Q,"exportEnd",(function(){return Wo})),r.d(Q,"exportFramePerSecond",(function(){return Xo})),r.d(Q,"exportSpeed",(function(){return Ko})),r.d(Q,"Shader",(function(){return Yo}));var Z={};r.r(Z),r.d(Z,"n",(function(){return Jo})),r.d(Z,"title",(function(){return ei})),r.d(Z,"Shader",(function(){return ti}));var J={};r.r(J),r.d(J,"n",(function(){return ni})),r.d(J,"title",(function(){return oi})),r.d(J,"exportSize",(function(){return ii})),r.d(J,"exportStart",(function(){return ai})),r.d(J,"exportEnd",(function(){return si})),r.d(J,"exportFramePerSecond",(function(){return ci})),r.d(J,"exportSpeed",(function(){return li})),r.d(J,"Shader",(function(){return fi}));var ee={};r.r(ee),r.d(ee,"n",(function(){return pi})),r.d(ee,"title",(function(){return di})),r.d(ee,"Shader",(function(){return hi}));var te={};r.r(te),r.d(te,"n",(function(){return mi})),r.d(te,"title",(function(){return gi})),r.d(te,"Shader",(function(){return yi}));var re={};r.r(re),r.d(re,"n",(function(){return xi})),r.d(re,"title",(function(){return wi})),r.d(re,"Shader",(function(){return _i}));var ne={};r.r(ne),r.d(ne,"n",(function(){return Si})),r.d(ne,"title",(function(){return Oi})),r.d(ne,"exportSize",(function(){return Ri})),r.d(ne,"exportStart",(function(){return Ti})),r.d(ne,"exportEnd",(function(){return zi})),r.d(ne,"exportFramePerSecond",(function(){return Pi})),r.d(ne,"exportSpeed",(function(){return Ci})),r.d(ne,"Shader",(function(){return Ii}));var oe={};r.r(oe),r.d(oe,"n",(function(){return Ai})),r.d(oe,"title",(function(){return ki})),r.d(oe,"Shader",(function(){return Di}));var ie={};r.r(ie),r.d(ie,"n",(function(){return Ni})),r.d(ie,"title",(function(){return Mi})),r.d(ie,"exportSize",(function(){return Ui})),r.d(ie,"exportStart",(function(){return Bi})),r.d(ie,"exportEnd",(function(){return Fi})),r.d(ie,"exportFramePerSecond",(function(){return qi})),r.d(ie,"exportSpeed",(function(){return $i})),r.d(ie,"Shader",(function(){return Gi}));var ae={};r.r(ae),r.d(ae,"exportSize",(function(){return Xi})),r.d(ae,"exportStart",(function(){return Ki})),r.d(ae,"exportEnd",(function(){return Yi})),r.d(ae,"exportFramePerSecond",(function(){return Qi})),r.d(ae,"exportSpeed",(function(){return Zi})),r.d(ae,"exportMP4vb",(function(){return Ji})),r.d(ae,"n",(function(){return ea})),r.d(ae,"title",(function(){return ta})),r.d(ae,"nfts",(function(){return ra})),r.d(ae,"Shader",(function(){return oa}));var se={};r.r(se),r.d(se,"n",(function(){return sa})),r.d(se,"title",(function(){return ca})),r.d(se,"description",(function(){return la})),r.d(se,"Shader",(function(){return fa}));var ce={};r.r(ce),r.d(ce,"n",(function(){return da})),r.d(ce,"title",(function(){return ha})),r.d(ce,"Shader",(function(){return va}));var le={};r.r(le),r.d(le,"n",(function(){return ga})),r.d(le,"title",(function(){return ya})),r.d(le,"exportEnd",(function(){return ba})),r.d(le,"exportFramePerSecond",(function(){return xa})),r.d(le,"preload",(function(){return wa})),r.d(le,"Shader",(function(){return _a}));var fe={};r.r(fe),r.d(fe,"n",(function(){return Sa})),r.d(fe,"title",(function(){return Oa})),r.d(fe,"exportEnd",(function(){return Ra})),r.d(fe,"exportFramePerSecond",(function(){return Ta})),r.d(fe,"exportSpeed",(function(){return za})),r.d(fe,"Logic",(function(){return Pa})),r.d(fe,"Shader",(function(){return ka}));var ue={};r.r(ue),r.d(ue,"n",(function(){return Na})),r.d(ue,"title",(function(){return Ma})),r.d(ue,"exportSize",(function(){return Ua})),r.d(ue,"exportStart",(function(){return Ba})),r.d(ue,"exportEnd",(function(){return Fa})),r.d(ue,"exportFramePerSecond",(function(){return qa})),r.d(ue,"exportSpeed",(function(){return $a})),r.d(ue,"exportMP4vb",(function(){return Ga})),r.d(ue,"Logic",(function(){return Va})),r.d(ue,"Shader",(function(){return Ya}));var pe={};r.r(pe),r.d(pe,"n",(function(){return Za})),r.d(pe,"title",(function(){return Ja})),r.d(pe,"exportEnd",(function(){return es})),r.d(pe,"nfts",(function(){return ts})),r.d(pe,"Shader",(function(){return rs}));var de={};r.r(de),r.d(de,"n",(function(){return os})),r.d(de,"title",(function(){return is})),r.d(de,"exportSize",(function(){return as})),r.d(de,"exportStart",(function(){return ss})),r.d(de,"exportEnd",(function(){return cs})),r.d(de,"exportFramePerSecond",(function(){return ls})),r.d(de,"exportSpeed",(function(){return fs})),r.d(de,"exportSkipFrame",(function(){return us})),r.d(de,"exportPaletteGenOnce",(function(){return ps})),r.d(de,"exportPaletteSize",(function(){return ds})),r.d(de,"nfts",(function(){return hs})),r.d(de,"Shader",(function(){return vs}));var he={};r.r(he),r.d(he,"n",(function(){return ys})),r.d(he,"title",(function(){return bs})),r.d(he,"exportSize",(function(){return xs})),r.d(he,"exportStart",(function(){return ws})),r.d(he,"exportEnd",(function(){return _s})),r.d(he,"exportFramePerSecond",(function(){return Es})),r.d(he,"exportSpeed",(function(){return Ss})),r.d(he,"exportSkipFrame",(function(){return Os})),r.d(he,"exportPaletteGenOnce",(function(){return Rs})),r.d(he,"exportPaletteSize",(function(){return Ts})),r.d(he,"Shader",(function(){return zs}));var ve={};r.r(ve),r.d(ve,"n",(function(){return Is})),r.d(ve,"title",(function(){return js})),r.d(ve,"exportSize",(function(){return As})),r.d(ve,"exportStart",(function(){return ks})),r.d(ve,"exportEnd",(function(){return Ds})),r.d(ve,"exportFramePerSecond",(function(){return Ls})),r.d(ve,"exportSpeed",(function(){return Ns})),r.d(ve,"exportSkipFrame",(function(){return Ms})),r.d(ve,"exportPaletteGenOnce",(function(){return Us})),r.d(ve,"exportPaletteSize",(function(){return Bs})),r.d(ve,"Shader",(function(){return Fs}));var me={};r.r(me),r.d(me,"n",(function(){return Gs})),r.d(me,"title",(function(){return Hs})),r.d(me,"exportSize",(function(){return Vs})),r.d(me,"exportStart",(function(){return Ws})),r.d(me,"exportEnd",(function(){return Xs})),r.d(me,"exportFramePerSecond",(function(){return Ks})),r.d(me,"exportSpeed",(function(){return Ys})),r.d(me,"exportSkipFrame",(function(){return Qs})),r.d(me,"exportPaletteGenOnce",(function(){return Zs})),r.d(me,"exportPaletteSize",(function(){return Js})),r.d(me,"Shader",(function(){return ec}));var ge={};r.r(ge),r.d(ge,"n",(function(){return nc})),r.d(ge,"title",(function(){return oc})),r.d(ge,"exportSize",(function(){return ic})),r.d(ge,"exportStart",(function(){return ac})),r.d(ge,"exportEnd",(function(){return sc})),r.d(ge,"exportFramePerSecond",(function(){return cc})),r.d(ge,"exportSpeed",(function(){return lc})),r.d(ge,"exportPaletteGenOnce",(function(){return fc})),r.d(ge,"exportPaletteSize",(function(){return uc})),r.d(ge,"Shader",(function(){return pc}));var ye={};r.r(ye),r.d(ye,"n",(function(){return hc})),r.d(ye,"title",(function(){return vc})),r.d(ye,"exportSize",(function(){return mc})),r.d(ye,"exportStart",(function(){return gc})),r.d(ye,"exportEnd",(function(){return yc})),r.d(ye,"exportFramePerSecond",(function(){return bc})),r.d(ye,"exportSpeed",(function(){return xc})),r.d(ye,"exportPaletteGenOnce",(function(){return wc})),r.d(ye,"exportPaletteSize",(function(){return _c})),r.d(ye,"Shader",(function(){return Ec}));var be={};r.r(be),r.d(be,"n",(function(){return Oc})),r.d(be,"title",(function(){return Rc})),r.d(be,"exportSize",(function(){return Tc})),r.d(be,"exportStart",(function(){return zc})),r.d(be,"exportEnd",(function(){return Pc})),r.d(be,"exportFramePerSecond",(function(){return Cc})),r.d(be,"exportSpeed",(function(){return Ic})),r.d(be,"exportPaletteGenOnce",(function(){return jc})),r.d(be,"exportPaletteSize",(function(){return Ac})),r.d(be,"Shader",(function(){return kc}));var xe=r("nKUr"),we=r("rr/c");const _e=1,Ee="Hello 2020",Se=({time:e})=>Object(xe.jsx)(we.Node,{shader:Oe.day001,uniforms:{time:e}}),Oe=we.Shaders.create({day001:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
float vingt (vec2 p) {
...
}`}}),Re=2,Te="stripes",ze=400,Pe=0,Ce=60,Ie=24,je=1,Ae=({time:e})=>Object(xe.jsx)(we.Node,{shader:ke.node,uniforms:{time:e}}),ke=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),De=3,Le="zephyr",Ne=({time:e})=>Object(xe.jsx)(we.Node,{shader:Me.node,uniforms:{time:e}}),Me=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}});var Ue=r("q1tI"),Be=r.n(Ue);const Fe=we.Shaders.create({InitGameOfLife:{frag:we.GLSL`
  precision highp float;
  uniform float seed;
  // i
  varying vec2 uv;
  ...
  }`}}),qe=Be.a.memo((({tick:e,size:t,refreshEveryTicks:r})=>e%(r||1/0)===0?Object(xe.jsx)(we.Node,{shader:Fe.InitGameOfLife,uniforms:{seed:Math.random()},width:t,height:t,backbuffering:!0,sync:!0}):Object(xe.jsx)(we.Node,{shader:Fe.GameOfLife,width:t,height:t,backbuffering:!0,sync:!0,uniforms:{t:we.Uniform.Backbuffer,size:t}}))),$e=4,Ge="Ray of Life";let He;const Ve=({time:e})=>{He||(He=e);const t=e-He,r=Math.floor(10*t),n=r+25,o=10*(1+Math.floor(r/50)),i=10*(1+Math.floor(n/50));return Object(xe.jsx)(We,{time:e,a:Object(xe.jsx)(we.NearestCopy,{children:Object(xe.jsx)(qe,{refreshEveryTicks:50,tick:r,size:o})}),b:Object(xe.jsx)(we.NearestCopy,{children:Object(xe.jsx)(qe,{refreshEveryTicks:50,tick:n,size:i})})})},We=({a:e,b:t,time:r})=>Object(xe.jsx)(we.Node,{uniforms:{a:e,b:t,time:r},shader:Xe.main}),Xe=we.Shaders.create({main:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Ke=5,Ye="Here We Go Again",Qe=({time:e})=>Object(xe.jsx)(we.Node,{shader:Ze.node,uniforms:{time:e}}),Ze=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    sqrt(vec3(1. - shad));
  gl_FragColor = vec4(c,1.0);
}`}}),Je=6,et="Bestagons",tt=({time:e})=>Object(xe.jsx)(we.Node,{shader:rt.node,uniforms:{time:e}}),rt=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),nt=7,ot="Worms party",it=({time:e})=>Object(xe.jsx)(we.Node,{shader:at.node,uniforms:{time:e}}),at=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    sqrt(vec3(1. - shad));
  gl_FragColor = vec4(c,1.0);
}`}}),st=8,ct="moontains",lt=({time:e})=>Object(xe.jsx)(we.Node,{shader:ft.node,uniforms:{time:e}}),ft=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),ut=9,pt="Virus",dt=400,ht=16.3,vt=26,mt=24,gt=.8,yt=({time:e})=>Object(xe.jsx)(we.Node,{shader:bt.node,uniforms:{time:e}}),bt=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),xt=10,wt="ring",_t=({time:e})=>Object(xe.jsx)(we.Node,{shader:Et.node,uniforms:{time:e}}),Et=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),St=11,Ot="magic mouse",Rt=({time:e})=>Object(xe.jsx)(we.Node,{shader:Tt.node,uniforms:{time:e}}),Tt=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),zt=12,Pt="floor is lava",Ct=({time:e})=>Object(xe.jsx)(we.Node,{shader:It.node,uniforms:{time:e}}),It=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),jt=13,At="chip",kt=({time:e})=>Object(xe.jsx)(we.Node,{shader:Dt.node,uniforms:{time:e}}),Dt=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
`}}),Lt=14,Nt="seizure",Mt=({time:e})=>Object(xe.jsx)(we.Node,{shader:Ut.node,uniforms:{time:e}}),Ut=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Bt=we.Shaders.create({blur1D:{frag:we.GLSL`precision highp float;
varying vec2 uv;
uniform sampler2D t;
...
}`}});var Ft=({width:e,height:t,pixelRatio:r,direction:n,children:o})=>Object(xe.jsx)(we.Node,{shader:Bt.blur1D,width:e,height:t,pixelRatio:r,uniforms:{direction:n,resolution:we.Uniform.Resolution,t:o}});const qt=Math.sqrt(2)/2;var $t=(e,t,r)=>{const n=2*t*Math.ceil(e/2)/r;switch((e-1)%4){case 0:return[n,0];case 1:return[0,n];case 2:return[n*qt,n*qt];case 3:return[n*qt,-n*qt]}};const Gt=({width:e,height:t,pixelRatio:r,factor:n,children:o,passes:i,directionForPass:a})=>{const s=c=>c<=0?o:Object(xe.jsx)(Ft,{width:e,height:t,pixelRatio:r,direction:a(c,n,i),children:s(c-1)});return s(i)};Gt.defaultProps={passes:2,directionForPass:$t};var Ht=Gt;const Vt=we.Shaders.create({blur1D:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
...
}`}});var Wt=({width:e,height:t,map:r,pixelRatio:n,direction:o,children:i})=>Object(xe.jsx)(we.Node,{shader:Vt.blur1D,width:e,height:t,pixelRatio:n,uniforms:{direction:o,resolution:we.Uniform.Resolution,t:i,map:r}});const Xt=({width:e,height:t,map:r,pixelRatio:n,factor:o,children:i,passes:a,directionForPass:s})=>{const c=l=>l<=0?i:Object(xe.jsx)(Wt,{width:e,height:t,map:r,pixelRatio:n,direction:s(l,o,a),children:c(l-1)});return c(a)};Xt.defaultProps={passes:2,directionForPass:$t};const Kt=15,Yt="parametric",Qt=({time:e})=>Object(xe.jsx)(we.LinearCopy,{children:Object(xe.jsx)(Jt,{persistence:.98+.02*Math.cos(e)+-.8*Math.exp(-e),children:Object(xe.jsx)(Ht,{passes:4,factor:.2,children:Object(xe.jsx)(Zt,{time:e})})})}),Zt=({time:e})=>Object(xe.jsx)(we.Node,{shader:er.node,uniforms:{time:e}}),Jt=({children:e,persistence:t})=>Object(xe.jsx)(we.Node,{shader:er.persistence,backbuffering:!0,uniforms:{t:e,back:we.Uniform.Backbuffer,persistence:t}}),er=we.Shaders.create({persistence:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),tr=16,rr="reuleaux",nr=({time:e})=>Object(xe.jsx)(we.Node,{shader:or.node,uniforms:{time:e}}),or=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    color(0.5 * time);
  gl_FragColor = vec4(c, 1.0);
}`}}),ir=17,ar="screws",sr=({time:e})=>Object(xe.jsx)(we.Node,{shader:cr.node,uniforms:{time:e}}),cr=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),lr=18,fr="queen",ur=({time:e})=>Object(xe.jsx)(we.Node,{shader:pr.node,uniforms:{time:e}}),pr=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
}`}}),dr=19,hr="they were six",vr=({time:e})=>Object(xe.jsx)(we.Node,{shader:mr.node,uniforms:{time:e}}),mr=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),gr=20,yr="trippy tiles",br=({time:e})=>Object(xe.jsx)(we.LinearCopy,{children:Object(xe.jsx)(xr,{persistence:.85,children:Object(xe.jsx)(we.Node,{shader:wr.node,uniforms:{time:e}})})}),xr=({children:e,persistence:t})=>Object(xe.jsx)(we.Node,{shader:wr.persistence,backbuffering:!0,uniforms:{t:e,back:we.Uniform.Backbuffer,persistence:t}}),wr=we.Shaders.create({persistence:{frag:we.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),_r=21,Er="HODL",Sr=({time:e})=>Object(xe.jsx)(we.LinearCopy,{children:Object(xe.jsx)(Or,{persistence:Math.min(.99,.015*e),time:e,children:Object(xe.jsx)(we.Node,{shader:Rr.node,uniforms:{time:e}})})}),Or=({children:e,persistence:t,time:r})=>Object(xe.jsx)(we.Node,{shader:Rr.shakePersistence,backbuffering:!0,uniforms:{t:e,back:we.Uniform.Backbuffer,persistence:t,time:r}}),Rr=we.Shaders.create({shakePersistence:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform sampler2D t, back;
uniform float time;
...
}`}}),Tr=22,zr="atoms",Pr=({time:e})=>Object(xe.jsx)(we.Node,{shader:Cr.node,uniforms:{time:e,t:"/images/einstein-tongue-out.jpg"}}),Cr=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D t;
...
void main() {
...
}`}}),Ir=23,jr="Hexacubes",Ar=({time:e})=>Object(xe.jsx)(we.Node,{shader:kr.node,uniforms:{time:e}}),kr=we.Shaders.create({node:{frag:we.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform float time;
  const float PI = ${Math.PI};
  ...
  void main() {
    ...
    gl_FragColor = vec4(c, 1.0);
      ...
      `}}),Dr=24,Lr="dark cubes",Nr=({time:e})=>Object(xe.jsx)(we.Node,{shader:Mr.node,uniforms:{time:e}}),Mr=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),Ur=25,Br="Mandelbrot",Fr=({time:e})=>Object(xe.jsx)(we.LinearCopy,{children:Object(xe.jsx)(qr,{persistence:.9,children:Object(xe.jsx)(Ht,{passes:4,factor:.1,children:Object(xe.jsx)(we.Node,{shader:$r.node,uniforms:{time:e}})})})}),qr=({children:e,persistence:t})=>Object(xe.jsx)(we.Node,{shader:$r.persistence,backbuffering:!0,uniforms:{t:e,back:we.Uniform.Backbuffer,persistence:t}}),$r=we.Shaders.create({persistence:{frag:we.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Gr=26,Hr="fumes",Vr=({time:e})=>Object(xe.jsx)(we.LinearCopy,{children:Object(xe.jsx)(Wr,{persistence:.9,children:Object(xe.jsx)(Ht,{passes:4,factor:Math.min(.6,.01*e),children:Object(xe.jsx)(we.Node,{shader:Xr.node,uniforms:{time:e}})})})}),Wr=({children:e,persistence:t})=>Object(xe.jsx)(we.Node,{shader:Xr.persistence,backbuffering:!0,uniforms:{t:e,back:we.Uniform.Backbuffer,persistence:t}}),Xr=we.Shaders.create({persistence:{frag:we.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Kr=27,Yr="real burning ship",Qr=400,Zr=0,Jr=60,en=12,tn=2,rn=({time:e})=>Object(xe.jsx)(we.LinearCopy,{children:Object(xe.jsx)(nn,{persistence:.8+.05*Math.random(),time:e,children:Object(xe.jsx)(we.Node,{shader:on.node,uniforms:{time:e}})})}),nn=({children:e,persistence:t,time:r})=>Object(xe.jsx)(we.Node,{shader:on.persistence,backbuffering:!0,uniforms:{t:e,back:we.Uniform.Backbuffer,persistence:t,time:r}}),on=we.Shaders.create({persistence:{frag:we.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),an=28,sn="No, I'M Batman",cn=({time:e})=>Object(xe.jsx)(we.LinearCopy,{children:Object(xe.jsx)(ln,{persistence:.5+.48*Math.min(1,e/60),children:Object(xe.jsx)(we.Node,{shader:fn.node,uniforms:{time:e}})})}),ln=({children:e,persistence:t})=>Object(xe.jsx)(we.Node,{shader:fn.persistence,backbuffering:!0,uniforms:{t:e,back:we.Uniform.Backbuffer,persistence:t}}),fn=we.Shaders.create({persistence:{frag:we.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),un=29,pn="sdBitcoin(p)",dn=({time:e})=>Object(xe.jsx)(we.Node,{shader:hn.node,uniforms:{time:e}}),hn=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),vn=30,mn="21 millions",gn=({time:e})=>Object(xe.jsx)(we.Node,{shader:yn.node,uniforms:{time:e,numberInCirculation:18557031}}),yn=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),bn=31,xn="alien tower",wn=({time:e})=>Object(xe.jsx)(we.Node,{shader:_n.node,uniforms:{time:e,numberInCirculation:18557031}}),_n=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform float numberInCirculation;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),En=32,Sn="GoL valley";let On;const Rn=({time:e})=>{On||(On=e);const t=e-On,r=Math.floor(12*t);return Object(xe.jsx)(we.Node,{shader:Tn.node,uniforms:{time:e,t:Object(xe.jsx)(qe,{refreshEveryTicks:100,tick:r,size:100})}})},Tn=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D t;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),zn=33,Pn="x(x+32y)%(tN+1)%n";const Cn=({time:e})=>Object(xe.jsx)(we.Node,{shader:In.node,uniforms:{time:e}}),In=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),jn=34,An="\u230a2cos(x)sin(y+t)\u230b%7";const kn=({time:e})=>Object(xe.jsx)(we.Node,{shader:Dn.node,uniforms:{time:e}}),Dn=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
#define PI ${Math.PI}
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Ln=35,Nn="aie confiance",Mn=({time:e})=>Object(xe.jsx)(we.LinearCopy,{children:Object(xe.jsx)(Un,{persistence:.6,children:Object(xe.jsx)(we.Node,{shader:Bn.node,uniforms:{time:e}})})}),Un=({children:e,persistence:t})=>Object(xe.jsx)(we.Node,{shader:Bn.persistence,backbuffering:!0,uniforms:{t:e,back:we.Uniform.Backbuffer,persistence:t}}),Bn=we.Shaders.create({persistence:{frag:we.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Fn=36,qn="crois en moi",$n=({time:e})=>Object(xe.jsx)(we.LinearCopy,{children:Object(xe.jsx)(Gn,{children:Object(xe.jsx)(we.Node,{shader:Hn.node,uniforms:{time:e}})})}),Gn=({children:e,persistence:t})=>Object(xe.jsx)(we.Node,{shader:Hn.persistence,backbuffering:!0,uniforms:{t:e,back:we.Uniform.Backbuffer,persistence:t}}),Hn=we.Shaders.create({persistence:{frag:we.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Vn=37,Wn="sdBrick",Xn=({time:e})=>Object(xe.jsx)(we.Node,{shader:Kn.node,uniforms:{time:e}}),Kn=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Yn=38,Qn="Golden mandelbulb",Zn=({time:e})=>Object(xe.jsx)(we.LinearCopy,{children:Object(xe.jsx)(Jn,{persistence:.5,children:Object(xe.jsx)(we.Node,{shader:eo.node,uniforms:{time:e}})})}),Jn=({children:e,persistence:t})=>Object(xe.jsx)(we.Node,{shader:eo.persistence,backbuffering:!0,uniforms:{t:e,back:we.Uniform.Backbuffer,persistence:t}}),eo=we.Shaders.create({persistence:{frag:we.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  clr /= 4.;
  gl_FragColor = vec4(clr, 1.0);
}`}}),to=39,ro="metaballs",no=({time:e})=>Object(xe.jsx)(we.Node,{shader:oo.node,uniforms:{time:e}}),oo=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  clr /= 4.;
  gl_FragColor = vec4(clr, 1.0);
}`}}),io=40,ao="pen-o-plasma",so=({time:e})=>Object(xe.jsx)(we.Node,{shader:co.node,uniforms:{time:e}}),co=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(clr, 1.0);
}`}}),lo=41,fo="reflection",uo=({time:e})=>Object(xe.jsx)(we.Node,{shader:po.node,uniforms:{time:e}}),po=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),ho=42,vo="reflection party",mo=({time:e})=>Object(xe.jsx)(we.Node,{shader:go.node,uniforms:{time:e}}),go=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c = mix(c, reflection(p, n, 10.), glossy);
  gl_FragColor = vec4(c, 1.0);
}`}}),yo=43,bo="irreconcilable queens",xo=({time:e})=>Object(xe.jsx)(we.LinearCopy,{children:Object(xe.jsx)(wo,{persistence:.4,children:Object(xe.jsx)(we.Node,{shader:_o.node,uniforms:{time:e}})})}),wo=({children:e,persistence:t})=>Object(xe.jsx)(we.Node,{shader:_o.persistence,backbuffering:!0,uniforms:{t:e,back:we.Uniform.Backbuffer,persistence:t}}),_o=we.Shaders.create({persistence:{frag:we.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Eo=44,So="royal meeting",Oo=({time:e})=>Object(xe.jsx)(we.Node,{shader:Ro.node,uniforms:{time:e}}),Ro=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
#define PI ${Math.PI}
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),To=45,zo="wood pawns army",Po=({time:e})=>Object(xe.jsx)(we.Node,{shader:Co.node,uniforms:{time:e,wood:"/images/seamless-wood-background-1.jpg"}}),Co=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),Io=46,jo="Bank of Bicoin",Ao=({time:e})=>Object(xe.jsx)(we.Node,{shader:ko.node,uniforms:{time:e}}),ko=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),Do=47,Lo="glow experiment",No=({time:e})=>Object(xe.jsx)(we.Node,{shader:Mo.node,uniforms:{time:e}}),Mo=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Uo=48,Bo="Starry Night",Fo=({time:e})=>Object(xe.jsx)(we.Node,{shader:qo.node,uniforms:{time:e,img:"/images/seamless-wood2.jpg"}}),qo=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(clr, 1.0);
}`}}),$o=49,Go="chinese lantern",Ho=400,Vo=0,Wo=20,Xo=24,Ko=1.1,Yo=({time:e})=>Object(xe.jsx)(we.LinearCopy,{children:Object(xe.jsx)(Qo,{persistence:.8,children:Object(xe.jsx)(we.Node,{shader:Zo.node,uniforms:{time:e}})})}),Qo=({children:e,persistence:t})=>Object(xe.jsx)(we.Node,{shader:Zo.persistence,backbuffering:!0,uniforms:{t:e,back:we.Uniform.Backbuffer,persistence:t}}),Zo=we.Shaders.create({persistence:{frag:we.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  clr += c;
  gl_FragColor = vec4(clr, 1.0);
}`}}),Jo=50,ei="jumpy rooks",ti=({time:e})=>Object(xe.jsx)(we.Node,{shader:ri.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),ri=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),ni=51,oi="symmetry chess",ii=400,ai=0,si=20,ci=24,li=1,fi=({time:e})=>Object(xe.jsx)(we.Node,{shader:ui.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),ui=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),pi=52,di="knights dance",hi=({time:e})=>Object(xe.jsx)(we.Node,{shader:vi.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),vi=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),mi=53,gi="cross waves",yi=({time:e})=>Object(xe.jsx)(we.Node,{shader:bi.node,uniforms:{time:e}}),bi=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  */
}`}}),xi=54,wi="chess set",_i=({time:e})=>Object(xe.jsx)(we.Node,{shader:Ei.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),Ei=we.Shaders.create({node:{frag:we.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  color = vec4(c, 1.0);
}`}}),Si=55,Oi="cube d'or",Ri=400,Ti=0,zi=20,Pi=24,Ci=1,Ii=({time:e})=>Object(xe.jsx)(we.Node,{shader:ji.node,uniforms:{time:e}}),ji=we.Shaders.create({node:{frag:we.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  #endif
  color = vec4(c, 1.0);
}`}}),Ai=56,ki="jade forest",Di=({time:e})=>Object(xe.jsx)(we.Node,{shader:Li.node,uniforms:{time:e}}),Li=we.Shaders.create({node:{frag:we.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  color = vec4(c, 1.0);
}`}}),Ni=57,Mi="Virus v2",Ui=400,Bi=0,Fi=20,qi=24,$i=.8,Gi=({time:e})=>Object(xe.jsx)(we.Node,{shader:Hi.node,uniforms:{time:e}}),Hi=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}});var Vi=r("005v"),Wi=r.n(Vi);const Xi=400,Ki=0,Yi=30,Qi=20,Zi=1,Ji="5M",ea=58,ta="Mandelglitch",ra=[{url:"https://ethblock.art/create/17",text:"Mint on ethblock.art"},{url:"https://ghostmarket.io/asset/pha/ghost/3008841254969814369262311336331954453497120774334547905246474374493804042898/",text:"ghostmarket.io: 400 KCAL"},{url:"https://www.hicetnunc.xyz/objkt/3063",text:"hicetnunc.xyz: Mandelglitch #1 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3068",text:"hicetnunc.xyz: Mandelglitch #2 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3071",text:"hicetnunc.xyz: Mandelglitch #3 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3072",text:"hicetnunc.xyz: Mandelglitch #4 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3073",text:"hicetnunc.xyz: Mandelglitch #5 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3077",text:"hicetnunc.xyz: Mandelglitch #6 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3088",text:"hicetnunc.xyz: Mandelglitch #7 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3574",text:"hicetnunc.xyz: Mandelglitch #8 (5 XTZ)"}];const na=e=>e<.5?2*e*e:(4-2*e)*e-1;const oa=({time:e,n:t,exporting:r})=>{const n=Object(Ue.useMemo)((()=>function(e,t=0){const r=e?3:50,n=new Wi.a(t);return Array(r).fill(null).map((()=>Array(12).fill(null).map((()=>n.random()))))}(r,t)),[t,r]),o=e/10%n.length,i=Math.floor(o),a=o-i;let[s,c,l,f,u,p,d,h,v,m,g,y]=(b=n[i%n.length],x=n[(i+1)%n.length],w=na(a),b.map(((e,t)=>e*(1-w)+x[t]*w)));var b,x,w;return l=na(l),Object(xe.jsx)(we.LinearCopy,{children:Object(xe.jsx)(aa,{persistence:r?0:.8,children:Object(xe.jsx)(we.Node,{shader:ia.main,uniforms:{aa:r?2:0,time:e,resolution:we.Uniform.Resolution,travel:s,love:c,dark:l,rot:r?2*Math.PI/Yi:.1,s1:f,s2:u,s3:p,s4:d,s5:h,s6:v,s7:m,s8:g,s9:y}})})})},ia=we.Shaders.create({persistence:{frag:we.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  `}}),aa=({children:e,persistence:t})=>Object(xe.jsx)(we.Node,{shader:ia.persistence,backbuffering:!0,uniforms:{t:e,back:we.Uniform.Backbuffer,persistence:t}}),sa=59,ca="Pixels 256",la="There will be only 256 patterns generated by this single fragment shader.",fa=({time:e,n:t,exporting:r})=>Object(xe.jsx)(ua,{n:t+1+(r?0:Math.floor(e))}),ua=Be.a.memo((({n:e})=>{const t=new Wi.a(e%256),r=t.random(),n=t.random(),o=t.random(),i=t.random(),a=t.random(),s=t.random();return Object(xe.jsx)(we.Node,{shader:pa.node,uniforms:{s1:r,s2:n,s3:o,s4:i,s5:a,s6:s}})})),pa=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),da=60,ha="Bitcoin rainbow",va=({time:e})=>Object(xe.jsx)(we.Node,{shader:ma.node,uniforms:{time:e}}),ma=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),ga=61,ya="Binance gradients",ba=1,xa=30,wa=["/images/shaders/binance.dist.png"],_a=({time:e})=>Object(xe.jsx)(we.Node,{shader:Ea.node,uniforms:{time:e,image:"/images/shaders/binance.dist.png"}}),Ea=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Sa=62,Oa="Overgrowth",Ra=20,Ta=40,za=1,Pa=({generation:e,size:t,n:r})=>Object(xe.jsx)(we.Node,{width:t,height:t,shader:Da.logic,uniforms:{generation:e,prev:we.Uniform.Backbuffer,size:t,seed:r/100},backbuffering:!0}),Ca=Be.a.memo(Pa),Ia=({time:e,generation:t,n:r})=>Object(xe.jsx)(we.Node,{shader:Da.render,uniforms:{time:e,logic:Object(xe.jsx)(Ca,{generation:t,size:140,n:r})},uniformsOptions:{logic:{interpolation:"nearest"}}}),ja=Be.a.memo(Ia),Aa=1e3*Math.random(),ka=({time:e,n:t})=>Object(xe.jsx)(ja,{n:t+Aa,time:e,generation:Math.floor(30*e)},t),Da=we.Shaders.create({logic:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
...
`}});var La=r("AJhG");const Na=63,Ma="Relics",Ua=400,Ba=2,Fa=4,qa=20,$a=1,Ga="5M",Ha={colors:[.7,.55,.4],logicSize:80,amp:1,base:2,persistance:.89,delta:.5,seed:0};console.log(Object.keys(Ha).map((e=>String(Ha[e]))).join("_"));const Va=({g:e,size:t,seed:r,amp:n,base:o,persistance:i,delta:a})=>Object(xe.jsx)(we.Node,{width:t,height:t,shader:Qa.logic,uniforms:{amp:n,base:o,g:e,prev:we.Uniform.Backbuffer,size:t,seed:r,persistance:i,delta:a},backbuffering:!0},t),Wa=Be.a.memo(Va),Xa=({g:e,colors:t,amp:r,base:n,persistance:o,delta:i,logicSize:a,seed:s})=>Object(xe.jsx)(we.Node,{shader:Qa.render,uniforms:{colors:t,logic:Object(xe.jsx)(Wa,{amp:r,base:n,g:e,size:a,seed:s,persistance:o,delta:i})},uniformsOptions:{logic:{interpolation:"nearest"}}}),Ka=Be.a.memo(Xa),Ya=({time:e})=>{const{colors:t,logicSize:r,amp:n,base:o,persistance:i,delta:a,seed:s}=Object(La.b)(Ha);return Object(xe.jsx)(Ka,{amp:n,base:o,g:Math.floor(20*e)%40,colors:t,persistance:i,delta:a,seed:s,logicSize:r})},Qa=we.Shaders.create({logic:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform sampler2D prev;
uniform float g;
...
`}}),Za=64,Ja="Intersection",es=8*Math.PI,ts=[{url:"https://www.hicetnunc.xyz/objkt/28592",text:"hic et nunc NFT"}],rs=({time:e})=>Object(xe.jsx)(we.Node,{shader:ns.render,uniforms:{resolution:we.Uniform.Resolution,time:e}}),ns=we.Shaders.create({render:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform vec2 resolution;
...
`}}),os=65,is="Duality",as=800,ss=4,cs=8,ls=30,fs=1,us=3,ps=!0,ds=16,hs=[{url:"https://hicetnunc.xyz/objkt/64326",text:"hic et nunc NFT"}],vs=({time:e})=>Object(xe.jsx)(we.NearestCopy,{children:Object(xe.jsx)(ms,{persistence:.3,children:Object(xe.jsx)(we.Node,{shader:gs.render,uniforms:{resolution:we.Uniform.Resolution,time:e}})})}),ms=({children:e,persistence:t})=>Object(xe.jsx)(we.Node,{shader:gs.persistence,backbuffering:!0,uniforms:{t:e,back:we.Uniform.Backbuffer,persistence:t}}),gs=we.Shaders.create({persistence:{frag:we.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),ys=66,bs="hicetnunc",xs=800,ws=2,_s=ws+8,Es=30,Ss=1,Os=7,Rs=!0,Ts=16,zs=({time:e})=>Object(xe.jsx)(we.NearestCopy,{children:Object(xe.jsx)(Ps,{persistence:.5,children:Object(xe.jsx)(we.Node,{shader:Cs.render,uniforms:{resolution:we.Uniform.Resolution,time:e,freq:2}})})}),Ps=({children:e,persistence:t})=>Object(xe.jsx)(we.Node,{shader:Cs.persistence,backbuffering:!0,uniforms:{t:e,back:we.Uniform.Backbuffer,persistence:t}}),Cs=we.Shaders.create({persistence:{frag:we.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Is=67,js="Jumping blob",As=800,ks=2,Ds=ks+8,Ls=30,Ns=1,Ms=7,Us=!0,Bs=16,Fs=({time:e})=>Object(xe.jsx)(we.NearestCopy,{children:Object(xe.jsx)(qs,{persistence:.6,children:Object(xe.jsx)(we.Node,{shader:$s.render,uniforms:{resolution:we.Uniform.Resolution,time:e,freq:2}})})}),qs=({children:e,persistence:t})=>Object(xe.jsx)(we.Node,{shader:$s.persistence,backbuffering:!0,uniforms:{t:e,back:we.Uniform.Backbuffer,persistence:t}}),$s=we.Shaders.create({persistence:{frag:we.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Gs=68,Hs="ring",Vs=800,Ws=2,Xs=Ws+10,Ks=30,Ys=1,Qs=7,Zs=!0,Js=128,ec=({time:e})=>Object(xe.jsx)(we.NearestCopy,{children:Object(xe.jsx)(tc,{persistence:.9,children:Object(xe.jsx)(we.Node,{shader:rc.render,uniforms:{resolution:we.Uniform.Resolution,time:e,freq:2}})})}),tc=({children:e,persistence:t})=>Object(xe.jsx)(we.Node,{shader:rc.persistence,backbuffering:!0,uniforms:{t:e,back:we.Uniform.Backbuffer,persistence:t}}),rc=we.Shaders.create({persistence:{frag:we.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),nc=69,oc="Bananas paradize",ic=400,ac=0,sc=20,cc=20,lc=1,fc=!0,uc=128,pc=({time:e})=>Object(xe.jsx)(we.Node,{shader:dc.node,uniforms:{time:e,resolution:we.Uniform.Resolution}}),dc=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),hc=70,vc="warp1",mc=400,gc=0,yc=20,bc=20,xc=1,wc=!1,_c=256,Ec=({time:e})=>Object(xe.jsx)(we.Node,{shader:Sc.node,uniforms:{time:e,resolution:we.Uniform.Resolution}}),Sc=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),Oc=71,Rc="warp2",Tc=640,zc=0,Pc=20,Cc=24,Ic=1,jc=!1,Ac=256,kc=({time:e})=>Object(xe.jsx)(we.Node,{shader:Dc.node,uniforms:{time:e}}),Dc=we.Shaders.create({node:{frag:we.GLSL`
precision highp float;
varying vec2 uv;

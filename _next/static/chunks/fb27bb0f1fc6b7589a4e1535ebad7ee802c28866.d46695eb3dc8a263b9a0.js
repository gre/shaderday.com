...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Ue=5,Me="Here We Go Again",qe=({time:e})=>Object(le.jsx)(pe.Node,{shader:Fe.node,uniforms:{time:e}}),Fe=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    sqrt(vec3(1. - shad));
  gl_FragColor = vec4(c,1.0);
}`}}),Be=6,Ge="Bestagons",He=({time:e})=>Object(le.jsx)(pe.Node,{shader:Ve.node,uniforms:{time:e}}),Ve=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}});var Nt=({width:e,height:t,map:r,pixelRatio:o,direction:i,children:n})=>Object(le.jsx)(pe.Node,{shader:jt.blur1D,width:e,height:t,pixelRatio:o,uniforms:{direction:i,resolution:pe.Uniform.Resolution,t:n,map:r}});const kt=({width:e,height:t,map:r,pixelRatio:o,factor:i,children:n,passes:a,directionForPass:s})=>{const c=l=>l<=0?n:Object(le.jsx)(Nt,{width:e,height:t,map:r,pixelRatio:o,direction:s(l,i,a),children:c(l-1)});return c(a)};kt.defaultProps={passes:2,directionForPass:Ct};const Ut=15,Mt="parametric",qt=({time:e})=>Object(le.jsx)(pe.LinearCopy,{children:Object(le.jsx)(Bt,{persistence:.98+.02*Math.cos(e)+-.8*Math.exp(-e),children:Object(le.jsx)(Lt,{passes:4,factor:.2,children:Object(le.jsx)(Ft,{time:e})})})}),Ft=({time:e})=>Object(le.jsx)(pe.Node,{shader:Gt.node,uniforms:{time:e}}),Bt=({children:e,persistence:t})=>Object(le.jsx)(pe.Node,{shader:Gt.persistence,backbuffering:!0,uniforms:{t:e,back:pe.Uniform.Backbuffer,persistence:t}}),Gt=pe.Shaders.create({persistence:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),Ur=27,Mr="real burning ship",qr=400,Fr=0,Br=60,Gr=12,Hr=2,Vr=({time:e})=>Object(le.jsx)(pe.LinearCopy,{children:Object(le.jsx)(Xr,{persistence:.8+.05*Math.random(),time:e,children:Object(le.jsx)(pe.Node,{shader:Yr.node,uniforms:{time:e}})})}),Xr=({children:e,persistence:t,time:r})=>Object(le.jsx)(pe.Node,{shader:Yr.persistence,backbuffering:!0,uniforms:{t:e,back:pe.Uniform.Backbuffer,persistence:t,time:r}}),Yr=pe.Shaders.create({persistence:{frag:pe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Mo=38,qo="Golden mandelbulb",Fo=({time:e})=>Object(le.jsx)(pe.LinearCopy,{children:Object(le.jsx)(Bo,{persistence:.5,children:Object(le.jsx)(pe.Node,{shader:Go.node,uniforms:{time:e}})})}),Bo=({children:e,persistence:t})=>Object(le.jsx)(pe.Node,{shader:Go.persistence,backbuffering:!0,uniforms:{t:e,back:pe.Uniform.Backbuffer,persistence:t}}),Go=pe.Shaders.create({persistence:{frag:pe.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  clr += c;
  gl_FragColor = vec4(clr, 1.0);
}`}}),Fi=50,Bi="jumpy rooks",Gi=({time:e})=>Object(le.jsx)(pe.Node,{shader:Hi.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),Hi=pe.Shaders.create({node:{frag:pe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;

...
`}}),dt=9,vt="Virus",ht=400,mt=16.3,gt=26,yt=24,bt=.8,xt=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:wt.node,uniforms:{time:e}}),wt=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),hr=19,mr="they were six",gr=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:yr.node,uniforms:{time:e}}),yr=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),gn=30,yn="21 millions",bn=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:xn.node,uniforms:{time:e,numberInCirculation:18557031}}),xn=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),mo=42,go="reflection party",yo=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:bo.node,uniforms:{time:e}}),bo=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),yi=53,bi="cross waves",xi=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:wi.node,uniforms:{time:e}}),wi=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),ha=60,ma="Bitcoin rainbow",ga=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:ya.node,uniforms:{time:e}}),ya=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),ba=61,xa="Binance gradients",wa=1,_a=30,Ea=["/images/shaders/binance.dist.png"],Sa=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:Oa.node,uniforms:{time:e,image:"/images/shaders/binance.dist.png"}}),Oa=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),as=65,ss="Duality",cs=800,ls=4,fs=8,us=30,ps=1,ds=3,vs=!0,hs=16,ms=[{url:"https://hicetnunc.xyz/objkt/64326",text:"hic et nunc NFT"}],gs=({time:e})=>Object(_e.jsx)(Ee.NearestCopy,{children:Object(_e.jsx)(ys,{persistence:.3,children:Object(_e.jsx)(Ee.Node,{shader:bs.render,uniforms:{resolution:Ee.Uniform.Resolution,time:e}})})}),ys=({children:e,persistence:t})=>Object(_e.jsx)(Ee.Node,{shader:bs.persistence,backbuffering:!0,uniforms:{t:e,back:Ee.Uniform.Backbuffer,persistence:t}}),bs=Ee.Shaders.create({persistence:{frag:Ee.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),mc=70,gc="warp1",yc=400,bc=0,xc=20,wc=20,_c=1,Ec=!1,Sc=256,Oc=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:Rc.node,uniforms:{time:e,resolution:Ee.Uniform.Resolution}}),Rc=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;

...
`}}),pt=9,dt="Virus",ht=400,vt=16.3,mt=26,gt=24,yt=.8,bt=({time:e})=>Object(we.jsx)(_e.Node,{shader:xt.node,uniforms:{time:e}}),xt=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),hr=19,vr="they were six",mr=({time:e})=>Object(we.jsx)(_e.Node,{shader:gr.node,uniforms:{time:e}}),gr=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
`}}),pn=29,dn="sdBitcoin(p)",hn=({time:e})=>Object(we.jsx)(_e.Node,{shader:vn.node,uniforms:{time:e}}),vn=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(clr, 1.0);
}`}}),fo=41,uo="reflection",po=({time:e})=>Object(we.jsx)(_e.Node,{shader:ho.node,uniforms:{time:e}}),ho=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),vo=42,mo="reflection party",go=({time:e})=>Object(we.jsx)(_e.Node,{shader:yo.node,uniforms:{time:e}}),yo=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),di=52,hi="knights dance",vi=({time:e})=>Object(we.jsx)(_e.Node,{shader:mi.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),mi=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
`}}),ha=60,va="Bitcoin rainbow",ma=({time:e})=>Object(we.jsx)(_e.Node,{shader:ga.node,uniforms:{time:e}}),ga=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),oc=69,ic="Bananas paradize",ac=400,sc=0,cc=20,lc=20,fc=1,uc=!0,pc=128,dc=({time:e})=>Object(we.jsx)(_e.Node,{shader:hc.node,uniforms:{time:e,resolution:_e.Uniform.Resolution}}),hc=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),vc=70,mc="warp1",gc=400,yc=0,bc=20,xc=20,wc=1,_c=!1,Ec=256,Sc=({time:e})=>Object(we.jsx)(_e.Node,{shader:Oc.node,uniforms:{time:e,resolution:_e.Uniform.Resolution}}),Oc=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;

...
}`}}),We=2,Xe="stripes",Ke=400,Ye=0,Qe=60,Ze=24,Je=1,et=({time:e})=>Object(Be.jsx)(qe.Node,{shader:tt.node,uniforms:{time:e}}),tt=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),rt=3,nt="zephyr",ot=({time:e})=>Object(Be.jsx)(qe.Node,{shader:it.node,uniforms:{time:e}}),it=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}});var at=r("q1tI"),ct=r.n(at);const st=qe.Shaders.create({InitGameOfLife:{frag:qe.GLSL`
  precision highp float;
  uniform float seed;
  // i
  varying vec2 uv;
  ...
  }`}}),lt=ct.a.memo((({tick:e,size:t,refreshEveryTicks:r})=>e%(r||1/0)===0?Object(Be.jsx)(qe.Node,{shader:st.InitGameOfLife,uniforms:{seed:Math.random()},width:t,height:t,backbuffering:!0,sync:!0}):Object(Be.jsx)(qe.Node,{shader:st.GameOfLife,width:t,height:t,backbuffering:!0,sync:!0,uniforms:{t:qe.Uniform.Backbuffer,size:t}}))),ft=4,ut="Ray of Life";let pt;const dt=({time:e})=>{pt||(pt=e);const t=e-pt,r=Math.floor(10*t),n=r+25,o=10*(1+Math.floor(r/50)),i=10*(1+Math.floor(n/50));return Object(Be.jsx)(vt,{time:e,a:Object(Be.jsx)(qe.NearestCopy,{children:Object(Be.jsx)(lt,{refreshEveryTicks:50,tick:r,size:o})}),b:Object(Be.jsx)(qe.NearestCopy,{children:Object(Be.jsx)(lt,{refreshEveryTicks:50,tick:n,size:i})})})},vt=({a:e,b:t,time:r})=>Object(Be.jsx)(qe.Node,{uniforms:{a:e,b:t,time:r},shader:ht.main}),ht=qe.Shaders.create({main:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),mt=5,gt="Here We Go Again",bt=({time:e})=>Object(Be.jsx)(qe.Node,{shader:xt.node,uniforms:{time:e}}),xt=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    sqrt(vec3(1. - shad));
  gl_FragColor = vec4(c,1.0);
}`}}),yt=6,wt="Bestagons",_t=({time:e})=>Object(Be.jsx)(qe.Node,{shader:St.node,uniforms:{time:e}}),St=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),Et=7,Ot="Worms party",Rt=({time:e})=>Object(Be.jsx)(qe.Node,{shader:zt.node,uniforms:{time:e}}),zt=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    sqrt(vec3(1. - shad));
  gl_FragColor = vec4(c,1.0);
}`}}),Tt=8,Pt="moontains",It=({time:e})=>Object(Be.jsx)(qe.Node,{shader:Ct.node,uniforms:{time:e}}),Ct=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),jt=9,kt="Virus",At=400,Dt=16.3,Lt=26,Nt=24,Mt=.8,Ut=({time:e})=>Object(Be.jsx)(qe.Node,{shader:Ft.node,uniforms:{time:e}}),Ft=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Bt=10,qt="ring",$t=({time:e})=>Object(Be.jsx)(qe.Node,{shader:Gt.node,uniforms:{time:e}}),Gt=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Ht=11,Vt="magic mouse",Wt=({time:e})=>Object(Be.jsx)(qe.Node,{shader:Xt.node,uniforms:{time:e}}),Xt=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Kt=12,Yt="floor is lava",Qt=({time:e})=>Object(Be.jsx)(qe.Node,{shader:Zt.node,uniforms:{time:e}}),Zt=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Jt=13,er="chip",tr=({time:e})=>Object(Be.jsx)(qe.Node,{shader:rr.node,uniforms:{time:e}}),rr=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
`}}),nr=14,or="seizure",ir=({time:e})=>Object(Be.jsx)(qe.Node,{shader:ar.node,uniforms:{time:e}}),ar=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),cr=qe.Shaders.create({blur1D:{frag:qe.GLSL`precision highp float;
varying vec2 uv;
uniform sampler2D t;
...
}`}});var sr=({width:e,height:t,pixelRatio:r,direction:n,children:o})=>Object(Be.jsx)(qe.Node,{shader:cr.blur1D,width:e,height:t,pixelRatio:r,uniforms:{direction:n,resolution:qe.Uniform.Resolution,t:o}});const lr=Math.sqrt(2)/2;var fr=(e,t,r)=>{const n=2*t*Math.ceil(e/2)/r;switch((e-1)%4){case 0:return[n,0];case 1:return[0,n];case 2:return[n*lr,n*lr];case 3:return[n*lr,-n*lr]}};const ur=({width:e,height:t,pixelRatio:r,factor:n,children:o,passes:i,directionForPass:a})=>{const c=s=>s<=0?o:Object(Be.jsx)(sr,{width:e,height:t,pixelRatio:r,direction:a(s,n,i),children:c(s-1)});return c(i)};ur.defaultProps={passes:2,directionForPass:fr};var pr=ur;const dr=qe.Shaders.create({blur1D:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
...
}`}});var vr=({width:e,height:t,map:r,pixelRatio:n,direction:o,children:i})=>Object(Be.jsx)(qe.Node,{shader:dr.blur1D,width:e,height:t,pixelRatio:n,uniforms:{direction:o,resolution:qe.Uniform.Resolution,t:i,map:r}});const hr=({width:e,height:t,map:r,pixelRatio:n,factor:o,children:i,passes:a,directionForPass:c})=>{const s=l=>l<=0?i:Object(Be.jsx)(vr,{width:e,height:t,map:r,pixelRatio:n,direction:c(l,o,a),children:s(l-1)});return s(a)};hr.defaultProps={passes:2,directionForPass:fr};const mr=15,gr="parametric",br=({time:e})=>Object(Be.jsx)(qe.LinearCopy,{children:Object(Be.jsx)(yr,{persistence:.98+.02*Math.cos(e)+-.8*Math.exp(-e),children:Object(Be.jsx)(pr,{passes:4,factor:.2,children:Object(Be.jsx)(xr,{time:e})})})}),xr=({time:e})=>Object(Be.jsx)(qe.Node,{shader:wr.node,uniforms:{time:e}}),yr=({children:e,persistence:t})=>Object(Be.jsx)(qe.Node,{shader:wr.persistence,backbuffering:!0,uniforms:{t:e,back:qe.Uniform.Backbuffer,persistence:t}}),wr=qe.Shaders.create({persistence:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),_r=16,Sr="reuleaux",Er=({time:e})=>Object(Be.jsx)(qe.Node,{shader:Or.node,uniforms:{time:e}}),Or=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    color(0.5 * time);
  gl_FragColor = vec4(c, 1.0);
}`}}),Rr=17,zr="screws",Tr=({time:e})=>Object(Be.jsx)(qe.Node,{shader:Pr.node,uniforms:{time:e}}),Pr=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),Ir=18,Cr="queen",jr=({time:e})=>Object(Be.jsx)(qe.Node,{shader:kr.node,uniforms:{time:e}}),kr=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
}`}}),Ar=19,Dr="they were six",Lr=({time:e})=>Object(Be.jsx)(qe.Node,{shader:Nr.node,uniforms:{time:e}}),Nr=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Mr=20,Ur="trippy tiles",Fr=({time:e})=>Object(Be.jsx)(qe.LinearCopy,{children:Object(Be.jsx)(Br,{persistence:.85,children:Object(Be.jsx)(qe.Node,{shader:qr.node,uniforms:{time:e}})})}),Br=({children:e,persistence:t})=>Object(Be.jsx)(qe.Node,{shader:qr.persistence,backbuffering:!0,uniforms:{t:e,back:qe.Uniform.Backbuffer,persistence:t}}),qr=qe.Shaders.create({persistence:{frag:qe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),$r=21,Gr="HODL",Hr=({time:e})=>Object(Be.jsx)(qe.LinearCopy,{children:Object(Be.jsx)(Vr,{persistence:Math.min(.99,.015*e),time:e,children:Object(Be.jsx)(qe.Node,{shader:Wr.node,uniforms:{time:e}})})}),Vr=({children:e,persistence:t,time:r})=>Object(Be.jsx)(qe.Node,{shader:Wr.shakePersistence,backbuffering:!0,uniforms:{t:e,back:qe.Uniform.Backbuffer,persistence:t,time:r}}),Wr=qe.Shaders.create({shakePersistence:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform sampler2D t, back;
uniform float time;
...
}`}}),Xr=22,Kr="atoms",Yr=({time:e})=>Object(Be.jsx)(qe.Node,{shader:Qr.node,uniforms:{time:e,t:"/images/einstein-tongue-out.jpg"}}),Qr=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D t;
...
void main() {
...
}`}}),Zr=23,Jr="Hexacubes",en=({time:e})=>Object(Be.jsx)(qe.Node,{shader:tn.node,uniforms:{time:e}}),tn=qe.Shaders.create({node:{frag:qe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform float time;
  const float PI = ${Math.PI};
  ...
  void main() {
    ...
    gl_FragColor = vec4(c, 1.0);
      ...
      `}}),rn=24,nn="dark cubes",on=({time:e})=>Object(Be.jsx)(qe.Node,{shader:an.node,uniforms:{time:e}}),an=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),cn=25,sn="Mandelbrot",ln=({time:e})=>Object(Be.jsx)(qe.LinearCopy,{children:Object(Be.jsx)(fn,{persistence:.9,children:Object(Be.jsx)(pr,{passes:4,factor:.1,children:Object(Be.jsx)(qe.Node,{shader:un.node,uniforms:{time:e}})})})}),fn=({children:e,persistence:t})=>Object(Be.jsx)(qe.Node,{shader:un.persistence,backbuffering:!0,uniforms:{t:e,back:qe.Uniform.Backbuffer,persistence:t}}),un=qe.Shaders.create({persistence:{frag:qe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),pn=26,dn="fumes",vn=({time:e})=>Object(Be.jsx)(qe.LinearCopy,{children:Object(Be.jsx)(hn,{persistence:.9,children:Object(Be.jsx)(pr,{passes:4,factor:Math.min(.6,.01*e),children:Object(Be.jsx)(qe.Node,{shader:mn.node,uniforms:{time:e}})})})}),hn=({children:e,persistence:t})=>Object(Be.jsx)(qe.Node,{shader:mn.persistence,backbuffering:!0,uniforms:{t:e,back:qe.Uniform.Backbuffer,persistence:t}}),mn=qe.Shaders.create({persistence:{frag:qe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),gn=27,bn="real burning ship",xn=400,yn=0,wn=60,_n=12,Sn=2,En=({time:e})=>Object(Be.jsx)(qe.LinearCopy,{children:Object(Be.jsx)(On,{persistence:.8+.05*Math.random(),time:e,children:Object(Be.jsx)(qe.Node,{shader:Rn.node,uniforms:{time:e}})})}),On=({children:e,persistence:t,time:r})=>Object(Be.jsx)(qe.Node,{shader:Rn.persistence,backbuffering:!0,uniforms:{t:e,back:qe.Uniform.Backbuffer,persistence:t,time:r}}),Rn=qe.Shaders.create({persistence:{frag:qe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),zn=28,Tn="No, I'M Batman",Pn=({time:e})=>Object(Be.jsx)(qe.LinearCopy,{children:Object(Be.jsx)(In,{persistence:.5+.48*Math.min(1,e/60),children:Object(Be.jsx)(qe.Node,{shader:Cn.node,uniforms:{time:e}})})}),In=({children:e,persistence:t})=>Object(Be.jsx)(qe.Node,{shader:Cn.persistence,backbuffering:!0,uniforms:{t:e,back:qe.Uniform.Backbuffer,persistence:t}}),Cn=qe.Shaders.create({persistence:{frag:qe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),jn=29,kn="sdBitcoin(p)",An=({time:e})=>Object(Be.jsx)(qe.Node,{shader:Dn.node,uniforms:{time:e}}),Dn=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Ln=30,Nn="21 millions",Mn=({time:e})=>Object(Be.jsx)(qe.Node,{shader:Un.node,uniforms:{time:e,numberInCirculation:18557031}}),Un=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Fn=31,Bn="alien tower",qn=({time:e})=>Object(Be.jsx)(qe.Node,{shader:$n.node,uniforms:{time:e,numberInCirculation:18557031}}),$n=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform float numberInCirculation;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Gn=32,Hn="GoL valley";let Vn;const Wn=({time:e})=>{Vn||(Vn=e);const t=e-Vn,r=Math.floor(12*t);return Object(Be.jsx)(qe.Node,{shader:Xn.node,uniforms:{time:e,t:Object(Be.jsx)(lt,{refreshEveryTicks:100,tick:r,size:100})}})},Xn=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D t;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Kn=33,Yn="x(x+32y)%(tN+1)%n";const Qn=({time:e})=>Object(Be.jsx)(qe.Node,{shader:Zn.node,uniforms:{time:e}}),Zn=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Jn=34,eo="\u230a2cos(x)sin(y+t)\u230b%7";const to=({time:e})=>Object(Be.jsx)(qe.Node,{shader:ro.node,uniforms:{time:e}}),ro=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
#define PI ${Math.PI}
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),no=35,oo="aie confiance",io=({time:e})=>Object(Be.jsx)(qe.LinearCopy,{children:Object(Be.jsx)(ao,{persistence:.6,children:Object(Be.jsx)(qe.Node,{shader:co.node,uniforms:{time:e}})})}),ao=({children:e,persistence:t})=>Object(Be.jsx)(qe.Node,{shader:co.persistence,backbuffering:!0,uniforms:{t:e,back:qe.Uniform.Backbuffer,persistence:t}}),co=qe.Shaders.create({persistence:{frag:qe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),so=36,lo="crois en moi",fo=({time:e})=>Object(Be.jsx)(qe.LinearCopy,{children:Object(Be.jsx)(uo,{children:Object(Be.jsx)(qe.Node,{shader:po.node,uniforms:{time:e}})})}),uo=({children:e,persistence:t})=>Object(Be.jsx)(qe.Node,{shader:po.persistence,backbuffering:!0,uniforms:{t:e,back:qe.Uniform.Backbuffer,persistence:t}}),po=qe.Shaders.create({persistence:{frag:qe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),vo=37,ho="sdBrick",mo=({time:e})=>Object(Be.jsx)(qe.Node,{shader:go.node,uniforms:{time:e}}),go=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),bo=38,xo="Golden mandelbulb",yo=({time:e})=>Object(Be.jsx)(qe.LinearCopy,{children:Object(Be.jsx)(wo,{persistence:.5,children:Object(Be.jsx)(qe.Node,{shader:_o.node,uniforms:{time:e}})})}),wo=({children:e,persistence:t})=>Object(Be.jsx)(qe.Node,{shader:_o.persistence,backbuffering:!0,uniforms:{t:e,back:qe.Uniform.Backbuffer,persistence:t}}),_o=qe.Shaders.create({persistence:{frag:qe.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  clr /= 4.;
  gl_FragColor = vec4(clr, 1.0);
}`}}),So=39,Eo="metaballs",Oo=({time:e})=>Object(Be.jsx)(qe.Node,{shader:Ro.node,uniforms:{time:e}}),Ro=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  clr /= 4.;
  gl_FragColor = vec4(clr, 1.0);
}`}}),zo=40,To="pen-o-plasma",Po=({time:e})=>Object(Be.jsx)(qe.Node,{shader:Io.node,uniforms:{time:e}}),Io=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(clr, 1.0);
}`}}),Co=41,jo="reflection",ko=({time:e})=>Object(Be.jsx)(qe.Node,{shader:Ao.node,uniforms:{time:e}}),Ao=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Do=42,Lo="reflection party",No=({time:e})=>Object(Be.jsx)(qe.Node,{shader:Mo.node,uniforms:{time:e}}),Mo=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c = mix(c, reflection(p, n, 10.), glossy);
  gl_FragColor = vec4(c, 1.0);
}`}}),Uo=43,Fo="irreconcilable queens",Bo=({time:e})=>Object(Be.jsx)(qe.LinearCopy,{children:Object(Be.jsx)(qo,{persistence:.4,children:Object(Be.jsx)(qe.Node,{shader:$o.node,uniforms:{time:e}})})}),qo=({children:e,persistence:t})=>Object(Be.jsx)(qe.Node,{shader:$o.persistence,backbuffering:!0,uniforms:{t:e,back:qe.Uniform.Backbuffer,persistence:t}}),$o=qe.Shaders.create({persistence:{frag:qe.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Go=44,Ho="royal meeting",Vo=({time:e})=>Object(Be.jsx)(qe.Node,{shader:Wo.node,uniforms:{time:e}}),Wo=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
#define PI ${Math.PI}
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),Xo=45,Ko="wood pawns army",Yo=({time:e})=>Object(Be.jsx)(qe.Node,{shader:Qo.node,uniforms:{time:e,wood:"/images/seamless-wood-background-1.jpg"}}),Qo=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),Zo=46,Jo="Bank of Bicoin",ei=({time:e})=>Object(Be.jsx)(qe.Node,{shader:ti.node,uniforms:{time:e}}),ti=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),ri=47,ni="glow experiment",oi=({time:e})=>Object(Be.jsx)(qe.Node,{shader:ii.node,uniforms:{time:e}}),ii=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),ai=48,ci="Starry Night",si=({time:e})=>Object(Be.jsx)(qe.Node,{shader:li.node,uniforms:{time:e,img:"/images/seamless-wood2.jpg"}}),li=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(clr, 1.0);
}`}}),fi=49,ui="chinese lantern",pi=400,di=0,vi=20,hi=24,mi=1.1,gi=({time:e})=>Object(Be.jsx)(qe.LinearCopy,{children:Object(Be.jsx)(bi,{persistence:.8,children:Object(Be.jsx)(qe.Node,{shader:xi.node,uniforms:{time:e}})})}),bi=({children:e,persistence:t})=>Object(Be.jsx)(qe.Node,{shader:xi.persistence,backbuffering:!0,uniforms:{t:e,back:qe.Uniform.Backbuffer,persistence:t}}),xi=qe.Shaders.create({persistence:{frag:qe.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  clr += c;
  gl_FragColor = vec4(clr, 1.0);
}`}}),yi=50,wi="jumpy rooks",_i=({time:e})=>Object(Be.jsx)(qe.Node,{shader:Si.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),Si=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),Ei=51,Oi="symmetry chess",Ri=400,zi=0,Ti=20,Pi=24,Ii=1,Ci=({time:e})=>Object(Be.jsx)(qe.Node,{shader:ji.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),ji=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),ki=52,Ai="knights dance",Di=({time:e})=>Object(Be.jsx)(qe.Node,{shader:Li.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),Li=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),Ni=53,Mi="cross waves",Ui=({time:e})=>Object(Be.jsx)(qe.Node,{shader:Fi.node,uniforms:{time:e}}),Fi=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  */
}`}}),Bi=54,qi="chess set",$i=({time:e})=>Object(Be.jsx)(qe.Node,{shader:Gi.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),Gi=qe.Shaders.create({node:{frag:qe.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  color = vec4(c, 1.0);
}`}}),Hi=55,Vi="cube d'or",Wi=400,Xi=0,Ki=20,Yi=24,Qi=1,Zi=({time:e})=>Object(Be.jsx)(qe.Node,{shader:Ji.node,uniforms:{time:e}}),Ji=qe.Shaders.create({node:{frag:qe.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  #endif
  color = vec4(c, 1.0);
}`}}),ea=56,ta="jade forest",ra=({time:e})=>Object(Be.jsx)(qe.Node,{shader:na.node,uniforms:{time:e}}),na=qe.Shaders.create({node:{frag:qe.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  color = vec4(c, 1.0);
}`}}),oa=57,ia="Virus v2",aa=400,ca=0,sa=20,la=24,fa=.8,ua=({time:e})=>Object(Be.jsx)(qe.Node,{shader:pa.node,uniforms:{time:e}}),pa=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}});var da=r("005v"),va=r.n(da);const ha=400,ma=0,ga=30,ba=20,xa=1,ya="5M",wa=58,_a="Mandelglitch",Sa=[{url:"https://ethblock.art/create/17",text:"Mint on ethblock.art"},{url:"https://ghostmarket.io/asset/pha/ghost/3008841254969814369262311336331954453497120774334547905246474374493804042898/",text:"ghostmarket.io: 400 KCAL"},{url:"https://www.hicetnunc.xyz/objkt/3063",text:"hicetnunc.xyz: Mandelglitch #1 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3068",text:"hicetnunc.xyz: Mandelglitch #2 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3071",text:"hicetnunc.xyz: Mandelglitch #3 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3072",text:"hicetnunc.xyz: Mandelglitch #4 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3073",text:"hicetnunc.xyz: Mandelglitch #5 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3077",text:"hicetnunc.xyz: Mandelglitch #6 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3088",text:"hicetnunc.xyz: Mandelglitch #7 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3574",text:"hicetnunc.xyz: Mandelglitch #8 (5 XTZ)"}];const Ea=e=>e<.5?2*e*e:(4-2*e)*e-1;const Oa=({time:e,n:t,exporting:r})=>{const n=Object(at.useMemo)((()=>function(e,t=0){const r=e?3:50,n=new va.a(t);return Array(r).fill(null).map((()=>Array(12).fill(null).map((()=>n.random()))))}(r,t)),[t,r]),o=e/10%n.length,i=Math.floor(o),a=o-i;let[c,s,l,f,u,p,d,v,h,m,g,b]=(x=n[i%n.length],y=n[(i+1)%n.length],w=Ea(a),x.map(((e,t)=>e*(1-w)+y[t]*w)));var x,y,w;return l=Ea(l),Object(Be.jsx)(qe.LinearCopy,{children:Object(Be.jsx)(za,{persistence:r?0:.8,children:Object(Be.jsx)(qe.Node,{shader:Ra.main,uniforms:{aa:r?2:0,time:e,resolution:qe.Uniform.Resolution,travel:c,love:s,dark:l,rot:r?2*Math.PI/ga:.1,s1:f,s2:u,s3:p,s4:d,s5:v,s6:h,s7:m,s8:g,s9:b}})})})},Ra=qe.Shaders.create({persistence:{frag:qe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  `}}),za=({children:e,persistence:t})=>Object(Be.jsx)(qe.Node,{shader:Ra.persistence,backbuffering:!0,uniforms:{t:e,back:qe.Uniform.Backbuffer,persistence:t}}),Ta=59,Pa="Pixels 256",Ia="There will be only 256 patterns generated by this single fragment shader.",Ca=({time:e,n:t,exporting:r})=>Object(Be.jsx)(ja,{n:t+1+(r?0:Math.floor(e))}),ja=ct.a.memo((({n:e})=>{const t=new va.a(e%256),r=t.random(),n=t.random(),o=t.random(),i=t.random(),a=t.random(),c=t.random();return Object(Be.jsx)(qe.Node,{shader:ka.node,uniforms:{s1:r,s2:n,s3:o,s4:i,s5:a,s6:c}})})),ka=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),Aa=60,Da="Bitcoin rainbow",La=({time:e})=>Object(Be.jsx)(qe.Node,{shader:Na.node,uniforms:{time:e}}),Na=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Ma=61,Ua="Binance gradients",Fa=1,Ba=30,qa=["/images/shaders/binance.dist.png"],$a=({time:e})=>Object(Be.jsx)(qe.Node,{shader:Ga.node,uniforms:{time:e,image:"/images/shaders/binance.dist.png"}}),Ga=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Ha=62,Va="Overgrowth",Wa=20,Xa=40,Ka=1,Ya=({generation:e,size:t,n:r})=>Object(Be.jsx)(qe.Node,{width:t,height:t,shader:rc.logic,uniforms:{generation:e,prev:qe.Uniform.Backbuffer,size:t,seed:r/100},backbuffering:!0}),Qa=ct.a.memo(Ya),Za=({time:e,generation:t,n:r})=>Object(Be.jsx)(qe.Node,{shader:rc.render,uniforms:{time:e,logic:Object(Be.jsx)(Qa,{generation:t,size:140,n:r})},uniformsOptions:{logic:{interpolation:"nearest"}}}),Ja=ct.a.memo(Za),ec=1e3*Math.random(),tc=({time:e,n:t})=>Object(Be.jsx)(Ja,{n:t+ec,time:e,generation:Math.floor(30*e)},t),rc=qe.Shaders.create({logic:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
...
`}});var nc=r("AJhG");const oc=63,ic="Relics",ac=400,cc=2,sc=4,lc=20,fc=1,uc="5M",pc={colors:[.7,.55,.4],logicSize:80,amp:1,base:2,persistance:.89,delta:.5,seed:0};console.log(Object.keys(pc).map((e=>String(pc[e]))).join("_"));const dc=({g:e,size:t,seed:r,amp:n,base:o,persistance:i,delta:a})=>Object(Be.jsx)(qe.Node,{width:t,height:t,shader:bc.logic,uniforms:{amp:n,base:o,g:e,prev:qe.Uniform.Backbuffer,size:t,seed:r,persistance:i,delta:a},backbuffering:!0},t),vc=ct.a.memo(dc),hc=({g:e,colors:t,amp:r,base:n,persistance:o,delta:i,logicSize:a,seed:c})=>Object(Be.jsx)(qe.Node,{shader:bc.render,uniforms:{colors:t,logic:Object(Be.jsx)(vc,{amp:r,base:n,g:e,size:a,seed:c,persistance:o,delta:i})},uniformsOptions:{logic:{interpolation:"nearest"}}}),mc=ct.a.memo(hc),gc=({time:e})=>{const{colors:t,logicSize:r,amp:n,base:o,persistance:i,delta:a,seed:c}=Object(nc.b)(pc);return Object(Be.jsx)(mc,{amp:n,base:o,g:Math.floor(20*e)%40,colors:t,persistance:i,delta:a,seed:c,logicSize:r})},bc=qe.Shaders.create({logic:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform sampler2D prev;
uniform float g;
...
`}}),xc=64,yc="Intersection",wc=8*Math.PI,_c=[{url:"https://www.hicetnunc.xyz/objkt/28592",text:"hic et nunc NFT"}],Sc=({time:e})=>Object(Be.jsx)(qe.Node,{shader:Ec.render,uniforms:{resolution:qe.Uniform.Resolution,time:e}}),Ec=qe.Shaders.create({render:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform vec2 resolution;
...
`}}),Oc=65,Rc="Duality",zc=800,Tc=4,Pc=8,Ic=30,Cc=1,jc=3,kc=!0,Ac=16,Dc=[{url:"https://hicetnunc.xyz/objkt/64326",text:"hic et nunc NFT"}],Lc=({time:e})=>Object(Be.jsx)(qe.NearestCopy,{children:Object(Be.jsx)(Nc,{persistence:.3,children:Object(Be.jsx)(qe.Node,{shader:Mc.render,uniforms:{resolution:qe.Uniform.Resolution,time:e}})})}),Nc=({children:e,persistence:t})=>Object(Be.jsx)(qe.Node,{shader:Mc.persistence,backbuffering:!0,uniforms:{t:e,back:qe.Uniform.Backbuffer,persistence:t}}),Mc=qe.Shaders.create({persistence:{frag:qe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Uc=66,Fc="hicetnunc",Bc=800,qc=2,$c=qc+8,Gc=30,Hc=1,Vc=7,Wc=!0,Xc=16,Kc=({time:e})=>Object(Be.jsx)(qe.NearestCopy,{children:Object(Be.jsx)(Yc,{persistence:.5,children:Object(Be.jsx)(qe.Node,{shader:Qc.render,uniforms:{resolution:qe.Uniform.Resolution,time:e,freq:2}})})}),Yc=({children:e,persistence:t})=>Object(Be.jsx)(qe.Node,{shader:Qc.persistence,backbuffering:!0,uniforms:{t:e,back:qe.Uniform.Backbuffer,persistence:t}}),Qc=qe.Shaders.create({persistence:{frag:qe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Zc=67,Jc="Jumping blob",es=800,ts=2,rs=ts+8,ns=30,os=1,is=7,as=!0,cs=16,ss=({time:e})=>Object(Be.jsx)(qe.NearestCopy,{children:Object(Be.jsx)(ls,{persistence:.6,children:Object(Be.jsx)(qe.Node,{shader:fs.render,uniforms:{resolution:qe.Uniform.Resolution,time:e,freq:2}})})}),ls=({children:e,persistence:t})=>Object(Be.jsx)(qe.Node,{shader:fs.persistence,backbuffering:!0,uniforms:{t:e,back:qe.Uniform.Backbuffer,persistence:t}}),fs=qe.Shaders.create({persistence:{frag:qe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),us=68,ps="ring",ds=800,vs=2,hs=vs+10,ms=30,gs=1,bs=7,xs=!0,ys=128,ws=({time:e})=>Object(Be.jsx)(qe.NearestCopy,{children:Object(Be.jsx)(_s,{persistence:.9,children:Object(Be.jsx)(qe.Node,{shader:Ss.render,uniforms:{resolution:qe.Uniform.Resolution,time:e,freq:2}})})}),_s=({children:e,persistence:t})=>Object(Be.jsx)(qe.Node,{shader:Ss.persistence,backbuffering:!0,uniforms:{t:e,back:qe.Uniform.Backbuffer,persistence:t}}),Ss=qe.Shaders.create({persistence:{frag:qe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Es=69,Os="Bananas paradize",Rs=400,zs=0,Ts=20,Ps=20,Is=1,Cs=!0,js=128,ks=({time:e})=>Object(Be.jsx)(qe.Node,{shader:As.node,uniforms:{time:e,resolution:qe.Uniform.Resolution}}),As=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),Ds=70,Ls="warp1",Ns=400,Ms=0,Us=20,Fs=20,Bs=1,qs=!1,$s=256,Gs=({time:e})=>Object(Be.jsx)(qe.Node,{shader:Hs.node,uniforms:{time:e,resolution:qe.Uniform.Resolution}}),Hs=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),Vs=71,Ws="warp2",Xs=640,Ks=0,Ys=20,Qs=24,Zs=1,Js=!1,el=256,tl=({time:e})=>Object(Be.jsx)(qe.Node,{shader:rl.node,uniforms:{time:e}}),rl=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),nl=72,ol="Planet Hole",il=640,al=0,cl=20,sl=24,ll=1,fl=!1,ul=256,pl=[{url:"https://hicetnunc.xyz/objkt/87918",text:"hic et nunc NFT"}],dl=({time:e,n:t})=>{const r=new va.a(t),n=.2+3*r.random()*r.random(),o=.2+10*r.random()*r.random(),i=r.random(),a=[i+.2-.5*r.random(),i+.02-.1*r.random(),i-.02+.1*r.random()];return Object(Be.jsx)(qe.Node,{shader:vl.node,uniforms:{resolution:qe.Uniform.Resolution,time:e,a:n,b:o,c:a}})},vl=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
...
`}}),hl=73,ml="purple square corridor",gl=640,bl=0,xl=20,yl=24,wl=1,_l=!1,Sl=256,El=72e5,Ol=({time:e})=>{const t=Date.now(),r=t/El-Math.floor(t/El);return Object(Be.jsx)(qe.Node,{shader:Rl.node,uniforms:{resolution:qe.Uniform.Resolution,time:e+1e3*r,speed:.01,c:[.8,.1,.3]}})},Rl=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
...
`}}),zl=74,Tl="blue square corridor",Pl=640,Il=0,Cl=20,jl=24,kl=1,Al=!1,Dl=256,Ll=72e5,Nl=({time:e})=>{const t=Date.now(),r=t/Ll-Math.floor(t/Ll);return Object(Be.jsx)(qe.Node,{shader:Ml.node,uniforms:{resolution:qe.Uniform.Resolution,time:e+1e3*r,speed:.01,c:[0,.3,.4]}})},Ml=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
...
`}}),Ul=75,Fl="moir\xe9 square smoke",Bl=640,ql=0,$l=20,Gl=24,Hl=1,Vl=!1,Wl=256,Xl=36e5,Kl=({time:e})=>{const t=Date.now(),r=t/Xl-Math.floor(t/Xl);return Object(Be.jsx)(qe.Node,{shader:Yl.node,uniforms:{resolution:qe.Uniform.Resolution,time:e+1e3*r,speed:.01}})},Yl=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
...
`}}),Ql=76,Zl="Purple",Jl=640,ef=0,tf=20,rf=24,nf=1,of=!1,af=256,cf=({time:e})=>Object(Be.jsx)(qe.Node,{shader:sf.node,uniforms:{resolution:qe.Uniform.Resolution,time:e}}),sf=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),lf=77,ff="Roses",uf=512,pf=0,df=8,vf=20,hf=1,mf=!1,gf=64,bf=({time:e})=>Object(Be.jsx)(qe.Node,{shader:xf.node,uniforms:{resolution:qe.Uniform.Resolution,time:e}}),xf=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),yf=78,wf="Nature",_f=512,Sf=0,Ef=10,Of=16,Rf=1,zf=!1,Tf=64,Pf=({time:e})=>Object(Be.jsx)(qe.Node,{shader:If.node,uniforms:{resolution:qe.Uniform.Resolution,time:e}}),If=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),Cf=79,jf="Circle",kf=512,Af=0,Df=10,Lf=16,Nf=1,Mf=!1,Uf=64,Ff=({time:e})=>Object(Be.jsx)(qe.Node,{shader:Bf.node,uniforms:{resolution:qe.Uniform.Resolution,time:e}}),Bf=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),qf=80,$f="Morphing Tunnel",Gf=512,Hf=0,Vf=10,Wf=16,Xf=1,Kf=!1,Yf=64,Qf=({time:e})=>Object(Be.jsx)(qe.Node,{shader:Zf.node,uniforms:{resolution:qe.Uniform.Resolution,time:e}}),Zf=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),Jf=81,eu="Red Blue Stripes",tu=512,ru=0,nu=10,ou=16,iu=1,au=!1,cu=64,su=({time:e})=>Object(Be.jsx)(qe.Node,{shader:lu.node,uniforms:{resolution:qe.Uniform.Resolution,time:e}}),lu=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),fu=82,uu="Mountain waves",pu=512,du=0,vu=10,hu=16,mu=1,gu=!1,bu=64,xu=({time:e})=>Object(Be.jsx)(qe.Node,{shader:yu.node,uniforms:{resolution:qe.Uniform.Resolution,time:e}}),yu=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),wu=83,_u="Pink Plume",Su=512,Eu=0,Ou=10,Ru=16,zu=1,Tu=!1,Pu=64,Iu=({time:e})=>Object(Be.jsx)(qe.Node,{shader:Cu.node,uniforms:{resolution:qe.Uniform.Resolution,time:e}}),Cu=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),ju=84,ku="Flame Waves",Au=512,Du=0,Lu=10,Nu=16,Mu=1,Uu=!1,Fu=64,Bu=({time:e})=>Object(Be.jsx)(qe.Node,{shader:qu.node,uniforms:{resolution:qe.Uniform.Resolution,time:e}}),qu=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),$u=85,Gu="Flaming Borders",Hu=512,Vu=0,Wu=10,Xu=16,Ku=1,Yu=!1,Qu=64,Zu=({time:e})=>Object(Be.jsx)(qe.Node,{shader:Ju.node,uniforms:{resolution:qe.Uniform.Resolution,time:e}}),Ju=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),ep=86,tp="Waves",rp=512,np=0,op=10,ip=16,ap=1,cp=!1,sp=64,lp=({time:e})=>Object(Be.jsx)(qe.Node,{shader:fp.node,uniforms:{resolution:qe.Uniform.Resolution,time:e}}),fp=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),up=87,pp="Square Waves",dp=512,vp=0,hp=10,mp=16,gp=1,bp=!1,xp=64,yp=({time:e})=>Object(Be.jsx)(qe.Node,{shader:wp.node,uniforms:{resolution:qe.Uniform.Resolution,time:e}}),wp=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),_p=88,Sp="Unboxing",Ep=512,Op=0,Rp=10,zp=16,Tp=1,Pp=!1,Ip=64,Cp=({time:e})=>Object(Be.jsx)(qe.Node,{shader:jp.node,uniforms:{resolution:qe.Uniform.Resolution,time:e}}),jp=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),kp=89,Ap="Creepy",Dp=512,Lp=0,Np=10,Mp=16,Up=1,Fp=!1,Bp=64,qp=({time:e})=>Object(Be.jsx)(qe.Node,{shader:$p.node,uniforms:{resolution:qe.Uniform.Resolution,time:e}}),$p=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),Gp=90,Hp="Square Path",Vp=512,Wp=0,Xp=10,Kp=16,Yp=1,Qp=!1,Zp=64,Jp=({time:e})=>Object(Be.jsx)(qe.Node,{shader:ed.node,uniforms:{resolution:qe.Uniform.Resolution,time:e}}),ed=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),td=91,rd="Door Path",nd=512,od=0,id=10,ad=16,cd=1,sd=!1,ld=64,fd=({time:e})=>Object(Be.jsx)(qe.Node,{shader:ud.node,uniforms:{resolution:qe.Uniform.Resolution,time:e}}),ud=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),pd=92,dd="Green Cosmos",vd=512,hd=0,md=10,gd=16,bd=1,xd=!1,yd=64,wd=({time:e})=>Object(Be.jsx)(qe.Node,{shader:_d.node,uniforms:{resolution:qe.Uniform.Resolution,time:e}}),_d=qe.Shaders.create({node:{frag:qe.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;

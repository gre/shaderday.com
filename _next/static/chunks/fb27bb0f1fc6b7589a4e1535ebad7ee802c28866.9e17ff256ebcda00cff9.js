...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),ke=5,Ue="Here We Go Again",Me=({time:e})=>Object(ce.jsx)(le.Node,{shader:qe.node,uniforms:{time:e}}),qe=le.Shaders.create({node:{frag:le.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}});var jt=({width:e,height:t,map:r,pixelRatio:o,direction:i,children:n})=>Object(ce.jsx)(le.Node,{shader:Lt.blur1D,width:e,height:t,pixelRatio:o,uniforms:{direction:i,resolution:le.Uniform.Resolution,t:n,map:r}});const Nt=({width:e,height:t,map:r,pixelRatio:o,factor:i,children:n,passes:a,directionForPass:s})=>{const c=l=>l<=0?n:Object(ce.jsx)(jt,{width:e,height:t,map:r,pixelRatio:o,direction:s(l,i,a),children:c(l-1)});return c(a)};Nt.defaultProps={passes:2,directionForPass:Ot};const kt=15,Ut="parametric",Mt=({time:e})=>Object(ce.jsx)(le.LinearCopy,{children:Object(ce.jsx)(Ft,{persistence:.98+.02*Math.cos(e)+-.8*Math.exp(-e),children:Object(ce.jsx)(Dt,{passes:4,factor:.2,children:Object(ce.jsx)(qt,{time:e})})})}),qt=({time:e})=>Object(ce.jsx)(le.Node,{shader:Bt.node,uniforms:{time:e}}),Ft=({children:e,persistence:t})=>Object(ce.jsx)(le.Node,{shader:Bt.persistence,backbuffering:!0,uniforms:{t:e,back:le.Uniform.Backbuffer,persistence:t}}),Bt=le.Shaders.create({persistence:{frag:le.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),kr=27,Ur="real burning ship",Mr=400,qr=0,Fr=60,Br=12,Gr=2,Hr=({time:e})=>Object(ce.jsx)(le.LinearCopy,{children:Object(ce.jsx)(Vr,{persistence:.8+.05*Math.random(),time:e,children:Object(ce.jsx)(le.Node,{shader:Xr.node,uniforms:{time:e}})})}),Vr=({children:e,persistence:t,time:r})=>Object(ce.jsx)(le.Node,{shader:Xr.persistence,backbuffering:!0,uniforms:{t:e,back:le.Uniform.Backbuffer,persistence:t,time:r}}),Xr=le.Shaders.create({persistence:{frag:le.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Lo=37,jo="sdBrick",No=({time:e})=>Object(ce.jsx)(le.Node,{shader:ko.node,uniforms:{time:e}}),ko=le.Shaders.create({node:{frag:le.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Uo=38,Mo="Golden mandelbulb",qo=({time:e})=>Object(ce.jsx)(le.LinearCopy,{children:Object(ce.jsx)(Fo,{persistence:.5,children:Object(ce.jsx)(le.Node,{shader:Bo.node,uniforms:{time:e}})})}),Fo=({children:e,persistence:t})=>Object(ce.jsx)(le.Node,{shader:Bo.persistence,backbuffering:!0,uniforms:{t:e,back:le.Uniform.Backbuffer,persistence:t}}),Bo=le.Shaders.create({persistence:{frag:le.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(clr, 1.0);
}`}}),Ai=49,Oi="chinese lantern",Ci=400,Di=0,Li=20,ji=24,Ni=1.1,ki=({time:e})=>Object(ce.jsx)(le.LinearCopy,{children:Object(ce.jsx)(Ui,{persistence:.8,children:Object(ce.jsx)(le.Node,{shader:Mi.node,uniforms:{time:e}})})}),Ui=({children:e,persistence:t})=>Object(ce.jsx)(le.Node,{shader:Mi.persistence,backbuffering:!0,uniforms:{t:e,back:le.Uniform.Backbuffer,persistence:t}}),Mi=le.Shaders.create({persistence:{frag:le.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;

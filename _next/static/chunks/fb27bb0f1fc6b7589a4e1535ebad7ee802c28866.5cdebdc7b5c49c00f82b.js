...
`}});var za=r("AJhG");const Ca=63,Pa="Relics",Ia=400,ja=0,Aa=60,ka=20,Da=1,La="5M",Na={colors:[.7,.55,.4],logicSize:80,amp:1,base:2,persistance:.89,delta:.5,seed:0},Ma=({freq:e,g:t,size:r,seed:n,amp:o,base:i,persistance:a,delta:s})=>Object(pe.jsx)(de.Node,{width:r,height:r,shader:$a.logic,uniforms:{amp:o,base:i,freq:e,g:t,prev:de.Uniform.Backbuffer,size:r,seed:n,persistance:a,delta:s},backbuffering:!0},r),Ua=je.a.memo(Ma),Ba=({g:e,colors:t,amp:r,base:n,persistance:o,delta:i,logicSize:a,seed:s})=>Object(pe.jsx)(de.Node,{shader:$a.render,uniforms:{colors:t,logic:Object(pe.jsx)(Ua,{amp:r,base:n,g:e,size:a,seed:s,persistance:o,delta:i})},uniformsOptions:{logic:{interpolation:"nearest"}}}),Fa=je.a.memo(Ba),qa=({time:e})=>{const{colors:t,logicSize:r,amp:n,base:o,persistance:i,delta:a,seed:s}=Object(za.b)(Na);return Object(pe.jsx)(Fa,{amp:n,base:o,g:Math.floor(20*e)%1200,colors:t,persistance:i,delta:a,seed:s,logicSize:r})},$a=de.Shaders.create({logic:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform sampler2D prev;
uniform float g;

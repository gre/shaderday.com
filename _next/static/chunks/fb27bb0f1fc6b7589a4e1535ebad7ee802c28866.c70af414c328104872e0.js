...
}`}}).copy;t.default=i},MAJC:function(e,t,r){"use strict";e.exports=function(e){return"undefined"!==typeof e&&null!==e&&("object"===typeof e||"function"===typeof e)}},Ni9w:function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;t.default=class{constructor(){var e,t,r;r=[],(t="_loaders")in(e=this)?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r}add(e){this._loaders.push(e),this._loaders.sort(((e,t)=>("number"===typeof t.priority?t.priority:0)-("number"===typeof e.priority?e.priority:0)))}remove(e){const t=this._loaders.indexOf(e);-1!==t&&this._loaders.splice(t,1)}get(){return this._loaders}}},O8XB:function(e,t,r){"use strict";(function(e,n){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var o,i,a,s,c,l=p(r("tbvF")),f=p(r("Ytbt")),u=p(r("zqV6"));function p(e){return e&&e.__esModule?e:{default:e}}"undefined"===typeof e&&(n.Buffer=(i=o=class{},c=t=>t instanceof e,(s="isBuffer")in(a=o)?Object.defineProperty(a,s,{value:c,enumerable:!0,configurable:!0,writable:!0}):a[s]=c,i));t.default=(e,t,r,n)=>{const o="undefined"!==typeof WebGLRenderingContext&&e instanceof WebGLRenderingContext;let i=r.dtype,a=r.shape.slice(),s=e.getParameter(e.MAX_TEXTURE_SIZE);if(a[0]<0||a[0]>s||a[1]<0||a[1]>s)throw new Error("gl-react: Invalid texture size");let c=function(e,t){return 3===e.length?1===t[2]&&t[1]===e[0]*e[2]&&t[0]===e[2]:1===t[0]&&t[1]===e[0]}(a,r.stride.slice()),p=0;"float32"===i?p=e.FLOAT:"float64"===i?(p=e.FLOAT,c=!1,i="float32"):"uint8"===i?p=e.UNSIGNED_BYTE:(p=e.UNSIGNED_BYTE,c=!1,i="uint8");let d,h=0,v=0;if(2===a.length)v=h=e.LUMINANCE,a=[a[0],a[1],1],r=(0,l.default)(r.data,a,[r.stride[0],r.stride[1],1],r.offset);else{if(3!==a.length)throw new Error("gl-texture2d: Invalid shape for texture");if(1===a[2])v=h=e.ALPHA,o||(n=!1);else if(2===a[2])v=h=e.LUMINANCE_ALPHA,o||(n=!1);else if(3===a[2])h=e.RGB,v=o?e.RGB:e.RGB32F;else{if(4!==a[2])throw new Error("gl-texture2d: Invalid shape for pixel coords");h=e.RGBA,v=o?e.RGBA:e.RGBA32F}}p!==e.FLOAT||n||(p=e.UNSIGNED_BYTE,c=!1);let m,g=r.size;if(c)d=0===r.offset&&r.data.length===g?r.data:r.data.subarray(r.offset,r.offset+g);else{let t=[a[2],a[2]*a[0],1];if("float32"!==i&&"float64"!==i||p!==e.UNSIGNED_BYTE){m=u.default.malloc(g,i);let e=(0,l.default)(m,a,t,0);f.default.assign(e,r)}else{m=u.default.malloc(g,"uint8"),function(e,t){f.default.muls(e,t,255)}((0,l.default)(m,a,t,0),r)}d=m.subarray(0,g)}e.texImage2D(e.TEXTURE_2D,0,v,a[0],a[1],0,h,p,d),m&&u.default.free(m)}}).call(this,r("HDXh").Buffer,r("ntbh"))},OTww:function(e,t,r){"use strict";(function(e){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var n,o=(n=r("Ni9w"))&&n.__esModule?n:{default:n};const i="undefined"===typeof window?e:window,a="__webglTextureLoader_registry";var s=i[a]||(i[a]=new o.default);t.default=s}).call(this,r("ntbh"))},QLaP:function(e,t,r){"use strict";e.exports=function(e,t,r,n,o,i,a,s){if(!e){var c;if(void 0===t)c=new Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else{var l=[r,n,o,i,a,s],f=0;(c=new Error(t.replace(/%s/g,(function(){return l[f++]})))).name="Invariant Violation"}throw c.framesToPop=1,c}}},QM7d:function(e,t,r){"use strict";var n=r("033R");function o(){this.argTypes=[],this.shimArgs=[],this.arrayArgs=[],this.arrayBlockIndices=[],this.scalarArgs=[],this.offsetArgs=[],this.offsetArgIndex=[],this.indexArgs=[],this.shapeArgs=[],this.funcName="",this.pre=null,this.body=null,this.post=null,this.debug=!1}e.exports=function(e){var t=new o;t.pre=e.pre,t.body=e.body,t.post=e.post;var r=e.args.slice(0);t.argTypes=r;for(var i=0;i<r.length;++i){var a=r[i];if("array"===a||"object"===typeof a&&a.blockIndices){if(t.argTypes[i]="array",t.arrayArgs.push(i),t.arrayBlockIndices.push(a.blockIndices?a.blockIndices:0),t.shimArgs.push("array"+i),i<t.pre.args.length&&t.pre.args[i].count>0)throw new Error("cwise: pre() block may not reference array args");if(i<t.post.args.length&&t.post.args[i].count>0)throw new Error("cwise: post() block may not reference array args")}else if("scalar"===a)t.scalarArgs.push(i),t.shimArgs.push("scalar"+i);else if("index"===a){if(t.indexArgs.push(i),i<t.pre.args.length&&t.pre.args[i].count>0)throw new Error("cwise: pre() block may not reference array index");if(i<t.body.args.length&&t.body.args[i].lvalue)throw new Error("cwise: body() block may not write to array index");if(i<t.post.args.length&&t.post.args[i].count>0)throw new Error("cwise: post() block may not reference array index")}else if("shape"===a){if(t.shapeArgs.push(i),i<t.pre.args.length&&t.pre.args[i].lvalue)throw new Error("cwise: pre() block may not write to array shape");if(i<t.body.args.length&&t.body.args[i].lvalue)throw new Error("cwise: body() block may not write to array shape");if(i<t.post.args.length&&t.post.args[i].lvalue)throw new Error("cwise: post() block may not write to array shape")}else{if("object"!==typeof a||!a.offset)throw new Error("cwise: Unknown argument type "+r[i]);t.argTypes[i]="offset",t.offsetArgs.push({array:a.array,offset:a.offset}),t.offsetArgIndex.push(i)}}if(t.arrayArgs.length<=0)throw new Error("cwise: No array arguments specified");if(t.pre.args.length>r.length)throw new Error("cwise: Too many arguments in pre() block");if(t.body.args.length>r.length)throw new Error("cwise: Too many arguments in body() block");if(t.post.args.length>r.length)throw new Error("cwise: Too many arguments in post() block");return t.debug=!!e.printCode||!!e.debug,t.funcName=e.funcName||"cwise",t.blockSize=e.blockSize||64,n(t)}},R9Te:function(e,t,r){"use strict";var n=r("CyWo"),o=r("z08I"),i=r("+0iv"),a=r("vCtr");function s(e){return"__proto__"!==e&&"constructor"!==e&&"prototype"!==e}e.exports=function(e,t,r){if(!a(e))return e;if(Array.isArray(t)&&(t=[].concat.apply([],t).join(".")),"string"!==typeof t)return e;for(var c=n(t,{sep:".",brackets:!0}).filter(s),l=c.length,f=-1,u=e;++f<l;){var p=c[f];f===l-1?i(u[p])&&i(r)?u[p]=o({},u[p],r):u[p]=r:(a(u[p])||(u[p]={}),u=u[p])}return e}},RjOF:function(e,t,r){"use strict";var n,o="";e.exports=function(e,t){if("string"!==typeof e)throw new TypeError("expected a string");if(1===t)return e;if(2===t)return e+e;var r=e.length*t;if(n!==e||"undefined"===typeof n)n=e,o="";else if(o.length>=r)return o.substr(0,r);for(;r>o.length&&t>1;)1&t&&(o+=e),t>>=1,e+=e;return o=(o+=e).substr(0,r)}},Ry8g:function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;t.default=e=>{const t=e.getExtension("WEBGL_lose_context");t&&t.loseContext()}},SMLl:function(e,t,r){"use strict";var n=r("RjOF");e.exports=function(e,t,r){return n(r="undefined"!==typeof r?r+"":" ",t)+e}},TBio:function(e,t,r){"use strict";var n=r("F16p");function o(e,t,r){var n,o,i=e.length,a=t.arrayArgs.length,s=t.indexArgs.length>0,c=[],l=[],f=0,u=0;for(n=0;n<i;++n)l.push(["i",n,"=0"].join(""));for(o=0;o<a;++o)for(n=0;n<i;++n)u=f,f=e[n],0===n?l.push(["d",o,"s",n,"=t",o,"p",f].join("")):l.push(["d",o,"s",n,"=(t",o,"p",f,"-s",u,"*t",o,"p",u,")"].join(""));for(l.length>0&&c.push("var "+l.join(",")),n=i-1;n>=0;--n)f=e[n],c.push(["for(i",n,"=0;i",n,"<s",f,";++i",n,"){"].join(""));for(c.push(r),n=0;n<i;++n){for(u=f,f=e[n],o=0;o<a;++o)c.push(["p",o,"+=d",o,"s",n].join(""));s&&(n>0&&c.push(["index[",u,"]-=s",u].join("")),c.push(["++index[",f,"]"].join(""))),c.push("}")}return c.join("\n")}function i(e,t,r){for(var n=e.body,o=[],i=[],a=0;a<e.args.length;++a){var s=e.args[a];if(!(s.count<=0)){var c=new RegExp(s.name,"g"),l="",f=t.arrayArgs.indexOf(a);switch(t.argTypes[a]){case"offset":var u=t.offsetArgIndex.indexOf(a);f=t.offsetArgs[u].array,l="+q"+u;case"array":l="p"+f+l;var p="l"+a,d="a"+f;if(0===t.arrayBlockIndices[f])1===s.count?"generic"===r[f]?s.lvalue?(o.push(["var ",p,"=",d,".get(",l,")"].join("")),n=n.replace(c,p),i.push([d,".set(",l,",",p,")"].join(""))):n=n.replace(c,[d,".get(",l,")"].join("")):n=n.replace(c,[d,"[",l,"]"].join("")):"generic"===r[f]?(o.push(["var ",p,"=",d,".get(",l,")"].join("")),n=n.replace(c,p),s.lvalue&&i.push([d,".set(",l,",",p,")"].join(""))):(o.push(["var ",p,"=",d,"[",l,"]"].join("")),n=n.replace(c,p),s.lvalue&&i.push([d,"[",l,"]=",p].join("")));else{for(var h=[s.name],v=[l],m=0;m<Math.abs(t.arrayBlockIndices[f]);m++)h.push("\\s*\\[([^\\]]+)\\]"),v.push("$"+(m+1)+"*t"+f+"b"+m);if(c=new RegExp(h.join(""),"g"),l=v.join("+"),"generic"===r[f])throw new Error("cwise: Generic arrays not supported in combination with blocks!");n=n.replace(c,[d,"[",l,"]"].join(""))}break;case"scalar":n=n.replace(c,"Y"+t.scalarArgs.indexOf(a));break;case"index":n=n.replace(c,"index");break;case"shape":n=n.replace(c,"shape")}}}return[o.join("\n"),n,i.join("\n")].join("\n").trim()}function a(e){for(var t=new Array(e.length),r=!0,n=0;n<e.length;++n){var o=e[n],i=o.match(/\d+/);i=i?i[0]:"",0===o.charAt(0)?t[n]="u"+o.charAt(1)+i:t[n]=o.charAt(0)+i,n>0&&(r=r&&t[n]===t[n-1])}return r?t[0]:t.join("")}e.exports=function(e,t){for(var r=t[1].length-Math.abs(e.arrayBlockIndices[0])|0,s=new Array(e.arrayArgs.length),c=new Array(e.arrayArgs.length),l=0;l<e.arrayArgs.length;++l)c[l]=t[2*l],s[l]=t[2*l+1];var f=[],u=[],p=[],d=[],h=[];for(l=0;l<e.arrayArgs.length;++l){e.arrayBlockIndices[l]<0?(p.push(0),d.push(r),f.push(r),u.push(r+e.arrayBlockIndices[l])):(p.push(e.arrayBlockIndices[l]),d.push(e.arrayBlockIndices[l]+r),f.push(0),u.push(e.arrayBlockIndices[l]));for(var v=[],m=0;m<s[l].length;m++)p[l]<=s[l][m]&&s[l][m]<d[l]&&v.push(s[l][m]-p[l]);h.push(v)}var g=["SS"],y=["'use strict'"],b=[];for(m=0;m<r;++m)b.push(["s",m,"=SS[",m,"]"].join(""));for(l=0;l<e.arrayArgs.length;++l){g.push("a"+l),g.push("t"+l),g.push("p"+l);for(m=0;m<r;++m)b.push(["t",l,"p",m,"=t",l,"[",p[l]+m,"]"].join(""));for(m=0;m<Math.abs(e.arrayBlockIndices[l]);++m)b.push(["t",l,"b",m,"=t",l,"[",f[l]+m,"]"].join(""))}for(l=0;l<e.scalarArgs.length;++l)g.push("Y"+l);if(e.shapeArgs.length>0&&b.push("shape=SS.slice(0)"),e.indexArgs.length>0){var x=new Array(r);for(l=0;l<r;++l)x[l]="0";b.push(["index=[",x.join(","),"]"].join(""))}for(l=0;l<e.offsetArgs.length;++l){var w=e.offsetArgs[l],_=[];for(m=0;m<w.offset.length;++m)0!==w.offset[m]&&(1===w.offset[m]?_.push(["t",w.array,"p",m].join("")):_.push([w.offset[m],"*t",w.array,"p",m].join("")));0===_.length?b.push("q"+l+"=0"):b.push(["q",l,"=",_.join("+")].join(""))}var E=n([].concat(e.pre.thisVars).concat(e.body.thisVars).concat(e.post.thisVars));for((b=b.concat(E)).length>0&&y.push("var "+b.join(",")),l=0;l<e.arrayArgs.length;++l)y.push("p"+l+"|=0");e.pre.body.length>3&&y.push(i(e.pre,e,c));var S=i(e.body,e,c),O=function(e){for(var t=0,r=e[0].length;t<r;){for(var n=1;n<e.length;++n)if(e[n][t]!==e[0][t])return t;++t}return t}(h);O<r?y.push(function(e,t,r,n){for(var i=t.length,a=r.arrayArgs.length,s=r.blockSize,c=r.indexArgs.length>0,l=[],f=0;f<a;++f)l.push(["var offset",f,"=p",f].join(""));for(f=e;f<i;++f)l.push(["for(var j"+f+"=SS[",t[f],"]|0;j",f,">0;){"].join("")),l.push(["if(j",f,"<",s,"){"].join("")),l.push(["s",t[f],"=j",f].join("")),l.push(["j",f,"=0"].join("")),l.push(["}else{s",t[f],"=",s].join("")),l.push(["j",f,"-=",s,"}"].join("")),c&&l.push(["index[",t[f],"]=j",f].join(""));for(f=0;f<a;++f){for(var u=["offset"+f],p=e;p<i;++p)u.push(["j",p,"*t",f,"p",t[p]].join(""));l.push(["p",f,"=(",u.join("+"),")"].join(""))}for(l.push(o(t,r,n)),f=e;f<i;++f)l.push("}");return l.join("\n")}(O,h[0],e,S)):y.push(o(h[0],e,S)),e.post.body.length>3&&y.push(i(e.post,e,c)),e.debug&&console.log("-----Generated cwise routine for ",t,":\n"+y.join("\n")+"\n----------");var R=[e.funcName||"unnamed","_cwise_loop_",s[0].join("s"),"m",O,a(c)].join("");return new Function(["function ",R,"(",g.join(","),"){",y.join("\n"),"} return ",R].join(""))()}},TGEO:function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),Object.defineProperty(t,"WebGLTextureLoader",{enumerable:!0,get:function(){return n.default}}),Object.defineProperty(t,"WebGLTextureLoaderAsyncHashCache",{enumerable:!0,get:function(){return o.default}}),Object.defineProperty(t,"WebGLTextureLoaderSyncHashCache",{enumerable:!0,get:function(){return i.default}}),Object.defineProperty(t,"LoadersRegistry",{enumerable:!0,get:function(){return a.default}}),Object.defineProperty(t,"LoaderResolver",{enumerable:!0,get:function(){return s.default}}),Object.defineProperty(t,"globalRegistry",{enumerable:!0,get:function(){return c.default}});var n=l(r("HbIt")),o=l(r("cDsr")),i=l(r("VYxY")),a=l(r("Ni9w")),s=l(r("LhdL")),c=l(r("OTww"));function l(e){return e&&e.__esModule?e:{default:e}}},TKux:function(e,t,r){"use strict";r.d(t,"b",(function(){return dc})),r.d(t,"c",(function(){return hc})),r.d(t,"a",(function(){return vc}));var n={};r.r(n),r.d(n,"n",(function(){return xe})),r.d(n,"title",(function(){return we})),r.d(n,"Shader",(function(){return _e}));var o={};r.r(o),r.d(o,"n",(function(){return Se})),r.d(o,"title",(function(){return Oe})),r.d(o,"exportSize",(function(){return Re})),r.d(o,"exportStart",(function(){return Te})),r.d(o,"exportEnd",(function(){return ze})),r.d(o,"exportFramePerSecond",(function(){return Ce})),r.d(o,"exportSpeed",(function(){return Pe})),r.d(o,"Shader",(function(){return Ie}));var i={};r.r(i),r.d(i,"n",(function(){return Ae})),r.d(i,"title",(function(){return ke})),r.d(i,"Shader",(function(){return De}));var a={};r.r(a),r.d(a,"n",(function(){return Fe})),r.d(a,"title",(function(){return qe})),r.d(a,"Shader",(function(){return Ge}));var s={};r.r(s),r.d(s,"n",(function(){return We})),r.d(s,"title",(function(){return Xe})),r.d(s,"Shader",(function(){return Ke}));var c={};r.r(c),r.d(c,"n",(function(){return Qe})),r.d(c,"title",(function(){return Ze})),r.d(c,"Shader",(function(){return Je}));var l={};r.r(l),r.d(l,"n",(function(){return tt})),r.d(l,"title",(function(){return rt})),r.d(l,"Shader",(function(){return nt}));var f={};r.r(f),r.d(f,"n",(function(){return it})),r.d(f,"title",(function(){return at})),r.d(f,"Shader",(function(){return st}));var u={};r.r(u),r.d(u,"n",(function(){return lt})),r.d(u,"title",(function(){return ft})),r.d(u,"exportSize",(function(){return ut})),r.d(u,"exportStart",(function(){return pt})),r.d(u,"exportEnd",(function(){return dt})),r.d(u,"exportFramePerSecond",(function(){return ht})),r.d(u,"exportSpeed",(function(){return vt})),r.d(u,"Shader",(function(){return mt}));var p={};r.r(p),r.d(p,"n",(function(){return yt})),r.d(p,"title",(function(){return bt})),r.d(p,"Shader",(function(){return xt}));var d={};r.r(d),r.d(d,"n",(function(){return _t})),r.d(d,"title",(function(){return Et})),r.d(d,"Shader",(function(){return St}));var h={};r.r(h),r.d(h,"n",(function(){return Rt})),r.d(h,"title",(function(){return Tt})),r.d(h,"Shader",(function(){return zt}));var v={};r.r(v),r.d(v,"n",(function(){return Pt})),r.d(v,"title",(function(){return It})),r.d(v,"Shader",(function(){return jt}));var m={};r.r(m),r.d(m,"n",(function(){return kt})),r.d(m,"title",(function(){return Dt})),r.d(m,"Shader",(function(){return Lt}));var g={};r.r(g),r.d(g,"n",(function(){return Wt})),r.d(g,"title",(function(){return Xt})),r.d(g,"Shader",(function(){return Kt}));var y={};r.r(y),r.d(y,"n",(function(){return Jt})),r.d(y,"title",(function(){return er})),r.d(y,"Shader",(function(){return tr}));var b={};r.r(b),r.d(b,"n",(function(){return nr})),r.d(b,"title",(function(){return or})),r.d(b,"Shader",(function(){return ir}));var x={};r.r(x),r.d(x,"n",(function(){return sr})),r.d(x,"title",(function(){return cr})),r.d(x,"Shader",(function(){return lr}));var w={};r.r(w),r.d(w,"n",(function(){return ur})),r.d(w,"title",(function(){return pr})),r.d(w,"Shader",(function(){return dr}));var _={};r.r(_),r.d(_,"n",(function(){return vr})),r.d(_,"title",(function(){return mr})),r.d(_,"Shader",(function(){return gr}));var E={};r.r(E),r.d(E,"n",(function(){return xr})),r.d(E,"title",(function(){return wr})),r.d(E,"Shader",(function(){return _r}));var S={};r.r(S),r.d(S,"n",(function(){return Or})),r.d(S,"title",(function(){return Rr})),r.d(S,"Shader",(function(){return Tr}));var O={};r.r(O),r.d(O,"n",(function(){return Cr})),r.d(O,"title",(function(){return Pr})),r.d(O,"Shader",(function(){return Ir}));var R={};r.r(R),r.d(R,"n",(function(){return Ar})),r.d(R,"title",(function(){return kr})),r.d(R,"Shader",(function(){return Dr}));var T={};r.r(T),r.d(T,"n",(function(){return Nr})),r.d(T,"title",(function(){return Mr})),r.d(T,"Shader",(function(){return Ur}));var z={};r.r(z),r.d(z,"n",(function(){return qr})),r.d(z,"title",(function(){return $r})),r.d(z,"Shader",(function(){return Gr}));var C={};r.r(C),r.d(C,"n",(function(){return Wr})),r.d(C,"title",(function(){return Xr})),r.d(C,"exportSize",(function(){return Kr})),r.d(C,"exportStart",(function(){return Yr})),r.d(C,"exportEnd",(function(){return Qr})),r.d(C,"exportFramePerSecond",(function(){return Zr})),r.d(C,"exportSpeed",(function(){return Jr})),r.d(C,"Shader",(function(){return en}));var P={};r.r(P),r.d(P,"n",(function(){return nn})),r.d(P,"title",(function(){return on})),r.d(P,"Shader",(function(){return an}));var I={};r.r(I),r.d(I,"n",(function(){return ln})),r.d(I,"title",(function(){return fn})),r.d(I,"Shader",(function(){return un}));var j={};r.r(j),r.d(j,"n",(function(){return dn})),r.d(j,"title",(function(){return hn})),r.d(j,"Shader",(function(){return vn}));var A={};r.r(A),r.d(A,"n",(function(){return gn})),r.d(A,"title",(function(){return yn})),r.d(A,"Shader",(function(){return bn}));var k={};r.r(k),r.d(k,"n",(function(){return wn})),r.d(k,"title",(function(){return _n})),r.d(k,"Shader",(function(){return Sn}));var D={};r.r(D),r.d(D,"n",(function(){return Rn})),r.d(D,"title",(function(){return Tn})),r.d(D,"Shader",(function(){return zn}));var L={};r.r(L),r.d(L,"n",(function(){return Pn})),r.d(L,"title",(function(){return In})),r.d(L,"Shader",(function(){return jn}));var N={};r.r(N),r.d(N,"n",(function(){return kn})),r.d(N,"title",(function(){return Dn})),r.d(N,"Shader",(function(){return Ln}));var M={};r.r(M),r.d(M,"n",(function(){return Un})),r.d(M,"title",(function(){return Bn})),r.d(M,"Shader",(function(){return Fn}));var U={};r.r(U),r.d(U,"n",(function(){return Gn})),r.d(U,"title",(function(){return Hn})),r.d(U,"Shader",(function(){return Vn}));var B={};r.r(B),r.d(B,"n",(function(){return Xn})),r.d(B,"title",(function(){return Kn})),r.d(B,"Shader",(function(){return Yn}));var F={};r.r(F),r.d(F,"n",(function(){return Jn})),r.d(F,"title",(function(){return eo})),r.d(F,"Shader",(function(){return to}));var q={};r.r(q),r.d(q,"n",(function(){return no})),r.d(q,"title",(function(){return oo})),r.d(q,"Shader",(function(){return io}));var $={};r.r($),r.d($,"n",(function(){return so})),r.d($,"title",(function(){return co})),r.d($,"Shader",(function(){return lo}));var G={};r.r(G),r.d(G,"n",(function(){return uo})),r.d(G,"title",(function(){return po})),r.d(G,"Shader",(function(){return ho}));var H={};r.r(H),r.d(H,"n",(function(){return mo})),r.d(H,"title",(function(){return go})),r.d(H,"Shader",(function(){return yo}));var V={};r.r(V),r.d(V,"n",(function(){return wo})),r.d(V,"title",(function(){return _o})),r.d(V,"Shader",(function(){return Eo}));var W={};r.r(W),r.d(W,"n",(function(){return Oo})),r.d(W,"title",(function(){return Ro})),r.d(W,"Shader",(function(){return To}));var X={};r.r(X),r.d(X,"n",(function(){return Co})),r.d(X,"title",(function(){return Po})),r.d(X,"Shader",(function(){return Io}));var K={};r.r(K),r.d(K,"n",(function(){return Ao})),r.d(K,"title",(function(){return ko})),r.d(K,"Shader",(function(){return Do}));var Y={};r.r(Y),r.d(Y,"n",(function(){return No})),r.d(Y,"title",(function(){return Mo})),r.d(Y,"Shader",(function(){return Uo}));var Q={};r.r(Q),r.d(Q,"n",(function(){return Fo})),r.d(Q,"title",(function(){return qo})),r.d(Q,"exportSize",(function(){return $o})),r.d(Q,"exportStart",(function(){return Go})),r.d(Q,"exportEnd",(function(){return Ho})),r.d(Q,"exportFramePerSecond",(function(){return Vo})),r.d(Q,"exportSpeed",(function(){return Wo})),r.d(Q,"Shader",(function(){return Xo}));var Z={};r.r(Z),r.d(Z,"n",(function(){return Qo})),r.d(Z,"title",(function(){return Zo})),r.d(Z,"Shader",(function(){return Jo}));var J={};r.r(J),r.d(J,"n",(function(){return ti})),r.d(J,"title",(function(){return ri})),r.d(J,"exportSize",(function(){return ni})),r.d(J,"exportStart",(function(){return oi})),r.d(J,"exportEnd",(function(){return ii})),r.d(J,"exportFramePerSecond",(function(){return ai})),r.d(J,"exportSpeed",(function(){return si})),r.d(J,"Shader",(function(){return ci}));var ee={};r.r(ee),r.d(ee,"n",(function(){return fi})),r.d(ee,"title",(function(){return ui})),r.d(ee,"Shader",(function(){return pi}));var te={};r.r(te),r.d(te,"n",(function(){return hi})),r.d(te,"title",(function(){return vi})),r.d(te,"Shader",(function(){return mi}));var re={};r.r(re),r.d(re,"n",(function(){return yi})),r.d(re,"title",(function(){return bi})),r.d(re,"Shader",(function(){return xi}));var ne={};r.r(ne),r.d(ne,"n",(function(){return _i})),r.d(ne,"title",(function(){return Ei})),r.d(ne,"exportSize",(function(){return Si})),r.d(ne,"exportStart",(function(){return Oi})),r.d(ne,"exportEnd",(function(){return Ri})),r.d(ne,"exportFramePerSecond",(function(){return Ti})),r.d(ne,"exportSpeed",(function(){return zi})),r.d(ne,"Shader",(function(){return Ci}));var oe={};r.r(oe),r.d(oe,"n",(function(){return Ii})),r.d(oe,"title",(function(){return ji})),r.d(oe,"Shader",(function(){return Ai}));var ie={};r.r(ie),r.d(ie,"n",(function(){return Di})),r.d(ie,"title",(function(){return Li})),r.d(ie,"exportSize",(function(){return Ni})),r.d(ie,"exportStart",(function(){return Mi})),r.d(ie,"exportEnd",(function(){return Ui})),r.d(ie,"exportFramePerSecond",(function(){return Bi})),r.d(ie,"exportSpeed",(function(){return Fi})),r.d(ie,"Shader",(function(){return qi}));var ae={};r.r(ae),r.d(ae,"exportSize",(function(){return Vi})),r.d(ae,"exportStart",(function(){return Wi})),r.d(ae,"exportEnd",(function(){return Xi})),r.d(ae,"exportFramePerSecond",(function(){return Ki})),r.d(ae,"exportSpeed",(function(){return Yi})),r.d(ae,"exportMP4vb",(function(){return Qi})),r.d(ae,"n",(function(){return Zi})),r.d(ae,"title",(function(){return Ji})),r.d(ae,"nfts",(function(){return ea})),r.d(ae,"Shader",(function(){return ra}));var se={};r.r(se),r.d(se,"n",(function(){return ia})),r.d(se,"title",(function(){return aa})),r.d(se,"description",(function(){return sa})),r.d(se,"Shader",(function(){return ca}));var ce={};r.r(ce),r.d(ce,"n",(function(){return ua})),r.d(ce,"title",(function(){return pa})),r.d(ce,"Shader",(function(){return da}));var le={};r.r(le),r.d(le,"n",(function(){return va})),r.d(le,"title",(function(){return ma})),r.d(le,"exportEnd",(function(){return ga})),r.d(le,"exportFramePerSecond",(function(){return ya})),r.d(le,"preload",(function(){return ba})),r.d(le,"Shader",(function(){return xa}));var fe={};r.r(fe),r.d(fe,"n",(function(){return _a})),r.d(fe,"title",(function(){return Ea})),r.d(fe,"exportEnd",(function(){return Sa})),r.d(fe,"exportFramePerSecond",(function(){return Oa})),r.d(fe,"exportSpeed",(function(){return Ra})),r.d(fe,"Logic",(function(){return Ta})),r.d(fe,"Shader",(function(){return ja}));var ue={};r.r(ue),r.d(ue,"n",(function(){return Da})),r.d(ue,"title",(function(){return La})),r.d(ue,"exportSize",(function(){return Na})),r.d(ue,"exportStart",(function(){return Ma})),r.d(ue,"exportEnd",(function(){return Ua})),r.d(ue,"exportFramePerSecond",(function(){return Ba})),r.d(ue,"exportSpeed",(function(){return Fa})),r.d(ue,"exportMP4vb",(function(){return qa})),r.d(ue,"Logic",(function(){return Ga})),r.d(ue,"Shader",(function(){return Xa}));var pe={};r.r(pe),r.d(pe,"n",(function(){return Ya})),r.d(pe,"title",(function(){return Qa})),r.d(pe,"exportEnd",(function(){return Za})),r.d(pe,"nfts",(function(){return Ja})),r.d(pe,"Shader",(function(){return es}));var de={};r.r(de),r.d(de,"n",(function(){return rs})),r.d(de,"title",(function(){return ns})),r.d(de,"exportSize",(function(){return os})),r.d(de,"exportStart",(function(){return is})),r.d(de,"exportEnd",(function(){return as})),r.d(de,"exportFramePerSecond",(function(){return ss})),r.d(de,"exportSpeed",(function(){return cs})),r.d(de,"exportSkipFrame",(function(){return ls})),r.d(de,"exportPaletteGenOnce",(function(){return fs})),r.d(de,"exportPaletteSize",(function(){return us})),r.d(de,"nfts",(function(){return ps})),r.d(de,"Shader",(function(){return ds}));var he={};r.r(he),r.d(he,"n",(function(){return ms})),r.d(he,"title",(function(){return gs})),r.d(he,"exportSize",(function(){return ys})),r.d(he,"exportStart",(function(){return bs})),r.d(he,"exportEnd",(function(){return xs})),r.d(he,"exportFramePerSecond",(function(){return ws})),r.d(he,"exportSpeed",(function(){return _s})),r.d(he,"exportSkipFrame",(function(){return Es})),r.d(he,"exportPaletteGenOnce",(function(){return Ss})),r.d(he,"exportPaletteSize",(function(){return Os})),r.d(he,"Shader",(function(){return Rs}));var ve={};r.r(ve),r.d(ve,"n",(function(){return Cs})),r.d(ve,"title",(function(){return Ps})),r.d(ve,"exportSize",(function(){return Is})),r.d(ve,"exportStart",(function(){return js})),r.d(ve,"exportEnd",(function(){return As})),r.d(ve,"exportFramePerSecond",(function(){return ks})),r.d(ve,"exportSpeed",(function(){return Ds})),r.d(ve,"exportSkipFrame",(function(){return Ls})),r.d(ve,"exportPaletteGenOnce",(function(){return Ns})),r.d(ve,"exportPaletteSize",(function(){return Ms})),r.d(ve,"Shader",(function(){return Us}));var me={};r.r(me),r.d(me,"n",(function(){return qs})),r.d(me,"title",(function(){return $s})),r.d(me,"exportSize",(function(){return Gs})),r.d(me,"exportStart",(function(){return Hs})),r.d(me,"exportEnd",(function(){return Vs})),r.d(me,"exportFramePerSecond",(function(){return Ws})),r.d(me,"exportSpeed",(function(){return Xs})),r.d(me,"exportSkipFrame",(function(){return Ks})),r.d(me,"exportPaletteGenOnce",(function(){return Ys})),r.d(me,"exportPaletteSize",(function(){return Qs})),r.d(me,"Shader",(function(){return Zs}));var ge={};r.r(ge),r.d(ge,"n",(function(){return tc})),r.d(ge,"title",(function(){return rc})),r.d(ge,"exportSize",(function(){return nc})),r.d(ge,"exportStart",(function(){return oc})),r.d(ge,"exportEnd",(function(){return ic})),r.d(ge,"exportFramePerSecond",(function(){return ac})),r.d(ge,"exportSpeed",(function(){return sc})),r.d(ge,"exportPaletteGenOnce",(function(){return cc})),r.d(ge,"exportPaletteSize",(function(){return lc})),r.d(ge,"Shader",(function(){return fc}));var ye=r("nKUr"),be=r("rr/c");const xe=1,we="Hello 2020",_e=({time:e})=>Object(ye.jsx)(be.Node,{shader:Ee.day001,uniforms:{time:e}}),Ee=be.Shaders.create({day001:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
float vingt (vec2 p) {
...
}`}}),Se=2,Oe="stripes",Re=400,Te=0,ze=60,Ce=24,Pe=1,Ie=({time:e})=>Object(ye.jsx)(be.Node,{shader:je.node,uniforms:{time:e}}),je=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),Ae=3,ke="zephyr",De=({time:e})=>Object(ye.jsx)(be.Node,{shader:Le.node,uniforms:{time:e}}),Le=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}});var Ne=r("q1tI"),Me=r.n(Ne);const Ue=be.Shaders.create({InitGameOfLife:{frag:be.GLSL`
  precision highp float;
  uniform float seed;
  // i
  varying vec2 uv;
  ...
  }`}}),Be=Me.a.memo((({tick:e,size:t,refreshEveryTicks:r})=>e%(r||1/0)===0?Object(ye.jsx)(be.Node,{shader:Ue.InitGameOfLife,uniforms:{seed:Math.random()},width:t,height:t,backbuffering:!0,sync:!0}):Object(ye.jsx)(be.Node,{shader:Ue.GameOfLife,width:t,height:t,backbuffering:!0,sync:!0,uniforms:{t:be.Uniform.Backbuffer,size:t}}))),Fe=4,qe="Ray of Life";let $e;const Ge=({time:e})=>{$e||($e=e);const t=e-$e,r=Math.floor(10*t),n=r+25,o=10*(1+Math.floor(r/50)),i=10*(1+Math.floor(n/50));return Object(ye.jsx)(He,{time:e,a:Object(ye.jsx)(be.NearestCopy,{children:Object(ye.jsx)(Be,{refreshEveryTicks:50,tick:r,size:o})}),b:Object(ye.jsx)(be.NearestCopy,{children:Object(ye.jsx)(Be,{refreshEveryTicks:50,tick:n,size:i})})})},He=({a:e,b:t,time:r})=>Object(ye.jsx)(be.Node,{uniforms:{a:e,b:t,time:r},shader:Ve.main}),Ve=be.Shaders.create({main:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),We=5,Xe="Here We Go Again",Ke=({time:e})=>Object(ye.jsx)(be.Node,{shader:Ye.node,uniforms:{time:e}}),Ye=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    sqrt(vec3(1. - shad));
  gl_FragColor = vec4(c,1.0);
}`}}),Qe=6,Ze="Bestagons",Je=({time:e})=>Object(ye.jsx)(be.Node,{shader:et.node,uniforms:{time:e}}),et=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),tt=7,rt="Worms party",nt=({time:e})=>Object(ye.jsx)(be.Node,{shader:ot.node,uniforms:{time:e}}),ot=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    sqrt(vec3(1. - shad));
  gl_FragColor = vec4(c,1.0);
}`}}),it=8,at="moontains",st=({time:e})=>Object(ye.jsx)(be.Node,{shader:ct.node,uniforms:{time:e}}),ct=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),lt=9,ft="Virus",ut=400,pt=16.3,dt=26,ht=24,vt=.8,mt=({time:e})=>Object(ye.jsx)(be.Node,{shader:gt.node,uniforms:{time:e}}),gt=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),yt=10,bt="ring",xt=({time:e})=>Object(ye.jsx)(be.Node,{shader:wt.node,uniforms:{time:e}}),wt=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),_t=11,Et="magic mouse",St=({time:e})=>Object(ye.jsx)(be.Node,{shader:Ot.node,uniforms:{time:e}}),Ot=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Rt=12,Tt="floor is lava",zt=({time:e})=>Object(ye.jsx)(be.Node,{shader:Ct.node,uniforms:{time:e}}),Ct=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Pt=13,It="chip",jt=({time:e})=>Object(ye.jsx)(be.Node,{shader:At.node,uniforms:{time:e}}),At=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
`}}),kt=14,Dt="seizure",Lt=({time:e})=>Object(ye.jsx)(be.Node,{shader:Nt.node,uniforms:{time:e}}),Nt=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Mt=be.Shaders.create({blur1D:{frag:be.GLSL`precision highp float;
varying vec2 uv;
uniform sampler2D t;
...
}`}});var Ut=({width:e,height:t,pixelRatio:r,direction:n,children:o})=>Object(ye.jsx)(be.Node,{shader:Mt.blur1D,width:e,height:t,pixelRatio:r,uniforms:{direction:n,resolution:be.Uniform.Resolution,t:o}});const Bt=Math.sqrt(2)/2;var Ft=(e,t,r)=>{const n=2*t*Math.ceil(e/2)/r;switch((e-1)%4){case 0:return[n,0];case 1:return[0,n];case 2:return[n*Bt,n*Bt];case 3:return[n*Bt,-n*Bt]}};const qt=({width:e,height:t,pixelRatio:r,factor:n,children:o,passes:i,directionForPass:a})=>{const s=c=>c<=0?o:Object(ye.jsx)(Ut,{width:e,height:t,pixelRatio:r,direction:a(c,n,i),children:s(c-1)});return s(i)};qt.defaultProps={passes:2,directionForPass:Ft};var $t=qt;const Gt=be.Shaders.create({blur1D:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
...
}`}});var Ht=({width:e,height:t,map:r,pixelRatio:n,direction:o,children:i})=>Object(ye.jsx)(be.Node,{shader:Gt.blur1D,width:e,height:t,pixelRatio:n,uniforms:{direction:o,resolution:be.Uniform.Resolution,t:i,map:r}});const Vt=({width:e,height:t,map:r,pixelRatio:n,factor:o,children:i,passes:a,directionForPass:s})=>{const c=l=>l<=0?i:Object(ye.jsx)(Ht,{width:e,height:t,map:r,pixelRatio:n,direction:s(l,o,a),children:c(l-1)});return c(a)};Vt.defaultProps={passes:2,directionForPass:Ft};const Wt=15,Xt="parametric",Kt=({time:e})=>Object(ye.jsx)(be.LinearCopy,{children:Object(ye.jsx)(Qt,{persistence:.98+.02*Math.cos(e)+-.8*Math.exp(-e),children:Object(ye.jsx)($t,{passes:4,factor:.2,children:Object(ye.jsx)(Yt,{time:e})})})}),Yt=({time:e})=>Object(ye.jsx)(be.Node,{shader:Zt.node,uniforms:{time:e}}),Qt=({children:e,persistence:t})=>Object(ye.jsx)(be.Node,{shader:Zt.persistence,backbuffering:!0,uniforms:{t:e,back:be.Uniform.Backbuffer,persistence:t}}),Zt=be.Shaders.create({persistence:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),Jt=16,er="reuleaux",tr=({time:e})=>Object(ye.jsx)(be.Node,{shader:rr.node,uniforms:{time:e}}),rr=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    color(0.5 * time);
  gl_FragColor = vec4(c, 1.0);
}`}}),nr=17,or="screws",ir=({time:e})=>Object(ye.jsx)(be.Node,{shader:ar.node,uniforms:{time:e}}),ar=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),sr=18,cr="queen",lr=({time:e})=>Object(ye.jsx)(be.Node,{shader:fr.node,uniforms:{time:e}}),fr=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
}`}}),ur=19,pr="they were six",dr=({time:e})=>Object(ye.jsx)(be.Node,{shader:hr.node,uniforms:{time:e}}),hr=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),vr=20,mr="trippy tiles",gr=({time:e})=>Object(ye.jsx)(be.LinearCopy,{children:Object(ye.jsx)(yr,{persistence:.85,children:Object(ye.jsx)(be.Node,{shader:br.node,uniforms:{time:e}})})}),yr=({children:e,persistence:t})=>Object(ye.jsx)(be.Node,{shader:br.persistence,backbuffering:!0,uniforms:{t:e,back:be.Uniform.Backbuffer,persistence:t}}),br=be.Shaders.create({persistence:{frag:be.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),xr=21,wr="HODL",_r=({time:e})=>Object(ye.jsx)(be.LinearCopy,{children:Object(ye.jsx)(Er,{persistence:Math.min(.99,.015*e),time:e,children:Object(ye.jsx)(be.Node,{shader:Sr.node,uniforms:{time:e}})})}),Er=({children:e,persistence:t,time:r})=>Object(ye.jsx)(be.Node,{shader:Sr.shakePersistence,backbuffering:!0,uniforms:{t:e,back:be.Uniform.Backbuffer,persistence:t,time:r}}),Sr=be.Shaders.create({shakePersistence:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform sampler2D t, back;
uniform float time;
...
}`}}),Or=22,Rr="atoms",Tr=({time:e})=>Object(ye.jsx)(be.Node,{shader:zr.node,uniforms:{time:e,t:"/images/einstein-tongue-out.jpg"}}),zr=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D t;
...
void main() {
...
}`}}),Cr=23,Pr="Hexacubes",Ir=({time:e})=>Object(ye.jsx)(be.Node,{shader:jr.node,uniforms:{time:e}}),jr=be.Shaders.create({node:{frag:be.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform float time;
  const float PI = ${Math.PI};
  ...
  void main() {
    ...
    gl_FragColor = vec4(c, 1.0);
      ...
      `}}),Ar=24,kr="dark cubes",Dr=({time:e})=>Object(ye.jsx)(be.Node,{shader:Lr.node,uniforms:{time:e}}),Lr=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),Nr=25,Mr="Mandelbrot",Ur=({time:e})=>Object(ye.jsx)(be.LinearCopy,{children:Object(ye.jsx)(Br,{persistence:.9,children:Object(ye.jsx)($t,{passes:4,factor:.1,children:Object(ye.jsx)(be.Node,{shader:Fr.node,uniforms:{time:e}})})})}),Br=({children:e,persistence:t})=>Object(ye.jsx)(be.Node,{shader:Fr.persistence,backbuffering:!0,uniforms:{t:e,back:be.Uniform.Backbuffer,persistence:t}}),Fr=be.Shaders.create({persistence:{frag:be.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),qr=26,$r="fumes",Gr=({time:e})=>Object(ye.jsx)(be.LinearCopy,{children:Object(ye.jsx)(Hr,{persistence:.9,children:Object(ye.jsx)($t,{passes:4,factor:Math.min(.6,.01*e),children:Object(ye.jsx)(be.Node,{shader:Vr.node,uniforms:{time:e}})})})}),Hr=({children:e,persistence:t})=>Object(ye.jsx)(be.Node,{shader:Vr.persistence,backbuffering:!0,uniforms:{t:e,back:be.Uniform.Backbuffer,persistence:t}}),Vr=be.Shaders.create({persistence:{frag:be.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Wr=27,Xr="real burning ship",Kr=400,Yr=0,Qr=60,Zr=12,Jr=2,en=({time:e})=>Object(ye.jsx)(be.LinearCopy,{children:Object(ye.jsx)(tn,{persistence:.8+.05*Math.random(),time:e,children:Object(ye.jsx)(be.Node,{shader:rn.node,uniforms:{time:e}})})}),tn=({children:e,persistence:t,time:r})=>Object(ye.jsx)(be.Node,{shader:rn.persistence,backbuffering:!0,uniforms:{t:e,back:be.Uniform.Backbuffer,persistence:t,time:r}}),rn=be.Shaders.create({persistence:{frag:be.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),nn=28,on="No, I'M Batman",an=({time:e})=>Object(ye.jsx)(be.LinearCopy,{children:Object(ye.jsx)(sn,{persistence:.5+.48*Math.min(1,e/60),children:Object(ye.jsx)(be.Node,{shader:cn.node,uniforms:{time:e}})})}),sn=({children:e,persistence:t})=>Object(ye.jsx)(be.Node,{shader:cn.persistence,backbuffering:!0,uniforms:{t:e,back:be.Uniform.Backbuffer,persistence:t}}),cn=be.Shaders.create({persistence:{frag:be.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),ln=29,fn="sdBitcoin(p)",un=({time:e})=>Object(ye.jsx)(be.Node,{shader:pn.node,uniforms:{time:e}}),pn=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),dn=30,hn="21 millions",vn=({time:e})=>Object(ye.jsx)(be.Node,{shader:mn.node,uniforms:{time:e,numberInCirculation:18557031}}),mn=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),gn=31,yn="alien tower",bn=({time:e})=>Object(ye.jsx)(be.Node,{shader:xn.node,uniforms:{time:e,numberInCirculation:18557031}}),xn=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform float numberInCirculation;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),wn=32,_n="GoL valley";let En;const Sn=({time:e})=>{En||(En=e);const t=e-En,r=Math.floor(12*t);return Object(ye.jsx)(be.Node,{shader:On.node,uniforms:{time:e,t:Object(ye.jsx)(Be,{refreshEveryTicks:100,tick:r,size:100})}})},On=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D t;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Rn=33,Tn="x(x+32y)%(tN+1)%n";const zn=({time:e})=>Object(ye.jsx)(be.Node,{shader:Cn.node,uniforms:{time:e}}),Cn=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Pn=34,In="\u230a2cos(x)sin(y+t)\u230b%7";const jn=({time:e})=>Object(ye.jsx)(be.Node,{shader:An.node,uniforms:{time:e}}),An=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
#define PI ${Math.PI}
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),kn=35,Dn="aie confiance",Ln=({time:e})=>Object(ye.jsx)(be.LinearCopy,{children:Object(ye.jsx)(Nn,{persistence:.6,children:Object(ye.jsx)(be.Node,{shader:Mn.node,uniforms:{time:e}})})}),Nn=({children:e,persistence:t})=>Object(ye.jsx)(be.Node,{shader:Mn.persistence,backbuffering:!0,uniforms:{t:e,back:be.Uniform.Backbuffer,persistence:t}}),Mn=be.Shaders.create({persistence:{frag:be.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Un=36,Bn="crois en moi",Fn=({time:e})=>Object(ye.jsx)(be.LinearCopy,{children:Object(ye.jsx)(qn,{children:Object(ye.jsx)(be.Node,{shader:$n.node,uniforms:{time:e}})})}),qn=({children:e,persistence:t})=>Object(ye.jsx)(be.Node,{shader:$n.persistence,backbuffering:!0,uniforms:{t:e,back:be.Uniform.Backbuffer,persistence:t}}),$n=be.Shaders.create({persistence:{frag:be.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Gn=37,Hn="sdBrick",Vn=({time:e})=>Object(ye.jsx)(be.Node,{shader:Wn.node,uniforms:{time:e}}),Wn=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Xn=38,Kn="Golden mandelbulb",Yn=({time:e})=>Object(ye.jsx)(be.LinearCopy,{children:Object(ye.jsx)(Qn,{persistence:.5,children:Object(ye.jsx)(be.Node,{shader:Zn.node,uniforms:{time:e}})})}),Qn=({children:e,persistence:t})=>Object(ye.jsx)(be.Node,{shader:Zn.persistence,backbuffering:!0,uniforms:{t:e,back:be.Uniform.Backbuffer,persistence:t}}),Zn=be.Shaders.create({persistence:{frag:be.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  clr /= 4.;
  gl_FragColor = vec4(clr, 1.0);
}`}}),Jn=39,eo="metaballs",to=({time:e})=>Object(ye.jsx)(be.Node,{shader:ro.node,uniforms:{time:e}}),ro=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  clr /= 4.;
  gl_FragColor = vec4(clr, 1.0);
}`}}),no=40,oo="pen-o-plasma",io=({time:e})=>Object(ye.jsx)(be.Node,{shader:ao.node,uniforms:{time:e}}),ao=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(clr, 1.0);
}`}}),so=41,co="reflection",lo=({time:e})=>Object(ye.jsx)(be.Node,{shader:fo.node,uniforms:{time:e}}),fo=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),uo=42,po="reflection party",ho=({time:e})=>Object(ye.jsx)(be.Node,{shader:vo.node,uniforms:{time:e}}),vo=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c = mix(c, reflection(p, n, 10.), glossy);
  gl_FragColor = vec4(c, 1.0);
}`}}),mo=43,go="irreconcilable queens",yo=({time:e})=>Object(ye.jsx)(be.LinearCopy,{children:Object(ye.jsx)(bo,{persistence:.4,children:Object(ye.jsx)(be.Node,{shader:xo.node,uniforms:{time:e}})})}),bo=({children:e,persistence:t})=>Object(ye.jsx)(be.Node,{shader:xo.persistence,backbuffering:!0,uniforms:{t:e,back:be.Uniform.Backbuffer,persistence:t}}),xo=be.Shaders.create({persistence:{frag:be.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),wo=44,_o="royal meeting",Eo=({time:e})=>Object(ye.jsx)(be.Node,{shader:So.node,uniforms:{time:e}}),So=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
#define PI ${Math.PI}
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),Oo=45,Ro="wood pawns army",To=({time:e})=>Object(ye.jsx)(be.Node,{shader:zo.node,uniforms:{time:e,wood:"/images/seamless-wood-background-1.jpg"}}),zo=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),Co=46,Po="Bank of Bicoin",Io=({time:e})=>Object(ye.jsx)(be.Node,{shader:jo.node,uniforms:{time:e}}),jo=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),Ao=47,ko="glow experiment",Do=({time:e})=>Object(ye.jsx)(be.Node,{shader:Lo.node,uniforms:{time:e}}),Lo=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),No=48,Mo="Starry Night",Uo=({time:e})=>Object(ye.jsx)(be.Node,{shader:Bo.node,uniforms:{time:e,img:"/images/seamless-wood2.jpg"}}),Bo=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(clr, 1.0);
}`}}),Fo=49,qo="chinese lantern",$o=400,Go=0,Ho=20,Vo=24,Wo=1.1,Xo=({time:e})=>Object(ye.jsx)(be.LinearCopy,{children:Object(ye.jsx)(Ko,{persistence:.8,children:Object(ye.jsx)(be.Node,{shader:Yo.node,uniforms:{time:e}})})}),Ko=({children:e,persistence:t})=>Object(ye.jsx)(be.Node,{shader:Yo.persistence,backbuffering:!0,uniforms:{t:e,back:be.Uniform.Backbuffer,persistence:t}}),Yo=be.Shaders.create({persistence:{frag:be.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  clr += c;
  gl_FragColor = vec4(clr, 1.0);
}`}}),Qo=50,Zo="jumpy rooks",Jo=({time:e})=>Object(ye.jsx)(be.Node,{shader:ei.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),ei=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),ti=51,ri="symmetry chess",ni=400,oi=0,ii=20,ai=24,si=1,ci=({time:e})=>Object(ye.jsx)(be.Node,{shader:li.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),li=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),fi=52,ui="knights dance",pi=({time:e})=>Object(ye.jsx)(be.Node,{shader:di.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),di=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),hi=53,vi="cross waves",mi=({time:e})=>Object(ye.jsx)(be.Node,{shader:gi.node,uniforms:{time:e}}),gi=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  */
}`}}),yi=54,bi="chess set",xi=({time:e})=>Object(ye.jsx)(be.Node,{shader:wi.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),wi=be.Shaders.create({node:{frag:be.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  color = vec4(c, 1.0);
}`}}),_i=55,Ei="cube d'or",Si=400,Oi=0,Ri=20,Ti=24,zi=1,Ci=({time:e})=>Object(ye.jsx)(be.Node,{shader:Pi.node,uniforms:{time:e}}),Pi=be.Shaders.create({node:{frag:be.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  #endif
  color = vec4(c, 1.0);
}`}}),Ii=56,ji="jade forest",Ai=({time:e})=>Object(ye.jsx)(be.Node,{shader:ki.node,uniforms:{time:e}}),ki=be.Shaders.create({node:{frag:be.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  color = vec4(c, 1.0);
}`}}),Di=57,Li="Virus v2",Ni=400,Mi=0,Ui=20,Bi=24,Fi=.8,qi=({time:e})=>Object(ye.jsx)(be.Node,{shader:$i.node,uniforms:{time:e}}),$i=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}});var Gi=r("005v"),Hi=r.n(Gi);const Vi=400,Wi=0,Xi=30,Ki=20,Yi=1,Qi="5M",Zi=58,Ji="Mandelglitch",ea=[{url:"https://ethblock.art/create/17",text:"Mint on ethblock.art"},{url:"https://ghostmarket.io/asset/pha/ghost/3008841254969814369262311336331954453497120774334547905246474374493804042898/",text:"ghostmarket.io: 400 KCAL"},{url:"https://www.hicetnunc.xyz/objkt/3063",text:"hicetnunc.xyz: Mandelglitch #1 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3068",text:"hicetnunc.xyz: Mandelglitch #2 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3071",text:"hicetnunc.xyz: Mandelglitch #3 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3072",text:"hicetnunc.xyz: Mandelglitch #4 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3073",text:"hicetnunc.xyz: Mandelglitch #5 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3077",text:"hicetnunc.xyz: Mandelglitch #6 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3088",text:"hicetnunc.xyz: Mandelglitch #7 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3574",text:"hicetnunc.xyz: Mandelglitch #8 (5 XTZ)"}];const ta=e=>e<.5?2*e*e:(4-2*e)*e-1;const ra=({time:e,n:t,exporting:r})=>{const n=Object(Ne.useMemo)((()=>function(e,t=0){const r=e?3:50,n=new Hi.a(t);return Array(r).fill(null).map((()=>Array(12).fill(null).map((()=>n.random()))))}(r,t)),[t,r]),o=e/10%n.length,i=Math.floor(o),a=o-i;let[s,c,l,f,u,p,d,h,v,m,g,y]=(b=n[i%n.length],x=n[(i+1)%n.length],w=ta(a),b.map(((e,t)=>e*(1-w)+x[t]*w)));var b,x,w;return l=ta(l),Object(ye.jsx)(be.LinearCopy,{children:Object(ye.jsx)(oa,{persistence:r?0:.8,children:Object(ye.jsx)(be.Node,{shader:na.main,uniforms:{aa:r?2:0,time:e,resolution:be.Uniform.Resolution,travel:s,love:c,dark:l,rot:r?2*Math.PI/Xi:.1,s1:f,s2:u,s3:p,s4:d,s5:h,s6:v,s7:m,s8:g,s9:y}})})})},na=be.Shaders.create({persistence:{frag:be.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  `}}),oa=({children:e,persistence:t})=>Object(ye.jsx)(be.Node,{shader:na.persistence,backbuffering:!0,uniforms:{t:e,back:be.Uniform.Backbuffer,persistence:t}}),ia=59,aa="Pixels 256",sa="There will be only 256 patterns generated by this single fragment shader.",ca=({time:e,n:t,exporting:r})=>Object(ye.jsx)(la,{n:t+1+(r?0:Math.floor(e))}),la=Me.a.memo((({n:e})=>{const t=new Hi.a(e%256),r=t.random(),n=t.random(),o=t.random(),i=t.random(),a=t.random(),s=t.random();return Object(ye.jsx)(be.Node,{shader:fa.node,uniforms:{s1:r,s2:n,s3:o,s4:i,s5:a,s6:s}})})),fa=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),ua=60,pa="Bitcoin rainbow",da=({time:e})=>Object(ye.jsx)(be.Node,{shader:ha.node,uniforms:{time:e}}),ha=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),va=61,ma="Binance gradients",ga=1,ya=30,ba=["/images/shaders/binance.dist.png"],xa=({time:e})=>Object(ye.jsx)(be.Node,{shader:wa.node,uniforms:{time:e,image:"/images/shaders/binance.dist.png"}}),wa=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),_a=62,Ea="Overgrowth",Sa=20,Oa=40,Ra=1,Ta=({generation:e,size:t,n:r})=>Object(ye.jsx)(be.Node,{width:t,height:t,shader:Aa.logic,uniforms:{generation:e,prev:be.Uniform.Backbuffer,size:t,seed:r/100},backbuffering:!0}),za=Me.a.memo(Ta),Ca=({time:e,generation:t,n:r})=>Object(ye.jsx)(be.Node,{shader:Aa.render,uniforms:{time:e,logic:Object(ye.jsx)(za,{generation:t,size:140,n:r})},uniformsOptions:{logic:{interpolation:"nearest"}}}),Pa=Me.a.memo(Ca),Ia=1e3*Math.random(),ja=({time:e,n:t})=>Object(ye.jsx)(Pa,{n:t+Ia,time:e,generation:Math.floor(30*e)},t),Aa=be.Shaders.create({logic:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
...
`}});var ka=r("AJhG");const Da=63,La="Relics",Na=400,Ma=2,Ua=4,Ba=20,Fa=1,qa="5M",$a={colors:[.7,.55,.4],logicSize:80,amp:1,base:2,persistance:.89,delta:.5,seed:0};console.log(Object.keys($a).map((e=>String($a[e]))).join("_"));const Ga=({g:e,size:t,seed:r,amp:n,base:o,persistance:i,delta:a})=>Object(ye.jsx)(be.Node,{width:t,height:t,shader:Ka.logic,uniforms:{amp:n,base:o,g:e,prev:be.Uniform.Backbuffer,size:t,seed:r,persistance:i,delta:a},backbuffering:!0},t),Ha=Me.a.memo(Ga),Va=({g:e,colors:t,amp:r,base:n,persistance:o,delta:i,logicSize:a,seed:s})=>Object(ye.jsx)(be.Node,{shader:Ka.render,uniforms:{colors:t,logic:Object(ye.jsx)(Ha,{amp:r,base:n,g:e,size:a,seed:s,persistance:o,delta:i})},uniformsOptions:{logic:{interpolation:"nearest"}}}),Wa=Me.a.memo(Va),Xa=({time:e})=>{const{colors:t,logicSize:r,amp:n,base:o,persistance:i,delta:a,seed:s}=Object(ka.b)($a);return Object(ye.jsx)(Wa,{amp:n,base:o,g:Math.floor(20*e)%40,colors:t,persistance:i,delta:a,seed:s,logicSize:r})},Ka=be.Shaders.create({logic:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform sampler2D prev;
uniform float g;
...
`}}),Ya=64,Qa="Intersection",Za=8*Math.PI,Ja=[{url:"https://www.hicetnunc.xyz/objkt/28592",text:"hic et nunc NFT"}],es=({time:e})=>Object(ye.jsx)(be.Node,{shader:ts.render,uniforms:{resolution:be.Uniform.Resolution,time:e}}),ts=be.Shaders.create({render:{frag:be.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform vec2 resolution;
...
`}}),rs=65,ns="Duality",os=800,is=4,as=8,ss=30,cs=1,ls=3,fs=!0,us=16,ps=[{url:"https://hicetnunc.xyz/objkt/64326",text:"hic et nunc NFT"}],ds=({time:e})=>Object(ye.jsx)(be.NearestCopy,{children:Object(ye.jsx)(hs,{persistence:.3,children:Object(ye.jsx)(be.Node,{shader:vs.render,uniforms:{resolution:be.Uniform.Resolution,time:e}})})}),hs=({children:e,persistence:t})=>Object(ye.jsx)(be.Node,{shader:vs.persistence,backbuffering:!0,uniforms:{t:e,back:be.Uniform.Backbuffer,persistence:t}}),vs=be.Shaders.create({persistence:{frag:be.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),ms=66,gs="hicetnunc",ys=800,bs=2,xs=bs+8,ws=30,_s=1,Es=7,Ss=!0,Os=16,Rs=({time:e})=>Object(ye.jsx)(be.NearestCopy,{children:Object(ye.jsx)(Ts,{persistence:.5,children:Object(ye.jsx)(be.Node,{shader:zs.render,uniforms:{resolution:be.Uniform.Resolution,time:e,freq:2}})})}),Ts=({children:e,persistence:t})=>Object(ye.jsx)(be.Node,{shader:zs.persistence,backbuffering:!0,uniforms:{t:e,back:be.Uniform.Backbuffer,persistence:t}}),zs=be.Shaders.create({persistence:{frag:be.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Cs=67,Ps="Jumping blob",Is=800,js=2,As=js+8,ks=30,Ds=1,Ls=7,Ns=!0,Ms=16,Us=({time:e})=>Object(ye.jsx)(be.NearestCopy,{children:Object(ye.jsx)(Bs,{persistence:.6,children:Object(ye.jsx)(be.Node,{shader:Fs.render,uniforms:{resolution:be.Uniform.Resolution,time:e,freq:2}})})}),Bs=({children:e,persistence:t})=>Object(ye.jsx)(be.Node,{shader:Fs.persistence,backbuffering:!0,uniforms:{t:e,back:be.Uniform.Backbuffer,persistence:t}}),Fs=be.Shaders.create({persistence:{frag:be.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),qs=68,$s="ring",Gs=800,Hs=2,Vs=Hs+10,Ws=30,Xs=1,Ks=7,Ys=!0,Qs=128,Zs=({time:e})=>Object(ye.jsx)(be.NearestCopy,{children:Object(ye.jsx)(Js,{persistence:.9,children:Object(ye.jsx)(be.Node,{shader:ec.render,uniforms:{resolution:be.Uniform.Resolution,time:e,freq:2}})})}),Js=({children:e,persistence:t})=>Object(ye.jsx)(be.Node,{shader:ec.persistence,backbuffering:!0,uniforms:{t:e,back:be.Uniform.Backbuffer,persistence:t}}),ec=be.Shaders.create({persistence:{frag:be.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),tc=69,rc="Bananas paradize",nc=400,oc=0,ic=20,ac=20,sc=1,cc=!0,lc=128,fc=({time:e})=>Object(ye.jsx)(be.Node,{shader:uc.node,uniforms:{time:e,resolution:be.Uniform.Resolution}}),uc=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;

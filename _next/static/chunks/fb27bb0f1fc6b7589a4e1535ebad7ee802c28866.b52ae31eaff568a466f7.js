...
}`}}),he=2,me="stripes",ge=400,ye=0,xe=60,be=24,we=1,_e=({time:e})=>Object(le.jsx)(fe.Node,{shader:Se.node,uniforms:{time:e}}),Se=fe.Shaders.create({node:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),Ee=3,ze="zephyr",Te=({time:e})=>Object(le.jsx)(fe.Node,{shader:Re.node,uniforms:{time:e}}),Re=fe.Shaders.create({node:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}});var Ie=r("q1tI"),Pe=r.n(Ie);const Ae=fe.Shaders.create({InitGameOfLife:{frag:fe.GLSL`
  precision highp float;
  uniform float seed;
  // i
  varying vec2 uv;
  ...
  }`}}),Oe=Pe.a.memo((({tick:e,size:t,refreshEveryTicks:r})=>e%(r||1/0)===0?Object(le.jsx)(fe.Node,{shader:Ae.InitGameOfLife,uniforms:{seed:Math.random()},width:t,height:t,backbuffering:!0,sync:!0}):Object(le.jsx)(fe.Node,{shader:Ae.GameOfLife,width:t,height:t,backbuffering:!0,sync:!0,uniforms:{t:fe.Uniform.Backbuffer,size:t}}))),Ce=4,De="Ray of Life";let Le;const je=({time:e})=>{Le||(Le=e);const t=e-Le,r=Math.floor(10*t),o=r+25,i=10*(1+Math.floor(r/50)),n=10*(1+Math.floor(o/50));return Object(le.jsx)(Ne,{time:e,a:Object(le.jsx)(fe.NearestCopy,{children:Object(le.jsx)(Oe,{refreshEveryTicks:50,tick:r,size:i})}),b:Object(le.jsx)(fe.NearestCopy,{children:Object(le.jsx)(Oe,{refreshEveryTicks:50,tick:o,size:n})})})},Ne=({a:e,b:t,time:r})=>Object(le.jsx)(fe.Node,{uniforms:{a:e,b:t,time:r},shader:Ue.main}),Ue=fe.Shaders.create({main:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Me=5,ke="Here We Go Again",Be=({time:e})=>Object(le.jsx)(fe.Node,{shader:qe.node,uniforms:{time:e}}),qe=fe.Shaders.create({node:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    sqrt(vec3(1. - shad));
  gl_FragColor = vec4(c,1.0);
}`}}),Fe=6,Ge="Bestagons",He=({time:e})=>Object(le.jsx)(fe.Node,{shader:Ve.node,uniforms:{time:e}}),Ve=fe.Shaders.create({node:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),Xe=7,Ye="Worms party",We=({time:e})=>Object(le.jsx)(fe.Node,{shader:Ke.node,uniforms:{time:e}}),Ke=fe.Shaders.create({node:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    sqrt(vec3(1. - shad));
  gl_FragColor = vec4(c,1.0);
}`}}),$e=8,Qe="moontains",Ze=({time:e})=>Object(le.jsx)(fe.Node,{shader:Je.node,uniforms:{time:e}}),Je=fe.Shaders.create({node:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),et=9,tt="Virus",rt=400,ot=16.3,it=26,nt=24,at=.8,st=({time:e})=>Object(le.jsx)(fe.Node,{shader:ct.node,uniforms:{time:e}}),ct=fe.Shaders.create({node:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),lt=10,ft="ring",pt=({time:e})=>Object(le.jsx)(fe.Node,{shader:ut.node,uniforms:{time:e}}),ut=fe.Shaders.create({node:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),dt=11,vt="magic mouse",ht=({time:e})=>Object(le.jsx)(fe.Node,{shader:mt.node,uniforms:{time:e}}),mt=fe.Shaders.create({node:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),gt=12,yt="floor is lava",xt=({time:e})=>Object(le.jsx)(fe.Node,{shader:bt.node,uniforms:{time:e}}),bt=fe.Shaders.create({node:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),wt=13,_t="chip",St=({time:e})=>Object(le.jsx)(fe.Node,{shader:Et.node,uniforms:{time:e}}),Et=fe.Shaders.create({node:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
`}}),zt=14,Tt="seizure",Rt=({time:e})=>Object(le.jsx)(fe.Node,{shader:It.node,uniforms:{time:e}}),It=fe.Shaders.create({node:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Pt=fe.Shaders.create({blur1D:{frag:fe.GLSL`precision highp float;
varying vec2 uv;
uniform sampler2D t;
...
}`}});var At=({width:e,height:t,pixelRatio:r,direction:o,children:i})=>Object(le.jsx)(fe.Node,{shader:Pt.blur1D,width:e,height:t,pixelRatio:r,uniforms:{direction:o,resolution:fe.Uniform.Resolution,t:i}});const Ot=Math.sqrt(2)/2;var Ct=(e,t,r)=>{const o=2*t*Math.ceil(e/2)/r;switch((e-1)%4){case 0:return[o,0];case 1:return[0,o];case 2:return[o*Ot,o*Ot];case 3:return[o*Ot,-o*Ot]}};const Dt=({width:e,height:t,pixelRatio:r,factor:o,children:i,passes:n,directionForPass:a})=>{const s=c=>c<=0?i:Object(le.jsx)(At,{width:e,height:t,pixelRatio:r,direction:a(c,o,n),children:s(c-1)});return s(n)};Dt.defaultProps={passes:2,directionForPass:Ct};var Lt=Dt;const jt=fe.Shaders.create({blur1D:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
...
}`}});var Nt=({width:e,height:t,map:r,pixelRatio:o,direction:i,children:n})=>Object(le.jsx)(fe.Node,{shader:jt.blur1D,width:e,height:t,pixelRatio:o,uniforms:{direction:i,resolution:fe.Uniform.Resolution,t:n,map:r}});const Ut=({width:e,height:t,map:r,pixelRatio:o,factor:i,children:n,passes:a,directionForPass:s})=>{const c=l=>l<=0?n:Object(le.jsx)(Nt,{width:e,height:t,map:r,pixelRatio:o,direction:s(l,i,a),children:c(l-1)});return c(a)};Ut.defaultProps={passes:2,directionForPass:Ct};const Mt=15,kt="parametric",Bt=({time:e})=>Object(le.jsx)(fe.LinearCopy,{children:Object(le.jsx)(Ft,{persistence:.98+.02*Math.cos(e)+-.8*Math.exp(-e),children:Object(le.jsx)(Lt,{passes:4,factor:.2,children:Object(le.jsx)(qt,{time:e})})})}),qt=({time:e})=>Object(le.jsx)(fe.Node,{shader:Gt.node,uniforms:{time:e}}),Ft=({children:e,persistence:t})=>Object(le.jsx)(fe.Node,{shader:Gt.persistence,backbuffering:!0,uniforms:{t:e,back:fe.Uniform.Backbuffer,persistence:t}}),Gt=fe.Shaders.create({persistence:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),Ht=16,Vt="reuleaux",Xt=({time:e})=>Object(le.jsx)(fe.Node,{shader:Yt.node,uniforms:{time:e}}),Yt=fe.Shaders.create({node:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    color(0.5 * time);
  gl_FragColor = vec4(c, 1.0);
}`}}),Wt=17,Kt="screws",$t=({time:e})=>Object(le.jsx)(fe.Node,{shader:Qt.node,uniforms:{time:e}}),Qt=fe.Shaders.create({node:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),Zt=18,Jt="queen",er=({time:e})=>Object(le.jsx)(fe.Node,{shader:tr.node,uniforms:{time:e}}),tr=fe.Shaders.create({node:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
}`}}),rr=19,or="they were six",ir=({time:e})=>Object(le.jsx)(fe.Node,{shader:nr.node,uniforms:{time:e}}),nr=fe.Shaders.create({node:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),ar=20,sr="trippy tiles",cr=({time:e})=>Object(le.jsx)(fe.LinearCopy,{children:Object(le.jsx)(lr,{persistence:.85,children:Object(le.jsx)(fe.Node,{shader:fr.node,uniforms:{time:e}})})}),lr=({children:e,persistence:t})=>Object(le.jsx)(fe.Node,{shader:fr.persistence,backbuffering:!0,uniforms:{t:e,back:fe.Uniform.Backbuffer,persistence:t}}),fr=fe.Shaders.create({persistence:{frag:fe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),pr=21,ur="HODL",dr=({time:e})=>Object(le.jsx)(fe.LinearCopy,{children:Object(le.jsx)(vr,{persistence:Math.min(.99,.015*e),time:e,children:Object(le.jsx)(fe.Node,{shader:hr.node,uniforms:{time:e}})})}),vr=({children:e,persistence:t,time:r})=>Object(le.jsx)(fe.Node,{shader:hr.shakePersistence,backbuffering:!0,uniforms:{t:e,back:fe.Uniform.Backbuffer,persistence:t,time:r}}),hr=fe.Shaders.create({shakePersistence:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
uniform sampler2D t, back;
uniform float time;
...
}`}}),mr=22,gr="atoms",yr=({time:e})=>Object(le.jsx)(fe.Node,{shader:xr.node,uniforms:{time:e,t:"/images/einstein-tongue-out.jpg"}}),xr=fe.Shaders.create({node:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D t;
...
void main() {
...
}`}}),br=23,wr="Hexacubes",_r=({time:e})=>Object(le.jsx)(fe.Node,{shader:Sr.node,uniforms:{time:e}}),Sr=fe.Shaders.create({node:{frag:fe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform float time;
  const float PI = ${Math.PI};
  ...
  void main() {
    ...
    gl_FragColor = vec4(c, 1.0);
      ...
      `}}),Er=24,zr="dark cubes",Tr=({time:e})=>Object(le.jsx)(fe.Node,{shader:Rr.node,uniforms:{time:e}}),Rr=fe.Shaders.create({node:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),Ir=25,Pr="Mandelbrot",Ar=({time:e})=>Object(le.jsx)(fe.LinearCopy,{children:Object(le.jsx)(Or,{persistence:.9,children:Object(le.jsx)(Lt,{passes:4,factor:.1,children:Object(le.jsx)(fe.Node,{shader:Cr.node,uniforms:{time:e}})})})}),Or=({children:e,persistence:t})=>Object(le.jsx)(fe.Node,{shader:Cr.persistence,backbuffering:!0,uniforms:{t:e,back:fe.Uniform.Backbuffer,persistence:t}}),Cr=fe.Shaders.create({persistence:{frag:fe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Dr=26,Lr="fumes",jr=({time:e})=>Object(le.jsx)(fe.LinearCopy,{children:Object(le.jsx)(Nr,{persistence:.9,children:Object(le.jsx)(Lt,{passes:4,factor:Math.min(.6,.01*e),children:Object(le.jsx)(fe.Node,{shader:Ur.node,uniforms:{time:e}})})})}),Nr=({children:e,persistence:t})=>Object(le.jsx)(fe.Node,{shader:Ur.persistence,backbuffering:!0,uniforms:{t:e,back:fe.Uniform.Backbuffer,persistence:t}}),Ur=fe.Shaders.create({persistence:{frag:fe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Mr=27,kr="real burning ship",Br=400,qr=0,Fr=60,Gr=12,Hr=2,Vr=({time:e})=>Object(le.jsx)(fe.LinearCopy,{children:Object(le.jsx)(Xr,{persistence:.8+.05*Math.random(),time:e,children:Object(le.jsx)(fe.Node,{shader:Yr.node,uniforms:{time:e}})})}),Xr=({children:e,persistence:t,time:r})=>Object(le.jsx)(fe.Node,{shader:Yr.persistence,backbuffering:!0,uniforms:{t:e,back:fe.Uniform.Backbuffer,persistence:t,time:r}}),Yr=fe.Shaders.create({persistence:{frag:fe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Wr=28,Kr="No, I'M Batman",$r=({time:e})=>Object(le.jsx)(fe.LinearCopy,{children:Object(le.jsx)(Qr,{persistence:.5+.48*Math.min(1,e/60),children:Object(le.jsx)(fe.Node,{shader:Zr.node,uniforms:{time:e}})})}),Qr=({children:e,persistence:t})=>Object(le.jsx)(fe.Node,{shader:Zr.persistence,backbuffering:!0,uniforms:{t:e,back:fe.Uniform.Backbuffer,persistence:t}}),Zr=fe.Shaders.create({persistence:{frag:fe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Jr=29,eo="sdBitcoin(p)",to=({time:e})=>Object(le.jsx)(fe.Node,{shader:ro.node,uniforms:{time:e}}),ro=fe.Shaders.create({node:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),oo=30,io="21 millions",no=({time:e})=>Object(le.jsx)(fe.Node,{shader:ao.node,uniforms:{time:e,numberInCirculation:18557031}}),ao=fe.Shaders.create({node:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),so=31,co="alien tower",lo=({time:e})=>Object(le.jsx)(fe.Node,{shader:fo.node,uniforms:{time:e,numberInCirculation:18557031}}),fo=fe.Shaders.create({node:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform float numberInCirculation;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),po=32,uo="GoL valley";let vo;const ho=({time:e})=>{vo||(vo=e);const t=e-vo,r=Math.floor(12*t);return Object(le.jsx)(fe.Node,{shader:mo.node,uniforms:{time:e,t:Object(le.jsx)(Oe,{refreshEveryTicks:100,tick:r,size:100})}})},mo=fe.Shaders.create({node:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D t;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),go=33,yo="x(x+32y)%(tN+1)%n";const xo=({time:e})=>Object(le.jsx)(fe.Node,{shader:bo.node,uniforms:{time:e}}),bo=fe.Shaders.create({node:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),wo=34,_o="\u230a2cos(x)sin(y+t)\u230b%7";const So=({time:e})=>Object(le.jsx)(fe.Node,{shader:Eo.node,uniforms:{time:e}}),Eo=fe.Shaders.create({node:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
#define PI ${Math.PI}
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),zo=35,To="aie confiance",Ro=({time:e})=>Object(le.jsx)(fe.LinearCopy,{children:Object(le.jsx)(Io,{persistence:.6,children:Object(le.jsx)(fe.Node,{shader:Po.node,uniforms:{time:e}})})}),Io=({children:e,persistence:t})=>Object(le.jsx)(fe.Node,{shader:Po.persistence,backbuffering:!0,uniforms:{t:e,back:fe.Uniform.Backbuffer,persistence:t}}),Po=fe.Shaders.create({persistence:{frag:fe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Ao=36,Oo="crois en moi",Co=({time:e})=>Object(le.jsx)(fe.LinearCopy,{children:Object(le.jsx)(Do,{children:Object(le.jsx)(fe.Node,{shader:Lo.node,uniforms:{time:e}})})}),Do=({children:e,persistence:t})=>Object(le.jsx)(fe.Node,{shader:Lo.persistence,backbuffering:!0,uniforms:{t:e,back:fe.Uniform.Backbuffer,persistence:t}}),Lo=fe.Shaders.create({persistence:{frag:fe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),jo=37,No="sdBrick",Uo=({time:e})=>Object(le.jsx)(fe.Node,{shader:Mo.node,uniforms:{time:e}}),Mo=fe.Shaders.create({node:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),ko=38,Bo="Golden mandelbulb",qo=({time:e})=>Object(le.jsx)(fe.LinearCopy,{children:Object(le.jsx)(Fo,{persistence:.5,children:Object(le.jsx)(fe.Node,{shader:Go.node,uniforms:{time:e}})})}),Fo=({children:e,persistence:t})=>Object(le.jsx)(fe.Node,{shader:Go.persistence,backbuffering:!0,uniforms:{t:e,back:fe.Uniform.Backbuffer,persistence:t}}),Go=fe.Shaders.create({persistence:{frag:fe.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  clr /= 4.;
  gl_FragColor = vec4(clr, 1.0);
}`}}),Ho=39,Vo="metaballs",Xo=({time:e})=>Object(le.jsx)(fe.Node,{shader:Yo.node,uniforms:{time:e}}),Yo=fe.Shaders.create({node:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  clr /= 4.;
  gl_FragColor = vec4(clr, 1.0);
}`}}),Wo=40,Ko="pen-o-plasma",$o=({time:e})=>Object(le.jsx)(fe.Node,{shader:Qo.node,uniforms:{time:e}}),Qo=fe.Shaders.create({node:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(clr, 1.0);
}`}}),Zo=41,Jo="reflection",ei=({time:e})=>Object(le.jsx)(fe.Node,{shader:ti.node,uniforms:{time:e}}),ti=fe.Shaders.create({node:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),ri=42,oi="reflection party",ii=({time:e})=>Object(le.jsx)(fe.Node,{shader:ni.node,uniforms:{time:e}}),ni=fe.Shaders.create({node:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c = mix(c, reflection(p, n, 10.), glossy);
  gl_FragColor = vec4(c, 1.0);
}`}}),ai=43,si="irreconcilable queens",ci=({time:e})=>Object(le.jsx)(fe.LinearCopy,{children:Object(le.jsx)(li,{persistence:.4,children:Object(le.jsx)(fe.Node,{shader:fi.node,uniforms:{time:e}})})}),li=({children:e,persistence:t})=>Object(le.jsx)(fe.Node,{shader:fi.persistence,backbuffering:!0,uniforms:{t:e,back:fe.Uniform.Backbuffer,persistence:t}}),fi=fe.Shaders.create({persistence:{frag:fe.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),pi=44,ui="royal meeting",di=({time:e})=>Object(le.jsx)(fe.Node,{shader:vi.node,uniforms:{time:e}}),vi=fe.Shaders.create({node:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
#define PI ${Math.PI}
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),hi=45,mi="wood pawns army",gi=({time:e})=>Object(le.jsx)(fe.Node,{shader:yi.node,uniforms:{time:e,wood:"/images/seamless-wood-background-1.jpg"}}),yi=fe.Shaders.create({node:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),xi=46,bi="Bank of Bicoin",wi=({time:e})=>Object(le.jsx)(fe.Node,{shader:_i.node,uniforms:{time:e}}),_i=fe.Shaders.create({node:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),Si=47,Ei="glow experiment",zi=({time:e})=>Object(le.jsx)(fe.Node,{shader:Ti.node,uniforms:{time:e}}),Ti=fe.Shaders.create({node:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Ri=48,Ii="Starry Night",Pi=({time:e})=>Object(le.jsx)(fe.Node,{shader:Ai.node,uniforms:{time:e,img:"/images/seamless-wood2.jpg"}}),Ai=fe.Shaders.create({node:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(clr, 1.0);
}`}}),Oi=49,Ci="chinese lantern",Di=400,Li=0,ji=20,Ni=24,Ui=1.1,Mi=({time:e})=>Object(le.jsx)(fe.LinearCopy,{children:Object(le.jsx)(ki,{persistence:.8,children:Object(le.jsx)(fe.Node,{shader:Bi.node,uniforms:{time:e}})})}),ki=({children:e,persistence:t})=>Object(le.jsx)(fe.Node,{shader:Bi.persistence,backbuffering:!0,uniforms:{t:e,back:fe.Uniform.Backbuffer,persistence:t}}),Bi=fe.Shaders.create({persistence:{frag:fe.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  clr += c;
  gl_FragColor = vec4(clr, 1.0);
}`}}),qi=50,Fi="jumpy rooks",Gi=({time:e})=>Object(le.jsx)(fe.Node,{shader:Hi.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),Hi=fe.Shaders.create({node:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),Vi=51,Xi="symmetry chess",Yi=400,Wi=0,Ki=20,$i=24,Qi=1,Zi=({time:e})=>Object(le.jsx)(fe.Node,{shader:Ji.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),Ji=fe.Shaders.create({node:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),en=52,tn="knights dance",rn=({time:e})=>Object(le.jsx)(fe.Node,{shader:on.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),on=fe.Shaders.create({node:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),nn=53,an="cross waves",sn=({time:e})=>Object(le.jsx)(fe.Node,{shader:cn.node,uniforms:{time:e}}),cn=fe.Shaders.create({node:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  */
}`}}),ln=54,fn="chess set",pn=({time:e})=>Object(le.jsx)(fe.Node,{shader:un.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),un=fe.Shaders.create({node:{frag:fe.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  color = vec4(c, 1.0);
}`}}),dn=55,vn="cube d'or",hn=400,mn=0,gn=20,yn=24,xn=1,bn=({time:e})=>Object(le.jsx)(fe.Node,{shader:wn.node,uniforms:{time:e}}),wn=fe.Shaders.create({node:{frag:fe.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  #endif
  color = vec4(c, 1.0);
}`}}),_n=56,Sn="jade forest",En=({time:e})=>Object(le.jsx)(fe.Node,{shader:zn.node,uniforms:{time:e}}),zn=fe.Shaders.create({node:{frag:fe.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  color = vec4(c, 1.0);
}`}}),Tn=57,Rn="Virus v2",In=400,Pn=0,An=20,On=24,Cn=.8,Dn=({time:e})=>Object(le.jsx)(fe.Node,{shader:Ln.node,uniforms:{time:e}}),Ln=fe.Shaders.create({node:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}});var jn=r("005v"),Nn=r.n(jn);const Un=400,Mn=0,kn=30,Bn=20,qn=1,Fn="5M",Gn=58,Hn="Mandelglitch",Vn=[{url:"https://ethblock.art/create/17",text:"Mint on ethblock.art"},{url:"https://ghostmarket.io/asset/pha/ghost/3008841254969814369262311336331954453497120774334547905246474374493804042898/",text:"ghostmarket.io: 400 KCAL"},{url:"https://www.hicetnunc.xyz/objkt/3063",text:"hicetnunc.xyz: Mandelglitch #1 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3068",text:"hicetnunc.xyz: Mandelglitch #2 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3071",text:"hicetnunc.xyz: Mandelglitch #3 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3072",text:"hicetnunc.xyz: Mandelglitch #4 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3073",text:"hicetnunc.xyz: Mandelglitch #5 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3077",text:"hicetnunc.xyz: Mandelglitch #6 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3088",text:"hicetnunc.xyz: Mandelglitch #7 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3574",text:"hicetnunc.xyz: Mandelglitch #8 (5 XTZ)"}];const Xn=e=>e<.5?2*e*e:(4-2*e)*e-1;const Yn=({time:e,n:t,exporting:r})=>{const o=Object(Ie.useMemo)((()=>function(e,t=0){const r=e?3:50,o=new Nn.a(t);return Array(r).fill(null).map((()=>Array(12).fill(null).map((()=>o.random()))))}(r,t)),[t,r]),i=e/10%o.length,n=Math.floor(i),a=i-n;let[s,c,l,f,p,u,d,v,h,m,g,y]=(x=o[n%o.length],b=o[(n+1)%o.length],w=Xn(a),x.map(((e,t)=>e*(1-w)+b[t]*w)));var x,b,w;return l=Xn(l),Object(le.jsx)(fe.LinearCopy,{children:Object(le.jsx)(Kn,{persistence:r?0:.8,children:Object(le.jsx)(fe.Node,{shader:Wn.main,uniforms:{aa:r?2:0,time:e,resolution:fe.Uniform.Resolution,travel:s,love:c,dark:l,rot:r?2*Math.PI/kn:.1,s1:f,s2:p,s3:u,s4:d,s5:v,s6:h,s7:m,s8:g,s9:y}})})})},Wn=fe.Shaders.create({persistence:{frag:fe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  `}}),Kn=({children:e,persistence:t})=>Object(le.jsx)(fe.Node,{shader:Wn.persistence,backbuffering:!0,uniforms:{t:e,back:fe.Uniform.Backbuffer,persistence:t}}),$n=59,Qn="Pixels 256",Zn="There will be only 256 patterns generated by this single fragment shader.",Jn=({time:e,n:t,exporting:r})=>Object(le.jsx)(ea,{n:t+1+(r?0:Math.floor(e))}),ea=Pe.a.memo((({n:e})=>{const t=new Nn.a(e%256),r=t.random(),o=t.random(),i=t.random(),n=t.random(),a=t.random(),s=t.random();return Object(le.jsx)(fe.Node,{shader:ta.node,uniforms:{s1:r,s2:o,s3:i,s4:n,s5:a,s6:s}})})),ta=fe.Shaders.create({node:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),ra=60,oa="bitcoin",ia=({time:e})=>Object(le.jsx)(fe.Node,{shader:na.node,uniforms:{time:e}}),na=fe.Shaders.create({node:{frag:fe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;

...
}`}}).copy;t.default=i},MAJC:function(e,t,r){"use strict";e.exports=function(e){return"undefined"!==typeof e&&null!==e&&("object"===typeof e||"function"===typeof e)}},Ni9w:function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;t.default=class{constructor(){var e,t,r;r=[],(t="_loaders")in(e=this)?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r}add(e){this._loaders.push(e),this._loaders.sort(((e,t)=>("number"===typeof t.priority?t.priority:0)-("number"===typeof e.priority?e.priority:0)))}remove(e){const t=this._loaders.indexOf(e);-1!==t&&this._loaders.splice(t,1)}get(){return this._loaders}}},O8XB:function(e,t,r){"use strict";(function(e,n){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var o,i,a,s,c,l=p(r("tbvF")),f=p(r("Ytbt")),u=p(r("zqV6"));function p(e){return e&&e.__esModule?e:{default:e}}"undefined"===typeof e&&(n.Buffer=(i=o=class{},c=t=>t instanceof e,(s="isBuffer")in(a=o)?Object.defineProperty(a,s,{value:c,enumerable:!0,configurable:!0,writable:!0}):a[s]=c,i));t.default=(e,t,r,n)=>{const o="undefined"!==typeof WebGLRenderingContext&&e instanceof WebGLRenderingContext;let i=r.dtype,a=r.shape.slice(),s=e.getParameter(e.MAX_TEXTURE_SIZE);if(a[0]<0||a[0]>s||a[1]<0||a[1]>s)throw new Error("gl-react: Invalid texture size");let c=function(e,t){return 3===e.length?1===t[2]&&t[1]===e[0]*e[2]&&t[0]===e[2]:1===t[0]&&t[1]===e[0]}(a,r.stride.slice()),p=0;"float32"===i?p=e.FLOAT:"float64"===i?(p=e.FLOAT,c=!1,i="float32"):"uint8"===i?p=e.UNSIGNED_BYTE:(p=e.UNSIGNED_BYTE,c=!1,i="uint8");let d,h=0,v=0;if(2===a.length)v=h=e.LUMINANCE,a=[a[0],a[1],1],r=(0,l.default)(r.data,a,[r.stride[0],r.stride[1],1],r.offset);else{if(3!==a.length)throw new Error("gl-texture2d: Invalid shape for texture");if(1===a[2])v=h=e.ALPHA,o||(n=!1);else if(2===a[2])v=h=e.LUMINANCE_ALPHA,o||(n=!1);else if(3===a[2])h=e.RGB,v=o?e.RGB:e.RGB32F;else{if(4!==a[2])throw new Error("gl-texture2d: Invalid shape for pixel coords");h=e.RGBA,v=o?e.RGBA:e.RGBA32F}}p!==e.FLOAT||n||(p=e.UNSIGNED_BYTE,c=!1);let m,g=r.size;if(c)d=0===r.offset&&r.data.length===g?r.data:r.data.subarray(r.offset,r.offset+g);else{let t=[a[2],a[2]*a[0],1];if("float32"!==i&&"float64"!==i||p!==e.UNSIGNED_BYTE){m=u.default.malloc(g,i);let e=(0,l.default)(m,a,t,0);f.default.assign(e,r)}else{m=u.default.malloc(g,"uint8"),function(e,t){f.default.muls(e,t,255)}((0,l.default)(m,a,t,0),r)}d=m.subarray(0,g)}e.texImage2D(e.TEXTURE_2D,0,v,a[0],a[1],0,h,p,d),m&&u.default.free(m)}}).call(this,r("HDXh").Buffer,r("ntbh"))},OTww:function(e,t,r){"use strict";(function(e){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var n,o=(n=r("Ni9w"))&&n.__esModule?n:{default:n};const i="undefined"===typeof window?e:window,a="__webglTextureLoader_registry";var s=i[a]||(i[a]=new o.default);t.default=s}).call(this,r("ntbh"))},QLaP:function(e,t,r){"use strict";e.exports=function(e,t,r,n,o,i,a,s){if(!e){var c;if(void 0===t)c=new Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else{var l=[r,n,o,i,a,s],f=0;(c=new Error(t.replace(/%s/g,(function(){return l[f++]})))).name="Invariant Violation"}throw c.framesToPop=1,c}}},QM7d:function(e,t,r){"use strict";var n=r("033R");function o(){this.argTypes=[],this.shimArgs=[],this.arrayArgs=[],this.arrayBlockIndices=[],this.scalarArgs=[],this.offsetArgs=[],this.offsetArgIndex=[],this.indexArgs=[],this.shapeArgs=[],this.funcName="",this.pre=null,this.body=null,this.post=null,this.debug=!1}e.exports=function(e){var t=new o;t.pre=e.pre,t.body=e.body,t.post=e.post;var r=e.args.slice(0);t.argTypes=r;for(var i=0;i<r.length;++i){var a=r[i];if("array"===a||"object"===typeof a&&a.blockIndices){if(t.argTypes[i]="array",t.arrayArgs.push(i),t.arrayBlockIndices.push(a.blockIndices?a.blockIndices:0),t.shimArgs.push("array"+i),i<t.pre.args.length&&t.pre.args[i].count>0)throw new Error("cwise: pre() block may not reference array args");if(i<t.post.args.length&&t.post.args[i].count>0)throw new Error("cwise: post() block may not reference array args")}else if("scalar"===a)t.scalarArgs.push(i),t.shimArgs.push("scalar"+i);else if("index"===a){if(t.indexArgs.push(i),i<t.pre.args.length&&t.pre.args[i].count>0)throw new Error("cwise: pre() block may not reference array index");if(i<t.body.args.length&&t.body.args[i].lvalue)throw new Error("cwise: body() block may not write to array index");if(i<t.post.args.length&&t.post.args[i].count>0)throw new Error("cwise: post() block may not reference array index")}else if("shape"===a){if(t.shapeArgs.push(i),i<t.pre.args.length&&t.pre.args[i].lvalue)throw new Error("cwise: pre() block may not write to array shape");if(i<t.body.args.length&&t.body.args[i].lvalue)throw new Error("cwise: body() block may not write to array shape");if(i<t.post.args.length&&t.post.args[i].lvalue)throw new Error("cwise: post() block may not write to array shape")}else{if("object"!==typeof a||!a.offset)throw new Error("cwise: Unknown argument type "+r[i]);t.argTypes[i]="offset",t.offsetArgs.push({array:a.array,offset:a.offset}),t.offsetArgIndex.push(i)}}if(t.arrayArgs.length<=0)throw new Error("cwise: No array arguments specified");if(t.pre.args.length>r.length)throw new Error("cwise: Too many arguments in pre() block");if(t.body.args.length>r.length)throw new Error("cwise: Too many arguments in body() block");if(t.post.args.length>r.length)throw new Error("cwise: Too many arguments in post() block");return t.debug=!!e.printCode||!!e.debug,t.funcName=e.funcName||"cwise",t.blockSize=e.blockSize||64,n(t)}},R9Te:function(e,t,r){"use strict";var n=r("CyWo"),o=r("z08I"),i=r("+0iv"),a=r("vCtr");function s(e){return"__proto__"!==e&&"constructor"!==e&&"prototype"!==e}e.exports=function(e,t,r){if(!a(e))return e;if(Array.isArray(t)&&(t=[].concat.apply([],t).join(".")),"string"!==typeof t)return e;for(var c=n(t,{sep:".",brackets:!0}).filter(s),l=c.length,f=-1,u=e;++f<l;){var p=c[f];f===l-1?i(u[p])&&i(r)?u[p]=o({},u[p],r):u[p]=r:(a(u[p])||(u[p]={}),u=u[p])}return e}},RjOF:function(e,t,r){"use strict";var n,o="";e.exports=function(e,t){if("string"!==typeof e)throw new TypeError("expected a string");if(1===t)return e;if(2===t)return e+e;var r=e.length*t;if(n!==e||"undefined"===typeof n)n=e,o="";else if(o.length>=r)return o.substr(0,r);for(;r>o.length&&t>1;)1&t&&(o+=e),t>>=1,e+=e;return o=(o+=e).substr(0,r)}},Ry8g:function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;t.default=e=>{const t=e.getExtension("WEBGL_lose_context");t&&t.loseContext()}},SMLl:function(e,t,r){"use strict";var n=r("RjOF");e.exports=function(e,t,r){return n(r="undefined"!==typeof r?r+"":" ",t)+e}},TBio:function(e,t,r){"use strict";var n=r("F16p");function o(e,t,r){var n,o,i=e.length,a=t.arrayArgs.length,s=t.indexArgs.length>0,c=[],l=[],f=0,u=0;for(n=0;n<i;++n)l.push(["i",n,"=0"].join(""));for(o=0;o<a;++o)for(n=0;n<i;++n)u=f,f=e[n],0===n?l.push(["d",o,"s",n,"=t",o,"p",f].join("")):l.push(["d",o,"s",n,"=(t",o,"p",f,"-s",u,"*t",o,"p",u,")"].join(""));for(l.length>0&&c.push("var "+l.join(",")),n=i-1;n>=0;--n)f=e[n],c.push(["for(i",n,"=0;i",n,"<s",f,";++i",n,"){"].join(""));for(c.push(r),n=0;n<i;++n){for(u=f,f=e[n],o=0;o<a;++o)c.push(["p",o,"+=d",o,"s",n].join(""));s&&(n>0&&c.push(["index[",u,"]-=s",u].join("")),c.push(["++index[",f,"]"].join(""))),c.push("}")}return c.join("\n")}function i(e,t,r){for(var n=e.body,o=[],i=[],a=0;a<e.args.length;++a){var s=e.args[a];if(!(s.count<=0)){var c=new RegExp(s.name,"g"),l="",f=t.arrayArgs.indexOf(a);switch(t.argTypes[a]){case"offset":var u=t.offsetArgIndex.indexOf(a);f=t.offsetArgs[u].array,l="+q"+u;case"array":l="p"+f+l;var p="l"+a,d="a"+f;if(0===t.arrayBlockIndices[f])1===s.count?"generic"===r[f]?s.lvalue?(o.push(["var ",p,"=",d,".get(",l,")"].join("")),n=n.replace(c,p),i.push([d,".set(",l,",",p,")"].join(""))):n=n.replace(c,[d,".get(",l,")"].join("")):n=n.replace(c,[d,"[",l,"]"].join("")):"generic"===r[f]?(o.push(["var ",p,"=",d,".get(",l,")"].join("")),n=n.replace(c,p),s.lvalue&&i.push([d,".set(",l,",",p,")"].join(""))):(o.push(["var ",p,"=",d,"[",l,"]"].join("")),n=n.replace(c,p),s.lvalue&&i.push([d,"[",l,"]=",p].join("")));else{for(var h=[s.name],v=[l],m=0;m<Math.abs(t.arrayBlockIndices[f]);m++)h.push("\\s*\\[([^\\]]+)\\]"),v.push("$"+(m+1)+"*t"+f+"b"+m);if(c=new RegExp(h.join(""),"g"),l=v.join("+"),"generic"===r[f])throw new Error("cwise: Generic arrays not supported in combination with blocks!");n=n.replace(c,[d,"[",l,"]"].join(""))}break;case"scalar":n=n.replace(c,"Y"+t.scalarArgs.indexOf(a));break;case"index":n=n.replace(c,"index");break;case"shape":n=n.replace(c,"shape")}}}return[o.join("\n"),n,i.join("\n")].join("\n").trim()}function a(e){for(var t=new Array(e.length),r=!0,n=0;n<e.length;++n){var o=e[n],i=o.match(/\d+/);i=i?i[0]:"",0===o.charAt(0)?t[n]="u"+o.charAt(1)+i:t[n]=o.charAt(0)+i,n>0&&(r=r&&t[n]===t[n-1])}return r?t[0]:t.join("")}e.exports=function(e,t){for(var r=t[1].length-Math.abs(e.arrayBlockIndices[0])|0,s=new Array(e.arrayArgs.length),c=new Array(e.arrayArgs.length),l=0;l<e.arrayArgs.length;++l)c[l]=t[2*l],s[l]=t[2*l+1];var f=[],u=[],p=[],d=[],h=[];for(l=0;l<e.arrayArgs.length;++l){e.arrayBlockIndices[l]<0?(p.push(0),d.push(r),f.push(r),u.push(r+e.arrayBlockIndices[l])):(p.push(e.arrayBlockIndices[l]),d.push(e.arrayBlockIndices[l]+r),f.push(0),u.push(e.arrayBlockIndices[l]));for(var v=[],m=0;m<s[l].length;m++)p[l]<=s[l][m]&&s[l][m]<d[l]&&v.push(s[l][m]-p[l]);h.push(v)}var g=["SS"],y=["'use strict'"],b=[];for(m=0;m<r;++m)b.push(["s",m,"=SS[",m,"]"].join(""));for(l=0;l<e.arrayArgs.length;++l){g.push("a"+l),g.push("t"+l),g.push("p"+l);for(m=0;m<r;++m)b.push(["t",l,"p",m,"=t",l,"[",p[l]+m,"]"].join(""));for(m=0;m<Math.abs(e.arrayBlockIndices[l]);++m)b.push(["t",l,"b",m,"=t",l,"[",f[l]+m,"]"].join(""))}for(l=0;l<e.scalarArgs.length;++l)g.push("Y"+l);if(e.shapeArgs.length>0&&b.push("shape=SS.slice(0)"),e.indexArgs.length>0){var x=new Array(r);for(l=0;l<r;++l)x[l]="0";b.push(["index=[",x.join(","),"]"].join(""))}for(l=0;l<e.offsetArgs.length;++l){var w=e.offsetArgs[l],_=[];for(m=0;m<w.offset.length;++m)0!==w.offset[m]&&(1===w.offset[m]?_.push(["t",w.array,"p",m].join("")):_.push([w.offset[m],"*t",w.array,"p",m].join("")));0===_.length?b.push("q"+l+"=0"):b.push(["q",l,"=",_.join("+")].join(""))}var E=n([].concat(e.pre.thisVars).concat(e.body.thisVars).concat(e.post.thisVars));for((b=b.concat(E)).length>0&&y.push("var "+b.join(",")),l=0;l<e.arrayArgs.length;++l)y.push("p"+l+"|=0");e.pre.body.length>3&&y.push(i(e.pre,e,c));var S=i(e.body,e,c),O=function(e){for(var t=0,r=e[0].length;t<r;){for(var n=1;n<e.length;++n)if(e[n][t]!==e[0][t])return t;++t}return t}(h);O<r?y.push(function(e,t,r,n){for(var i=t.length,a=r.arrayArgs.length,s=r.blockSize,c=r.indexArgs.length>0,l=[],f=0;f<a;++f)l.push(["var offset",f,"=p",f].join(""));for(f=e;f<i;++f)l.push(["for(var j"+f+"=SS[",t[f],"]|0;j",f,">0;){"].join("")),l.push(["if(j",f,"<",s,"){"].join("")),l.push(["s",t[f],"=j",f].join("")),l.push(["j",f,"=0"].join("")),l.push(["}else{s",t[f],"=",s].join("")),l.push(["j",f,"-=",s,"}"].join("")),c&&l.push(["index[",t[f],"]=j",f].join(""));for(f=0;f<a;++f){for(var u=["offset"+f],p=e;p<i;++p)u.push(["j",p,"*t",f,"p",t[p]].join(""));l.push(["p",f,"=(",u.join("+"),")"].join(""))}for(l.push(o(t,r,n)),f=e;f<i;++f)l.push("}");return l.join("\n")}(O,h[0],e,S)):y.push(o(h[0],e,S)),e.post.body.length>3&&y.push(i(e.post,e,c)),e.debug&&console.log("-----Generated cwise routine for ",t,":\n"+y.join("\n")+"\n----------");var R=[e.funcName||"unnamed","_cwise_loop_",s[0].join("s"),"m",O,a(c)].join("");return new Function(["function ",R,"(",g.join(","),"){",y.join("\n"),"} return ",R].join(""))()}},TGEO:function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),Object.defineProperty(t,"WebGLTextureLoader",{enumerable:!0,get:function(){return n.default}}),Object.defineProperty(t,"WebGLTextureLoaderAsyncHashCache",{enumerable:!0,get:function(){return o.default}}),Object.defineProperty(t,"WebGLTextureLoaderSyncHashCache",{enumerable:!0,get:function(){return i.default}}),Object.defineProperty(t,"LoadersRegistry",{enumerable:!0,get:function(){return a.default}}),Object.defineProperty(t,"LoaderResolver",{enumerable:!0,get:function(){return s.default}}),Object.defineProperty(t,"globalRegistry",{enumerable:!0,get:function(){return c.default}});var n=l(r("HbIt")),o=l(r("cDsr")),i=l(r("VYxY")),a=l(r("Ni9w")),s=l(r("LhdL")),c=l(r("OTww"));function l(e){return e&&e.__esModule?e:{default:e}}},TKux:function(e,t,r){"use strict";r.d(t,"b",(function(){return Oc})),r.d(t,"c",(function(){return Rc})),r.d(t,"a",(function(){return Tc}));var n={};r.r(n),r.d(n,"n",(function(){return we})),r.d(n,"title",(function(){return _e})),r.d(n,"Shader",(function(){return Ee}));var o={};r.r(o),r.d(o,"n",(function(){return Oe})),r.d(o,"title",(function(){return Re})),r.d(o,"exportSize",(function(){return Te})),r.d(o,"exportStart",(function(){return ze})),r.d(o,"exportEnd",(function(){return Ce})),r.d(o,"exportFramePerSecond",(function(){return Pe})),r.d(o,"exportSpeed",(function(){return Ie})),r.d(o,"Shader",(function(){return je}));var i={};r.r(i),r.d(i,"n",(function(){return ke})),r.d(i,"title",(function(){return De})),r.d(i,"Shader",(function(){return Le}));var a={};r.r(a),r.d(a,"n",(function(){return qe})),r.d(a,"title",(function(){return $e})),r.d(a,"Shader",(function(){return He}));var s={};r.r(s),r.d(s,"n",(function(){return Xe})),r.d(s,"title",(function(){return Ke})),r.d(s,"Shader",(function(){return Ye}));var c={};r.r(c),r.d(c,"n",(function(){return Ze})),r.d(c,"title",(function(){return Je})),r.d(c,"Shader",(function(){return et}));var l={};r.r(l),r.d(l,"n",(function(){return rt})),r.d(l,"title",(function(){return nt})),r.d(l,"Shader",(function(){return ot}));var f={};r.r(f),r.d(f,"n",(function(){return at})),r.d(f,"title",(function(){return st})),r.d(f,"Shader",(function(){return ct}));var u={};r.r(u),r.d(u,"n",(function(){return ft})),r.d(u,"title",(function(){return ut})),r.d(u,"exportSize",(function(){return pt})),r.d(u,"exportStart",(function(){return dt})),r.d(u,"exportEnd",(function(){return ht})),r.d(u,"exportFramePerSecond",(function(){return vt})),r.d(u,"exportSpeed",(function(){return mt})),r.d(u,"Shader",(function(){return gt}));var p={};r.r(p),r.d(p,"n",(function(){return bt})),r.d(p,"title",(function(){return xt})),r.d(p,"Shader",(function(){return wt}));var d={};r.r(d),r.d(d,"n",(function(){return Et})),r.d(d,"title",(function(){return St})),r.d(d,"Shader",(function(){return Ot}));var h={};r.r(h),r.d(h,"n",(function(){return Tt})),r.d(h,"title",(function(){return zt})),r.d(h,"Shader",(function(){return Ct}));var v={};r.r(v),r.d(v,"n",(function(){return It})),r.d(v,"title",(function(){return jt})),r.d(v,"Shader",(function(){return At}));var m={};r.r(m),r.d(m,"n",(function(){return Dt})),r.d(m,"title",(function(){return Lt})),r.d(m,"Shader",(function(){return Nt}));var g={};r.r(g),r.d(g,"n",(function(){return Xt})),r.d(g,"title",(function(){return Kt})),r.d(g,"Shader",(function(){return Yt}));var y={};r.r(y),r.d(y,"n",(function(){return er})),r.d(y,"title",(function(){return tr})),r.d(y,"Shader",(function(){return rr}));var b={};r.r(b),r.d(b,"n",(function(){return or})),r.d(b,"title",(function(){return ir})),r.d(b,"Shader",(function(){return ar}));var x={};r.r(x),r.d(x,"n",(function(){return cr})),r.d(x,"title",(function(){return lr})),r.d(x,"Shader",(function(){return fr}));var w={};r.r(w),r.d(w,"n",(function(){return pr})),r.d(w,"title",(function(){return dr})),r.d(w,"Shader",(function(){return hr}));var _={};r.r(_),r.d(_,"n",(function(){return mr})),r.d(_,"title",(function(){return gr})),r.d(_,"Shader",(function(){return yr}));var E={};r.r(E),r.d(E,"n",(function(){return wr})),r.d(E,"title",(function(){return _r})),r.d(E,"Shader",(function(){return Er}));var S={};r.r(S),r.d(S,"n",(function(){return Rr})),r.d(S,"title",(function(){return Tr})),r.d(S,"Shader",(function(){return zr}));var O={};r.r(O),r.d(O,"n",(function(){return Pr})),r.d(O,"title",(function(){return Ir})),r.d(O,"Shader",(function(){return jr}));var R={};r.r(R),r.d(R,"n",(function(){return kr})),r.d(R,"title",(function(){return Dr})),r.d(R,"Shader",(function(){return Lr}));var T={};r.r(T),r.d(T,"n",(function(){return Mr})),r.d(T,"title",(function(){return Ur})),r.d(T,"Shader",(function(){return Br}));var z={};r.r(z),r.d(z,"n",(function(){return $r})),r.d(z,"title",(function(){return Gr})),r.d(z,"Shader",(function(){return Hr}));var C={};r.r(C),r.d(C,"n",(function(){return Xr})),r.d(C,"title",(function(){return Kr})),r.d(C,"exportSize",(function(){return Yr})),r.d(C,"exportStart",(function(){return Qr})),r.d(C,"exportEnd",(function(){return Zr})),r.d(C,"exportFramePerSecond",(function(){return Jr})),r.d(C,"exportSpeed",(function(){return en})),r.d(C,"Shader",(function(){return tn}));var P={};r.r(P),r.d(P,"n",(function(){return on})),r.d(P,"title",(function(){return an})),r.d(P,"Shader",(function(){return sn}));var I={};r.r(I),r.d(I,"n",(function(){return fn})),r.d(I,"title",(function(){return un})),r.d(I,"Shader",(function(){return pn}));var j={};r.r(j),r.d(j,"n",(function(){return hn})),r.d(j,"title",(function(){return vn})),r.d(j,"Shader",(function(){return mn}));var A={};r.r(A),r.d(A,"n",(function(){return yn})),r.d(A,"title",(function(){return bn})),r.d(A,"Shader",(function(){return xn}));var k={};r.r(k),r.d(k,"n",(function(){return _n})),r.d(k,"title",(function(){return En})),r.d(k,"Shader",(function(){return On}));var D={};r.r(D),r.d(D,"n",(function(){return Tn})),r.d(D,"title",(function(){return zn})),r.d(D,"Shader",(function(){return Cn}));var L={};r.r(L),r.d(L,"n",(function(){return In})),r.d(L,"title",(function(){return jn})),r.d(L,"Shader",(function(){return An}));var N={};r.r(N),r.d(N,"n",(function(){return Dn})),r.d(N,"title",(function(){return Ln})),r.d(N,"Shader",(function(){return Nn}));var M={};r.r(M),r.d(M,"n",(function(){return Bn})),r.d(M,"title",(function(){return Fn})),r.d(M,"Shader",(function(){return qn}));var U={};r.r(U),r.d(U,"n",(function(){return Hn})),r.d(U,"title",(function(){return Vn})),r.d(U,"Shader",(function(){return Wn}));var B={};r.r(B),r.d(B,"n",(function(){return Kn})),r.d(B,"title",(function(){return Yn})),r.d(B,"Shader",(function(){return Qn}));var F={};r.r(F),r.d(F,"n",(function(){return eo})),r.d(F,"title",(function(){return to})),r.d(F,"Shader",(function(){return ro}));var q={};r.r(q),r.d(q,"n",(function(){return oo})),r.d(q,"title",(function(){return io})),r.d(q,"Shader",(function(){return ao}));var $={};r.r($),r.d($,"n",(function(){return co})),r.d($,"title",(function(){return lo})),r.d($,"Shader",(function(){return fo}));var G={};r.r(G),r.d(G,"n",(function(){return po})),r.d(G,"title",(function(){return ho})),r.d(G,"Shader",(function(){return vo}));var H={};r.r(H),r.d(H,"n",(function(){return go})),r.d(H,"title",(function(){return yo})),r.d(H,"Shader",(function(){return bo}));var V={};r.r(V),r.d(V,"n",(function(){return _o})),r.d(V,"title",(function(){return Eo})),r.d(V,"Shader",(function(){return So}));var W={};r.r(W),r.d(W,"n",(function(){return Ro})),r.d(W,"title",(function(){return To})),r.d(W,"Shader",(function(){return zo}));var X={};r.r(X),r.d(X,"n",(function(){return Po})),r.d(X,"title",(function(){return Io})),r.d(X,"Shader",(function(){return jo}));var K={};r.r(K),r.d(K,"n",(function(){return ko})),r.d(K,"title",(function(){return Do})),r.d(K,"Shader",(function(){return Lo}));var Y={};r.r(Y),r.d(Y,"n",(function(){return Mo})),r.d(Y,"title",(function(){return Uo})),r.d(Y,"Shader",(function(){return Bo}));var Q={};r.r(Q),r.d(Q,"n",(function(){return qo})),r.d(Q,"title",(function(){return $o})),r.d(Q,"exportSize",(function(){return Go})),r.d(Q,"exportStart",(function(){return Ho})),r.d(Q,"exportEnd",(function(){return Vo})),r.d(Q,"exportFramePerSecond",(function(){return Wo})),r.d(Q,"exportSpeed",(function(){return Xo})),r.d(Q,"Shader",(function(){return Ko}));var Z={};r.r(Z),r.d(Z,"n",(function(){return Zo})),r.d(Z,"title",(function(){return Jo})),r.d(Z,"Shader",(function(){return ei}));var J={};r.r(J),r.d(J,"n",(function(){return ri})),r.d(J,"title",(function(){return ni})),r.d(J,"exportSize",(function(){return oi})),r.d(J,"exportStart",(function(){return ii})),r.d(J,"exportEnd",(function(){return ai})),r.d(J,"exportFramePerSecond",(function(){return si})),r.d(J,"exportSpeed",(function(){return ci})),r.d(J,"Shader",(function(){return li}));var ee={};r.r(ee),r.d(ee,"n",(function(){return ui})),r.d(ee,"title",(function(){return pi})),r.d(ee,"Shader",(function(){return di}));var te={};r.r(te),r.d(te,"n",(function(){return vi})),r.d(te,"title",(function(){return mi})),r.d(te,"Shader",(function(){return gi}));var re={};r.r(re),r.d(re,"n",(function(){return bi})),r.d(re,"title",(function(){return xi})),r.d(re,"Shader",(function(){return wi}));var ne={};r.r(ne),r.d(ne,"n",(function(){return Ei})),r.d(ne,"title",(function(){return Si})),r.d(ne,"exportSize",(function(){return Oi})),r.d(ne,"exportStart",(function(){return Ri})),r.d(ne,"exportEnd",(function(){return Ti})),r.d(ne,"exportFramePerSecond",(function(){return zi})),r.d(ne,"exportSpeed",(function(){return Ci})),r.d(ne,"Shader",(function(){return Pi}));var oe={};r.r(oe),r.d(oe,"n",(function(){return ji})),r.d(oe,"title",(function(){return Ai})),r.d(oe,"Shader",(function(){return ki}));var ie={};r.r(ie),r.d(ie,"n",(function(){return Li})),r.d(ie,"title",(function(){return Ni})),r.d(ie,"exportSize",(function(){return Mi})),r.d(ie,"exportStart",(function(){return Ui})),r.d(ie,"exportEnd",(function(){return Bi})),r.d(ie,"exportFramePerSecond",(function(){return Fi})),r.d(ie,"exportSpeed",(function(){return qi})),r.d(ie,"Shader",(function(){return $i}));var ae={};r.r(ae),r.d(ae,"exportSize",(function(){return Wi})),r.d(ae,"exportStart",(function(){return Xi})),r.d(ae,"exportEnd",(function(){return Ki})),r.d(ae,"exportFramePerSecond",(function(){return Yi})),r.d(ae,"exportSpeed",(function(){return Qi})),r.d(ae,"exportMP4vb",(function(){return Zi})),r.d(ae,"n",(function(){return Ji})),r.d(ae,"title",(function(){return ea})),r.d(ae,"nfts",(function(){return ta})),r.d(ae,"Shader",(function(){return na}));var se={};r.r(se),r.d(se,"n",(function(){return aa})),r.d(se,"title",(function(){return sa})),r.d(se,"description",(function(){return ca})),r.d(se,"Shader",(function(){return la}));var ce={};r.r(ce),r.d(ce,"n",(function(){return pa})),r.d(ce,"title",(function(){return da})),r.d(ce,"Shader",(function(){return ha}));var le={};r.r(le),r.d(le,"n",(function(){return ma})),r.d(le,"title",(function(){return ga})),r.d(le,"exportEnd",(function(){return ya})),r.d(le,"exportFramePerSecond",(function(){return ba})),r.d(le,"preload",(function(){return xa})),r.d(le,"Shader",(function(){return wa}));var fe={};r.r(fe),r.d(fe,"n",(function(){return Ea})),r.d(fe,"title",(function(){return Sa})),r.d(fe,"exportEnd",(function(){return Oa})),r.d(fe,"exportFramePerSecond",(function(){return Ra})),r.d(fe,"exportSpeed",(function(){return Ta})),r.d(fe,"Logic",(function(){return za})),r.d(fe,"Shader",(function(){return Aa}));var ue={};r.r(ue),r.d(ue,"n",(function(){return La})),r.d(ue,"title",(function(){return Na})),r.d(ue,"exportSize",(function(){return Ma})),r.d(ue,"exportStart",(function(){return Ua})),r.d(ue,"exportEnd",(function(){return Ba})),r.d(ue,"exportFramePerSecond",(function(){return Fa})),r.d(ue,"exportSpeed",(function(){return qa})),r.d(ue,"exportMP4vb",(function(){return $a})),r.d(ue,"Logic",(function(){return Ha})),r.d(ue,"Shader",(function(){return Ka}));var pe={};r.r(pe),r.d(pe,"n",(function(){return Qa})),r.d(pe,"title",(function(){return Za})),r.d(pe,"exportEnd",(function(){return Ja})),r.d(pe,"nfts",(function(){return es})),r.d(pe,"Shader",(function(){return ts}));var de={};r.r(de),r.d(de,"n",(function(){return ns})),r.d(de,"title",(function(){return os})),r.d(de,"exportSize",(function(){return is})),r.d(de,"exportStart",(function(){return as})),r.d(de,"exportEnd",(function(){return ss})),r.d(de,"exportFramePerSecond",(function(){return cs})),r.d(de,"exportSpeed",(function(){return ls})),r.d(de,"exportSkipFrame",(function(){return fs})),r.d(de,"exportPaletteGenOnce",(function(){return us})),r.d(de,"exportPaletteSize",(function(){return ps})),r.d(de,"nfts",(function(){return ds})),r.d(de,"Shader",(function(){return hs}));var he={};r.r(he),r.d(he,"n",(function(){return gs})),r.d(he,"title",(function(){return ys})),r.d(he,"exportSize",(function(){return bs})),r.d(he,"exportStart",(function(){return xs})),r.d(he,"exportEnd",(function(){return ws})),r.d(he,"exportFramePerSecond",(function(){return _s})),r.d(he,"exportSpeed",(function(){return Es})),r.d(he,"exportSkipFrame",(function(){return Ss})),r.d(he,"exportPaletteGenOnce",(function(){return Os})),r.d(he,"exportPaletteSize",(function(){return Rs})),r.d(he,"Shader",(function(){return Ts}));var ve={};r.r(ve),r.d(ve,"n",(function(){return Ps})),r.d(ve,"title",(function(){return Is})),r.d(ve,"exportSize",(function(){return js})),r.d(ve,"exportStart",(function(){return As})),r.d(ve,"exportEnd",(function(){return ks})),r.d(ve,"exportFramePerSecond",(function(){return Ds})),r.d(ve,"exportSpeed",(function(){return Ls})),r.d(ve,"exportSkipFrame",(function(){return Ns})),r.d(ve,"exportPaletteGenOnce",(function(){return Ms})),r.d(ve,"exportPaletteSize",(function(){return Us})),r.d(ve,"Shader",(function(){return Bs}));var me={};r.r(me),r.d(me,"n",(function(){return $s})),r.d(me,"title",(function(){return Gs})),r.d(me,"exportSize",(function(){return Hs})),r.d(me,"exportStart",(function(){return Vs})),r.d(me,"exportEnd",(function(){return Ws})),r.d(me,"exportFramePerSecond",(function(){return Xs})),r.d(me,"exportSpeed",(function(){return Ks})),r.d(me,"exportSkipFrame",(function(){return Ys})),r.d(me,"exportPaletteGenOnce",(function(){return Qs})),r.d(me,"exportPaletteSize",(function(){return Zs})),r.d(me,"Shader",(function(){return Js}));var ge={};r.r(ge),r.d(ge,"n",(function(){return rc})),r.d(ge,"title",(function(){return nc})),r.d(ge,"exportSize",(function(){return oc})),r.d(ge,"exportStart",(function(){return ic})),r.d(ge,"exportEnd",(function(){return ac})),r.d(ge,"exportFramePerSecond",(function(){return sc})),r.d(ge,"exportSpeed",(function(){return cc})),r.d(ge,"exportPaletteGenOnce",(function(){return lc})),r.d(ge,"exportPaletteSize",(function(){return fc})),r.d(ge,"Shader",(function(){return uc}));var ye={};r.r(ye),r.d(ye,"n",(function(){return dc})),r.d(ye,"title",(function(){return hc})),r.d(ye,"exportSize",(function(){return vc})),r.d(ye,"exportStart",(function(){return mc})),r.d(ye,"exportEnd",(function(){return gc})),r.d(ye,"exportFramePerSecond",(function(){return yc})),r.d(ye,"exportSpeed",(function(){return bc})),r.d(ye,"exportPaletteGenOnce",(function(){return xc})),r.d(ye,"exportPaletteSize",(function(){return wc})),r.d(ye,"Shader",(function(){return _c}));var be=r("nKUr"),xe=r("rr/c");const we=1,_e="Hello 2020",Ee=({time:e})=>Object(be.jsx)(xe.Node,{shader:Se.day001,uniforms:{time:e}}),Se=xe.Shaders.create({day001:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
float vingt (vec2 p) {
...
}`}}),Oe=2,Re="stripes",Te=400,ze=0,Ce=60,Pe=24,Ie=1,je=({time:e})=>Object(be.jsx)(xe.Node,{shader:Ae.node,uniforms:{time:e}}),Ae=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),ke=3,De="zephyr",Le=({time:e})=>Object(be.jsx)(xe.Node,{shader:Ne.node,uniforms:{time:e}}),Ne=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}});var Me=r("q1tI"),Ue=r.n(Me);const Be=xe.Shaders.create({InitGameOfLife:{frag:xe.GLSL`
  precision highp float;
  uniform float seed;
  // i
  varying vec2 uv;
  ...
  }`}}),Fe=Ue.a.memo((({tick:e,size:t,refreshEveryTicks:r})=>e%(r||1/0)===0?Object(be.jsx)(xe.Node,{shader:Be.InitGameOfLife,uniforms:{seed:Math.random()},width:t,height:t,backbuffering:!0,sync:!0}):Object(be.jsx)(xe.Node,{shader:Be.GameOfLife,width:t,height:t,backbuffering:!0,sync:!0,uniforms:{t:xe.Uniform.Backbuffer,size:t}}))),qe=4,$e="Ray of Life";let Ge;const He=({time:e})=>{Ge||(Ge=e);const t=e-Ge,r=Math.floor(10*t),n=r+25,o=10*(1+Math.floor(r/50)),i=10*(1+Math.floor(n/50));return Object(be.jsx)(Ve,{time:e,a:Object(be.jsx)(xe.NearestCopy,{children:Object(be.jsx)(Fe,{refreshEveryTicks:50,tick:r,size:o})}),b:Object(be.jsx)(xe.NearestCopy,{children:Object(be.jsx)(Fe,{refreshEveryTicks:50,tick:n,size:i})})})},Ve=({a:e,b:t,time:r})=>Object(be.jsx)(xe.Node,{uniforms:{a:e,b:t,time:r},shader:We.main}),We=xe.Shaders.create({main:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Xe=5,Ke="Here We Go Again",Ye=({time:e})=>Object(be.jsx)(xe.Node,{shader:Qe.node,uniforms:{time:e}}),Qe=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    sqrt(vec3(1. - shad));
  gl_FragColor = vec4(c,1.0);
}`}}),Ze=6,Je="Bestagons",et=({time:e})=>Object(be.jsx)(xe.Node,{shader:tt.node,uniforms:{time:e}}),tt=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),rt=7,nt="Worms party",ot=({time:e})=>Object(be.jsx)(xe.Node,{shader:it.node,uniforms:{time:e}}),it=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    sqrt(vec3(1. - shad));
  gl_FragColor = vec4(c,1.0);
}`}}),at=8,st="moontains",ct=({time:e})=>Object(be.jsx)(xe.Node,{shader:lt.node,uniforms:{time:e}}),lt=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),ft=9,ut="Virus",pt=400,dt=16.3,ht=26,vt=24,mt=.8,gt=({time:e})=>Object(be.jsx)(xe.Node,{shader:yt.node,uniforms:{time:e}}),yt=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),bt=10,xt="ring",wt=({time:e})=>Object(be.jsx)(xe.Node,{shader:_t.node,uniforms:{time:e}}),_t=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Et=11,St="magic mouse",Ot=({time:e})=>Object(be.jsx)(xe.Node,{shader:Rt.node,uniforms:{time:e}}),Rt=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Tt=12,zt="floor is lava",Ct=({time:e})=>Object(be.jsx)(xe.Node,{shader:Pt.node,uniforms:{time:e}}),Pt=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),It=13,jt="chip",At=({time:e})=>Object(be.jsx)(xe.Node,{shader:kt.node,uniforms:{time:e}}),kt=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
`}}),Dt=14,Lt="seizure",Nt=({time:e})=>Object(be.jsx)(xe.Node,{shader:Mt.node,uniforms:{time:e}}),Mt=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Ut=xe.Shaders.create({blur1D:{frag:xe.GLSL`precision highp float;
varying vec2 uv;
uniform sampler2D t;
...
}`}});var Bt=({width:e,height:t,pixelRatio:r,direction:n,children:o})=>Object(be.jsx)(xe.Node,{shader:Ut.blur1D,width:e,height:t,pixelRatio:r,uniforms:{direction:n,resolution:xe.Uniform.Resolution,t:o}});const Ft=Math.sqrt(2)/2;var qt=(e,t,r)=>{const n=2*t*Math.ceil(e/2)/r;switch((e-1)%4){case 0:return[n,0];case 1:return[0,n];case 2:return[n*Ft,n*Ft];case 3:return[n*Ft,-n*Ft]}};const $t=({width:e,height:t,pixelRatio:r,factor:n,children:o,passes:i,directionForPass:a})=>{const s=c=>c<=0?o:Object(be.jsx)(Bt,{width:e,height:t,pixelRatio:r,direction:a(c,n,i),children:s(c-1)});return s(i)};$t.defaultProps={passes:2,directionForPass:qt};var Gt=$t;const Ht=xe.Shaders.create({blur1D:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
...
}`}});var Vt=({width:e,height:t,map:r,pixelRatio:n,direction:o,children:i})=>Object(be.jsx)(xe.Node,{shader:Ht.blur1D,width:e,height:t,pixelRatio:n,uniforms:{direction:o,resolution:xe.Uniform.Resolution,t:i,map:r}});const Wt=({width:e,height:t,map:r,pixelRatio:n,factor:o,children:i,passes:a,directionForPass:s})=>{const c=l=>l<=0?i:Object(be.jsx)(Vt,{width:e,height:t,map:r,pixelRatio:n,direction:s(l,o,a),children:c(l-1)});return c(a)};Wt.defaultProps={passes:2,directionForPass:qt};const Xt=15,Kt="parametric",Yt=({time:e})=>Object(be.jsx)(xe.LinearCopy,{children:Object(be.jsx)(Zt,{persistence:.98+.02*Math.cos(e)+-.8*Math.exp(-e),children:Object(be.jsx)(Gt,{passes:4,factor:.2,children:Object(be.jsx)(Qt,{time:e})})})}),Qt=({time:e})=>Object(be.jsx)(xe.Node,{shader:Jt.node,uniforms:{time:e}}),Zt=({children:e,persistence:t})=>Object(be.jsx)(xe.Node,{shader:Jt.persistence,backbuffering:!0,uniforms:{t:e,back:xe.Uniform.Backbuffer,persistence:t}}),Jt=xe.Shaders.create({persistence:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),er=16,tr="reuleaux",rr=({time:e})=>Object(be.jsx)(xe.Node,{shader:nr.node,uniforms:{time:e}}),nr=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    color(0.5 * time);
  gl_FragColor = vec4(c, 1.0);
}`}}),or=17,ir="screws",ar=({time:e})=>Object(be.jsx)(xe.Node,{shader:sr.node,uniforms:{time:e}}),sr=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),cr=18,lr="queen",fr=({time:e})=>Object(be.jsx)(xe.Node,{shader:ur.node,uniforms:{time:e}}),ur=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
}`}}),pr=19,dr="they were six",hr=({time:e})=>Object(be.jsx)(xe.Node,{shader:vr.node,uniforms:{time:e}}),vr=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),mr=20,gr="trippy tiles",yr=({time:e})=>Object(be.jsx)(xe.LinearCopy,{children:Object(be.jsx)(br,{persistence:.85,children:Object(be.jsx)(xe.Node,{shader:xr.node,uniforms:{time:e}})})}),br=({children:e,persistence:t})=>Object(be.jsx)(xe.Node,{shader:xr.persistence,backbuffering:!0,uniforms:{t:e,back:xe.Uniform.Backbuffer,persistence:t}}),xr=xe.Shaders.create({persistence:{frag:xe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),wr=21,_r="HODL",Er=({time:e})=>Object(be.jsx)(xe.LinearCopy,{children:Object(be.jsx)(Sr,{persistence:Math.min(.99,.015*e),time:e,children:Object(be.jsx)(xe.Node,{shader:Or.node,uniforms:{time:e}})})}),Sr=({children:e,persistence:t,time:r})=>Object(be.jsx)(xe.Node,{shader:Or.shakePersistence,backbuffering:!0,uniforms:{t:e,back:xe.Uniform.Backbuffer,persistence:t,time:r}}),Or=xe.Shaders.create({shakePersistence:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform sampler2D t, back;
uniform float time;
...
}`}}),Rr=22,Tr="atoms",zr=({time:e})=>Object(be.jsx)(xe.Node,{shader:Cr.node,uniforms:{time:e,t:"/images/einstein-tongue-out.jpg"}}),Cr=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D t;
...
void main() {
...
}`}}),Pr=23,Ir="Hexacubes",jr=({time:e})=>Object(be.jsx)(xe.Node,{shader:Ar.node,uniforms:{time:e}}),Ar=xe.Shaders.create({node:{frag:xe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform float time;
  const float PI = ${Math.PI};
  ...
  void main() {
    ...
    gl_FragColor = vec4(c, 1.0);
      ...
      `}}),kr=24,Dr="dark cubes",Lr=({time:e})=>Object(be.jsx)(xe.Node,{shader:Nr.node,uniforms:{time:e}}),Nr=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),Mr=25,Ur="Mandelbrot",Br=({time:e})=>Object(be.jsx)(xe.LinearCopy,{children:Object(be.jsx)(Fr,{persistence:.9,children:Object(be.jsx)(Gt,{passes:4,factor:.1,children:Object(be.jsx)(xe.Node,{shader:qr.node,uniforms:{time:e}})})})}),Fr=({children:e,persistence:t})=>Object(be.jsx)(xe.Node,{shader:qr.persistence,backbuffering:!0,uniforms:{t:e,back:xe.Uniform.Backbuffer,persistence:t}}),qr=xe.Shaders.create({persistence:{frag:xe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),$r=26,Gr="fumes",Hr=({time:e})=>Object(be.jsx)(xe.LinearCopy,{children:Object(be.jsx)(Vr,{persistence:.9,children:Object(be.jsx)(Gt,{passes:4,factor:Math.min(.6,.01*e),children:Object(be.jsx)(xe.Node,{shader:Wr.node,uniforms:{time:e}})})})}),Vr=({children:e,persistence:t})=>Object(be.jsx)(xe.Node,{shader:Wr.persistence,backbuffering:!0,uniforms:{t:e,back:xe.Uniform.Backbuffer,persistence:t}}),Wr=xe.Shaders.create({persistence:{frag:xe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Xr=27,Kr="real burning ship",Yr=400,Qr=0,Zr=60,Jr=12,en=2,tn=({time:e})=>Object(be.jsx)(xe.LinearCopy,{children:Object(be.jsx)(rn,{persistence:.8+.05*Math.random(),time:e,children:Object(be.jsx)(xe.Node,{shader:nn.node,uniforms:{time:e}})})}),rn=({children:e,persistence:t,time:r})=>Object(be.jsx)(xe.Node,{shader:nn.persistence,backbuffering:!0,uniforms:{t:e,back:xe.Uniform.Backbuffer,persistence:t,time:r}}),nn=xe.Shaders.create({persistence:{frag:xe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),on=28,an="No, I'M Batman",sn=({time:e})=>Object(be.jsx)(xe.LinearCopy,{children:Object(be.jsx)(cn,{persistence:.5+.48*Math.min(1,e/60),children:Object(be.jsx)(xe.Node,{shader:ln.node,uniforms:{time:e}})})}),cn=({children:e,persistence:t})=>Object(be.jsx)(xe.Node,{shader:ln.persistence,backbuffering:!0,uniforms:{t:e,back:xe.Uniform.Backbuffer,persistence:t}}),ln=xe.Shaders.create({persistence:{frag:xe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),fn=29,un="sdBitcoin(p)",pn=({time:e})=>Object(be.jsx)(xe.Node,{shader:dn.node,uniforms:{time:e}}),dn=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),hn=30,vn="21 millions",mn=({time:e})=>Object(be.jsx)(xe.Node,{shader:gn.node,uniforms:{time:e,numberInCirculation:18557031}}),gn=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),yn=31,bn="alien tower",xn=({time:e})=>Object(be.jsx)(xe.Node,{shader:wn.node,uniforms:{time:e,numberInCirculation:18557031}}),wn=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform float numberInCirculation;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),_n=32,En="GoL valley";let Sn;const On=({time:e})=>{Sn||(Sn=e);const t=e-Sn,r=Math.floor(12*t);return Object(be.jsx)(xe.Node,{shader:Rn.node,uniforms:{time:e,t:Object(be.jsx)(Fe,{refreshEveryTicks:100,tick:r,size:100})}})},Rn=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D t;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Tn=33,zn="x(x+32y)%(tN+1)%n";const Cn=({time:e})=>Object(be.jsx)(xe.Node,{shader:Pn.node,uniforms:{time:e}}),Pn=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),In=34,jn="\u230a2cos(x)sin(y+t)\u230b%7";const An=({time:e})=>Object(be.jsx)(xe.Node,{shader:kn.node,uniforms:{time:e}}),kn=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
#define PI ${Math.PI}
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Dn=35,Ln="aie confiance",Nn=({time:e})=>Object(be.jsx)(xe.LinearCopy,{children:Object(be.jsx)(Mn,{persistence:.6,children:Object(be.jsx)(xe.Node,{shader:Un.node,uniforms:{time:e}})})}),Mn=({children:e,persistence:t})=>Object(be.jsx)(xe.Node,{shader:Un.persistence,backbuffering:!0,uniforms:{t:e,back:xe.Uniform.Backbuffer,persistence:t}}),Un=xe.Shaders.create({persistence:{frag:xe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Bn=36,Fn="crois en moi",qn=({time:e})=>Object(be.jsx)(xe.LinearCopy,{children:Object(be.jsx)($n,{children:Object(be.jsx)(xe.Node,{shader:Gn.node,uniforms:{time:e}})})}),$n=({children:e,persistence:t})=>Object(be.jsx)(xe.Node,{shader:Gn.persistence,backbuffering:!0,uniforms:{t:e,back:xe.Uniform.Backbuffer,persistence:t}}),Gn=xe.Shaders.create({persistence:{frag:xe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Hn=37,Vn="sdBrick",Wn=({time:e})=>Object(be.jsx)(xe.Node,{shader:Xn.node,uniforms:{time:e}}),Xn=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Kn=38,Yn="Golden mandelbulb",Qn=({time:e})=>Object(be.jsx)(xe.LinearCopy,{children:Object(be.jsx)(Zn,{persistence:.5,children:Object(be.jsx)(xe.Node,{shader:Jn.node,uniforms:{time:e}})})}),Zn=({children:e,persistence:t})=>Object(be.jsx)(xe.Node,{shader:Jn.persistence,backbuffering:!0,uniforms:{t:e,back:xe.Uniform.Backbuffer,persistence:t}}),Jn=xe.Shaders.create({persistence:{frag:xe.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  clr /= 4.;
  gl_FragColor = vec4(clr, 1.0);
}`}}),eo=39,to="metaballs",ro=({time:e})=>Object(be.jsx)(xe.Node,{shader:no.node,uniforms:{time:e}}),no=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  clr /= 4.;
  gl_FragColor = vec4(clr, 1.0);
}`}}),oo=40,io="pen-o-plasma",ao=({time:e})=>Object(be.jsx)(xe.Node,{shader:so.node,uniforms:{time:e}}),so=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(clr, 1.0);
}`}}),co=41,lo="reflection",fo=({time:e})=>Object(be.jsx)(xe.Node,{shader:uo.node,uniforms:{time:e}}),uo=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),po=42,ho="reflection party",vo=({time:e})=>Object(be.jsx)(xe.Node,{shader:mo.node,uniforms:{time:e}}),mo=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c = mix(c, reflection(p, n, 10.), glossy);
  gl_FragColor = vec4(c, 1.0);
}`}}),go=43,yo="irreconcilable queens",bo=({time:e})=>Object(be.jsx)(xe.LinearCopy,{children:Object(be.jsx)(xo,{persistence:.4,children:Object(be.jsx)(xe.Node,{shader:wo.node,uniforms:{time:e}})})}),xo=({children:e,persistence:t})=>Object(be.jsx)(xe.Node,{shader:wo.persistence,backbuffering:!0,uniforms:{t:e,back:xe.Uniform.Backbuffer,persistence:t}}),wo=xe.Shaders.create({persistence:{frag:xe.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),_o=44,Eo="royal meeting",So=({time:e})=>Object(be.jsx)(xe.Node,{shader:Oo.node,uniforms:{time:e}}),Oo=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
#define PI ${Math.PI}
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),Ro=45,To="wood pawns army",zo=({time:e})=>Object(be.jsx)(xe.Node,{shader:Co.node,uniforms:{time:e,wood:"/images/seamless-wood-background-1.jpg"}}),Co=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),Po=46,Io="Bank of Bicoin",jo=({time:e})=>Object(be.jsx)(xe.Node,{shader:Ao.node,uniforms:{time:e}}),Ao=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),ko=47,Do="glow experiment",Lo=({time:e})=>Object(be.jsx)(xe.Node,{shader:No.node,uniforms:{time:e}}),No=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Mo=48,Uo="Starry Night",Bo=({time:e})=>Object(be.jsx)(xe.Node,{shader:Fo.node,uniforms:{time:e,img:"/images/seamless-wood2.jpg"}}),Fo=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(clr, 1.0);
}`}}),qo=49,$o="chinese lantern",Go=400,Ho=0,Vo=20,Wo=24,Xo=1.1,Ko=({time:e})=>Object(be.jsx)(xe.LinearCopy,{children:Object(be.jsx)(Yo,{persistence:.8,children:Object(be.jsx)(xe.Node,{shader:Qo.node,uniforms:{time:e}})})}),Yo=({children:e,persistence:t})=>Object(be.jsx)(xe.Node,{shader:Qo.persistence,backbuffering:!0,uniforms:{t:e,back:xe.Uniform.Backbuffer,persistence:t}}),Qo=xe.Shaders.create({persistence:{frag:xe.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  clr += c;
  gl_FragColor = vec4(clr, 1.0);
}`}}),Zo=50,Jo="jumpy rooks",ei=({time:e})=>Object(be.jsx)(xe.Node,{shader:ti.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),ti=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),ri=51,ni="symmetry chess",oi=400,ii=0,ai=20,si=24,ci=1,li=({time:e})=>Object(be.jsx)(xe.Node,{shader:fi.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),fi=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),ui=52,pi="knights dance",di=({time:e})=>Object(be.jsx)(xe.Node,{shader:hi.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),hi=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),vi=53,mi="cross waves",gi=({time:e})=>Object(be.jsx)(xe.Node,{shader:yi.node,uniforms:{time:e}}),yi=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  */
}`}}),bi=54,xi="chess set",wi=({time:e})=>Object(be.jsx)(xe.Node,{shader:_i.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),_i=xe.Shaders.create({node:{frag:xe.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  color = vec4(c, 1.0);
}`}}),Ei=55,Si="cube d'or",Oi=400,Ri=0,Ti=20,zi=24,Ci=1,Pi=({time:e})=>Object(be.jsx)(xe.Node,{shader:Ii.node,uniforms:{time:e}}),Ii=xe.Shaders.create({node:{frag:xe.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  #endif
  color = vec4(c, 1.0);
}`}}),ji=56,Ai="jade forest",ki=({time:e})=>Object(be.jsx)(xe.Node,{shader:Di.node,uniforms:{time:e}}),Di=xe.Shaders.create({node:{frag:xe.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  color = vec4(c, 1.0);
}`}}),Li=57,Ni="Virus v2",Mi=400,Ui=0,Bi=20,Fi=24,qi=.8,$i=({time:e})=>Object(be.jsx)(xe.Node,{shader:Gi.node,uniforms:{time:e}}),Gi=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}});var Hi=r("005v"),Vi=r.n(Hi);const Wi=400,Xi=0,Ki=30,Yi=20,Qi=1,Zi="5M",Ji=58,ea="Mandelglitch",ta=[{url:"https://ethblock.art/create/17",text:"Mint on ethblock.art"},{url:"https://ghostmarket.io/asset/pha/ghost/3008841254969814369262311336331954453497120774334547905246474374493804042898/",text:"ghostmarket.io: 400 KCAL"},{url:"https://www.hicetnunc.xyz/objkt/3063",text:"hicetnunc.xyz: Mandelglitch #1 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3068",text:"hicetnunc.xyz: Mandelglitch #2 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3071",text:"hicetnunc.xyz: Mandelglitch #3 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3072",text:"hicetnunc.xyz: Mandelglitch #4 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3073",text:"hicetnunc.xyz: Mandelglitch #5 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3077",text:"hicetnunc.xyz: Mandelglitch #6 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3088",text:"hicetnunc.xyz: Mandelglitch #7 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3574",text:"hicetnunc.xyz: Mandelglitch #8 (5 XTZ)"}];const ra=e=>e<.5?2*e*e:(4-2*e)*e-1;const na=({time:e,n:t,exporting:r})=>{const n=Object(Me.useMemo)((()=>function(e,t=0){const r=e?3:50,n=new Vi.a(t);return Array(r).fill(null).map((()=>Array(12).fill(null).map((()=>n.random()))))}(r,t)),[t,r]),o=e/10%n.length,i=Math.floor(o),a=o-i;let[s,c,l,f,u,p,d,h,v,m,g,y]=(b=n[i%n.length],x=n[(i+1)%n.length],w=ra(a),b.map(((e,t)=>e*(1-w)+x[t]*w)));var b,x,w;return l=ra(l),Object(be.jsx)(xe.LinearCopy,{children:Object(be.jsx)(ia,{persistence:r?0:.8,children:Object(be.jsx)(xe.Node,{shader:oa.main,uniforms:{aa:r?2:0,time:e,resolution:xe.Uniform.Resolution,travel:s,love:c,dark:l,rot:r?2*Math.PI/Ki:.1,s1:f,s2:u,s3:p,s4:d,s5:h,s6:v,s7:m,s8:g,s9:y}})})})},oa=xe.Shaders.create({persistence:{frag:xe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  `}}),ia=({children:e,persistence:t})=>Object(be.jsx)(xe.Node,{shader:oa.persistence,backbuffering:!0,uniforms:{t:e,back:xe.Uniform.Backbuffer,persistence:t}}),aa=59,sa="Pixels 256",ca="There will be only 256 patterns generated by this single fragment shader.",la=({time:e,n:t,exporting:r})=>Object(be.jsx)(fa,{n:t+1+(r?0:Math.floor(e))}),fa=Ue.a.memo((({n:e})=>{const t=new Vi.a(e%256),r=t.random(),n=t.random(),o=t.random(),i=t.random(),a=t.random(),s=t.random();return Object(be.jsx)(xe.Node,{shader:ua.node,uniforms:{s1:r,s2:n,s3:o,s4:i,s5:a,s6:s}})})),ua=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),pa=60,da="Bitcoin rainbow",ha=({time:e})=>Object(be.jsx)(xe.Node,{shader:va.node,uniforms:{time:e}}),va=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),ma=61,ga="Binance gradients",ya=1,ba=30,xa=["/images/shaders/binance.dist.png"],wa=({time:e})=>Object(be.jsx)(xe.Node,{shader:_a.node,uniforms:{time:e,image:"/images/shaders/binance.dist.png"}}),_a=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Ea=62,Sa="Overgrowth",Oa=20,Ra=40,Ta=1,za=({generation:e,size:t,n:r})=>Object(be.jsx)(xe.Node,{width:t,height:t,shader:ka.logic,uniforms:{generation:e,prev:xe.Uniform.Backbuffer,size:t,seed:r/100},backbuffering:!0}),Ca=Ue.a.memo(za),Pa=({time:e,generation:t,n:r})=>Object(be.jsx)(xe.Node,{shader:ka.render,uniforms:{time:e,logic:Object(be.jsx)(Ca,{generation:t,size:140,n:r})},uniformsOptions:{logic:{interpolation:"nearest"}}}),Ia=Ue.a.memo(Pa),ja=1e3*Math.random(),Aa=({time:e,n:t})=>Object(be.jsx)(Ia,{n:t+ja,time:e,generation:Math.floor(30*e)},t),ka=xe.Shaders.create({logic:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
...
`}});var Da=r("AJhG");const La=63,Na="Relics",Ma=400,Ua=2,Ba=4,Fa=20,qa=1,$a="5M",Ga={colors:[.7,.55,.4],logicSize:80,amp:1,base:2,persistance:.89,delta:.5,seed:0};console.log(Object.keys(Ga).map((e=>String(Ga[e]))).join("_"));const Ha=({g:e,size:t,seed:r,amp:n,base:o,persistance:i,delta:a})=>Object(be.jsx)(xe.Node,{width:t,height:t,shader:Ya.logic,uniforms:{amp:n,base:o,g:e,prev:xe.Uniform.Backbuffer,size:t,seed:r,persistance:i,delta:a},backbuffering:!0},t),Va=Ue.a.memo(Ha),Wa=({g:e,colors:t,amp:r,base:n,persistance:o,delta:i,logicSize:a,seed:s})=>Object(be.jsx)(xe.Node,{shader:Ya.render,uniforms:{colors:t,logic:Object(be.jsx)(Va,{amp:r,base:n,g:e,size:a,seed:s,persistance:o,delta:i})},uniformsOptions:{logic:{interpolation:"nearest"}}}),Xa=Ue.a.memo(Wa),Ka=({time:e})=>{const{colors:t,logicSize:r,amp:n,base:o,persistance:i,delta:a,seed:s}=Object(Da.b)(Ga);return Object(be.jsx)(Xa,{amp:n,base:o,g:Math.floor(20*e)%40,colors:t,persistance:i,delta:a,seed:s,logicSize:r})},Ya=xe.Shaders.create({logic:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform sampler2D prev;
uniform float g;
...
`}}),Qa=64,Za="Intersection",Ja=8*Math.PI,es=[{url:"https://www.hicetnunc.xyz/objkt/28592",text:"hic et nunc NFT"}],ts=({time:e})=>Object(be.jsx)(xe.Node,{shader:rs.render,uniforms:{resolution:xe.Uniform.Resolution,time:e}}),rs=xe.Shaders.create({render:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform vec2 resolution;
...
`}}),ns=65,os="Duality",is=800,as=4,ss=8,cs=30,ls=1,fs=3,us=!0,ps=16,ds=[{url:"https://hicetnunc.xyz/objkt/64326",text:"hic et nunc NFT"}],hs=({time:e})=>Object(be.jsx)(xe.NearestCopy,{children:Object(be.jsx)(vs,{persistence:.3,children:Object(be.jsx)(xe.Node,{shader:ms.render,uniforms:{resolution:xe.Uniform.Resolution,time:e}})})}),vs=({children:e,persistence:t})=>Object(be.jsx)(xe.Node,{shader:ms.persistence,backbuffering:!0,uniforms:{t:e,back:xe.Uniform.Backbuffer,persistence:t}}),ms=xe.Shaders.create({persistence:{frag:xe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),gs=66,ys="hicetnunc",bs=800,xs=2,ws=xs+8,_s=30,Es=1,Ss=7,Os=!0,Rs=16,Ts=({time:e})=>Object(be.jsx)(xe.NearestCopy,{children:Object(be.jsx)(zs,{persistence:.5,children:Object(be.jsx)(xe.Node,{shader:Cs.render,uniforms:{resolution:xe.Uniform.Resolution,time:e,freq:2}})})}),zs=({children:e,persistence:t})=>Object(be.jsx)(xe.Node,{shader:Cs.persistence,backbuffering:!0,uniforms:{t:e,back:xe.Uniform.Backbuffer,persistence:t}}),Cs=xe.Shaders.create({persistence:{frag:xe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Ps=67,Is="Jumping blob",js=800,As=2,ks=As+8,Ds=30,Ls=1,Ns=7,Ms=!0,Us=16,Bs=({time:e})=>Object(be.jsx)(xe.NearestCopy,{children:Object(be.jsx)(Fs,{persistence:.6,children:Object(be.jsx)(xe.Node,{shader:qs.render,uniforms:{resolution:xe.Uniform.Resolution,time:e,freq:2}})})}),Fs=({children:e,persistence:t})=>Object(be.jsx)(xe.Node,{shader:qs.persistence,backbuffering:!0,uniforms:{t:e,back:xe.Uniform.Backbuffer,persistence:t}}),qs=xe.Shaders.create({persistence:{frag:xe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),$s=68,Gs="ring",Hs=800,Vs=2,Ws=Vs+10,Xs=30,Ks=1,Ys=7,Qs=!0,Zs=128,Js=({time:e})=>Object(be.jsx)(xe.NearestCopy,{children:Object(be.jsx)(ec,{persistence:.9,children:Object(be.jsx)(xe.Node,{shader:tc.render,uniforms:{resolution:xe.Uniform.Resolution,time:e,freq:2}})})}),ec=({children:e,persistence:t})=>Object(be.jsx)(xe.Node,{shader:tc.persistence,backbuffering:!0,uniforms:{t:e,back:xe.Uniform.Backbuffer,persistence:t}}),tc=xe.Shaders.create({persistence:{frag:xe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),rc=69,nc="Bananas paradize",oc=400,ic=0,ac=20,sc=20,cc=1,lc=!0,fc=128,uc=({time:e})=>Object(be.jsx)(xe.Node,{shader:pc.node,uniforms:{time:e,resolution:xe.Uniform.Resolution}}),pc=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),dc=70,hc="warp1",vc=400,mc=0,gc=20,yc=20,bc=1,xc=!1,wc=256,_c=({time:e})=>Object(be.jsx)(xe.Node,{shader:Ec.node,uniforms:{time:e,resolution:xe.Uniform.Resolution}}),Ec=xe.Shaders.create({node:{frag:xe.GLSL`
precision highp float;
varying vec2 uv;

...
}`}}).copy;t.default=i},MAJC:function(e,t,r){"use strict";e.exports=function(e){return"undefined"!==typeof e&&null!==e&&("object"===typeof e||"function"===typeof e)}},Ni9w:function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;t.default=class{constructor(){var e,t,r;r=[],(t="_loaders")in(e=this)?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r}add(e){this._loaders.push(e),this._loaders.sort(((e,t)=>("number"===typeof t.priority?t.priority:0)-("number"===typeof e.priority?e.priority:0)))}remove(e){const t=this._loaders.indexOf(e);-1!==t&&this._loaders.splice(t,1)}get(){return this._loaders}}},O8XB:function(e,t,r){"use strict";(function(e,n){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var o,i,a,s,c,l=p(r("tbvF")),f=p(r("Ytbt")),u=p(r("zqV6"));function p(e){return e&&e.__esModule?e:{default:e}}"undefined"===typeof e&&(n.Buffer=(i=o=class{},c=t=>t instanceof e,(s="isBuffer")in(a=o)?Object.defineProperty(a,s,{value:c,enumerable:!0,configurable:!0,writable:!0}):a[s]=c,i));t.default=(e,t,r,n)=>{const o="undefined"!==typeof WebGLRenderingContext&&e instanceof WebGLRenderingContext;let i=r.dtype,a=r.shape.slice(),s=e.getParameter(e.MAX_TEXTURE_SIZE);if(a[0]<0||a[0]>s||a[1]<0||a[1]>s)throw new Error("gl-react: Invalid texture size");let c=function(e,t){return 3===e.length?1===t[2]&&t[1]===e[0]*e[2]&&t[0]===e[2]:1===t[0]&&t[1]===e[0]}(a,r.stride.slice()),p=0;"float32"===i?p=e.FLOAT:"float64"===i?(p=e.FLOAT,c=!1,i="float32"):"uint8"===i?p=e.UNSIGNED_BYTE:(p=e.UNSIGNED_BYTE,c=!1,i="uint8");let d,v=0,h=0;if(2===a.length)h=v=e.LUMINANCE,a=[a[0],a[1],1],r=(0,l.default)(r.data,a,[r.stride[0],r.stride[1],1],r.offset);else{if(3!==a.length)throw new Error("gl-texture2d: Invalid shape for texture");if(1===a[2])h=v=e.ALPHA,o||(n=!1);else if(2===a[2])h=v=e.LUMINANCE_ALPHA,o||(n=!1);else if(3===a[2])v=e.RGB,h=o?e.RGB:e.RGB32F;else{if(4!==a[2])throw new Error("gl-texture2d: Invalid shape for pixel coords");v=e.RGBA,h=o?e.RGBA:e.RGBA32F}}p!==e.FLOAT||n||(p=e.UNSIGNED_BYTE,c=!1);let m,g=r.size;if(c)d=0===r.offset&&r.data.length===g?r.data:r.data.subarray(r.offset,r.offset+g);else{let t=[a[2],a[2]*a[0],1];if("float32"!==i&&"float64"!==i||p!==e.UNSIGNED_BYTE){m=u.default.malloc(g,i);let e=(0,l.default)(m,a,t,0);f.default.assign(e,r)}else{m=u.default.malloc(g,"uint8"),function(e,t){f.default.muls(e,t,255)}((0,l.default)(m,a,t,0),r)}d=m.subarray(0,g)}e.texImage2D(e.TEXTURE_2D,0,h,a[0],a[1],0,v,p,d),m&&u.default.free(m)}}).call(this,r("HDXh").Buffer,r("ntbh"))},OTww:function(e,t,r){"use strict";(function(e){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var n,o=(n=r("Ni9w"))&&n.__esModule?n:{default:n};const i="undefined"===typeof window?e:window,a="__webglTextureLoader_registry";var s=i[a]||(i[a]=new o.default);t.default=s}).call(this,r("ntbh"))},QLaP:function(e,t,r){"use strict";e.exports=function(e,t,r,n,o,i,a,s){if(!e){var c;if(void 0===t)c=new Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else{var l=[r,n,o,i,a,s],f=0;(c=new Error(t.replace(/%s/g,(function(){return l[f++]})))).name="Invariant Violation"}throw c.framesToPop=1,c}}},QM7d:function(e,t,r){"use strict";var n=r("033R");function o(){this.argTypes=[],this.shimArgs=[],this.arrayArgs=[],this.arrayBlockIndices=[],this.scalarArgs=[],this.offsetArgs=[],this.offsetArgIndex=[],this.indexArgs=[],this.shapeArgs=[],this.funcName="",this.pre=null,this.body=null,this.post=null,this.debug=!1}e.exports=function(e){var t=new o;t.pre=e.pre,t.body=e.body,t.post=e.post;var r=e.args.slice(0);t.argTypes=r;for(var i=0;i<r.length;++i){var a=r[i];if("array"===a||"object"===typeof a&&a.blockIndices){if(t.argTypes[i]="array",t.arrayArgs.push(i),t.arrayBlockIndices.push(a.blockIndices?a.blockIndices:0),t.shimArgs.push("array"+i),i<t.pre.args.length&&t.pre.args[i].count>0)throw new Error("cwise: pre() block may not reference array args");if(i<t.post.args.length&&t.post.args[i].count>0)throw new Error("cwise: post() block may not reference array args")}else if("scalar"===a)t.scalarArgs.push(i),t.shimArgs.push("scalar"+i);else if("index"===a){if(t.indexArgs.push(i),i<t.pre.args.length&&t.pre.args[i].count>0)throw new Error("cwise: pre() block may not reference array index");if(i<t.body.args.length&&t.body.args[i].lvalue)throw new Error("cwise: body() block may not write to array index");if(i<t.post.args.length&&t.post.args[i].count>0)throw new Error("cwise: post() block may not reference array index")}else if("shape"===a){if(t.shapeArgs.push(i),i<t.pre.args.length&&t.pre.args[i].lvalue)throw new Error("cwise: pre() block may not write to array shape");if(i<t.body.args.length&&t.body.args[i].lvalue)throw new Error("cwise: body() block may not write to array shape");if(i<t.post.args.length&&t.post.args[i].lvalue)throw new Error("cwise: post() block may not write to array shape")}else{if("object"!==typeof a||!a.offset)throw new Error("cwise: Unknown argument type "+r[i]);t.argTypes[i]="offset",t.offsetArgs.push({array:a.array,offset:a.offset}),t.offsetArgIndex.push(i)}}if(t.arrayArgs.length<=0)throw new Error("cwise: No array arguments specified");if(t.pre.args.length>r.length)throw new Error("cwise: Too many arguments in pre() block");if(t.body.args.length>r.length)throw new Error("cwise: Too many arguments in body() block");if(t.post.args.length>r.length)throw new Error("cwise: Too many arguments in post() block");return t.debug=!!e.printCode||!!e.debug,t.funcName=e.funcName||"cwise",t.blockSize=e.blockSize||64,n(t)}},R9Te:function(e,t,r){"use strict";var n=r("CyWo"),o=r("z08I"),i=r("+0iv"),a=r("vCtr");function s(e){return"__proto__"!==e&&"constructor"!==e&&"prototype"!==e}e.exports=function(e,t,r){if(!a(e))return e;if(Array.isArray(t)&&(t=[].concat.apply([],t).join(".")),"string"!==typeof t)return e;for(var c=n(t,{sep:".",brackets:!0}).filter(s),l=c.length,f=-1,u=e;++f<l;){var p=c[f];f===l-1?i(u[p])&&i(r)?u[p]=o({},u[p],r):u[p]=r:(a(u[p])||(u[p]={}),u=u[p])}return e}},RjOF:function(e,t,r){"use strict";var n,o="";e.exports=function(e,t){if("string"!==typeof e)throw new TypeError("expected a string");if(1===t)return e;if(2===t)return e+e;var r=e.length*t;if(n!==e||"undefined"===typeof n)n=e,o="";else if(o.length>=r)return o.substr(0,r);for(;r>o.length&&t>1;)1&t&&(o+=e),t>>=1,e+=e;return o=(o+=e).substr(0,r)}},Ry8g:function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;t.default=e=>{const t=e.getExtension("WEBGL_lose_context");t&&t.loseContext()}},SMLl:function(e,t,r){"use strict";var n=r("RjOF");e.exports=function(e,t,r){return n(r="undefined"!==typeof r?r+"":" ",t)+e}},TBio:function(e,t,r){"use strict";var n=r("F16p");function o(e,t,r){var n,o,i=e.length,a=t.arrayArgs.length,s=t.indexArgs.length>0,c=[],l=[],f=0,u=0;for(n=0;n<i;++n)l.push(["i",n,"=0"].join(""));for(o=0;o<a;++o)for(n=0;n<i;++n)u=f,f=e[n],0===n?l.push(["d",o,"s",n,"=t",o,"p",f].join("")):l.push(["d",o,"s",n,"=(t",o,"p",f,"-s",u,"*t",o,"p",u,")"].join(""));for(l.length>0&&c.push("var "+l.join(",")),n=i-1;n>=0;--n)f=e[n],c.push(["for(i",n,"=0;i",n,"<s",f,";++i",n,"){"].join(""));for(c.push(r),n=0;n<i;++n){for(u=f,f=e[n],o=0;o<a;++o)c.push(["p",o,"+=d",o,"s",n].join(""));s&&(n>0&&c.push(["index[",u,"]-=s",u].join("")),c.push(["++index[",f,"]"].join(""))),c.push("}")}return c.join("\n")}function i(e,t,r){for(var n=e.body,o=[],i=[],a=0;a<e.args.length;++a){var s=e.args[a];if(!(s.count<=0)){var c=new RegExp(s.name,"g"),l="",f=t.arrayArgs.indexOf(a);switch(t.argTypes[a]){case"offset":var u=t.offsetArgIndex.indexOf(a);f=t.offsetArgs[u].array,l="+q"+u;case"array":l="p"+f+l;var p="l"+a,d="a"+f;if(0===t.arrayBlockIndices[f])1===s.count?"generic"===r[f]?s.lvalue?(o.push(["var ",p,"=",d,".get(",l,")"].join("")),n=n.replace(c,p),i.push([d,".set(",l,",",p,")"].join(""))):n=n.replace(c,[d,".get(",l,")"].join("")):n=n.replace(c,[d,"[",l,"]"].join("")):"generic"===r[f]?(o.push(["var ",p,"=",d,".get(",l,")"].join("")),n=n.replace(c,p),s.lvalue&&i.push([d,".set(",l,",",p,")"].join(""))):(o.push(["var ",p,"=",d,"[",l,"]"].join("")),n=n.replace(c,p),s.lvalue&&i.push([d,"[",l,"]=",p].join("")));else{for(var v=[s.name],h=[l],m=0;m<Math.abs(t.arrayBlockIndices[f]);m++)v.push("\\s*\\[([^\\]]+)\\]"),h.push("$"+(m+1)+"*t"+f+"b"+m);if(c=new RegExp(v.join(""),"g"),l=h.join("+"),"generic"===r[f])throw new Error("cwise: Generic arrays not supported in combination with blocks!");n=n.replace(c,[d,"[",l,"]"].join(""))}break;case"scalar":n=n.replace(c,"Y"+t.scalarArgs.indexOf(a));break;case"index":n=n.replace(c,"index");break;case"shape":n=n.replace(c,"shape")}}}return[o.join("\n"),n,i.join("\n")].join("\n").trim()}function a(e){for(var t=new Array(e.length),r=!0,n=0;n<e.length;++n){var o=e[n],i=o.match(/\d+/);i=i?i[0]:"",0===o.charAt(0)?t[n]="u"+o.charAt(1)+i:t[n]=o.charAt(0)+i,n>0&&(r=r&&t[n]===t[n-1])}return r?t[0]:t.join("")}e.exports=function(e,t){for(var r=t[1].length-Math.abs(e.arrayBlockIndices[0])|0,s=new Array(e.arrayArgs.length),c=new Array(e.arrayArgs.length),l=0;l<e.arrayArgs.length;++l)c[l]=t[2*l],s[l]=t[2*l+1];var f=[],u=[],p=[],d=[],v=[];for(l=0;l<e.arrayArgs.length;++l){e.arrayBlockIndices[l]<0?(p.push(0),d.push(r),f.push(r),u.push(r+e.arrayBlockIndices[l])):(p.push(e.arrayBlockIndices[l]),d.push(e.arrayBlockIndices[l]+r),f.push(0),u.push(e.arrayBlockIndices[l]));for(var h=[],m=0;m<s[l].length;m++)p[l]<=s[l][m]&&s[l][m]<d[l]&&h.push(s[l][m]-p[l]);v.push(h)}var g=["SS"],b=["'use strict'"],y=[];for(m=0;m<r;++m)y.push(["s",m,"=SS[",m,"]"].join(""));for(l=0;l<e.arrayArgs.length;++l){g.push("a"+l),g.push("t"+l),g.push("p"+l);for(m=0;m<r;++m)y.push(["t",l,"p",m,"=t",l,"[",p[l]+m,"]"].join(""));for(m=0;m<Math.abs(e.arrayBlockIndices[l]);++m)y.push(["t",l,"b",m,"=t",l,"[",f[l]+m,"]"].join(""))}for(l=0;l<e.scalarArgs.length;++l)g.push("Y"+l);if(e.shapeArgs.length>0&&y.push("shape=SS.slice(0)"),e.indexArgs.length>0){var x=new Array(r);for(l=0;l<r;++l)x[l]="0";y.push(["index=[",x.join(","),"]"].join(""))}for(l=0;l<e.offsetArgs.length;++l){var w=e.offsetArgs[l],_=[];for(m=0;m<w.offset.length;++m)0!==w.offset[m]&&(1===w.offset[m]?_.push(["t",w.array,"p",m].join("")):_.push([w.offset[m],"*t",w.array,"p",m].join("")));0===_.length?y.push("q"+l+"=0"):y.push(["q",l,"=",_.join("+")].join(""))}var E=n([].concat(e.pre.thisVars).concat(e.body.thisVars).concat(e.post.thisVars));for((y=y.concat(E)).length>0&&b.push("var "+y.join(",")),l=0;l<e.arrayArgs.length;++l)b.push("p"+l+"|=0");e.pre.body.length>3&&b.push(i(e.pre,e,c));var S=i(e.body,e,c),O=function(e){for(var t=0,r=e[0].length;t<r;){for(var n=1;n<e.length;++n)if(e[n][t]!==e[0][t])return t;++t}return t}(v);O<r?b.push(function(e,t,r,n){for(var i=t.length,a=r.arrayArgs.length,s=r.blockSize,c=r.indexArgs.length>0,l=[],f=0;f<a;++f)l.push(["var offset",f,"=p",f].join(""));for(f=e;f<i;++f)l.push(["for(var j"+f+"=SS[",t[f],"]|0;j",f,">0;){"].join("")),l.push(["if(j",f,"<",s,"){"].join("")),l.push(["s",t[f],"=j",f].join("")),l.push(["j",f,"=0"].join("")),l.push(["}else{s",t[f],"=",s].join("")),l.push(["j",f,"-=",s,"}"].join("")),c&&l.push(["index[",t[f],"]=j",f].join(""));for(f=0;f<a;++f){for(var u=["offset"+f],p=e;p<i;++p)u.push(["j",p,"*t",f,"p",t[p]].join(""));l.push(["p",f,"=(",u.join("+"),")"].join(""))}for(l.push(o(t,r,n)),f=e;f<i;++f)l.push("}");return l.join("\n")}(O,v[0],e,S)):b.push(o(v[0],e,S)),e.post.body.length>3&&b.push(i(e.post,e,c)),e.debug&&console.log("-----Generated cwise routine for ",t,":\n"+b.join("\n")+"\n----------");var R=[e.funcName||"unnamed","_cwise_loop_",s[0].join("s"),"m",O,a(c)].join("");return new Function(["function ",R,"(",g.join(","),"){",b.join("\n"),"} return ",R].join(""))()}},TGEO:function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),Object.defineProperty(t,"WebGLTextureLoader",{enumerable:!0,get:function(){return n.default}}),Object.defineProperty(t,"WebGLTextureLoaderAsyncHashCache",{enumerable:!0,get:function(){return o.default}}),Object.defineProperty(t,"WebGLTextureLoaderSyncHashCache",{enumerable:!0,get:function(){return i.default}}),Object.defineProperty(t,"LoadersRegistry",{enumerable:!0,get:function(){return a.default}}),Object.defineProperty(t,"LoaderResolver",{enumerable:!0,get:function(){return s.default}}),Object.defineProperty(t,"globalRegistry",{enumerable:!0,get:function(){return c.default}});var n=l(r("HbIt")),o=l(r("cDsr")),i=l(r("VYxY")),a=l(r("Ni9w")),s=l(r("LhdL")),c=l(r("OTww"));function l(e){return e&&e.__esModule?e:{default:e}}},TKux:function(e,t,r){"use strict";r.d(t,"b",(function(){return ll})),r.d(t,"c",(function(){return fl})),r.d(t,"a",(function(){return ul}));var n={};r.r(n),r.d(n,"n",(function(){return Se})),r.d(n,"title",(function(){return Oe})),r.d(n,"Shader",(function(){return Re}));var o={};r.r(o),r.d(o,"n",(function(){return ze})),r.d(o,"title",(function(){return Pe})),r.d(o,"exportSize",(function(){return Ce})),r.d(o,"exportStart",(function(){return Ie})),r.d(o,"exportEnd",(function(){return je})),r.d(o,"exportFramePerSecond",(function(){return Ae})),r.d(o,"exportSpeed",(function(){return ke})),r.d(o,"Shader",(function(){return De}));var i={};r.r(i),r.d(i,"n",(function(){return Ne})),r.d(i,"title",(function(){return Me})),r.d(i,"Shader",(function(){return Ue}));var a={};r.r(a),r.d(a,"n",(function(){return He})),r.d(a,"title",(function(){return Ve})),r.d(a,"Shader",(function(){return Xe}));var s={};r.r(s),r.d(s,"n",(function(){return Qe})),r.d(s,"title",(function(){return Ze})),r.d(s,"Shader",(function(){return Je}));var c={};r.r(c),r.d(c,"n",(function(){return tt})),r.d(c,"title",(function(){return rt})),r.d(c,"Shader",(function(){return nt}));var l={};r.r(l),r.d(l,"n",(function(){return it})),r.d(l,"title",(function(){return at})),r.d(l,"Shader",(function(){return st}));var f={};r.r(f),r.d(f,"n",(function(){return lt})),r.d(f,"title",(function(){return ft})),r.d(f,"Shader",(function(){return ut}));var u={};r.r(u),r.d(u,"n",(function(){return dt})),r.d(u,"title",(function(){return vt})),r.d(u,"exportSize",(function(){return ht})),r.d(u,"exportStart",(function(){return mt})),r.d(u,"exportEnd",(function(){return gt})),r.d(u,"exportFramePerSecond",(function(){return bt})),r.d(u,"exportSpeed",(function(){return yt})),r.d(u,"Shader",(function(){return xt}));var p={};r.r(p),r.d(p,"n",(function(){return _t})),r.d(p,"title",(function(){return Et})),r.d(p,"Shader",(function(){return St}));var d={};r.r(d),r.d(d,"n",(function(){return Rt})),r.d(d,"title",(function(){return Tt})),r.d(d,"Shader",(function(){return zt}));var v={};r.r(v),r.d(v,"n",(function(){return Ct})),r.d(v,"title",(function(){return It})),r.d(v,"Shader",(function(){return jt}));var h={};r.r(h),r.d(h,"n",(function(){return kt})),r.d(h,"title",(function(){return Dt})),r.d(h,"Shader",(function(){return Lt}));var m={};r.r(m),r.d(m,"n",(function(){return Mt})),r.d(m,"title",(function(){return Ut})),r.d(m,"Shader",(function(){return Bt}));var g={};r.r(g),r.d(g,"n",(function(){return Qt})),r.d(g,"title",(function(){return Zt})),r.d(g,"Shader",(function(){return Jt}));var b={};r.r(b),r.d(b,"n",(function(){return nr})),r.d(b,"title",(function(){return or})),r.d(b,"Shader",(function(){return ir}));var y={};r.r(y),r.d(y,"n",(function(){return sr})),r.d(y,"title",(function(){return cr})),r.d(y,"Shader",(function(){return lr}));var x={};r.r(x),r.d(x,"n",(function(){return ur})),r.d(x,"title",(function(){return pr})),r.d(x,"Shader",(function(){return dr}));var w={};r.r(w),r.d(w,"n",(function(){return hr})),r.d(w,"title",(function(){return mr})),r.d(w,"Shader",(function(){return gr}));var _={};r.r(_),r.d(_,"n",(function(){return yr})),r.d(_,"title",(function(){return xr})),r.d(_,"Shader",(function(){return wr}));var E={};r.r(E),r.d(E,"n",(function(){return Sr})),r.d(E,"title",(function(){return Or})),r.d(E,"Shader",(function(){return Rr}));var S={};r.r(S),r.d(S,"n",(function(){return Pr})),r.d(S,"title",(function(){return Cr})),r.d(S,"Shader",(function(){return Ir}));var O={};r.r(O),r.d(O,"n",(function(){return Ar})),r.d(O,"title",(function(){return kr})),r.d(O,"Shader",(function(){return Dr}));var R={};r.r(R),r.d(R,"n",(function(){return Nr})),r.d(R,"title",(function(){return Mr})),r.d(R,"Shader",(function(){return Ur}));var T={};r.r(T),r.d(T,"n",(function(){return Fr})),r.d(T,"title",(function(){return qr})),r.d(T,"Shader",(function(){return $r}));var z={};r.r(z),r.d(z,"n",(function(){return Vr})),r.d(z,"title",(function(){return Wr})),r.d(z,"Shader",(function(){return Xr}));var P={};r.r(P),r.d(P,"n",(function(){return Qr})),r.d(P,"title",(function(){return Zr})),r.d(P,"exportSize",(function(){return Jr})),r.d(P,"exportStart",(function(){return en})),r.d(P,"exportEnd",(function(){return tn})),r.d(P,"exportFramePerSecond",(function(){return rn})),r.d(P,"exportSpeed",(function(){return nn})),r.d(P,"Shader",(function(){return on}));var C={};r.r(C),r.d(C,"n",(function(){return cn})),r.d(C,"title",(function(){return ln})),r.d(C,"Shader",(function(){return fn}));var I={};r.r(I),r.d(I,"n",(function(){return dn})),r.d(I,"title",(function(){return vn})),r.d(I,"Shader",(function(){return hn}));var j={};r.r(j),r.d(j,"n",(function(){return gn})),r.d(j,"title",(function(){return bn})),r.d(j,"Shader",(function(){return yn}));var A={};r.r(A),r.d(A,"n",(function(){return wn})),r.d(A,"title",(function(){return _n})),r.d(A,"Shader",(function(){return En}));var k={};r.r(k),r.d(k,"n",(function(){return On})),r.d(k,"title",(function(){return Rn})),r.d(k,"Shader",(function(){return zn}));var D={};r.r(D),r.d(D,"n",(function(){return Cn})),r.d(D,"title",(function(){return In})),r.d(D,"Shader",(function(){return jn}));var L={};r.r(L),r.d(L,"n",(function(){return kn})),r.d(L,"title",(function(){return Dn})),r.d(L,"Shader",(function(){return Ln}));var N={};r.r(N),r.d(N,"n",(function(){return Mn})),r.d(N,"title",(function(){return Un})),r.d(N,"Shader",(function(){return Bn}));var M={};r.r(M),r.d(M,"n",(function(){return $n})),r.d(M,"title",(function(){return Gn})),r.d(M,"Shader",(function(){return Hn}));var U={};r.r(U),r.d(U,"n",(function(){return Xn})),r.d(U,"title",(function(){return Kn})),r.d(U,"Shader",(function(){return Yn}));var B={};r.r(B),r.d(B,"n",(function(){return Zn})),r.d(B,"title",(function(){return Jn})),r.d(B,"Shader",(function(){return eo}));var F={};r.r(F),r.d(F,"n",(function(){return no})),r.d(F,"title",(function(){return oo})),r.d(F,"Shader",(function(){return io}));var q={};r.r(q),r.d(q,"n",(function(){return so})),r.d(q,"title",(function(){return co})),r.d(q,"Shader",(function(){return lo}));var $={};r.r($),r.d($,"n",(function(){return uo})),r.d($,"title",(function(){return po})),r.d($,"Shader",(function(){return vo}));var G={};r.r(G),r.d(G,"n",(function(){return mo})),r.d(G,"title",(function(){return go})),r.d(G,"Shader",(function(){return bo}));var H={};r.r(H),r.d(H,"n",(function(){return xo})),r.d(H,"title",(function(){return wo})),r.d(H,"Shader",(function(){return _o}));var V={};r.r(V),r.d(V,"n",(function(){return Oo})),r.d(V,"title",(function(){return Ro})),r.d(V,"Shader",(function(){return To}));var W={};r.r(W),r.d(W,"n",(function(){return Po})),r.d(W,"title",(function(){return Co})),r.d(W,"Shader",(function(){return Io}));var X={};r.r(X),r.d(X,"n",(function(){return Ao})),r.d(X,"title",(function(){return ko})),r.d(X,"Shader",(function(){return Do}));var K={};r.r(K),r.d(K,"n",(function(){return No})),r.d(K,"title",(function(){return Mo})),r.d(K,"Shader",(function(){return Uo}));var Y={};r.r(Y),r.d(Y,"n",(function(){return Fo})),r.d(Y,"title",(function(){return qo})),r.d(Y,"Shader",(function(){return $o}));var Q={};r.r(Q),r.d(Q,"n",(function(){return Ho})),r.d(Q,"title",(function(){return Vo})),r.d(Q,"exportSize",(function(){return Wo})),r.d(Q,"exportStart",(function(){return Xo})),r.d(Q,"exportEnd",(function(){return Ko})),r.d(Q,"exportFramePerSecond",(function(){return Yo})),r.d(Q,"exportSpeed",(function(){return Qo})),r.d(Q,"Shader",(function(){return Zo}));var Z={};r.r(Z),r.d(Z,"n",(function(){return ti})),r.d(Z,"title",(function(){return ri})),r.d(Z,"Shader",(function(){return ni}));var J={};r.r(J),r.d(J,"n",(function(){return ii})),r.d(J,"title",(function(){return ai})),r.d(J,"exportSize",(function(){return si})),r.d(J,"exportStart",(function(){return ci})),r.d(J,"exportEnd",(function(){return li})),r.d(J,"exportFramePerSecond",(function(){return fi})),r.d(J,"exportSpeed",(function(){return ui})),r.d(J,"Shader",(function(){return pi}));var ee={};r.r(ee),r.d(ee,"n",(function(){return vi})),r.d(ee,"title",(function(){return hi})),r.d(ee,"Shader",(function(){return mi}));var te={};r.r(te),r.d(te,"n",(function(){return bi})),r.d(te,"title",(function(){return yi})),r.d(te,"Shader",(function(){return xi}));var re={};r.r(re),r.d(re,"n",(function(){return _i})),r.d(re,"title",(function(){return Ei})),r.d(re,"Shader",(function(){return Si}));var ne={};r.r(ne),r.d(ne,"n",(function(){return Ri})),r.d(ne,"title",(function(){return Ti})),r.d(ne,"exportSize",(function(){return zi})),r.d(ne,"exportStart",(function(){return Pi})),r.d(ne,"exportEnd",(function(){return Ci})),r.d(ne,"exportFramePerSecond",(function(){return Ii})),r.d(ne,"exportSpeed",(function(){return ji})),r.d(ne,"Shader",(function(){return Ai}));var oe={};r.r(oe),r.d(oe,"n",(function(){return Di})),r.d(oe,"title",(function(){return Li})),r.d(oe,"Shader",(function(){return Ni}));var ie={};r.r(ie),r.d(ie,"n",(function(){return Ui})),r.d(ie,"title",(function(){return Bi})),r.d(ie,"exportSize",(function(){return Fi})),r.d(ie,"exportStart",(function(){return qi})),r.d(ie,"exportEnd",(function(){return $i})),r.d(ie,"exportFramePerSecond",(function(){return Gi})),r.d(ie,"exportSpeed",(function(){return Hi})),r.d(ie,"Shader",(function(){return Vi}));var ae={};r.r(ae),r.d(ae,"exportSize",(function(){return Yi})),r.d(ae,"exportStart",(function(){return Qi})),r.d(ae,"exportEnd",(function(){return Zi})),r.d(ae,"exportFramePerSecond",(function(){return Ji})),r.d(ae,"exportSpeed",(function(){return ea})),r.d(ae,"exportMP4vb",(function(){return ta})),r.d(ae,"n",(function(){return ra})),r.d(ae,"title",(function(){return na})),r.d(ae,"nfts",(function(){return oa})),r.d(ae,"Shader",(function(){return aa}));var se={};r.r(se),r.d(se,"n",(function(){return la})),r.d(se,"title",(function(){return fa})),r.d(se,"description",(function(){return ua})),r.d(se,"Shader",(function(){return pa}));var ce={};r.r(ce),r.d(ce,"n",(function(){return ha})),r.d(ce,"title",(function(){return ma})),r.d(ce,"Shader",(function(){return ga}));var le={};r.r(le),r.d(le,"n",(function(){return ya})),r.d(le,"title",(function(){return xa})),r.d(le,"exportEnd",(function(){return wa})),r.d(le,"exportFramePerSecond",(function(){return _a})),r.d(le,"preload",(function(){return Ea})),r.d(le,"Shader",(function(){return Sa}));var fe={};r.r(fe),r.d(fe,"n",(function(){return Ra})),r.d(fe,"title",(function(){return Ta})),r.d(fe,"exportEnd",(function(){return za})),r.d(fe,"exportFramePerSecond",(function(){return Pa})),r.d(fe,"exportSpeed",(function(){return Ca})),r.d(fe,"Logic",(function(){return Ia})),r.d(fe,"Shader",(function(){return La}));var ue={};r.r(ue),r.d(ue,"n",(function(){return Ua})),r.d(ue,"title",(function(){return Ba})),r.d(ue,"exportSize",(function(){return Fa})),r.d(ue,"exportStart",(function(){return qa})),r.d(ue,"exportEnd",(function(){return $a})),r.d(ue,"exportFramePerSecond",(function(){return Ga})),r.d(ue,"exportSpeed",(function(){return Ha})),r.d(ue,"exportMP4vb",(function(){return Va})),r.d(ue,"Logic",(function(){return Xa})),r.d(ue,"Shader",(function(){return Za}));var pe={};r.r(pe),r.d(pe,"n",(function(){return es})),r.d(pe,"title",(function(){return ts})),r.d(pe,"exportEnd",(function(){return rs})),r.d(pe,"nfts",(function(){return ns})),r.d(pe,"Shader",(function(){return os}));var de={};r.r(de),r.d(de,"n",(function(){return as})),r.d(de,"title",(function(){return ss})),r.d(de,"exportSize",(function(){return cs})),r.d(de,"exportStart",(function(){return ls})),r.d(de,"exportEnd",(function(){return fs})),r.d(de,"exportFramePerSecond",(function(){return us})),r.d(de,"exportSpeed",(function(){return ps})),r.d(de,"exportSkipFrame",(function(){return ds})),r.d(de,"exportPaletteGenOnce",(function(){return vs})),r.d(de,"exportPaletteSize",(function(){return hs})),r.d(de,"nfts",(function(){return ms})),r.d(de,"Shader",(function(){return gs}));var ve={};r.r(ve),r.d(ve,"n",(function(){return xs})),r.d(ve,"title",(function(){return ws})),r.d(ve,"exportSize",(function(){return _s})),r.d(ve,"exportStart",(function(){return Es})),r.d(ve,"exportEnd",(function(){return Ss})),r.d(ve,"exportFramePerSecond",(function(){return Os})),r.d(ve,"exportSpeed",(function(){return Rs})),r.d(ve,"exportSkipFrame",(function(){return Ts})),r.d(ve,"exportPaletteGenOnce",(function(){return zs})),r.d(ve,"exportPaletteSize",(function(){return Ps})),r.d(ve,"Shader",(function(){return Cs}));var he={};r.r(he),r.d(he,"n",(function(){return As})),r.d(he,"title",(function(){return ks})),r.d(he,"exportSize",(function(){return Ds})),r.d(he,"exportStart",(function(){return Ls})),r.d(he,"exportEnd",(function(){return Ns})),r.d(he,"exportFramePerSecond",(function(){return Ms})),r.d(he,"exportSpeed",(function(){return Us})),r.d(he,"exportSkipFrame",(function(){return Bs})),r.d(he,"exportPaletteGenOnce",(function(){return Fs})),r.d(he,"exportPaletteSize",(function(){return qs})),r.d(he,"Shader",(function(){return $s}));var me={};r.r(me),r.d(me,"n",(function(){return Vs})),r.d(me,"title",(function(){return Ws})),r.d(me,"exportSize",(function(){return Xs})),r.d(me,"exportStart",(function(){return Ks})),r.d(me,"exportEnd",(function(){return Ys})),r.d(me,"exportFramePerSecond",(function(){return Qs})),r.d(me,"exportSpeed",(function(){return Zs})),r.d(me,"exportSkipFrame",(function(){return Js})),r.d(me,"exportPaletteGenOnce",(function(){return ec})),r.d(me,"exportPaletteSize",(function(){return tc})),r.d(me,"Shader",(function(){return rc}));var ge={};r.r(ge),r.d(ge,"n",(function(){return ic})),r.d(ge,"title",(function(){return ac})),r.d(ge,"exportSize",(function(){return sc})),r.d(ge,"exportStart",(function(){return cc})),r.d(ge,"exportEnd",(function(){return lc})),r.d(ge,"exportFramePerSecond",(function(){return fc})),r.d(ge,"exportSpeed",(function(){return uc})),r.d(ge,"exportPaletteGenOnce",(function(){return pc})),r.d(ge,"exportPaletteSize",(function(){return dc})),r.d(ge,"Shader",(function(){return vc}));var be={};r.r(be),r.d(be,"n",(function(){return mc})),r.d(be,"title",(function(){return gc})),r.d(be,"exportSize",(function(){return bc})),r.d(be,"exportStart",(function(){return yc})),r.d(be,"exportEnd",(function(){return xc})),r.d(be,"exportFramePerSecond",(function(){return wc})),r.d(be,"exportSpeed",(function(){return _c})),r.d(be,"exportPaletteGenOnce",(function(){return Ec})),r.d(be,"exportPaletteSize",(function(){return Sc})),r.d(be,"Shader",(function(){return Oc}));var ye={};r.r(ye),r.d(ye,"n",(function(){return Tc})),r.d(ye,"title",(function(){return zc})),r.d(ye,"exportSize",(function(){return Pc})),r.d(ye,"exportStart",(function(){return Cc})),r.d(ye,"exportEnd",(function(){return Ic})),r.d(ye,"exportFramePerSecond",(function(){return jc})),r.d(ye,"exportSpeed",(function(){return Ac})),r.d(ye,"exportPaletteGenOnce",(function(){return kc})),r.d(ye,"exportPaletteSize",(function(){return Dc})),r.d(ye,"Shader",(function(){return Lc}));var xe={};r.r(xe),r.d(xe,"n",(function(){return Mc})),r.d(xe,"title",(function(){return Uc})),r.d(xe,"exportSize",(function(){return Bc})),r.d(xe,"exportStart",(function(){return Fc})),r.d(xe,"exportEnd",(function(){return qc})),r.d(xe,"exportFramePerSecond",(function(){return $c})),r.d(xe,"exportSpeed",(function(){return Gc})),r.d(xe,"exportPaletteGenOnce",(function(){return Hc})),r.d(xe,"exportPaletteSize",(function(){return Vc})),r.d(xe,"nfts",(function(){return Wc})),r.d(xe,"Shader",(function(){return Xc}));var we={};r.r(we),r.d(we,"n",(function(){return Yc})),r.d(we,"title",(function(){return Qc})),r.d(we,"exportSize",(function(){return Zc})),r.d(we,"exportStart",(function(){return Jc})),r.d(we,"exportEnd",(function(){return el})),r.d(we,"exportFramePerSecond",(function(){return tl})),r.d(we,"exportSpeed",(function(){return rl})),r.d(we,"exportPaletteGenOnce",(function(){return nl})),r.d(we,"exportPaletteSize",(function(){return ol})),r.d(we,"Shader",(function(){return al}));var _e=r("nKUr"),Ee=r("rr/c");const Se=1,Oe="Hello 2020",Re=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:Te.day001,uniforms:{time:e}}),Te=Ee.Shaders.create({day001:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
float vingt (vec2 p) {
...
}`}}),ze=2,Pe="stripes",Ce=400,Ie=0,je=60,Ae=24,ke=1,De=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:Le.node,uniforms:{time:e}}),Le=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),Ne=3,Me="zephyr",Ue=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:Be.node,uniforms:{time:e}}),Be=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}});var Fe=r("q1tI"),qe=r.n(Fe);const $e=Ee.Shaders.create({InitGameOfLife:{frag:Ee.GLSL`
  precision highp float;
  uniform float seed;
  // i
  varying vec2 uv;
  ...
  }`}}),Ge=qe.a.memo((({tick:e,size:t,refreshEveryTicks:r})=>e%(r||1/0)===0?Object(_e.jsx)(Ee.Node,{shader:$e.InitGameOfLife,uniforms:{seed:Math.random()},width:t,height:t,backbuffering:!0,sync:!0}):Object(_e.jsx)(Ee.Node,{shader:$e.GameOfLife,width:t,height:t,backbuffering:!0,sync:!0,uniforms:{t:Ee.Uniform.Backbuffer,size:t}}))),He=4,Ve="Ray of Life";let We;const Xe=({time:e})=>{We||(We=e);const t=e-We,r=Math.floor(10*t),n=r+25,o=10*(1+Math.floor(r/50)),i=10*(1+Math.floor(n/50));return Object(_e.jsx)(Ke,{time:e,a:Object(_e.jsx)(Ee.NearestCopy,{children:Object(_e.jsx)(Ge,{refreshEveryTicks:50,tick:r,size:o})}),b:Object(_e.jsx)(Ee.NearestCopy,{children:Object(_e.jsx)(Ge,{refreshEveryTicks:50,tick:n,size:i})})})},Ke=({a:e,b:t,time:r})=>Object(_e.jsx)(Ee.Node,{uniforms:{a:e,b:t,time:r},shader:Ye.main}),Ye=Ee.Shaders.create({main:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Qe=5,Ze="Here We Go Again",Je=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:et.node,uniforms:{time:e}}),et=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    sqrt(vec3(1. - shad));
  gl_FragColor = vec4(c,1.0);
}`}}),tt=6,rt="Bestagons",nt=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:ot.node,uniforms:{time:e}}),ot=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),it=7,at="Worms party",st=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:ct.node,uniforms:{time:e}}),ct=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    sqrt(vec3(1. - shad));
  gl_FragColor = vec4(c,1.0);
}`}}),lt=8,ft="moontains",ut=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:pt.node,uniforms:{time:e}}),pt=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),dt=9,vt="Virus",ht=400,mt=16.3,gt=26,bt=24,yt=.8,xt=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:wt.node,uniforms:{time:e}}),wt=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),_t=10,Et="ring",St=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:Ot.node,uniforms:{time:e}}),Ot=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Rt=11,Tt="magic mouse",zt=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:Pt.node,uniforms:{time:e}}),Pt=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Ct=12,It="floor is lava",jt=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:At.node,uniforms:{time:e}}),At=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),kt=13,Dt="chip",Lt=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:Nt.node,uniforms:{time:e}}),Nt=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
`}}),Mt=14,Ut="seizure",Bt=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:Ft.node,uniforms:{time:e}}),Ft=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),qt=Ee.Shaders.create({blur1D:{frag:Ee.GLSL`precision highp float;
varying vec2 uv;
uniform sampler2D t;
...
}`}});var $t=({width:e,height:t,pixelRatio:r,direction:n,children:o})=>Object(_e.jsx)(Ee.Node,{shader:qt.blur1D,width:e,height:t,pixelRatio:r,uniforms:{direction:n,resolution:Ee.Uniform.Resolution,t:o}});const Gt=Math.sqrt(2)/2;var Ht=(e,t,r)=>{const n=2*t*Math.ceil(e/2)/r;switch((e-1)%4){case 0:return[n,0];case 1:return[0,n];case 2:return[n*Gt,n*Gt];case 3:return[n*Gt,-n*Gt]}};const Vt=({width:e,height:t,pixelRatio:r,factor:n,children:o,passes:i,directionForPass:a})=>{const s=c=>c<=0?o:Object(_e.jsx)($t,{width:e,height:t,pixelRatio:r,direction:a(c,n,i),children:s(c-1)});return s(i)};Vt.defaultProps={passes:2,directionForPass:Ht};var Wt=Vt;const Xt=Ee.Shaders.create({blur1D:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
...
}`}});var Kt=({width:e,height:t,map:r,pixelRatio:n,direction:o,children:i})=>Object(_e.jsx)(Ee.Node,{shader:Xt.blur1D,width:e,height:t,pixelRatio:n,uniforms:{direction:o,resolution:Ee.Uniform.Resolution,t:i,map:r}});const Yt=({width:e,height:t,map:r,pixelRatio:n,factor:o,children:i,passes:a,directionForPass:s})=>{const c=l=>l<=0?i:Object(_e.jsx)(Kt,{width:e,height:t,map:r,pixelRatio:n,direction:s(l,o,a),children:c(l-1)});return c(a)};Yt.defaultProps={passes:2,directionForPass:Ht};const Qt=15,Zt="parametric",Jt=({time:e})=>Object(_e.jsx)(Ee.LinearCopy,{children:Object(_e.jsx)(tr,{persistence:.98+.02*Math.cos(e)+-.8*Math.exp(-e),children:Object(_e.jsx)(Wt,{passes:4,factor:.2,children:Object(_e.jsx)(er,{time:e})})})}),er=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:rr.node,uniforms:{time:e}}),tr=({children:e,persistence:t})=>Object(_e.jsx)(Ee.Node,{shader:rr.persistence,backbuffering:!0,uniforms:{t:e,back:Ee.Uniform.Backbuffer,persistence:t}}),rr=Ee.Shaders.create({persistence:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),nr=16,or="reuleaux",ir=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:ar.node,uniforms:{time:e}}),ar=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    color(0.5 * time);
  gl_FragColor = vec4(c, 1.0);
}`}}),sr=17,cr="screws",lr=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:fr.node,uniforms:{time:e}}),fr=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),ur=18,pr="queen",dr=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:vr.node,uniforms:{time:e}}),vr=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
}`}}),hr=19,mr="they were six",gr=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:br.node,uniforms:{time:e}}),br=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),yr=20,xr="trippy tiles",wr=({time:e})=>Object(_e.jsx)(Ee.LinearCopy,{children:Object(_e.jsx)(_r,{persistence:.85,children:Object(_e.jsx)(Ee.Node,{shader:Er.node,uniforms:{time:e}})})}),_r=({children:e,persistence:t})=>Object(_e.jsx)(Ee.Node,{shader:Er.persistence,backbuffering:!0,uniforms:{t:e,back:Ee.Uniform.Backbuffer,persistence:t}}),Er=Ee.Shaders.create({persistence:{frag:Ee.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Sr=21,Or="HODL",Rr=({time:e})=>Object(_e.jsx)(Ee.LinearCopy,{children:Object(_e.jsx)(Tr,{persistence:Math.min(.99,.015*e),time:e,children:Object(_e.jsx)(Ee.Node,{shader:zr.node,uniforms:{time:e}})})}),Tr=({children:e,persistence:t,time:r})=>Object(_e.jsx)(Ee.Node,{shader:zr.shakePersistence,backbuffering:!0,uniforms:{t:e,back:Ee.Uniform.Backbuffer,persistence:t,time:r}}),zr=Ee.Shaders.create({shakePersistence:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform sampler2D t, back;
uniform float time;
...
}`}}),Pr=22,Cr="atoms",Ir=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:jr.node,uniforms:{time:e,t:"/images/einstein-tongue-out.jpg"}}),jr=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D t;
...
void main() {
...
}`}}),Ar=23,kr="Hexacubes",Dr=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:Lr.node,uniforms:{time:e}}),Lr=Ee.Shaders.create({node:{frag:Ee.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform float time;
  const float PI = ${Math.PI};
  ...
  void main() {
    ...
    gl_FragColor = vec4(c, 1.0);
      ...
      `}}),Nr=24,Mr="dark cubes",Ur=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:Br.node,uniforms:{time:e}}),Br=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),Fr=25,qr="Mandelbrot",$r=({time:e})=>Object(_e.jsx)(Ee.LinearCopy,{children:Object(_e.jsx)(Gr,{persistence:.9,children:Object(_e.jsx)(Wt,{passes:4,factor:.1,children:Object(_e.jsx)(Ee.Node,{shader:Hr.node,uniforms:{time:e}})})})}),Gr=({children:e,persistence:t})=>Object(_e.jsx)(Ee.Node,{shader:Hr.persistence,backbuffering:!0,uniforms:{t:e,back:Ee.Uniform.Backbuffer,persistence:t}}),Hr=Ee.Shaders.create({persistence:{frag:Ee.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Vr=26,Wr="fumes",Xr=({time:e})=>Object(_e.jsx)(Ee.LinearCopy,{children:Object(_e.jsx)(Kr,{persistence:.9,children:Object(_e.jsx)(Wt,{passes:4,factor:Math.min(.6,.01*e),children:Object(_e.jsx)(Ee.Node,{shader:Yr.node,uniforms:{time:e}})})})}),Kr=({children:e,persistence:t})=>Object(_e.jsx)(Ee.Node,{shader:Yr.persistence,backbuffering:!0,uniforms:{t:e,back:Ee.Uniform.Backbuffer,persistence:t}}),Yr=Ee.Shaders.create({persistence:{frag:Ee.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Qr=27,Zr="real burning ship",Jr=400,en=0,tn=60,rn=12,nn=2,on=({time:e})=>Object(_e.jsx)(Ee.LinearCopy,{children:Object(_e.jsx)(an,{persistence:.8+.05*Math.random(),time:e,children:Object(_e.jsx)(Ee.Node,{shader:sn.node,uniforms:{time:e}})})}),an=({children:e,persistence:t,time:r})=>Object(_e.jsx)(Ee.Node,{shader:sn.persistence,backbuffering:!0,uniforms:{t:e,back:Ee.Uniform.Backbuffer,persistence:t,time:r}}),sn=Ee.Shaders.create({persistence:{frag:Ee.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),cn=28,ln="No, I'M Batman",fn=({time:e})=>Object(_e.jsx)(Ee.LinearCopy,{children:Object(_e.jsx)(un,{persistence:.5+.48*Math.min(1,e/60),children:Object(_e.jsx)(Ee.Node,{shader:pn.node,uniforms:{time:e}})})}),un=({children:e,persistence:t})=>Object(_e.jsx)(Ee.Node,{shader:pn.persistence,backbuffering:!0,uniforms:{t:e,back:Ee.Uniform.Backbuffer,persistence:t}}),pn=Ee.Shaders.create({persistence:{frag:Ee.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),dn=29,vn="sdBitcoin(p)",hn=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:mn.node,uniforms:{time:e}}),mn=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),gn=30,bn="21 millions",yn=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:xn.node,uniforms:{time:e,numberInCirculation:18557031}}),xn=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),wn=31,_n="alien tower",En=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:Sn.node,uniforms:{time:e,numberInCirculation:18557031}}),Sn=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform float numberInCirculation;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),On=32,Rn="GoL valley";let Tn;const zn=({time:e})=>{Tn||(Tn=e);const t=e-Tn,r=Math.floor(12*t);return Object(_e.jsx)(Ee.Node,{shader:Pn.node,uniforms:{time:e,t:Object(_e.jsx)(Ge,{refreshEveryTicks:100,tick:r,size:100})}})},Pn=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D t;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Cn=33,In="x(x+32y)%(tN+1)%n";const jn=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:An.node,uniforms:{time:e}}),An=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),kn=34,Dn="\u230a2cos(x)sin(y+t)\u230b%7";const Ln=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:Nn.node,uniforms:{time:e}}),Nn=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
#define PI ${Math.PI}
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Mn=35,Un="aie confiance",Bn=({time:e})=>Object(_e.jsx)(Ee.LinearCopy,{children:Object(_e.jsx)(Fn,{persistence:.6,children:Object(_e.jsx)(Ee.Node,{shader:qn.node,uniforms:{time:e}})})}),Fn=({children:e,persistence:t})=>Object(_e.jsx)(Ee.Node,{shader:qn.persistence,backbuffering:!0,uniforms:{t:e,back:Ee.Uniform.Backbuffer,persistence:t}}),qn=Ee.Shaders.create({persistence:{frag:Ee.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),$n=36,Gn="crois en moi",Hn=({time:e})=>Object(_e.jsx)(Ee.LinearCopy,{children:Object(_e.jsx)(Vn,{children:Object(_e.jsx)(Ee.Node,{shader:Wn.node,uniforms:{time:e}})})}),Vn=({children:e,persistence:t})=>Object(_e.jsx)(Ee.Node,{shader:Wn.persistence,backbuffering:!0,uniforms:{t:e,back:Ee.Uniform.Backbuffer,persistence:t}}),Wn=Ee.Shaders.create({persistence:{frag:Ee.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Xn=37,Kn="sdBrick",Yn=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:Qn.node,uniforms:{time:e}}),Qn=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Zn=38,Jn="Golden mandelbulb",eo=({time:e})=>Object(_e.jsx)(Ee.LinearCopy,{children:Object(_e.jsx)(to,{persistence:.5,children:Object(_e.jsx)(Ee.Node,{shader:ro.node,uniforms:{time:e}})})}),to=({children:e,persistence:t})=>Object(_e.jsx)(Ee.Node,{shader:ro.persistence,backbuffering:!0,uniforms:{t:e,back:Ee.Uniform.Backbuffer,persistence:t}}),ro=Ee.Shaders.create({persistence:{frag:Ee.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  clr /= 4.;
  gl_FragColor = vec4(clr, 1.0);
}`}}),no=39,oo="metaballs",io=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:ao.node,uniforms:{time:e}}),ao=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  clr /= 4.;
  gl_FragColor = vec4(clr, 1.0);
}`}}),so=40,co="pen-o-plasma",lo=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:fo.node,uniforms:{time:e}}),fo=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(clr, 1.0);
}`}}),uo=41,po="reflection",vo=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:ho.node,uniforms:{time:e}}),ho=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),mo=42,go="reflection party",bo=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:yo.node,uniforms:{time:e}}),yo=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c = mix(c, reflection(p, n, 10.), glossy);
  gl_FragColor = vec4(c, 1.0);
}`}}),xo=43,wo="irreconcilable queens",_o=({time:e})=>Object(_e.jsx)(Ee.LinearCopy,{children:Object(_e.jsx)(Eo,{persistence:.4,children:Object(_e.jsx)(Ee.Node,{shader:So.node,uniforms:{time:e}})})}),Eo=({children:e,persistence:t})=>Object(_e.jsx)(Ee.Node,{shader:So.persistence,backbuffering:!0,uniforms:{t:e,back:Ee.Uniform.Backbuffer,persistence:t}}),So=Ee.Shaders.create({persistence:{frag:Ee.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Oo=44,Ro="royal meeting",To=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:zo.node,uniforms:{time:e}}),zo=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
#define PI ${Math.PI}
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),Po=45,Co="wood pawns army",Io=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:jo.node,uniforms:{time:e,wood:"/images/seamless-wood-background-1.jpg"}}),jo=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),Ao=46,ko="Bank of Bicoin",Do=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:Lo.node,uniforms:{time:e}}),Lo=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),No=47,Mo="glow experiment",Uo=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:Bo.node,uniforms:{time:e}}),Bo=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Fo=48,qo="Starry Night",$o=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:Go.node,uniforms:{time:e,img:"/images/seamless-wood2.jpg"}}),Go=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(clr, 1.0);
}`}}),Ho=49,Vo="chinese lantern",Wo=400,Xo=0,Ko=20,Yo=24,Qo=1.1,Zo=({time:e})=>Object(_e.jsx)(Ee.LinearCopy,{children:Object(_e.jsx)(Jo,{persistence:.8,children:Object(_e.jsx)(Ee.Node,{shader:ei.node,uniforms:{time:e}})})}),Jo=({children:e,persistence:t})=>Object(_e.jsx)(Ee.Node,{shader:ei.persistence,backbuffering:!0,uniforms:{t:e,back:Ee.Uniform.Backbuffer,persistence:t}}),ei=Ee.Shaders.create({persistence:{frag:Ee.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  clr += c;
  gl_FragColor = vec4(clr, 1.0);
}`}}),ti=50,ri="jumpy rooks",ni=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:oi.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),oi=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),ii=51,ai="symmetry chess",si=400,ci=0,li=20,fi=24,ui=1,pi=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:di.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),di=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),vi=52,hi="knights dance",mi=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:gi.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),gi=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),bi=53,yi="cross waves",xi=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:wi.node,uniforms:{time:e}}),wi=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  */
}`}}),_i=54,Ei="chess set",Si=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:Oi.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),Oi=Ee.Shaders.create({node:{frag:Ee.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  color = vec4(c, 1.0);
}`}}),Ri=55,Ti="cube d'or",zi=400,Pi=0,Ci=20,Ii=24,ji=1,Ai=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:ki.node,uniforms:{time:e}}),ki=Ee.Shaders.create({node:{frag:Ee.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  #endif
  color = vec4(c, 1.0);
}`}}),Di=56,Li="jade forest",Ni=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:Mi.node,uniforms:{time:e}}),Mi=Ee.Shaders.create({node:{frag:Ee.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  color = vec4(c, 1.0);
}`}}),Ui=57,Bi="Virus v2",Fi=400,qi=0,$i=20,Gi=24,Hi=.8,Vi=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:Wi.node,uniforms:{time:e}}),Wi=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}});var Xi=r("005v"),Ki=r.n(Xi);const Yi=400,Qi=0,Zi=30,Ji=20,ea=1,ta="5M",ra=58,na="Mandelglitch",oa=[{url:"https://ethblock.art/create/17",text:"Mint on ethblock.art"},{url:"https://ghostmarket.io/asset/pha/ghost/3008841254969814369262311336331954453497120774334547905246474374493804042898/",text:"ghostmarket.io: 400 KCAL"},{url:"https://www.hicetnunc.xyz/objkt/3063",text:"hicetnunc.xyz: Mandelglitch #1 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3068",text:"hicetnunc.xyz: Mandelglitch #2 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3071",text:"hicetnunc.xyz: Mandelglitch #3 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3072",text:"hicetnunc.xyz: Mandelglitch #4 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3073",text:"hicetnunc.xyz: Mandelglitch #5 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3077",text:"hicetnunc.xyz: Mandelglitch #6 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3088",text:"hicetnunc.xyz: Mandelglitch #7 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3574",text:"hicetnunc.xyz: Mandelglitch #8 (5 XTZ)"}];const ia=e=>e<.5?2*e*e:(4-2*e)*e-1;const aa=({time:e,n:t,exporting:r})=>{const n=Object(Fe.useMemo)((()=>function(e,t=0){const r=e?3:50,n=new Ki.a(t);return Array(r).fill(null).map((()=>Array(12).fill(null).map((()=>n.random()))))}(r,t)),[t,r]),o=e/10%n.length,i=Math.floor(o),a=o-i;let[s,c,l,f,u,p,d,v,h,m,g,b]=(y=n[i%n.length],x=n[(i+1)%n.length],w=ia(a),y.map(((e,t)=>e*(1-w)+x[t]*w)));var y,x,w;return l=ia(l),Object(_e.jsx)(Ee.LinearCopy,{children:Object(_e.jsx)(ca,{persistence:r?0:.8,children:Object(_e.jsx)(Ee.Node,{shader:sa.main,uniforms:{aa:r?2:0,time:e,resolution:Ee.Uniform.Resolution,travel:s,love:c,dark:l,rot:r?2*Math.PI/Zi:.1,s1:f,s2:u,s3:p,s4:d,s5:v,s6:h,s7:m,s8:g,s9:b}})})})},sa=Ee.Shaders.create({persistence:{frag:Ee.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  `}}),ca=({children:e,persistence:t})=>Object(_e.jsx)(Ee.Node,{shader:sa.persistence,backbuffering:!0,uniforms:{t:e,back:Ee.Uniform.Backbuffer,persistence:t}}),la=59,fa="Pixels 256",ua="There will be only 256 patterns generated by this single fragment shader.",pa=({time:e,n:t,exporting:r})=>Object(_e.jsx)(da,{n:t+1+(r?0:Math.floor(e))}),da=qe.a.memo((({n:e})=>{const t=new Ki.a(e%256),r=t.random(),n=t.random(),o=t.random(),i=t.random(),a=t.random(),s=t.random();return Object(_e.jsx)(Ee.Node,{shader:va.node,uniforms:{s1:r,s2:n,s3:o,s4:i,s5:a,s6:s}})})),va=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),ha=60,ma="Bitcoin rainbow",ga=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:ba.node,uniforms:{time:e}}),ba=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),ya=61,xa="Binance gradients",wa=1,_a=30,Ea=["/images/shaders/binance.dist.png"],Sa=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:Oa.node,uniforms:{time:e,image:"/images/shaders/binance.dist.png"}}),Oa=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Ra=62,Ta="Overgrowth",za=20,Pa=40,Ca=1,Ia=({generation:e,size:t,n:r})=>Object(_e.jsx)(Ee.Node,{width:t,height:t,shader:Na.logic,uniforms:{generation:e,prev:Ee.Uniform.Backbuffer,size:t,seed:r/100},backbuffering:!0}),ja=qe.a.memo(Ia),Aa=({time:e,generation:t,n:r})=>Object(_e.jsx)(Ee.Node,{shader:Na.render,uniforms:{time:e,logic:Object(_e.jsx)(ja,{generation:t,size:140,n:r})},uniformsOptions:{logic:{interpolation:"nearest"}}}),ka=qe.a.memo(Aa),Da=1e3*Math.random(),La=({time:e,n:t})=>Object(_e.jsx)(ka,{n:t+Da,time:e,generation:Math.floor(30*e)},t),Na=Ee.Shaders.create({logic:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
...
`}});var Ma=r("AJhG");const Ua=63,Ba="Relics",Fa=400,qa=2,$a=4,Ga=20,Ha=1,Va="5M",Wa={colors:[.7,.55,.4],logicSize:80,amp:1,base:2,persistance:.89,delta:.5,seed:0};console.log(Object.keys(Wa).map((e=>String(Wa[e]))).join("_"));const Xa=({g:e,size:t,seed:r,amp:n,base:o,persistance:i,delta:a})=>Object(_e.jsx)(Ee.Node,{width:t,height:t,shader:Ja.logic,uniforms:{amp:n,base:o,g:e,prev:Ee.Uniform.Backbuffer,size:t,seed:r,persistance:i,delta:a},backbuffering:!0},t),Ka=qe.a.memo(Xa),Ya=({g:e,colors:t,amp:r,base:n,persistance:o,delta:i,logicSize:a,seed:s})=>Object(_e.jsx)(Ee.Node,{shader:Ja.render,uniforms:{colors:t,logic:Object(_e.jsx)(Ka,{amp:r,base:n,g:e,size:a,seed:s,persistance:o,delta:i})},uniformsOptions:{logic:{interpolation:"nearest"}}}),Qa=qe.a.memo(Ya),Za=({time:e})=>{const{colors:t,logicSize:r,amp:n,base:o,persistance:i,delta:a,seed:s}=Object(Ma.b)(Wa);return Object(_e.jsx)(Qa,{amp:n,base:o,g:Math.floor(20*e)%40,colors:t,persistance:i,delta:a,seed:s,logicSize:r})},Ja=Ee.Shaders.create({logic:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform sampler2D prev;
uniform float g;
...
`}}),es=64,ts="Intersection",rs=8*Math.PI,ns=[{url:"https://www.hicetnunc.xyz/objkt/28592",text:"hic et nunc NFT"}],os=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:is.render,uniforms:{resolution:Ee.Uniform.Resolution,time:e}}),is=Ee.Shaders.create({render:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform vec2 resolution;
...
`}}),as=65,ss="Duality",cs=800,ls=4,fs=8,us=30,ps=1,ds=3,vs=!0,hs=16,ms=[{url:"https://hicetnunc.xyz/objkt/64326",text:"hic et nunc NFT"}],gs=({time:e})=>Object(_e.jsx)(Ee.NearestCopy,{children:Object(_e.jsx)(bs,{persistence:.3,children:Object(_e.jsx)(Ee.Node,{shader:ys.render,uniforms:{resolution:Ee.Uniform.Resolution,time:e}})})}),bs=({children:e,persistence:t})=>Object(_e.jsx)(Ee.Node,{shader:ys.persistence,backbuffering:!0,uniforms:{t:e,back:Ee.Uniform.Backbuffer,persistence:t}}),ys=Ee.Shaders.create({persistence:{frag:Ee.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),xs=66,ws="hicetnunc",_s=800,Es=2,Ss=Es+8,Os=30,Rs=1,Ts=7,zs=!0,Ps=16,Cs=({time:e})=>Object(_e.jsx)(Ee.NearestCopy,{children:Object(_e.jsx)(Is,{persistence:.5,children:Object(_e.jsx)(Ee.Node,{shader:js.render,uniforms:{resolution:Ee.Uniform.Resolution,time:e,freq:2}})})}),Is=({children:e,persistence:t})=>Object(_e.jsx)(Ee.Node,{shader:js.persistence,backbuffering:!0,uniforms:{t:e,back:Ee.Uniform.Backbuffer,persistence:t}}),js=Ee.Shaders.create({persistence:{frag:Ee.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),As=67,ks="Jumping blob",Ds=800,Ls=2,Ns=Ls+8,Ms=30,Us=1,Bs=7,Fs=!0,qs=16,$s=({time:e})=>Object(_e.jsx)(Ee.NearestCopy,{children:Object(_e.jsx)(Gs,{persistence:.6,children:Object(_e.jsx)(Ee.Node,{shader:Hs.render,uniforms:{resolution:Ee.Uniform.Resolution,time:e,freq:2}})})}),Gs=({children:e,persistence:t})=>Object(_e.jsx)(Ee.Node,{shader:Hs.persistence,backbuffering:!0,uniforms:{t:e,back:Ee.Uniform.Backbuffer,persistence:t}}),Hs=Ee.Shaders.create({persistence:{frag:Ee.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Vs=68,Ws="ring",Xs=800,Ks=2,Ys=Ks+10,Qs=30,Zs=1,Js=7,ec=!0,tc=128,rc=({time:e})=>Object(_e.jsx)(Ee.NearestCopy,{children:Object(_e.jsx)(nc,{persistence:.9,children:Object(_e.jsx)(Ee.Node,{shader:oc.render,uniforms:{resolution:Ee.Uniform.Resolution,time:e,freq:2}})})}),nc=({children:e,persistence:t})=>Object(_e.jsx)(Ee.Node,{shader:oc.persistence,backbuffering:!0,uniforms:{t:e,back:Ee.Uniform.Backbuffer,persistence:t}}),oc=Ee.Shaders.create({persistence:{frag:Ee.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),ic=69,ac="Bananas paradize",sc=400,cc=0,lc=20,fc=20,uc=1,pc=!0,dc=128,vc=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:hc.node,uniforms:{time:e,resolution:Ee.Uniform.Resolution}}),hc=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),mc=70,gc="warp1",bc=400,yc=0,xc=20,wc=20,_c=1,Ec=!1,Sc=256,Oc=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:Rc.node,uniforms:{time:e,resolution:Ee.Uniform.Resolution}}),Rc=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),Tc=71,zc="warp2",Pc=640,Cc=0,Ic=20,jc=24,Ac=1,kc=!1,Dc=256,Lc=({time:e})=>Object(_e.jsx)(Ee.Node,{shader:Nc.node,uniforms:{time:e}}),Nc=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),Mc=72,Uc="Planet Hole",Bc=640,Fc=0,qc=20,$c=24,Gc=1,Hc=!1,Vc=256,Wc=[{url:"https://hicetnunc.xyz/objkt/87918",text:"hic et nunc NFT"}],Xc=({time:e,n:t})=>{const r=new Ki.a(t),n=.2+3*r.random()*r.random(),o=.2+10*r.random()*r.random(),i=r.random(),a=[i+.2-.5*r.random(),i+.02-.1*r.random(),i-.02+.1*r.random()];return Object(_e.jsx)(Ee.Node,{shader:Kc.node,uniforms:{resolution:Ee.Uniform.Resolution,time:e,a:n,b:o,c:a}})},Kc=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
...
`}}),Yc=73,Qc="purple square corridor",Zc=640,Jc=0,el=20,tl=24,rl=1,nl=!1,ol=256,il=72e5,al=({time:e})=>{const t=Date.now(),r=t/il-Math.floor(t/il);return Object(_e.jsx)(Ee.Node,{shader:sl.node,uniforms:{resolution:Ee.Uniform.Resolution,time:e+1e3*r,speed:.01,c:[.8,.1,.3]}})},sl=Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
...
`}}),cl=(Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
...
`}}),Ee.Shaders.create({node:{frag:Ee.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;

...
}`}}).copy;t.default=i},MAJC:function(e,t,r){"use strict";e.exports=function(e){return"undefined"!==typeof e&&null!==e&&("object"===typeof e||"function"===typeof e)}},Ni9w:function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;t.default=class{constructor(){var e,t,r;r=[],(t="_loaders")in(e=this)?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r}add(e){this._loaders.push(e),this._loaders.sort(((e,t)=>("number"===typeof t.priority?t.priority:0)-("number"===typeof e.priority?e.priority:0)))}remove(e){const t=this._loaders.indexOf(e);-1!==t&&this._loaders.splice(t,1)}get(){return this._loaders}}},O8XB:function(e,t,r){"use strict";(function(e,n){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var o,i,a,c,s,l=p(r("tbvF")),f=p(r("Ytbt")),u=p(r("zqV6"));function p(e){return e&&e.__esModule?e:{default:e}}"undefined"===typeof e&&(n.Buffer=(i=o=class{},s=t=>t instanceof e,(c="isBuffer")in(a=o)?Object.defineProperty(a,c,{value:s,enumerable:!0,configurable:!0,writable:!0}):a[c]=s,i));t.default=(e,t,r,n)=>{const o="undefined"!==typeof WebGLRenderingContext&&e instanceof WebGLRenderingContext;let i=r.dtype,a=r.shape.slice(),c=e.getParameter(e.MAX_TEXTURE_SIZE);if(a[0]<0||a[0]>c||a[1]<0||a[1]>c)throw new Error("gl-react: Invalid texture size");let s=function(e,t){return 3===e.length?1===t[2]&&t[1]===e[0]*e[2]&&t[0]===e[2]:1===t[0]&&t[1]===e[0]}(a,r.stride.slice()),p=0;"float32"===i?p=e.FLOAT:"float64"===i?(p=e.FLOAT,s=!1,i="float32"):"uint8"===i?p=e.UNSIGNED_BYTE:(p=e.UNSIGNED_BYTE,s=!1,i="uint8");let d,v=0,h=0;if(2===a.length)h=v=e.LUMINANCE,a=[a[0],a[1],1],r=(0,l.default)(r.data,a,[r.stride[0],r.stride[1],1],r.offset);else{if(3!==a.length)throw new Error("gl-texture2d: Invalid shape for texture");if(1===a[2])h=v=e.ALPHA,o||(n=!1);else if(2===a[2])h=v=e.LUMINANCE_ALPHA,o||(n=!1);else if(3===a[2])v=e.RGB,h=o?e.RGB:e.RGB32F;else{if(4!==a[2])throw new Error("gl-texture2d: Invalid shape for pixel coords");v=e.RGBA,h=o?e.RGBA:e.RGBA32F}}p!==e.FLOAT||n||(p=e.UNSIGNED_BYTE,s=!1);let m,g=r.size;if(s)d=0===r.offset&&r.data.length===g?r.data:r.data.subarray(r.offset,r.offset+g);else{let t=[a[2],a[2]*a[0],1];if("float32"!==i&&"float64"!==i||p!==e.UNSIGNED_BYTE){m=u.default.malloc(g,i);let e=(0,l.default)(m,a,t,0);f.default.assign(e,r)}else{m=u.default.malloc(g,"uint8"),function(e,t){f.default.muls(e,t,255)}((0,l.default)(m,a,t,0),r)}d=m.subarray(0,g)}e.texImage2D(e.TEXTURE_2D,0,h,a[0],a[1],0,v,p,d),m&&u.default.free(m)}}).call(this,r("HDXh").Buffer,r("ntbh"))},OTww:function(e,t,r){"use strict";(function(e){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var n,o=(n=r("Ni9w"))&&n.__esModule?n:{default:n};const i="undefined"===typeof window?e:window,a="__webglTextureLoader_registry";var c=i[a]||(i[a]=new o.default);t.default=c}).call(this,r("ntbh"))},QLaP:function(e,t,r){"use strict";e.exports=function(e,t,r,n,o,i,a,c){if(!e){var s;if(void 0===t)s=new Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else{var l=[r,n,o,i,a,c],f=0;(s=new Error(t.replace(/%s/g,(function(){return l[f++]})))).name="Invariant Violation"}throw s.framesToPop=1,s}}},QM7d:function(e,t,r){"use strict";var n=r("033R");function o(){this.argTypes=[],this.shimArgs=[],this.arrayArgs=[],this.arrayBlockIndices=[],this.scalarArgs=[],this.offsetArgs=[],this.offsetArgIndex=[],this.indexArgs=[],this.shapeArgs=[],this.funcName="",this.pre=null,this.body=null,this.post=null,this.debug=!1}e.exports=function(e){var t=new o;t.pre=e.pre,t.body=e.body,t.post=e.post;var r=e.args.slice(0);t.argTypes=r;for(var i=0;i<r.length;++i){var a=r[i];if("array"===a||"object"===typeof a&&a.blockIndices){if(t.argTypes[i]="array",t.arrayArgs.push(i),t.arrayBlockIndices.push(a.blockIndices?a.blockIndices:0),t.shimArgs.push("array"+i),i<t.pre.args.length&&t.pre.args[i].count>0)throw new Error("cwise: pre() block may not reference array args");if(i<t.post.args.length&&t.post.args[i].count>0)throw new Error("cwise: post() block may not reference array args")}else if("scalar"===a)t.scalarArgs.push(i),t.shimArgs.push("scalar"+i);else if("index"===a){if(t.indexArgs.push(i),i<t.pre.args.length&&t.pre.args[i].count>0)throw new Error("cwise: pre() block may not reference array index");if(i<t.body.args.length&&t.body.args[i].lvalue)throw new Error("cwise: body() block may not write to array index");if(i<t.post.args.length&&t.post.args[i].count>0)throw new Error("cwise: post() block may not reference array index")}else if("shape"===a){if(t.shapeArgs.push(i),i<t.pre.args.length&&t.pre.args[i].lvalue)throw new Error("cwise: pre() block may not write to array shape");if(i<t.body.args.length&&t.body.args[i].lvalue)throw new Error("cwise: body() block may not write to array shape");if(i<t.post.args.length&&t.post.args[i].lvalue)throw new Error("cwise: post() block may not write to array shape")}else{if("object"!==typeof a||!a.offset)throw new Error("cwise: Unknown argument type "+r[i]);t.argTypes[i]="offset",t.offsetArgs.push({array:a.array,offset:a.offset}),t.offsetArgIndex.push(i)}}if(t.arrayArgs.length<=0)throw new Error("cwise: No array arguments specified");if(t.pre.args.length>r.length)throw new Error("cwise: Too many arguments in pre() block");if(t.body.args.length>r.length)throw new Error("cwise: Too many arguments in body() block");if(t.post.args.length>r.length)throw new Error("cwise: Too many arguments in post() block");return t.debug=!!e.printCode||!!e.debug,t.funcName=e.funcName||"cwise",t.blockSize=e.blockSize||64,n(t)}},R9Te:function(e,t,r){"use strict";var n=r("CyWo"),o=r("z08I"),i=r("+0iv"),a=r("vCtr");function c(e){return"__proto__"!==e&&"constructor"!==e&&"prototype"!==e}e.exports=function(e,t,r){if(!a(e))return e;if(Array.isArray(t)&&(t=[].concat.apply([],t).join(".")),"string"!==typeof t)return e;for(var s=n(t,{sep:".",brackets:!0}).filter(c),l=s.length,f=-1,u=e;++f<l;){var p=s[f];f===l-1?i(u[p])&&i(r)?u[p]=o({},u[p],r):u[p]=r:(a(u[p])||(u[p]={}),u=u[p])}return e}},RjOF:function(e,t,r){"use strict";var n,o="";e.exports=function(e,t){if("string"!==typeof e)throw new TypeError("expected a string");if(1===t)return e;if(2===t)return e+e;var r=e.length*t;if(n!==e||"undefined"===typeof n)n=e,o="";else if(o.length>=r)return o.substr(0,r);for(;r>o.length&&t>1;)1&t&&(o+=e),t>>=1,e+=e;return o=(o+=e).substr(0,r)}},Ry8g:function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;t.default=e=>{const t=e.getExtension("WEBGL_lose_context");t&&t.loseContext()}},SMLl:function(e,t,r){"use strict";var n=r("RjOF");e.exports=function(e,t,r){return n(r="undefined"!==typeof r?r+"":" ",t)+e}},TBio:function(e,t,r){"use strict";var n=r("F16p");function o(e,t,r){var n,o,i=e.length,a=t.arrayArgs.length,c=t.indexArgs.length>0,s=[],l=[],f=0,u=0;for(n=0;n<i;++n)l.push(["i",n,"=0"].join(""));for(o=0;o<a;++o)for(n=0;n<i;++n)u=f,f=e[n],0===n?l.push(["d",o,"s",n,"=t",o,"p",f].join("")):l.push(["d",o,"s",n,"=(t",o,"p",f,"-s",u,"*t",o,"p",u,")"].join(""));for(l.length>0&&s.push("var "+l.join(",")),n=i-1;n>=0;--n)f=e[n],s.push(["for(i",n,"=0;i",n,"<s",f,";++i",n,"){"].join(""));for(s.push(r),n=0;n<i;++n){for(u=f,f=e[n],o=0;o<a;++o)s.push(["p",o,"+=d",o,"s",n].join(""));c&&(n>0&&s.push(["index[",u,"]-=s",u].join("")),s.push(["++index[",f,"]"].join(""))),s.push("}")}return s.join("\n")}function i(e,t,r){for(var n=e.body,o=[],i=[],a=0;a<e.args.length;++a){var c=e.args[a];if(!(c.count<=0)){var s=new RegExp(c.name,"g"),l="",f=t.arrayArgs.indexOf(a);switch(t.argTypes[a]){case"offset":var u=t.offsetArgIndex.indexOf(a);f=t.offsetArgs[u].array,l="+q"+u;case"array":l="p"+f+l;var p="l"+a,d="a"+f;if(0===t.arrayBlockIndices[f])1===c.count?"generic"===r[f]?c.lvalue?(o.push(["var ",p,"=",d,".get(",l,")"].join("")),n=n.replace(s,p),i.push([d,".set(",l,",",p,")"].join(""))):n=n.replace(s,[d,".get(",l,")"].join("")):n=n.replace(s,[d,"[",l,"]"].join("")):"generic"===r[f]?(o.push(["var ",p,"=",d,".get(",l,")"].join("")),n=n.replace(s,p),c.lvalue&&i.push([d,".set(",l,",",p,")"].join(""))):(o.push(["var ",p,"=",d,"[",l,"]"].join("")),n=n.replace(s,p),c.lvalue&&i.push([d,"[",l,"]=",p].join("")));else{for(var v=[c.name],h=[l],m=0;m<Math.abs(t.arrayBlockIndices[f]);m++)v.push("\\s*\\[([^\\]]+)\\]"),h.push("$"+(m+1)+"*t"+f+"b"+m);if(s=new RegExp(v.join(""),"g"),l=h.join("+"),"generic"===r[f])throw new Error("cwise: Generic arrays not supported in combination with blocks!");n=n.replace(s,[d,"[",l,"]"].join(""))}break;case"scalar":n=n.replace(s,"Y"+t.scalarArgs.indexOf(a));break;case"index":n=n.replace(s,"index");break;case"shape":n=n.replace(s,"shape")}}}return[o.join("\n"),n,i.join("\n")].join("\n").trim()}function a(e){for(var t=new Array(e.length),r=!0,n=0;n<e.length;++n){var o=e[n],i=o.match(/\d+/);i=i?i[0]:"",0===o.charAt(0)?t[n]="u"+o.charAt(1)+i:t[n]=o.charAt(0)+i,n>0&&(r=r&&t[n]===t[n-1])}return r?t[0]:t.join("")}e.exports=function(e,t){for(var r=t[1].length-Math.abs(e.arrayBlockIndices[0])|0,c=new Array(e.arrayArgs.length),s=new Array(e.arrayArgs.length),l=0;l<e.arrayArgs.length;++l)s[l]=t[2*l],c[l]=t[2*l+1];var f=[],u=[],p=[],d=[],v=[];for(l=0;l<e.arrayArgs.length;++l){e.arrayBlockIndices[l]<0?(p.push(0),d.push(r),f.push(r),u.push(r+e.arrayBlockIndices[l])):(p.push(e.arrayBlockIndices[l]),d.push(e.arrayBlockIndices[l]+r),f.push(0),u.push(e.arrayBlockIndices[l]));for(var h=[],m=0;m<c[l].length;m++)p[l]<=c[l][m]&&c[l][m]<d[l]&&h.push(c[l][m]-p[l]);v.push(h)}var g=["SS"],x=["'use strict'"],b=[];for(m=0;m<r;++m)b.push(["s",m,"=SS[",m,"]"].join(""));for(l=0;l<e.arrayArgs.length;++l){g.push("a"+l),g.push("t"+l),g.push("p"+l);for(m=0;m<r;++m)b.push(["t",l,"p",m,"=t",l,"[",p[l]+m,"]"].join(""));for(m=0;m<Math.abs(e.arrayBlockIndices[l]);++m)b.push(["t",l,"b",m,"=t",l,"[",f[l]+m,"]"].join(""))}for(l=0;l<e.scalarArgs.length;++l)g.push("Y"+l);if(e.shapeArgs.length>0&&b.push("shape=SS.slice(0)"),e.indexArgs.length>0){var y=new Array(r);for(l=0;l<r;++l)y[l]="0";b.push(["index=[",y.join(","),"]"].join(""))}for(l=0;l<e.offsetArgs.length;++l){var w=e.offsetArgs[l],_=[];for(m=0;m<w.offset.length;++m)0!==w.offset[m]&&(1===w.offset[m]?_.push(["t",w.array,"p",m].join("")):_.push([w.offset[m],"*t",w.array,"p",m].join("")));0===_.length?b.push("q"+l+"=0"):b.push(["q",l,"=",_.join("+")].join(""))}var S=n([].concat(e.pre.thisVars).concat(e.body.thisVars).concat(e.post.thisVars));for((b=b.concat(S)).length>0&&x.push("var "+b.join(",")),l=0;l<e.arrayArgs.length;++l)x.push("p"+l+"|=0");e.pre.body.length>3&&x.push(i(e.pre,e,s));var E=i(e.body,e,s),O=function(e){for(var t=0,r=e[0].length;t<r;){for(var n=1;n<e.length;++n)if(e[n][t]!==e[0][t])return t;++t}return t}(v);O<r?x.push(function(e,t,r,n){for(var i=t.length,a=r.arrayArgs.length,c=r.blockSize,s=r.indexArgs.length>0,l=[],f=0;f<a;++f)l.push(["var offset",f,"=p",f].join(""));for(f=e;f<i;++f)l.push(["for(var j"+f+"=SS[",t[f],"]|0;j",f,">0;){"].join("")),l.push(["if(j",f,"<",c,"){"].join("")),l.push(["s",t[f],"=j",f].join("")),l.push(["j",f,"=0"].join("")),l.push(["}else{s",t[f],"=",c].join("")),l.push(["j",f,"-=",c,"}"].join("")),s&&l.push(["index[",t[f],"]=j",f].join(""));for(f=0;f<a;++f){for(var u=["offset"+f],p=e;p<i;++p)u.push(["j",p,"*t",f,"p",t[p]].join(""));l.push(["p",f,"=(",u.join("+"),")"].join(""))}for(l.push(o(t,r,n)),f=e;f<i;++f)l.push("}");return l.join("\n")}(O,v[0],e,E)):x.push(o(v[0],e,E)),e.post.body.length>3&&x.push(i(e.post,e,s)),e.debug&&console.log("-----Generated cwise routine for ",t,":\n"+x.join("\n")+"\n----------");var R=[e.funcName||"unnamed","_cwise_loop_",c[0].join("s"),"m",O,a(s)].join("");return new Function(["function ",R,"(",g.join(","),"){",x.join("\n"),"} return ",R].join(""))()}},TGEO:function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),Object.defineProperty(t,"WebGLTextureLoader",{enumerable:!0,get:function(){return n.default}}),Object.defineProperty(t,"WebGLTextureLoaderAsyncHashCache",{enumerable:!0,get:function(){return o.default}}),Object.defineProperty(t,"WebGLTextureLoaderSyncHashCache",{enumerable:!0,get:function(){return i.default}}),Object.defineProperty(t,"LoadersRegistry",{enumerable:!0,get:function(){return a.default}}),Object.defineProperty(t,"LoaderResolver",{enumerable:!0,get:function(){return c.default}}),Object.defineProperty(t,"globalRegistry",{enumerable:!0,get:function(){return s.default}});var n=l(r("HbIt")),o=l(r("cDsr")),i=l(r("VYxY")),a=l(r("Ni9w")),c=l(r("LhdL")),s=l(r("OTww"));function l(e){return e&&e.__esModule?e:{default:e}}},TKux:function(e,t,r){"use strict";r.d(t,"b",(function(){return Lh})),r.d(t,"c",(function(){return Nh})),r.d(t,"a",(function(){return Mh}));var n={};r.r(n),r.d(n,"n",(function(){return Je})),r.d(n,"title",(function(){return et})),r.d(n,"Shader",(function(){return tt}));var o={};r.r(o),r.d(o,"n",(function(){return nt})),r.d(o,"title",(function(){return ot})),r.d(o,"exportSize",(function(){return it})),r.d(o,"exportStart",(function(){return at})),r.d(o,"exportEnd",(function(){return ct})),r.d(o,"exportFramePerSecond",(function(){return st})),r.d(o,"exportSpeed",(function(){return lt})),r.d(o,"Shader",(function(){return ft}));var i={};r.r(i),r.d(i,"n",(function(){return pt})),r.d(i,"title",(function(){return dt})),r.d(i,"Shader",(function(){return vt}));var a={};r.r(a),r.d(a,"n",(function(){return yt})),r.d(a,"title",(function(){return wt})),r.d(a,"Shader",(function(){return St}));var c={};r.r(c),r.d(c,"n",(function(){return Rt})),r.d(c,"title",(function(){return Pt})),r.d(c,"Shader",(function(){return zt}));var s={};r.r(s),r.d(s,"n",(function(){return It})),r.d(s,"title",(function(){return Ct})),r.d(s,"Shader",(function(){return jt}));var l={};r.r(l),r.d(l,"n",(function(){return At})),r.d(l,"title",(function(){return Dt})),r.d(l,"Shader",(function(){return Lt}));var f={};r.r(f),r.d(f,"n",(function(){return Mt})),r.d(f,"title",(function(){return Ut})),r.d(f,"Shader",(function(){return Ft}));var u={};r.r(u),r.d(u,"n",(function(){return qt})),r.d(u,"title",(function(){return Gt})),r.d(u,"exportSize",(function(){return $t})),r.d(u,"exportStart",(function(){return Ht})),r.d(u,"exportEnd",(function(){return Vt})),r.d(u,"exportFramePerSecond",(function(){return Wt})),r.d(u,"exportSpeed",(function(){return Xt})),r.d(u,"Shader",(function(){return Kt}));var p={};r.r(p),r.d(p,"n",(function(){return Qt})),r.d(p,"title",(function(){return Zt})),r.d(p,"Shader",(function(){return Jt}));var d={};r.r(d),r.d(d,"n",(function(){return tr})),r.d(d,"title",(function(){return rr})),r.d(d,"Shader",(function(){return nr}));var v={};r.r(v),r.d(v,"n",(function(){return ir})),r.d(v,"title",(function(){return ar})),r.d(v,"Shader",(function(){return cr}));var h={};r.r(h),r.d(h,"n",(function(){return lr})),r.d(h,"title",(function(){return fr})),r.d(h,"Shader",(function(){return ur}));var m={};r.r(m),r.d(m,"n",(function(){return dr})),r.d(m,"title",(function(){return vr})),r.d(m,"Shader",(function(){return hr}));var g={};r.r(g),r.d(g,"n",(function(){return Rr})),r.d(g,"title",(function(){return Pr})),r.d(g,"Shader",(function(){return zr}));var x={};r.r(x),r.d(x,"n",(function(){return jr})),r.d(x,"title",(function(){return kr})),r.d(x,"Shader",(function(){return Ar}));var b={};r.r(b),r.d(b,"n",(function(){return Lr})),r.d(b,"title",(function(){return Nr})),r.d(b,"Shader",(function(){return Mr}));var y={};r.r(y),r.d(y,"n",(function(){return Fr})),r.d(y,"title",(function(){return Br})),r.d(y,"Shader",(function(){return qr}));var w={};r.r(w),r.d(w,"n",(function(){return $r})),r.d(w,"title",(function(){return Hr})),r.d(w,"Shader",(function(){return Vr}));var _={};r.r(_),r.d(_,"n",(function(){return Xr})),r.d(_,"title",(function(){return Kr})),r.d(_,"Shader",(function(){return Yr}));var S={};r.r(S),r.d(S,"n",(function(){return Jr})),r.d(S,"title",(function(){return en})),r.d(S,"Shader",(function(){return tn}));var E={};r.r(E),r.d(E,"n",(function(){return on})),r.d(E,"title",(function(){return an})),r.d(E,"Shader",(function(){return cn}));var O={};r.r(O),r.d(O,"n",(function(){return ln})),r.d(O,"title",(function(){return fn})),r.d(O,"Shader",(function(){return un}));var R={};r.r(R),r.d(R,"n",(function(){return dn})),r.d(R,"title",(function(){return vn})),r.d(R,"Shader",(function(){return hn}));var P={};r.r(P),r.d(P,"n",(function(){return gn})),r.d(P,"title",(function(){return xn})),r.d(P,"Shader",(function(){return bn}));var z={};r.r(z),r.d(z,"n",(function(){return _n})),r.d(z,"title",(function(){return Sn})),r.d(z,"Shader",(function(){return En}));var T={};r.r(T),r.d(T,"n",(function(){return Pn})),r.d(T,"title",(function(){return zn})),r.d(T,"exportSize",(function(){return Tn})),r.d(T,"exportStart",(function(){return In})),r.d(T,"exportEnd",(function(){return Cn})),r.d(T,"exportFramePerSecond",(function(){return jn})),r.d(T,"exportSpeed",(function(){return kn})),r.d(T,"Shader",(function(){return An}));var I={};r.r(I),r.d(I,"n",(function(){return Nn})),r.d(I,"title",(function(){return Mn})),r.d(I,"Shader",(function(){return Un}));var C={};r.r(C),r.d(C,"n",(function(){return qn})),r.d(C,"title",(function(){return Gn})),r.d(C,"Shader",(function(){return $n}));var j={};r.r(j),r.d(j,"n",(function(){return Vn})),r.d(j,"title",(function(){return Wn})),r.d(j,"Shader",(function(){return Xn}));var k={};r.r(k),r.d(k,"n",(function(){return Yn})),r.d(k,"title",(function(){return Qn})),r.d(k,"Shader",(function(){return Zn}));var A={};r.r(A),r.d(A,"n",(function(){return eo})),r.d(A,"title",(function(){return to})),r.d(A,"Shader",(function(){return no}));var D={};r.r(D),r.d(D,"n",(function(){return io})),r.d(D,"title",(function(){return ao})),r.d(D,"Shader",(function(){return co}));var L={};r.r(L),r.d(L,"n",(function(){return lo})),r.d(L,"title",(function(){return fo})),r.d(L,"Shader",(function(){return uo}));var N={};r.r(N),r.d(N,"n",(function(){return vo})),r.d(N,"title",(function(){return ho})),r.d(N,"Shader",(function(){return mo}));var M={};r.r(M),r.d(M,"n",(function(){return bo})),r.d(M,"title",(function(){return yo})),r.d(M,"Shader",(function(){return wo}));var U={};r.r(U),r.d(U,"n",(function(){return Eo})),r.d(U,"title",(function(){return Oo})),r.d(U,"Shader",(function(){return Ro}));var F={};r.r(F),r.d(F,"n",(function(){return zo})),r.d(F,"title",(function(){return To})),r.d(F,"Shader",(function(){return Io}));var B={};r.r(B),r.d(B,"n",(function(){return ko})),r.d(B,"title",(function(){return Ao})),r.d(B,"Shader",(function(){return Do}));var q={};r.r(q),r.d(q,"n",(function(){return No})),r.d(q,"title",(function(){return Mo})),r.d(q,"Shader",(function(){return Uo}));var G={};r.r(G),r.d(G,"n",(function(){return Bo})),r.d(G,"title",(function(){return qo})),r.d(G,"Shader",(function(){return Go}));var $={};r.r($),r.d($,"n",(function(){return Ho})),r.d($,"title",(function(){return Vo})),r.d($,"Shader",(function(){return Wo}));var H={};r.r(H),r.d(H,"n",(function(){return Ko})),r.d(H,"title",(function(){return Yo})),r.d(H,"Shader",(function(){return Qo}));var V={};r.r(V),r.d(V,"n",(function(){return ei})),r.d(V,"title",(function(){return ti})),r.d(V,"Shader",(function(){return ri}));var W={};r.r(W),r.d(W,"n",(function(){return oi})),r.d(W,"title",(function(){return ii})),r.d(W,"Shader",(function(){return ai}));var X={};r.r(X),r.d(X,"n",(function(){return si})),r.d(X,"title",(function(){return li})),r.d(X,"Shader",(function(){return fi}));var K={};r.r(K),r.d(K,"n",(function(){return pi})),r.d(K,"title",(function(){return di})),r.d(K,"Shader",(function(){return vi}));var Y={};r.r(Y),r.d(Y,"n",(function(){return mi})),r.d(Y,"title",(function(){return gi})),r.d(Y,"Shader",(function(){return xi}));var Q={};r.r(Q),r.d(Q,"n",(function(){return yi})),r.d(Q,"title",(function(){return wi})),r.d(Q,"exportSize",(function(){return _i})),r.d(Q,"exportStart",(function(){return Si})),r.d(Q,"exportEnd",(function(){return Ei})),r.d(Q,"exportFramePerSecond",(function(){return Oi})),r.d(Q,"exportSpeed",(function(){return Ri})),r.d(Q,"Shader",(function(){return Pi}));var Z={};r.r(Z),r.d(Z,"n",(function(){return Ii})),r.d(Z,"title",(function(){return Ci})),r.d(Z,"Shader",(function(){return ji}));var J={};r.r(J),r.d(J,"n",(function(){return Ai})),r.d(J,"title",(function(){return Di})),r.d(J,"exportSize",(function(){return Li})),r.d(J,"exportStart",(function(){return Ni})),r.d(J,"exportEnd",(function(){return Mi})),r.d(J,"exportFramePerSecond",(function(){return Ui})),r.d(J,"exportSpeed",(function(){return Fi})),r.d(J,"Shader",(function(){return Bi}));var ee={};r.r(ee),r.d(ee,"n",(function(){return Gi})),r.d(ee,"title",(function(){return $i})),r.d(ee,"Shader",(function(){return Hi}));var te={};r.r(te),r.d(te,"n",(function(){return Wi})),r.d(te,"title",(function(){return Xi})),r.d(te,"Shader",(function(){return Ki}));var re={};r.r(re),r.d(re,"n",(function(){return Qi})),r.d(re,"title",(function(){return Zi})),r.d(re,"Shader",(function(){return Ji}));var ne={};r.r(ne),r.d(ne,"n",(function(){return ta})),r.d(ne,"title",(function(){return ra})),r.d(ne,"exportSize",(function(){return na})),r.d(ne,"exportStart",(function(){return oa})),r.d(ne,"exportEnd",(function(){return ia})),r.d(ne,"exportFramePerSecond",(function(){return aa})),r.d(ne,"exportSpeed",(function(){return ca})),r.d(ne,"Shader",(function(){return sa}));var oe={};r.r(oe),r.d(oe,"n",(function(){return fa})),r.d(oe,"title",(function(){return ua})),r.d(oe,"Shader",(function(){return pa}));var ie={};r.r(ie),r.d(ie,"n",(function(){return va})),r.d(ie,"title",(function(){return ha})),r.d(ie,"exportSize",(function(){return ma})),r.d(ie,"exportStart",(function(){return ga})),r.d(ie,"exportEnd",(function(){return xa})),r.d(ie,"exportFramePerSecond",(function(){return ba})),r.d(ie,"exportSpeed",(function(){return ya})),r.d(ie,"Shader",(function(){return wa}));var ae={};r.r(ae),r.d(ae,"exportSize",(function(){return Oa})),r.d(ae,"exportStart",(function(){return Ra})),r.d(ae,"exportEnd",(function(){return Pa})),r.d(ae,"exportFramePerSecond",(function(){return za})),r.d(ae,"exportSpeed",(function(){return Ta})),r.d(ae,"exportMP4vb",(function(){return Ia})),r.d(ae,"n",(function(){return Ca})),r.d(ae,"title",(function(){return ja})),r.d(ae,"nfts",(function(){return ka})),r.d(ae,"Shader",(function(){return Da}));var ce={};r.r(ce),r.d(ce,"n",(function(){return Ma})),r.d(ce,"title",(function(){return Ua})),r.d(ce,"description",(function(){return Fa})),r.d(ce,"Shader",(function(){return Ba}));var se={};r.r(se),r.d(se,"n",(function(){return $a})),r.d(se,"title",(function(){return Ha})),r.d(se,"Shader",(function(){return Va}));var le={};r.r(le),r.d(le,"n",(function(){return Xa})),r.d(le,"title",(function(){return Ka})),r.d(le,"exportEnd",(function(){return Ya})),r.d(le,"exportFramePerSecond",(function(){return Qa})),r.d(le,"preload",(function(){return Za})),r.d(le,"Shader",(function(){return Ja}));var fe={};r.r(fe),r.d(fe,"n",(function(){return tc})),r.d(fe,"title",(function(){return rc})),r.d(fe,"exportEnd",(function(){return nc})),r.d(fe,"exportFramePerSecond",(function(){return oc})),r.d(fe,"exportSpeed",(function(){return ic})),r.d(fe,"Logic",(function(){return ac})),r.d(fe,"Shader",(function(){return uc}));var ue={};r.r(ue),r.d(ue,"n",(function(){return vc})),r.d(ue,"title",(function(){return hc})),r.d(ue,"exportSize",(function(){return mc})),r.d(ue,"exportStart",(function(){return gc})),r.d(ue,"exportEnd",(function(){return xc})),r.d(ue,"exportFramePerSecond",(function(){return bc})),r.d(ue,"exportSpeed",(function(){return yc})),r.d(ue,"exportMP4vb",(function(){return wc})),r.d(ue,"Logic",(function(){return Sc})),r.d(ue,"Shader",(function(){return Pc}));var pe={};r.r(pe),r.d(pe,"n",(function(){return Tc})),r.d(pe,"title",(function(){return Ic})),r.d(pe,"exportEnd",(function(){return Cc})),r.d(pe,"nfts",(function(){return jc})),r.d(pe,"Shader",(function(){return kc}));var de={};r.r(de),r.d(de,"n",(function(){return Dc})),r.d(de,"title",(function(){return Lc})),r.d(de,"exportSize",(function(){return Nc})),r.d(de,"exportStart",(function(){return Mc})),r.d(de,"exportEnd",(function(){return Uc})),r.d(de,"exportFramePerSecond",(function(){return Fc})),r.d(de,"exportSpeed",(function(){return Bc})),r.d(de,"exportSkipFrame",(function(){return qc})),r.d(de,"exportPaletteGenOnce",(function(){return Gc})),r.d(de,"exportPaletteSize",(function(){return $c})),r.d(de,"nfts",(function(){return Hc})),r.d(de,"Shader",(function(){return Vc}));var ve={};r.r(ve),r.d(ve,"n",(function(){return Kc})),r.d(ve,"title",(function(){return Yc})),r.d(ve,"exportSize",(function(){return Qc})),r.d(ve,"exportStart",(function(){return Zc})),r.d(ve,"exportEnd",(function(){return Jc})),r.d(ve,"exportFramePerSecond",(function(){return es})),r.d(ve,"exportSpeed",(function(){return ts})),r.d(ve,"exportSkipFrame",(function(){return rs})),r.d(ve,"exportPaletteGenOnce",(function(){return ns})),r.d(ve,"exportPaletteSize",(function(){return os})),r.d(ve,"Shader",(function(){return is}));var he={};r.r(he),r.d(he,"n",(function(){return ss})),r.d(he,"title",(function(){return ls})),r.d(he,"exportSize",(function(){return fs})),r.d(he,"exportStart",(function(){return us})),r.d(he,"exportEnd",(function(){return ps})),r.d(he,"exportFramePerSecond",(function(){return ds})),r.d(he,"exportSpeed",(function(){return vs})),r.d(he,"exportSkipFrame",(function(){return hs})),r.d(he,"exportPaletteGenOnce",(function(){return ms})),r.d(he,"exportPaletteSize",(function(){return gs})),r.d(he,"Shader",(function(){return xs}));var me={};r.r(me),r.d(me,"n",(function(){return ws})),r.d(me,"title",(function(){return _s})),r.d(me,"exportSize",(function(){return Ss})),r.d(me,"exportStart",(function(){return Es})),r.d(me,"exportEnd",(function(){return Os})),r.d(me,"exportFramePerSecond",(function(){return Rs})),r.d(me,"exportSpeed",(function(){return Ps})),r.d(me,"exportSkipFrame",(function(){return zs})),r.d(me,"exportPaletteGenOnce",(function(){return Ts})),r.d(me,"exportPaletteSize",(function(){return Is})),r.d(me,"Shader",(function(){return Cs}));var ge={};r.r(ge),r.d(ge,"n",(function(){return As})),r.d(ge,"title",(function(){return Ds})),r.d(ge,"exportSize",(function(){return Ls})),r.d(ge,"exportStart",(function(){return Ns})),r.d(ge,"exportEnd",(function(){return Ms})),r.d(ge,"exportFramePerSecond",(function(){return Us})),r.d(ge,"exportSpeed",(function(){return Fs})),r.d(ge,"exportPaletteGenOnce",(function(){return Bs})),r.d(ge,"exportPaletteSize",(function(){return qs})),r.d(ge,"Shader",(function(){return Gs}));var xe={};r.r(xe),r.d(xe,"n",(function(){return Hs})),r.d(xe,"title",(function(){return Vs})),r.d(xe,"exportSize",(function(){return Ws})),r.d(xe,"exportStart",(function(){return Xs})),r.d(xe,"exportEnd",(function(){return Ks})),r.d(xe,"exportFramePerSecond",(function(){return Ys})),r.d(xe,"exportSpeed",(function(){return Qs})),r.d(xe,"exportPaletteGenOnce",(function(){return Zs})),r.d(xe,"exportPaletteSize",(function(){return Js})),r.d(xe,"Shader",(function(){return el}));var be={};r.r(be),r.d(be,"n",(function(){return rl})),r.d(be,"title",(function(){return nl})),r.d(be,"exportSize",(function(){return ol})),r.d(be,"exportStart",(function(){return il})),r.d(be,"exportEnd",(function(){return al})),r.d(be,"exportFramePerSecond",(function(){return cl})),r.d(be,"exportSpeed",(function(){return sl})),r.d(be,"exportPaletteGenOnce",(function(){return ll})),r.d(be,"exportPaletteSize",(function(){return fl})),r.d(be,"Shader",(function(){return ul}));var ye={};r.r(ye),r.d(ye,"n",(function(){return dl})),r.d(ye,"title",(function(){return vl})),r.d(ye,"exportSize",(function(){return hl})),r.d(ye,"exportStart",(function(){return ml})),r.d(ye,"exportEnd",(function(){return gl})),r.d(ye,"exportFramePerSecond",(function(){return xl})),r.d(ye,"exportSpeed",(function(){return bl})),r.d(ye,"exportPaletteGenOnce",(function(){return yl})),r.d(ye,"exportPaletteSize",(function(){return wl})),r.d(ye,"nfts",(function(){return _l})),r.d(ye,"Shader",(function(){return Sl}));var we={};r.r(we),r.d(we,"n",(function(){return Ol})),r.d(we,"title",(function(){return Rl})),r.d(we,"exportSize",(function(){return Pl})),r.d(we,"exportStart",(function(){return zl})),r.d(we,"exportEnd",(function(){return Tl})),r.d(we,"exportFramePerSecond",(function(){return Il})),r.d(we,"exportSpeed",(function(){return Cl})),r.d(we,"exportPaletteGenOnce",(function(){return jl})),r.d(we,"exportPaletteSize",(function(){return kl})),r.d(we,"Shader",(function(){return Dl}));var _e={};r.r(_e),r.d(_e,"n",(function(){return Nl})),r.d(_e,"title",(function(){return Ml})),r.d(_e,"exportSize",(function(){return Ul})),r.d(_e,"exportStart",(function(){return Fl})),r.d(_e,"exportEnd",(function(){return Bl})),r.d(_e,"exportFramePerSecond",(function(){return ql})),r.d(_e,"exportSpeed",(function(){return Gl})),r.d(_e,"exportPaletteGenOnce",(function(){return $l})),r.d(_e,"exportPaletteSize",(function(){return Hl})),r.d(_e,"Shader",(function(){return Wl}));var Se={};r.r(Se),r.d(Se,"n",(function(){return Kl})),r.d(Se,"title",(function(){return Yl})),r.d(Se,"exportSize",(function(){return Ql})),r.d(Se,"exportStart",(function(){return Zl})),r.d(Se,"exportEnd",(function(){return Jl})),r.d(Se,"exportFramePerSecond",(function(){return ef})),r.d(Se,"exportSpeed",(function(){return tf})),r.d(Se,"exportPaletteGenOnce",(function(){return rf})),r.d(Se,"exportPaletteSize",(function(){return nf})),r.d(Se,"Shader",(function(){return af}));var Ee={};r.r(Ee),r.d(Ee,"n",(function(){return sf})),r.d(Ee,"title",(function(){return lf})),r.d(Ee,"exportSize",(function(){return ff})),r.d(Ee,"exportStart",(function(){return uf})),r.d(Ee,"exportEnd",(function(){return pf})),r.d(Ee,"exportFramePerSecond",(function(){return df})),r.d(Ee,"exportSpeed",(function(){return vf})),r.d(Ee,"exportPaletteGenOnce",(function(){return hf})),r.d(Ee,"exportPaletteSize",(function(){return mf})),r.d(Ee,"Shader",(function(){return gf}));var Oe={};r.r(Oe),r.d(Oe,"n",(function(){return bf})),r.d(Oe,"title",(function(){return yf})),r.d(Oe,"exportSize",(function(){return wf})),r.d(Oe,"exportStart",(function(){return _f})),r.d(Oe,"exportEnd",(function(){return Sf})),r.d(Oe,"exportFramePerSecond",(function(){return Ef})),r.d(Oe,"exportSpeed",(function(){return Of})),r.d(Oe,"exportPaletteGenOnce",(function(){return Rf})),r.d(Oe,"exportPaletteSize",(function(){return Pf})),r.d(Oe,"Shader",(function(){return zf}));var Re={};r.r(Re),r.d(Re,"n",(function(){return If})),r.d(Re,"title",(function(){return Cf})),r.d(Re,"exportSize",(function(){return jf})),r.d(Re,"exportStart",(function(){return kf})),r.d(Re,"exportEnd",(function(){return Af})),r.d(Re,"exportFramePerSecond",(function(){return Df})),r.d(Re,"exportSpeed",(function(){return Lf})),r.d(Re,"exportPaletteGenOnce",(function(){return Nf})),r.d(Re,"exportPaletteSize",(function(){return Mf})),r.d(Re,"Shader",(function(){return Uf}));var Pe={};r.r(Pe),r.d(Pe,"n",(function(){return Bf})),r.d(Pe,"title",(function(){return qf})),r.d(Pe,"exportSize",(function(){return Gf})),r.d(Pe,"exportStart",(function(){return $f})),r.d(Pe,"exportEnd",(function(){return Hf})),r.d(Pe,"exportFramePerSecond",(function(){return Vf})),r.d(Pe,"exportSpeed",(function(){return Wf})),r.d(Pe,"exportPaletteGenOnce",(function(){return Xf})),r.d(Pe,"exportPaletteSize",(function(){return Kf})),r.d(Pe,"Shader",(function(){return Yf}));var ze={};r.r(ze),r.d(ze,"n",(function(){return Zf})),r.d(ze,"title",(function(){return Jf})),r.d(ze,"exportSize",(function(){return eu})),r.d(ze,"exportStart",(function(){return tu})),r.d(ze,"exportEnd",(function(){return ru})),r.d(ze,"exportFramePerSecond",(function(){return nu})),r.d(ze,"exportSpeed",(function(){return ou})),r.d(ze,"exportPaletteGenOnce",(function(){return iu})),r.d(ze,"exportPaletteSize",(function(){return au})),r.d(ze,"Shader",(function(){return cu}));var Te={};r.r(Te),r.d(Te,"n",(function(){return lu})),r.d(Te,"title",(function(){return fu})),r.d(Te,"exportSize",(function(){return uu})),r.d(Te,"exportStart",(function(){return pu})),r.d(Te,"exportEnd",(function(){return du})),r.d(Te,"exportFramePerSecond",(function(){return vu})),r.d(Te,"exportSpeed",(function(){return hu})),r.d(Te,"exportPaletteGenOnce",(function(){return mu})),r.d(Te,"exportPaletteSize",(function(){return gu})),r.d(Te,"Shader",(function(){return xu}));var Ie={};r.r(Ie),r.d(Ie,"n",(function(){return yu})),r.d(Ie,"title",(function(){return wu})),r.d(Ie,"exportSize",(function(){return _u})),r.d(Ie,"exportStart",(function(){return Su})),r.d(Ie,"exportEnd",(function(){return Eu})),r.d(Ie,"exportFramePerSecond",(function(){return Ou})),r.d(Ie,"exportSpeed",(function(){return Ru})),r.d(Ie,"exportPaletteGenOnce",(function(){return Pu})),r.d(Ie,"exportPaletteSize",(function(){return zu})),r.d(Ie,"Shader",(function(){return Tu}));var Ce={};r.r(Ce),r.d(Ce,"n",(function(){return Cu})),r.d(Ce,"title",(function(){return ju})),r.d(Ce,"exportSize",(function(){return ku})),r.d(Ce,"exportStart",(function(){return Au})),r.d(Ce,"exportEnd",(function(){return Du})),r.d(Ce,"exportFramePerSecond",(function(){return Lu})),r.d(Ce,"exportSpeed",(function(){return Nu})),r.d(Ce,"exportPaletteGenOnce",(function(){return Mu})),r.d(Ce,"exportPaletteSize",(function(){return Uu})),r.d(Ce,"Shader",(function(){return Fu}));var je={};r.r(je),r.d(je,"n",(function(){return qu})),r.d(je,"title",(function(){return Gu})),r.d(je,"exportSize",(function(){return $u})),r.d(je,"exportStart",(function(){return Hu})),r.d(je,"exportEnd",(function(){return Vu})),r.d(je,"exportFramePerSecond",(function(){return Wu})),r.d(je,"exportSpeed",(function(){return Xu})),r.d(je,"exportPaletteGenOnce",(function(){return Ku})),r.d(je,"exportPaletteSize",(function(){return Yu})),r.d(je,"Shader",(function(){return Qu}));var ke={};r.r(ke),r.d(ke,"n",(function(){return Ju})),r.d(ke,"title",(function(){return ep})),r.d(ke,"exportSize",(function(){return tp})),r.d(ke,"exportStart",(function(){return rp})),r.d(ke,"exportEnd",(function(){return np})),r.d(ke,"exportFramePerSecond",(function(){return op})),r.d(ke,"exportSpeed",(function(){return ip})),r.d(ke,"exportPaletteGenOnce",(function(){return ap})),r.d(ke,"exportPaletteSize",(function(){return cp})),r.d(ke,"Shader",(function(){return sp}));var Ae={};r.r(Ae),r.d(Ae,"n",(function(){return fp})),r.d(Ae,"title",(function(){return up})),r.d(Ae,"exportSize",(function(){return pp})),r.d(Ae,"exportStart",(function(){return dp})),r.d(Ae,"exportEnd",(function(){return vp})),r.d(Ae,"exportFramePerSecond",(function(){return hp})),r.d(Ae,"exportSpeed",(function(){return mp})),r.d(Ae,"exportPaletteGenOnce",(function(){return gp})),r.d(Ae,"exportPaletteSize",(function(){return xp})),r.d(Ae,"Shader",(function(){return bp}));var De={};r.r(De),r.d(De,"n",(function(){return wp})),r.d(De,"title",(function(){return _p})),r.d(De,"exportSize",(function(){return Sp})),r.d(De,"exportStart",(function(){return Ep})),r.d(De,"exportEnd",(function(){return Op})),r.d(De,"exportFramePerSecond",(function(){return Rp})),r.d(De,"exportSpeed",(function(){return Pp})),r.d(De,"exportPaletteGenOnce",(function(){return zp})),r.d(De,"exportPaletteSize",(function(){return Tp})),r.d(De,"Shader",(function(){return Ip}));var Le={};r.r(Le),r.d(Le,"n",(function(){return jp})),r.d(Le,"title",(function(){return kp})),r.d(Le,"exportSize",(function(){return Ap})),r.d(Le,"exportStart",(function(){return Dp})),r.d(Le,"exportEnd",(function(){return Lp})),r.d(Le,"exportFramePerSecond",(function(){return Np})),r.d(Le,"exportSpeed",(function(){return Mp})),r.d(Le,"exportPaletteGenOnce",(function(){return Up})),r.d(Le,"exportPaletteSize",(function(){return Fp})),r.d(Le,"Shader",(function(){return Bp}));var Ne={};r.r(Ne),r.d(Ne,"n",(function(){return Gp})),r.d(Ne,"title",(function(){return $p})),r.d(Ne,"exportSize",(function(){return Hp})),r.d(Ne,"exportStart",(function(){return Vp})),r.d(Ne,"exportEnd",(function(){return Wp})),r.d(Ne,"exportFramePerSecond",(function(){return Xp})),r.d(Ne,"exportSpeed",(function(){return Kp})),r.d(Ne,"exportPaletteGenOnce",(function(){return Yp})),r.d(Ne,"exportPaletteSize",(function(){return Qp})),r.d(Ne,"Shader",(function(){return Zp}));var Me={};r.r(Me),r.d(Me,"n",(function(){return ed})),r.d(Me,"title",(function(){return td})),r.d(Me,"exportSize",(function(){return rd})),r.d(Me,"exportStart",(function(){return nd})),r.d(Me,"exportEnd",(function(){return od})),r.d(Me,"exportFramePerSecond",(function(){return id})),r.d(Me,"exportSpeed",(function(){return ad})),r.d(Me,"exportPaletteGenOnce",(function(){return cd})),r.d(Me,"exportPaletteSize",(function(){return sd})),r.d(Me,"Shader",(function(){return ld}));var Ue={};r.r(Ue),r.d(Ue,"n",(function(){return ud})),r.d(Ue,"title",(function(){return pd})),r.d(Ue,"exportSize",(function(){return dd})),r.d(Ue,"exportStart",(function(){return vd})),r.d(Ue,"exportEnd",(function(){return hd})),r.d(Ue,"exportFramePerSecond",(function(){return md})),r.d(Ue,"exportSpeed",(function(){return gd})),r.d(Ue,"exportPaletteGenOnce",(function(){return xd})),r.d(Ue,"exportPaletteSize",(function(){return bd})),r.d(Ue,"Shader",(function(){return yd}));var Fe={};r.r(Fe),r.d(Fe,"n",(function(){return _d})),r.d(Fe,"title",(function(){return Sd})),r.d(Fe,"exportSize",(function(){return Ed})),r.d(Fe,"exportStart",(function(){return Od})),r.d(Fe,"exportEnd",(function(){return Rd})),r.d(Fe,"exportFramePerSecond",(function(){return Pd})),r.d(Fe,"exportSpeed",(function(){return zd})),r.d(Fe,"exportPaletteGenOnce",(function(){return Td})),r.d(Fe,"exportPaletteSize",(function(){return Id})),r.d(Fe,"Shader",(function(){return Cd}));var Be={};r.r(Be),r.d(Be,"n",(function(){return kd})),r.d(Be,"title",(function(){return Ad})),r.d(Be,"exportSize",(function(){return Dd})),r.d(Be,"exportStart",(function(){return Ld})),r.d(Be,"exportEnd",(function(){return Nd})),r.d(Be,"exportFramePerSecond",(function(){return Md})),r.d(Be,"exportSpeed",(function(){return Ud})),r.d(Be,"exportPaletteGenOnce",(function(){return Fd})),r.d(Be,"exportPaletteSize",(function(){return Bd})),r.d(Be,"Shader",(function(){return qd}));var qe={};r.r(qe),r.d(qe,"n",(function(){return $d})),r.d(qe,"title",(function(){return Hd})),r.d(qe,"exportSize",(function(){return Vd})),r.d(qe,"exportStart",(function(){return Wd})),r.d(qe,"exportEnd",(function(){return Xd})),r.d(qe,"exportFramePerSecond",(function(){return Kd})),r.d(qe,"exportSpeed",(function(){return Yd})),r.d(qe,"exportPaletteGenOnce",(function(){return Qd})),r.d(qe,"exportPaletteSize",(function(){return Zd})),r.d(qe,"Shader",(function(){return Jd}));var Ge={};r.r(Ge),r.d(Ge,"n",(function(){return tv})),r.d(Ge,"title",(function(){return rv})),r.d(Ge,"exportSize",(function(){return nv})),r.d(Ge,"exportStart",(function(){return ov})),r.d(Ge,"exportEnd",(function(){return iv})),r.d(Ge,"exportFramePerSecond",(function(){return av})),r.d(Ge,"exportSpeed",(function(){return cv})),r.d(Ge,"exportPaletteGenOnce",(function(){return sv})),r.d(Ge,"exportPaletteSize",(function(){return lv})),r.d(Ge,"Shader",(function(){return fv}));var $e={};r.r($e),r.d($e,"n",(function(){return pv})),r.d($e,"title",(function(){return dv})),r.d($e,"exportSize",(function(){return vv})),r.d($e,"exportStart",(function(){return hv})),r.d($e,"exportEnd",(function(){return mv})),r.d($e,"exportFramePerSecond",(function(){return gv})),r.d($e,"exportSpeed",(function(){return xv})),r.d($e,"exportPaletteGenOnce",(function(){return bv})),r.d($e,"exportPaletteSize",(function(){return yv})),r.d($e,"Shader",(function(){return wv}));var He={};r.r(He),r.d(He,"n",(function(){return Sv})),r.d(He,"title",(function(){return Ev})),r.d(He,"exportSize",(function(){return Ov})),r.d(He,"exportStart",(function(){return Rv})),r.d(He,"exportEnd",(function(){return Pv})),r.d(He,"exportFramePerSecond",(function(){return zv})),r.d(He,"exportSpeed",(function(){return Tv})),r.d(He,"exportPaletteGenOnce",(function(){return Iv})),r.d(He,"exportPaletteSize",(function(){return Cv})),r.d(He,"Shader",(function(){return jv}));var Ve={};r.r(Ve),r.d(Ve,"n",(function(){return Av})),r.d(Ve,"title",(function(){return Dv})),r.d(Ve,"exportSize",(function(){return Lv})),r.d(Ve,"exportStart",(function(){return Nv})),r.d(Ve,"exportEnd",(function(){return Mv})),r.d(Ve,"exportFramePerSecond",(function(){return Uv})),r.d(Ve,"exportSpeed",(function(){return Fv})),r.d(Ve,"exportPaletteGenOnce",(function(){return Bv})),r.d(Ve,"exportPaletteSize",(function(){return qv})),r.d(Ve,"Shader",(function(){return Gv}));var We={};r.r(We),r.d(We,"n",(function(){return Hv})),r.d(We,"title",(function(){return Vv})),r.d(We,"exportSize",(function(){return Wv})),r.d(We,"exportStart",(function(){return Xv})),r.d(We,"exportEnd",(function(){return Kv})),r.d(We,"exportFramePerSecond",(function(){return Yv})),r.d(We,"exportSpeed",(function(){return Qv})),r.d(We,"exportPaletteGenOnce",(function(){return Zv})),r.d(We,"exportPaletteSize",(function(){return Jv})),r.d(We,"Shader",(function(){return eh}));var Xe={};r.r(Xe),r.d(Xe,"n",(function(){return rh})),r.d(Xe,"title",(function(){return nh})),r.d(Xe,"exportSize",(function(){return oh})),r.d(Xe,"exportStart",(function(){return ih})),r.d(Xe,"exportEnd",(function(){return ah})),r.d(Xe,"exportFramePerSecond",(function(){return ch})),r.d(Xe,"exportSpeed",(function(){return sh})),r.d(Xe,"exportPaletteGenOnce",(function(){return lh})),r.d(Xe,"exportPaletteSize",(function(){return fh})),r.d(Xe,"Shader",(function(){return uh}));var Ke={};r.r(Ke),r.d(Ke,"n",(function(){return dh})),r.d(Ke,"title",(function(){return vh})),r.d(Ke,"exportSize",(function(){return hh})),r.d(Ke,"exportStart",(function(){return mh})),r.d(Ke,"exportEnd",(function(){return gh})),r.d(Ke,"exportFramePerSecond",(function(){return xh})),r.d(Ke,"exportSpeed",(function(){return bh})),r.d(Ke,"exportPaletteGenOnce",(function(){return yh})),r.d(Ke,"exportPaletteSize",(function(){return wh})),r.d(Ke,"Shader",(function(){return _h}));var Ye={};r.r(Ye),r.d(Ye,"n",(function(){return Eh})),r.d(Ye,"title",(function(){return Oh})),r.d(Ye,"exportSize",(function(){return Rh})),r.d(Ye,"exportStart",(function(){return Ph})),r.d(Ye,"exportEnd",(function(){return zh})),r.d(Ye,"exportFramePerSecond",(function(){return Th})),r.d(Ye,"exportSpeed",(function(){return Ih})),r.d(Ye,"exportPaletteGenOnce",(function(){return Ch})),r.d(Ye,"exportPaletteSize",(function(){return jh})),r.d(Ye,"Shader",(function(){return kh}));var Qe=r("nKUr"),Ze=r("rr/c");const Je=1,et="Hello 2020",tt=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:rt.day001,uniforms:{time:e}}),rt=Ze.Shaders.create({day001:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
float vingt (vec2 p) {
...
}`}}),nt=2,ot="stripes",it=400,at=0,ct=60,st=24,lt=1,ft=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:ut.node,uniforms:{time:e}}),ut=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),pt=3,dt="zephyr",vt=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:ht.node,uniforms:{time:e}}),ht=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}});var mt=r("q1tI"),gt=r.n(mt);const xt=Ze.Shaders.create({InitGameOfLife:{frag:Ze.GLSL`
  precision highp float;
  uniform float seed;
  // i
  varying vec2 uv;
  ...
  }`}}),bt=gt.a.memo((({tick:e,size:t,refreshEveryTicks:r})=>e%(r||1/0)===0?Object(Qe.jsx)(Ze.Node,{shader:xt.InitGameOfLife,uniforms:{seed:Math.random()},width:t,height:t,backbuffering:!0,sync:!0}):Object(Qe.jsx)(Ze.Node,{shader:xt.GameOfLife,width:t,height:t,backbuffering:!0,sync:!0,uniforms:{t:Ze.Uniform.Backbuffer,size:t}}))),yt=4,wt="Ray of Life";let _t;const St=({time:e})=>{_t||(_t=e);const t=e-_t,r=Math.floor(10*t),n=r+25,o=10*(1+Math.floor(r/50)),i=10*(1+Math.floor(n/50));return Object(Qe.jsx)(Et,{time:e,a:Object(Qe.jsx)(Ze.NearestCopy,{children:Object(Qe.jsx)(bt,{refreshEveryTicks:50,tick:r,size:o})}),b:Object(Qe.jsx)(Ze.NearestCopy,{children:Object(Qe.jsx)(bt,{refreshEveryTicks:50,tick:n,size:i})})})},Et=({a:e,b:t,time:r})=>Object(Qe.jsx)(Ze.Node,{uniforms:{a:e,b:t,time:r},shader:Ot.main}),Ot=Ze.Shaders.create({main:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Rt=5,Pt="Here We Go Again",zt=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:Tt.node,uniforms:{time:e}}),Tt=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    sqrt(vec3(1. - shad));
  gl_FragColor = vec4(c,1.0);
}`}}),It=6,Ct="Bestagons",jt=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:kt.node,uniforms:{time:e}}),kt=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),At=7,Dt="Worms party",Lt=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:Nt.node,uniforms:{time:e}}),Nt=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    sqrt(vec3(1. - shad));
  gl_FragColor = vec4(c,1.0);
}`}}),Mt=8,Ut="moontains",Ft=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:Bt.node,uniforms:{time:e}}),Bt=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),qt=9,Gt="Virus",$t=400,Ht=16.3,Vt=26,Wt=24,Xt=.8,Kt=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:Yt.node,uniforms:{time:e}}),Yt=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Qt=10,Zt="ring",Jt=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:er.node,uniforms:{time:e}}),er=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),tr=11,rr="magic mouse",nr=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:or.node,uniforms:{time:e}}),or=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),ir=12,ar="floor is lava",cr=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:sr.node,uniforms:{time:e}}),sr=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),lr=13,fr="chip",ur=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:pr.node,uniforms:{time:e}}),pr=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
`}}),dr=14,vr="seizure",hr=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:mr.node,uniforms:{time:e}}),mr=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),gr=Ze.Shaders.create({blur1D:{frag:Ze.GLSL`precision highp float;
varying vec2 uv;
uniform sampler2D t;
...
}`}});var xr=({width:e,height:t,pixelRatio:r,direction:n,children:o})=>Object(Qe.jsx)(Ze.Node,{shader:gr.blur1D,width:e,height:t,pixelRatio:r,uniforms:{direction:n,resolution:Ze.Uniform.Resolution,t:o}});const br=Math.sqrt(2)/2;var yr=(e,t,r)=>{const n=2*t*Math.ceil(e/2)/r;switch((e-1)%4){case 0:return[n,0];case 1:return[0,n];case 2:return[n*br,n*br];case 3:return[n*br,-n*br]}};const wr=({width:e,height:t,pixelRatio:r,factor:n,children:o,passes:i,directionForPass:a})=>{const c=s=>s<=0?o:Object(Qe.jsx)(xr,{width:e,height:t,pixelRatio:r,direction:a(s,n,i),children:c(s-1)});return c(i)};wr.defaultProps={passes:2,directionForPass:yr};var _r=wr;const Sr=Ze.Shaders.create({blur1D:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
...
}`}});var Er=({width:e,height:t,map:r,pixelRatio:n,direction:o,children:i})=>Object(Qe.jsx)(Ze.Node,{shader:Sr.blur1D,width:e,height:t,pixelRatio:n,uniforms:{direction:o,resolution:Ze.Uniform.Resolution,t:i,map:r}});const Or=({width:e,height:t,map:r,pixelRatio:n,factor:o,children:i,passes:a,directionForPass:c})=>{const s=l=>l<=0?i:Object(Qe.jsx)(Er,{width:e,height:t,map:r,pixelRatio:n,direction:c(l,o,a),children:s(l-1)});return s(a)};Or.defaultProps={passes:2,directionForPass:yr};const Rr=15,Pr="parametric",zr=({time:e})=>Object(Qe.jsx)(Ze.LinearCopy,{children:Object(Qe.jsx)(Ir,{persistence:.98+.02*Math.cos(e)+-.8*Math.exp(-e),children:Object(Qe.jsx)(_r,{passes:4,factor:.2,children:Object(Qe.jsx)(Tr,{time:e})})})}),Tr=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:Cr.node,uniforms:{time:e}}),Ir=({children:e,persistence:t})=>Object(Qe.jsx)(Ze.Node,{shader:Cr.persistence,backbuffering:!0,uniforms:{t:e,back:Ze.Uniform.Backbuffer,persistence:t}}),Cr=Ze.Shaders.create({persistence:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),jr=16,kr="reuleaux",Ar=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:Dr.node,uniforms:{time:e}}),Dr=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    color(0.5 * time);
  gl_FragColor = vec4(c, 1.0);
}`}}),Lr=17,Nr="screws",Mr=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:Ur.node,uniforms:{time:e}}),Ur=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),Fr=18,Br="queen",qr=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:Gr.node,uniforms:{time:e}}),Gr=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
}`}}),$r=19,Hr="they were six",Vr=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:Wr.node,uniforms:{time:e}}),Wr=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Xr=20,Kr="trippy tiles",Yr=({time:e})=>Object(Qe.jsx)(Ze.LinearCopy,{children:Object(Qe.jsx)(Qr,{persistence:.85,children:Object(Qe.jsx)(Ze.Node,{shader:Zr.node,uniforms:{time:e}})})}),Qr=({children:e,persistence:t})=>Object(Qe.jsx)(Ze.Node,{shader:Zr.persistence,backbuffering:!0,uniforms:{t:e,back:Ze.Uniform.Backbuffer,persistence:t}}),Zr=Ze.Shaders.create({persistence:{frag:Ze.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Jr=21,en="HODL",tn=({time:e})=>Object(Qe.jsx)(Ze.LinearCopy,{children:Object(Qe.jsx)(rn,{persistence:Math.min(.99,.015*e),time:e,children:Object(Qe.jsx)(Ze.Node,{shader:nn.node,uniforms:{time:e}})})}),rn=({children:e,persistence:t,time:r})=>Object(Qe.jsx)(Ze.Node,{shader:nn.shakePersistence,backbuffering:!0,uniforms:{t:e,back:Ze.Uniform.Backbuffer,persistence:t,time:r}}),nn=Ze.Shaders.create({shakePersistence:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform sampler2D t, back;
uniform float time;
...
}`}}),on=22,an="atoms",cn=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:sn.node,uniforms:{time:e,t:"/images/einstein-tongue-out.jpg"}}),sn=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D t;
...
void main() {
...
}`}}),ln=23,fn="Hexacubes",un=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:pn.node,uniforms:{time:e}}),pn=Ze.Shaders.create({node:{frag:Ze.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform float time;
  const float PI = ${Math.PI};
  ...
  void main() {
    ...
    gl_FragColor = vec4(c, 1.0);
      ...
      `}}),dn=24,vn="dark cubes",hn=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:mn.node,uniforms:{time:e}}),mn=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),gn=25,xn="Mandelbrot",bn=({time:e})=>Object(Qe.jsx)(Ze.LinearCopy,{children:Object(Qe.jsx)(yn,{persistence:.9,children:Object(Qe.jsx)(_r,{passes:4,factor:.1,children:Object(Qe.jsx)(Ze.Node,{shader:wn.node,uniforms:{time:e}})})})}),yn=({children:e,persistence:t})=>Object(Qe.jsx)(Ze.Node,{shader:wn.persistence,backbuffering:!0,uniforms:{t:e,back:Ze.Uniform.Backbuffer,persistence:t}}),wn=Ze.Shaders.create({persistence:{frag:Ze.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),_n=26,Sn="fumes",En=({time:e})=>Object(Qe.jsx)(Ze.LinearCopy,{children:Object(Qe.jsx)(On,{persistence:.9,children:Object(Qe.jsx)(_r,{passes:4,factor:Math.min(.6,.01*e),children:Object(Qe.jsx)(Ze.Node,{shader:Rn.node,uniforms:{time:e}})})})}),On=({children:e,persistence:t})=>Object(Qe.jsx)(Ze.Node,{shader:Rn.persistence,backbuffering:!0,uniforms:{t:e,back:Ze.Uniform.Backbuffer,persistence:t}}),Rn=Ze.Shaders.create({persistence:{frag:Ze.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Pn=27,zn="real burning ship",Tn=400,In=0,Cn=60,jn=12,kn=2,An=({time:e})=>Object(Qe.jsx)(Ze.LinearCopy,{children:Object(Qe.jsx)(Dn,{persistence:.8+.05*Math.random(),time:e,children:Object(Qe.jsx)(Ze.Node,{shader:Ln.node,uniforms:{time:e}})})}),Dn=({children:e,persistence:t,time:r})=>Object(Qe.jsx)(Ze.Node,{shader:Ln.persistence,backbuffering:!0,uniforms:{t:e,back:Ze.Uniform.Backbuffer,persistence:t,time:r}}),Ln=Ze.Shaders.create({persistence:{frag:Ze.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Nn=28,Mn="No, I'M Batman",Un=({time:e})=>Object(Qe.jsx)(Ze.LinearCopy,{children:Object(Qe.jsx)(Fn,{persistence:.5+.48*Math.min(1,e/60),children:Object(Qe.jsx)(Ze.Node,{shader:Bn.node,uniforms:{time:e}})})}),Fn=({children:e,persistence:t})=>Object(Qe.jsx)(Ze.Node,{shader:Bn.persistence,backbuffering:!0,uniforms:{t:e,back:Ze.Uniform.Backbuffer,persistence:t}}),Bn=Ze.Shaders.create({persistence:{frag:Ze.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),qn=29,Gn="sdBitcoin(p)",$n=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:Hn.node,uniforms:{time:e}}),Hn=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Vn=30,Wn="21 millions",Xn=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:Kn.node,uniforms:{time:e,numberInCirculation:18557031}}),Kn=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Yn=31,Qn="alien tower",Zn=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:Jn.node,uniforms:{time:e,numberInCirculation:18557031}}),Jn=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform float numberInCirculation;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),eo=32,to="GoL valley";let ro;const no=({time:e})=>{ro||(ro=e);const t=e-ro,r=Math.floor(12*t);return Object(Qe.jsx)(Ze.Node,{shader:oo.node,uniforms:{time:e,t:Object(Qe.jsx)(bt,{refreshEveryTicks:100,tick:r,size:100})}})},oo=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D t;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),io=33,ao="x(x+32y)%(tN+1)%n";const co=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:so.node,uniforms:{time:e}}),so=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),lo=34,fo="\u230a2cos(x)sin(y+t)\u230b%7";const uo=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:po.node,uniforms:{time:e}}),po=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
#define PI ${Math.PI}
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),vo=35,ho="aie confiance",mo=({time:e})=>Object(Qe.jsx)(Ze.LinearCopy,{children:Object(Qe.jsx)(go,{persistence:.6,children:Object(Qe.jsx)(Ze.Node,{shader:xo.node,uniforms:{time:e}})})}),go=({children:e,persistence:t})=>Object(Qe.jsx)(Ze.Node,{shader:xo.persistence,backbuffering:!0,uniforms:{t:e,back:Ze.Uniform.Backbuffer,persistence:t}}),xo=Ze.Shaders.create({persistence:{frag:Ze.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),bo=36,yo="crois en moi",wo=({time:e})=>Object(Qe.jsx)(Ze.LinearCopy,{children:Object(Qe.jsx)(_o,{children:Object(Qe.jsx)(Ze.Node,{shader:So.node,uniforms:{time:e}})})}),_o=({children:e,persistence:t})=>Object(Qe.jsx)(Ze.Node,{shader:So.persistence,backbuffering:!0,uniforms:{t:e,back:Ze.Uniform.Backbuffer,persistence:t}}),So=Ze.Shaders.create({persistence:{frag:Ze.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Eo=37,Oo="sdBrick",Ro=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:Po.node,uniforms:{time:e}}),Po=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),zo=38,To="Golden mandelbulb",Io=({time:e})=>Object(Qe.jsx)(Ze.LinearCopy,{children:Object(Qe.jsx)(Co,{persistence:.5,children:Object(Qe.jsx)(Ze.Node,{shader:jo.node,uniforms:{time:e}})})}),Co=({children:e,persistence:t})=>Object(Qe.jsx)(Ze.Node,{shader:jo.persistence,backbuffering:!0,uniforms:{t:e,back:Ze.Uniform.Backbuffer,persistence:t}}),jo=Ze.Shaders.create({persistence:{frag:Ze.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  clr /= 4.;
  gl_FragColor = vec4(clr, 1.0);
}`}}),ko=39,Ao="metaballs",Do=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:Lo.node,uniforms:{time:e}}),Lo=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  clr /= 4.;
  gl_FragColor = vec4(clr, 1.0);
}`}}),No=40,Mo="pen-o-plasma",Uo=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:Fo.node,uniforms:{time:e}}),Fo=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(clr, 1.0);
}`}}),Bo=41,qo="reflection",Go=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:$o.node,uniforms:{time:e}}),$o=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Ho=42,Vo="reflection party",Wo=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:Xo.node,uniforms:{time:e}}),Xo=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c = mix(c, reflection(p, n, 10.), glossy);
  gl_FragColor = vec4(c, 1.0);
}`}}),Ko=43,Yo="irreconcilable queens",Qo=({time:e})=>Object(Qe.jsx)(Ze.LinearCopy,{children:Object(Qe.jsx)(Zo,{persistence:.4,children:Object(Qe.jsx)(Ze.Node,{shader:Jo.node,uniforms:{time:e}})})}),Zo=({children:e,persistence:t})=>Object(Qe.jsx)(Ze.Node,{shader:Jo.persistence,backbuffering:!0,uniforms:{t:e,back:Ze.Uniform.Backbuffer,persistence:t}}),Jo=Ze.Shaders.create({persistence:{frag:Ze.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),ei=44,ti="royal meeting",ri=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:ni.node,uniforms:{time:e}}),ni=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
#define PI ${Math.PI}
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),oi=45,ii="wood pawns army",ai=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:ci.node,uniforms:{time:e,wood:"/images/seamless-wood-background-1.jpg"}}),ci=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),si=46,li="Bank of Bicoin",fi=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:ui.node,uniforms:{time:e}}),ui=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),pi=47,di="glow experiment",vi=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:hi.node,uniforms:{time:e}}),hi=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),mi=48,gi="Starry Night",xi=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:bi.node,uniforms:{time:e,img:"/images/seamless-wood2.jpg"}}),bi=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(clr, 1.0);
}`}}),yi=49,wi="chinese lantern",_i=400,Si=0,Ei=20,Oi=24,Ri=1.1,Pi=({time:e})=>Object(Qe.jsx)(Ze.LinearCopy,{children:Object(Qe.jsx)(zi,{persistence:.8,children:Object(Qe.jsx)(Ze.Node,{shader:Ti.node,uniforms:{time:e}})})}),zi=({children:e,persistence:t})=>Object(Qe.jsx)(Ze.Node,{shader:Ti.persistence,backbuffering:!0,uniforms:{t:e,back:Ze.Uniform.Backbuffer,persistence:t}}),Ti=Ze.Shaders.create({persistence:{frag:Ze.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  clr += c;
  gl_FragColor = vec4(clr, 1.0);
}`}}),Ii=50,Ci="jumpy rooks",ji=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:ki.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),ki=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),Ai=51,Di="symmetry chess",Li=400,Ni=0,Mi=20,Ui=24,Fi=1,Bi=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:qi.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),qi=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Gi=52,$i="knights dance",Hi=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:Vi.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),Vi=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),Wi=53,Xi="cross waves",Ki=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:Yi.node,uniforms:{time:e}}),Yi=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  */
}`}}),Qi=54,Zi="chess set",Ji=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:ea.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),ea=Ze.Shaders.create({node:{frag:Ze.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  color = vec4(c, 1.0);
}`}}),ta=55,ra="cube d'or",na=400,oa=0,ia=20,aa=24,ca=1,sa=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:la.node,uniforms:{time:e}}),la=Ze.Shaders.create({node:{frag:Ze.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  #endif
  color = vec4(c, 1.0);
}`}}),fa=56,ua="jade forest",pa=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:da.node,uniforms:{time:e}}),da=Ze.Shaders.create({node:{frag:Ze.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  color = vec4(c, 1.0);
}`}}),va=57,ha="Virus v2",ma=400,ga=0,xa=20,ba=24,ya=.8,wa=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:_a.node,uniforms:{time:e}}),_a=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}});var Sa=r("005v"),Ea=r.n(Sa);const Oa=400,Ra=0,Pa=30,za=20,Ta=1,Ia="5M",Ca=58,ja="Mandelglitch",ka=[{url:"https://ethblock.art/create/17",text:"Mint on ethblock.art"},{url:"https://ghostmarket.io/asset/pha/ghost/3008841254969814369262311336331954453497120774334547905246474374493804042898/",text:"ghostmarket.io: 400 KCAL"},{url:"https://www.hicetnunc.xyz/objkt/3063",text:"hicetnunc.xyz: Mandelglitch #1 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3068",text:"hicetnunc.xyz: Mandelglitch #2 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3071",text:"hicetnunc.xyz: Mandelglitch #3 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3072",text:"hicetnunc.xyz: Mandelglitch #4 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3073",text:"hicetnunc.xyz: Mandelglitch #5 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3077",text:"hicetnunc.xyz: Mandelglitch #6 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3088",text:"hicetnunc.xyz: Mandelglitch #7 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3574",text:"hicetnunc.xyz: Mandelglitch #8 (5 XTZ)"}];const Aa=e=>e<.5?2*e*e:(4-2*e)*e-1;const Da=({time:e,n:t,exporting:r})=>{const n=Object(mt.useMemo)((()=>function(e,t=0){const r=e?3:50,n=new Ea.a(t);return Array(r).fill(null).map((()=>Array(12).fill(null).map((()=>n.random()))))}(r,t)),[t,r]),o=e/10%n.length,i=Math.floor(o),a=o-i;let[c,s,l,f,u,p,d,v,h,m,g,x]=(b=n[i%n.length],y=n[(i+1)%n.length],w=Aa(a),b.map(((e,t)=>e*(1-w)+y[t]*w)));var b,y,w;return l=Aa(l),Object(Qe.jsx)(Ze.LinearCopy,{children:Object(Qe.jsx)(Na,{persistence:r?0:.8,children:Object(Qe.jsx)(Ze.Node,{shader:La.main,uniforms:{aa:r?2:0,time:e,resolution:Ze.Uniform.Resolution,travel:c,love:s,dark:l,rot:r?2*Math.PI/Pa:.1,s1:f,s2:u,s3:p,s4:d,s5:v,s6:h,s7:m,s8:g,s9:x}})})})},La=Ze.Shaders.create({persistence:{frag:Ze.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  `}}),Na=({children:e,persistence:t})=>Object(Qe.jsx)(Ze.Node,{shader:La.persistence,backbuffering:!0,uniforms:{t:e,back:Ze.Uniform.Backbuffer,persistence:t}}),Ma=59,Ua="Pixels 256",Fa="There will be only 256 patterns generated by this single fragment shader.",Ba=({time:e,n:t,exporting:r})=>Object(Qe.jsx)(qa,{n:t+1+(r?0:Math.floor(e))}),qa=gt.a.memo((({n:e})=>{const t=new Ea.a(e%256),r=t.random(),n=t.random(),o=t.random(),i=t.random(),a=t.random(),c=t.random();return Object(Qe.jsx)(Ze.Node,{shader:Ga.node,uniforms:{s1:r,s2:n,s3:o,s4:i,s5:a,s6:c}})})),Ga=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),$a=60,Ha="Bitcoin rainbow",Va=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:Wa.node,uniforms:{time:e}}),Wa=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Xa=61,Ka="Binance gradients",Ya=1,Qa=30,Za=["/images/shaders/binance.dist.png"],Ja=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:ec.node,uniforms:{time:e,image:"/images/shaders/binance.dist.png"}}),ec=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),tc=62,rc="Overgrowth",nc=20,oc=40,ic=1,ac=({generation:e,size:t,n:r})=>Object(Qe.jsx)(Ze.Node,{width:t,height:t,shader:pc.logic,uniforms:{generation:e,prev:Ze.Uniform.Backbuffer,size:t,seed:r/100},backbuffering:!0}),cc=gt.a.memo(ac),sc=({time:e,generation:t,n:r})=>Object(Qe.jsx)(Ze.Node,{shader:pc.render,uniforms:{time:e,logic:Object(Qe.jsx)(cc,{generation:t,size:140,n:r})},uniformsOptions:{logic:{interpolation:"nearest"}}}),lc=gt.a.memo(sc),fc=1e3*Math.random(),uc=({time:e,n:t})=>Object(Qe.jsx)(lc,{n:t+fc,time:e,generation:Math.floor(30*e)},t),pc=Ze.Shaders.create({logic:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
...
`}});var dc=r("AJhG");const vc=63,hc="Relics",mc=400,gc=2,xc=4,bc=20,yc=1,wc="5M",_c={colors:[.7,.55,.4],logicSize:80,amp:1,base:2,persistance:.89,delta:.5,seed:0};console.log(Object.keys(_c).map((e=>String(_c[e]))).join("_"));const Sc=({g:e,size:t,seed:r,amp:n,base:o,persistance:i,delta:a})=>Object(Qe.jsx)(Ze.Node,{width:t,height:t,shader:zc.logic,uniforms:{amp:n,base:o,g:e,prev:Ze.Uniform.Backbuffer,size:t,seed:r,persistance:i,delta:a},backbuffering:!0},t),Ec=gt.a.memo(Sc),Oc=({g:e,colors:t,amp:r,base:n,persistance:o,delta:i,logicSize:a,seed:c})=>Object(Qe.jsx)(Ze.Node,{shader:zc.render,uniforms:{colors:t,logic:Object(Qe.jsx)(Ec,{amp:r,base:n,g:e,size:a,seed:c,persistance:o,delta:i})},uniformsOptions:{logic:{interpolation:"nearest"}}}),Rc=gt.a.memo(Oc),Pc=({time:e})=>{const{colors:t,logicSize:r,amp:n,base:o,persistance:i,delta:a,seed:c}=Object(dc.b)(_c);return Object(Qe.jsx)(Rc,{amp:n,base:o,g:Math.floor(20*e)%40,colors:t,persistance:i,delta:a,seed:c,logicSize:r})},zc=Ze.Shaders.create({logic:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform sampler2D prev;
uniform float g;
...
`}}),Tc=64,Ic="Intersection",Cc=8*Math.PI,jc=[{url:"https://www.hicetnunc.xyz/objkt/28592",text:"hic et nunc NFT"}],kc=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:Ac.render,uniforms:{resolution:Ze.Uniform.Resolution,time:e}}),Ac=Ze.Shaders.create({render:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform vec2 resolution;
...
`}}),Dc=65,Lc="Duality",Nc=800,Mc=4,Uc=8,Fc=30,Bc=1,qc=3,Gc=!0,$c=16,Hc=[{url:"https://hicetnunc.xyz/objkt/64326",text:"hic et nunc NFT"}],Vc=({time:e})=>Object(Qe.jsx)(Ze.NearestCopy,{children:Object(Qe.jsx)(Wc,{persistence:.3,children:Object(Qe.jsx)(Ze.Node,{shader:Xc.render,uniforms:{resolution:Ze.Uniform.Resolution,time:e}})})}),Wc=({children:e,persistence:t})=>Object(Qe.jsx)(Ze.Node,{shader:Xc.persistence,backbuffering:!0,uniforms:{t:e,back:Ze.Uniform.Backbuffer,persistence:t}}),Xc=Ze.Shaders.create({persistence:{frag:Ze.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Kc=66,Yc="hicetnunc",Qc=800,Zc=2,Jc=Zc+8,es=30,ts=1,rs=7,ns=!0,os=16,is=({time:e})=>Object(Qe.jsx)(Ze.NearestCopy,{children:Object(Qe.jsx)(as,{persistence:.5,children:Object(Qe.jsx)(Ze.Node,{shader:cs.render,uniforms:{resolution:Ze.Uniform.Resolution,time:e,freq:2}})})}),as=({children:e,persistence:t})=>Object(Qe.jsx)(Ze.Node,{shader:cs.persistence,backbuffering:!0,uniforms:{t:e,back:Ze.Uniform.Backbuffer,persistence:t}}),cs=Ze.Shaders.create({persistence:{frag:Ze.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),ss=67,ls="Jumping blob",fs=800,us=2,ps=us+8,ds=30,vs=1,hs=7,ms=!0,gs=16,xs=({time:e})=>Object(Qe.jsx)(Ze.NearestCopy,{children:Object(Qe.jsx)(bs,{persistence:.6,children:Object(Qe.jsx)(Ze.Node,{shader:ys.render,uniforms:{resolution:Ze.Uniform.Resolution,time:e,freq:2}})})}),bs=({children:e,persistence:t})=>Object(Qe.jsx)(Ze.Node,{shader:ys.persistence,backbuffering:!0,uniforms:{t:e,back:Ze.Uniform.Backbuffer,persistence:t}}),ys=Ze.Shaders.create({persistence:{frag:Ze.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),ws=68,_s="ring",Ss=800,Es=2,Os=Es+10,Rs=30,Ps=1,zs=7,Ts=!0,Is=128,Cs=({time:e})=>Object(Qe.jsx)(Ze.NearestCopy,{children:Object(Qe.jsx)(js,{persistence:.9,children:Object(Qe.jsx)(Ze.Node,{shader:ks.render,uniforms:{resolution:Ze.Uniform.Resolution,time:e,freq:2}})})}),js=({children:e,persistence:t})=>Object(Qe.jsx)(Ze.Node,{shader:ks.persistence,backbuffering:!0,uniforms:{t:e,back:Ze.Uniform.Backbuffer,persistence:t}}),ks=Ze.Shaders.create({persistence:{frag:Ze.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),As=69,Ds="Bananas paradize",Ls=400,Ns=0,Ms=20,Us=20,Fs=1,Bs=!0,qs=128,Gs=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:$s.node,uniforms:{time:e,resolution:Ze.Uniform.Resolution}}),$s=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),Hs=70,Vs="warp1",Ws=400,Xs=0,Ks=20,Ys=20,Qs=1,Zs=!1,Js=256,el=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:tl.node,uniforms:{time:e,resolution:Ze.Uniform.Resolution}}),tl=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),rl=71,nl="warp2",ol=640,il=0,al=20,cl=24,sl=1,ll=!1,fl=256,ul=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:pl.node,uniforms:{time:e}}),pl=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),dl=72,vl="Planet Hole",hl=640,ml=0,gl=20,xl=24,bl=1,yl=!1,wl=256,_l=[{url:"https://hicetnunc.xyz/objkt/87918",text:"hic et nunc NFT"}],Sl=({time:e,n:t})=>{const r=new Ea.a(t),n=.2+3*r.random()*r.random(),o=.2+10*r.random()*r.random(),i=r.random(),a=[i+.2-.5*r.random(),i+.02-.1*r.random(),i-.02+.1*r.random()];return Object(Qe.jsx)(Ze.Node,{shader:El.node,uniforms:{resolution:Ze.Uniform.Resolution,time:e,a:n,b:o,c:a}})},El=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
...
`}}),Ol=73,Rl="purple square corridor",Pl=640,zl=0,Tl=20,Il=24,Cl=1,jl=!1,kl=256,Al=72e5,Dl=({time:e})=>{const t=Date.now(),r=t/Al-Math.floor(t/Al);return Object(Qe.jsx)(Ze.Node,{shader:Ll.node,uniforms:{resolution:Ze.Uniform.Resolution,time:e+1e3*r,speed:.01,c:[.8,.1,.3]}})},Ll=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
...
`}}),Nl=74,Ml="blue square corridor",Ul=640,Fl=0,Bl=20,ql=24,Gl=1,$l=!1,Hl=256,Vl=72e5,Wl=({time:e})=>{const t=Date.now(),r=t/Vl-Math.floor(t/Vl);return Object(Qe.jsx)(Ze.Node,{shader:Xl.node,uniforms:{resolution:Ze.Uniform.Resolution,time:e+1e3*r,speed:.01,c:[0,.3,.4]}})},Xl=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
...
`}}),Kl=75,Yl="moir\xe9 square smoke",Ql=640,Zl=0,Jl=20,ef=24,tf=1,rf=!1,nf=256,of=36e5,af=({time:e})=>{const t=Date.now(),r=t/of-Math.floor(t/of);return Object(Qe.jsx)(Ze.Node,{shader:cf.node,uniforms:{resolution:Ze.Uniform.Resolution,time:e+1e3*r,speed:.01}})},cf=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
...
`}}),sf=76,lf="Purple",ff=640,uf=0,pf=20,df=24,vf=1,hf=!1,mf=256,gf=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:xf.node,uniforms:{resolution:Ze.Uniform.Resolution,time:e}}),xf=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),bf=77,yf="Roses",wf=512,_f=0,Sf=8,Ef=20,Of=1,Rf=!1,Pf=64,zf=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:Tf.node,uniforms:{resolution:Ze.Uniform.Resolution,time:e}}),Tf=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),If=78,Cf="Nature",jf=512,kf=0,Af=10,Df=16,Lf=1,Nf=!1,Mf=64,Uf=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:Ff.node,uniforms:{resolution:Ze.Uniform.Resolution,time:e}}),Ff=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),Bf=79,qf="Circle",Gf=512,$f=0,Hf=10,Vf=16,Wf=1,Xf=!1,Kf=64,Yf=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:Qf.node,uniforms:{resolution:Ze.Uniform.Resolution,time:e}}),Qf=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),Zf=80,Jf="Morphing Tunnel",eu=512,tu=0,ru=10,nu=16,ou=1,iu=!1,au=64,cu=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:su.node,uniforms:{resolution:Ze.Uniform.Resolution,time:e}}),su=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),lu=81,fu="Red Blue Stripes",uu=512,pu=0,du=10,vu=16,hu=1,mu=!1,gu=64,xu=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:bu.node,uniforms:{resolution:Ze.Uniform.Resolution,time:e}}),bu=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),yu=82,wu="Mountain waves",_u=512,Su=0,Eu=10,Ou=16,Ru=1,Pu=!1,zu=64,Tu=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:Iu.node,uniforms:{resolution:Ze.Uniform.Resolution,time:e}}),Iu=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),Cu=83,ju="Pink Plume",ku=512,Au=0,Du=10,Lu=16,Nu=1,Mu=!1,Uu=64,Fu=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:Bu.node,uniforms:{resolution:Ze.Uniform.Resolution,time:e}}),Bu=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),qu=84,Gu="Flame Waves",$u=512,Hu=0,Vu=10,Wu=16,Xu=1,Ku=!1,Yu=64,Qu=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:Zu.node,uniforms:{resolution:Ze.Uniform.Resolution,time:e}}),Zu=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),Ju=85,ep="Flaming Borders",tp=512,rp=0,np=10,op=16,ip=1,ap=!1,cp=64,sp=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:lp.node,uniforms:{resolution:Ze.Uniform.Resolution,time:e}}),lp=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),fp=86,up="Waves",pp=512,dp=0,vp=10,hp=16,mp=1,gp=!1,xp=64,bp=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:yp.node,uniforms:{resolution:Ze.Uniform.Resolution,time:e}}),yp=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),wp=87,_p="Square Waves",Sp=512,Ep=0,Op=10,Rp=16,Pp=1,zp=!1,Tp=64,Ip=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:Cp.node,uniforms:{resolution:Ze.Uniform.Resolution,time:e}}),Cp=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),jp=88,kp="Unboxing",Ap=512,Dp=0,Lp=10,Np=16,Mp=1,Up=!1,Fp=64,Bp=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:qp.node,uniforms:{resolution:Ze.Uniform.Resolution,time:e}}),qp=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),Gp=89,$p="Creepy",Hp=512,Vp=0,Wp=10,Xp=16,Kp=1,Yp=!1,Qp=64,Zp=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:Jp.node,uniforms:{resolution:Ze.Uniform.Resolution,time:e}}),Jp=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),ed=90,td="Square Path",rd=512,nd=0,od=10,id=16,ad=1,cd=!1,sd=64,ld=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:fd.node,uniforms:{resolution:Ze.Uniform.Resolution,time:e}}),fd=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),ud=91,pd="Door Path",dd=512,vd=0,hd=10,md=16,gd=1,xd=!1,bd=64,yd=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:wd.node,uniforms:{resolution:Ze.Uniform.Resolution,time:e}}),wd=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),_d=92,Sd="Green Cosmos",Ed=512,Od=0,Rd=10,Pd=16,zd=1,Td=!1,Id=64,Cd=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:jd.node,uniforms:{resolution:Ze.Uniform.Resolution,time:e}}),jd=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),kd=93,Ad="Is it alive",Dd=512,Ld=0,Nd=10,Md=16,Ud=1,Fd=!1,Bd=64,qd=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:Gd.node,uniforms:{resolution:Ze.Uniform.Resolution,time:e}}),Gd=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),$d=94,Hd="Sand",Vd=512,Wd=0,Xd=10,Kd=16,Yd=1,Qd=!1,Zd=128,Jd=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:ev.node,uniforms:{resolution:Ze.Uniform.Resolution,time:e}}),ev=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),tv=95,rv="Diamond Dream",nv=512,ov=0,iv=10,av=16,cv=1,sv=!1,lv=128,fv=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:uv.node,uniforms:{resolution:Ze.Uniform.Resolution,time:e}}),uv=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),pv=96,dv="Blue Brain",vv=512,hv=0,mv=10,gv=16,xv=1,bv=!1,yv=128,wv=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:_v.node,uniforms:{resolution:Ze.Uniform.Resolution,time:e}}),_v=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),Sv=97,Ev="Blue Yellow Storm",Ov=512,Rv=0,Pv=10,zv=16,Tv=1,Iv=!1,Cv=128,jv=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:kv.node,uniforms:{resolution:Ze.Uniform.Resolution,time:e}}),kv=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),Av=98,Dv="Crossing",Lv=512,Nv=0,Mv=10,Uv=16,Fv=1,Bv=!1,qv=64,Gv=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:$v.node,uniforms:{resolution:Ze.Uniform.Resolution,time:e}}),$v=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),Hv=99,Vv="Wave fire storm",Wv=512,Xv=0,Kv=10,Yv=16,Qv=1,Zv=!1,Jv=64,eh=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:th.node,uniforms:{resolution:Ze.Uniform.Resolution,time:e}}),th=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),rh=100,nh="Cloud tunnel",oh=512,ih=0,ah=10,ch=16,sh=1,lh=!1,fh=64,uh=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:ph.node,uniforms:{resolution:Ze.Uniform.Resolution,time:e}}),ph=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),dh=101,vh="Scale cloud",hh=512,mh=0,gh=10,xh=16,bh=1,yh=!1,wh=64,_h=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:Sh.node,uniforms:{resolution:Ze.Uniform.Resolution,time:e}}),Sh=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),Eh=102,Oh="Pinky green cloud",Rh=512,Ph=0,zh=10,Th=16,Ih=1,Ch=!1,jh=64,kh=({time:e})=>Object(Qe.jsx)(Ze.Node,{shader:Ah.node,uniforms:{resolution:Ze.Uniform.Resolution,time:e}}),Ah=Ze.Shaders.create({node:{frag:Ze.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;

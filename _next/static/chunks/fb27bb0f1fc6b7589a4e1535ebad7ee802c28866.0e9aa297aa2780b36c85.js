...
}`}}),ye=2,be="stripes",xe=400,we=0,_e=60,Ee=24,Se=1,Oe=({time:e})=>Object(pe.jsx)(de.Node,{shader:Re.node,uniforms:{time:e}}),Re=de.Shaders.create({node:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),Te=3,ze="zephyr",Ce=({time:e})=>Object(pe.jsx)(de.Node,{shader:Pe.node,uniforms:{time:e}}),Pe=de.Shaders.create({node:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}});var Ie=r("q1tI"),je=r.n(Ie);const Ae=de.Shaders.create({InitGameOfLife:{frag:de.GLSL`
  precision highp float;
  uniform float seed;
  // i
  varying vec2 uv;
  ...
  }`}}),ke=je.a.memo((({tick:e,size:t,refreshEveryTicks:r})=>e%(r||1/0)===0?Object(pe.jsx)(de.Node,{shader:Ae.InitGameOfLife,uniforms:{seed:Math.random()},width:t,height:t,backbuffering:!0,sync:!0}):Object(pe.jsx)(de.Node,{shader:Ae.GameOfLife,width:t,height:t,backbuffering:!0,sync:!0,uniforms:{t:de.Uniform.Backbuffer,size:t}}))),De=4,Le="Ray of Life";let Ne;const Me=({time:e})=>{Ne||(Ne=e);const t=e-Ne,r=Math.floor(10*t),n=r+25,o=10*(1+Math.floor(r/50)),i=10*(1+Math.floor(n/50));return Object(pe.jsx)(Ue,{time:e,a:Object(pe.jsx)(de.NearestCopy,{children:Object(pe.jsx)(ke,{refreshEveryTicks:50,tick:r,size:o})}),b:Object(pe.jsx)(de.NearestCopy,{children:Object(pe.jsx)(ke,{refreshEveryTicks:50,tick:n,size:i})})})},Ue=({a:e,b:t,time:r})=>Object(pe.jsx)(de.Node,{uniforms:{a:e,b:t,time:r},shader:Be.main}),Be=de.Shaders.create({main:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Fe=5,qe="Here We Go Again",$e=({time:e})=>Object(pe.jsx)(de.Node,{shader:Ge.node,uniforms:{time:e}}),Ge=de.Shaders.create({node:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    sqrt(vec3(1. - shad));
  gl_FragColor = vec4(c,1.0);
}`}}),He=6,Ve="Bestagons",We=({time:e})=>Object(pe.jsx)(de.Node,{shader:Xe.node,uniforms:{time:e}}),Xe=de.Shaders.create({node:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),Ke=7,Ye="Worms party",Qe=({time:e})=>Object(pe.jsx)(de.Node,{shader:Ze.node,uniforms:{time:e}}),Ze=de.Shaders.create({node:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    sqrt(vec3(1. - shad));
  gl_FragColor = vec4(c,1.0);
}`}}),Je=8,et="moontains",tt=({time:e})=>Object(pe.jsx)(de.Node,{shader:rt.node,uniforms:{time:e}}),rt=de.Shaders.create({node:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),nt=9,ot="Virus",it=400,at=16.3,st=26,ct=24,lt=.8,ft=({time:e})=>Object(pe.jsx)(de.Node,{shader:ut.node,uniforms:{time:e}}),ut=de.Shaders.create({node:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),pt=10,dt="ring",ht=({time:e})=>Object(pe.jsx)(de.Node,{shader:vt.node,uniforms:{time:e}}),vt=de.Shaders.create({node:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),mt=11,gt="magic mouse",yt=({time:e})=>Object(pe.jsx)(de.Node,{shader:bt.node,uniforms:{time:e}}),bt=de.Shaders.create({node:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),xt=12,wt="floor is lava",_t=({time:e})=>Object(pe.jsx)(de.Node,{shader:Et.node,uniforms:{time:e}}),Et=de.Shaders.create({node:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),St=13,Ot="chip",Rt=({time:e})=>Object(pe.jsx)(de.Node,{shader:Tt.node,uniforms:{time:e}}),Tt=de.Shaders.create({node:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
`}}),zt=14,Ct="seizure",Pt=({time:e})=>Object(pe.jsx)(de.Node,{shader:It.node,uniforms:{time:e}}),It=de.Shaders.create({node:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),jt=de.Shaders.create({blur1D:{frag:de.GLSL`precision highp float;
varying vec2 uv;
uniform sampler2D t;
...
}`}});var At=({width:e,height:t,pixelRatio:r,direction:n,children:o})=>Object(pe.jsx)(de.Node,{shader:jt.blur1D,width:e,height:t,pixelRatio:r,uniforms:{direction:n,resolution:de.Uniform.Resolution,t:o}});const kt=Math.sqrt(2)/2;var Dt=(e,t,r)=>{const n=2*t*Math.ceil(e/2)/r;switch((e-1)%4){case 0:return[n,0];case 1:return[0,n];case 2:return[n*kt,n*kt];case 3:return[n*kt,-n*kt]}};const Lt=({width:e,height:t,pixelRatio:r,factor:n,children:o,passes:i,directionForPass:a})=>{const s=c=>c<=0?o:Object(pe.jsx)(At,{width:e,height:t,pixelRatio:r,direction:a(c,n,i),children:s(c-1)});return s(i)};Lt.defaultProps={passes:2,directionForPass:Dt};var Nt=Lt;const Mt=de.Shaders.create({blur1D:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
...
}`}});var Ut=({width:e,height:t,map:r,pixelRatio:n,direction:o,children:i})=>Object(pe.jsx)(de.Node,{shader:Mt.blur1D,width:e,height:t,pixelRatio:n,uniforms:{direction:o,resolution:de.Uniform.Resolution,t:i,map:r}});const Bt=({width:e,height:t,map:r,pixelRatio:n,factor:o,children:i,passes:a,directionForPass:s})=>{const c=l=>l<=0?i:Object(pe.jsx)(Ut,{width:e,height:t,map:r,pixelRatio:n,direction:s(l,o,a),children:c(l-1)});return c(a)};Bt.defaultProps={passes:2,directionForPass:Dt};const Ft=15,qt="parametric",$t=({time:e})=>Object(pe.jsx)(de.LinearCopy,{children:Object(pe.jsx)(Ht,{persistence:.98+.02*Math.cos(e)+-.8*Math.exp(-e),children:Object(pe.jsx)(Nt,{passes:4,factor:.2,children:Object(pe.jsx)(Gt,{time:e})})})}),Gt=({time:e})=>Object(pe.jsx)(de.Node,{shader:Vt.node,uniforms:{time:e}}),Ht=({children:e,persistence:t})=>Object(pe.jsx)(de.Node,{shader:Vt.persistence,backbuffering:!0,uniforms:{t:e,back:de.Uniform.Backbuffer,persistence:t}}),Vt=de.Shaders.create({persistence:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),Wt=16,Xt="reuleaux",Kt=({time:e})=>Object(pe.jsx)(de.Node,{shader:Yt.node,uniforms:{time:e}}),Yt=de.Shaders.create({node:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    color(0.5 * time);
  gl_FragColor = vec4(c, 1.0);
}`}}),Qt=17,Zt="screws",Jt=({time:e})=>Object(pe.jsx)(de.Node,{shader:er.node,uniforms:{time:e}}),er=de.Shaders.create({node:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),tr=18,rr="queen",nr=({time:e})=>Object(pe.jsx)(de.Node,{shader:or.node,uniforms:{time:e}}),or=de.Shaders.create({node:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
}`}}),ir=19,ar="they were six",sr=({time:e})=>Object(pe.jsx)(de.Node,{shader:cr.node,uniforms:{time:e}}),cr=de.Shaders.create({node:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),lr=20,fr="trippy tiles",ur=({time:e})=>Object(pe.jsx)(de.LinearCopy,{children:Object(pe.jsx)(pr,{persistence:.85,children:Object(pe.jsx)(de.Node,{shader:dr.node,uniforms:{time:e}})})}),pr=({children:e,persistence:t})=>Object(pe.jsx)(de.Node,{shader:dr.persistence,backbuffering:!0,uniforms:{t:e,back:de.Uniform.Backbuffer,persistence:t}}),dr=de.Shaders.create({persistence:{frag:de.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),hr=21,vr="HODL",mr=({time:e})=>Object(pe.jsx)(de.LinearCopy,{children:Object(pe.jsx)(gr,{persistence:Math.min(.99,.015*e),time:e,children:Object(pe.jsx)(de.Node,{shader:yr.node,uniforms:{time:e}})})}),gr=({children:e,persistence:t,time:r})=>Object(pe.jsx)(de.Node,{shader:yr.shakePersistence,backbuffering:!0,uniforms:{t:e,back:de.Uniform.Backbuffer,persistence:t,time:r}}),yr=de.Shaders.create({shakePersistence:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform sampler2D t, back;
uniform float time;
...
}`}}),br=22,xr="atoms",wr=({time:e})=>Object(pe.jsx)(de.Node,{shader:_r.node,uniforms:{time:e,t:"/images/einstein-tongue-out.jpg"}}),_r=de.Shaders.create({node:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D t;
...
void main() {
...
}`}}),Er=23,Sr="Hexacubes",Or=({time:e})=>Object(pe.jsx)(de.Node,{shader:Rr.node,uniforms:{time:e}}),Rr=de.Shaders.create({node:{frag:de.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform float time;
  const float PI = ${Math.PI};
  ...
  void main() {
    ...
    gl_FragColor = vec4(c, 1.0);
      ...
      `}}),Tr=24,zr="dark cubes",Cr=({time:e})=>Object(pe.jsx)(de.Node,{shader:Pr.node,uniforms:{time:e}}),Pr=de.Shaders.create({node:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),Ir=25,jr="Mandelbrot",Ar=({time:e})=>Object(pe.jsx)(de.LinearCopy,{children:Object(pe.jsx)(kr,{persistence:.9,children:Object(pe.jsx)(Nt,{passes:4,factor:.1,children:Object(pe.jsx)(de.Node,{shader:Dr.node,uniforms:{time:e}})})})}),kr=({children:e,persistence:t})=>Object(pe.jsx)(de.Node,{shader:Dr.persistence,backbuffering:!0,uniforms:{t:e,back:de.Uniform.Backbuffer,persistence:t}}),Dr=de.Shaders.create({persistence:{frag:de.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Lr=26,Nr="fumes",Mr=({time:e})=>Object(pe.jsx)(de.LinearCopy,{children:Object(pe.jsx)(Ur,{persistence:.9,children:Object(pe.jsx)(Nt,{passes:4,factor:Math.min(.6,.01*e),children:Object(pe.jsx)(de.Node,{shader:Br.node,uniforms:{time:e}})})})}),Ur=({children:e,persistence:t})=>Object(pe.jsx)(de.Node,{shader:Br.persistence,backbuffering:!0,uniforms:{t:e,back:de.Uniform.Backbuffer,persistence:t}}),Br=de.Shaders.create({persistence:{frag:de.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Fr=27,qr="real burning ship",$r=400,Gr=0,Hr=60,Vr=12,Wr=2,Xr=({time:e})=>Object(pe.jsx)(de.LinearCopy,{children:Object(pe.jsx)(Kr,{persistence:.8+.05*Math.random(),time:e,children:Object(pe.jsx)(de.Node,{shader:Yr.node,uniforms:{time:e}})})}),Kr=({children:e,persistence:t,time:r})=>Object(pe.jsx)(de.Node,{shader:Yr.persistence,backbuffering:!0,uniforms:{t:e,back:de.Uniform.Backbuffer,persistence:t,time:r}}),Yr=de.Shaders.create({persistence:{frag:de.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Qr=28,Zr="No, I'M Batman",Jr=({time:e})=>Object(pe.jsx)(de.LinearCopy,{children:Object(pe.jsx)(en,{persistence:.5+.48*Math.min(1,e/60),children:Object(pe.jsx)(de.Node,{shader:tn.node,uniforms:{time:e}})})}),en=({children:e,persistence:t})=>Object(pe.jsx)(de.Node,{shader:tn.persistence,backbuffering:!0,uniforms:{t:e,back:de.Uniform.Backbuffer,persistence:t}}),tn=de.Shaders.create({persistence:{frag:de.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),rn=29,nn="sdBitcoin(p)",on=({time:e})=>Object(pe.jsx)(de.Node,{shader:an.node,uniforms:{time:e}}),an=de.Shaders.create({node:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),sn=30,cn="21 millions",ln=({time:e})=>Object(pe.jsx)(de.Node,{shader:fn.node,uniforms:{time:e,numberInCirculation:18557031}}),fn=de.Shaders.create({node:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),un=31,pn="alien tower",dn=({time:e})=>Object(pe.jsx)(de.Node,{shader:hn.node,uniforms:{time:e,numberInCirculation:18557031}}),hn=de.Shaders.create({node:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform float numberInCirculation;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),vn=32,mn="GoL valley";let gn;const yn=({time:e})=>{gn||(gn=e);const t=e-gn,r=Math.floor(12*t);return Object(pe.jsx)(de.Node,{shader:bn.node,uniforms:{time:e,t:Object(pe.jsx)(ke,{refreshEveryTicks:100,tick:r,size:100})}})},bn=de.Shaders.create({node:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D t;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),xn=33,wn="x(x+32y)%(tN+1)%n";const _n=({time:e})=>Object(pe.jsx)(de.Node,{shader:En.node,uniforms:{time:e}}),En=de.Shaders.create({node:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Sn=34,On="\u230a2cos(x)sin(y+t)\u230b%7";const Rn=({time:e})=>Object(pe.jsx)(de.Node,{shader:Tn.node,uniforms:{time:e}}),Tn=de.Shaders.create({node:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
#define PI ${Math.PI}
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),zn=35,Cn="aie confiance",Pn=({time:e})=>Object(pe.jsx)(de.LinearCopy,{children:Object(pe.jsx)(In,{persistence:.6,children:Object(pe.jsx)(de.Node,{shader:jn.node,uniforms:{time:e}})})}),In=({children:e,persistence:t})=>Object(pe.jsx)(de.Node,{shader:jn.persistence,backbuffering:!0,uniforms:{t:e,back:de.Uniform.Backbuffer,persistence:t}}),jn=de.Shaders.create({persistence:{frag:de.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),An=36,kn="crois en moi",Dn=({time:e})=>Object(pe.jsx)(de.LinearCopy,{children:Object(pe.jsx)(Ln,{children:Object(pe.jsx)(de.Node,{shader:Nn.node,uniforms:{time:e}})})}),Ln=({children:e,persistence:t})=>Object(pe.jsx)(de.Node,{shader:Nn.persistence,backbuffering:!0,uniforms:{t:e,back:de.Uniform.Backbuffer,persistence:t}}),Nn=de.Shaders.create({persistence:{frag:de.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Mn=37,Un="sdBrick",Bn=({time:e})=>Object(pe.jsx)(de.Node,{shader:Fn.node,uniforms:{time:e}}),Fn=de.Shaders.create({node:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),qn=38,$n="Golden mandelbulb",Gn=({time:e})=>Object(pe.jsx)(de.LinearCopy,{children:Object(pe.jsx)(Hn,{persistence:.5,children:Object(pe.jsx)(de.Node,{shader:Vn.node,uniforms:{time:e}})})}),Hn=({children:e,persistence:t})=>Object(pe.jsx)(de.Node,{shader:Vn.persistence,backbuffering:!0,uniforms:{t:e,back:de.Uniform.Backbuffer,persistence:t}}),Vn=de.Shaders.create({persistence:{frag:de.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  clr /= 4.;
  gl_FragColor = vec4(clr, 1.0);
}`}}),Wn=39,Xn="metaballs",Kn=({time:e})=>Object(pe.jsx)(de.Node,{shader:Yn.node,uniforms:{time:e}}),Yn=de.Shaders.create({node:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  clr /= 4.;
  gl_FragColor = vec4(clr, 1.0);
}`}}),Qn=40,Zn="pen-o-plasma",Jn=({time:e})=>Object(pe.jsx)(de.Node,{shader:eo.node,uniforms:{time:e}}),eo=de.Shaders.create({node:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(clr, 1.0);
}`}}),to=41,ro="reflection",no=({time:e})=>Object(pe.jsx)(de.Node,{shader:oo.node,uniforms:{time:e}}),oo=de.Shaders.create({node:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),io=42,ao="reflection party",so=({time:e})=>Object(pe.jsx)(de.Node,{shader:co.node,uniforms:{time:e}}),co=de.Shaders.create({node:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c = mix(c, reflection(p, n, 10.), glossy);
  gl_FragColor = vec4(c, 1.0);
}`}}),lo=43,fo="irreconcilable queens",uo=({time:e})=>Object(pe.jsx)(de.LinearCopy,{children:Object(pe.jsx)(po,{persistence:.4,children:Object(pe.jsx)(de.Node,{shader:ho.node,uniforms:{time:e}})})}),po=({children:e,persistence:t})=>Object(pe.jsx)(de.Node,{shader:ho.persistence,backbuffering:!0,uniforms:{t:e,back:de.Uniform.Backbuffer,persistence:t}}),ho=de.Shaders.create({persistence:{frag:de.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),vo=44,mo="royal meeting",go=({time:e})=>Object(pe.jsx)(de.Node,{shader:yo.node,uniforms:{time:e}}),yo=de.Shaders.create({node:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
#define PI ${Math.PI}
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),bo=45,xo="wood pawns army",wo=({time:e})=>Object(pe.jsx)(de.Node,{shader:_o.node,uniforms:{time:e,wood:"/images/seamless-wood-background-1.jpg"}}),_o=de.Shaders.create({node:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),Eo=46,So="Bank of Bicoin",Oo=({time:e})=>Object(pe.jsx)(de.Node,{shader:Ro.node,uniforms:{time:e}}),Ro=de.Shaders.create({node:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),To=47,zo="glow experiment",Co=({time:e})=>Object(pe.jsx)(de.Node,{shader:Po.node,uniforms:{time:e}}),Po=de.Shaders.create({node:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Io=48,jo="Starry Night",Ao=({time:e})=>Object(pe.jsx)(de.Node,{shader:ko.node,uniforms:{time:e,img:"/images/seamless-wood2.jpg"}}),ko=de.Shaders.create({node:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(clr, 1.0);
}`}}),Do=49,Lo="chinese lantern",No=400,Mo=0,Uo=20,Bo=24,Fo=1.1,qo=({time:e})=>Object(pe.jsx)(de.LinearCopy,{children:Object(pe.jsx)($o,{persistence:.8,children:Object(pe.jsx)(de.Node,{shader:Go.node,uniforms:{time:e}})})}),$o=({children:e,persistence:t})=>Object(pe.jsx)(de.Node,{shader:Go.persistence,backbuffering:!0,uniforms:{t:e,back:de.Uniform.Backbuffer,persistence:t}}),Go=de.Shaders.create({persistence:{frag:de.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  clr += c;
  gl_FragColor = vec4(clr, 1.0);
}`}}),Ho=50,Vo="jumpy rooks",Wo=({time:e})=>Object(pe.jsx)(de.Node,{shader:Xo.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),Xo=de.Shaders.create({node:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),Ko=51,Yo="symmetry chess",Qo=400,Zo=0,Jo=20,ei=24,ti=1,ri=({time:e})=>Object(pe.jsx)(de.Node,{shader:ni.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),ni=de.Shaders.create({node:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),oi=52,ii="knights dance",ai=({time:e})=>Object(pe.jsx)(de.Node,{shader:si.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),si=de.Shaders.create({node:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),ci=53,li="cross waves",fi=({time:e})=>Object(pe.jsx)(de.Node,{shader:ui.node,uniforms:{time:e}}),ui=de.Shaders.create({node:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  */
}`}}),pi=54,di="chess set",hi=({time:e})=>Object(pe.jsx)(de.Node,{shader:vi.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),vi=de.Shaders.create({node:{frag:de.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  color = vec4(c, 1.0);
}`}}),mi=55,gi="cube d'or",yi=400,bi=0,xi=20,wi=24,_i=1,Ei=({time:e})=>Object(pe.jsx)(de.Node,{shader:Si.node,uniforms:{time:e}}),Si=de.Shaders.create({node:{frag:de.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  #endif
  color = vec4(c, 1.0);
}`}}),Oi=56,Ri="jade forest",Ti=({time:e})=>Object(pe.jsx)(de.Node,{shader:zi.node,uniforms:{time:e}}),zi=de.Shaders.create({node:{frag:de.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  color = vec4(c, 1.0);
}`}}),Ci=57,Pi="Virus v2",Ii=400,ji=0,Ai=20,ki=24,Di=.8,Li=({time:e})=>Object(pe.jsx)(de.Node,{shader:Ni.node,uniforms:{time:e}}),Ni=de.Shaders.create({node:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}});var Mi=r("005v"),Ui=r.n(Mi);const Bi=400,Fi=0,qi=30,$i=20,Gi=1,Hi="5M",Vi=58,Wi="Mandelglitch",Xi=[{url:"https://ethblock.art/create/17",text:"Mint on ethblock.art"},{url:"https://ghostmarket.io/asset/pha/ghost/3008841254969814369262311336331954453497120774334547905246474374493804042898/",text:"ghostmarket.io: 400 KCAL"},{url:"https://www.hicetnunc.xyz/objkt/3063",text:"hicetnunc.xyz: Mandelglitch #1 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3068",text:"hicetnunc.xyz: Mandelglitch #2 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3071",text:"hicetnunc.xyz: Mandelglitch #3 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3072",text:"hicetnunc.xyz: Mandelglitch #4 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3073",text:"hicetnunc.xyz: Mandelglitch #5 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3077",text:"hicetnunc.xyz: Mandelglitch #6 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3088",text:"hicetnunc.xyz: Mandelglitch #7 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3574",text:"hicetnunc.xyz: Mandelglitch #8 (5 XTZ)"}];const Ki=e=>e<.5?2*e*e:(4-2*e)*e-1;const Yi=({time:e,n:t,exporting:r})=>{const n=Object(Ie.useMemo)((()=>function(e,t=0){const r=e?3:50,n=new Ui.a(t);return Array(r).fill(null).map((()=>Array(12).fill(null).map((()=>n.random()))))}(r,t)),[t,r]),o=e/10%n.length,i=Math.floor(o),a=o-i;let[s,c,l,f,u,p,d,h,v,m,g,y]=(b=n[i%n.length],x=n[(i+1)%n.length],w=Ki(a),b.map(((e,t)=>e*(1-w)+x[t]*w)));var b,x,w;return l=Ki(l),Object(pe.jsx)(de.LinearCopy,{children:Object(pe.jsx)(Zi,{persistence:r?0:.8,children:Object(pe.jsx)(de.Node,{shader:Qi.main,uniforms:{aa:r?2:0,time:e,resolution:de.Uniform.Resolution,travel:s,love:c,dark:l,rot:r?2*Math.PI/qi:.1,s1:f,s2:u,s3:p,s4:d,s5:h,s6:v,s7:m,s8:g,s9:y}})})})},Qi=de.Shaders.create({persistence:{frag:de.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  `}}),Zi=({children:e,persistence:t})=>Object(pe.jsx)(de.Node,{shader:Qi.persistence,backbuffering:!0,uniforms:{t:e,back:de.Uniform.Backbuffer,persistence:t}}),Ji=59,ea="Pixels 256",ta="There will be only 256 patterns generated by this single fragment shader.",ra=({time:e,n:t,exporting:r})=>Object(pe.jsx)(na,{n:t+1+(r?0:Math.floor(e))}),na=je.a.memo((({n:e})=>{const t=new Ui.a(e%256),r=t.random(),n=t.random(),o=t.random(),i=t.random(),a=t.random(),s=t.random();return Object(pe.jsx)(de.Node,{shader:oa.node,uniforms:{s1:r,s2:n,s3:o,s4:i,s5:a,s6:s}})})),oa=de.Shaders.create({node:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),ia=60,aa="Bitcoin rainbow",sa=({time:e})=>Object(pe.jsx)(de.Node,{shader:ca.node,uniforms:{time:e}}),ca=de.Shaders.create({node:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),la=61,fa="Binance gradients",ua=1,pa=30,da=["/images/shaders/binance.dist.png"],ha=({time:e})=>Object(pe.jsx)(de.Node,{shader:va.node,uniforms:{time:e,image:"/images/shaders/binance.dist.png"}}),va=de.Shaders.create({node:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}});var za=r("AJhG");const Ca=63,Pa="Relics",Ia=400,ja=2,Aa=4,ka=20,Da=1,La="5M",Na={colors:[.7,.55,.4],logicSize:80,amp:1,base:2,persistance:.89,delta:.5,seed:0};console.log(Object.keys(Na).map((e=>String(Na[e]))).join("_"));const Ma=({g:e,size:t,seed:r,amp:n,base:o,persistance:i,delta:a})=>Object(pe.jsx)(de.Node,{width:t,height:t,shader:$a.logic,uniforms:{amp:n,base:o,g:e,prev:de.Uniform.Backbuffer,size:t,seed:r,persistance:i,delta:a},backbuffering:!0},t),Ua=je.a.memo(Ma),Ba=({g:e,colors:t,amp:r,base:n,persistance:o,delta:i,logicSize:a,seed:s})=>Object(pe.jsx)(de.Node,{shader:$a.render,uniforms:{colors:t,logic:Object(pe.jsx)(Ua,{amp:r,base:n,g:e,size:a,seed:s,persistance:o,delta:i})},uniformsOptions:{logic:{interpolation:"nearest"}}}),Fa=je.a.memo(Ba),qa=({time:e})=>{const{colors:t,logicSize:r,amp:n,base:o,persistance:i,delta:a,seed:s}=Object(za.b)(Na);return Object(pe.jsx)(Fa,{amp:n,base:o,g:Math.floor(20*e)%40,colors:t,persistance:i,delta:a,seed:s,logicSize:r})},$a=de.Shaders.create({logic:{frag:de.GLSL`
precision highp float;
varying vec2 uv;
uniform sampler2D prev;
uniform float g;

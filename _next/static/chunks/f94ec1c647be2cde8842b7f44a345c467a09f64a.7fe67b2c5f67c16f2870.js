...
}`}}),Ke=2,Ye="stripes",Qe=400,Ze=0,Je=60,et=24,tt=1,rt=({time:e})=>Object($e.jsx)(Ge.Node,{shader:nt.node,uniforms:{time:e}}),nt=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),ot=3,it="zephyr",at=({time:e})=>Object($e.jsx)(Ge.Node,{shader:ct.node,uniforms:{time:e}}),ct=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}});var st=r("q1tI"),lt=r.n(st);const ft=Ge.Shaders.create({InitGameOfLife:{frag:Ge.GLSL`
  precision highp float;
  uniform float seed;
  // i
  varying vec2 uv;
  ...
  }`}}),ut=lt.a.memo((({tick:e,size:t,refreshEveryTicks:r})=>e%(r||1/0)===0?Object($e.jsx)(Ge.Node,{shader:ft.InitGameOfLife,uniforms:{seed:Math.random()},width:t,height:t,backbuffering:!0,sync:!0}):Object($e.jsx)(Ge.Node,{shader:ft.GameOfLife,width:t,height:t,backbuffering:!0,sync:!0,uniforms:{t:Ge.Uniform.Backbuffer,size:t}}))),pt=4,dt="Ray of Life";let vt;const ht=({time:e})=>{vt||(vt=e);const t=e-vt,r=Math.floor(10*t),n=r+25,o=10*(1+Math.floor(r/50)),i=10*(1+Math.floor(n/50));return Object($e.jsx)(mt,{time:e,a:Object($e.jsx)(Ge.NearestCopy,{children:Object($e.jsx)(ut,{refreshEveryTicks:50,tick:r,size:o})}),b:Object($e.jsx)(Ge.NearestCopy,{children:Object($e.jsx)(ut,{refreshEveryTicks:50,tick:n,size:i})})})},mt=({a:e,b:t,time:r})=>Object($e.jsx)(Ge.Node,{uniforms:{a:e,b:t,time:r},shader:gt.main}),gt=Ge.Shaders.create({main:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),bt=5,xt="Here We Go Again",yt=({time:e})=>Object($e.jsx)(Ge.Node,{shader:wt.node,uniforms:{time:e}}),wt=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    sqrt(vec3(1. - shad));
  gl_FragColor = vec4(c,1.0);
}`}}),_t=6,St="Bestagons",Et=({time:e})=>Object($e.jsx)(Ge.Node,{shader:Ot.node,uniforms:{time:e}}),Ot=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),Rt=7,zt="Worms party",Pt=({time:e})=>Object($e.jsx)(Ge.Node,{shader:Tt.node,uniforms:{time:e}}),Tt=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    sqrt(vec3(1. - shad));
  gl_FragColor = vec4(c,1.0);
}`}}),It=8,Ct="moontains",jt=({time:e})=>Object($e.jsx)(Ge.Node,{shader:kt.node,uniforms:{time:e}}),kt=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),At=9,Dt="Virus",Lt=400,Nt=16.3,Mt=26,Ut=24,Ft=.8,Bt=({time:e})=>Object($e.jsx)(Ge.Node,{shader:qt.node,uniforms:{time:e}}),qt=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),$t=10,Gt="ring",Ht=({time:e})=>Object($e.jsx)(Ge.Node,{shader:Vt.node,uniforms:{time:e}}),Vt=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Wt=11,Xt="magic mouse",Kt=({time:e})=>Object($e.jsx)(Ge.Node,{shader:Yt.node,uniforms:{time:e}}),Yt=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Qt=12,Zt="floor is lava",Jt=({time:e})=>Object($e.jsx)(Ge.Node,{shader:er.node,uniforms:{time:e}}),er=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),tr=13,rr="chip",nr=({time:e})=>Object($e.jsx)(Ge.Node,{shader:or.node,uniforms:{time:e}}),or=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
`}}),ir=14,ar="seizure",cr=({time:e})=>Object($e.jsx)(Ge.Node,{shader:sr.node,uniforms:{time:e}}),sr=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),lr=Ge.Shaders.create({blur1D:{frag:Ge.GLSL`precision highp float;
varying vec2 uv;
uniform sampler2D t;
...
}`}});var fr=({width:e,height:t,pixelRatio:r,direction:n,children:o})=>Object($e.jsx)(Ge.Node,{shader:lr.blur1D,width:e,height:t,pixelRatio:r,uniforms:{direction:n,resolution:Ge.Uniform.Resolution,t:o}});const ur=Math.sqrt(2)/2;var pr=(e,t,r)=>{const n=2*t*Math.ceil(e/2)/r;switch((e-1)%4){case 0:return[n,0];case 1:return[0,n];case 2:return[n*ur,n*ur];case 3:return[n*ur,-n*ur]}};const dr=({width:e,height:t,pixelRatio:r,factor:n,children:o,passes:i,directionForPass:a})=>{const c=s=>s<=0?o:Object($e.jsx)(fr,{width:e,height:t,pixelRatio:r,direction:a(s,n,i),children:c(s-1)});return c(i)};dr.defaultProps={passes:2,directionForPass:pr};var vr=dr;const hr=Ge.Shaders.create({blur1D:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
...
}`}});var mr=({width:e,height:t,map:r,pixelRatio:n,direction:o,children:i})=>Object($e.jsx)(Ge.Node,{shader:hr.blur1D,width:e,height:t,pixelRatio:n,uniforms:{direction:o,resolution:Ge.Uniform.Resolution,t:i,map:r}});const gr=({width:e,height:t,map:r,pixelRatio:n,factor:o,children:i,passes:a,directionForPass:c})=>{const s=l=>l<=0?i:Object($e.jsx)(mr,{width:e,height:t,map:r,pixelRatio:n,direction:c(l,o,a),children:s(l-1)});return s(a)};gr.defaultProps={passes:2,directionForPass:pr};const br=15,xr="parametric",yr=({time:e})=>Object($e.jsx)(Ge.LinearCopy,{children:Object($e.jsx)(_r,{persistence:.98+.02*Math.cos(e)+-.8*Math.exp(-e),children:Object($e.jsx)(vr,{passes:4,factor:.2,children:Object($e.jsx)(wr,{time:e})})})}),wr=({time:e})=>Object($e.jsx)(Ge.Node,{shader:Sr.node,uniforms:{time:e}}),_r=({children:e,persistence:t})=>Object($e.jsx)(Ge.Node,{shader:Sr.persistence,backbuffering:!0,uniforms:{t:e,back:Ge.Uniform.Backbuffer,persistence:t}}),Sr=Ge.Shaders.create({persistence:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),Er=16,Or="reuleaux",Rr=({time:e})=>Object($e.jsx)(Ge.Node,{shader:zr.node,uniforms:{time:e}}),zr=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    color(0.5 * time);
  gl_FragColor = vec4(c, 1.0);
}`}}),Pr=17,Tr="screws",Ir=({time:e})=>Object($e.jsx)(Ge.Node,{shader:Cr.node,uniforms:{time:e}}),Cr=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),jr=18,kr="queen",Ar=({time:e})=>Object($e.jsx)(Ge.Node,{shader:Dr.node,uniforms:{time:e}}),Dr=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
}`}}),Lr=19,Nr="they were six",Mr=({time:e})=>Object($e.jsx)(Ge.Node,{shader:Ur.node,uniforms:{time:e}}),Ur=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Fr=20,Br="trippy tiles",qr=({time:e})=>Object($e.jsx)(Ge.LinearCopy,{children:Object($e.jsx)($r,{persistence:.85,children:Object($e.jsx)(Ge.Node,{shader:Gr.node,uniforms:{time:e}})})}),$r=({children:e,persistence:t})=>Object($e.jsx)(Ge.Node,{shader:Gr.persistence,backbuffering:!0,uniforms:{t:e,back:Ge.Uniform.Backbuffer,persistence:t}}),Gr=Ge.Shaders.create({persistence:{frag:Ge.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Hr=21,Vr="HODL",Wr=({time:e})=>Object($e.jsx)(Ge.LinearCopy,{children:Object($e.jsx)(Xr,{persistence:Math.min(.99,.015*e),time:e,children:Object($e.jsx)(Ge.Node,{shader:Kr.node,uniforms:{time:e}})})}),Xr=({children:e,persistence:t,time:r})=>Object($e.jsx)(Ge.Node,{shader:Kr.shakePersistence,backbuffering:!0,uniforms:{t:e,back:Ge.Uniform.Backbuffer,persistence:t,time:r}}),Kr=Ge.Shaders.create({shakePersistence:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform sampler2D t, back;
uniform float time;
...
}`}}),Yr=22,Qr="atoms",Zr=({time:e})=>Object($e.jsx)(Ge.Node,{shader:Jr.node,uniforms:{time:e,t:"/images/einstein-tongue-out.jpg"}}),Jr=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D t;
...
void main() {
...
}`}}),en=23,tn="Hexacubes",rn=({time:e})=>Object($e.jsx)(Ge.Node,{shader:nn.node,uniforms:{time:e}}),nn=Ge.Shaders.create({node:{frag:Ge.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform float time;
  const float PI = ${Math.PI};
  ...
  void main() {
    ...
    gl_FragColor = vec4(c, 1.0);
      ...
      `}}),on=24,an="dark cubes",cn=({time:e})=>Object($e.jsx)(Ge.Node,{shader:sn.node,uniforms:{time:e}}),sn=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),ln=25,fn="Mandelbrot",un=({time:e})=>Object($e.jsx)(Ge.LinearCopy,{children:Object($e.jsx)(pn,{persistence:.9,children:Object($e.jsx)(vr,{passes:4,factor:.1,children:Object($e.jsx)(Ge.Node,{shader:dn.node,uniforms:{time:e}})})})}),pn=({children:e,persistence:t})=>Object($e.jsx)(Ge.Node,{shader:dn.persistence,backbuffering:!0,uniforms:{t:e,back:Ge.Uniform.Backbuffer,persistence:t}}),dn=Ge.Shaders.create({persistence:{frag:Ge.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),vn=26,hn="fumes",mn=({time:e})=>Object($e.jsx)(Ge.LinearCopy,{children:Object($e.jsx)(gn,{persistence:.9,children:Object($e.jsx)(vr,{passes:4,factor:Math.min(.6,.01*e),children:Object($e.jsx)(Ge.Node,{shader:bn.node,uniforms:{time:e}})})})}),gn=({children:e,persistence:t})=>Object($e.jsx)(Ge.Node,{shader:bn.persistence,backbuffering:!0,uniforms:{t:e,back:Ge.Uniform.Backbuffer,persistence:t}}),bn=Ge.Shaders.create({persistence:{frag:Ge.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),xn=27,yn="real burning ship",wn=400,_n=0,Sn=60,En=12,On=2,Rn=({time:e})=>Object($e.jsx)(Ge.LinearCopy,{children:Object($e.jsx)(zn,{persistence:.8+.05*Math.random(),time:e,children:Object($e.jsx)(Ge.Node,{shader:Pn.node,uniforms:{time:e}})})}),zn=({children:e,persistence:t,time:r})=>Object($e.jsx)(Ge.Node,{shader:Pn.persistence,backbuffering:!0,uniforms:{t:e,back:Ge.Uniform.Backbuffer,persistence:t,time:r}}),Pn=Ge.Shaders.create({persistence:{frag:Ge.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Tn=28,In="No, I'M Batman",Cn=({time:e})=>Object($e.jsx)(Ge.LinearCopy,{children:Object($e.jsx)(jn,{persistence:.5+.48*Math.min(1,e/60),children:Object($e.jsx)(Ge.Node,{shader:kn.node,uniforms:{time:e}})})}),jn=({children:e,persistence:t})=>Object($e.jsx)(Ge.Node,{shader:kn.persistence,backbuffering:!0,uniforms:{t:e,back:Ge.Uniform.Backbuffer,persistence:t}}),kn=Ge.Shaders.create({persistence:{frag:Ge.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),An=29,Dn="sdBitcoin(p)",Ln=({time:e})=>Object($e.jsx)(Ge.Node,{shader:Nn.node,uniforms:{time:e}}),Nn=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Mn=30,Un="21 millions",Fn=({time:e})=>Object($e.jsx)(Ge.Node,{shader:Bn.node,uniforms:{time:e,numberInCirculation:18557031}}),Bn=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),qn=31,$n="alien tower",Gn=({time:e})=>Object($e.jsx)(Ge.Node,{shader:Hn.node,uniforms:{time:e,numberInCirculation:18557031}}),Hn=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform float numberInCirculation;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Vn=32,Wn="GoL valley";let Xn;const Kn=({time:e})=>{Xn||(Xn=e);const t=e-Xn,r=Math.floor(12*t);return Object($e.jsx)(Ge.Node,{shader:Yn.node,uniforms:{time:e,t:Object($e.jsx)(ut,{refreshEveryTicks:100,tick:r,size:100})}})},Yn=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D t;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Qn=33,Zn="x(x+32y)%(tN+1)%n";const Jn=({time:e})=>Object($e.jsx)(Ge.Node,{shader:eo.node,uniforms:{time:e}}),eo=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),to=34,ro="\u230a2cos(x)sin(y+t)\u230b%7";const no=({time:e})=>Object($e.jsx)(Ge.Node,{shader:oo.node,uniforms:{time:e}}),oo=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
#define PI ${Math.PI}
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),io=35,ao="aie confiance",co=({time:e})=>Object($e.jsx)(Ge.LinearCopy,{children:Object($e.jsx)(so,{persistence:.6,children:Object($e.jsx)(Ge.Node,{shader:lo.node,uniforms:{time:e}})})}),so=({children:e,persistence:t})=>Object($e.jsx)(Ge.Node,{shader:lo.persistence,backbuffering:!0,uniforms:{t:e,back:Ge.Uniform.Backbuffer,persistence:t}}),lo=Ge.Shaders.create({persistence:{frag:Ge.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),fo=36,uo="crois en moi",po=({time:e})=>Object($e.jsx)(Ge.LinearCopy,{children:Object($e.jsx)(vo,{children:Object($e.jsx)(Ge.Node,{shader:ho.node,uniforms:{time:e}})})}),vo=({children:e,persistence:t})=>Object($e.jsx)(Ge.Node,{shader:ho.persistence,backbuffering:!0,uniforms:{t:e,back:Ge.Uniform.Backbuffer,persistence:t}}),ho=Ge.Shaders.create({persistence:{frag:Ge.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),mo=37,go="sdBrick",bo=({time:e})=>Object($e.jsx)(Ge.Node,{shader:xo.node,uniforms:{time:e}}),xo=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),yo=38,wo="Golden mandelbulb",_o=({time:e})=>Object($e.jsx)(Ge.LinearCopy,{children:Object($e.jsx)(So,{persistence:.5,children:Object($e.jsx)(Ge.Node,{shader:Eo.node,uniforms:{time:e}})})}),So=({children:e,persistence:t})=>Object($e.jsx)(Ge.Node,{shader:Eo.persistence,backbuffering:!0,uniforms:{t:e,back:Ge.Uniform.Backbuffer,persistence:t}}),Eo=Ge.Shaders.create({persistence:{frag:Ge.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  clr /= 4.;
  gl_FragColor = vec4(clr, 1.0);
}`}}),Oo=39,Ro="metaballs",zo=({time:e})=>Object($e.jsx)(Ge.Node,{shader:Po.node,uniforms:{time:e}}),Po=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  clr /= 4.;
  gl_FragColor = vec4(clr, 1.0);
}`}}),To=40,Io="pen-o-plasma",Co=({time:e})=>Object($e.jsx)(Ge.Node,{shader:jo.node,uniforms:{time:e}}),jo=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(clr, 1.0);
}`}}),ko=41,Ao="reflection",Do=({time:e})=>Object($e.jsx)(Ge.Node,{shader:Lo.node,uniforms:{time:e}}),Lo=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),No=42,Mo="reflection party",Uo=({time:e})=>Object($e.jsx)(Ge.Node,{shader:Fo.node,uniforms:{time:e}}),Fo=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c = mix(c, reflection(p, n, 10.), glossy);
  gl_FragColor = vec4(c, 1.0);
}`}}),Bo=43,qo="irreconcilable queens",$o=({time:e})=>Object($e.jsx)(Ge.LinearCopy,{children:Object($e.jsx)(Go,{persistence:.4,children:Object($e.jsx)(Ge.Node,{shader:Ho.node,uniforms:{time:e}})})}),Go=({children:e,persistence:t})=>Object($e.jsx)(Ge.Node,{shader:Ho.persistence,backbuffering:!0,uniforms:{t:e,back:Ge.Uniform.Backbuffer,persistence:t}}),Ho=Ge.Shaders.create({persistence:{frag:Ge.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Vo=44,Wo="royal meeting",Xo=({time:e})=>Object($e.jsx)(Ge.Node,{shader:Ko.node,uniforms:{time:e}}),Ko=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
#define PI ${Math.PI}
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),Yo=45,Qo="wood pawns army",Zo=({time:e})=>Object($e.jsx)(Ge.Node,{shader:Jo.node,uniforms:{time:e,wood:"/images/seamless-wood-background-1.jpg"}}),Jo=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),ei=46,ti="Bank of Bicoin",ri=({time:e})=>Object($e.jsx)(Ge.Node,{shader:ni.node,uniforms:{time:e}}),ni=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),oi=47,ii="glow experiment",ai=({time:e})=>Object($e.jsx)(Ge.Node,{shader:ci.node,uniforms:{time:e}}),ci=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),si=48,li="Starry Night",fi=({time:e})=>Object($e.jsx)(Ge.Node,{shader:ui.node,uniforms:{time:e,img:"/images/seamless-wood2.jpg"}}),ui=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(clr, 1.0);
}`}}),pi=49,di="chinese lantern",vi=400,hi=0,mi=20,gi=24,bi=1.1,xi=({time:e})=>Object($e.jsx)(Ge.LinearCopy,{children:Object($e.jsx)(yi,{persistence:.8,children:Object($e.jsx)(Ge.Node,{shader:wi.node,uniforms:{time:e}})})}),yi=({children:e,persistence:t})=>Object($e.jsx)(Ge.Node,{shader:wi.persistence,backbuffering:!0,uniforms:{t:e,back:Ge.Uniform.Backbuffer,persistence:t}}),wi=Ge.Shaders.create({persistence:{frag:Ge.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  clr += c;
  gl_FragColor = vec4(clr, 1.0);
}`}}),_i=50,Si="jumpy rooks",Ei=({time:e})=>Object($e.jsx)(Ge.Node,{shader:Oi.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),Oi=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),Ri=51,zi="symmetry chess",Pi=400,Ti=0,Ii=20,Ci=24,ji=1,ki=({time:e})=>Object($e.jsx)(Ge.Node,{shader:Ai.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),Ai=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Di=52,Li="knights dance",Ni=({time:e})=>Object($e.jsx)(Ge.Node,{shader:Mi.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),Mi=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),Ui=53,Fi="cross waves",Bi=({time:e})=>Object($e.jsx)(Ge.Node,{shader:qi.node,uniforms:{time:e}}),qi=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  */
}`}}),$i=54,Gi="chess set",Hi=({time:e})=>Object($e.jsx)(Ge.Node,{shader:Vi.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),Vi=Ge.Shaders.create({node:{frag:Ge.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  color = vec4(c, 1.0);
}`}}),Wi=55,Xi="cube d'or",Ki=400,Yi=0,Qi=20,Zi=24,Ji=1,ea=({time:e})=>Object($e.jsx)(Ge.Node,{shader:ta.node,uniforms:{time:e}}),ta=Ge.Shaders.create({node:{frag:Ge.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  #endif
  color = vec4(c, 1.0);
}`}}),ra=56,na="jade forest",oa=({time:e})=>Object($e.jsx)(Ge.Node,{shader:ia.node,uniforms:{time:e}}),ia=Ge.Shaders.create({node:{frag:Ge.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  color = vec4(c, 1.0);
}`}}),aa=57,ca="Virus v2",sa=400,la=0,fa=20,ua=24,pa=.8,da=({time:e})=>Object($e.jsx)(Ge.Node,{shader:va.node,uniforms:{time:e}}),va=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}});var ha=r("005v"),ma=r.n(ha);const ga=400,ba=0,xa=30,ya=20,wa=1,_a="5M",Sa=58,Ea="Mandelglitch",Oa=[{url:"https://ethblock.art/create/17",text:"Mint on ethblock.art"},{url:"https://ghostmarket.io/asset/pha/ghost/3008841254969814369262311336331954453497120774334547905246474374493804042898/",text:"ghostmarket.io: 400 KCAL"},{url:"https://www.hicetnunc.xyz/objkt/3063",text:"hicetnunc.xyz: Mandelglitch #1 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3068",text:"hicetnunc.xyz: Mandelglitch #2 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3071",text:"hicetnunc.xyz: Mandelglitch #3 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3072",text:"hicetnunc.xyz: Mandelglitch #4 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3073",text:"hicetnunc.xyz: Mandelglitch #5 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3077",text:"hicetnunc.xyz: Mandelglitch #6 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3088",text:"hicetnunc.xyz: Mandelglitch #7 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3574",text:"hicetnunc.xyz: Mandelglitch #8 (5 XTZ)"}];const Ra=e=>e<.5?2*e*e:(4-2*e)*e-1;const za=({time:e,n:t,exporting:r})=>{const n=Object(st.useMemo)((()=>function(e,t=0){const r=e?3:50,n=new ma.a(t);return Array(r).fill(null).map((()=>Array(12).fill(null).map((()=>n.random()))))}(r,t)),[t,r]),o=e/10%n.length,i=Math.floor(o),a=o-i;let[c,s,l,f,u,p,d,v,h,m,g,b]=(x=n[i%n.length],y=n[(i+1)%n.length],w=Ra(a),x.map(((e,t)=>e*(1-w)+y[t]*w)));var x,y,w;return l=Ra(l),Object($e.jsx)(Ge.LinearCopy,{children:Object($e.jsx)(Ta,{persistence:r?0:.8,children:Object($e.jsx)(Ge.Node,{shader:Pa.main,uniforms:{aa:r?2:0,time:e,resolution:Ge.Uniform.Resolution,travel:c,love:s,dark:l,rot:r?2*Math.PI/xa:.1,s1:f,s2:u,s3:p,s4:d,s5:v,s6:h,s7:m,s8:g,s9:b}})})})},Pa=Ge.Shaders.create({persistence:{frag:Ge.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  `}}),Ta=({children:e,persistence:t})=>Object($e.jsx)(Ge.Node,{shader:Pa.persistence,backbuffering:!0,uniforms:{t:e,back:Ge.Uniform.Backbuffer,persistence:t}}),Ia=59,Ca="Pixels 256",ja="There will be only 256 patterns generated by this single fragment shader.",ka=({time:e,n:t,exporting:r})=>Object($e.jsx)(Aa,{n:t+1+(r?0:Math.floor(e))}),Aa=lt.a.memo((({n:e})=>{const t=new ma.a(e%256),r=t.random(),n=t.random(),o=t.random(),i=t.random(),a=t.random(),c=t.random();return Object($e.jsx)(Ge.Node,{shader:Da.node,uniforms:{s1:r,s2:n,s3:o,s4:i,s5:a,s6:c}})})),Da=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),La=60,Na="Bitcoin rainbow",Ma=({time:e})=>Object($e.jsx)(Ge.Node,{shader:Ua.node,uniforms:{time:e}}),Ua=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Fa=61,Ba="Binance gradients",qa=1,$a=30,Ga=["/images/shaders/binance.dist.png"],Ha=({time:e})=>Object($e.jsx)(Ge.Node,{shader:Va.node,uniforms:{time:e,image:"/images/shaders/binance.dist.png"}}),Va=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Wa=62,Xa="Overgrowth",Ka=20,Ya=40,Qa=1,Za=({generation:e,size:t,n:r})=>Object($e.jsx)(Ge.Node,{width:t,height:t,shader:oc.logic,uniforms:{generation:e,prev:Ge.Uniform.Backbuffer,size:t,seed:r/100},backbuffering:!0}),Ja=lt.a.memo(Za),ec=({time:e,generation:t,n:r})=>Object($e.jsx)(Ge.Node,{shader:oc.render,uniforms:{time:e,logic:Object($e.jsx)(Ja,{generation:t,size:140,n:r})},uniformsOptions:{logic:{interpolation:"nearest"}}}),tc=lt.a.memo(ec),rc=1e3*Math.random(),nc=({time:e,n:t})=>Object($e.jsx)(tc,{n:t+rc,time:e,generation:Math.floor(30*e)},t),oc=Ge.Shaders.create({logic:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
...
`}});var ic=r("AJhG");const ac=63,cc="Relics",sc=400,lc=2,fc=4,uc=20,pc=1,dc="5M",vc={colors:[.7,.55,.4],logicSize:80,amp:1,base:2,persistance:.89,delta:.5,seed:0};console.log(Object.keys(vc).map((e=>String(vc[e]))).join("_"));const hc=({g:e,size:t,seed:r,amp:n,base:o,persistance:i,delta:a})=>Object($e.jsx)(Ge.Node,{width:t,height:t,shader:yc.logic,uniforms:{amp:n,base:o,g:e,prev:Ge.Uniform.Backbuffer,size:t,seed:r,persistance:i,delta:a},backbuffering:!0},t),mc=lt.a.memo(hc),gc=({g:e,colors:t,amp:r,base:n,persistance:o,delta:i,logicSize:a,seed:c})=>Object($e.jsx)(Ge.Node,{shader:yc.render,uniforms:{colors:t,logic:Object($e.jsx)(mc,{amp:r,base:n,g:e,size:a,seed:c,persistance:o,delta:i})},uniformsOptions:{logic:{interpolation:"nearest"}}}),bc=lt.a.memo(gc),xc=({time:e})=>{const{colors:t,logicSize:r,amp:n,base:o,persistance:i,delta:a,seed:c}=Object(ic.b)(vc);return Object($e.jsx)(bc,{amp:n,base:o,g:Math.floor(20*e)%40,colors:t,persistance:i,delta:a,seed:c,logicSize:r})},yc=Ge.Shaders.create({logic:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform sampler2D prev;
uniform float g;
...
`}}),wc=64,_c="Intersection",Sc=8*Math.PI,Ec=[{url:"https://www.hicetnunc.xyz/objkt/28592",text:"hic et nunc NFT"}],Oc=({time:e})=>Object($e.jsx)(Ge.Node,{shader:Rc.render,uniforms:{resolution:Ge.Uniform.Resolution,time:e}}),Rc=Ge.Shaders.create({render:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform vec2 resolution;
...
`}}),zc=65,Pc="Duality",Tc=800,Ic=4,Cc=8,jc=30,kc=1,Ac=3,Dc=!0,Lc=16,Nc=[{url:"https://hicetnunc.xyz/objkt/64326",text:"hic et nunc NFT"}],Mc=({time:e})=>Object($e.jsx)(Ge.NearestCopy,{children:Object($e.jsx)(Uc,{persistence:.3,children:Object($e.jsx)(Ge.Node,{shader:Fc.render,uniforms:{resolution:Ge.Uniform.Resolution,time:e}})})}),Uc=({children:e,persistence:t})=>Object($e.jsx)(Ge.Node,{shader:Fc.persistence,backbuffering:!0,uniforms:{t:e,back:Ge.Uniform.Backbuffer,persistence:t}}),Fc=Ge.Shaders.create({persistence:{frag:Ge.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Bc=66,qc="hicetnunc",$c=800,Gc=2,Hc=Gc+8,Vc=30,Wc=1,Xc=7,Kc=!0,Yc=16,Qc=({time:e})=>Object($e.jsx)(Ge.NearestCopy,{children:Object($e.jsx)(Zc,{persistence:.5,children:Object($e.jsx)(Ge.Node,{shader:Jc.render,uniforms:{resolution:Ge.Uniform.Resolution,time:e,freq:2}})})}),Zc=({children:e,persistence:t})=>Object($e.jsx)(Ge.Node,{shader:Jc.persistence,backbuffering:!0,uniforms:{t:e,back:Ge.Uniform.Backbuffer,persistence:t}}),Jc=Ge.Shaders.create({persistence:{frag:Ge.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),es=67,ts="Jumping blob",rs=800,ns=2,os=ns+8,is=30,as=1,cs=7,ss=!0,ls=16,fs=({time:e})=>Object($e.jsx)(Ge.NearestCopy,{children:Object($e.jsx)(us,{persistence:.6,children:Object($e.jsx)(Ge.Node,{shader:ps.render,uniforms:{resolution:Ge.Uniform.Resolution,time:e,freq:2}})})}),us=({children:e,persistence:t})=>Object($e.jsx)(Ge.Node,{shader:ps.persistence,backbuffering:!0,uniforms:{t:e,back:Ge.Uniform.Backbuffer,persistence:t}}),ps=Ge.Shaders.create({persistence:{frag:Ge.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),ds=68,vs="ring",hs=800,ms=2,gs=ms+10,bs=30,xs=1,ys=7,ws=!0,_s=128,Ss=({time:e})=>Object($e.jsx)(Ge.NearestCopy,{children:Object($e.jsx)(Es,{persistence:.9,children:Object($e.jsx)(Ge.Node,{shader:Os.render,uniforms:{resolution:Ge.Uniform.Resolution,time:e,freq:2}})})}),Es=({children:e,persistence:t})=>Object($e.jsx)(Ge.Node,{shader:Os.persistence,backbuffering:!0,uniforms:{t:e,back:Ge.Uniform.Backbuffer,persistence:t}}),Os=Ge.Shaders.create({persistence:{frag:Ge.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Rs=69,zs="Bananas paradize",Ps=400,Ts=0,Is=20,Cs=20,js=1,ks=!0,As=128,Ds=({time:e})=>Object($e.jsx)(Ge.Node,{shader:Ls.node,uniforms:{time:e,resolution:Ge.Uniform.Resolution}}),Ls=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),Ns=70,Ms="warp1",Us=400,Fs=0,Bs=20,qs=20,$s=1,Gs=!1,Hs=256,Vs=({time:e})=>Object($e.jsx)(Ge.Node,{shader:Ws.node,uniforms:{time:e,resolution:Ge.Uniform.Resolution}}),Ws=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),Xs=71,Ks="warp2",Ys=640,Qs=0,Zs=20,Js=24,el=1,tl=!1,rl=256,nl=({time:e})=>Object($e.jsx)(Ge.Node,{shader:ol.node,uniforms:{time:e}}),ol=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),il=72,al="Planet Hole",cl=640,sl=0,ll=20,fl=24,ul=1,pl=!1,dl=256,vl=[{url:"https://hicetnunc.xyz/objkt/87918",text:"hic et nunc NFT"}],hl=({time:e,n:t})=>{const r=new ma.a(t),n=.2+3*r.random()*r.random(),o=.2+10*r.random()*r.random(),i=r.random(),a=[i+.2-.5*r.random(),i+.02-.1*r.random(),i-.02+.1*r.random()];return Object($e.jsx)(Ge.Node,{shader:ml.node,uniforms:{resolution:Ge.Uniform.Resolution,time:e,a:n,b:o,c:a}})},ml=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
...
`}}),gl=73,bl="purple square corridor",xl=640,yl=0,wl=20,_l=24,Sl=1,El=!1,Ol=256,Rl=72e5,zl=({time:e})=>{const t=Date.now(),r=t/Rl-Math.floor(t/Rl);return Object($e.jsx)(Ge.Node,{shader:Pl.node,uniforms:{resolution:Ge.Uniform.Resolution,time:e+1e3*r,speed:.01,c:[.8,.1,.3]}})},Pl=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
...
`}}),Tl=74,Il="blue square corridor",Cl=640,jl=0,kl=20,Al=24,Dl=1,Ll=!1,Nl=256,Ml=72e5,Ul=({time:e})=>{const t=Date.now(),r=t/Ml-Math.floor(t/Ml);return Object($e.jsx)(Ge.Node,{shader:Fl.node,uniforms:{resolution:Ge.Uniform.Resolution,time:e+1e3*r,speed:.01,c:[0,.3,.4]}})},Fl=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
...
`}}),Bl=75,ql="moir\xe9 square smoke",$l=640,Gl=0,Hl=20,Vl=24,Wl=1,Xl=!1,Kl=256,Yl=36e5,Ql=({time:e})=>{const t=Date.now(),r=t/Yl-Math.floor(t/Yl);return Object($e.jsx)(Ge.Node,{shader:Zl.node,uniforms:{resolution:Ge.Uniform.Resolution,time:e+1e3*r,speed:.01}})},Zl=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
...
`}}),Jl=76,ef="Purple",tf=640,rf=0,nf=20,of=24,af=1,cf=!1,sf=256,lf=({time:e})=>Object($e.jsx)(Ge.Node,{shader:ff.node,uniforms:{resolution:Ge.Uniform.Resolution,time:e}}),ff=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),uf=77,pf="Roses",df=512,vf=0,hf=8,mf=20,gf=1,bf=!1,xf=64,yf=({time:e})=>Object($e.jsx)(Ge.Node,{shader:wf.node,uniforms:{resolution:Ge.Uniform.Resolution,time:e}}),wf=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),_f=78,Sf="Nature",Ef=512,Of=0,Rf=10,zf=16,Pf=1,Tf=!1,If=64,Cf=({time:e})=>Object($e.jsx)(Ge.Node,{shader:jf.node,uniforms:{resolution:Ge.Uniform.Resolution,time:e}}),jf=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),kf=79,Af="Circle",Df=512,Lf=0,Nf=10,Mf=16,Uf=1,Ff=!1,Bf=64,qf=({time:e})=>Object($e.jsx)(Ge.Node,{shader:$f.node,uniforms:{resolution:Ge.Uniform.Resolution,time:e}}),$f=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),Gf=80,Hf="Morphing Tunnel",Vf=512,Wf=0,Xf=10,Kf=16,Yf=1,Qf=!1,Zf=64,Jf=({time:e})=>Object($e.jsx)(Ge.Node,{shader:eu.node,uniforms:{resolution:Ge.Uniform.Resolution,time:e}}),eu=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),tu=81,ru="Red Blue Stripes",nu=512,ou=0,iu=10,au=16,cu=1,su=!1,lu=64,fu=({time:e})=>Object($e.jsx)(Ge.Node,{shader:uu.node,uniforms:{resolution:Ge.Uniform.Resolution,time:e}}),uu=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),pu=82,du="Mountain waves",vu=512,hu=0,mu=10,gu=16,bu=1,xu=!1,yu=64,wu=({time:e})=>Object($e.jsx)(Ge.Node,{shader:_u.node,uniforms:{resolution:Ge.Uniform.Resolution,time:e}}),_u=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),Su=83,Eu="Pink Plume",Ou=512,Ru=0,zu=10,Pu=16,Tu=1,Iu=!1,Cu=64,ju=({time:e})=>Object($e.jsx)(Ge.Node,{shader:ku.node,uniforms:{resolution:Ge.Uniform.Resolution,time:e}}),ku=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),Au=84,Du="Flame Waves",Lu=512,Nu=0,Mu=10,Uu=16,Fu=1,Bu=!1,qu=64,$u=({time:e})=>Object($e.jsx)(Ge.Node,{shader:Gu.node,uniforms:{resolution:Ge.Uniform.Resolution,time:e}}),Gu=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),Hu=85,Vu="Flaming Borders",Wu=512,Xu=0,Ku=10,Yu=16,Qu=1,Zu=!1,Ju=64,ep=({time:e})=>Object($e.jsx)(Ge.Node,{shader:tp.node,uniforms:{resolution:Ge.Uniform.Resolution,time:e}}),tp=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),rp=86,np="Waves",op=512,ip=0,ap=10,cp=16,sp=1,lp=!1,fp=64,up=({time:e})=>Object($e.jsx)(Ge.Node,{shader:pp.node,uniforms:{resolution:Ge.Uniform.Resolution,time:e}}),pp=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),dp=87,vp="Square Waves",hp=512,mp=0,gp=10,bp=16,xp=1,yp=!1,wp=64,_p=({time:e})=>Object($e.jsx)(Ge.Node,{shader:Sp.node,uniforms:{resolution:Ge.Uniform.Resolution,time:e}}),Sp=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),Ep=88,Op="Unboxing",Rp=512,zp=0,Pp=10,Tp=16,Ip=1,Cp=!1,jp=64,kp=({time:e})=>Object($e.jsx)(Ge.Node,{shader:Ap.node,uniforms:{resolution:Ge.Uniform.Resolution,time:e}}),Ap=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),Dp=89,Lp="Creepy",Np=512,Mp=0,Up=10,Fp=16,Bp=1,qp=!1,$p=64,Gp=({time:e})=>Object($e.jsx)(Ge.Node,{shader:Hp.node,uniforms:{resolution:Ge.Uniform.Resolution,time:e}}),Hp=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),Vp=90,Wp="Square Path",Xp=512,Kp=0,Yp=10,Qp=16,Zp=1,Jp=!1,ed=64,td=({time:e})=>Object($e.jsx)(Ge.Node,{shader:rd.node,uniforms:{resolution:Ge.Uniform.Resolution,time:e}}),rd=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),nd=91,od="Door Path",id=512,ad=0,cd=10,sd=16,ld=1,fd=!1,ud=64,pd=({time:e})=>Object($e.jsx)(Ge.Node,{shader:dd.node,uniforms:{resolution:Ge.Uniform.Resolution,time:e}}),dd=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),vd=92,hd="Green Cosmos",md=512,gd=0,bd=10,xd=16,yd=1,wd=!1,_d=64,Sd=({time:e})=>Object($e.jsx)(Ge.Node,{shader:Ed.node,uniforms:{resolution:Ge.Uniform.Resolution,time:e}}),Ed=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),Od=93,Rd="Is it alive",zd=512,Pd=0,Td=10,Id=16,Cd=1,jd=!1,kd=64,Ad=({time:e})=>Object($e.jsx)(Ge.Node,{shader:Dd.node,uniforms:{resolution:Ge.Uniform.Resolution,time:e}}),Dd=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),Ld=94,Nd="Sand",Md=512,Ud=0,Fd=10,Bd=16,qd=1,$d=!1,Gd=128,Hd=({time:e})=>Object($e.jsx)(Ge.Node,{shader:Vd.node,uniforms:{resolution:Ge.Uniform.Resolution,time:e}}),Vd=Ge.Shaders.create({node:{frag:Ge.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;

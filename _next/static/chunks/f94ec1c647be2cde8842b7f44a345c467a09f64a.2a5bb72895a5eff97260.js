...
}`}}).copy;t.default=i},MAJC:function(e,t,r){"use strict";e.exports=function(e){return"undefined"!==typeof e&&null!==e&&("object"===typeof e||"function"===typeof e)}},Ni9w:function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;t.default=class{constructor(){var e,t,r;r=[],(t="_loaders")in(e=this)?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r}add(e){this._loaders.push(e),this._loaders.sort(((e,t)=>("number"===typeof t.priority?t.priority:0)-("number"===typeof e.priority?e.priority:0)))}remove(e){const t=this._loaders.indexOf(e);-1!==t&&this._loaders.splice(t,1)}get(){return this._loaders}}},O8XB:function(e,t,r){"use strict";(function(e,n){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var o,i,a,s,c,l=p(r("tbvF")),f=p(r("Ytbt")),u=p(r("zqV6"));function p(e){return e&&e.__esModule?e:{default:e}}"undefined"===typeof e&&(n.Buffer=(i=o=class{},c=t=>t instanceof e,(s="isBuffer")in(a=o)?Object.defineProperty(a,s,{value:c,enumerable:!0,configurable:!0,writable:!0}):a[s]=c,i));t.default=(e,t,r,n)=>{const o="undefined"!==typeof WebGLRenderingContext&&e instanceof WebGLRenderingContext;let i=r.dtype,a=r.shape.slice(),s=e.getParameter(e.MAX_TEXTURE_SIZE);if(a[0]<0||a[0]>s||a[1]<0||a[1]>s)throw new Error("gl-react: Invalid texture size");let c=function(e,t){return 3===e.length?1===t[2]&&t[1]===e[0]*e[2]&&t[0]===e[2]:1===t[0]&&t[1]===e[0]}(a,r.stride.slice()),p=0;"float32"===i?p=e.FLOAT:"float64"===i?(p=e.FLOAT,c=!1,i="float32"):"uint8"===i?p=e.UNSIGNED_BYTE:(p=e.UNSIGNED_BYTE,c=!1,i="uint8");let d,v=0,h=0;if(2===a.length)h=v=e.LUMINANCE,a=[a[0],a[1],1],r=(0,l.default)(r.data,a,[r.stride[0],r.stride[1],1],r.offset);else{if(3!==a.length)throw new Error("gl-texture2d: Invalid shape for texture");if(1===a[2])h=v=e.ALPHA,o||(n=!1);else if(2===a[2])h=v=e.LUMINANCE_ALPHA,o||(n=!1);else if(3===a[2])v=e.RGB,h=o?e.RGB:e.RGB32F;else{if(4!==a[2])throw new Error("gl-texture2d: Invalid shape for pixel coords");v=e.RGBA,h=o?e.RGBA:e.RGBA32F}}p!==e.FLOAT||n||(p=e.UNSIGNED_BYTE,c=!1);let m,g=r.size;if(c)d=0===r.offset&&r.data.length===g?r.data:r.data.subarray(r.offset,r.offset+g);else{let t=[a[2],a[2]*a[0],1];if("float32"!==i&&"float64"!==i||p!==e.UNSIGNED_BYTE){m=u.default.malloc(g,i);let e=(0,l.default)(m,a,t,0);f.default.assign(e,r)}else{m=u.default.malloc(g,"uint8"),function(e,t){f.default.muls(e,t,255)}((0,l.default)(m,a,t,0),r)}d=m.subarray(0,g)}e.texImage2D(e.TEXTURE_2D,0,h,a[0],a[1],0,v,p,d),m&&u.default.free(m)}}).call(this,r("HDXh").Buffer,r("ntbh"))},OTww:function(e,t,r){"use strict";(function(e){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var n,o=(n=r("Ni9w"))&&n.__esModule?n:{default:n};const i="undefined"===typeof window?e:window,a="__webglTextureLoader_registry";var s=i[a]||(i[a]=new o.default);t.default=s}).call(this,r("ntbh"))},QLaP:function(e,t,r){"use strict";e.exports=function(e,t,r,n,o,i,a,s){if(!e){var c;if(void 0===t)c=new Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else{var l=[r,n,o,i,a,s],f=0;(c=new Error(t.replace(/%s/g,(function(){return l[f++]})))).name="Invariant Violation"}throw c.framesToPop=1,c}}},QM7d:function(e,t,r){"use strict";var n=r("033R");function o(){this.argTypes=[],this.shimArgs=[],this.arrayArgs=[],this.arrayBlockIndices=[],this.scalarArgs=[],this.offsetArgs=[],this.offsetArgIndex=[],this.indexArgs=[],this.shapeArgs=[],this.funcName="",this.pre=null,this.body=null,this.post=null,this.debug=!1}e.exports=function(e){var t=new o;t.pre=e.pre,t.body=e.body,t.post=e.post;var r=e.args.slice(0);t.argTypes=r;for(var i=0;i<r.length;++i){var a=r[i];if("array"===a||"object"===typeof a&&a.blockIndices){if(t.argTypes[i]="array",t.arrayArgs.push(i),t.arrayBlockIndices.push(a.blockIndices?a.blockIndices:0),t.shimArgs.push("array"+i),i<t.pre.args.length&&t.pre.args[i].count>0)throw new Error("cwise: pre() block may not reference array args");if(i<t.post.args.length&&t.post.args[i].count>0)throw new Error("cwise: post() block may not reference array args")}else if("scalar"===a)t.scalarArgs.push(i),t.shimArgs.push("scalar"+i);else if("index"===a){if(t.indexArgs.push(i),i<t.pre.args.length&&t.pre.args[i].count>0)throw new Error("cwise: pre() block may not reference array index");if(i<t.body.args.length&&t.body.args[i].lvalue)throw new Error("cwise: body() block may not write to array index");if(i<t.post.args.length&&t.post.args[i].count>0)throw new Error("cwise: post() block may not reference array index")}else if("shape"===a){if(t.shapeArgs.push(i),i<t.pre.args.length&&t.pre.args[i].lvalue)throw new Error("cwise: pre() block may not write to array shape");if(i<t.body.args.length&&t.body.args[i].lvalue)throw new Error("cwise: body() block may not write to array shape");if(i<t.post.args.length&&t.post.args[i].lvalue)throw new Error("cwise: post() block may not write to array shape")}else{if("object"!==typeof a||!a.offset)throw new Error("cwise: Unknown argument type "+r[i]);t.argTypes[i]="offset",t.offsetArgs.push({array:a.array,offset:a.offset}),t.offsetArgIndex.push(i)}}if(t.arrayArgs.length<=0)throw new Error("cwise: No array arguments specified");if(t.pre.args.length>r.length)throw new Error("cwise: Too many arguments in pre() block");if(t.body.args.length>r.length)throw new Error("cwise: Too many arguments in body() block");if(t.post.args.length>r.length)throw new Error("cwise: Too many arguments in post() block");return t.debug=!!e.printCode||!!e.debug,t.funcName=e.funcName||"cwise",t.blockSize=e.blockSize||64,n(t)}},R9Te:function(e,t,r){"use strict";var n=r("CyWo"),o=r("z08I"),i=r("+0iv"),a=r("vCtr");function s(e){return"__proto__"!==e&&"constructor"!==e&&"prototype"!==e}e.exports=function(e,t,r){if(!a(e))return e;if(Array.isArray(t)&&(t=[].concat.apply([],t).join(".")),"string"!==typeof t)return e;for(var c=n(t,{sep:".",brackets:!0}).filter(s),l=c.length,f=-1,u=e;++f<l;){var p=c[f];f===l-1?i(u[p])&&i(r)?u[p]=o({},u[p],r):u[p]=r:(a(u[p])||(u[p]={}),u=u[p])}return e}},RjOF:function(e,t,r){"use strict";var n,o="";e.exports=function(e,t){if("string"!==typeof e)throw new TypeError("expected a string");if(1===t)return e;if(2===t)return e+e;var r=e.length*t;if(n!==e||"undefined"===typeof n)n=e,o="";else if(o.length>=r)return o.substr(0,r);for(;r>o.length&&t>1;)1&t&&(o+=e),t>>=1,e+=e;return o=(o+=e).substr(0,r)}},Ry8g:function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;t.default=e=>{const t=e.getExtension("WEBGL_lose_context");t&&t.loseContext()}},SMLl:function(e,t,r){"use strict";var n=r("RjOF");e.exports=function(e,t,r){return n(r="undefined"!==typeof r?r+"":" ",t)+e}},TBio:function(e,t,r){"use strict";var n=r("F16p");function o(e,t,r){var n,o,i=e.length,a=t.arrayArgs.length,s=t.indexArgs.length>0,c=[],l=[],f=0,u=0;for(n=0;n<i;++n)l.push(["i",n,"=0"].join(""));for(o=0;o<a;++o)for(n=0;n<i;++n)u=f,f=e[n],0===n?l.push(["d",o,"s",n,"=t",o,"p",f].join("")):l.push(["d",o,"s",n,"=(t",o,"p",f,"-s",u,"*t",o,"p",u,")"].join(""));for(l.length>0&&c.push("var "+l.join(",")),n=i-1;n>=0;--n)f=e[n],c.push(["for(i",n,"=0;i",n,"<s",f,";++i",n,"){"].join(""));for(c.push(r),n=0;n<i;++n){for(u=f,f=e[n],o=0;o<a;++o)c.push(["p",o,"+=d",o,"s",n].join(""));s&&(n>0&&c.push(["index[",u,"]-=s",u].join("")),c.push(["++index[",f,"]"].join(""))),c.push("}")}return c.join("\n")}function i(e,t,r){for(var n=e.body,o=[],i=[],a=0;a<e.args.length;++a){var s=e.args[a];if(!(s.count<=0)){var c=new RegExp(s.name,"g"),l="",f=t.arrayArgs.indexOf(a);switch(t.argTypes[a]){case"offset":var u=t.offsetArgIndex.indexOf(a);f=t.offsetArgs[u].array,l="+q"+u;case"array":l="p"+f+l;var p="l"+a,d="a"+f;if(0===t.arrayBlockIndices[f])1===s.count?"generic"===r[f]?s.lvalue?(o.push(["var ",p,"=",d,".get(",l,")"].join("")),n=n.replace(c,p),i.push([d,".set(",l,",",p,")"].join(""))):n=n.replace(c,[d,".get(",l,")"].join("")):n=n.replace(c,[d,"[",l,"]"].join("")):"generic"===r[f]?(o.push(["var ",p,"=",d,".get(",l,")"].join("")),n=n.replace(c,p),s.lvalue&&i.push([d,".set(",l,",",p,")"].join(""))):(o.push(["var ",p,"=",d,"[",l,"]"].join("")),n=n.replace(c,p),s.lvalue&&i.push([d,"[",l,"]=",p].join("")));else{for(var v=[s.name],h=[l],m=0;m<Math.abs(t.arrayBlockIndices[f]);m++)v.push("\\s*\\[([^\\]]+)\\]"),h.push("$"+(m+1)+"*t"+f+"b"+m);if(c=new RegExp(v.join(""),"g"),l=h.join("+"),"generic"===r[f])throw new Error("cwise: Generic arrays not supported in combination with blocks!");n=n.replace(c,[d,"[",l,"]"].join(""))}break;case"scalar":n=n.replace(c,"Y"+t.scalarArgs.indexOf(a));break;case"index":n=n.replace(c,"index");break;case"shape":n=n.replace(c,"shape")}}}return[o.join("\n"),n,i.join("\n")].join("\n").trim()}function a(e){for(var t=new Array(e.length),r=!0,n=0;n<e.length;++n){var o=e[n],i=o.match(/\d+/);i=i?i[0]:"",0===o.charAt(0)?t[n]="u"+o.charAt(1)+i:t[n]=o.charAt(0)+i,n>0&&(r=r&&t[n]===t[n-1])}return r?t[0]:t.join("")}e.exports=function(e,t){for(var r=t[1].length-Math.abs(e.arrayBlockIndices[0])|0,s=new Array(e.arrayArgs.length),c=new Array(e.arrayArgs.length),l=0;l<e.arrayArgs.length;++l)c[l]=t[2*l],s[l]=t[2*l+1];var f=[],u=[],p=[],d=[],v=[];for(l=0;l<e.arrayArgs.length;++l){e.arrayBlockIndices[l]<0?(p.push(0),d.push(r),f.push(r),u.push(r+e.arrayBlockIndices[l])):(p.push(e.arrayBlockIndices[l]),d.push(e.arrayBlockIndices[l]+r),f.push(0),u.push(e.arrayBlockIndices[l]));for(var h=[],m=0;m<s[l].length;m++)p[l]<=s[l][m]&&s[l][m]<d[l]&&h.push(s[l][m]-p[l]);v.push(h)}var g=["SS"],b=["'use strict'"],y=[];for(m=0;m<r;++m)y.push(["s",m,"=SS[",m,"]"].join(""));for(l=0;l<e.arrayArgs.length;++l){g.push("a"+l),g.push("t"+l),g.push("p"+l);for(m=0;m<r;++m)y.push(["t",l,"p",m,"=t",l,"[",p[l]+m,"]"].join(""));for(m=0;m<Math.abs(e.arrayBlockIndices[l]);++m)y.push(["t",l,"b",m,"=t",l,"[",f[l]+m,"]"].join(""))}for(l=0;l<e.scalarArgs.length;++l)g.push("Y"+l);if(e.shapeArgs.length>0&&y.push("shape=SS.slice(0)"),e.indexArgs.length>0){var x=new Array(r);for(l=0;l<r;++l)x[l]="0";y.push(["index=[",x.join(","),"]"].join(""))}for(l=0;l<e.offsetArgs.length;++l){var w=e.offsetArgs[l],_=[];for(m=0;m<w.offset.length;++m)0!==w.offset[m]&&(1===w.offset[m]?_.push(["t",w.array,"p",m].join("")):_.push([w.offset[m],"*t",w.array,"p",m].join("")));0===_.length?y.push("q"+l+"=0"):y.push(["q",l,"=",_.join("+")].join(""))}var E=n([].concat(e.pre.thisVars).concat(e.body.thisVars).concat(e.post.thisVars));for((y=y.concat(E)).length>0&&b.push("var "+y.join(",")),l=0;l<e.arrayArgs.length;++l)b.push("p"+l+"|=0");e.pre.body.length>3&&b.push(i(e.pre,e,c));var S=i(e.body,e,c),O=function(e){for(var t=0,r=e[0].length;t<r;){for(var n=1;n<e.length;++n)if(e[n][t]!==e[0][t])return t;++t}return t}(v);O<r?b.push(function(e,t,r,n){for(var i=t.length,a=r.arrayArgs.length,s=r.blockSize,c=r.indexArgs.length>0,l=[],f=0;f<a;++f)l.push(["var offset",f,"=p",f].join(""));for(f=e;f<i;++f)l.push(["for(var j"+f+"=SS[",t[f],"]|0;j",f,">0;){"].join("")),l.push(["if(j",f,"<",s,"){"].join("")),l.push(["s",t[f],"=j",f].join("")),l.push(["j",f,"=0"].join("")),l.push(["}else{s",t[f],"=",s].join("")),l.push(["j",f,"-=",s,"}"].join("")),c&&l.push(["index[",t[f],"]=j",f].join(""));for(f=0;f<a;++f){for(var u=["offset"+f],p=e;p<i;++p)u.push(["j",p,"*t",f,"p",t[p]].join(""));l.push(["p",f,"=(",u.join("+"),")"].join(""))}for(l.push(o(t,r,n)),f=e;f<i;++f)l.push("}");return l.join("\n")}(O,v[0],e,S)):b.push(o(v[0],e,S)),e.post.body.length>3&&b.push(i(e.post,e,c)),e.debug&&console.log("-----Generated cwise routine for ",t,":\n"+b.join("\n")+"\n----------");var R=[e.funcName||"unnamed","_cwise_loop_",s[0].join("s"),"m",O,a(c)].join("");return new Function(["function ",R,"(",g.join(","),"){",b.join("\n"),"} return ",R].join(""))()}},TGEO:function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),Object.defineProperty(t,"WebGLTextureLoader",{enumerable:!0,get:function(){return n.default}}),Object.defineProperty(t,"WebGLTextureLoaderAsyncHashCache",{enumerable:!0,get:function(){return o.default}}),Object.defineProperty(t,"WebGLTextureLoaderSyncHashCache",{enumerable:!0,get:function(){return i.default}}),Object.defineProperty(t,"LoadersRegistry",{enumerable:!0,get:function(){return a.default}}),Object.defineProperty(t,"LoaderResolver",{enumerable:!0,get:function(){return s.default}}),Object.defineProperty(t,"globalRegistry",{enumerable:!0,get:function(){return c.default}});var n=l(r("HbIt")),o=l(r("cDsr")),i=l(r("VYxY")),a=l(r("Ni9w")),s=l(r("LhdL")),c=l(r("OTww"));function l(e){return e&&e.__esModule?e:{default:e}}},TKux:function(e,t,r){"use strict";r.d(t,"b",(function(){return Dl})),r.d(t,"c",(function(){return Ll})),r.d(t,"a",(function(){return Nl}));var n={};r.r(n),r.d(n,"n",(function(){return Re})),r.d(n,"title",(function(){return Te})),r.d(n,"Shader",(function(){return ze}));var o={};r.r(o),r.d(o,"n",(function(){return Ce})),r.d(o,"title",(function(){return Ie})),r.d(o,"exportSize",(function(){return je})),r.d(o,"exportStart",(function(){return Ae})),r.d(o,"exportEnd",(function(){return ke})),r.d(o,"exportFramePerSecond",(function(){return De})),r.d(o,"exportSpeed",(function(){return Le})),r.d(o,"Shader",(function(){return Ne}));var i={};r.r(i),r.d(i,"n",(function(){return Ue})),r.d(i,"title",(function(){return Be})),r.d(i,"Shader",(function(){return Fe}));var a={};r.r(a),r.d(a,"n",(function(){return We})),r.d(a,"title",(function(){return Xe})),r.d(a,"Shader",(function(){return Ye}));var s={};r.r(s),r.d(s,"n",(function(){return Je})),r.d(s,"title",(function(){return et})),r.d(s,"Shader",(function(){return tt}));var c={};r.r(c),r.d(c,"n",(function(){return nt})),r.d(c,"title",(function(){return ot})),r.d(c,"Shader",(function(){return it}));var l={};r.r(l),r.d(l,"n",(function(){return st})),r.d(l,"title",(function(){return ct})),r.d(l,"Shader",(function(){return lt}));var f={};r.r(f),r.d(f,"n",(function(){return ut})),r.d(f,"title",(function(){return pt})),r.d(f,"Shader",(function(){return dt}));var u={};r.r(u),r.d(u,"n",(function(){return ht})),r.d(u,"title",(function(){return mt})),r.d(u,"exportSize",(function(){return gt})),r.d(u,"exportStart",(function(){return bt})),r.d(u,"exportEnd",(function(){return yt})),r.d(u,"exportFramePerSecond",(function(){return xt})),r.d(u,"exportSpeed",(function(){return wt})),r.d(u,"Shader",(function(){return _t}));var p={};r.r(p),r.d(p,"n",(function(){return St})),r.d(p,"title",(function(){return Ot})),r.d(p,"Shader",(function(){return Rt}));var d={};r.r(d),r.d(d,"n",(function(){return zt})),r.d(d,"title",(function(){return Pt})),r.d(d,"Shader",(function(){return Ct}));var v={};r.r(v),r.d(v,"n",(function(){return jt})),r.d(v,"title",(function(){return At})),r.d(v,"Shader",(function(){return kt}));var h={};r.r(h),r.d(h,"n",(function(){return Lt})),r.d(h,"title",(function(){return Nt})),r.d(h,"Shader",(function(){return Mt}));var m={};r.r(m),r.d(m,"n",(function(){return Bt})),r.d(m,"title",(function(){return Ft})),r.d(m,"Shader",(function(){return qt}));var g={};r.r(g),r.d(g,"n",(function(){return Jt})),r.d(g,"title",(function(){return er})),r.d(g,"Shader",(function(){return tr}));var b={};r.r(b),r.d(b,"n",(function(){return ir})),r.d(b,"title",(function(){return ar})),r.d(b,"Shader",(function(){return sr}));var y={};r.r(y),r.d(y,"n",(function(){return lr})),r.d(y,"title",(function(){return fr})),r.d(y,"Shader",(function(){return ur}));var x={};r.r(x),r.d(x,"n",(function(){return dr})),r.d(x,"title",(function(){return vr})),r.d(x,"Shader",(function(){return hr}));var w={};r.r(w),r.d(w,"n",(function(){return gr})),r.d(w,"title",(function(){return br})),r.d(w,"Shader",(function(){return yr}));var _={};r.r(_),r.d(_,"n",(function(){return wr})),r.d(_,"title",(function(){return _r})),r.d(_,"Shader",(function(){return Er}));var E={};r.r(E),r.d(E,"n",(function(){return Rr})),r.d(E,"title",(function(){return Tr})),r.d(E,"Shader",(function(){return zr}));var S={};r.r(S),r.d(S,"n",(function(){return Ir})),r.d(S,"title",(function(){return jr})),r.d(S,"Shader",(function(){return Ar}));var O={};r.r(O),r.d(O,"n",(function(){return Dr})),r.d(O,"title",(function(){return Lr})),r.d(O,"Shader",(function(){return Nr}));var R={};r.r(R),r.d(R,"n",(function(){return Ur})),r.d(R,"title",(function(){return Br})),r.d(R,"Shader",(function(){return Fr}));var T={};r.r(T),r.d(T,"n",(function(){return $r})),r.d(T,"title",(function(){return Gr})),r.d(T,"Shader",(function(){return Hr}));var z={};r.r(z),r.d(z,"n",(function(){return Xr})),r.d(z,"title",(function(){return Kr})),r.d(z,"Shader",(function(){return Yr}));var P={};r.r(P),r.d(P,"n",(function(){return Jr})),r.d(P,"title",(function(){return en})),r.d(P,"exportSize",(function(){return tn})),r.d(P,"exportStart",(function(){return rn})),r.d(P,"exportEnd",(function(){return nn})),r.d(P,"exportFramePerSecond",(function(){return on})),r.d(P,"exportSpeed",(function(){return an})),r.d(P,"Shader",(function(){return sn}));var C={};r.r(C),r.d(C,"n",(function(){return fn})),r.d(C,"title",(function(){return un})),r.d(C,"Shader",(function(){return pn}));var I={};r.r(I),r.d(I,"n",(function(){return hn})),r.d(I,"title",(function(){return mn})),r.d(I,"Shader",(function(){return gn}));var j={};r.r(j),r.d(j,"n",(function(){return yn})),r.d(j,"title",(function(){return xn})),r.d(j,"Shader",(function(){return wn}));var A={};r.r(A),r.d(A,"n",(function(){return En})),r.d(A,"title",(function(){return Sn})),r.d(A,"Shader",(function(){return On}));var k={};r.r(k),r.d(k,"n",(function(){return Tn})),r.d(k,"title",(function(){return zn})),r.d(k,"Shader",(function(){return Cn}));var D={};r.r(D),r.d(D,"n",(function(){return jn})),r.d(D,"title",(function(){return An})),r.d(D,"Shader",(function(){return kn}));var L={};r.r(L),r.d(L,"n",(function(){return Ln})),r.d(L,"title",(function(){return Nn})),r.d(L,"Shader",(function(){return Mn}));var N={};r.r(N),r.d(N,"n",(function(){return Bn})),r.d(N,"title",(function(){return Fn})),r.d(N,"Shader",(function(){return qn}));var M={};r.r(M),r.d(M,"n",(function(){return Hn})),r.d(M,"title",(function(){return Vn})),r.d(M,"Shader",(function(){return Wn}));var U={};r.r(U),r.d(U,"n",(function(){return Yn})),r.d(U,"title",(function(){return Qn})),r.d(U,"Shader",(function(){return Zn}));var B={};r.r(B),r.d(B,"n",(function(){return eo})),r.d(B,"title",(function(){return to})),r.d(B,"Shader",(function(){return ro}));var F={};r.r(F),r.d(F,"n",(function(){return io})),r.d(F,"title",(function(){return ao})),r.d(F,"Shader",(function(){return so}));var q={};r.r(q),r.d(q,"n",(function(){return lo})),r.d(q,"title",(function(){return fo})),r.d(q,"Shader",(function(){return uo}));var $={};r.r($),r.d($,"n",(function(){return vo})),r.d($,"title",(function(){return ho})),r.d($,"Shader",(function(){return mo}));var G={};r.r(G),r.d(G,"n",(function(){return bo})),r.d(G,"title",(function(){return yo})),r.d(G,"Shader",(function(){return xo}));var H={};r.r(H),r.d(H,"n",(function(){return _o})),r.d(H,"title",(function(){return Eo})),r.d(H,"Shader",(function(){return So}));var V={};r.r(V),r.d(V,"n",(function(){return To})),r.d(V,"title",(function(){return zo})),r.d(V,"Shader",(function(){return Po}));var W={};r.r(W),r.d(W,"n",(function(){return Io})),r.d(W,"title",(function(){return jo})),r.d(W,"Shader",(function(){return Ao}));var X={};r.r(X),r.d(X,"n",(function(){return Do})),r.d(X,"title",(function(){return Lo})),r.d(X,"Shader",(function(){return No}));var K={};r.r(K),r.d(K,"n",(function(){return Uo})),r.d(K,"title",(function(){return Bo})),r.d(K,"Shader",(function(){return Fo}));var Y={};r.r(Y),r.d(Y,"n",(function(){return $o})),r.d(Y,"title",(function(){return Go})),r.d(Y,"Shader",(function(){return Ho}));var Q={};r.r(Q),r.d(Q,"n",(function(){return Wo})),r.d(Q,"title",(function(){return Xo})),r.d(Q,"exportSize",(function(){return Ko})),r.d(Q,"exportStart",(function(){return Yo})),r.d(Q,"exportEnd",(function(){return Qo})),r.d(Q,"exportFramePerSecond",(function(){return Zo})),r.d(Q,"exportSpeed",(function(){return Jo})),r.d(Q,"Shader",(function(){return ei}));var Z={};r.r(Z),r.d(Z,"n",(function(){return ni})),r.d(Z,"title",(function(){return oi})),r.d(Z,"Shader",(function(){return ii}));var J={};r.r(J),r.d(J,"n",(function(){return si})),r.d(J,"title",(function(){return ci})),r.d(J,"exportSize",(function(){return li})),r.d(J,"exportStart",(function(){return fi})),r.d(J,"exportEnd",(function(){return ui})),r.d(J,"exportFramePerSecond",(function(){return pi})),r.d(J,"exportSpeed",(function(){return di})),r.d(J,"Shader",(function(){return vi}));var ee={};r.r(ee),r.d(ee,"n",(function(){return mi})),r.d(ee,"title",(function(){return gi})),r.d(ee,"Shader",(function(){return bi}));var te={};r.r(te),r.d(te,"n",(function(){return xi})),r.d(te,"title",(function(){return wi})),r.d(te,"Shader",(function(){return _i}));var re={};r.r(re),r.d(re,"n",(function(){return Si})),r.d(re,"title",(function(){return Oi})),r.d(re,"Shader",(function(){return Ri}));var ne={};r.r(ne),r.d(ne,"n",(function(){return zi})),r.d(ne,"title",(function(){return Pi})),r.d(ne,"exportSize",(function(){return Ci})),r.d(ne,"exportStart",(function(){return Ii})),r.d(ne,"exportEnd",(function(){return ji})),r.d(ne,"exportFramePerSecond",(function(){return Ai})),r.d(ne,"exportSpeed",(function(){return ki})),r.d(ne,"Shader",(function(){return Di}));var oe={};r.r(oe),r.d(oe,"n",(function(){return Ni})),r.d(oe,"title",(function(){return Mi})),r.d(oe,"Shader",(function(){return Ui}));var ie={};r.r(ie),r.d(ie,"n",(function(){return Fi})),r.d(ie,"title",(function(){return qi})),r.d(ie,"exportSize",(function(){return $i})),r.d(ie,"exportStart",(function(){return Gi})),r.d(ie,"exportEnd",(function(){return Hi})),r.d(ie,"exportFramePerSecond",(function(){return Vi})),r.d(ie,"exportSpeed",(function(){return Wi})),r.d(ie,"Shader",(function(){return Xi}));var ae={};r.r(ae),r.d(ae,"exportSize",(function(){return Zi})),r.d(ae,"exportStart",(function(){return Ji})),r.d(ae,"exportEnd",(function(){return ea})),r.d(ae,"exportFramePerSecond",(function(){return ta})),r.d(ae,"exportSpeed",(function(){return ra})),r.d(ae,"exportMP4vb",(function(){return na})),r.d(ae,"n",(function(){return oa})),r.d(ae,"title",(function(){return ia})),r.d(ae,"nfts",(function(){return aa})),r.d(ae,"Shader",(function(){return ca}));var se={};r.r(se),r.d(se,"n",(function(){return ua})),r.d(se,"title",(function(){return pa})),r.d(se,"description",(function(){return da})),r.d(se,"Shader",(function(){return va}));var ce={};r.r(ce),r.d(ce,"n",(function(){return ga})),r.d(ce,"title",(function(){return ba})),r.d(ce,"Shader",(function(){return ya}));var le={};r.r(le),r.d(le,"n",(function(){return wa})),r.d(le,"title",(function(){return _a})),r.d(le,"exportEnd",(function(){return Ea})),r.d(le,"exportFramePerSecond",(function(){return Sa})),r.d(le,"preload",(function(){return Oa})),r.d(le,"Shader",(function(){return Ra}));var fe={};r.r(fe),r.d(fe,"n",(function(){return za})),r.d(fe,"title",(function(){return Pa})),r.d(fe,"exportEnd",(function(){return Ca})),r.d(fe,"exportFramePerSecond",(function(){return Ia})),r.d(fe,"exportSpeed",(function(){return ja})),r.d(fe,"Logic",(function(){return Aa})),r.d(fe,"Shader",(function(){return Ma}));var ue={};r.r(ue),r.d(ue,"n",(function(){return Fa})),r.d(ue,"title",(function(){return qa})),r.d(ue,"exportSize",(function(){return $a})),r.d(ue,"exportStart",(function(){return Ga})),r.d(ue,"exportEnd",(function(){return Ha})),r.d(ue,"exportFramePerSecond",(function(){return Va})),r.d(ue,"exportSpeed",(function(){return Wa})),r.d(ue,"exportMP4vb",(function(){return Xa})),r.d(ue,"Logic",(function(){return Ya})),r.d(ue,"Shader",(function(){return es}));var pe={};r.r(pe),r.d(pe,"n",(function(){return rs})),r.d(pe,"title",(function(){return ns})),r.d(pe,"exportEnd",(function(){return os})),r.d(pe,"nfts",(function(){return is})),r.d(pe,"Shader",(function(){return as}));var de={};r.r(de),r.d(de,"n",(function(){return cs})),r.d(de,"title",(function(){return ls})),r.d(de,"exportSize",(function(){return fs})),r.d(de,"exportStart",(function(){return us})),r.d(de,"exportEnd",(function(){return ps})),r.d(de,"exportFramePerSecond",(function(){return ds})),r.d(de,"exportSpeed",(function(){return vs})),r.d(de,"exportSkipFrame",(function(){return hs})),r.d(de,"exportPaletteGenOnce",(function(){return ms})),r.d(de,"exportPaletteSize",(function(){return gs})),r.d(de,"nfts",(function(){return bs})),r.d(de,"Shader",(function(){return ys}));var ve={};r.r(ve),r.d(ve,"n",(function(){return _s})),r.d(ve,"title",(function(){return Es})),r.d(ve,"exportSize",(function(){return Ss})),r.d(ve,"exportStart",(function(){return Os})),r.d(ve,"exportEnd",(function(){return Rs})),r.d(ve,"exportFramePerSecond",(function(){return Ts})),r.d(ve,"exportSpeed",(function(){return zs})),r.d(ve,"exportSkipFrame",(function(){return Ps})),r.d(ve,"exportPaletteGenOnce",(function(){return Cs})),r.d(ve,"exportPaletteSize",(function(){return Is})),r.d(ve,"Shader",(function(){return js}));var he={};r.r(he),r.d(he,"n",(function(){return Ds})),r.d(he,"title",(function(){return Ls})),r.d(he,"exportSize",(function(){return Ns})),r.d(he,"exportStart",(function(){return Ms})),r.d(he,"exportEnd",(function(){return Us})),r.d(he,"exportFramePerSecond",(function(){return Bs})),r.d(he,"exportSpeed",(function(){return Fs})),r.d(he,"exportSkipFrame",(function(){return qs})),r.d(he,"exportPaletteGenOnce",(function(){return $s})),r.d(he,"exportPaletteSize",(function(){return Gs})),r.d(he,"Shader",(function(){return Hs}));var me={};r.r(me),r.d(me,"n",(function(){return Xs})),r.d(me,"title",(function(){return Ks})),r.d(me,"exportSize",(function(){return Ys})),r.d(me,"exportStart",(function(){return Qs})),r.d(me,"exportEnd",(function(){return Zs})),r.d(me,"exportFramePerSecond",(function(){return Js})),r.d(me,"exportSpeed",(function(){return ec})),r.d(me,"exportSkipFrame",(function(){return tc})),r.d(me,"exportPaletteGenOnce",(function(){return rc})),r.d(me,"exportPaletteSize",(function(){return nc})),r.d(me,"Shader",(function(){return oc}));var ge={};r.r(ge),r.d(ge,"n",(function(){return sc})),r.d(ge,"title",(function(){return cc})),r.d(ge,"exportSize",(function(){return lc})),r.d(ge,"exportStart",(function(){return fc})),r.d(ge,"exportEnd",(function(){return uc})),r.d(ge,"exportFramePerSecond",(function(){return pc})),r.d(ge,"exportSpeed",(function(){return dc})),r.d(ge,"exportPaletteGenOnce",(function(){return vc})),r.d(ge,"exportPaletteSize",(function(){return hc})),r.d(ge,"Shader",(function(){return mc}));var be={};r.r(be),r.d(be,"n",(function(){return bc})),r.d(be,"title",(function(){return yc})),r.d(be,"exportSize",(function(){return xc})),r.d(be,"exportStart",(function(){return wc})),r.d(be,"exportEnd",(function(){return _c})),r.d(be,"exportFramePerSecond",(function(){return Ec})),r.d(be,"exportSpeed",(function(){return Sc})),r.d(be,"exportPaletteGenOnce",(function(){return Oc})),r.d(be,"exportPaletteSize",(function(){return Rc})),r.d(be,"Shader",(function(){return Tc}));var ye={};r.r(ye),r.d(ye,"n",(function(){return Pc})),r.d(ye,"title",(function(){return Cc})),r.d(ye,"exportSize",(function(){return Ic})),r.d(ye,"exportStart",(function(){return jc})),r.d(ye,"exportEnd",(function(){return Ac})),r.d(ye,"exportFramePerSecond",(function(){return kc})),r.d(ye,"exportSpeed",(function(){return Dc})),r.d(ye,"exportPaletteGenOnce",(function(){return Lc})),r.d(ye,"exportPaletteSize",(function(){return Nc})),r.d(ye,"Shader",(function(){return Mc}));var xe={};r.r(xe),r.d(xe,"n",(function(){return Bc})),r.d(xe,"title",(function(){return Fc})),r.d(xe,"exportSize",(function(){return qc})),r.d(xe,"exportStart",(function(){return $c})),r.d(xe,"exportEnd",(function(){return Gc})),r.d(xe,"exportFramePerSecond",(function(){return Hc})),r.d(xe,"exportSpeed",(function(){return Vc})),r.d(xe,"exportPaletteGenOnce",(function(){return Wc})),r.d(xe,"exportPaletteSize",(function(){return Xc})),r.d(xe,"nfts",(function(){return Kc})),r.d(xe,"Shader",(function(){return Yc}));var we={};r.r(we),r.d(we,"n",(function(){return Zc})),r.d(we,"title",(function(){return Jc})),r.d(we,"exportSize",(function(){return el})),r.d(we,"exportStart",(function(){return tl})),r.d(we,"exportEnd",(function(){return rl})),r.d(we,"exportFramePerSecond",(function(){return nl})),r.d(we,"exportSpeed",(function(){return ol})),r.d(we,"exportPaletteGenOnce",(function(){return il})),r.d(we,"exportPaletteSize",(function(){return al})),r.d(we,"Shader",(function(){return cl}));var _e={};r.r(_e),r.d(_e,"n",(function(){return fl})),r.d(_e,"title",(function(){return ul})),r.d(_e,"exportSize",(function(){return pl})),r.d(_e,"exportStart",(function(){return dl})),r.d(_e,"exportEnd",(function(){return vl})),r.d(_e,"exportFramePerSecond",(function(){return hl})),r.d(_e,"exportSpeed",(function(){return ml})),r.d(_e,"exportPaletteGenOnce",(function(){return gl})),r.d(_e,"exportPaletteSize",(function(){return bl})),r.d(_e,"Shader",(function(){return xl}));var Ee={};r.r(Ee),r.d(Ee,"n",(function(){return _l})),r.d(Ee,"title",(function(){return El})),r.d(Ee,"exportSize",(function(){return Sl})),r.d(Ee,"exportStart",(function(){return Ol})),r.d(Ee,"exportEnd",(function(){return Rl})),r.d(Ee,"exportFramePerSecond",(function(){return Tl})),r.d(Ee,"exportSpeed",(function(){return zl})),r.d(Ee,"exportPaletteGenOnce",(function(){return Pl})),r.d(Ee,"exportPaletteSize",(function(){return Cl})),r.d(Ee,"Shader",(function(){return jl}));var Se=r("nKUr"),Oe=r("rr/c");const Re=1,Te="Hello 2020",ze=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:Pe.day001,uniforms:{time:e}}),Pe=Oe.Shaders.create({day001:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
float vingt (vec2 p) {
...
}`}}),Ce=2,Ie="stripes",je=400,Ae=0,ke=60,De=24,Le=1,Ne=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:Me.node,uniforms:{time:e}}),Me=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),Ue=3,Be="zephyr",Fe=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:qe.node,uniforms:{time:e}}),qe=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}});var $e=r("q1tI"),Ge=r.n($e);const He=Oe.Shaders.create({InitGameOfLife:{frag:Oe.GLSL`
  precision highp float;
  uniform float seed;
  // i
  varying vec2 uv;
  ...
  }`}}),Ve=Ge.a.memo((({tick:e,size:t,refreshEveryTicks:r})=>e%(r||1/0)===0?Object(Se.jsx)(Oe.Node,{shader:He.InitGameOfLife,uniforms:{seed:Math.random()},width:t,height:t,backbuffering:!0,sync:!0}):Object(Se.jsx)(Oe.Node,{shader:He.GameOfLife,width:t,height:t,backbuffering:!0,sync:!0,uniforms:{t:Oe.Uniform.Backbuffer,size:t}}))),We=4,Xe="Ray of Life";let Ke;const Ye=({time:e})=>{Ke||(Ke=e);const t=e-Ke,r=Math.floor(10*t),n=r+25,o=10*(1+Math.floor(r/50)),i=10*(1+Math.floor(n/50));return Object(Se.jsx)(Qe,{time:e,a:Object(Se.jsx)(Oe.NearestCopy,{children:Object(Se.jsx)(Ve,{refreshEveryTicks:50,tick:r,size:o})}),b:Object(Se.jsx)(Oe.NearestCopy,{children:Object(Se.jsx)(Ve,{refreshEveryTicks:50,tick:n,size:i})})})},Qe=({a:e,b:t,time:r})=>Object(Se.jsx)(Oe.Node,{uniforms:{a:e,b:t,time:r},shader:Ze.main}),Ze=Oe.Shaders.create({main:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Je=5,et="Here We Go Again",tt=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:rt.node,uniforms:{time:e}}),rt=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    sqrt(vec3(1. - shad));
  gl_FragColor = vec4(c,1.0);
}`}}),nt=6,ot="Bestagons",it=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:at.node,uniforms:{time:e}}),at=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),st=7,ct="Worms party",lt=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:ft.node,uniforms:{time:e}}),ft=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    sqrt(vec3(1. - shad));
  gl_FragColor = vec4(c,1.0);
}`}}),ut=8,pt="moontains",dt=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:vt.node,uniforms:{time:e}}),vt=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),ht=9,mt="Virus",gt=400,bt=16.3,yt=26,xt=24,wt=.8,_t=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:Et.node,uniforms:{time:e}}),Et=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),St=10,Ot="ring",Rt=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:Tt.node,uniforms:{time:e}}),Tt=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),zt=11,Pt="magic mouse",Ct=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:It.node,uniforms:{time:e}}),It=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),jt=12,At="floor is lava",kt=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:Dt.node,uniforms:{time:e}}),Dt=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Lt=13,Nt="chip",Mt=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:Ut.node,uniforms:{time:e}}),Ut=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
`}}),Bt=14,Ft="seizure",qt=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:$t.node,uniforms:{time:e}}),$t=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Gt=Oe.Shaders.create({blur1D:{frag:Oe.GLSL`precision highp float;
varying vec2 uv;
uniform sampler2D t;
...
}`}});var Ht=({width:e,height:t,pixelRatio:r,direction:n,children:o})=>Object(Se.jsx)(Oe.Node,{shader:Gt.blur1D,width:e,height:t,pixelRatio:r,uniforms:{direction:n,resolution:Oe.Uniform.Resolution,t:o}});const Vt=Math.sqrt(2)/2;var Wt=(e,t,r)=>{const n=2*t*Math.ceil(e/2)/r;switch((e-1)%4){case 0:return[n,0];case 1:return[0,n];case 2:return[n*Vt,n*Vt];case 3:return[n*Vt,-n*Vt]}};const Xt=({width:e,height:t,pixelRatio:r,factor:n,children:o,passes:i,directionForPass:a})=>{const s=c=>c<=0?o:Object(Se.jsx)(Ht,{width:e,height:t,pixelRatio:r,direction:a(c,n,i),children:s(c-1)});return s(i)};Xt.defaultProps={passes:2,directionForPass:Wt};var Kt=Xt;const Yt=Oe.Shaders.create({blur1D:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
...
}`}});var Qt=({width:e,height:t,map:r,pixelRatio:n,direction:o,children:i})=>Object(Se.jsx)(Oe.Node,{shader:Yt.blur1D,width:e,height:t,pixelRatio:n,uniforms:{direction:o,resolution:Oe.Uniform.Resolution,t:i,map:r}});const Zt=({width:e,height:t,map:r,pixelRatio:n,factor:o,children:i,passes:a,directionForPass:s})=>{const c=l=>l<=0?i:Object(Se.jsx)(Qt,{width:e,height:t,map:r,pixelRatio:n,direction:s(l,o,a),children:c(l-1)});return c(a)};Zt.defaultProps={passes:2,directionForPass:Wt};const Jt=15,er="parametric",tr=({time:e})=>Object(Se.jsx)(Oe.LinearCopy,{children:Object(Se.jsx)(nr,{persistence:.98+.02*Math.cos(e)+-.8*Math.exp(-e),children:Object(Se.jsx)(Kt,{passes:4,factor:.2,children:Object(Se.jsx)(rr,{time:e})})})}),rr=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:or.node,uniforms:{time:e}}),nr=({children:e,persistence:t})=>Object(Se.jsx)(Oe.Node,{shader:or.persistence,backbuffering:!0,uniforms:{t:e,back:Oe.Uniform.Backbuffer,persistence:t}}),or=Oe.Shaders.create({persistence:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),ir=16,ar="reuleaux",sr=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:cr.node,uniforms:{time:e}}),cr=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    color(0.5 * time);
  gl_FragColor = vec4(c, 1.0);
}`}}),lr=17,fr="screws",ur=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:pr.node,uniforms:{time:e}}),pr=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),dr=18,vr="queen",hr=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:mr.node,uniforms:{time:e}}),mr=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
}`}}),gr=19,br="they were six",yr=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:xr.node,uniforms:{time:e}}),xr=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),wr=20,_r="trippy tiles",Er=({time:e})=>Object(Se.jsx)(Oe.LinearCopy,{children:Object(Se.jsx)(Sr,{persistence:.85,children:Object(Se.jsx)(Oe.Node,{shader:Or.node,uniforms:{time:e}})})}),Sr=({children:e,persistence:t})=>Object(Se.jsx)(Oe.Node,{shader:Or.persistence,backbuffering:!0,uniforms:{t:e,back:Oe.Uniform.Backbuffer,persistence:t}}),Or=Oe.Shaders.create({persistence:{frag:Oe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Rr=21,Tr="HODL",zr=({time:e})=>Object(Se.jsx)(Oe.LinearCopy,{children:Object(Se.jsx)(Pr,{persistence:Math.min(.99,.015*e),time:e,children:Object(Se.jsx)(Oe.Node,{shader:Cr.node,uniforms:{time:e}})})}),Pr=({children:e,persistence:t,time:r})=>Object(Se.jsx)(Oe.Node,{shader:Cr.shakePersistence,backbuffering:!0,uniforms:{t:e,back:Oe.Uniform.Backbuffer,persistence:t,time:r}}),Cr=Oe.Shaders.create({shakePersistence:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform sampler2D t, back;
uniform float time;
...
}`}}),Ir=22,jr="atoms",Ar=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:kr.node,uniforms:{time:e,t:"/images/einstein-tongue-out.jpg"}}),kr=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D t;
...
void main() {
...
}`}}),Dr=23,Lr="Hexacubes",Nr=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:Mr.node,uniforms:{time:e}}),Mr=Oe.Shaders.create({node:{frag:Oe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform float time;
  const float PI = ${Math.PI};
  ...
  void main() {
    ...
    gl_FragColor = vec4(c, 1.0);
      ...
      `}}),Ur=24,Br="dark cubes",Fr=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:qr.node,uniforms:{time:e}}),qr=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),$r=25,Gr="Mandelbrot",Hr=({time:e})=>Object(Se.jsx)(Oe.LinearCopy,{children:Object(Se.jsx)(Vr,{persistence:.9,children:Object(Se.jsx)(Kt,{passes:4,factor:.1,children:Object(Se.jsx)(Oe.Node,{shader:Wr.node,uniforms:{time:e}})})})}),Vr=({children:e,persistence:t})=>Object(Se.jsx)(Oe.Node,{shader:Wr.persistence,backbuffering:!0,uniforms:{t:e,back:Oe.Uniform.Backbuffer,persistence:t}}),Wr=Oe.Shaders.create({persistence:{frag:Oe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Xr=26,Kr="fumes",Yr=({time:e})=>Object(Se.jsx)(Oe.LinearCopy,{children:Object(Se.jsx)(Qr,{persistence:.9,children:Object(Se.jsx)(Kt,{passes:4,factor:Math.min(.6,.01*e),children:Object(Se.jsx)(Oe.Node,{shader:Zr.node,uniforms:{time:e}})})})}),Qr=({children:e,persistence:t})=>Object(Se.jsx)(Oe.Node,{shader:Zr.persistence,backbuffering:!0,uniforms:{t:e,back:Oe.Uniform.Backbuffer,persistence:t}}),Zr=Oe.Shaders.create({persistence:{frag:Oe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Jr=27,en="real burning ship",tn=400,rn=0,nn=60,on=12,an=2,sn=({time:e})=>Object(Se.jsx)(Oe.LinearCopy,{children:Object(Se.jsx)(cn,{persistence:.8+.05*Math.random(),time:e,children:Object(Se.jsx)(Oe.Node,{shader:ln.node,uniforms:{time:e}})})}),cn=({children:e,persistence:t,time:r})=>Object(Se.jsx)(Oe.Node,{shader:ln.persistence,backbuffering:!0,uniforms:{t:e,back:Oe.Uniform.Backbuffer,persistence:t,time:r}}),ln=Oe.Shaders.create({persistence:{frag:Oe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),fn=28,un="No, I'M Batman",pn=({time:e})=>Object(Se.jsx)(Oe.LinearCopy,{children:Object(Se.jsx)(dn,{persistence:.5+.48*Math.min(1,e/60),children:Object(Se.jsx)(Oe.Node,{shader:vn.node,uniforms:{time:e}})})}),dn=({children:e,persistence:t})=>Object(Se.jsx)(Oe.Node,{shader:vn.persistence,backbuffering:!0,uniforms:{t:e,back:Oe.Uniform.Backbuffer,persistence:t}}),vn=Oe.Shaders.create({persistence:{frag:Oe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),hn=29,mn="sdBitcoin(p)",gn=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:bn.node,uniforms:{time:e}}),bn=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),yn=30,xn="21 millions",wn=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:_n.node,uniforms:{time:e,numberInCirculation:18557031}}),_n=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),En=31,Sn="alien tower",On=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:Rn.node,uniforms:{time:e,numberInCirculation:18557031}}),Rn=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform float numberInCirculation;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Tn=32,zn="GoL valley";let Pn;const Cn=({time:e})=>{Pn||(Pn=e);const t=e-Pn,r=Math.floor(12*t);return Object(Se.jsx)(Oe.Node,{shader:In.node,uniforms:{time:e,t:Object(Se.jsx)(Ve,{refreshEveryTicks:100,tick:r,size:100})}})},In=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D t;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),jn=33,An="x(x+32y)%(tN+1)%n";const kn=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:Dn.node,uniforms:{time:e}}),Dn=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Ln=34,Nn="\u230a2cos(x)sin(y+t)\u230b%7";const Mn=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:Un.node,uniforms:{time:e}}),Un=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
#define PI ${Math.PI}
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Bn=35,Fn="aie confiance",qn=({time:e})=>Object(Se.jsx)(Oe.LinearCopy,{children:Object(Se.jsx)($n,{persistence:.6,children:Object(Se.jsx)(Oe.Node,{shader:Gn.node,uniforms:{time:e}})})}),$n=({children:e,persistence:t})=>Object(Se.jsx)(Oe.Node,{shader:Gn.persistence,backbuffering:!0,uniforms:{t:e,back:Oe.Uniform.Backbuffer,persistence:t}}),Gn=Oe.Shaders.create({persistence:{frag:Oe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Hn=36,Vn="crois en moi",Wn=({time:e})=>Object(Se.jsx)(Oe.LinearCopy,{children:Object(Se.jsx)(Xn,{children:Object(Se.jsx)(Oe.Node,{shader:Kn.node,uniforms:{time:e}})})}),Xn=({children:e,persistence:t})=>Object(Se.jsx)(Oe.Node,{shader:Kn.persistence,backbuffering:!0,uniforms:{t:e,back:Oe.Uniform.Backbuffer,persistence:t}}),Kn=Oe.Shaders.create({persistence:{frag:Oe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Yn=37,Qn="sdBrick",Zn=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:Jn.node,uniforms:{time:e}}),Jn=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),eo=38,to="Golden mandelbulb",ro=({time:e})=>Object(Se.jsx)(Oe.LinearCopy,{children:Object(Se.jsx)(no,{persistence:.5,children:Object(Se.jsx)(Oe.Node,{shader:oo.node,uniforms:{time:e}})})}),no=({children:e,persistence:t})=>Object(Se.jsx)(Oe.Node,{shader:oo.persistence,backbuffering:!0,uniforms:{t:e,back:Oe.Uniform.Backbuffer,persistence:t}}),oo=Oe.Shaders.create({persistence:{frag:Oe.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  clr /= 4.;
  gl_FragColor = vec4(clr, 1.0);
}`}}),io=39,ao="metaballs",so=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:co.node,uniforms:{time:e}}),co=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  clr /= 4.;
  gl_FragColor = vec4(clr, 1.0);
}`}}),lo=40,fo="pen-o-plasma",uo=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:po.node,uniforms:{time:e}}),po=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(clr, 1.0);
}`}}),vo=41,ho="reflection",mo=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:go.node,uniforms:{time:e}}),go=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),bo=42,yo="reflection party",xo=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:wo.node,uniforms:{time:e}}),wo=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c = mix(c, reflection(p, n, 10.), glossy);
  gl_FragColor = vec4(c, 1.0);
}`}}),_o=43,Eo="irreconcilable queens",So=({time:e})=>Object(Se.jsx)(Oe.LinearCopy,{children:Object(Se.jsx)(Oo,{persistence:.4,children:Object(Se.jsx)(Oe.Node,{shader:Ro.node,uniforms:{time:e}})})}),Oo=({children:e,persistence:t})=>Object(Se.jsx)(Oe.Node,{shader:Ro.persistence,backbuffering:!0,uniforms:{t:e,back:Oe.Uniform.Backbuffer,persistence:t}}),Ro=Oe.Shaders.create({persistence:{frag:Oe.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),To=44,zo="royal meeting",Po=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:Co.node,uniforms:{time:e}}),Co=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
#define PI ${Math.PI}
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),Io=45,jo="wood pawns army",Ao=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:ko.node,uniforms:{time:e,wood:"/images/seamless-wood-background-1.jpg"}}),ko=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),Do=46,Lo="Bank of Bicoin",No=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:Mo.node,uniforms:{time:e}}),Mo=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),Uo=47,Bo="glow experiment",Fo=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:qo.node,uniforms:{time:e}}),qo=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),$o=48,Go="Starry Night",Ho=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:Vo.node,uniforms:{time:e,img:"/images/seamless-wood2.jpg"}}),Vo=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(clr, 1.0);
}`}}),Wo=49,Xo="chinese lantern",Ko=400,Yo=0,Qo=20,Zo=24,Jo=1.1,ei=({time:e})=>Object(Se.jsx)(Oe.LinearCopy,{children:Object(Se.jsx)(ti,{persistence:.8,children:Object(Se.jsx)(Oe.Node,{shader:ri.node,uniforms:{time:e}})})}),ti=({children:e,persistence:t})=>Object(Se.jsx)(Oe.Node,{shader:ri.persistence,backbuffering:!0,uniforms:{t:e,back:Oe.Uniform.Backbuffer,persistence:t}}),ri=Oe.Shaders.create({persistence:{frag:Oe.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  clr += c;
  gl_FragColor = vec4(clr, 1.0);
}`}}),ni=50,oi="jumpy rooks",ii=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:ai.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),ai=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),si=51,ci="symmetry chess",li=400,fi=0,ui=20,pi=24,di=1,vi=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:hi.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),hi=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),mi=52,gi="knights dance",bi=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:yi.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),yi=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),xi=53,wi="cross waves",_i=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:Ei.node,uniforms:{time:e}}),Ei=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  */
}`}}),Si=54,Oi="chess set",Ri=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:Ti.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),Ti=Oe.Shaders.create({node:{frag:Oe.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  color = vec4(c, 1.0);
}`}}),zi=55,Pi="cube d'or",Ci=400,Ii=0,ji=20,Ai=24,ki=1,Di=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:Li.node,uniforms:{time:e}}),Li=Oe.Shaders.create({node:{frag:Oe.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  #endif
  color = vec4(c, 1.0);
}`}}),Ni=56,Mi="jade forest",Ui=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:Bi.node,uniforms:{time:e}}),Bi=Oe.Shaders.create({node:{frag:Oe.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  color = vec4(c, 1.0);
}`}}),Fi=57,qi="Virus v2",$i=400,Gi=0,Hi=20,Vi=24,Wi=.8,Xi=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:Ki.node,uniforms:{time:e}}),Ki=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}});var Yi=r("005v"),Qi=r.n(Yi);const Zi=400,Ji=0,ea=30,ta=20,ra=1,na="5M",oa=58,ia="Mandelglitch",aa=[{url:"https://ethblock.art/create/17",text:"Mint on ethblock.art"},{url:"https://ghostmarket.io/asset/pha/ghost/3008841254969814369262311336331954453497120774334547905246474374493804042898/",text:"ghostmarket.io: 400 KCAL"},{url:"https://www.hicetnunc.xyz/objkt/3063",text:"hicetnunc.xyz: Mandelglitch #1 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3068",text:"hicetnunc.xyz: Mandelglitch #2 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3071",text:"hicetnunc.xyz: Mandelglitch #3 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3072",text:"hicetnunc.xyz: Mandelglitch #4 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3073",text:"hicetnunc.xyz: Mandelglitch #5 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3077",text:"hicetnunc.xyz: Mandelglitch #6 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3088",text:"hicetnunc.xyz: Mandelglitch #7 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3574",text:"hicetnunc.xyz: Mandelglitch #8 (5 XTZ)"}];const sa=e=>e<.5?2*e*e:(4-2*e)*e-1;const ca=({time:e,n:t,exporting:r})=>{const n=Object($e.useMemo)((()=>function(e,t=0){const r=e?3:50,n=new Qi.a(t);return Array(r).fill(null).map((()=>Array(12).fill(null).map((()=>n.random()))))}(r,t)),[t,r]),o=e/10%n.length,i=Math.floor(o),a=o-i;let[s,c,l,f,u,p,d,v,h,m,g,b]=(y=n[i%n.length],x=n[(i+1)%n.length],w=sa(a),y.map(((e,t)=>e*(1-w)+x[t]*w)));var y,x,w;return l=sa(l),Object(Se.jsx)(Oe.LinearCopy,{children:Object(Se.jsx)(fa,{persistence:r?0:.8,children:Object(Se.jsx)(Oe.Node,{shader:la.main,uniforms:{aa:r?2:0,time:e,resolution:Oe.Uniform.Resolution,travel:s,love:c,dark:l,rot:r?2*Math.PI/ea:.1,s1:f,s2:u,s3:p,s4:d,s5:v,s6:h,s7:m,s8:g,s9:b}})})})},la=Oe.Shaders.create({persistence:{frag:Oe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  `}}),fa=({children:e,persistence:t})=>Object(Se.jsx)(Oe.Node,{shader:la.persistence,backbuffering:!0,uniforms:{t:e,back:Oe.Uniform.Backbuffer,persistence:t}}),ua=59,pa="Pixels 256",da="There will be only 256 patterns generated by this single fragment shader.",va=({time:e,n:t,exporting:r})=>Object(Se.jsx)(ha,{n:t+1+(r?0:Math.floor(e))}),ha=Ge.a.memo((({n:e})=>{const t=new Qi.a(e%256),r=t.random(),n=t.random(),o=t.random(),i=t.random(),a=t.random(),s=t.random();return Object(Se.jsx)(Oe.Node,{shader:ma.node,uniforms:{s1:r,s2:n,s3:o,s4:i,s5:a,s6:s}})})),ma=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),ga=60,ba="Bitcoin rainbow",ya=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:xa.node,uniforms:{time:e}}),xa=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),wa=61,_a="Binance gradients",Ea=1,Sa=30,Oa=["/images/shaders/binance.dist.png"],Ra=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:Ta.node,uniforms:{time:e,image:"/images/shaders/binance.dist.png"}}),Ta=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),za=62,Pa="Overgrowth",Ca=20,Ia=40,ja=1,Aa=({generation:e,size:t,n:r})=>Object(Se.jsx)(Oe.Node,{width:t,height:t,shader:Ua.logic,uniforms:{generation:e,prev:Oe.Uniform.Backbuffer,size:t,seed:r/100},backbuffering:!0}),ka=Ge.a.memo(Aa),Da=({time:e,generation:t,n:r})=>Object(Se.jsx)(Oe.Node,{shader:Ua.render,uniforms:{time:e,logic:Object(Se.jsx)(ka,{generation:t,size:140,n:r})},uniformsOptions:{logic:{interpolation:"nearest"}}}),La=Ge.a.memo(Da),Na=1e3*Math.random(),Ma=({time:e,n:t})=>Object(Se.jsx)(La,{n:t+Na,time:e,generation:Math.floor(30*e)},t),Ua=Oe.Shaders.create({logic:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
...
`}});var Ba=r("AJhG");const Fa=63,qa="Relics",$a=400,Ga=2,Ha=4,Va=20,Wa=1,Xa="5M",Ka={colors:[.7,.55,.4],logicSize:80,amp:1,base:2,persistance:.89,delta:.5,seed:0};console.log(Object.keys(Ka).map((e=>String(Ka[e]))).join("_"));const Ya=({g:e,size:t,seed:r,amp:n,base:o,persistance:i,delta:a})=>Object(Se.jsx)(Oe.Node,{width:t,height:t,shader:ts.logic,uniforms:{amp:n,base:o,g:e,prev:Oe.Uniform.Backbuffer,size:t,seed:r,persistance:i,delta:a},backbuffering:!0},t),Qa=Ge.a.memo(Ya),Za=({g:e,colors:t,amp:r,base:n,persistance:o,delta:i,logicSize:a,seed:s})=>Object(Se.jsx)(Oe.Node,{shader:ts.render,uniforms:{colors:t,logic:Object(Se.jsx)(Qa,{amp:r,base:n,g:e,size:a,seed:s,persistance:o,delta:i})},uniformsOptions:{logic:{interpolation:"nearest"}}}),Ja=Ge.a.memo(Za),es=({time:e})=>{const{colors:t,logicSize:r,amp:n,base:o,persistance:i,delta:a,seed:s}=Object(Ba.b)(Ka);return Object(Se.jsx)(Ja,{amp:n,base:o,g:Math.floor(20*e)%40,colors:t,persistance:i,delta:a,seed:s,logicSize:r})},ts=Oe.Shaders.create({logic:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform sampler2D prev;
uniform float g;
...
`}}),rs=64,ns="Intersection",os=8*Math.PI,is=[{url:"https://www.hicetnunc.xyz/objkt/28592",text:"hic et nunc NFT"}],as=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:ss.render,uniforms:{resolution:Oe.Uniform.Resolution,time:e}}),ss=Oe.Shaders.create({render:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform vec2 resolution;
...
`}}),cs=65,ls="Duality",fs=800,us=4,ps=8,ds=30,vs=1,hs=3,ms=!0,gs=16,bs=[{url:"https://hicetnunc.xyz/objkt/64326",text:"hic et nunc NFT"}],ys=({time:e})=>Object(Se.jsx)(Oe.NearestCopy,{children:Object(Se.jsx)(xs,{persistence:.3,children:Object(Se.jsx)(Oe.Node,{shader:ws.render,uniforms:{resolution:Oe.Uniform.Resolution,time:e}})})}),xs=({children:e,persistence:t})=>Object(Se.jsx)(Oe.Node,{shader:ws.persistence,backbuffering:!0,uniforms:{t:e,back:Oe.Uniform.Backbuffer,persistence:t}}),ws=Oe.Shaders.create({persistence:{frag:Oe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),_s=66,Es="hicetnunc",Ss=800,Os=2,Rs=Os+8,Ts=30,zs=1,Ps=7,Cs=!0,Is=16,js=({time:e})=>Object(Se.jsx)(Oe.NearestCopy,{children:Object(Se.jsx)(As,{persistence:.5,children:Object(Se.jsx)(Oe.Node,{shader:ks.render,uniforms:{resolution:Oe.Uniform.Resolution,time:e,freq:2}})})}),As=({children:e,persistence:t})=>Object(Se.jsx)(Oe.Node,{shader:ks.persistence,backbuffering:!0,uniforms:{t:e,back:Oe.Uniform.Backbuffer,persistence:t}}),ks=Oe.Shaders.create({persistence:{frag:Oe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Ds=67,Ls="Jumping blob",Ns=800,Ms=2,Us=Ms+8,Bs=30,Fs=1,qs=7,$s=!0,Gs=16,Hs=({time:e})=>Object(Se.jsx)(Oe.NearestCopy,{children:Object(Se.jsx)(Vs,{persistence:.6,children:Object(Se.jsx)(Oe.Node,{shader:Ws.render,uniforms:{resolution:Oe.Uniform.Resolution,time:e,freq:2}})})}),Vs=({children:e,persistence:t})=>Object(Se.jsx)(Oe.Node,{shader:Ws.persistence,backbuffering:!0,uniforms:{t:e,back:Oe.Uniform.Backbuffer,persistence:t}}),Ws=Oe.Shaders.create({persistence:{frag:Oe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Xs=68,Ks="ring",Ys=800,Qs=2,Zs=Qs+10,Js=30,ec=1,tc=7,rc=!0,nc=128,oc=({time:e})=>Object(Se.jsx)(Oe.NearestCopy,{children:Object(Se.jsx)(ic,{persistence:.9,children:Object(Se.jsx)(Oe.Node,{shader:ac.render,uniforms:{resolution:Oe.Uniform.Resolution,time:e,freq:2}})})}),ic=({children:e,persistence:t})=>Object(Se.jsx)(Oe.Node,{shader:ac.persistence,backbuffering:!0,uniforms:{t:e,back:Oe.Uniform.Backbuffer,persistence:t}}),ac=Oe.Shaders.create({persistence:{frag:Oe.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),sc=69,cc="Bananas paradize",lc=400,fc=0,uc=20,pc=20,dc=1,vc=!0,hc=128,mc=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:gc.node,uniforms:{time:e,resolution:Oe.Uniform.Resolution}}),gc=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),bc=70,yc="warp1",xc=400,wc=0,_c=20,Ec=20,Sc=1,Oc=!1,Rc=256,Tc=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:zc.node,uniforms:{time:e,resolution:Oe.Uniform.Resolution}}),zc=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),Pc=71,Cc="warp2",Ic=640,jc=0,Ac=20,kc=24,Dc=1,Lc=!1,Nc=256,Mc=({time:e})=>Object(Se.jsx)(Oe.Node,{shader:Uc.node,uniforms:{time:e}}),Uc=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),Bc=72,Fc="Planet Hole",qc=640,$c=0,Gc=20,Hc=24,Vc=1,Wc=!1,Xc=256,Kc=[{url:"https://hicetnunc.xyz/objkt/87918",text:"hic et nunc NFT"}],Yc=({time:e,n:t})=>{const r=new Qi.a(t),n=.2+3*r.random()*r.random(),o=.2+10*r.random()*r.random(),i=r.random(),a=[i+.2-.5*r.random(),i+.02-.1*r.random(),i-.02+.1*r.random()];return Object(Se.jsx)(Oe.Node,{shader:Qc.node,uniforms:{resolution:Oe.Uniform.Resolution,time:e,a:n,b:o,c:a}})},Qc=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
...
`}}),Zc=73,Jc="purple square corridor",el=640,tl=0,rl=20,nl=24,ol=1,il=!1,al=256,sl=72e5,cl=({time:e})=>{const t=Date.now(),r=t/sl-Math.floor(t/sl);return Object(Se.jsx)(Oe.Node,{shader:ll.node,uniforms:{resolution:Oe.Uniform.Resolution,time:e+1e3*r,speed:.01,c:[.8,.1,.3]}})},ll=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
...
`}}),fl=74,ul="blue square corridor",pl=640,dl=0,vl=20,hl=24,ml=1,gl=!1,bl=256,yl=72e5,xl=({time:e})=>{const t=Date.now(),r=t/yl-Math.floor(t/yl);return Object(Se.jsx)(Oe.Node,{shader:wl.node,uniforms:{resolution:Oe.Uniform.Resolution,time:e+1e3*r,speed:.01,c:[0,.3,.4]}})},wl=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
...
`}}),_l=75,El="moir\xe9 square smoke",Sl=640,Ol=0,Rl=20,Tl=24,zl=1,Pl=!1,Cl=256,Il=36e5,jl=({time:e})=>{const t=Date.now(),r=t/Il-Math.floor(t/Il);return Object(Se.jsx)(Oe.Node,{shader:Al.node,uniforms:{resolution:Oe.Uniform.Resolution,time:e+1e3*r,speed:.01}})},Al=Oe.Shaders.create({node:{frag:Oe.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;

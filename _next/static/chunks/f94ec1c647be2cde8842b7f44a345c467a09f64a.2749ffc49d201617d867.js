...
}`}}),Ze=2,Je="stripes",et=400,tt=0,rt=60,nt=24,ot=1,it=({time:e})=>Object(Ve.jsx)(We.Node,{shader:at.node,uniforms:{time:e}}),at=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),ct=3,st="zephyr",lt=({time:e})=>Object(Ve.jsx)(We.Node,{shader:ft.node,uniforms:{time:e}}),ft=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}});var ut=r("q1tI"),pt=r.n(ut);const dt=We.Shaders.create({InitGameOfLife:{frag:We.GLSL`
  precision highp float;
  uniform float seed;
  // i
  varying vec2 uv;
  ...
  }`}}),vt=pt.a.memo((({tick:e,size:t,refreshEveryTicks:r})=>e%(r||1/0)===0?Object(Ve.jsx)(We.Node,{shader:dt.InitGameOfLife,uniforms:{seed:Math.random()},width:t,height:t,backbuffering:!0,sync:!0}):Object(Ve.jsx)(We.Node,{shader:dt.GameOfLife,width:t,height:t,backbuffering:!0,sync:!0,uniforms:{t:We.Uniform.Backbuffer,size:t}}))),ht=4,mt="Ray of Life";let gt;const xt=({time:e})=>{gt||(gt=e);const t=e-gt,r=Math.floor(10*t),n=r+25,o=10*(1+Math.floor(r/50)),i=10*(1+Math.floor(n/50));return Object(Ve.jsx)(bt,{time:e,a:Object(Ve.jsx)(We.NearestCopy,{children:Object(Ve.jsx)(vt,{refreshEveryTicks:50,tick:r,size:o})}),b:Object(Ve.jsx)(We.NearestCopy,{children:Object(Ve.jsx)(vt,{refreshEveryTicks:50,tick:n,size:i})})})},bt=({a:e,b:t,time:r})=>Object(Ve.jsx)(We.Node,{uniforms:{a:e,b:t,time:r},shader:yt.main}),yt=We.Shaders.create({main:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),wt=5,_t="Here We Go Again",St=({time:e})=>Object(Ve.jsx)(We.Node,{shader:Et.node,uniforms:{time:e}}),Et=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    sqrt(vec3(1. - shad));
  gl_FragColor = vec4(c,1.0);
}`}}),Ot=6,Rt="Bestagons",zt=({time:e})=>Object(Ve.jsx)(We.Node,{shader:Pt.node,uniforms:{time:e}}),Pt=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),Tt=7,It="Worms party",Ct=({time:e})=>Object(Ve.jsx)(We.Node,{shader:jt.node,uniforms:{time:e}}),jt=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    sqrt(vec3(1. - shad));
  gl_FragColor = vec4(c,1.0);
}`}}),kt=8,At="moontains",Dt=({time:e})=>Object(Ve.jsx)(We.Node,{shader:Lt.node,uniforms:{time:e}}),Lt=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Nt=9,Mt="Virus",Ut=400,Ft=16.3,Bt=26,qt=24,Gt=.8,$t=({time:e})=>Object(Ve.jsx)(We.Node,{shader:Ht.node,uniforms:{time:e}}),Ht=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Vt=10,Wt="ring",Xt=({time:e})=>Object(Ve.jsx)(We.Node,{shader:Kt.node,uniforms:{time:e}}),Kt=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Yt=11,Qt="magic mouse",Zt=({time:e})=>Object(Ve.jsx)(We.Node,{shader:Jt.node,uniforms:{time:e}}),Jt=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),er=12,tr="floor is lava",rr=({time:e})=>Object(Ve.jsx)(We.Node,{shader:nr.node,uniforms:{time:e}}),nr=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),or=13,ir="chip",ar=({time:e})=>Object(Ve.jsx)(We.Node,{shader:cr.node,uniforms:{time:e}}),cr=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
`}}),sr=14,lr="seizure",fr=({time:e})=>Object(Ve.jsx)(We.Node,{shader:ur.node,uniforms:{time:e}}),ur=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),pr=We.Shaders.create({blur1D:{frag:We.GLSL`precision highp float;
varying vec2 uv;
uniform sampler2D t;
...
}`}});var dr=({width:e,height:t,pixelRatio:r,direction:n,children:o})=>Object(Ve.jsx)(We.Node,{shader:pr.blur1D,width:e,height:t,pixelRatio:r,uniforms:{direction:n,resolution:We.Uniform.Resolution,t:o}});const vr=Math.sqrt(2)/2;var hr=(e,t,r)=>{const n=2*t*Math.ceil(e/2)/r;switch((e-1)%4){case 0:return[n,0];case 1:return[0,n];case 2:return[n*vr,n*vr];case 3:return[n*vr,-n*vr]}};const mr=({width:e,height:t,pixelRatio:r,factor:n,children:o,passes:i,directionForPass:a})=>{const c=s=>s<=0?o:Object(Ve.jsx)(dr,{width:e,height:t,pixelRatio:r,direction:a(s,n,i),children:c(s-1)});return c(i)};mr.defaultProps={passes:2,directionForPass:hr};var gr=mr;const xr=We.Shaders.create({blur1D:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
...
}`}});var br=({width:e,height:t,map:r,pixelRatio:n,direction:o,children:i})=>Object(Ve.jsx)(We.Node,{shader:xr.blur1D,width:e,height:t,pixelRatio:n,uniforms:{direction:o,resolution:We.Uniform.Resolution,t:i,map:r}});const yr=({width:e,height:t,map:r,pixelRatio:n,factor:o,children:i,passes:a,directionForPass:c})=>{const s=l=>l<=0?i:Object(Ve.jsx)(br,{width:e,height:t,map:r,pixelRatio:n,direction:c(l,o,a),children:s(l-1)});return s(a)};yr.defaultProps={passes:2,directionForPass:hr};const wr=15,_r="parametric",Sr=({time:e})=>Object(Ve.jsx)(We.LinearCopy,{children:Object(Ve.jsx)(Or,{persistence:.98+.02*Math.cos(e)+-.8*Math.exp(-e),children:Object(Ve.jsx)(gr,{passes:4,factor:.2,children:Object(Ve.jsx)(Er,{time:e})})})}),Er=({time:e})=>Object(Ve.jsx)(We.Node,{shader:Rr.node,uniforms:{time:e}}),Or=({children:e,persistence:t})=>Object(Ve.jsx)(We.Node,{shader:Rr.persistence,backbuffering:!0,uniforms:{t:e,back:We.Uniform.Backbuffer,persistence:t}}),Rr=We.Shaders.create({persistence:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),zr=16,Pr="reuleaux",Tr=({time:e})=>Object(Ve.jsx)(We.Node,{shader:Ir.node,uniforms:{time:e}}),Ir=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    color(0.5 * time);
  gl_FragColor = vec4(c, 1.0);
}`}}),Cr=17,jr="screws",kr=({time:e})=>Object(Ve.jsx)(We.Node,{shader:Ar.node,uniforms:{time:e}}),Ar=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),Dr=18,Lr="queen",Nr=({time:e})=>Object(Ve.jsx)(We.Node,{shader:Mr.node,uniforms:{time:e}}),Mr=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
}`}}),Ur=19,Fr="they were six",Br=({time:e})=>Object(Ve.jsx)(We.Node,{shader:qr.node,uniforms:{time:e}}),qr=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Gr=20,$r="trippy tiles",Hr=({time:e})=>Object(Ve.jsx)(We.LinearCopy,{children:Object(Ve.jsx)(Vr,{persistence:.85,children:Object(Ve.jsx)(We.Node,{shader:Wr.node,uniforms:{time:e}})})}),Vr=({children:e,persistence:t})=>Object(Ve.jsx)(We.Node,{shader:Wr.persistence,backbuffering:!0,uniforms:{t:e,back:We.Uniform.Backbuffer,persistence:t}}),Wr=We.Shaders.create({persistence:{frag:We.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Xr=21,Kr="HODL",Yr=({time:e})=>Object(Ve.jsx)(We.LinearCopy,{children:Object(Ve.jsx)(Qr,{persistence:Math.min(.99,.015*e),time:e,children:Object(Ve.jsx)(We.Node,{shader:Zr.node,uniforms:{time:e}})})}),Qr=({children:e,persistence:t,time:r})=>Object(Ve.jsx)(We.Node,{shader:Zr.shakePersistence,backbuffering:!0,uniforms:{t:e,back:We.Uniform.Backbuffer,persistence:t,time:r}}),Zr=We.Shaders.create({shakePersistence:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform sampler2D t, back;
uniform float time;
...
}`}}),Jr=22,en="atoms",tn=({time:e})=>Object(Ve.jsx)(We.Node,{shader:rn.node,uniforms:{time:e,t:"/images/einstein-tongue-out.jpg"}}),rn=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D t;
...
void main() {
...
}`}}),nn=23,on="Hexacubes",an=({time:e})=>Object(Ve.jsx)(We.Node,{shader:cn.node,uniforms:{time:e}}),cn=We.Shaders.create({node:{frag:We.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform float time;
  const float PI = ${Math.PI};
  ...
  void main() {
    ...
    gl_FragColor = vec4(c, 1.0);
      ...
      `}}),sn=24,ln="dark cubes",fn=({time:e})=>Object(Ve.jsx)(We.Node,{shader:un.node,uniforms:{time:e}}),un=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),pn=25,dn="Mandelbrot",vn=({time:e})=>Object(Ve.jsx)(We.LinearCopy,{children:Object(Ve.jsx)(hn,{persistence:.9,children:Object(Ve.jsx)(gr,{passes:4,factor:.1,children:Object(Ve.jsx)(We.Node,{shader:mn.node,uniforms:{time:e}})})})}),hn=({children:e,persistence:t})=>Object(Ve.jsx)(We.Node,{shader:mn.persistence,backbuffering:!0,uniforms:{t:e,back:We.Uniform.Backbuffer,persistence:t}}),mn=We.Shaders.create({persistence:{frag:We.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),gn=26,xn="fumes",bn=({time:e})=>Object(Ve.jsx)(We.LinearCopy,{children:Object(Ve.jsx)(yn,{persistence:.9,children:Object(Ve.jsx)(gr,{passes:4,factor:Math.min(.6,.01*e),children:Object(Ve.jsx)(We.Node,{shader:wn.node,uniforms:{time:e}})})})}),yn=({children:e,persistence:t})=>Object(Ve.jsx)(We.Node,{shader:wn.persistence,backbuffering:!0,uniforms:{t:e,back:We.Uniform.Backbuffer,persistence:t}}),wn=We.Shaders.create({persistence:{frag:We.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),_n=27,Sn="real burning ship",En=400,On=0,Rn=60,zn=12,Pn=2,Tn=({time:e})=>Object(Ve.jsx)(We.LinearCopy,{children:Object(Ve.jsx)(In,{persistence:.8+.05*Math.random(),time:e,children:Object(Ve.jsx)(We.Node,{shader:Cn.node,uniforms:{time:e}})})}),In=({children:e,persistence:t,time:r})=>Object(Ve.jsx)(We.Node,{shader:Cn.persistence,backbuffering:!0,uniforms:{t:e,back:We.Uniform.Backbuffer,persistence:t,time:r}}),Cn=We.Shaders.create({persistence:{frag:We.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),jn=28,kn="No, I'M Batman",An=({time:e})=>Object(Ve.jsx)(We.LinearCopy,{children:Object(Ve.jsx)(Dn,{persistence:.5+.48*Math.min(1,e/60),children:Object(Ve.jsx)(We.Node,{shader:Ln.node,uniforms:{time:e}})})}),Dn=({children:e,persistence:t})=>Object(Ve.jsx)(We.Node,{shader:Ln.persistence,backbuffering:!0,uniforms:{t:e,back:We.Uniform.Backbuffer,persistence:t}}),Ln=We.Shaders.create({persistence:{frag:We.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Nn=29,Mn="sdBitcoin(p)",Un=({time:e})=>Object(Ve.jsx)(We.Node,{shader:Fn.node,uniforms:{time:e}}),Fn=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Bn=30,qn="21 millions",Gn=({time:e})=>Object(Ve.jsx)(We.Node,{shader:$n.node,uniforms:{time:e,numberInCirculation:18557031}}),$n=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Hn=31,Vn="alien tower",Wn=({time:e})=>Object(Ve.jsx)(We.Node,{shader:Xn.node,uniforms:{time:e,numberInCirculation:18557031}}),Xn=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform float numberInCirculation;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Kn=32,Yn="GoL valley";let Qn;const Zn=({time:e})=>{Qn||(Qn=e);const t=e-Qn,r=Math.floor(12*t);return Object(Ve.jsx)(We.Node,{shader:Jn.node,uniforms:{time:e,t:Object(Ve.jsx)(vt,{refreshEveryTicks:100,tick:r,size:100})}})},Jn=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D t;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),eo=33,to="x(x+32y)%(tN+1)%n";const ro=({time:e})=>Object(Ve.jsx)(We.Node,{shader:no.node,uniforms:{time:e}}),no=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),oo=34,io="\u230a2cos(x)sin(y+t)\u230b%7";const ao=({time:e})=>Object(Ve.jsx)(We.Node,{shader:co.node,uniforms:{time:e}}),co=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
#define PI ${Math.PI}
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),so=35,lo="aie confiance",fo=({time:e})=>Object(Ve.jsx)(We.LinearCopy,{children:Object(Ve.jsx)(uo,{persistence:.6,children:Object(Ve.jsx)(We.Node,{shader:po.node,uniforms:{time:e}})})}),uo=({children:e,persistence:t})=>Object(Ve.jsx)(We.Node,{shader:po.persistence,backbuffering:!0,uniforms:{t:e,back:We.Uniform.Backbuffer,persistence:t}}),po=We.Shaders.create({persistence:{frag:We.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),vo=36,ho="crois en moi",mo=({time:e})=>Object(Ve.jsx)(We.LinearCopy,{children:Object(Ve.jsx)(go,{children:Object(Ve.jsx)(We.Node,{shader:xo.node,uniforms:{time:e}})})}),go=({children:e,persistence:t})=>Object(Ve.jsx)(We.Node,{shader:xo.persistence,backbuffering:!0,uniforms:{t:e,back:We.Uniform.Backbuffer,persistence:t}}),xo=We.Shaders.create({persistence:{frag:We.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),bo=37,yo="sdBrick",wo=({time:e})=>Object(Ve.jsx)(We.Node,{shader:_o.node,uniforms:{time:e}}),_o=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),So=38,Eo="Golden mandelbulb",Oo=({time:e})=>Object(Ve.jsx)(We.LinearCopy,{children:Object(Ve.jsx)(Ro,{persistence:.5,children:Object(Ve.jsx)(We.Node,{shader:zo.node,uniforms:{time:e}})})}),Ro=({children:e,persistence:t})=>Object(Ve.jsx)(We.Node,{shader:zo.persistence,backbuffering:!0,uniforms:{t:e,back:We.Uniform.Backbuffer,persistence:t}}),zo=We.Shaders.create({persistence:{frag:We.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  clr /= 4.;
  gl_FragColor = vec4(clr, 1.0);
}`}}),Po=39,To="metaballs",Io=({time:e})=>Object(Ve.jsx)(We.Node,{shader:Co.node,uniforms:{time:e}}),Co=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  clr /= 4.;
  gl_FragColor = vec4(clr, 1.0);
}`}}),jo=40,ko="pen-o-plasma",Ao=({time:e})=>Object(Ve.jsx)(We.Node,{shader:Do.node,uniforms:{time:e}}),Do=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(clr, 1.0);
}`}}),Lo=41,No="reflection",Mo=({time:e})=>Object(Ve.jsx)(We.Node,{shader:Uo.node,uniforms:{time:e}}),Uo=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Fo=42,Bo="reflection party",qo=({time:e})=>Object(Ve.jsx)(We.Node,{shader:Go.node,uniforms:{time:e}}),Go=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c = mix(c, reflection(p, n, 10.), glossy);
  gl_FragColor = vec4(c, 1.0);
}`}}),$o=43,Ho="irreconcilable queens",Vo=({time:e})=>Object(Ve.jsx)(We.LinearCopy,{children:Object(Ve.jsx)(Wo,{persistence:.4,children:Object(Ve.jsx)(We.Node,{shader:Xo.node,uniforms:{time:e}})})}),Wo=({children:e,persistence:t})=>Object(Ve.jsx)(We.Node,{shader:Xo.persistence,backbuffering:!0,uniforms:{t:e,back:We.Uniform.Backbuffer,persistence:t}}),Xo=We.Shaders.create({persistence:{frag:We.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Ko=44,Yo="royal meeting",Qo=({time:e})=>Object(Ve.jsx)(We.Node,{shader:Zo.node,uniforms:{time:e}}),Zo=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
#define PI ${Math.PI}
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),Jo=45,ei="wood pawns army",ti=({time:e})=>Object(Ve.jsx)(We.Node,{shader:ri.node,uniforms:{time:e,wood:"/images/seamless-wood-background-1.jpg"}}),ri=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),ni=46,oi="Bank of Bicoin",ii=({time:e})=>Object(Ve.jsx)(We.Node,{shader:ai.node,uniforms:{time:e}}),ai=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),ci=47,si="glow experiment",li=({time:e})=>Object(Ve.jsx)(We.Node,{shader:fi.node,uniforms:{time:e}}),fi=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),ui=48,pi="Starry Night",di=({time:e})=>Object(Ve.jsx)(We.Node,{shader:vi.node,uniforms:{time:e,img:"/images/seamless-wood2.jpg"}}),vi=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(clr, 1.0);
}`}}),hi=49,mi="chinese lantern",gi=400,xi=0,bi=20,yi=24,wi=1.1,_i=({time:e})=>Object(Ve.jsx)(We.LinearCopy,{children:Object(Ve.jsx)(Si,{persistence:.8,children:Object(Ve.jsx)(We.Node,{shader:Ei.node,uniforms:{time:e}})})}),Si=({children:e,persistence:t})=>Object(Ve.jsx)(We.Node,{shader:Ei.persistence,backbuffering:!0,uniforms:{t:e,back:We.Uniform.Backbuffer,persistence:t}}),Ei=We.Shaders.create({persistence:{frag:We.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  clr += c;
  gl_FragColor = vec4(clr, 1.0);
}`}}),Oi=50,Ri="jumpy rooks",zi=({time:e})=>Object(Ve.jsx)(We.Node,{shader:Pi.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),Pi=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),Ti=51,Ii="symmetry chess",Ci=400,ji=0,ki=20,Ai=24,Di=1,Li=({time:e})=>Object(Ve.jsx)(We.Node,{shader:Ni.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),Ni=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Mi=52,Ui="knights dance",Fi=({time:e})=>Object(Ve.jsx)(We.Node,{shader:Bi.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),Bi=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),qi=53,Gi="cross waves",$i=({time:e})=>Object(Ve.jsx)(We.Node,{shader:Hi.node,uniforms:{time:e}}),Hi=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  */
}`}}),Vi=54,Wi="chess set",Xi=({time:e})=>Object(Ve.jsx)(We.Node,{shader:Ki.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),Ki=We.Shaders.create({node:{frag:We.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  color = vec4(c, 1.0);
}`}}),Yi=55,Qi="cube d'or",Zi=400,Ji=0,ea=20,ta=24,ra=1,na=({time:e})=>Object(Ve.jsx)(We.Node,{shader:oa.node,uniforms:{time:e}}),oa=We.Shaders.create({node:{frag:We.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  #endif
  color = vec4(c, 1.0);
}`}}),ia=56,aa="jade forest",ca=({time:e})=>Object(Ve.jsx)(We.Node,{shader:sa.node,uniforms:{time:e}}),sa=We.Shaders.create({node:{frag:We.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  color = vec4(c, 1.0);
}`}}),la=57,fa="Virus v2",ua=400,pa=0,da=20,va=24,ha=.8,ma=({time:e})=>Object(Ve.jsx)(We.Node,{shader:ga.node,uniforms:{time:e}}),ga=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}});var xa=r("005v"),ba=r.n(xa);const ya=400,wa=0,_a=30,Sa=20,Ea=1,Oa="5M",Ra=58,za="Mandelglitch",Pa=[{url:"https://ethblock.art/create/17",text:"Mint on ethblock.art"},{url:"https://ghostmarket.io/asset/pha/ghost/3008841254969814369262311336331954453497120774334547905246474374493804042898/",text:"ghostmarket.io: 400 KCAL"},{url:"https://www.hicetnunc.xyz/objkt/3063",text:"hicetnunc.xyz: Mandelglitch #1 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3068",text:"hicetnunc.xyz: Mandelglitch #2 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3071",text:"hicetnunc.xyz: Mandelglitch #3 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3072",text:"hicetnunc.xyz: Mandelglitch #4 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3073",text:"hicetnunc.xyz: Mandelglitch #5 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3077",text:"hicetnunc.xyz: Mandelglitch #6 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3088",text:"hicetnunc.xyz: Mandelglitch #7 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3574",text:"hicetnunc.xyz: Mandelglitch #8 (5 XTZ)"}];const Ta=e=>e<.5?2*e*e:(4-2*e)*e-1;const Ia=({time:e,n:t,exporting:r})=>{const n=Object(ut.useMemo)((()=>function(e,t=0){const r=e?3:50,n=new ba.a(t);return Array(r).fill(null).map((()=>Array(12).fill(null).map((()=>n.random()))))}(r,t)),[t,r]),o=e/10%n.length,i=Math.floor(o),a=o-i;let[c,s,l,f,u,p,d,v,h,m,g,x]=(b=n[i%n.length],y=n[(i+1)%n.length],w=Ta(a),b.map(((e,t)=>e*(1-w)+y[t]*w)));var b,y,w;return l=Ta(l),Object(Ve.jsx)(We.LinearCopy,{children:Object(Ve.jsx)(ja,{persistence:r?0:.8,children:Object(Ve.jsx)(We.Node,{shader:Ca.main,uniforms:{aa:r?2:0,time:e,resolution:We.Uniform.Resolution,travel:c,love:s,dark:l,rot:r?2*Math.PI/_a:.1,s1:f,s2:u,s3:p,s4:d,s5:v,s6:h,s7:m,s8:g,s9:x}})})})},Ca=We.Shaders.create({persistence:{frag:We.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  `}}),ja=({children:e,persistence:t})=>Object(Ve.jsx)(We.Node,{shader:Ca.persistence,backbuffering:!0,uniforms:{t:e,back:We.Uniform.Backbuffer,persistence:t}}),ka=59,Aa="Pixels 256",Da="There will be only 256 patterns generated by this single fragment shader.",La=({time:e,n:t,exporting:r})=>Object(Ve.jsx)(Na,{n:t+1+(r?0:Math.floor(e))}),Na=pt.a.memo((({n:e})=>{const t=new ba.a(e%256),r=t.random(),n=t.random(),o=t.random(),i=t.random(),a=t.random(),c=t.random();return Object(Ve.jsx)(We.Node,{shader:Ma.node,uniforms:{s1:r,s2:n,s3:o,s4:i,s5:a,s6:c}})})),Ma=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),Ua=60,Fa="Bitcoin rainbow",Ba=({time:e})=>Object(Ve.jsx)(We.Node,{shader:qa.node,uniforms:{time:e}}),qa=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Ga=61,$a="Binance gradients",Ha=1,Va=30,Wa=["/images/shaders/binance.dist.png"],Xa=({time:e})=>Object(Ve.jsx)(We.Node,{shader:Ka.node,uniforms:{time:e,image:"/images/shaders/binance.dist.png"}}),Ka=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Ya=62,Qa="Overgrowth",Za=20,Ja=40,ec=1,tc=({generation:e,size:t,n:r})=>Object(Ve.jsx)(We.Node,{width:t,height:t,shader:cc.logic,uniforms:{generation:e,prev:We.Uniform.Backbuffer,size:t,seed:r/100},backbuffering:!0}),rc=pt.a.memo(tc),nc=({time:e,generation:t,n:r})=>Object(Ve.jsx)(We.Node,{shader:cc.render,uniforms:{time:e,logic:Object(Ve.jsx)(rc,{generation:t,size:140,n:r})},uniformsOptions:{logic:{interpolation:"nearest"}}}),oc=pt.a.memo(nc),ic=1e3*Math.random(),ac=({time:e,n:t})=>Object(Ve.jsx)(oc,{n:t+ic,time:e,generation:Math.floor(30*e)},t),cc=We.Shaders.create({logic:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
...
`}});var sc=r("AJhG");const lc=63,fc="Relics",uc=400,pc=2,dc=4,vc=20,hc=1,mc="5M",gc={colors:[.7,.55,.4],logicSize:80,amp:1,base:2,persistance:.89,delta:.5,seed:0};console.log(Object.keys(gc).map((e=>String(gc[e]))).join("_"));const xc=({g:e,size:t,seed:r,amp:n,base:o,persistance:i,delta:a})=>Object(Ve.jsx)(We.Node,{width:t,height:t,shader:Sc.logic,uniforms:{amp:n,base:o,g:e,prev:We.Uniform.Backbuffer,size:t,seed:r,persistance:i,delta:a},backbuffering:!0},t),bc=pt.a.memo(xc),yc=({g:e,colors:t,amp:r,base:n,persistance:o,delta:i,logicSize:a,seed:c})=>Object(Ve.jsx)(We.Node,{shader:Sc.render,uniforms:{colors:t,logic:Object(Ve.jsx)(bc,{amp:r,base:n,g:e,size:a,seed:c,persistance:o,delta:i})},uniformsOptions:{logic:{interpolation:"nearest"}}}),wc=pt.a.memo(yc),_c=({time:e})=>{const{colors:t,logicSize:r,amp:n,base:o,persistance:i,delta:a,seed:c}=Object(sc.b)(gc);return Object(Ve.jsx)(wc,{amp:n,base:o,g:Math.floor(20*e)%40,colors:t,persistance:i,delta:a,seed:c,logicSize:r})},Sc=We.Shaders.create({logic:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform sampler2D prev;
uniform float g;
...
`}}),Ec=64,Oc="Intersection",Rc=8*Math.PI,zc=[{url:"https://www.hicetnunc.xyz/objkt/28592",text:"hic et nunc NFT"}],Pc=({time:e})=>Object(Ve.jsx)(We.Node,{shader:Tc.render,uniforms:{resolution:We.Uniform.Resolution,time:e}}),Tc=We.Shaders.create({render:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform vec2 resolution;
...
`}}),Ic=65,Cc="Duality",jc=800,kc=4,Ac=8,Dc=30,Lc=1,Nc=3,Mc=!0,Uc=16,Fc=[{url:"https://hicetnunc.xyz/objkt/64326",text:"hic et nunc NFT"}],Bc=({time:e})=>Object(Ve.jsx)(We.NearestCopy,{children:Object(Ve.jsx)(qc,{persistence:.3,children:Object(Ve.jsx)(We.Node,{shader:Gc.render,uniforms:{resolution:We.Uniform.Resolution,time:e}})})}),qc=({children:e,persistence:t})=>Object(Ve.jsx)(We.Node,{shader:Gc.persistence,backbuffering:!0,uniforms:{t:e,back:We.Uniform.Backbuffer,persistence:t}}),Gc=We.Shaders.create({persistence:{frag:We.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),$c=66,Hc="hicetnunc",Vc=800,Wc=2,Xc=Wc+8,Kc=30,Yc=1,Qc=7,Zc=!0,Jc=16,es=({time:e})=>Object(Ve.jsx)(We.NearestCopy,{children:Object(Ve.jsx)(ts,{persistence:.5,children:Object(Ve.jsx)(We.Node,{shader:rs.render,uniforms:{resolution:We.Uniform.Resolution,time:e,freq:2}})})}),ts=({children:e,persistence:t})=>Object(Ve.jsx)(We.Node,{shader:rs.persistence,backbuffering:!0,uniforms:{t:e,back:We.Uniform.Backbuffer,persistence:t}}),rs=We.Shaders.create({persistence:{frag:We.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),ns=67,os="Jumping blob",is=800,as=2,cs=as+8,ss=30,ls=1,fs=7,us=!0,ps=16,ds=({time:e})=>Object(Ve.jsx)(We.NearestCopy,{children:Object(Ve.jsx)(vs,{persistence:.6,children:Object(Ve.jsx)(We.Node,{shader:hs.render,uniforms:{resolution:We.Uniform.Resolution,time:e,freq:2}})})}),vs=({children:e,persistence:t})=>Object(Ve.jsx)(We.Node,{shader:hs.persistence,backbuffering:!0,uniforms:{t:e,back:We.Uniform.Backbuffer,persistence:t}}),hs=We.Shaders.create({persistence:{frag:We.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),ms=68,gs="ring",xs=800,bs=2,ys=bs+10,ws=30,_s=1,Ss=7,Es=!0,Os=128,Rs=({time:e})=>Object(Ve.jsx)(We.NearestCopy,{children:Object(Ve.jsx)(zs,{persistence:.9,children:Object(Ve.jsx)(We.Node,{shader:Ps.render,uniforms:{resolution:We.Uniform.Resolution,time:e,freq:2}})})}),zs=({children:e,persistence:t})=>Object(Ve.jsx)(We.Node,{shader:Ps.persistence,backbuffering:!0,uniforms:{t:e,back:We.Uniform.Backbuffer,persistence:t}}),Ps=We.Shaders.create({persistence:{frag:We.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Ts=69,Is="Bananas paradize",Cs=400,js=0,ks=20,As=20,Ds=1,Ls=!0,Ns=128,Ms=({time:e})=>Object(Ve.jsx)(We.Node,{shader:Us.node,uniforms:{time:e,resolution:We.Uniform.Resolution}}),Us=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),Fs=70,Bs="warp1",qs=400,Gs=0,$s=20,Hs=20,Vs=1,Ws=!1,Xs=256,Ks=({time:e})=>Object(Ve.jsx)(We.Node,{shader:Ys.node,uniforms:{time:e,resolution:We.Uniform.Resolution}}),Ys=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),Qs=71,Zs="warp2",Js=640,el=0,tl=20,rl=24,nl=1,ol=!1,il=256,al=({time:e})=>Object(Ve.jsx)(We.Node,{shader:cl.node,uniforms:{time:e}}),cl=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),sl=72,ll="Planet Hole",fl=640,ul=0,pl=20,dl=24,vl=1,hl=!1,ml=256,gl=[{url:"https://hicetnunc.xyz/objkt/87918",text:"hic et nunc NFT"}],xl=({time:e,n:t})=>{const r=new ba.a(t),n=.2+3*r.random()*r.random(),o=.2+10*r.random()*r.random(),i=r.random(),a=[i+.2-.5*r.random(),i+.02-.1*r.random(),i-.02+.1*r.random()];return Object(Ve.jsx)(We.Node,{shader:bl.node,uniforms:{resolution:We.Uniform.Resolution,time:e,a:n,b:o,c:a}})},bl=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
...
`}}),yl=73,wl="purple square corridor",_l=640,Sl=0,El=20,Ol=24,Rl=1,zl=!1,Pl=256,Tl=72e5,Il=({time:e})=>{const t=Date.now(),r=t/Tl-Math.floor(t/Tl);return Object(Ve.jsx)(We.Node,{shader:Cl.node,uniforms:{resolution:We.Uniform.Resolution,time:e+1e3*r,speed:.01,c:[.8,.1,.3]}})},Cl=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
...
`}}),jl=74,kl="blue square corridor",Al=640,Dl=0,Ll=20,Nl=24,Ml=1,Ul=!1,Fl=256,Bl=72e5,ql=({time:e})=>{const t=Date.now(),r=t/Bl-Math.floor(t/Bl);return Object(Ve.jsx)(We.Node,{shader:Gl.node,uniforms:{resolution:We.Uniform.Resolution,time:e+1e3*r,speed:.01,c:[0,.3,.4]}})},Gl=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
...
`}}),$l=75,Hl="moir\xe9 square smoke",Vl=640,Wl=0,Xl=20,Kl=24,Yl=1,Ql=!1,Zl=256,Jl=36e5,ef=({time:e})=>{const t=Date.now(),r=t/Jl-Math.floor(t/Jl);return Object(Ve.jsx)(We.Node,{shader:tf.node,uniforms:{resolution:We.Uniform.Resolution,time:e+1e3*r,speed:.01}})},tf=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
...
`}}),rf=76,nf="Purple",of=640,af=0,cf=20,sf=24,lf=1,ff=!1,uf=256,pf=({time:e})=>Object(Ve.jsx)(We.Node,{shader:df.node,uniforms:{resolution:We.Uniform.Resolution,time:e}}),df=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),vf=77,hf="Roses",mf=512,gf=0,xf=8,bf=20,yf=1,wf=!1,_f=64,Sf=({time:e})=>Object(Ve.jsx)(We.Node,{shader:Ef.node,uniforms:{resolution:We.Uniform.Resolution,time:e}}),Ef=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),Of=78,Rf="Nature",zf=512,Pf=0,Tf=10,If=16,Cf=1,jf=!1,kf=64,Af=({time:e})=>Object(Ve.jsx)(We.Node,{shader:Df.node,uniforms:{resolution:We.Uniform.Resolution,time:e}}),Df=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),Lf=79,Nf="Circle",Mf=512,Uf=0,Ff=10,Bf=16,qf=1,Gf=!1,$f=64,Hf=({time:e})=>Object(Ve.jsx)(We.Node,{shader:Vf.node,uniforms:{resolution:We.Uniform.Resolution,time:e}}),Vf=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),Wf=80,Xf="Morphing Tunnel",Kf=512,Yf=0,Qf=10,Zf=16,Jf=1,eu=!1,tu=64,ru=({time:e})=>Object(Ve.jsx)(We.Node,{shader:nu.node,uniforms:{resolution:We.Uniform.Resolution,time:e}}),nu=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),ou=81,iu="Red Blue Stripes",au=512,cu=0,su=10,lu=16,fu=1,uu=!1,pu=64,du=({time:e})=>Object(Ve.jsx)(We.Node,{shader:vu.node,uniforms:{resolution:We.Uniform.Resolution,time:e}}),vu=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),hu=82,mu="Mountain waves",gu=512,xu=0,bu=10,yu=16,wu=1,_u=!1,Su=64,Eu=({time:e})=>Object(Ve.jsx)(We.Node,{shader:Ou.node,uniforms:{resolution:We.Uniform.Resolution,time:e}}),Ou=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),Ru=83,zu="Pink Plume",Pu=512,Tu=0,Iu=10,Cu=16,ju=1,ku=!1,Au=64,Du=({time:e})=>Object(Ve.jsx)(We.Node,{shader:Lu.node,uniforms:{resolution:We.Uniform.Resolution,time:e}}),Lu=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),Nu=84,Mu="Flame Waves",Uu=512,Fu=0,Bu=10,qu=16,Gu=1,$u=!1,Hu=64,Vu=({time:e})=>Object(Ve.jsx)(We.Node,{shader:Wu.node,uniforms:{resolution:We.Uniform.Resolution,time:e}}),Wu=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),Xu=85,Ku="Flaming Borders",Yu=512,Qu=0,Zu=10,Ju=16,ep=1,tp=!1,rp=64,np=({time:e})=>Object(Ve.jsx)(We.Node,{shader:op.node,uniforms:{resolution:We.Uniform.Resolution,time:e}}),op=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),ip=86,ap="Waves",cp=512,sp=0,lp=10,fp=16,up=1,pp=!1,dp=64,vp=({time:e})=>Object(Ve.jsx)(We.Node,{shader:hp.node,uniforms:{resolution:We.Uniform.Resolution,time:e}}),hp=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),mp=87,gp="Square Waves",xp=512,bp=0,yp=10,wp=16,_p=1,Sp=!1,Ep=64,Op=({time:e})=>Object(Ve.jsx)(We.Node,{shader:Rp.node,uniforms:{resolution:We.Uniform.Resolution,time:e}}),Rp=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),zp=88,Pp="Unboxing",Tp=512,Ip=0,Cp=10,jp=16,kp=1,Ap=!1,Dp=64,Lp=({time:e})=>Object(Ve.jsx)(We.Node,{shader:Np.node,uniforms:{resolution:We.Uniform.Resolution,time:e}}),Np=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),Mp=89,Up="Creepy",Fp=512,Bp=0,qp=10,Gp=16,$p=1,Hp=!1,Vp=64,Wp=({time:e})=>Object(Ve.jsx)(We.Node,{shader:Xp.node,uniforms:{resolution:We.Uniform.Resolution,time:e}}),Xp=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),Kp=90,Yp="Square Path",Qp=512,Zp=0,Jp=10,ed=16,td=1,rd=!1,nd=64,od=({time:e})=>Object(Ve.jsx)(We.Node,{shader:id.node,uniforms:{resolution:We.Uniform.Resolution,time:e}}),id=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),ad=91,cd="Door Path",sd=512,ld=0,fd=10,ud=16,pd=1,dd=!1,vd=64,hd=({time:e})=>Object(Ve.jsx)(We.Node,{shader:md.node,uniforms:{resolution:We.Uniform.Resolution,time:e}}),md=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),gd=92,xd="Green Cosmos",bd=512,yd=0,wd=10,_d=16,Sd=1,Ed=!1,Od=64,Rd=({time:e})=>Object(Ve.jsx)(We.Node,{shader:zd.node,uniforms:{resolution:We.Uniform.Resolution,time:e}}),zd=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),Pd=93,Td="Is it alive",Id=512,Cd=0,jd=10,kd=16,Ad=1,Dd=!1,Ld=64,Nd=({time:e})=>Object(Ve.jsx)(We.Node,{shader:Md.node,uniforms:{resolution:We.Uniform.Resolution,time:e}}),Md=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),Ud=94,Fd="Sand",Bd=512,qd=0,Gd=10,$d=16,Hd=1,Vd=!1,Wd=128,Xd=({time:e})=>Object(Ve.jsx)(We.Node,{shader:Kd.node,uniforms:{resolution:We.Uniform.Resolution,time:e}}),Kd=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),Yd=95,Qd="Diamond Dream",Zd=512,Jd=0,ev=10,tv=16,rv=1,nv=!1,ov=128,iv=({time:e})=>Object(Ve.jsx)(We.Node,{shader:av.node,uniforms:{resolution:We.Uniform.Resolution,time:e}}),av=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),cv=96,sv="Blue Brain",lv=512,fv=0,uv=10,pv=16,dv=1,vv=!1,hv=128,mv=({time:e})=>Object(Ve.jsx)(We.Node,{shader:gv.node,uniforms:{resolution:We.Uniform.Resolution,time:e}}),gv=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;
...
`}}),xv=97,bv="Blue Yellow Storm",yv=512,wv=0,_v=10,Sv=16,Ev=1,Ov=!1,Rv=128,zv=({time:e})=>Object(Ve.jsx)(We.Node,{shader:Pv.node,uniforms:{resolution:We.Uniform.Resolution,time:e}}),Pv=We.Shaders.create({node:{frag:We.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
uniform float time;

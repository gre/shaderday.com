...
`}}),tc=69,rc="Bananas paradize",nc=400,oc=0,ic=20,ac=20,sc=1,cc=({time:e})=>Object(ye.jsx)(be.Node,{shader:lc.node,uniforms:{time:e,resolution:be.Uniform.Resolution}}),lc=be.Shaders.create({node:{frag:be.GLSL`
precision highp float;
varying vec2 uv;

...
`}}),Za=65,Ja="Duality",es=800,ts=4,rs=8,ns=30,os=1,is=3,as=!0,ss=16,cs=({time:e})=>Object(he.jsx)(ve.NearestCopy,{children:Object(he.jsx)(ls,{persistence:.3,children:Object(he.jsx)(ve.Node,{shader:fs.render,uniforms:{resolution:ve.Uniform.Resolution,time:e}})})}),ls=({children:e,persistence:t})=>Object(he.jsx)(ve.Node,{shader:fs.persistence,backbuffering:!0,uniforms:{t:e,back:ve.Uniform.Backbuffer,persistence:t}}),fs=ve.Shaders.create({persistence:{frag:ve.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),us=(ve.Shaders.create({persistence:{frag:ve.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;

...
}`}}).copy;t.default=i},MAJC:function(e,t,r){"use strict";e.exports=function(e){return"undefined"!==typeof e&&null!==e&&("object"===typeof e||"function"===typeof e)}},Ni9w:function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;t.default=class{constructor(){var e,t,r;r=[],(t="_loaders")in(e=this)?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r}add(e){this._loaders.push(e),this._loaders.sort(((e,t)=>("number"===typeof t.priority?t.priority:0)-("number"===typeof e.priority?e.priority:0)))}remove(e){const t=this._loaders.indexOf(e);-1!==t&&this._loaders.splice(t,1)}get(){return this._loaders}}},O8XB:function(e,t,r){"use strict";(function(e,n){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var o,i,a,s,c,l=p(r("tbvF")),f=p(r("Ytbt")),u=p(r("zqV6"));function p(e){return e&&e.__esModule?e:{default:e}}"undefined"===typeof e&&(n.Buffer=(i=o=class{},c=t=>t instanceof e,(s="isBuffer")in(a=o)?Object.defineProperty(a,s,{value:c,enumerable:!0,configurable:!0,writable:!0}):a[s]=c,i));t.default=(e,t,r,n)=>{const o="undefined"!==typeof WebGLRenderingContext&&e instanceof WebGLRenderingContext;let i=r.dtype,a=r.shape.slice(),s=e.getParameter(e.MAX_TEXTURE_SIZE);if(a[0]<0||a[0]>s||a[1]<0||a[1]>s)throw new Error("gl-react: Invalid texture size");let c=function(e,t){return 3===e.length?1===t[2]&&t[1]===e[0]*e[2]&&t[0]===e[2]:1===t[0]&&t[1]===e[0]}(a,r.stride.slice()),p=0;"float32"===i?p=e.FLOAT:"float64"===i?(p=e.FLOAT,c=!1,i="float32"):"uint8"===i?p=e.UNSIGNED_BYTE:(p=e.UNSIGNED_BYTE,c=!1,i="uint8");let d,h=0,v=0;if(2===a.length)v=h=e.LUMINANCE,a=[a[0],a[1],1],r=(0,l.default)(r.data,a,[r.stride[0],r.stride[1],1],r.offset);else{if(3!==a.length)throw new Error("gl-texture2d: Invalid shape for texture");if(1===a[2])v=h=e.ALPHA,o||(n=!1);else if(2===a[2])v=h=e.LUMINANCE_ALPHA,o||(n=!1);else if(3===a[2])h=e.RGB,v=o?e.RGB:e.RGB32F;else{if(4!==a[2])throw new Error("gl-texture2d: Invalid shape for pixel coords");h=e.RGBA,v=o?e.RGBA:e.RGBA32F}}p!==e.FLOAT||n||(p=e.UNSIGNED_BYTE,c=!1);let m,g=r.size;if(c)d=0===r.offset&&r.data.length===g?r.data:r.data.subarray(r.offset,r.offset+g);else{let t=[a[2],a[2]*a[0],1];if("float32"!==i&&"float64"!==i||p!==e.UNSIGNED_BYTE){m=u.default.malloc(g,i);let e=(0,l.default)(m,a,t,0);f.default.assign(e,r)}else{m=u.default.malloc(g,"uint8"),function(e,t){f.default.muls(e,t,255)}((0,l.default)(m,a,t,0),r)}d=m.subarray(0,g)}e.texImage2D(e.TEXTURE_2D,0,v,a[0],a[1],0,h,p,d),m&&u.default.free(m)}}).call(this,r("HDXh").Buffer,r("ntbh"))},OTww:function(e,t,r){"use strict";(function(e){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var n,o=(n=r("Ni9w"))&&n.__esModule?n:{default:n};const i="undefined"===typeof window?e:window,a="__webglTextureLoader_registry";var s=i[a]||(i[a]=new o.default);t.default=s}).call(this,r("ntbh"))},QLaP:function(e,t,r){"use strict";e.exports=function(e,t,r,n,o,i,a,s){if(!e){var c;if(void 0===t)c=new Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else{var l=[r,n,o,i,a,s],f=0;(c=new Error(t.replace(/%s/g,(function(){return l[f++]})))).name="Invariant Violation"}throw c.framesToPop=1,c}}},QM7d:function(e,t,r){"use strict";var n=r("033R");function o(){this.argTypes=[],this.shimArgs=[],this.arrayArgs=[],this.arrayBlockIndices=[],this.scalarArgs=[],this.offsetArgs=[],this.offsetArgIndex=[],this.indexArgs=[],this.shapeArgs=[],this.funcName="",this.pre=null,this.body=null,this.post=null,this.debug=!1}e.exports=function(e){var t=new o;t.pre=e.pre,t.body=e.body,t.post=e.post;var r=e.args.slice(0);t.argTypes=r;for(var i=0;i<r.length;++i){var a=r[i];if("array"===a||"object"===typeof a&&a.blockIndices){if(t.argTypes[i]="array",t.arrayArgs.push(i),t.arrayBlockIndices.push(a.blockIndices?a.blockIndices:0),t.shimArgs.push("array"+i),i<t.pre.args.length&&t.pre.args[i].count>0)throw new Error("cwise: pre() block may not reference array args");if(i<t.post.args.length&&t.post.args[i].count>0)throw new Error("cwise: post() block may not reference array args")}else if("scalar"===a)t.scalarArgs.push(i),t.shimArgs.push("scalar"+i);else if("index"===a){if(t.indexArgs.push(i),i<t.pre.args.length&&t.pre.args[i].count>0)throw new Error("cwise: pre() block may not reference array index");if(i<t.body.args.length&&t.body.args[i].lvalue)throw new Error("cwise: body() block may not write to array index");if(i<t.post.args.length&&t.post.args[i].count>0)throw new Error("cwise: post() block may not reference array index")}else if("shape"===a){if(t.shapeArgs.push(i),i<t.pre.args.length&&t.pre.args[i].lvalue)throw new Error("cwise: pre() block may not write to array shape");if(i<t.body.args.length&&t.body.args[i].lvalue)throw new Error("cwise: body() block may not write to array shape");if(i<t.post.args.length&&t.post.args[i].lvalue)throw new Error("cwise: post() block may not write to array shape")}else{if("object"!==typeof a||!a.offset)throw new Error("cwise: Unknown argument type "+r[i]);t.argTypes[i]="offset",t.offsetArgs.push({array:a.array,offset:a.offset}),t.offsetArgIndex.push(i)}}if(t.arrayArgs.length<=0)throw new Error("cwise: No array arguments specified");if(t.pre.args.length>r.length)throw new Error("cwise: Too many arguments in pre() block");if(t.body.args.length>r.length)throw new Error("cwise: Too many arguments in body() block");if(t.post.args.length>r.length)throw new Error("cwise: Too many arguments in post() block");return t.debug=!!e.printCode||!!e.debug,t.funcName=e.funcName||"cwise",t.blockSize=e.blockSize||64,n(t)}},R9Te:function(e,t,r){"use strict";var n=r("CyWo"),o=r("z08I"),i=r("+0iv"),a=r("vCtr");function s(e){return"__proto__"!==e&&"constructor"!==e&&"prototype"!==e}e.exports=function(e,t,r){if(!a(e))return e;if(Array.isArray(t)&&(t=[].concat.apply([],t).join(".")),"string"!==typeof t)return e;for(var c=n(t,{sep:".",brackets:!0}).filter(s),l=c.length,f=-1,u=e;++f<l;){var p=c[f];f===l-1?i(u[p])&&i(r)?u[p]=o({},u[p],r):u[p]=r:(a(u[p])||(u[p]={}),u=u[p])}return e}},RjOF:function(e,t,r){"use strict";var n,o="";e.exports=function(e,t){if("string"!==typeof e)throw new TypeError("expected a string");if(1===t)return e;if(2===t)return e+e;var r=e.length*t;if(n!==e||"undefined"===typeof n)n=e,o="";else if(o.length>=r)return o.substr(0,r);for(;r>o.length&&t>1;)1&t&&(o+=e),t>>=1,e+=e;return o=(o+=e).substr(0,r)}},Ry8g:function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;t.default=e=>{const t=e.getExtension("WEBGL_lose_context");t&&t.loseContext()}},SMLl:function(e,t,r){"use strict";var n=r("RjOF");e.exports=function(e,t,r){return n(r="undefined"!==typeof r?r+"":" ",t)+e}},TBio:function(e,t,r){"use strict";var n=r("F16p");function o(e,t,r){var n,o,i=e.length,a=t.arrayArgs.length,s=t.indexArgs.length>0,c=[],l=[],f=0,u=0;for(n=0;n<i;++n)l.push(["i",n,"=0"].join(""));for(o=0;o<a;++o)for(n=0;n<i;++n)u=f,f=e[n],0===n?l.push(["d",o,"s",n,"=t",o,"p",f].join("")):l.push(["d",o,"s",n,"=(t",o,"p",f,"-s",u,"*t",o,"p",u,")"].join(""));for(l.length>0&&c.push("var "+l.join(",")),n=i-1;n>=0;--n)f=e[n],c.push(["for(i",n,"=0;i",n,"<s",f,";++i",n,"){"].join(""));for(c.push(r),n=0;n<i;++n){for(u=f,f=e[n],o=0;o<a;++o)c.push(["p",o,"+=d",o,"s",n].join(""));s&&(n>0&&c.push(["index[",u,"]-=s",u].join("")),c.push(["++index[",f,"]"].join(""))),c.push("}")}return c.join("\n")}function i(e,t,r){for(var n=e.body,o=[],i=[],a=0;a<e.args.length;++a){var s=e.args[a];if(!(s.count<=0)){var c=new RegExp(s.name,"g"),l="",f=t.arrayArgs.indexOf(a);switch(t.argTypes[a]){case"offset":var u=t.offsetArgIndex.indexOf(a);f=t.offsetArgs[u].array,l="+q"+u;case"array":l="p"+f+l;var p="l"+a,d="a"+f;if(0===t.arrayBlockIndices[f])1===s.count?"generic"===r[f]?s.lvalue?(o.push(["var ",p,"=",d,".get(",l,")"].join("")),n=n.replace(c,p),i.push([d,".set(",l,",",p,")"].join(""))):n=n.replace(c,[d,".get(",l,")"].join("")):n=n.replace(c,[d,"[",l,"]"].join("")):"generic"===r[f]?(o.push(["var ",p,"=",d,".get(",l,")"].join("")),n=n.replace(c,p),s.lvalue&&i.push([d,".set(",l,",",p,")"].join(""))):(o.push(["var ",p,"=",d,"[",l,"]"].join("")),n=n.replace(c,p),s.lvalue&&i.push([d,"[",l,"]=",p].join("")));else{for(var h=[s.name],v=[l],m=0;m<Math.abs(t.arrayBlockIndices[f]);m++)h.push("\\s*\\[([^\\]]+)\\]"),v.push("$"+(m+1)+"*t"+f+"b"+m);if(c=new RegExp(h.join(""),"g"),l=v.join("+"),"generic"===r[f])throw new Error("cwise: Generic arrays not supported in combination with blocks!");n=n.replace(c,[d,"[",l,"]"].join(""))}break;case"scalar":n=n.replace(c,"Y"+t.scalarArgs.indexOf(a));break;case"index":n=n.replace(c,"index");break;case"shape":n=n.replace(c,"shape")}}}return[o.join("\n"),n,i.join("\n")].join("\n").trim()}function a(e){for(var t=new Array(e.length),r=!0,n=0;n<e.length;++n){var o=e[n],i=o.match(/\d+/);i=i?i[0]:"",0===o.charAt(0)?t[n]="u"+o.charAt(1)+i:t[n]=o.charAt(0)+i,n>0&&(r=r&&t[n]===t[n-1])}return r?t[0]:t.join("")}e.exports=function(e,t){for(var r=t[1].length-Math.abs(e.arrayBlockIndices[0])|0,s=new Array(e.arrayArgs.length),c=new Array(e.arrayArgs.length),l=0;l<e.arrayArgs.length;++l)c[l]=t[2*l],s[l]=t[2*l+1];var f=[],u=[],p=[],d=[],h=[];for(l=0;l<e.arrayArgs.length;++l){e.arrayBlockIndices[l]<0?(p.push(0),d.push(r),f.push(r),u.push(r+e.arrayBlockIndices[l])):(p.push(e.arrayBlockIndices[l]),d.push(e.arrayBlockIndices[l]+r),f.push(0),u.push(e.arrayBlockIndices[l]));for(var v=[],m=0;m<s[l].length;m++)p[l]<=s[l][m]&&s[l][m]<d[l]&&v.push(s[l][m]-p[l]);h.push(v)}var g=["SS"],y=["'use strict'"],b=[];for(m=0;m<r;++m)b.push(["s",m,"=SS[",m,"]"].join(""));for(l=0;l<e.arrayArgs.length;++l){g.push("a"+l),g.push("t"+l),g.push("p"+l);for(m=0;m<r;++m)b.push(["t",l,"p",m,"=t",l,"[",p[l]+m,"]"].join(""));for(m=0;m<Math.abs(e.arrayBlockIndices[l]);++m)b.push(["t",l,"b",m,"=t",l,"[",f[l]+m,"]"].join(""))}for(l=0;l<e.scalarArgs.length;++l)g.push("Y"+l);if(e.shapeArgs.length>0&&b.push("shape=SS.slice(0)"),e.indexArgs.length>0){var x=new Array(r);for(l=0;l<r;++l)x[l]="0";b.push(["index=[",x.join(","),"]"].join(""))}for(l=0;l<e.offsetArgs.length;++l){var w=e.offsetArgs[l],_=[];for(m=0;m<w.offset.length;++m)0!==w.offset[m]&&(1===w.offset[m]?_.push(["t",w.array,"p",m].join("")):_.push([w.offset[m],"*t",w.array,"p",m].join("")));0===_.length?b.push("q"+l+"=0"):b.push(["q",l,"=",_.join("+")].join(""))}var E=n([].concat(e.pre.thisVars).concat(e.body.thisVars).concat(e.post.thisVars));for((b=b.concat(E)).length>0&&y.push("var "+b.join(",")),l=0;l<e.arrayArgs.length;++l)y.push("p"+l+"|=0");e.pre.body.length>3&&y.push(i(e.pre,e,c));var S=i(e.body,e,c),O=function(e){for(var t=0,r=e[0].length;t<r;){for(var n=1;n<e.length;++n)if(e[n][t]!==e[0][t])return t;++t}return t}(h);O<r?y.push(function(e,t,r,n){for(var i=t.length,a=r.arrayArgs.length,s=r.blockSize,c=r.indexArgs.length>0,l=[],f=0;f<a;++f)l.push(["var offset",f,"=p",f].join(""));for(f=e;f<i;++f)l.push(["for(var j"+f+"=SS[",t[f],"]|0;j",f,">0;){"].join("")),l.push(["if(j",f,"<",s,"){"].join("")),l.push(["s",t[f],"=j",f].join("")),l.push(["j",f,"=0"].join("")),l.push(["}else{s",t[f],"=",s].join("")),l.push(["j",f,"-=",s,"}"].join("")),c&&l.push(["index[",t[f],"]=j",f].join(""));for(f=0;f<a;++f){for(var u=["offset"+f],p=e;p<i;++p)u.push(["j",p,"*t",f,"p",t[p]].join(""));l.push(["p",f,"=(",u.join("+"),")"].join(""))}for(l.push(o(t,r,n)),f=e;f<i;++f)l.push("}");return l.join("\n")}(O,h[0],e,S)):y.push(o(h[0],e,S)),e.post.body.length>3&&y.push(i(e.post,e,c)),e.debug&&console.log("-----Generated cwise routine for ",t,":\n"+y.join("\n")+"\n----------");var R=[e.funcName||"unnamed","_cwise_loop_",s[0].join("s"),"m",O,a(c)].join("");return new Function(["function ",R,"(",g.join(","),"){",y.join("\n"),"} return ",R].join(""))()}},TGEO:function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),Object.defineProperty(t,"WebGLTextureLoader",{enumerable:!0,get:function(){return n.default}}),Object.defineProperty(t,"WebGLTextureLoaderAsyncHashCache",{enumerable:!0,get:function(){return o.default}}),Object.defineProperty(t,"WebGLTextureLoaderSyncHashCache",{enumerable:!0,get:function(){return i.default}}),Object.defineProperty(t,"LoadersRegistry",{enumerable:!0,get:function(){return a.default}}),Object.defineProperty(t,"LoaderResolver",{enumerable:!0,get:function(){return s.default}}),Object.defineProperty(t,"globalRegistry",{enumerable:!0,get:function(){return c.default}});var n=l(r("HbIt")),o=l(r("cDsr")),i=l(r("VYxY")),a=l(r("Ni9w")),s=l(r("LhdL")),c=l(r("OTww"));function l(e){return e&&e.__esModule?e:{default:e}}},TKux:function(e,t,r){"use strict";r.d(t,"b",(function(){return tc})),r.d(t,"c",(function(){return rc})),r.d(t,"a",(function(){return nc}));var n={};r.r(n),r.d(n,"n",(function(){return be})),r.d(n,"title",(function(){return xe})),r.d(n,"Shader",(function(){return we}));var o={};r.r(o),r.d(o,"n",(function(){return Ee})),r.d(o,"title",(function(){return Se})),r.d(o,"exportSize",(function(){return Oe})),r.d(o,"exportStart",(function(){return Re})),r.d(o,"exportEnd",(function(){return Te})),r.d(o,"exportFramePerSecond",(function(){return ze})),r.d(o,"exportSpeed",(function(){return Ce})),r.d(o,"Shader",(function(){return Pe}));var i={};r.r(i),r.d(i,"n",(function(){return je})),r.d(i,"title",(function(){return Ae})),r.d(i,"Shader",(function(){return ke}));var a={};r.r(a),r.d(a,"n",(function(){return Be})),r.d(a,"title",(function(){return Fe})),r.d(a,"Shader",(function(){return $e}));var s={};r.r(s),r.d(s,"n",(function(){return Ve})),r.d(s,"title",(function(){return We})),r.d(s,"Shader",(function(){return Xe}));var c={};r.r(c),r.d(c,"n",(function(){return Ye})),r.d(c,"title",(function(){return Qe})),r.d(c,"Shader",(function(){return Ze}));var l={};r.r(l),r.d(l,"n",(function(){return et})),r.d(l,"title",(function(){return tt})),r.d(l,"Shader",(function(){return rt}));var f={};r.r(f),r.d(f,"n",(function(){return ot})),r.d(f,"title",(function(){return it})),r.d(f,"Shader",(function(){return at}));var u={};r.r(u),r.d(u,"n",(function(){return ct})),r.d(u,"title",(function(){return lt})),r.d(u,"exportSize",(function(){return ft})),r.d(u,"exportStart",(function(){return ut})),r.d(u,"exportEnd",(function(){return pt})),r.d(u,"exportFramePerSecond",(function(){return dt})),r.d(u,"exportSpeed",(function(){return ht})),r.d(u,"Shader",(function(){return vt}));var p={};r.r(p),r.d(p,"n",(function(){return gt})),r.d(p,"title",(function(){return yt})),r.d(p,"Shader",(function(){return bt}));var d={};r.r(d),r.d(d,"n",(function(){return wt})),r.d(d,"title",(function(){return _t})),r.d(d,"Shader",(function(){return Et}));var h={};r.r(h),r.d(h,"n",(function(){return Ot})),r.d(h,"title",(function(){return Rt})),r.d(h,"Shader",(function(){return Tt}));var v={};r.r(v),r.d(v,"n",(function(){return Ct})),r.d(v,"title",(function(){return Pt})),r.d(v,"Shader",(function(){return It}));var m={};r.r(m),r.d(m,"n",(function(){return At})),r.d(m,"title",(function(){return kt})),r.d(m,"Shader",(function(){return Dt}));var g={};r.r(g),r.d(g,"n",(function(){return Vt})),r.d(g,"title",(function(){return Wt})),r.d(g,"Shader",(function(){return Xt}));var y={};r.r(y),r.d(y,"n",(function(){return Zt})),r.d(y,"title",(function(){return Jt})),r.d(y,"Shader",(function(){return er}));var b={};r.r(b),r.d(b,"n",(function(){return rr})),r.d(b,"title",(function(){return nr})),r.d(b,"Shader",(function(){return or}));var x={};r.r(x),r.d(x,"n",(function(){return ar})),r.d(x,"title",(function(){return sr})),r.d(x,"Shader",(function(){return cr}));var w={};r.r(w),r.d(w,"n",(function(){return fr})),r.d(w,"title",(function(){return ur})),r.d(w,"Shader",(function(){return pr}));var _={};r.r(_),r.d(_,"n",(function(){return hr})),r.d(_,"title",(function(){return vr})),r.d(_,"Shader",(function(){return mr}));var E={};r.r(E),r.d(E,"n",(function(){return br})),r.d(E,"title",(function(){return xr})),r.d(E,"Shader",(function(){return wr}));var S={};r.r(S),r.d(S,"n",(function(){return Sr})),r.d(S,"title",(function(){return Or})),r.d(S,"Shader",(function(){return Rr}));var O={};r.r(O),r.d(O,"n",(function(){return zr})),r.d(O,"title",(function(){return Cr})),r.d(O,"Shader",(function(){return Pr}));var R={};r.r(R),r.d(R,"n",(function(){return jr})),r.d(R,"title",(function(){return Ar})),r.d(R,"Shader",(function(){return kr}));var T={};r.r(T),r.d(T,"n",(function(){return Lr})),r.d(T,"title",(function(){return Nr})),r.d(T,"Shader",(function(){return Mr}));var z={};r.r(z),r.d(z,"n",(function(){return Fr})),r.d(z,"title",(function(){return qr})),r.d(z,"Shader",(function(){return $r}));var C={};r.r(C),r.d(C,"n",(function(){return Vr})),r.d(C,"title",(function(){return Wr})),r.d(C,"exportSize",(function(){return Xr})),r.d(C,"exportStart",(function(){return Kr})),r.d(C,"exportEnd",(function(){return Yr})),r.d(C,"exportFramePerSecond",(function(){return Qr})),r.d(C,"exportSpeed",(function(){return Zr})),r.d(C,"Shader",(function(){return Jr}));var P={};r.r(P),r.d(P,"n",(function(){return rn})),r.d(P,"title",(function(){return nn})),r.d(P,"Shader",(function(){return on}));var I={};r.r(I),r.d(I,"n",(function(){return cn})),r.d(I,"title",(function(){return ln})),r.d(I,"Shader",(function(){return fn}));var j={};r.r(j),r.d(j,"n",(function(){return pn})),r.d(j,"title",(function(){return dn})),r.d(j,"Shader",(function(){return hn}));var A={};r.r(A),r.d(A,"n",(function(){return mn})),r.d(A,"title",(function(){return gn})),r.d(A,"Shader",(function(){return yn}));var k={};r.r(k),r.d(k,"n",(function(){return xn})),r.d(k,"title",(function(){return wn})),r.d(k,"Shader",(function(){return En}));var D={};r.r(D),r.d(D,"n",(function(){return On})),r.d(D,"title",(function(){return Rn})),r.d(D,"Shader",(function(){return Tn}));var L={};r.r(L),r.d(L,"n",(function(){return Cn})),r.d(L,"title",(function(){return Pn})),r.d(L,"Shader",(function(){return In}));var N={};r.r(N),r.d(N,"n",(function(){return An})),r.d(N,"title",(function(){return kn})),r.d(N,"Shader",(function(){return Dn}));var M={};r.r(M),r.d(M,"n",(function(){return Mn})),r.d(M,"title",(function(){return Un})),r.d(M,"Shader",(function(){return Bn}));var U={};r.r(U),r.d(U,"n",(function(){return $n})),r.d(U,"title",(function(){return Gn})),r.d(U,"Shader",(function(){return Hn}));var B={};r.r(B),r.d(B,"n",(function(){return Wn})),r.d(B,"title",(function(){return Xn})),r.d(B,"Shader",(function(){return Kn}));var F={};r.r(F),r.d(F,"n",(function(){return Zn})),r.d(F,"title",(function(){return Jn})),r.d(F,"Shader",(function(){return eo}));var q={};r.r(q),r.d(q,"n",(function(){return ro})),r.d(q,"title",(function(){return no})),r.d(q,"Shader",(function(){return oo}));var $={};r.r($),r.d($,"n",(function(){return ao})),r.d($,"title",(function(){return so})),r.d($,"Shader",(function(){return co}));var G={};r.r(G),r.d(G,"n",(function(){return fo})),r.d(G,"title",(function(){return uo})),r.d(G,"Shader",(function(){return po}));var H={};r.r(H),r.d(H,"n",(function(){return vo})),r.d(H,"title",(function(){return mo})),r.d(H,"Shader",(function(){return go}));var V={};r.r(V),r.d(V,"n",(function(){return xo})),r.d(V,"title",(function(){return wo})),r.d(V,"Shader",(function(){return _o}));var W={};r.r(W),r.d(W,"n",(function(){return So})),r.d(W,"title",(function(){return Oo})),r.d(W,"Shader",(function(){return Ro}));var X={};r.r(X),r.d(X,"n",(function(){return zo})),r.d(X,"title",(function(){return Co})),r.d(X,"Shader",(function(){return Po}));var K={};r.r(K),r.d(K,"n",(function(){return jo})),r.d(K,"title",(function(){return Ao})),r.d(K,"Shader",(function(){return ko}));var Y={};r.r(Y),r.d(Y,"n",(function(){return Lo})),r.d(Y,"title",(function(){return No})),r.d(Y,"Shader",(function(){return Mo}));var Q={};r.r(Q),r.d(Q,"n",(function(){return Bo})),r.d(Q,"title",(function(){return Fo})),r.d(Q,"exportSize",(function(){return qo})),r.d(Q,"exportStart",(function(){return $o})),r.d(Q,"exportEnd",(function(){return Go})),r.d(Q,"exportFramePerSecond",(function(){return Ho})),r.d(Q,"exportSpeed",(function(){return Vo})),r.d(Q,"Shader",(function(){return Wo}));var Z={};r.r(Z),r.d(Z,"n",(function(){return Yo})),r.d(Z,"title",(function(){return Qo})),r.d(Z,"Shader",(function(){return Zo}));var J={};r.r(J),r.d(J,"n",(function(){return ei})),r.d(J,"title",(function(){return ti})),r.d(J,"exportSize",(function(){return ri})),r.d(J,"exportStart",(function(){return ni})),r.d(J,"exportEnd",(function(){return oi})),r.d(J,"exportFramePerSecond",(function(){return ii})),r.d(J,"exportSpeed",(function(){return ai})),r.d(J,"Shader",(function(){return si}));var ee={};r.r(ee),r.d(ee,"n",(function(){return li})),r.d(ee,"title",(function(){return fi})),r.d(ee,"Shader",(function(){return ui}));var te={};r.r(te),r.d(te,"n",(function(){return di})),r.d(te,"title",(function(){return hi})),r.d(te,"Shader",(function(){return vi}));var re={};r.r(re),r.d(re,"n",(function(){return gi})),r.d(re,"title",(function(){return yi})),r.d(re,"Shader",(function(){return bi}));var ne={};r.r(ne),r.d(ne,"n",(function(){return wi})),r.d(ne,"title",(function(){return _i})),r.d(ne,"exportSize",(function(){return Ei})),r.d(ne,"exportStart",(function(){return Si})),r.d(ne,"exportEnd",(function(){return Oi})),r.d(ne,"exportFramePerSecond",(function(){return Ri})),r.d(ne,"exportSpeed",(function(){return Ti})),r.d(ne,"Shader",(function(){return zi}));var oe={};r.r(oe),r.d(oe,"n",(function(){return Pi})),r.d(oe,"title",(function(){return Ii})),r.d(oe,"Shader",(function(){return ji}));var ie={};r.r(ie),r.d(ie,"n",(function(){return ki})),r.d(ie,"title",(function(){return Di})),r.d(ie,"exportSize",(function(){return Li})),r.d(ie,"exportStart",(function(){return Ni})),r.d(ie,"exportEnd",(function(){return Mi})),r.d(ie,"exportFramePerSecond",(function(){return Ui})),r.d(ie,"exportSpeed",(function(){return Bi})),r.d(ie,"Shader",(function(){return Fi}));var ae={};r.r(ae),r.d(ae,"exportSize",(function(){return Hi})),r.d(ae,"exportStart",(function(){return Vi})),r.d(ae,"exportEnd",(function(){return Wi})),r.d(ae,"exportFramePerSecond",(function(){return Xi})),r.d(ae,"exportSpeed",(function(){return Ki})),r.d(ae,"exportMP4vb",(function(){return Yi})),r.d(ae,"n",(function(){return Qi})),r.d(ae,"title",(function(){return Zi})),r.d(ae,"nfts",(function(){return Ji})),r.d(ae,"Shader",(function(){return ta}));var se={};r.r(se),r.d(se,"n",(function(){return oa})),r.d(se,"title",(function(){return ia})),r.d(se,"description",(function(){return aa})),r.d(se,"Shader",(function(){return sa}));var ce={};r.r(ce),r.d(ce,"n",(function(){return fa})),r.d(ce,"title",(function(){return ua})),r.d(ce,"Shader",(function(){return pa}));var le={};r.r(le),r.d(le,"n",(function(){return ha})),r.d(le,"title",(function(){return va})),r.d(le,"exportEnd",(function(){return ma})),r.d(le,"exportFramePerSecond",(function(){return ga})),r.d(le,"preload",(function(){return ya})),r.d(le,"Shader",(function(){return ba}));var fe={};r.r(fe),r.d(fe,"n",(function(){return wa})),r.d(fe,"title",(function(){return _a})),r.d(fe,"exportEnd",(function(){return Ea})),r.d(fe,"exportFramePerSecond",(function(){return Sa})),r.d(fe,"exportSpeed",(function(){return Oa})),r.d(fe,"Logic",(function(){return Ra})),r.d(fe,"Shader",(function(){return Ia}));var ue={};r.r(ue),r.d(ue,"n",(function(){return ka})),r.d(ue,"title",(function(){return Da})),r.d(ue,"exportSize",(function(){return La})),r.d(ue,"exportStart",(function(){return Na})),r.d(ue,"exportEnd",(function(){return Ma})),r.d(ue,"exportFramePerSecond",(function(){return Ua})),r.d(ue,"exportSpeed",(function(){return Ba})),r.d(ue,"exportMP4vb",(function(){return Fa})),r.d(ue,"Logic",(function(){return $a})),r.d(ue,"Shader",(function(){return Wa}));var pe={};r.r(pe),r.d(pe,"n",(function(){return Ka})),r.d(pe,"title",(function(){return Ya})),r.d(pe,"exportEnd",(function(){return Qa})),r.d(pe,"nfts",(function(){return Za})),r.d(pe,"Shader",(function(){return Ja}));var de={};r.r(de),r.d(de,"n",(function(){return ts})),r.d(de,"title",(function(){return rs})),r.d(de,"exportSize",(function(){return ns})),r.d(de,"exportStart",(function(){return os})),r.d(de,"exportEnd",(function(){return is})),r.d(de,"exportFramePerSecond",(function(){return as})),r.d(de,"exportSpeed",(function(){return ss})),r.d(de,"exportSkipFrame",(function(){return cs})),r.d(de,"exportPaletteGenOnce",(function(){return ls})),r.d(de,"exportPaletteSize",(function(){return fs})),r.d(de,"nfts",(function(){return us})),r.d(de,"Shader",(function(){return ps}));var he={};r.r(he),r.d(he,"n",(function(){return vs})),r.d(he,"title",(function(){return ms})),r.d(he,"exportSize",(function(){return gs})),r.d(he,"exportStart",(function(){return ys})),r.d(he,"exportEnd",(function(){return bs})),r.d(he,"exportFramePerSecond",(function(){return xs})),r.d(he,"exportSpeed",(function(){return ws})),r.d(he,"exportSkipFrame",(function(){return _s})),r.d(he,"exportPaletteGenOnce",(function(){return Es})),r.d(he,"exportPaletteSize",(function(){return Ss})),r.d(he,"Shader",(function(){return Os}));var ve={};r.r(ve),r.d(ve,"n",(function(){return zs})),r.d(ve,"title",(function(){return Cs})),r.d(ve,"exportSize",(function(){return Ps})),r.d(ve,"exportStart",(function(){return Is})),r.d(ve,"exportEnd",(function(){return js})),r.d(ve,"exportFramePerSecond",(function(){return As})),r.d(ve,"exportSpeed",(function(){return ks})),r.d(ve,"exportSkipFrame",(function(){return Ds})),r.d(ve,"exportPaletteGenOnce",(function(){return Ls})),r.d(ve,"exportPaletteSize",(function(){return Ns})),r.d(ve,"Shader",(function(){return Ms}));var me={};r.r(me),r.d(me,"n",(function(){return Fs})),r.d(me,"title",(function(){return qs})),r.d(me,"exportSize",(function(){return $s})),r.d(me,"exportStart",(function(){return Gs})),r.d(me,"exportEnd",(function(){return Hs})),r.d(me,"exportFramePerSecond",(function(){return Vs})),r.d(me,"exportSpeed",(function(){return Ws})),r.d(me,"exportSkipFrame",(function(){return Xs})),r.d(me,"exportPaletteGenOnce",(function(){return Ks})),r.d(me,"exportPaletteSize",(function(){return Ys})),r.d(me,"Shader",(function(){return Qs}));var ge=r("nKUr"),ye=r("rr/c");const be=1,xe="Hello 2020",we=({time:e})=>Object(ge.jsx)(ye.Node,{shader:_e.day001,uniforms:{time:e}}),_e=ye.Shaders.create({day001:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
float vingt (vec2 p) {
...
}`}}),Ee=2,Se="stripes",Oe=400,Re=0,Te=60,ze=24,Ce=1,Pe=({time:e})=>Object(ge.jsx)(ye.Node,{shader:Ie.node,uniforms:{time:e}}),Ie=ye.Shaders.create({node:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),je=3,Ae="zephyr",ke=({time:e})=>Object(ge.jsx)(ye.Node,{shader:De.node,uniforms:{time:e}}),De=ye.Shaders.create({node:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}});var Le=r("q1tI"),Ne=r.n(Le);const Me=ye.Shaders.create({InitGameOfLife:{frag:ye.GLSL`
  precision highp float;
  uniform float seed;
  // i
  varying vec2 uv;
  ...
  }`}}),Ue=Ne.a.memo((({tick:e,size:t,refreshEveryTicks:r})=>e%(r||1/0)===0?Object(ge.jsx)(ye.Node,{shader:Me.InitGameOfLife,uniforms:{seed:Math.random()},width:t,height:t,backbuffering:!0,sync:!0}):Object(ge.jsx)(ye.Node,{shader:Me.GameOfLife,width:t,height:t,backbuffering:!0,sync:!0,uniforms:{t:ye.Uniform.Backbuffer,size:t}}))),Be=4,Fe="Ray of Life";let qe;const $e=({time:e})=>{qe||(qe=e);const t=e-qe,r=Math.floor(10*t),n=r+25,o=10*(1+Math.floor(r/50)),i=10*(1+Math.floor(n/50));return Object(ge.jsx)(Ge,{time:e,a:Object(ge.jsx)(ye.NearestCopy,{children:Object(ge.jsx)(Ue,{refreshEveryTicks:50,tick:r,size:o})}),b:Object(ge.jsx)(ye.NearestCopy,{children:Object(ge.jsx)(Ue,{refreshEveryTicks:50,tick:n,size:i})})})},Ge=({a:e,b:t,time:r})=>Object(ge.jsx)(ye.Node,{uniforms:{a:e,b:t,time:r},shader:He.main}),He=ye.Shaders.create({main:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Ve=5,We="Here We Go Again",Xe=({time:e})=>Object(ge.jsx)(ye.Node,{shader:Ke.node,uniforms:{time:e}}),Ke=ye.Shaders.create({node:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    sqrt(vec3(1. - shad));
  gl_FragColor = vec4(c,1.0);
}`}}),Ye=6,Qe="Bestagons",Ze=({time:e})=>Object(ge.jsx)(ye.Node,{shader:Je.node,uniforms:{time:e}}),Je=ye.Shaders.create({node:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),et=7,tt="Worms party",rt=({time:e})=>Object(ge.jsx)(ye.Node,{shader:nt.node,uniforms:{time:e}}),nt=ye.Shaders.create({node:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    sqrt(vec3(1. - shad));
  gl_FragColor = vec4(c,1.0);
}`}}),ot=8,it="moontains",at=({time:e})=>Object(ge.jsx)(ye.Node,{shader:st.node,uniforms:{time:e}}),st=ye.Shaders.create({node:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),ct=9,lt="Virus",ft=400,ut=16.3,pt=26,dt=24,ht=.8,vt=({time:e})=>Object(ge.jsx)(ye.Node,{shader:mt.node,uniforms:{time:e}}),mt=ye.Shaders.create({node:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),gt=10,yt="ring",bt=({time:e})=>Object(ge.jsx)(ye.Node,{shader:xt.node,uniforms:{time:e}}),xt=ye.Shaders.create({node:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),wt=11,_t="magic mouse",Et=({time:e})=>Object(ge.jsx)(ye.Node,{shader:St.node,uniforms:{time:e}}),St=ye.Shaders.create({node:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Ot=12,Rt="floor is lava",Tt=({time:e})=>Object(ge.jsx)(ye.Node,{shader:zt.node,uniforms:{time:e}}),zt=ye.Shaders.create({node:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Ct=13,Pt="chip",It=({time:e})=>Object(ge.jsx)(ye.Node,{shader:jt.node,uniforms:{time:e}}),jt=ye.Shaders.create({node:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
`}}),At=14,kt="seizure",Dt=({time:e})=>Object(ge.jsx)(ye.Node,{shader:Lt.node,uniforms:{time:e}}),Lt=ye.Shaders.create({node:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Nt=ye.Shaders.create({blur1D:{frag:ye.GLSL`precision highp float;
varying vec2 uv;
uniform sampler2D t;
...
}`}});var Mt=({width:e,height:t,pixelRatio:r,direction:n,children:o})=>Object(ge.jsx)(ye.Node,{shader:Nt.blur1D,width:e,height:t,pixelRatio:r,uniforms:{direction:n,resolution:ye.Uniform.Resolution,t:o}});const Ut=Math.sqrt(2)/2;var Bt=(e,t,r)=>{const n=2*t*Math.ceil(e/2)/r;switch((e-1)%4){case 0:return[n,0];case 1:return[0,n];case 2:return[n*Ut,n*Ut];case 3:return[n*Ut,-n*Ut]}};const Ft=({width:e,height:t,pixelRatio:r,factor:n,children:o,passes:i,directionForPass:a})=>{const s=c=>c<=0?o:Object(ge.jsx)(Mt,{width:e,height:t,pixelRatio:r,direction:a(c,n,i),children:s(c-1)});return s(i)};Ft.defaultProps={passes:2,directionForPass:Bt};var qt=Ft;const $t=ye.Shaders.create({blur1D:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
...
}`}});var Gt=({width:e,height:t,map:r,pixelRatio:n,direction:o,children:i})=>Object(ge.jsx)(ye.Node,{shader:$t.blur1D,width:e,height:t,pixelRatio:n,uniforms:{direction:o,resolution:ye.Uniform.Resolution,t:i,map:r}});const Ht=({width:e,height:t,map:r,pixelRatio:n,factor:o,children:i,passes:a,directionForPass:s})=>{const c=l=>l<=0?i:Object(ge.jsx)(Gt,{width:e,height:t,map:r,pixelRatio:n,direction:s(l,o,a),children:c(l-1)});return c(a)};Ht.defaultProps={passes:2,directionForPass:Bt};const Vt=15,Wt="parametric",Xt=({time:e})=>Object(ge.jsx)(ye.LinearCopy,{children:Object(ge.jsx)(Yt,{persistence:.98+.02*Math.cos(e)+-.8*Math.exp(-e),children:Object(ge.jsx)(qt,{passes:4,factor:.2,children:Object(ge.jsx)(Kt,{time:e})})})}),Kt=({time:e})=>Object(ge.jsx)(ye.Node,{shader:Qt.node,uniforms:{time:e}}),Yt=({children:e,persistence:t})=>Object(ge.jsx)(ye.Node,{shader:Qt.persistence,backbuffering:!0,uniforms:{t:e,back:ye.Uniform.Backbuffer,persistence:t}}),Qt=ye.Shaders.create({persistence:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),Zt=16,Jt="reuleaux",er=({time:e})=>Object(ge.jsx)(ye.Node,{shader:tr.node,uniforms:{time:e}}),tr=ye.Shaders.create({node:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    color(0.5 * time);
  gl_FragColor = vec4(c, 1.0);
}`}}),rr=17,nr="screws",or=({time:e})=>Object(ge.jsx)(ye.Node,{shader:ir.node,uniforms:{time:e}}),ir=ye.Shaders.create({node:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),ar=18,sr="queen",cr=({time:e})=>Object(ge.jsx)(ye.Node,{shader:lr.node,uniforms:{time:e}}),lr=ye.Shaders.create({node:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
}`}}),fr=19,ur="they were six",pr=({time:e})=>Object(ge.jsx)(ye.Node,{shader:dr.node,uniforms:{time:e}}),dr=ye.Shaders.create({node:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),hr=20,vr="trippy tiles",mr=({time:e})=>Object(ge.jsx)(ye.LinearCopy,{children:Object(ge.jsx)(gr,{persistence:.85,children:Object(ge.jsx)(ye.Node,{shader:yr.node,uniforms:{time:e}})})}),gr=({children:e,persistence:t})=>Object(ge.jsx)(ye.Node,{shader:yr.persistence,backbuffering:!0,uniforms:{t:e,back:ye.Uniform.Backbuffer,persistence:t}}),yr=ye.Shaders.create({persistence:{frag:ye.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),br=21,xr="HODL",wr=({time:e})=>Object(ge.jsx)(ye.LinearCopy,{children:Object(ge.jsx)(_r,{persistence:Math.min(.99,.015*e),time:e,children:Object(ge.jsx)(ye.Node,{shader:Er.node,uniforms:{time:e}})})}),_r=({children:e,persistence:t,time:r})=>Object(ge.jsx)(ye.Node,{shader:Er.shakePersistence,backbuffering:!0,uniforms:{t:e,back:ye.Uniform.Backbuffer,persistence:t,time:r}}),Er=ye.Shaders.create({shakePersistence:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform sampler2D t, back;
uniform float time;
...
}`}}),Sr=22,Or="atoms",Rr=({time:e})=>Object(ge.jsx)(ye.Node,{shader:Tr.node,uniforms:{time:e,t:"/images/einstein-tongue-out.jpg"}}),Tr=ye.Shaders.create({node:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D t;
...
void main() {
...
}`}}),zr=23,Cr="Hexacubes",Pr=({time:e})=>Object(ge.jsx)(ye.Node,{shader:Ir.node,uniforms:{time:e}}),Ir=ye.Shaders.create({node:{frag:ye.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform float time;
  const float PI = ${Math.PI};
  ...
  void main() {
    ...
    gl_FragColor = vec4(c, 1.0);
      ...
      `}}),jr=24,Ar="dark cubes",kr=({time:e})=>Object(ge.jsx)(ye.Node,{shader:Dr.node,uniforms:{time:e}}),Dr=ye.Shaders.create({node:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),Lr=25,Nr="Mandelbrot",Mr=({time:e})=>Object(ge.jsx)(ye.LinearCopy,{children:Object(ge.jsx)(Ur,{persistence:.9,children:Object(ge.jsx)(qt,{passes:4,factor:.1,children:Object(ge.jsx)(ye.Node,{shader:Br.node,uniforms:{time:e}})})})}),Ur=({children:e,persistence:t})=>Object(ge.jsx)(ye.Node,{shader:Br.persistence,backbuffering:!0,uniforms:{t:e,back:ye.Uniform.Backbuffer,persistence:t}}),Br=ye.Shaders.create({persistence:{frag:ye.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Fr=26,qr="fumes",$r=({time:e})=>Object(ge.jsx)(ye.LinearCopy,{children:Object(ge.jsx)(Gr,{persistence:.9,children:Object(ge.jsx)(qt,{passes:4,factor:Math.min(.6,.01*e),children:Object(ge.jsx)(ye.Node,{shader:Hr.node,uniforms:{time:e}})})})}),Gr=({children:e,persistence:t})=>Object(ge.jsx)(ye.Node,{shader:Hr.persistence,backbuffering:!0,uniforms:{t:e,back:ye.Uniform.Backbuffer,persistence:t}}),Hr=ye.Shaders.create({persistence:{frag:ye.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Vr=27,Wr="real burning ship",Xr=400,Kr=0,Yr=60,Qr=12,Zr=2,Jr=({time:e})=>Object(ge.jsx)(ye.LinearCopy,{children:Object(ge.jsx)(en,{persistence:.8+.05*Math.random(),time:e,children:Object(ge.jsx)(ye.Node,{shader:tn.node,uniforms:{time:e}})})}),en=({children:e,persistence:t,time:r})=>Object(ge.jsx)(ye.Node,{shader:tn.persistence,backbuffering:!0,uniforms:{t:e,back:ye.Uniform.Backbuffer,persistence:t,time:r}}),tn=ye.Shaders.create({persistence:{frag:ye.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),rn=28,nn="No, I'M Batman",on=({time:e})=>Object(ge.jsx)(ye.LinearCopy,{children:Object(ge.jsx)(an,{persistence:.5+.48*Math.min(1,e/60),children:Object(ge.jsx)(ye.Node,{shader:sn.node,uniforms:{time:e}})})}),an=({children:e,persistence:t})=>Object(ge.jsx)(ye.Node,{shader:sn.persistence,backbuffering:!0,uniforms:{t:e,back:ye.Uniform.Backbuffer,persistence:t}}),sn=ye.Shaders.create({persistence:{frag:ye.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),cn=29,ln="sdBitcoin(p)",fn=({time:e})=>Object(ge.jsx)(ye.Node,{shader:un.node,uniforms:{time:e}}),un=ye.Shaders.create({node:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),pn=30,dn="21 millions",hn=({time:e})=>Object(ge.jsx)(ye.Node,{shader:vn.node,uniforms:{time:e,numberInCirculation:18557031}}),vn=ye.Shaders.create({node:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),mn=31,gn="alien tower",yn=({time:e})=>Object(ge.jsx)(ye.Node,{shader:bn.node,uniforms:{time:e,numberInCirculation:18557031}}),bn=ye.Shaders.create({node:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform float numberInCirculation;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),xn=32,wn="GoL valley";let _n;const En=({time:e})=>{_n||(_n=e);const t=e-_n,r=Math.floor(12*t);return Object(ge.jsx)(ye.Node,{shader:Sn.node,uniforms:{time:e,t:Object(ge.jsx)(Ue,{refreshEveryTicks:100,tick:r,size:100})}})},Sn=ye.Shaders.create({node:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D t;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),On=33,Rn="x(x+32y)%(tN+1)%n";const Tn=({time:e})=>Object(ge.jsx)(ye.Node,{shader:zn.node,uniforms:{time:e}}),zn=ye.Shaders.create({node:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Cn=34,Pn="\u230a2cos(x)sin(y+t)\u230b%7";const In=({time:e})=>Object(ge.jsx)(ye.Node,{shader:jn.node,uniforms:{time:e}}),jn=ye.Shaders.create({node:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
#define PI ${Math.PI}
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),An=35,kn="aie confiance",Dn=({time:e})=>Object(ge.jsx)(ye.LinearCopy,{children:Object(ge.jsx)(Ln,{persistence:.6,children:Object(ge.jsx)(ye.Node,{shader:Nn.node,uniforms:{time:e}})})}),Ln=({children:e,persistence:t})=>Object(ge.jsx)(ye.Node,{shader:Nn.persistence,backbuffering:!0,uniforms:{t:e,back:ye.Uniform.Backbuffer,persistence:t}}),Nn=ye.Shaders.create({persistence:{frag:ye.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Mn=36,Un="crois en moi",Bn=({time:e})=>Object(ge.jsx)(ye.LinearCopy,{children:Object(ge.jsx)(Fn,{children:Object(ge.jsx)(ye.Node,{shader:qn.node,uniforms:{time:e}})})}),Fn=({children:e,persistence:t})=>Object(ge.jsx)(ye.Node,{shader:qn.persistence,backbuffering:!0,uniforms:{t:e,back:ye.Uniform.Backbuffer,persistence:t}}),qn=ye.Shaders.create({persistence:{frag:ye.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),$n=37,Gn="sdBrick",Hn=({time:e})=>Object(ge.jsx)(ye.Node,{shader:Vn.node,uniforms:{time:e}}),Vn=ye.Shaders.create({node:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Wn=38,Xn="Golden mandelbulb",Kn=({time:e})=>Object(ge.jsx)(ye.LinearCopy,{children:Object(ge.jsx)(Yn,{persistence:.5,children:Object(ge.jsx)(ye.Node,{shader:Qn.node,uniforms:{time:e}})})}),Yn=({children:e,persistence:t})=>Object(ge.jsx)(ye.Node,{shader:Qn.persistence,backbuffering:!0,uniforms:{t:e,back:ye.Uniform.Backbuffer,persistence:t}}),Qn=ye.Shaders.create({persistence:{frag:ye.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  clr /= 4.;
  gl_FragColor = vec4(clr, 1.0);
}`}}),Zn=39,Jn="metaballs",eo=({time:e})=>Object(ge.jsx)(ye.Node,{shader:to.node,uniforms:{time:e}}),to=ye.Shaders.create({node:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  clr /= 4.;
  gl_FragColor = vec4(clr, 1.0);
}`}}),ro=40,no="pen-o-plasma",oo=({time:e})=>Object(ge.jsx)(ye.Node,{shader:io.node,uniforms:{time:e}}),io=ye.Shaders.create({node:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(clr, 1.0);
}`}}),ao=41,so="reflection",co=({time:e})=>Object(ge.jsx)(ye.Node,{shader:lo.node,uniforms:{time:e}}),lo=ye.Shaders.create({node:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),fo=42,uo="reflection party",po=({time:e})=>Object(ge.jsx)(ye.Node,{shader:ho.node,uniforms:{time:e}}),ho=ye.Shaders.create({node:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c = mix(c, reflection(p, n, 10.), glossy);
  gl_FragColor = vec4(c, 1.0);
}`}}),vo=43,mo="irreconcilable queens",go=({time:e})=>Object(ge.jsx)(ye.LinearCopy,{children:Object(ge.jsx)(yo,{persistence:.4,children:Object(ge.jsx)(ye.Node,{shader:bo.node,uniforms:{time:e}})})}),yo=({children:e,persistence:t})=>Object(ge.jsx)(ye.Node,{shader:bo.persistence,backbuffering:!0,uniforms:{t:e,back:ye.Uniform.Backbuffer,persistence:t}}),bo=ye.Shaders.create({persistence:{frag:ye.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),xo=44,wo="royal meeting",_o=({time:e})=>Object(ge.jsx)(ye.Node,{shader:Eo.node,uniforms:{time:e}}),Eo=ye.Shaders.create({node:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
#define PI ${Math.PI}
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),So=45,Oo="wood pawns army",Ro=({time:e})=>Object(ge.jsx)(ye.Node,{shader:To.node,uniforms:{time:e,wood:"/images/seamless-wood-background-1.jpg"}}),To=ye.Shaders.create({node:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),zo=46,Co="Bank of Bicoin",Po=({time:e})=>Object(ge.jsx)(ye.Node,{shader:Io.node,uniforms:{time:e}}),Io=ye.Shaders.create({node:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),jo=47,Ao="glow experiment",ko=({time:e})=>Object(ge.jsx)(ye.Node,{shader:Do.node,uniforms:{time:e}}),Do=ye.Shaders.create({node:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Lo=48,No="Starry Night",Mo=({time:e})=>Object(ge.jsx)(ye.Node,{shader:Uo.node,uniforms:{time:e,img:"/images/seamless-wood2.jpg"}}),Uo=ye.Shaders.create({node:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(clr, 1.0);
}`}}),Bo=49,Fo="chinese lantern",qo=400,$o=0,Go=20,Ho=24,Vo=1.1,Wo=({time:e})=>Object(ge.jsx)(ye.LinearCopy,{children:Object(ge.jsx)(Xo,{persistence:.8,children:Object(ge.jsx)(ye.Node,{shader:Ko.node,uniforms:{time:e}})})}),Xo=({children:e,persistence:t})=>Object(ge.jsx)(ye.Node,{shader:Ko.persistence,backbuffering:!0,uniforms:{t:e,back:ye.Uniform.Backbuffer,persistence:t}}),Ko=ye.Shaders.create({persistence:{frag:ye.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  clr += c;
  gl_FragColor = vec4(clr, 1.0);
}`}}),Yo=50,Qo="jumpy rooks",Zo=({time:e})=>Object(ge.jsx)(ye.Node,{shader:Jo.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),Jo=ye.Shaders.create({node:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),ei=51,ti="symmetry chess",ri=400,ni=0,oi=20,ii=24,ai=1,si=({time:e})=>Object(ge.jsx)(ye.Node,{shader:ci.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),ci=ye.Shaders.create({node:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),li=52,fi="knights dance",ui=({time:e})=>Object(ge.jsx)(ye.Node,{shader:pi.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),pi=ye.Shaders.create({node:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),di=53,hi="cross waves",vi=({time:e})=>Object(ge.jsx)(ye.Node,{shader:mi.node,uniforms:{time:e}}),mi=ye.Shaders.create({node:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  */
}`}}),gi=54,yi="chess set",bi=({time:e})=>Object(ge.jsx)(ye.Node,{shader:xi.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),xi=ye.Shaders.create({node:{frag:ye.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  color = vec4(c, 1.0);
}`}}),wi=55,_i="cube d'or",Ei=400,Si=0,Oi=20,Ri=24,Ti=1,zi=({time:e})=>Object(ge.jsx)(ye.Node,{shader:Ci.node,uniforms:{time:e}}),Ci=ye.Shaders.create({node:{frag:ye.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  #endif
  color = vec4(c, 1.0);
}`}}),Pi=56,Ii="jade forest",ji=({time:e})=>Object(ge.jsx)(ye.Node,{shader:Ai.node,uniforms:{time:e}}),Ai=ye.Shaders.create({node:{frag:ye.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  color = vec4(c, 1.0);
}`}}),ki=57,Di="Virus v2",Li=400,Ni=0,Mi=20,Ui=24,Bi=.8,Fi=({time:e})=>Object(ge.jsx)(ye.Node,{shader:qi.node,uniforms:{time:e}}),qi=ye.Shaders.create({node:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}});var $i=r("005v"),Gi=r.n($i);const Hi=400,Vi=0,Wi=30,Xi=20,Ki=1,Yi="5M",Qi=58,Zi="Mandelglitch",Ji=[{url:"https://ethblock.art/create/17",text:"Mint on ethblock.art"},{url:"https://ghostmarket.io/asset/pha/ghost/3008841254969814369262311336331954453497120774334547905246474374493804042898/",text:"ghostmarket.io: 400 KCAL"},{url:"https://www.hicetnunc.xyz/objkt/3063",text:"hicetnunc.xyz: Mandelglitch #1 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3068",text:"hicetnunc.xyz: Mandelglitch #2 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3071",text:"hicetnunc.xyz: Mandelglitch #3 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3072",text:"hicetnunc.xyz: Mandelglitch #4 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3073",text:"hicetnunc.xyz: Mandelglitch #5 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3077",text:"hicetnunc.xyz: Mandelglitch #6 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3088",text:"hicetnunc.xyz: Mandelglitch #7 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3574",text:"hicetnunc.xyz: Mandelglitch #8 (5 XTZ)"}];const ea=e=>e<.5?2*e*e:(4-2*e)*e-1;const ta=({time:e,n:t,exporting:r})=>{const n=Object(Le.useMemo)((()=>function(e,t=0){const r=e?3:50,n=new Gi.a(t);return Array(r).fill(null).map((()=>Array(12).fill(null).map((()=>n.random()))))}(r,t)),[t,r]),o=e/10%n.length,i=Math.floor(o),a=o-i;let[s,c,l,f,u,p,d,h,v,m,g,y]=(b=n[i%n.length],x=n[(i+1)%n.length],w=ea(a),b.map(((e,t)=>e*(1-w)+x[t]*w)));var b,x,w;return l=ea(l),Object(ge.jsx)(ye.LinearCopy,{children:Object(ge.jsx)(na,{persistence:r?0:.8,children:Object(ge.jsx)(ye.Node,{shader:ra.main,uniforms:{aa:r?2:0,time:e,resolution:ye.Uniform.Resolution,travel:s,love:c,dark:l,rot:r?2*Math.PI/Wi:.1,s1:f,s2:u,s3:p,s4:d,s5:h,s6:v,s7:m,s8:g,s9:y}})})})},ra=ye.Shaders.create({persistence:{frag:ye.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  `}}),na=({children:e,persistence:t})=>Object(ge.jsx)(ye.Node,{shader:ra.persistence,backbuffering:!0,uniforms:{t:e,back:ye.Uniform.Backbuffer,persistence:t}}),oa=59,ia="Pixels 256",aa="There will be only 256 patterns generated by this single fragment shader.",sa=({time:e,n:t,exporting:r})=>Object(ge.jsx)(ca,{n:t+1+(r?0:Math.floor(e))}),ca=Ne.a.memo((({n:e})=>{const t=new Gi.a(e%256),r=t.random(),n=t.random(),o=t.random(),i=t.random(),a=t.random(),s=t.random();return Object(ge.jsx)(ye.Node,{shader:la.node,uniforms:{s1:r,s2:n,s3:o,s4:i,s5:a,s6:s}})})),la=ye.Shaders.create({node:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),fa=60,ua="Bitcoin rainbow",pa=({time:e})=>Object(ge.jsx)(ye.Node,{shader:da.node,uniforms:{time:e}}),da=ye.Shaders.create({node:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),ha=61,va="Binance gradients",ma=1,ga=30,ya=["/images/shaders/binance.dist.png"],ba=({time:e})=>Object(ge.jsx)(ye.Node,{shader:xa.node,uniforms:{time:e,image:"/images/shaders/binance.dist.png"}}),xa=ye.Shaders.create({node:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),wa=62,_a="Overgrowth",Ea=20,Sa=40,Oa=1,Ra=({generation:e,size:t,n:r})=>Object(ge.jsx)(ye.Node,{width:t,height:t,shader:ja.logic,uniforms:{generation:e,prev:ye.Uniform.Backbuffer,size:t,seed:r/100},backbuffering:!0}),Ta=Ne.a.memo(Ra),za=({time:e,generation:t,n:r})=>Object(ge.jsx)(ye.Node,{shader:ja.render,uniforms:{time:e,logic:Object(ge.jsx)(Ta,{generation:t,size:140,n:r})},uniformsOptions:{logic:{interpolation:"nearest"}}}),Ca=Ne.a.memo(za),Pa=1e3*Math.random(),Ia=({time:e,n:t})=>Object(ge.jsx)(Ca,{n:t+Pa,time:e,generation:Math.floor(30*e)},t),ja=ye.Shaders.create({logic:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
...
`}});var Aa=r("AJhG");const ka=63,Da="Relics",La=400,Na=2,Ma=4,Ua=20,Ba=1,Fa="5M",qa={colors:[.7,.55,.4],logicSize:80,amp:1,base:2,persistance:.89,delta:.5,seed:0};console.log(Object.keys(qa).map((e=>String(qa[e]))).join("_"));const $a=({g:e,size:t,seed:r,amp:n,base:o,persistance:i,delta:a})=>Object(ge.jsx)(ye.Node,{width:t,height:t,shader:Xa.logic,uniforms:{amp:n,base:o,g:e,prev:ye.Uniform.Backbuffer,size:t,seed:r,persistance:i,delta:a},backbuffering:!0},t),Ga=Ne.a.memo($a),Ha=({g:e,colors:t,amp:r,base:n,persistance:o,delta:i,logicSize:a,seed:s})=>Object(ge.jsx)(ye.Node,{shader:Xa.render,uniforms:{colors:t,logic:Object(ge.jsx)(Ga,{amp:r,base:n,g:e,size:a,seed:s,persistance:o,delta:i})},uniformsOptions:{logic:{interpolation:"nearest"}}}),Va=Ne.a.memo(Ha),Wa=({time:e})=>{const{colors:t,logicSize:r,amp:n,base:o,persistance:i,delta:a,seed:s}=Object(Aa.b)(qa);return Object(ge.jsx)(Va,{amp:n,base:o,g:Math.floor(20*e)%40,colors:t,persistance:i,delta:a,seed:s,logicSize:r})},Xa=ye.Shaders.create({logic:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform sampler2D prev;
uniform float g;
...
`}}),Ka=64,Ya="Intersection",Qa=8*Math.PI,Za=[{url:"https://www.hicetnunc.xyz/objkt/28592",text:"hic et nunc NFT"}],Ja=({time:e})=>Object(ge.jsx)(ye.Node,{shader:es.render,uniforms:{resolution:ye.Uniform.Resolution,time:e}}),es=ye.Shaders.create({render:{frag:ye.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform vec2 resolution;
...
`}}),ts=65,rs="Duality",ns=800,os=4,is=8,as=30,ss=1,cs=3,ls=!0,fs=16,us=[{url:"https://hicetnunc.xyz/objkt/64326",text:"hic et nunc NFT"}],ps=({time:e})=>Object(ge.jsx)(ye.NearestCopy,{children:Object(ge.jsx)(ds,{persistence:.3,children:Object(ge.jsx)(ye.Node,{shader:hs.render,uniforms:{resolution:ye.Uniform.Resolution,time:e}})})}),ds=({children:e,persistence:t})=>Object(ge.jsx)(ye.Node,{shader:hs.persistence,backbuffering:!0,uniforms:{t:e,back:ye.Uniform.Backbuffer,persistence:t}}),hs=ye.Shaders.create({persistence:{frag:ye.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),vs=66,ms="hicetnunc",gs=800,ys=2,bs=ys+8,xs=30,ws=1,_s=7,Es=!0,Ss=16,Os=({time:e})=>Object(ge.jsx)(ye.NearestCopy,{children:Object(ge.jsx)(Rs,{persistence:.5,children:Object(ge.jsx)(ye.Node,{shader:Ts.render,uniforms:{resolution:ye.Uniform.Resolution,time:e,freq:2}})})}),Rs=({children:e,persistence:t})=>Object(ge.jsx)(ye.Node,{shader:Ts.persistence,backbuffering:!0,uniforms:{t:e,back:ye.Uniform.Backbuffer,persistence:t}}),Ts=ye.Shaders.create({persistence:{frag:ye.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),zs=67,Cs="Jumping blob",Ps=800,Is=2,js=Is+8,As=30,ks=1,Ds=7,Ls=!0,Ns=16,Ms=({time:e})=>Object(ge.jsx)(ye.NearestCopy,{children:Object(ge.jsx)(Us,{persistence:.6,children:Object(ge.jsx)(ye.Node,{shader:Bs.render,uniforms:{resolution:ye.Uniform.Resolution,time:e,freq:2}})})}),Us=({children:e,persistence:t})=>Object(ge.jsx)(ye.Node,{shader:Bs.persistence,backbuffering:!0,uniforms:{t:e,back:ye.Uniform.Backbuffer,persistence:t}}),Bs=ye.Shaders.create({persistence:{frag:ye.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Fs=68,qs="ring",$s=800,Gs=2,Hs=Gs+10,Vs=30,Ws=1,Xs=7,Ks=!0,Ys=128,Qs=({time:e})=>Object(ge.jsx)(ye.NearestCopy,{children:Object(ge.jsx)(Zs,{persistence:.9,children:Object(ge.jsx)(ye.Node,{shader:Js.render,uniforms:{resolution:ye.Uniform.Resolution,time:e,freq:2}})})}),Zs=({children:e,persistence:t})=>Object(ge.jsx)(ye.Node,{shader:Js.persistence,backbuffering:!0,uniforms:{t:e,back:ye.Uniform.Backbuffer,persistence:t}}),Js=ye.Shaders.create({persistence:{frag:ye.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;

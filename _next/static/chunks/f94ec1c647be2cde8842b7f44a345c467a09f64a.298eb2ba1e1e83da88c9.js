...
}`}}).copy;t.default=i},MAJC:function(e,t,r){"use strict";e.exports=function(e){return"undefined"!==typeof e&&null!==e&&("object"===typeof e||"function"===typeof e)}},Ni9w:function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;t.default=class{constructor(){var e,t,r;r=[],(t="_loaders")in(e=this)?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r}add(e){this._loaders.push(e),this._loaders.sort(((e,t)=>("number"===typeof t.priority?t.priority:0)-("number"===typeof e.priority?e.priority:0)))}remove(e){const t=this._loaders.indexOf(e);-1!==t&&this._loaders.splice(t,1)}get(){return this._loaders}}},O8XB:function(e,t,r){"use strict";(function(e,n){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var o,i,a,s,c,l=p(r("tbvF")),f=p(r("Ytbt")),u=p(r("zqV6"));function p(e){return e&&e.__esModule?e:{default:e}}"undefined"===typeof e&&(n.Buffer=(i=o=class{},c=t=>t instanceof e,(s="isBuffer")in(a=o)?Object.defineProperty(a,s,{value:c,enumerable:!0,configurable:!0,writable:!0}):a[s]=c,i));t.default=(e,t,r,n)=>{const o="undefined"!==typeof WebGLRenderingContext&&e instanceof WebGLRenderingContext;let i=r.dtype,a=r.shape.slice(),s=e.getParameter(e.MAX_TEXTURE_SIZE);if(a[0]<0||a[0]>s||a[1]<0||a[1]>s)throw new Error("gl-react: Invalid texture size");let c=function(e,t){return 3===e.length?1===t[2]&&t[1]===e[0]*e[2]&&t[0]===e[2]:1===t[0]&&t[1]===e[0]}(a,r.stride.slice()),p=0;"float32"===i?p=e.FLOAT:"float64"===i?(p=e.FLOAT,c=!1,i="float32"):"uint8"===i?p=e.UNSIGNED_BYTE:(p=e.UNSIGNED_BYTE,c=!1,i="uint8");let d,v=0,h=0;if(2===a.length)h=v=e.LUMINANCE,a=[a[0],a[1],1],r=(0,l.default)(r.data,a,[r.stride[0],r.stride[1],1],r.offset);else{if(3!==a.length)throw new Error("gl-texture2d: Invalid shape for texture");if(1===a[2])h=v=e.ALPHA,o||(n=!1);else if(2===a[2])h=v=e.LUMINANCE_ALPHA,o||(n=!1);else if(3===a[2])v=e.RGB,h=o?e.RGB:e.RGB32F;else{if(4!==a[2])throw new Error("gl-texture2d: Invalid shape for pixel coords");v=e.RGBA,h=o?e.RGBA:e.RGBA32F}}p!==e.FLOAT||n||(p=e.UNSIGNED_BYTE,c=!1);let m,g=r.size;if(c)d=0===r.offset&&r.data.length===g?r.data:r.data.subarray(r.offset,r.offset+g);else{let t=[a[2],a[2]*a[0],1];if("float32"!==i&&"float64"!==i||p!==e.UNSIGNED_BYTE){m=u.default.malloc(g,i);let e=(0,l.default)(m,a,t,0);f.default.assign(e,r)}else{m=u.default.malloc(g,"uint8"),function(e,t){f.default.muls(e,t,255)}((0,l.default)(m,a,t,0),r)}d=m.subarray(0,g)}e.texImage2D(e.TEXTURE_2D,0,h,a[0],a[1],0,v,p,d),m&&u.default.free(m)}}).call(this,r("HDXh").Buffer,r("ntbh"))},OTww:function(e,t,r){"use strict";(function(e){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var n,o=(n=r("Ni9w"))&&n.__esModule?n:{default:n};const i="undefined"===typeof window?e:window,a="__webglTextureLoader_registry";var s=i[a]||(i[a]=new o.default);t.default=s}).call(this,r("ntbh"))},QLaP:function(e,t,r){"use strict";e.exports=function(e,t,r,n,o,i,a,s){if(!e){var c;if(void 0===t)c=new Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else{var l=[r,n,o,i,a,s],f=0;(c=new Error(t.replace(/%s/g,(function(){return l[f++]})))).name="Invariant Violation"}throw c.framesToPop=1,c}}},QM7d:function(e,t,r){"use strict";var n=r("033R");function o(){this.argTypes=[],this.shimArgs=[],this.arrayArgs=[],this.arrayBlockIndices=[],this.scalarArgs=[],this.offsetArgs=[],this.offsetArgIndex=[],this.indexArgs=[],this.shapeArgs=[],this.funcName="",this.pre=null,this.body=null,this.post=null,this.debug=!1}e.exports=function(e){var t=new o;t.pre=e.pre,t.body=e.body,t.post=e.post;var r=e.args.slice(0);t.argTypes=r;for(var i=0;i<r.length;++i){var a=r[i];if("array"===a||"object"===typeof a&&a.blockIndices){if(t.argTypes[i]="array",t.arrayArgs.push(i),t.arrayBlockIndices.push(a.blockIndices?a.blockIndices:0),t.shimArgs.push("array"+i),i<t.pre.args.length&&t.pre.args[i].count>0)throw new Error("cwise: pre() block may not reference array args");if(i<t.post.args.length&&t.post.args[i].count>0)throw new Error("cwise: post() block may not reference array args")}else if("scalar"===a)t.scalarArgs.push(i),t.shimArgs.push("scalar"+i);else if("index"===a){if(t.indexArgs.push(i),i<t.pre.args.length&&t.pre.args[i].count>0)throw new Error("cwise: pre() block may not reference array index");if(i<t.body.args.length&&t.body.args[i].lvalue)throw new Error("cwise: body() block may not write to array index");if(i<t.post.args.length&&t.post.args[i].count>0)throw new Error("cwise: post() block may not reference array index")}else if("shape"===a){if(t.shapeArgs.push(i),i<t.pre.args.length&&t.pre.args[i].lvalue)throw new Error("cwise: pre() block may not write to array shape");if(i<t.body.args.length&&t.body.args[i].lvalue)throw new Error("cwise: body() block may not write to array shape");if(i<t.post.args.length&&t.post.args[i].lvalue)throw new Error("cwise: post() block may not write to array shape")}else{if("object"!==typeof a||!a.offset)throw new Error("cwise: Unknown argument type "+r[i]);t.argTypes[i]="offset",t.offsetArgs.push({array:a.array,offset:a.offset}),t.offsetArgIndex.push(i)}}if(t.arrayArgs.length<=0)throw new Error("cwise: No array arguments specified");if(t.pre.args.length>r.length)throw new Error("cwise: Too many arguments in pre() block");if(t.body.args.length>r.length)throw new Error("cwise: Too many arguments in body() block");if(t.post.args.length>r.length)throw new Error("cwise: Too many arguments in post() block");return t.debug=!!e.printCode||!!e.debug,t.funcName=e.funcName||"cwise",t.blockSize=e.blockSize||64,n(t)}},R9Te:function(e,t,r){"use strict";var n=r("CyWo"),o=r("z08I"),i=r("+0iv"),a=r("vCtr");function s(e){return"__proto__"!==e&&"constructor"!==e&&"prototype"!==e}e.exports=function(e,t,r){if(!a(e))return e;if(Array.isArray(t)&&(t=[].concat.apply([],t).join(".")),"string"!==typeof t)return e;for(var c=n(t,{sep:".",brackets:!0}).filter(s),l=c.length,f=-1,u=e;++f<l;){var p=c[f];f===l-1?i(u[p])&&i(r)?u[p]=o({},u[p],r):u[p]=r:(a(u[p])||(u[p]={}),u=u[p])}return e}},RjOF:function(e,t,r){"use strict";var n,o="";e.exports=function(e,t){if("string"!==typeof e)throw new TypeError("expected a string");if(1===t)return e;if(2===t)return e+e;var r=e.length*t;if(n!==e||"undefined"===typeof n)n=e,o="";else if(o.length>=r)return o.substr(0,r);for(;r>o.length&&t>1;)1&t&&(o+=e),t>>=1,e+=e;return o=(o+=e).substr(0,r)}},Ry8g:function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;t.default=e=>{const t=e.getExtension("WEBGL_lose_context");t&&t.loseContext()}},SMLl:function(e,t,r){"use strict";var n=r("RjOF");e.exports=function(e,t,r){return n(r="undefined"!==typeof r?r+"":" ",t)+e}},TBio:function(e,t,r){"use strict";var n=r("F16p");function o(e,t,r){var n,o,i=e.length,a=t.arrayArgs.length,s=t.indexArgs.length>0,c=[],l=[],f=0,u=0;for(n=0;n<i;++n)l.push(["i",n,"=0"].join(""));for(o=0;o<a;++o)for(n=0;n<i;++n)u=f,f=e[n],0===n?l.push(["d",o,"s",n,"=t",o,"p",f].join("")):l.push(["d",o,"s",n,"=(t",o,"p",f,"-s",u,"*t",o,"p",u,")"].join(""));for(l.length>0&&c.push("var "+l.join(",")),n=i-1;n>=0;--n)f=e[n],c.push(["for(i",n,"=0;i",n,"<s",f,";++i",n,"){"].join(""));for(c.push(r),n=0;n<i;++n){for(u=f,f=e[n],o=0;o<a;++o)c.push(["p",o,"+=d",o,"s",n].join(""));s&&(n>0&&c.push(["index[",u,"]-=s",u].join("")),c.push(["++index[",f,"]"].join(""))),c.push("}")}return c.join("\n")}function i(e,t,r){for(var n=e.body,o=[],i=[],a=0;a<e.args.length;++a){var s=e.args[a];if(!(s.count<=0)){var c=new RegExp(s.name,"g"),l="",f=t.arrayArgs.indexOf(a);switch(t.argTypes[a]){case"offset":var u=t.offsetArgIndex.indexOf(a);f=t.offsetArgs[u].array,l="+q"+u;case"array":l="p"+f+l;var p="l"+a,d="a"+f;if(0===t.arrayBlockIndices[f])1===s.count?"generic"===r[f]?s.lvalue?(o.push(["var ",p,"=",d,".get(",l,")"].join("")),n=n.replace(c,p),i.push([d,".set(",l,",",p,")"].join(""))):n=n.replace(c,[d,".get(",l,")"].join("")):n=n.replace(c,[d,"[",l,"]"].join("")):"generic"===r[f]?(o.push(["var ",p,"=",d,".get(",l,")"].join("")),n=n.replace(c,p),s.lvalue&&i.push([d,".set(",l,",",p,")"].join(""))):(o.push(["var ",p,"=",d,"[",l,"]"].join("")),n=n.replace(c,p),s.lvalue&&i.push([d,"[",l,"]=",p].join("")));else{for(var v=[s.name],h=[l],m=0;m<Math.abs(t.arrayBlockIndices[f]);m++)v.push("\\s*\\[([^\\]]+)\\]"),h.push("$"+(m+1)+"*t"+f+"b"+m);if(c=new RegExp(v.join(""),"g"),l=h.join("+"),"generic"===r[f])throw new Error("cwise: Generic arrays not supported in combination with blocks!");n=n.replace(c,[d,"[",l,"]"].join(""))}break;case"scalar":n=n.replace(c,"Y"+t.scalarArgs.indexOf(a));break;case"index":n=n.replace(c,"index");break;case"shape":n=n.replace(c,"shape")}}}return[o.join("\n"),n,i.join("\n")].join("\n").trim()}function a(e){for(var t=new Array(e.length),r=!0,n=0;n<e.length;++n){var o=e[n],i=o.match(/\d+/);i=i?i[0]:"",0===o.charAt(0)?t[n]="u"+o.charAt(1)+i:t[n]=o.charAt(0)+i,n>0&&(r=r&&t[n]===t[n-1])}return r?t[0]:t.join("")}e.exports=function(e,t){for(var r=t[1].length-Math.abs(e.arrayBlockIndices[0])|0,s=new Array(e.arrayArgs.length),c=new Array(e.arrayArgs.length),l=0;l<e.arrayArgs.length;++l)c[l]=t[2*l],s[l]=t[2*l+1];var f=[],u=[],p=[],d=[],v=[];for(l=0;l<e.arrayArgs.length;++l){e.arrayBlockIndices[l]<0?(p.push(0),d.push(r),f.push(r),u.push(r+e.arrayBlockIndices[l])):(p.push(e.arrayBlockIndices[l]),d.push(e.arrayBlockIndices[l]+r),f.push(0),u.push(e.arrayBlockIndices[l]));for(var h=[],m=0;m<s[l].length;m++)p[l]<=s[l][m]&&s[l][m]<d[l]&&h.push(s[l][m]-p[l]);v.push(h)}var g=["SS"],b=["'use strict'"],y=[];for(m=0;m<r;++m)y.push(["s",m,"=SS[",m,"]"].join(""));for(l=0;l<e.arrayArgs.length;++l){g.push("a"+l),g.push("t"+l),g.push("p"+l);for(m=0;m<r;++m)y.push(["t",l,"p",m,"=t",l,"[",p[l]+m,"]"].join(""));for(m=0;m<Math.abs(e.arrayBlockIndices[l]);++m)y.push(["t",l,"b",m,"=t",l,"[",f[l]+m,"]"].join(""))}for(l=0;l<e.scalarArgs.length;++l)g.push("Y"+l);if(e.shapeArgs.length>0&&y.push("shape=SS.slice(0)"),e.indexArgs.length>0){var x=new Array(r);for(l=0;l<r;++l)x[l]="0";y.push(["index=[",x.join(","),"]"].join(""))}for(l=0;l<e.offsetArgs.length;++l){var w=e.offsetArgs[l],_=[];for(m=0;m<w.offset.length;++m)0!==w.offset[m]&&(1===w.offset[m]?_.push(["t",w.array,"p",m].join("")):_.push([w.offset[m],"*t",w.array,"p",m].join("")));0===_.length?y.push("q"+l+"=0"):y.push(["q",l,"=",_.join("+")].join(""))}var E=n([].concat(e.pre.thisVars).concat(e.body.thisVars).concat(e.post.thisVars));for((y=y.concat(E)).length>0&&b.push("var "+y.join(",")),l=0;l<e.arrayArgs.length;++l)b.push("p"+l+"|=0");e.pre.body.length>3&&b.push(i(e.pre,e,c));var S=i(e.body,e,c),O=function(e){for(var t=0,r=e[0].length;t<r;){for(var n=1;n<e.length;++n)if(e[n][t]!==e[0][t])return t;++t}return t}(v);O<r?b.push(function(e,t,r,n){for(var i=t.length,a=r.arrayArgs.length,s=r.blockSize,c=r.indexArgs.length>0,l=[],f=0;f<a;++f)l.push(["var offset",f,"=p",f].join(""));for(f=e;f<i;++f)l.push(["for(var j"+f+"=SS[",t[f],"]|0;j",f,">0;){"].join("")),l.push(["if(j",f,"<",s,"){"].join("")),l.push(["s",t[f],"=j",f].join("")),l.push(["j",f,"=0"].join("")),l.push(["}else{s",t[f],"=",s].join("")),l.push(["j",f,"-=",s,"}"].join("")),c&&l.push(["index[",t[f],"]=j",f].join(""));for(f=0;f<a;++f){for(var u=["offset"+f],p=e;p<i;++p)u.push(["j",p,"*t",f,"p",t[p]].join(""));l.push(["p",f,"=(",u.join("+"),")"].join(""))}for(l.push(o(t,r,n)),f=e;f<i;++f)l.push("}");return l.join("\n")}(O,v[0],e,S)):b.push(o(v[0],e,S)),e.post.body.length>3&&b.push(i(e.post,e,c)),e.debug&&console.log("-----Generated cwise routine for ",t,":\n"+b.join("\n")+"\n----------");var R=[e.funcName||"unnamed","_cwise_loop_",s[0].join("s"),"m",O,a(c)].join("");return new Function(["function ",R,"(",g.join(","),"){",b.join("\n"),"} return ",R].join(""))()}},TGEO:function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),Object.defineProperty(t,"WebGLTextureLoader",{enumerable:!0,get:function(){return n.default}}),Object.defineProperty(t,"WebGLTextureLoaderAsyncHashCache",{enumerable:!0,get:function(){return o.default}}),Object.defineProperty(t,"WebGLTextureLoaderSyncHashCache",{enumerable:!0,get:function(){return i.default}}),Object.defineProperty(t,"LoadersRegistry",{enumerable:!0,get:function(){return a.default}}),Object.defineProperty(t,"LoaderResolver",{enumerable:!0,get:function(){return s.default}}),Object.defineProperty(t,"globalRegistry",{enumerable:!0,get:function(){return c.default}});var n=l(r("HbIt")),o=l(r("cDsr")),i=l(r("VYxY")),a=l(r("Ni9w")),s=l(r("LhdL")),c=l(r("OTww"));function l(e){return e&&e.__esModule?e:{default:e}}},TKux:function(e,t,r){"use strict";r.d(t,"b",(function(){return _l})),r.d(t,"c",(function(){return El})),r.d(t,"a",(function(){return Sl}));var n={};r.r(n),r.d(n,"n",(function(){return Oe})),r.d(n,"title",(function(){return Re})),r.d(n,"Shader",(function(){return Te}));var o={};r.r(o),r.d(o,"n",(function(){return Pe})),r.d(o,"title",(function(){return Ce})),r.d(o,"exportSize",(function(){return Ie})),r.d(o,"exportStart",(function(){return je})),r.d(o,"exportEnd",(function(){return Ae})),r.d(o,"exportFramePerSecond",(function(){return ke})),r.d(o,"exportSpeed",(function(){return De})),r.d(o,"Shader",(function(){return Le}));var i={};r.r(i),r.d(i,"n",(function(){return Me})),r.d(i,"title",(function(){return Ue})),r.d(i,"Shader",(function(){return Be}));var a={};r.r(a),r.d(a,"n",(function(){return Ve})),r.d(a,"title",(function(){return We})),r.d(a,"Shader",(function(){return Ke}));var s={};r.r(s),r.d(s,"n",(function(){return Ze})),r.d(s,"title",(function(){return Je})),r.d(s,"Shader",(function(){return et}));var c={};r.r(c),r.d(c,"n",(function(){return rt})),r.d(c,"title",(function(){return nt})),r.d(c,"Shader",(function(){return ot}));var l={};r.r(l),r.d(l,"n",(function(){return at})),r.d(l,"title",(function(){return st})),r.d(l,"Shader",(function(){return ct}));var f={};r.r(f),r.d(f,"n",(function(){return ft})),r.d(f,"title",(function(){return ut})),r.d(f,"Shader",(function(){return pt}));var u={};r.r(u),r.d(u,"n",(function(){return vt})),r.d(u,"title",(function(){return ht})),r.d(u,"exportSize",(function(){return mt})),r.d(u,"exportStart",(function(){return gt})),r.d(u,"exportEnd",(function(){return bt})),r.d(u,"exportFramePerSecond",(function(){return yt})),r.d(u,"exportSpeed",(function(){return xt})),r.d(u,"Shader",(function(){return wt}));var p={};r.r(p),r.d(p,"n",(function(){return Et})),r.d(p,"title",(function(){return St})),r.d(p,"Shader",(function(){return Ot}));var d={};r.r(d),r.d(d,"n",(function(){return Tt})),r.d(d,"title",(function(){return zt})),r.d(d,"Shader",(function(){return Pt}));var v={};r.r(v),r.d(v,"n",(function(){return It})),r.d(v,"title",(function(){return jt})),r.d(v,"Shader",(function(){return At}));var h={};r.r(h),r.d(h,"n",(function(){return Dt})),r.d(h,"title",(function(){return Lt})),r.d(h,"Shader",(function(){return Nt}));var m={};r.r(m),r.d(m,"n",(function(){return Ut})),r.d(m,"title",(function(){return Bt})),r.d(m,"Shader",(function(){return Ft}));var g={};r.r(g),r.d(g,"n",(function(){return Zt})),r.d(g,"title",(function(){return Jt})),r.d(g,"Shader",(function(){return er}));var b={};r.r(b),r.d(b,"n",(function(){return or})),r.d(b,"title",(function(){return ir})),r.d(b,"Shader",(function(){return ar}));var y={};r.r(y),r.d(y,"n",(function(){return cr})),r.d(y,"title",(function(){return lr})),r.d(y,"Shader",(function(){return fr}));var x={};r.r(x),r.d(x,"n",(function(){return pr})),r.d(x,"title",(function(){return dr})),r.d(x,"Shader",(function(){return vr}));var w={};r.r(w),r.d(w,"n",(function(){return mr})),r.d(w,"title",(function(){return gr})),r.d(w,"Shader",(function(){return br}));var _={};r.r(_),r.d(_,"n",(function(){return xr})),r.d(_,"title",(function(){return wr})),r.d(_,"Shader",(function(){return _r}));var E={};r.r(E),r.d(E,"n",(function(){return Or})),r.d(E,"title",(function(){return Rr})),r.d(E,"Shader",(function(){return Tr}));var S={};r.r(S),r.d(S,"n",(function(){return Cr})),r.d(S,"title",(function(){return Ir})),r.d(S,"Shader",(function(){return jr}));var O={};r.r(O),r.d(O,"n",(function(){return kr})),r.d(O,"title",(function(){return Dr})),r.d(O,"Shader",(function(){return Lr}));var R={};r.r(R),r.d(R,"n",(function(){return Mr})),r.d(R,"title",(function(){return Ur})),r.d(R,"Shader",(function(){return Br}));var T={};r.r(T),r.d(T,"n",(function(){return qr})),r.d(T,"title",(function(){return $r})),r.d(T,"Shader",(function(){return Gr}));var z={};r.r(z),r.d(z,"n",(function(){return Wr})),r.d(z,"title",(function(){return Xr})),r.d(z,"Shader",(function(){return Kr}));var P={};r.r(P),r.d(P,"n",(function(){return Zr})),r.d(P,"title",(function(){return Jr})),r.d(P,"exportSize",(function(){return en})),r.d(P,"exportStart",(function(){return tn})),r.d(P,"exportEnd",(function(){return rn})),r.d(P,"exportFramePerSecond",(function(){return nn})),r.d(P,"exportSpeed",(function(){return on})),r.d(P,"Shader",(function(){return an}));var C={};r.r(C),r.d(C,"n",(function(){return ln})),r.d(C,"title",(function(){return fn})),r.d(C,"Shader",(function(){return un}));var I={};r.r(I),r.d(I,"n",(function(){return vn})),r.d(I,"title",(function(){return hn})),r.d(I,"Shader",(function(){return mn}));var j={};r.r(j),r.d(j,"n",(function(){return bn})),r.d(j,"title",(function(){return yn})),r.d(j,"Shader",(function(){return xn}));var A={};r.r(A),r.d(A,"n",(function(){return _n})),r.d(A,"title",(function(){return En})),r.d(A,"Shader",(function(){return Sn}));var k={};r.r(k),r.d(k,"n",(function(){return Rn})),r.d(k,"title",(function(){return Tn})),r.d(k,"Shader",(function(){return Pn}));var D={};r.r(D),r.d(D,"n",(function(){return In})),r.d(D,"title",(function(){return jn})),r.d(D,"Shader",(function(){return An}));var L={};r.r(L),r.d(L,"n",(function(){return Dn})),r.d(L,"title",(function(){return Ln})),r.d(L,"Shader",(function(){return Nn}));var N={};r.r(N),r.d(N,"n",(function(){return Un})),r.d(N,"title",(function(){return Bn})),r.d(N,"Shader",(function(){return Fn}));var M={};r.r(M),r.d(M,"n",(function(){return Gn})),r.d(M,"title",(function(){return Hn})),r.d(M,"Shader",(function(){return Vn}));var U={};r.r(U),r.d(U,"n",(function(){return Kn})),r.d(U,"title",(function(){return Yn})),r.d(U,"Shader",(function(){return Qn}));var B={};r.r(B),r.d(B,"n",(function(){return Jn})),r.d(B,"title",(function(){return eo})),r.d(B,"Shader",(function(){return to}));var F={};r.r(F),r.d(F,"n",(function(){return oo})),r.d(F,"title",(function(){return io})),r.d(F,"Shader",(function(){return ao}));var q={};r.r(q),r.d(q,"n",(function(){return co})),r.d(q,"title",(function(){return lo})),r.d(q,"Shader",(function(){return fo}));var $={};r.r($),r.d($,"n",(function(){return po})),r.d($,"title",(function(){return vo})),r.d($,"Shader",(function(){return ho}));var G={};r.r(G),r.d(G,"n",(function(){return go})),r.d(G,"title",(function(){return bo})),r.d(G,"Shader",(function(){return yo}));var H={};r.r(H),r.d(H,"n",(function(){return wo})),r.d(H,"title",(function(){return _o})),r.d(H,"Shader",(function(){return Eo}));var V={};r.r(V),r.d(V,"n",(function(){return Ro})),r.d(V,"title",(function(){return To})),r.d(V,"Shader",(function(){return zo}));var W={};r.r(W),r.d(W,"n",(function(){return Co})),r.d(W,"title",(function(){return Io})),r.d(W,"Shader",(function(){return jo}));var X={};r.r(X),r.d(X,"n",(function(){return ko})),r.d(X,"title",(function(){return Do})),r.d(X,"Shader",(function(){return Lo}));var K={};r.r(K),r.d(K,"n",(function(){return Mo})),r.d(K,"title",(function(){return Uo})),r.d(K,"Shader",(function(){return Bo}));var Y={};r.r(Y),r.d(Y,"n",(function(){return qo})),r.d(Y,"title",(function(){return $o})),r.d(Y,"Shader",(function(){return Go}));var Q={};r.r(Q),r.d(Q,"n",(function(){return Vo})),r.d(Q,"title",(function(){return Wo})),r.d(Q,"exportSize",(function(){return Xo})),r.d(Q,"exportStart",(function(){return Ko})),r.d(Q,"exportEnd",(function(){return Yo})),r.d(Q,"exportFramePerSecond",(function(){return Qo})),r.d(Q,"exportSpeed",(function(){return Zo})),r.d(Q,"Shader",(function(){return Jo}));var Z={};r.r(Z),r.d(Z,"n",(function(){return ri})),r.d(Z,"title",(function(){return ni})),r.d(Z,"Shader",(function(){return oi}));var J={};r.r(J),r.d(J,"n",(function(){return ai})),r.d(J,"title",(function(){return si})),r.d(J,"exportSize",(function(){return ci})),r.d(J,"exportStart",(function(){return li})),r.d(J,"exportEnd",(function(){return fi})),r.d(J,"exportFramePerSecond",(function(){return ui})),r.d(J,"exportSpeed",(function(){return pi})),r.d(J,"Shader",(function(){return di}));var ee={};r.r(ee),r.d(ee,"n",(function(){return hi})),r.d(ee,"title",(function(){return mi})),r.d(ee,"Shader",(function(){return gi}));var te={};r.r(te),r.d(te,"n",(function(){return yi})),r.d(te,"title",(function(){return xi})),r.d(te,"Shader",(function(){return wi}));var re={};r.r(re),r.d(re,"n",(function(){return Ei})),r.d(re,"title",(function(){return Si})),r.d(re,"Shader",(function(){return Oi}));var ne={};r.r(ne),r.d(ne,"n",(function(){return Ti})),r.d(ne,"title",(function(){return zi})),r.d(ne,"exportSize",(function(){return Pi})),r.d(ne,"exportStart",(function(){return Ci})),r.d(ne,"exportEnd",(function(){return Ii})),r.d(ne,"exportFramePerSecond",(function(){return ji})),r.d(ne,"exportSpeed",(function(){return Ai})),r.d(ne,"Shader",(function(){return ki}));var oe={};r.r(oe),r.d(oe,"n",(function(){return Li})),r.d(oe,"title",(function(){return Ni})),r.d(oe,"Shader",(function(){return Mi}));var ie={};r.r(ie),r.d(ie,"n",(function(){return Bi})),r.d(ie,"title",(function(){return Fi})),r.d(ie,"exportSize",(function(){return qi})),r.d(ie,"exportStart",(function(){return $i})),r.d(ie,"exportEnd",(function(){return Gi})),r.d(ie,"exportFramePerSecond",(function(){return Hi})),r.d(ie,"exportSpeed",(function(){return Vi})),r.d(ie,"Shader",(function(){return Wi}));var ae={};r.r(ae),r.d(ae,"exportSize",(function(){return Qi})),r.d(ae,"exportStart",(function(){return Zi})),r.d(ae,"exportEnd",(function(){return Ji})),r.d(ae,"exportFramePerSecond",(function(){return ea})),r.d(ae,"exportSpeed",(function(){return ta})),r.d(ae,"exportMP4vb",(function(){return ra})),r.d(ae,"n",(function(){return na})),r.d(ae,"title",(function(){return oa})),r.d(ae,"nfts",(function(){return ia})),r.d(ae,"Shader",(function(){return sa}));var se={};r.r(se),r.d(se,"n",(function(){return fa})),r.d(se,"title",(function(){return ua})),r.d(se,"description",(function(){return pa})),r.d(se,"Shader",(function(){return da}));var ce={};r.r(ce),r.d(ce,"n",(function(){return ma})),r.d(ce,"title",(function(){return ga})),r.d(ce,"Shader",(function(){return ba}));var le={};r.r(le),r.d(le,"n",(function(){return xa})),r.d(le,"title",(function(){return wa})),r.d(le,"exportEnd",(function(){return _a})),r.d(le,"exportFramePerSecond",(function(){return Ea})),r.d(le,"preload",(function(){return Sa})),r.d(le,"Shader",(function(){return Oa}));var fe={};r.r(fe),r.d(fe,"n",(function(){return Ta})),r.d(fe,"title",(function(){return za})),r.d(fe,"exportEnd",(function(){return Pa})),r.d(fe,"exportFramePerSecond",(function(){return Ca})),r.d(fe,"exportSpeed",(function(){return Ia})),r.d(fe,"Logic",(function(){return ja})),r.d(fe,"Shader",(function(){return Na}));var ue={};r.r(ue),r.d(ue,"n",(function(){return Ba})),r.d(ue,"title",(function(){return Fa})),r.d(ue,"exportSize",(function(){return qa})),r.d(ue,"exportStart",(function(){return $a})),r.d(ue,"exportEnd",(function(){return Ga})),r.d(ue,"exportFramePerSecond",(function(){return Ha})),r.d(ue,"exportSpeed",(function(){return Va})),r.d(ue,"exportMP4vb",(function(){return Wa})),r.d(ue,"Logic",(function(){return Ka})),r.d(ue,"Shader",(function(){return Ja}));var pe={};r.r(pe),r.d(pe,"n",(function(){return ts})),r.d(pe,"title",(function(){return rs})),r.d(pe,"exportEnd",(function(){return ns})),r.d(pe,"nfts",(function(){return os})),r.d(pe,"Shader",(function(){return is}));var de={};r.r(de),r.d(de,"n",(function(){return ss})),r.d(de,"title",(function(){return cs})),r.d(de,"exportSize",(function(){return ls})),r.d(de,"exportStart",(function(){return fs})),r.d(de,"exportEnd",(function(){return us})),r.d(de,"exportFramePerSecond",(function(){return ps})),r.d(de,"exportSpeed",(function(){return ds})),r.d(de,"exportSkipFrame",(function(){return vs})),r.d(de,"exportPaletteGenOnce",(function(){return hs})),r.d(de,"exportPaletteSize",(function(){return ms})),r.d(de,"nfts",(function(){return gs})),r.d(de,"Shader",(function(){return bs}));var ve={};r.r(ve),r.d(ve,"n",(function(){return ws})),r.d(ve,"title",(function(){return _s})),r.d(ve,"exportSize",(function(){return Es})),r.d(ve,"exportStart",(function(){return Ss})),r.d(ve,"exportEnd",(function(){return Os})),r.d(ve,"exportFramePerSecond",(function(){return Rs})),r.d(ve,"exportSpeed",(function(){return Ts})),r.d(ve,"exportSkipFrame",(function(){return zs})),r.d(ve,"exportPaletteGenOnce",(function(){return Ps})),r.d(ve,"exportPaletteSize",(function(){return Cs})),r.d(ve,"Shader",(function(){return Is}));var he={};r.r(he),r.d(he,"n",(function(){return ks})),r.d(he,"title",(function(){return Ds})),r.d(he,"exportSize",(function(){return Ls})),r.d(he,"exportStart",(function(){return Ns})),r.d(he,"exportEnd",(function(){return Ms})),r.d(he,"exportFramePerSecond",(function(){return Us})),r.d(he,"exportSpeed",(function(){return Bs})),r.d(he,"exportSkipFrame",(function(){return Fs})),r.d(he,"exportPaletteGenOnce",(function(){return qs})),r.d(he,"exportPaletteSize",(function(){return $s})),r.d(he,"Shader",(function(){return Gs}));var me={};r.r(me),r.d(me,"n",(function(){return Ws})),r.d(me,"title",(function(){return Xs})),r.d(me,"exportSize",(function(){return Ks})),r.d(me,"exportStart",(function(){return Ys})),r.d(me,"exportEnd",(function(){return Qs})),r.d(me,"exportFramePerSecond",(function(){return Zs})),r.d(me,"exportSpeed",(function(){return Js})),r.d(me,"exportSkipFrame",(function(){return ec})),r.d(me,"exportPaletteGenOnce",(function(){return tc})),r.d(me,"exportPaletteSize",(function(){return rc})),r.d(me,"Shader",(function(){return nc}));var ge={};r.r(ge),r.d(ge,"n",(function(){return ac})),r.d(ge,"title",(function(){return sc})),r.d(ge,"exportSize",(function(){return cc})),r.d(ge,"exportStart",(function(){return lc})),r.d(ge,"exportEnd",(function(){return fc})),r.d(ge,"exportFramePerSecond",(function(){return uc})),r.d(ge,"exportSpeed",(function(){return pc})),r.d(ge,"exportPaletteGenOnce",(function(){return dc})),r.d(ge,"exportPaletteSize",(function(){return vc})),r.d(ge,"Shader",(function(){return hc}));var be={};r.r(be),r.d(be,"n",(function(){return gc})),r.d(be,"title",(function(){return bc})),r.d(be,"exportSize",(function(){return yc})),r.d(be,"exportStart",(function(){return xc})),r.d(be,"exportEnd",(function(){return wc})),r.d(be,"exportFramePerSecond",(function(){return _c})),r.d(be,"exportSpeed",(function(){return Ec})),r.d(be,"exportPaletteGenOnce",(function(){return Sc})),r.d(be,"exportPaletteSize",(function(){return Oc})),r.d(be,"Shader",(function(){return Rc}));var ye={};r.r(ye),r.d(ye,"n",(function(){return zc})),r.d(ye,"title",(function(){return Pc})),r.d(ye,"exportSize",(function(){return Cc})),r.d(ye,"exportStart",(function(){return Ic})),r.d(ye,"exportEnd",(function(){return jc})),r.d(ye,"exportFramePerSecond",(function(){return Ac})),r.d(ye,"exportSpeed",(function(){return kc})),r.d(ye,"exportPaletteGenOnce",(function(){return Dc})),r.d(ye,"exportPaletteSize",(function(){return Lc})),r.d(ye,"Shader",(function(){return Nc}));var xe={};r.r(xe),r.d(xe,"n",(function(){return Uc})),r.d(xe,"title",(function(){return Bc})),r.d(xe,"exportSize",(function(){return Fc})),r.d(xe,"exportStart",(function(){return qc})),r.d(xe,"exportEnd",(function(){return $c})),r.d(xe,"exportFramePerSecond",(function(){return Gc})),r.d(xe,"exportSpeed",(function(){return Hc})),r.d(xe,"exportPaletteGenOnce",(function(){return Vc})),r.d(xe,"exportPaletteSize",(function(){return Wc})),r.d(xe,"nfts",(function(){return Xc})),r.d(xe,"Shader",(function(){return Kc}));var we={};r.r(we),r.d(we,"n",(function(){return Qc})),r.d(we,"title",(function(){return Zc})),r.d(we,"exportSize",(function(){return Jc})),r.d(we,"exportStart",(function(){return el})),r.d(we,"exportEnd",(function(){return tl})),r.d(we,"exportFramePerSecond",(function(){return rl})),r.d(we,"exportSpeed",(function(){return nl})),r.d(we,"exportPaletteGenOnce",(function(){return ol})),r.d(we,"exportPaletteSize",(function(){return il})),r.d(we,"Shader",(function(){return sl}));var _e={};r.r(_e),r.d(_e,"n",(function(){return ll})),r.d(_e,"title",(function(){return fl})),r.d(_e,"exportSize",(function(){return ul})),r.d(_e,"exportStart",(function(){return pl})),r.d(_e,"exportEnd",(function(){return dl})),r.d(_e,"exportFramePerSecond",(function(){return vl})),r.d(_e,"exportSpeed",(function(){return hl})),r.d(_e,"exportPaletteGenOnce",(function(){return ml})),r.d(_e,"exportPaletteSize",(function(){return gl})),r.d(_e,"Shader",(function(){return yl}));var Ee=r("nKUr"),Se=r("rr/c");const Oe=1,Re="Hello 2020",Te=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:ze.day001,uniforms:{time:e}}),ze=Se.Shaders.create({day001:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
float vingt (vec2 p) {
...
}`}}),Pe=2,Ce="stripes",Ie=400,je=0,Ae=60,ke=24,De=1,Le=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:Ne.node,uniforms:{time:e}}),Ne=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),Me=3,Ue="zephyr",Be=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:Fe.node,uniforms:{time:e}}),Fe=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}});var qe=r("q1tI"),$e=r.n(qe);const Ge=Se.Shaders.create({InitGameOfLife:{frag:Se.GLSL`
  precision highp float;
  uniform float seed;
  // i
  varying vec2 uv;
  ...
  }`}}),He=$e.a.memo((({tick:e,size:t,refreshEveryTicks:r})=>e%(r||1/0)===0?Object(Ee.jsx)(Se.Node,{shader:Ge.InitGameOfLife,uniforms:{seed:Math.random()},width:t,height:t,backbuffering:!0,sync:!0}):Object(Ee.jsx)(Se.Node,{shader:Ge.GameOfLife,width:t,height:t,backbuffering:!0,sync:!0,uniforms:{t:Se.Uniform.Backbuffer,size:t}}))),Ve=4,We="Ray of Life";let Xe;const Ke=({time:e})=>{Xe||(Xe=e);const t=e-Xe,r=Math.floor(10*t),n=r+25,o=10*(1+Math.floor(r/50)),i=10*(1+Math.floor(n/50));return Object(Ee.jsx)(Ye,{time:e,a:Object(Ee.jsx)(Se.NearestCopy,{children:Object(Ee.jsx)(He,{refreshEveryTicks:50,tick:r,size:o})}),b:Object(Ee.jsx)(Se.NearestCopy,{children:Object(Ee.jsx)(He,{refreshEveryTicks:50,tick:n,size:i})})})},Ye=({a:e,b:t,time:r})=>Object(Ee.jsx)(Se.Node,{uniforms:{a:e,b:t,time:r},shader:Qe.main}),Qe=Se.Shaders.create({main:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Ze=5,Je="Here We Go Again",et=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:tt.node,uniforms:{time:e}}),tt=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    sqrt(vec3(1. - shad));
  gl_FragColor = vec4(c,1.0);
}`}}),rt=6,nt="Bestagons",ot=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:it.node,uniforms:{time:e}}),it=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),at=7,st="Worms party",ct=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:lt.node,uniforms:{time:e}}),lt=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    sqrt(vec3(1. - shad));
  gl_FragColor = vec4(c,1.0);
}`}}),ft=8,ut="moontains",pt=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:dt.node,uniforms:{time:e}}),dt=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),vt=9,ht="Virus",mt=400,gt=16.3,bt=26,yt=24,xt=.8,wt=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:_t.node,uniforms:{time:e}}),_t=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Et=10,St="ring",Ot=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:Rt.node,uniforms:{time:e}}),Rt=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Tt=11,zt="magic mouse",Pt=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:Ct.node,uniforms:{time:e}}),Ct=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),It=12,jt="floor is lava",At=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:kt.node,uniforms:{time:e}}),kt=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Dt=13,Lt="chip",Nt=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:Mt.node,uniforms:{time:e}}),Mt=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
`}}),Ut=14,Bt="seizure",Ft=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:qt.node,uniforms:{time:e}}),qt=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),$t=Se.Shaders.create({blur1D:{frag:Se.GLSL`precision highp float;
varying vec2 uv;
uniform sampler2D t;
...
}`}});var Gt=({width:e,height:t,pixelRatio:r,direction:n,children:o})=>Object(Ee.jsx)(Se.Node,{shader:$t.blur1D,width:e,height:t,pixelRatio:r,uniforms:{direction:n,resolution:Se.Uniform.Resolution,t:o}});const Ht=Math.sqrt(2)/2;var Vt=(e,t,r)=>{const n=2*t*Math.ceil(e/2)/r;switch((e-1)%4){case 0:return[n,0];case 1:return[0,n];case 2:return[n*Ht,n*Ht];case 3:return[n*Ht,-n*Ht]}};const Wt=({width:e,height:t,pixelRatio:r,factor:n,children:o,passes:i,directionForPass:a})=>{const s=c=>c<=0?o:Object(Ee.jsx)(Gt,{width:e,height:t,pixelRatio:r,direction:a(c,n,i),children:s(c-1)});return s(i)};Wt.defaultProps={passes:2,directionForPass:Vt};var Xt=Wt;const Kt=Se.Shaders.create({blur1D:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
...
}`}});var Yt=({width:e,height:t,map:r,pixelRatio:n,direction:o,children:i})=>Object(Ee.jsx)(Se.Node,{shader:Kt.blur1D,width:e,height:t,pixelRatio:n,uniforms:{direction:o,resolution:Se.Uniform.Resolution,t:i,map:r}});const Qt=({width:e,height:t,map:r,pixelRatio:n,factor:o,children:i,passes:a,directionForPass:s})=>{const c=l=>l<=0?i:Object(Ee.jsx)(Yt,{width:e,height:t,map:r,pixelRatio:n,direction:s(l,o,a),children:c(l-1)});return c(a)};Qt.defaultProps={passes:2,directionForPass:Vt};const Zt=15,Jt="parametric",er=({time:e})=>Object(Ee.jsx)(Se.LinearCopy,{children:Object(Ee.jsx)(rr,{persistence:.98+.02*Math.cos(e)+-.8*Math.exp(-e),children:Object(Ee.jsx)(Xt,{passes:4,factor:.2,children:Object(Ee.jsx)(tr,{time:e})})})}),tr=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:nr.node,uniforms:{time:e}}),rr=({children:e,persistence:t})=>Object(Ee.jsx)(Se.Node,{shader:nr.persistence,backbuffering:!0,uniforms:{t:e,back:Se.Uniform.Backbuffer,persistence:t}}),nr=Se.Shaders.create({persistence:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),or=16,ir="reuleaux",ar=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:sr.node,uniforms:{time:e}}),sr=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    color(0.5 * time);
  gl_FragColor = vec4(c, 1.0);
}`}}),cr=17,lr="screws",fr=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:ur.node,uniforms:{time:e}}),ur=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),pr=18,dr="queen",vr=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:hr.node,uniforms:{time:e}}),hr=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
}`}}),mr=19,gr="they were six",br=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:yr.node,uniforms:{time:e}}),yr=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),xr=20,wr="trippy tiles",_r=({time:e})=>Object(Ee.jsx)(Se.LinearCopy,{children:Object(Ee.jsx)(Er,{persistence:.85,children:Object(Ee.jsx)(Se.Node,{shader:Sr.node,uniforms:{time:e}})})}),Er=({children:e,persistence:t})=>Object(Ee.jsx)(Se.Node,{shader:Sr.persistence,backbuffering:!0,uniforms:{t:e,back:Se.Uniform.Backbuffer,persistence:t}}),Sr=Se.Shaders.create({persistence:{frag:Se.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Or=21,Rr="HODL",Tr=({time:e})=>Object(Ee.jsx)(Se.LinearCopy,{children:Object(Ee.jsx)(zr,{persistence:Math.min(.99,.015*e),time:e,children:Object(Ee.jsx)(Se.Node,{shader:Pr.node,uniforms:{time:e}})})}),zr=({children:e,persistence:t,time:r})=>Object(Ee.jsx)(Se.Node,{shader:Pr.shakePersistence,backbuffering:!0,uniforms:{t:e,back:Se.Uniform.Backbuffer,persistence:t,time:r}}),Pr=Se.Shaders.create({shakePersistence:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform sampler2D t, back;
uniform float time;
...
}`}}),Cr=22,Ir="atoms",jr=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:Ar.node,uniforms:{time:e,t:"/images/einstein-tongue-out.jpg"}}),Ar=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D t;
...
void main() {
...
}`}}),kr=23,Dr="Hexacubes",Lr=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:Nr.node,uniforms:{time:e}}),Nr=Se.Shaders.create({node:{frag:Se.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform float time;
  const float PI = ${Math.PI};
  ...
  void main() {
    ...
    gl_FragColor = vec4(c, 1.0);
      ...
      `}}),Mr=24,Ur="dark cubes",Br=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:Fr.node,uniforms:{time:e}}),Fr=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),qr=25,$r="Mandelbrot",Gr=({time:e})=>Object(Ee.jsx)(Se.LinearCopy,{children:Object(Ee.jsx)(Hr,{persistence:.9,children:Object(Ee.jsx)(Xt,{passes:4,factor:.1,children:Object(Ee.jsx)(Se.Node,{shader:Vr.node,uniforms:{time:e}})})})}),Hr=({children:e,persistence:t})=>Object(Ee.jsx)(Se.Node,{shader:Vr.persistence,backbuffering:!0,uniforms:{t:e,back:Se.Uniform.Backbuffer,persistence:t}}),Vr=Se.Shaders.create({persistence:{frag:Se.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Wr=26,Xr="fumes",Kr=({time:e})=>Object(Ee.jsx)(Se.LinearCopy,{children:Object(Ee.jsx)(Yr,{persistence:.9,children:Object(Ee.jsx)(Xt,{passes:4,factor:Math.min(.6,.01*e),children:Object(Ee.jsx)(Se.Node,{shader:Qr.node,uniforms:{time:e}})})})}),Yr=({children:e,persistence:t})=>Object(Ee.jsx)(Se.Node,{shader:Qr.persistence,backbuffering:!0,uniforms:{t:e,back:Se.Uniform.Backbuffer,persistence:t}}),Qr=Se.Shaders.create({persistence:{frag:Se.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Zr=27,Jr="real burning ship",en=400,tn=0,rn=60,nn=12,on=2,an=({time:e})=>Object(Ee.jsx)(Se.LinearCopy,{children:Object(Ee.jsx)(sn,{persistence:.8+.05*Math.random(),time:e,children:Object(Ee.jsx)(Se.Node,{shader:cn.node,uniforms:{time:e}})})}),sn=({children:e,persistence:t,time:r})=>Object(Ee.jsx)(Se.Node,{shader:cn.persistence,backbuffering:!0,uniforms:{t:e,back:Se.Uniform.Backbuffer,persistence:t,time:r}}),cn=Se.Shaders.create({persistence:{frag:Se.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),ln=28,fn="No, I'M Batman",un=({time:e})=>Object(Ee.jsx)(Se.LinearCopy,{children:Object(Ee.jsx)(pn,{persistence:.5+.48*Math.min(1,e/60),children:Object(Ee.jsx)(Se.Node,{shader:dn.node,uniforms:{time:e}})})}),pn=({children:e,persistence:t})=>Object(Ee.jsx)(Se.Node,{shader:dn.persistence,backbuffering:!0,uniforms:{t:e,back:Se.Uniform.Backbuffer,persistence:t}}),dn=Se.Shaders.create({persistence:{frag:Se.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),vn=29,hn="sdBitcoin(p)",mn=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:gn.node,uniforms:{time:e}}),gn=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),bn=30,yn="21 millions",xn=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:wn.node,uniforms:{time:e,numberInCirculation:18557031}}),wn=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),_n=31,En="alien tower",Sn=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:On.node,uniforms:{time:e,numberInCirculation:18557031}}),On=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform float numberInCirculation;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Rn=32,Tn="GoL valley";let zn;const Pn=({time:e})=>{zn||(zn=e);const t=e-zn,r=Math.floor(12*t);return Object(Ee.jsx)(Se.Node,{shader:Cn.node,uniforms:{time:e,t:Object(Ee.jsx)(He,{refreshEveryTicks:100,tick:r,size:100})}})},Cn=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D t;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),In=33,jn="x(x+32y)%(tN+1)%n";const An=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:kn.node,uniforms:{time:e}}),kn=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Dn=34,Ln="\u230a2cos(x)sin(y+t)\u230b%7";const Nn=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:Mn.node,uniforms:{time:e}}),Mn=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
#define PI ${Math.PI}
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Un=35,Bn="aie confiance",Fn=({time:e})=>Object(Ee.jsx)(Se.LinearCopy,{children:Object(Ee.jsx)(qn,{persistence:.6,children:Object(Ee.jsx)(Se.Node,{shader:$n.node,uniforms:{time:e}})})}),qn=({children:e,persistence:t})=>Object(Ee.jsx)(Se.Node,{shader:$n.persistence,backbuffering:!0,uniforms:{t:e,back:Se.Uniform.Backbuffer,persistence:t}}),$n=Se.Shaders.create({persistence:{frag:Se.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Gn=36,Hn="crois en moi",Vn=({time:e})=>Object(Ee.jsx)(Se.LinearCopy,{children:Object(Ee.jsx)(Wn,{children:Object(Ee.jsx)(Se.Node,{shader:Xn.node,uniforms:{time:e}})})}),Wn=({children:e,persistence:t})=>Object(Ee.jsx)(Se.Node,{shader:Xn.persistence,backbuffering:!0,uniforms:{t:e,back:Se.Uniform.Backbuffer,persistence:t}}),Xn=Se.Shaders.create({persistence:{frag:Se.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Kn=37,Yn="sdBrick",Qn=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:Zn.node,uniforms:{time:e}}),Zn=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Jn=38,eo="Golden mandelbulb",to=({time:e})=>Object(Ee.jsx)(Se.LinearCopy,{children:Object(Ee.jsx)(ro,{persistence:.5,children:Object(Ee.jsx)(Se.Node,{shader:no.node,uniforms:{time:e}})})}),ro=({children:e,persistence:t})=>Object(Ee.jsx)(Se.Node,{shader:no.persistence,backbuffering:!0,uniforms:{t:e,back:Se.Uniform.Backbuffer,persistence:t}}),no=Se.Shaders.create({persistence:{frag:Se.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  clr /= 4.;
  gl_FragColor = vec4(clr, 1.0);
}`}}),oo=39,io="metaballs",ao=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:so.node,uniforms:{time:e}}),so=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  clr /= 4.;
  gl_FragColor = vec4(clr, 1.0);
}`}}),co=40,lo="pen-o-plasma",fo=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:uo.node,uniforms:{time:e}}),uo=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(clr, 1.0);
}`}}),po=41,vo="reflection",ho=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:mo.node,uniforms:{time:e}}),mo=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),go=42,bo="reflection party",yo=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:xo.node,uniforms:{time:e}}),xo=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c = mix(c, reflection(p, n, 10.), glossy);
  gl_FragColor = vec4(c, 1.0);
}`}}),wo=43,_o="irreconcilable queens",Eo=({time:e})=>Object(Ee.jsx)(Se.LinearCopy,{children:Object(Ee.jsx)(So,{persistence:.4,children:Object(Ee.jsx)(Se.Node,{shader:Oo.node,uniforms:{time:e}})})}),So=({children:e,persistence:t})=>Object(Ee.jsx)(Se.Node,{shader:Oo.persistence,backbuffering:!0,uniforms:{t:e,back:Se.Uniform.Backbuffer,persistence:t}}),Oo=Se.Shaders.create({persistence:{frag:Se.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Ro=44,To="royal meeting",zo=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:Po.node,uniforms:{time:e}}),Po=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
#define PI ${Math.PI}
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),Co=45,Io="wood pawns army",jo=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:Ao.node,uniforms:{time:e,wood:"/images/seamless-wood-background-1.jpg"}}),Ao=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),ko=46,Do="Bank of Bicoin",Lo=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:No.node,uniforms:{time:e}}),No=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),Mo=47,Uo="glow experiment",Bo=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:Fo.node,uniforms:{time:e}}),Fo=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),qo=48,$o="Starry Night",Go=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:Ho.node,uniforms:{time:e,img:"/images/seamless-wood2.jpg"}}),Ho=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(clr, 1.0);
}`}}),Vo=49,Wo="chinese lantern",Xo=400,Ko=0,Yo=20,Qo=24,Zo=1.1,Jo=({time:e})=>Object(Ee.jsx)(Se.LinearCopy,{children:Object(Ee.jsx)(ei,{persistence:.8,children:Object(Ee.jsx)(Se.Node,{shader:ti.node,uniforms:{time:e}})})}),ei=({children:e,persistence:t})=>Object(Ee.jsx)(Se.Node,{shader:ti.persistence,backbuffering:!0,uniforms:{t:e,back:Se.Uniform.Backbuffer,persistence:t}}),ti=Se.Shaders.create({persistence:{frag:Se.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  clr += c;
  gl_FragColor = vec4(clr, 1.0);
}`}}),ri=50,ni="jumpy rooks",oi=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:ii.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),ii=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),ai=51,si="symmetry chess",ci=400,li=0,fi=20,ui=24,pi=1,di=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:vi.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),vi=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),hi=52,mi="knights dance",gi=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:bi.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),bi=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),yi=53,xi="cross waves",wi=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:_i.node,uniforms:{time:e}}),_i=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  */
}`}}),Ei=54,Si="chess set",Oi=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:Ri.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),Ri=Se.Shaders.create({node:{frag:Se.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  color = vec4(c, 1.0);
}`}}),Ti=55,zi="cube d'or",Pi=400,Ci=0,Ii=20,ji=24,Ai=1,ki=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:Di.node,uniforms:{time:e}}),Di=Se.Shaders.create({node:{frag:Se.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  #endif
  color = vec4(c, 1.0);
}`}}),Li=56,Ni="jade forest",Mi=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:Ui.node,uniforms:{time:e}}),Ui=Se.Shaders.create({node:{frag:Se.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  color = vec4(c, 1.0);
}`}}),Bi=57,Fi="Virus v2",qi=400,$i=0,Gi=20,Hi=24,Vi=.8,Wi=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:Xi.node,uniforms:{time:e}}),Xi=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}});var Ki=r("005v"),Yi=r.n(Ki);const Qi=400,Zi=0,Ji=30,ea=20,ta=1,ra="5M",na=58,oa="Mandelglitch",ia=[{url:"https://ethblock.art/create/17",text:"Mint on ethblock.art"},{url:"https://ghostmarket.io/asset/pha/ghost/3008841254969814369262311336331954453497120774334547905246474374493804042898/",text:"ghostmarket.io: 400 KCAL"},{url:"https://www.hicetnunc.xyz/objkt/3063",text:"hicetnunc.xyz: Mandelglitch #1 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3068",text:"hicetnunc.xyz: Mandelglitch #2 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3071",text:"hicetnunc.xyz: Mandelglitch #3 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3072",text:"hicetnunc.xyz: Mandelglitch #4 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3073",text:"hicetnunc.xyz: Mandelglitch #5 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3077",text:"hicetnunc.xyz: Mandelglitch #6 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3088",text:"hicetnunc.xyz: Mandelglitch #7 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3574",text:"hicetnunc.xyz: Mandelglitch #8 (5 XTZ)"}];const aa=e=>e<.5?2*e*e:(4-2*e)*e-1;const sa=({time:e,n:t,exporting:r})=>{const n=Object(qe.useMemo)((()=>function(e,t=0){const r=e?3:50,n=new Yi.a(t);return Array(r).fill(null).map((()=>Array(12).fill(null).map((()=>n.random()))))}(r,t)),[t,r]),o=e/10%n.length,i=Math.floor(o),a=o-i;let[s,c,l,f,u,p,d,v,h,m,g,b]=(y=n[i%n.length],x=n[(i+1)%n.length],w=aa(a),y.map(((e,t)=>e*(1-w)+x[t]*w)));var y,x,w;return l=aa(l),Object(Ee.jsx)(Se.LinearCopy,{children:Object(Ee.jsx)(la,{persistence:r?0:.8,children:Object(Ee.jsx)(Se.Node,{shader:ca.main,uniforms:{aa:r?2:0,time:e,resolution:Se.Uniform.Resolution,travel:s,love:c,dark:l,rot:r?2*Math.PI/Ji:.1,s1:f,s2:u,s3:p,s4:d,s5:v,s6:h,s7:m,s8:g,s9:b}})})})},ca=Se.Shaders.create({persistence:{frag:Se.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  `}}),la=({children:e,persistence:t})=>Object(Ee.jsx)(Se.Node,{shader:ca.persistence,backbuffering:!0,uniforms:{t:e,back:Se.Uniform.Backbuffer,persistence:t}}),fa=59,ua="Pixels 256",pa="There will be only 256 patterns generated by this single fragment shader.",da=({time:e,n:t,exporting:r})=>Object(Ee.jsx)(va,{n:t+1+(r?0:Math.floor(e))}),va=$e.a.memo((({n:e})=>{const t=new Yi.a(e%256),r=t.random(),n=t.random(),o=t.random(),i=t.random(),a=t.random(),s=t.random();return Object(Ee.jsx)(Se.Node,{shader:ha.node,uniforms:{s1:r,s2:n,s3:o,s4:i,s5:a,s6:s}})})),ha=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),ma=60,ga="Bitcoin rainbow",ba=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:ya.node,uniforms:{time:e}}),ya=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),xa=61,wa="Binance gradients",_a=1,Ea=30,Sa=["/images/shaders/binance.dist.png"],Oa=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:Ra.node,uniforms:{time:e,image:"/images/shaders/binance.dist.png"}}),Ra=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Ta=62,za="Overgrowth",Pa=20,Ca=40,Ia=1,ja=({generation:e,size:t,n:r})=>Object(Ee.jsx)(Se.Node,{width:t,height:t,shader:Ma.logic,uniforms:{generation:e,prev:Se.Uniform.Backbuffer,size:t,seed:r/100},backbuffering:!0}),Aa=$e.a.memo(ja),ka=({time:e,generation:t,n:r})=>Object(Ee.jsx)(Se.Node,{shader:Ma.render,uniforms:{time:e,logic:Object(Ee.jsx)(Aa,{generation:t,size:140,n:r})},uniformsOptions:{logic:{interpolation:"nearest"}}}),Da=$e.a.memo(ka),La=1e3*Math.random(),Na=({time:e,n:t})=>Object(Ee.jsx)(Da,{n:t+La,time:e,generation:Math.floor(30*e)},t),Ma=Se.Shaders.create({logic:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
...
`}});var Ua=r("AJhG");const Ba=63,Fa="Relics",qa=400,$a=2,Ga=4,Ha=20,Va=1,Wa="5M",Xa={colors:[.7,.55,.4],logicSize:80,amp:1,base:2,persistance:.89,delta:.5,seed:0};console.log(Object.keys(Xa).map((e=>String(Xa[e]))).join("_"));const Ka=({g:e,size:t,seed:r,amp:n,base:o,persistance:i,delta:a})=>Object(Ee.jsx)(Se.Node,{width:t,height:t,shader:es.logic,uniforms:{amp:n,base:o,g:e,prev:Se.Uniform.Backbuffer,size:t,seed:r,persistance:i,delta:a},backbuffering:!0},t),Ya=$e.a.memo(Ka),Qa=({g:e,colors:t,amp:r,base:n,persistance:o,delta:i,logicSize:a,seed:s})=>Object(Ee.jsx)(Se.Node,{shader:es.render,uniforms:{colors:t,logic:Object(Ee.jsx)(Ya,{amp:r,base:n,g:e,size:a,seed:s,persistance:o,delta:i})},uniformsOptions:{logic:{interpolation:"nearest"}}}),Za=$e.a.memo(Qa),Ja=({time:e})=>{const{colors:t,logicSize:r,amp:n,base:o,persistance:i,delta:a,seed:s}=Object(Ua.b)(Xa);return Object(Ee.jsx)(Za,{amp:n,base:o,g:Math.floor(20*e)%40,colors:t,persistance:i,delta:a,seed:s,logicSize:r})},es=Se.Shaders.create({logic:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform sampler2D prev;
uniform float g;
...
`}}),ts=64,rs="Intersection",ns=8*Math.PI,os=[{url:"https://www.hicetnunc.xyz/objkt/28592",text:"hic et nunc NFT"}],is=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:as.render,uniforms:{resolution:Se.Uniform.Resolution,time:e}}),as=Se.Shaders.create({render:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform vec2 resolution;
...
`}}),ss=65,cs="Duality",ls=800,fs=4,us=8,ps=30,ds=1,vs=3,hs=!0,ms=16,gs=[{url:"https://hicetnunc.xyz/objkt/64326",text:"hic et nunc NFT"}],bs=({time:e})=>Object(Ee.jsx)(Se.NearestCopy,{children:Object(Ee.jsx)(ys,{persistence:.3,children:Object(Ee.jsx)(Se.Node,{shader:xs.render,uniforms:{resolution:Se.Uniform.Resolution,time:e}})})}),ys=({children:e,persistence:t})=>Object(Ee.jsx)(Se.Node,{shader:xs.persistence,backbuffering:!0,uniforms:{t:e,back:Se.Uniform.Backbuffer,persistence:t}}),xs=Se.Shaders.create({persistence:{frag:Se.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),ws=66,_s="hicetnunc",Es=800,Ss=2,Os=Ss+8,Rs=30,Ts=1,zs=7,Ps=!0,Cs=16,Is=({time:e})=>Object(Ee.jsx)(Se.NearestCopy,{children:Object(Ee.jsx)(js,{persistence:.5,children:Object(Ee.jsx)(Se.Node,{shader:As.render,uniforms:{resolution:Se.Uniform.Resolution,time:e,freq:2}})})}),js=({children:e,persistence:t})=>Object(Ee.jsx)(Se.Node,{shader:As.persistence,backbuffering:!0,uniforms:{t:e,back:Se.Uniform.Backbuffer,persistence:t}}),As=Se.Shaders.create({persistence:{frag:Se.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),ks=67,Ds="Jumping blob",Ls=800,Ns=2,Ms=Ns+8,Us=30,Bs=1,Fs=7,qs=!0,$s=16,Gs=({time:e})=>Object(Ee.jsx)(Se.NearestCopy,{children:Object(Ee.jsx)(Hs,{persistence:.6,children:Object(Ee.jsx)(Se.Node,{shader:Vs.render,uniforms:{resolution:Se.Uniform.Resolution,time:e,freq:2}})})}),Hs=({children:e,persistence:t})=>Object(Ee.jsx)(Se.Node,{shader:Vs.persistence,backbuffering:!0,uniforms:{t:e,back:Se.Uniform.Backbuffer,persistence:t}}),Vs=Se.Shaders.create({persistence:{frag:Se.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Ws=68,Xs="ring",Ks=800,Ys=2,Qs=Ys+10,Zs=30,Js=1,ec=7,tc=!0,rc=128,nc=({time:e})=>Object(Ee.jsx)(Se.NearestCopy,{children:Object(Ee.jsx)(oc,{persistence:.9,children:Object(Ee.jsx)(Se.Node,{shader:ic.render,uniforms:{resolution:Se.Uniform.Resolution,time:e,freq:2}})})}),oc=({children:e,persistence:t})=>Object(Ee.jsx)(Se.Node,{shader:ic.persistence,backbuffering:!0,uniforms:{t:e,back:Se.Uniform.Backbuffer,persistence:t}}),ic=Se.Shaders.create({persistence:{frag:Se.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),ac=69,sc="Bananas paradize",cc=400,lc=0,fc=20,uc=20,pc=1,dc=!0,vc=128,hc=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:mc.node,uniforms:{time:e,resolution:Se.Uniform.Resolution}}),mc=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),gc=70,bc="warp1",yc=400,xc=0,wc=20,_c=20,Ec=1,Sc=!1,Oc=256,Rc=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:Tc.node,uniforms:{time:e,resolution:Se.Uniform.Resolution}}),Tc=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),zc=71,Pc="warp2",Cc=640,Ic=0,jc=20,Ac=24,kc=1,Dc=!1,Lc=256,Nc=({time:e})=>Object(Ee.jsx)(Se.Node,{shader:Mc.node,uniforms:{time:e}}),Mc=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),Uc=72,Bc="Planet Hole",Fc=640,qc=0,$c=20,Gc=24,Hc=1,Vc=!1,Wc=256,Xc=[{url:"https://hicetnunc.xyz/objkt/87918",text:"hic et nunc NFT"}],Kc=({time:e,n:t})=>{const r=new Yi.a(t),n=.2+3*r.random()*r.random(),o=.2+10*r.random()*r.random(),i=r.random(),a=[i+.2-.5*r.random(),i+.02-.1*r.random(),i-.02+.1*r.random()];return Object(Ee.jsx)(Se.Node,{shader:Yc.node,uniforms:{resolution:Se.Uniform.Resolution,time:e,a:n,b:o,c:a}})},Yc=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
...
`}}),Qc=73,Zc="purple square corridor",Jc=640,el=0,tl=20,rl=24,nl=1,ol=!1,il=256,al=72e5,sl=({time:e})=>{const t=Date.now(),r=t/al-Math.floor(t/al);return Object(Ee.jsx)(Se.Node,{shader:cl.node,uniforms:{resolution:Se.Uniform.Resolution,time:e+1e3*r,speed:.01,c:[.8,.1,.3]}})},cl=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
...
`}}),ll=74,fl="blue square corridor",ul=640,pl=0,dl=20,vl=24,hl=1,ml=!1,gl=256,bl=72e5,yl=({time:e})=>{const t=Date.now(),r=t/bl-Math.floor(t/bl);return Object(Ee.jsx)(Se.Node,{shader:xl.node,uniforms:{resolution:Se.Uniform.Resolution,time:e+1e3*r,speed:.01,c:[0,.3,.4]}})},xl=Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
...
`}}),wl=(Se.Shaders.create({node:{frag:Se.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;

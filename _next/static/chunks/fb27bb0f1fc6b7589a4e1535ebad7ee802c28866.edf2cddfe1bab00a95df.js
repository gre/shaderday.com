...
}`}}).copy;t.default=i},MAJC:function(e,t,r){"use strict";e.exports=function(e){return"undefined"!==typeof e&&null!==e&&("object"===typeof e||"function"===typeof e)}},Ni9w:function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;t.default=class{constructor(){var e,t,r;r=[],(t="_loaders")in(e=this)?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r}add(e){this._loaders.push(e),this._loaders.sort(((e,t)=>("number"===typeof t.priority?t.priority:0)-("number"===typeof e.priority?e.priority:0)))}remove(e){const t=this._loaders.indexOf(e);-1!==t&&this._loaders.splice(t,1)}get(){return this._loaders}}},O8XB:function(e,t,r){"use strict";(function(e,n){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var o,i,a,s,c,l=p(r("tbvF")),f=p(r("Ytbt")),u=p(r("zqV6"));function p(e){return e&&e.__esModule?e:{default:e}}"undefined"===typeof e&&(n.Buffer=(i=o=class{},c=t=>t instanceof e,(s="isBuffer")in(a=o)?Object.defineProperty(a,s,{value:c,enumerable:!0,configurable:!0,writable:!0}):a[s]=c,i));t.default=(e,t,r,n)=>{const o="undefined"!==typeof WebGLRenderingContext&&e instanceof WebGLRenderingContext;let i=r.dtype,a=r.shape.slice(),s=e.getParameter(e.MAX_TEXTURE_SIZE);if(a[0]<0||a[0]>s||a[1]<0||a[1]>s)throw new Error("gl-react: Invalid texture size");let c=function(e,t){return 3===e.length?1===t[2]&&t[1]===e[0]*e[2]&&t[0]===e[2]:1===t[0]&&t[1]===e[0]}(a,r.stride.slice()),p=0;"float32"===i?p=e.FLOAT:"float64"===i?(p=e.FLOAT,c=!1,i="float32"):"uint8"===i?p=e.UNSIGNED_BYTE:(p=e.UNSIGNED_BYTE,c=!1,i="uint8");let d,v=0,h=0;if(2===a.length)h=v=e.LUMINANCE,a=[a[0],a[1],1],r=(0,l.default)(r.data,a,[r.stride[0],r.stride[1],1],r.offset);else{if(3!==a.length)throw new Error("gl-texture2d: Invalid shape for texture");if(1===a[2])h=v=e.ALPHA,o||(n=!1);else if(2===a[2])h=v=e.LUMINANCE_ALPHA,o||(n=!1);else if(3===a[2])v=e.RGB,h=o?e.RGB:e.RGB32F;else{if(4!==a[2])throw new Error("gl-texture2d: Invalid shape for pixel coords");v=e.RGBA,h=o?e.RGBA:e.RGBA32F}}p!==e.FLOAT||n||(p=e.UNSIGNED_BYTE,c=!1);let m,g=r.size;if(c)d=0===r.offset&&r.data.length===g?r.data:r.data.subarray(r.offset,r.offset+g);else{let t=[a[2],a[2]*a[0],1];if("float32"!==i&&"float64"!==i||p!==e.UNSIGNED_BYTE){m=u.default.malloc(g,i);let e=(0,l.default)(m,a,t,0);f.default.assign(e,r)}else{m=u.default.malloc(g,"uint8"),function(e,t){f.default.muls(e,t,255)}((0,l.default)(m,a,t,0),r)}d=m.subarray(0,g)}e.texImage2D(e.TEXTURE_2D,0,h,a[0],a[1],0,v,p,d),m&&u.default.free(m)}}).call(this,r("HDXh").Buffer,r("ntbh"))},OTww:function(e,t,r){"use strict";(function(e){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var n,o=(n=r("Ni9w"))&&n.__esModule?n:{default:n};const i="undefined"===typeof window?e:window,a="__webglTextureLoader_registry";var s=i[a]||(i[a]=new o.default);t.default=s}).call(this,r("ntbh"))},QLaP:function(e,t,r){"use strict";e.exports=function(e,t,r,n,o,i,a,s){if(!e){var c;if(void 0===t)c=new Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else{var l=[r,n,o,i,a,s],f=0;(c=new Error(t.replace(/%s/g,(function(){return l[f++]})))).name="Invariant Violation"}throw c.framesToPop=1,c}}},QM7d:function(e,t,r){"use strict";var n=r("033R");function o(){this.argTypes=[],this.shimArgs=[],this.arrayArgs=[],this.arrayBlockIndices=[],this.scalarArgs=[],this.offsetArgs=[],this.offsetArgIndex=[],this.indexArgs=[],this.shapeArgs=[],this.funcName="",this.pre=null,this.body=null,this.post=null,this.debug=!1}e.exports=function(e){var t=new o;t.pre=e.pre,t.body=e.body,t.post=e.post;var r=e.args.slice(0);t.argTypes=r;for(var i=0;i<r.length;++i){var a=r[i];if("array"===a||"object"===typeof a&&a.blockIndices){if(t.argTypes[i]="array",t.arrayArgs.push(i),t.arrayBlockIndices.push(a.blockIndices?a.blockIndices:0),t.shimArgs.push("array"+i),i<t.pre.args.length&&t.pre.args[i].count>0)throw new Error("cwise: pre() block may not reference array args");if(i<t.post.args.length&&t.post.args[i].count>0)throw new Error("cwise: post() block may not reference array args")}else if("scalar"===a)t.scalarArgs.push(i),t.shimArgs.push("scalar"+i);else if("index"===a){if(t.indexArgs.push(i),i<t.pre.args.length&&t.pre.args[i].count>0)throw new Error("cwise: pre() block may not reference array index");if(i<t.body.args.length&&t.body.args[i].lvalue)throw new Error("cwise: body() block may not write to array index");if(i<t.post.args.length&&t.post.args[i].count>0)throw new Error("cwise: post() block may not reference array index")}else if("shape"===a){if(t.shapeArgs.push(i),i<t.pre.args.length&&t.pre.args[i].lvalue)throw new Error("cwise: pre() block may not write to array shape");if(i<t.body.args.length&&t.body.args[i].lvalue)throw new Error("cwise: body() block may not write to array shape");if(i<t.post.args.length&&t.post.args[i].lvalue)throw new Error("cwise: post() block may not write to array shape")}else{if("object"!==typeof a||!a.offset)throw new Error("cwise: Unknown argument type "+r[i]);t.argTypes[i]="offset",t.offsetArgs.push({array:a.array,offset:a.offset}),t.offsetArgIndex.push(i)}}if(t.arrayArgs.length<=0)throw new Error("cwise: No array arguments specified");if(t.pre.args.length>r.length)throw new Error("cwise: Too many arguments in pre() block");if(t.body.args.length>r.length)throw new Error("cwise: Too many arguments in body() block");if(t.post.args.length>r.length)throw new Error("cwise: Too many arguments in post() block");return t.debug=!!e.printCode||!!e.debug,t.funcName=e.funcName||"cwise",t.blockSize=e.blockSize||64,n(t)}},R9Te:function(e,t,r){"use strict";var n=r("CyWo"),o=r("z08I"),i=r("+0iv"),a=r("vCtr");function s(e){return"__proto__"!==e&&"constructor"!==e&&"prototype"!==e}e.exports=function(e,t,r){if(!a(e))return e;if(Array.isArray(t)&&(t=[].concat.apply([],t).join(".")),"string"!==typeof t)return e;for(var c=n(t,{sep:".",brackets:!0}).filter(s),l=c.length,f=-1,u=e;++f<l;){var p=c[f];f===l-1?i(u[p])&&i(r)?u[p]=o({},u[p],r):u[p]=r:(a(u[p])||(u[p]={}),u=u[p])}return e}},RjOF:function(e,t,r){"use strict";var n,o="";e.exports=function(e,t){if("string"!==typeof e)throw new TypeError("expected a string");if(1===t)return e;if(2===t)return e+e;var r=e.length*t;if(n!==e||"undefined"===typeof n)n=e,o="";else if(o.length>=r)return o.substr(0,r);for(;r>o.length&&t>1;)1&t&&(o+=e),t>>=1,e+=e;return o=(o+=e).substr(0,r)}},Ry8g:function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;t.default=e=>{const t=e.getExtension("WEBGL_lose_context");t&&t.loseContext()}},SMLl:function(e,t,r){"use strict";var n=r("RjOF");e.exports=function(e,t,r){return n(r="undefined"!==typeof r?r+"":" ",t)+e}},TBio:function(e,t,r){"use strict";var n=r("F16p");function o(e,t,r){var n,o,i=e.length,a=t.arrayArgs.length,s=t.indexArgs.length>0,c=[],l=[],f=0,u=0;for(n=0;n<i;++n)l.push(["i",n,"=0"].join(""));for(o=0;o<a;++o)for(n=0;n<i;++n)u=f,f=e[n],0===n?l.push(["d",o,"s",n,"=t",o,"p",f].join("")):l.push(["d",o,"s",n,"=(t",o,"p",f,"-s",u,"*t",o,"p",u,")"].join(""));for(l.length>0&&c.push("var "+l.join(",")),n=i-1;n>=0;--n)f=e[n],c.push(["for(i",n,"=0;i",n,"<s",f,";++i",n,"){"].join(""));for(c.push(r),n=0;n<i;++n){for(u=f,f=e[n],o=0;o<a;++o)c.push(["p",o,"+=d",o,"s",n].join(""));s&&(n>0&&c.push(["index[",u,"]-=s",u].join("")),c.push(["++index[",f,"]"].join(""))),c.push("}")}return c.join("\n")}function i(e,t,r){for(var n=e.body,o=[],i=[],a=0;a<e.args.length;++a){var s=e.args[a];if(!(s.count<=0)){var c=new RegExp(s.name,"g"),l="",f=t.arrayArgs.indexOf(a);switch(t.argTypes[a]){case"offset":var u=t.offsetArgIndex.indexOf(a);f=t.offsetArgs[u].array,l="+q"+u;case"array":l="p"+f+l;var p="l"+a,d="a"+f;if(0===t.arrayBlockIndices[f])1===s.count?"generic"===r[f]?s.lvalue?(o.push(["var ",p,"=",d,".get(",l,")"].join("")),n=n.replace(c,p),i.push([d,".set(",l,",",p,")"].join(""))):n=n.replace(c,[d,".get(",l,")"].join("")):n=n.replace(c,[d,"[",l,"]"].join("")):"generic"===r[f]?(o.push(["var ",p,"=",d,".get(",l,")"].join("")),n=n.replace(c,p),s.lvalue&&i.push([d,".set(",l,",",p,")"].join(""))):(o.push(["var ",p,"=",d,"[",l,"]"].join("")),n=n.replace(c,p),s.lvalue&&i.push([d,"[",l,"]=",p].join("")));else{for(var v=[s.name],h=[l],m=0;m<Math.abs(t.arrayBlockIndices[f]);m++)v.push("\\s*\\[([^\\]]+)\\]"),h.push("$"+(m+1)+"*t"+f+"b"+m);if(c=new RegExp(v.join(""),"g"),l=h.join("+"),"generic"===r[f])throw new Error("cwise: Generic arrays not supported in combination with blocks!");n=n.replace(c,[d,"[",l,"]"].join(""))}break;case"scalar":n=n.replace(c,"Y"+t.scalarArgs.indexOf(a));break;case"index":n=n.replace(c,"index");break;case"shape":n=n.replace(c,"shape")}}}return[o.join("\n"),n,i.join("\n")].join("\n").trim()}function a(e){for(var t=new Array(e.length),r=!0,n=0;n<e.length;++n){var o=e[n],i=o.match(/\d+/);i=i?i[0]:"",0===o.charAt(0)?t[n]="u"+o.charAt(1)+i:t[n]=o.charAt(0)+i,n>0&&(r=r&&t[n]===t[n-1])}return r?t[0]:t.join("")}e.exports=function(e,t){for(var r=t[1].length-Math.abs(e.arrayBlockIndices[0])|0,s=new Array(e.arrayArgs.length),c=new Array(e.arrayArgs.length),l=0;l<e.arrayArgs.length;++l)c[l]=t[2*l],s[l]=t[2*l+1];var f=[],u=[],p=[],d=[],v=[];for(l=0;l<e.arrayArgs.length;++l){e.arrayBlockIndices[l]<0?(p.push(0),d.push(r),f.push(r),u.push(r+e.arrayBlockIndices[l])):(p.push(e.arrayBlockIndices[l]),d.push(e.arrayBlockIndices[l]+r),f.push(0),u.push(e.arrayBlockIndices[l]));for(var h=[],m=0;m<s[l].length;m++)p[l]<=s[l][m]&&s[l][m]<d[l]&&h.push(s[l][m]-p[l]);v.push(h)}var g=["SS"],y=["'use strict'"],b=[];for(m=0;m<r;++m)b.push(["s",m,"=SS[",m,"]"].join(""));for(l=0;l<e.arrayArgs.length;++l){g.push("a"+l),g.push("t"+l),g.push("p"+l);for(m=0;m<r;++m)b.push(["t",l,"p",m,"=t",l,"[",p[l]+m,"]"].join(""));for(m=0;m<Math.abs(e.arrayBlockIndices[l]);++m)b.push(["t",l,"b",m,"=t",l,"[",f[l]+m,"]"].join(""))}for(l=0;l<e.scalarArgs.length;++l)g.push("Y"+l);if(e.shapeArgs.length>0&&b.push("shape=SS.slice(0)"),e.indexArgs.length>0){var x=new Array(r);for(l=0;l<r;++l)x[l]="0";b.push(["index=[",x.join(","),"]"].join(""))}for(l=0;l<e.offsetArgs.length;++l){var w=e.offsetArgs[l],_=[];for(m=0;m<w.offset.length;++m)0!==w.offset[m]&&(1===w.offset[m]?_.push(["t",w.array,"p",m].join("")):_.push([w.offset[m],"*t",w.array,"p",m].join("")));0===_.length?b.push("q"+l+"=0"):b.push(["q",l,"=",_.join("+")].join(""))}var E=n([].concat(e.pre.thisVars).concat(e.body.thisVars).concat(e.post.thisVars));for((b=b.concat(E)).length>0&&y.push("var "+b.join(",")),l=0;l<e.arrayArgs.length;++l)y.push("p"+l+"|=0");e.pre.body.length>3&&y.push(i(e.pre,e,c));var S=i(e.body,e,c),O=function(e){for(var t=0,r=e[0].length;t<r;){for(var n=1;n<e.length;++n)if(e[n][t]!==e[0][t])return t;++t}return t}(v);O<r?y.push(function(e,t,r,n){for(var i=t.length,a=r.arrayArgs.length,s=r.blockSize,c=r.indexArgs.length>0,l=[],f=0;f<a;++f)l.push(["var offset",f,"=p",f].join(""));for(f=e;f<i;++f)l.push(["for(var j"+f+"=SS[",t[f],"]|0;j",f,">0;){"].join("")),l.push(["if(j",f,"<",s,"){"].join("")),l.push(["s",t[f],"=j",f].join("")),l.push(["j",f,"=0"].join("")),l.push(["}else{s",t[f],"=",s].join("")),l.push(["j",f,"-=",s,"}"].join("")),c&&l.push(["index[",t[f],"]=j",f].join(""));for(f=0;f<a;++f){for(var u=["offset"+f],p=e;p<i;++p)u.push(["j",p,"*t",f,"p",t[p]].join(""));l.push(["p",f,"=(",u.join("+"),")"].join(""))}for(l.push(o(t,r,n)),f=e;f<i;++f)l.push("}");return l.join("\n")}(O,v[0],e,S)):y.push(o(v[0],e,S)),e.post.body.length>3&&y.push(i(e.post,e,c)),e.debug&&console.log("-----Generated cwise routine for ",t,":\n"+y.join("\n")+"\n----------");var R=[e.funcName||"unnamed","_cwise_loop_",s[0].join("s"),"m",O,a(c)].join("");return new Function(["function ",R,"(",g.join(","),"){",y.join("\n"),"} return ",R].join(""))()}},TGEO:function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),Object.defineProperty(t,"WebGLTextureLoader",{enumerable:!0,get:function(){return n.default}}),Object.defineProperty(t,"WebGLTextureLoaderAsyncHashCache",{enumerable:!0,get:function(){return o.default}}),Object.defineProperty(t,"WebGLTextureLoaderSyncHashCache",{enumerable:!0,get:function(){return i.default}}),Object.defineProperty(t,"LoadersRegistry",{enumerable:!0,get:function(){return a.default}}),Object.defineProperty(t,"LoaderResolver",{enumerable:!0,get:function(){return s.default}}),Object.defineProperty(t,"globalRegistry",{enumerable:!0,get:function(){return c.default}});var n=l(r("HbIt")),o=l(r("cDsr")),i=l(r("VYxY")),a=l(r("Ni9w")),s=l(r("LhdL")),c=l(r("OTww"));function l(e){return e&&e.__esModule?e:{default:e}}},TKux:function(e,t,r){"use strict";r.d(t,"b",(function(){return Yc})),r.d(t,"c",(function(){return Qc})),r.d(t,"a",(function(){return Zc}));var n={};r.r(n),r.d(n,"n",(function(){return Ee})),r.d(n,"title",(function(){return Se})),r.d(n,"Shader",(function(){return Oe}));var o={};r.r(o),r.d(o,"n",(function(){return Te})),r.d(o,"title",(function(){return ze})),r.d(o,"exportSize",(function(){return Pe})),r.d(o,"exportStart",(function(){return Ce})),r.d(o,"exportEnd",(function(){return Ie})),r.d(o,"exportFramePerSecond",(function(){return je})),r.d(o,"exportSpeed",(function(){return Ae})),r.d(o,"Shader",(function(){return ke}));var i={};r.r(i),r.d(i,"n",(function(){return Le})),r.d(i,"title",(function(){return Ne})),r.d(i,"Shader",(function(){return Me}));var a={};r.r(a),r.d(a,"n",(function(){return Ge})),r.d(a,"title",(function(){return He})),r.d(a,"Shader",(function(){return We}));var s={};r.r(s),r.d(s,"n",(function(){return Ye})),r.d(s,"title",(function(){return Qe})),r.d(s,"Shader",(function(){return Ze}));var c={};r.r(c),r.d(c,"n",(function(){return et})),r.d(c,"title",(function(){return tt})),r.d(c,"Shader",(function(){return rt}));var l={};r.r(l),r.d(l,"n",(function(){return ot})),r.d(l,"title",(function(){return it})),r.d(l,"Shader",(function(){return at}));var f={};r.r(f),r.d(f,"n",(function(){return ct})),r.d(f,"title",(function(){return lt})),r.d(f,"Shader",(function(){return ft}));var u={};r.r(u),r.d(u,"n",(function(){return pt})),r.d(u,"title",(function(){return dt})),r.d(u,"exportSize",(function(){return vt})),r.d(u,"exportStart",(function(){return ht})),r.d(u,"exportEnd",(function(){return mt})),r.d(u,"exportFramePerSecond",(function(){return gt})),r.d(u,"exportSpeed",(function(){return yt})),r.d(u,"Shader",(function(){return bt}));var p={};r.r(p),r.d(p,"n",(function(){return wt})),r.d(p,"title",(function(){return _t})),r.d(p,"Shader",(function(){return Et}));var d={};r.r(d),r.d(d,"n",(function(){return Ot})),r.d(d,"title",(function(){return Rt})),r.d(d,"Shader",(function(){return Tt}));var v={};r.r(v),r.d(v,"n",(function(){return Pt})),r.d(v,"title",(function(){return Ct})),r.d(v,"Shader",(function(){return It}));var h={};r.r(h),r.d(h,"n",(function(){return At})),r.d(h,"title",(function(){return kt})),r.d(h,"Shader",(function(){return Dt}));var m={};r.r(m),r.d(m,"n",(function(){return Nt})),r.d(m,"title",(function(){return Mt})),r.d(m,"Shader",(function(){return Ut}));var g={};r.r(g),r.d(g,"n",(function(){return Yt})),r.d(g,"title",(function(){return Qt})),r.d(g,"Shader",(function(){return Zt}));var y={};r.r(y),r.d(y,"n",(function(){return rr})),r.d(y,"title",(function(){return nr})),r.d(y,"Shader",(function(){return or}));var b={};r.r(b),r.d(b,"n",(function(){return ar})),r.d(b,"title",(function(){return sr})),r.d(b,"Shader",(function(){return cr}));var x={};r.r(x),r.d(x,"n",(function(){return fr})),r.d(x,"title",(function(){return ur})),r.d(x,"Shader",(function(){return pr}));var w={};r.r(w),r.d(w,"n",(function(){return vr})),r.d(w,"title",(function(){return hr})),r.d(w,"Shader",(function(){return mr}));var _={};r.r(_),r.d(_,"n",(function(){return yr})),r.d(_,"title",(function(){return br})),r.d(_,"Shader",(function(){return xr}));var E={};r.r(E),r.d(E,"n",(function(){return Er})),r.d(E,"title",(function(){return Sr})),r.d(E,"Shader",(function(){return Or}));var S={};r.r(S),r.d(S,"n",(function(){return zr})),r.d(S,"title",(function(){return Pr})),r.d(S,"Shader",(function(){return Cr}));var O={};r.r(O),r.d(O,"n",(function(){return jr})),r.d(O,"title",(function(){return Ar})),r.d(O,"Shader",(function(){return kr}));var R={};r.r(R),r.d(R,"n",(function(){return Lr})),r.d(R,"title",(function(){return Nr})),r.d(R,"Shader",(function(){return Mr}));var T={};r.r(T),r.d(T,"n",(function(){return Br})),r.d(T,"title",(function(){return Fr})),r.d(T,"Shader",(function(){return qr}));var z={};r.r(z),r.d(z,"n",(function(){return Hr})),r.d(z,"title",(function(){return Vr})),r.d(z,"Shader",(function(){return Wr}));var P={};r.r(P),r.d(P,"n",(function(){return Yr})),r.d(P,"title",(function(){return Qr})),r.d(P,"exportSize",(function(){return Zr})),r.d(P,"exportStart",(function(){return Jr})),r.d(P,"exportEnd",(function(){return en})),r.d(P,"exportFramePerSecond",(function(){return tn})),r.d(P,"exportSpeed",(function(){return rn})),r.d(P,"Shader",(function(){return nn}));var C={};r.r(C),r.d(C,"n",(function(){return sn})),r.d(C,"title",(function(){return cn})),r.d(C,"Shader",(function(){return ln}));var I={};r.r(I),r.d(I,"n",(function(){return pn})),r.d(I,"title",(function(){return dn})),r.d(I,"Shader",(function(){return vn}));var j={};r.r(j),r.d(j,"n",(function(){return mn})),r.d(j,"title",(function(){return gn})),r.d(j,"Shader",(function(){return yn}));var A={};r.r(A),r.d(A,"n",(function(){return xn})),r.d(A,"title",(function(){return wn})),r.d(A,"Shader",(function(){return _n}));var k={};r.r(k),r.d(k,"n",(function(){return Sn})),r.d(k,"title",(function(){return On})),r.d(k,"Shader",(function(){return Tn}));var D={};r.r(D),r.d(D,"n",(function(){return Pn})),r.d(D,"title",(function(){return Cn})),r.d(D,"Shader",(function(){return In}));var L={};r.r(L),r.d(L,"n",(function(){return An})),r.d(L,"title",(function(){return kn})),r.d(L,"Shader",(function(){return Dn}));var N={};r.r(N),r.d(N,"n",(function(){return Nn})),r.d(N,"title",(function(){return Mn})),r.d(N,"Shader",(function(){return Un}));var M={};r.r(M),r.d(M,"n",(function(){return qn})),r.d(M,"title",(function(){return $n})),r.d(M,"Shader",(function(){return Gn}));var U={};r.r(U),r.d(U,"n",(function(){return Wn})),r.d(U,"title",(function(){return Xn})),r.d(U,"Shader",(function(){return Kn}));var B={};r.r(B),r.d(B,"n",(function(){return Qn})),r.d(B,"title",(function(){return Zn})),r.d(B,"Shader",(function(){return Jn}));var F={};r.r(F),r.d(F,"n",(function(){return ro})),r.d(F,"title",(function(){return no})),r.d(F,"Shader",(function(){return oo}));var q={};r.r(q),r.d(q,"n",(function(){return ao})),r.d(q,"title",(function(){return so})),r.d(q,"Shader",(function(){return co}));var $={};r.r($),r.d($,"n",(function(){return fo})),r.d($,"title",(function(){return uo})),r.d($,"Shader",(function(){return po}));var G={};r.r(G),r.d(G,"n",(function(){return ho})),r.d(G,"title",(function(){return mo})),r.d(G,"Shader",(function(){return go}));var H={};r.r(H),r.d(H,"n",(function(){return bo})),r.d(H,"title",(function(){return xo})),r.d(H,"Shader",(function(){return wo}));var V={};r.r(V),r.d(V,"n",(function(){return So})),r.d(V,"title",(function(){return Oo})),r.d(V,"Shader",(function(){return Ro}));var W={};r.r(W),r.d(W,"n",(function(){return zo})),r.d(W,"title",(function(){return Po})),r.d(W,"Shader",(function(){return Co}));var X={};r.r(X),r.d(X,"n",(function(){return jo})),r.d(X,"title",(function(){return Ao})),r.d(X,"Shader",(function(){return ko}));var K={};r.r(K),r.d(K,"n",(function(){return Lo})),r.d(K,"title",(function(){return No})),r.d(K,"Shader",(function(){return Mo}));var Y={};r.r(Y),r.d(Y,"n",(function(){return Bo})),r.d(Y,"title",(function(){return Fo})),r.d(Y,"Shader",(function(){return qo}));var Q={};r.r(Q),r.d(Q,"n",(function(){return Go})),r.d(Q,"title",(function(){return Ho})),r.d(Q,"exportSize",(function(){return Vo})),r.d(Q,"exportStart",(function(){return Wo})),r.d(Q,"exportEnd",(function(){return Xo})),r.d(Q,"exportFramePerSecond",(function(){return Ko})),r.d(Q,"exportSpeed",(function(){return Yo})),r.d(Q,"Shader",(function(){return Qo}));var Z={};r.r(Z),r.d(Z,"n",(function(){return ei})),r.d(Z,"title",(function(){return ti})),r.d(Z,"Shader",(function(){return ri}));var J={};r.r(J),r.d(J,"n",(function(){return oi})),r.d(J,"title",(function(){return ii})),r.d(J,"exportSize",(function(){return ai})),r.d(J,"exportStart",(function(){return si})),r.d(J,"exportEnd",(function(){return ci})),r.d(J,"exportFramePerSecond",(function(){return li})),r.d(J,"exportSpeed",(function(){return fi})),r.d(J,"Shader",(function(){return ui}));var ee={};r.r(ee),r.d(ee,"n",(function(){return di})),r.d(ee,"title",(function(){return vi})),r.d(ee,"Shader",(function(){return hi}));var te={};r.r(te),r.d(te,"n",(function(){return gi})),r.d(te,"title",(function(){return yi})),r.d(te,"Shader",(function(){return bi}));var re={};r.r(re),r.d(re,"n",(function(){return wi})),r.d(re,"title",(function(){return _i})),r.d(re,"Shader",(function(){return Ei}));var ne={};r.r(ne),r.d(ne,"n",(function(){return Oi})),r.d(ne,"title",(function(){return Ri})),r.d(ne,"exportSize",(function(){return Ti})),r.d(ne,"exportStart",(function(){return zi})),r.d(ne,"exportEnd",(function(){return Pi})),r.d(ne,"exportFramePerSecond",(function(){return Ci})),r.d(ne,"exportSpeed",(function(){return Ii})),r.d(ne,"Shader",(function(){return ji}));var oe={};r.r(oe),r.d(oe,"n",(function(){return ki})),r.d(oe,"title",(function(){return Di})),r.d(oe,"Shader",(function(){return Li}));var ie={};r.r(ie),r.d(ie,"n",(function(){return Mi})),r.d(ie,"title",(function(){return Ui})),r.d(ie,"exportSize",(function(){return Bi})),r.d(ie,"exportStart",(function(){return Fi})),r.d(ie,"exportEnd",(function(){return qi})),r.d(ie,"exportFramePerSecond",(function(){return $i})),r.d(ie,"exportSpeed",(function(){return Gi})),r.d(ie,"Shader",(function(){return Hi}));var ae={};r.r(ae),r.d(ae,"exportSize",(function(){return Ki})),r.d(ae,"exportStart",(function(){return Yi})),r.d(ae,"exportEnd",(function(){return Qi})),r.d(ae,"exportFramePerSecond",(function(){return Zi})),r.d(ae,"exportSpeed",(function(){return Ji})),r.d(ae,"exportMP4vb",(function(){return ea})),r.d(ae,"n",(function(){return ta})),r.d(ae,"title",(function(){return ra})),r.d(ae,"nfts",(function(){return na})),r.d(ae,"Shader",(function(){return ia}));var se={};r.r(se),r.d(se,"n",(function(){return ca})),r.d(se,"title",(function(){return la})),r.d(se,"description",(function(){return fa})),r.d(se,"Shader",(function(){return ua}));var ce={};r.r(ce),r.d(ce,"n",(function(){return va})),r.d(ce,"title",(function(){return ha})),r.d(ce,"Shader",(function(){return ma}));var le={};r.r(le),r.d(le,"n",(function(){return ya})),r.d(le,"title",(function(){return ba})),r.d(le,"exportEnd",(function(){return xa})),r.d(le,"exportFramePerSecond",(function(){return wa})),r.d(le,"preload",(function(){return _a})),r.d(le,"Shader",(function(){return Ea}));var fe={};r.r(fe),r.d(fe,"n",(function(){return Oa})),r.d(fe,"title",(function(){return Ra})),r.d(fe,"exportEnd",(function(){return Ta})),r.d(fe,"exportFramePerSecond",(function(){return za})),r.d(fe,"exportSpeed",(function(){return Pa})),r.d(fe,"Logic",(function(){return Ca})),r.d(fe,"Shader",(function(){return Da}));var ue={};r.r(ue),r.d(ue,"n",(function(){return Ma})),r.d(ue,"title",(function(){return Ua})),r.d(ue,"exportSize",(function(){return Ba})),r.d(ue,"exportStart",(function(){return Fa})),r.d(ue,"exportEnd",(function(){return qa})),r.d(ue,"exportFramePerSecond",(function(){return $a})),r.d(ue,"exportSpeed",(function(){return Ga})),r.d(ue,"exportMP4vb",(function(){return Ha})),r.d(ue,"Logic",(function(){return Wa})),r.d(ue,"Shader",(function(){return Qa}));var pe={};r.r(pe),r.d(pe,"n",(function(){return Ja})),r.d(pe,"title",(function(){return es})),r.d(pe,"exportEnd",(function(){return ts})),r.d(pe,"nfts",(function(){return rs})),r.d(pe,"Shader",(function(){return ns}));var de={};r.r(de),r.d(de,"n",(function(){return is})),r.d(de,"title",(function(){return as})),r.d(de,"exportSize",(function(){return ss})),r.d(de,"exportStart",(function(){return cs})),r.d(de,"exportEnd",(function(){return ls})),r.d(de,"exportFramePerSecond",(function(){return fs})),r.d(de,"exportSpeed",(function(){return us})),r.d(de,"exportSkipFrame",(function(){return ps})),r.d(de,"exportPaletteGenOnce",(function(){return ds})),r.d(de,"exportPaletteSize",(function(){return vs})),r.d(de,"nfts",(function(){return hs})),r.d(de,"Shader",(function(){return ms}));var ve={};r.r(ve),r.d(ve,"n",(function(){return bs})),r.d(ve,"title",(function(){return xs})),r.d(ve,"exportSize",(function(){return ws})),r.d(ve,"exportStart",(function(){return _s})),r.d(ve,"exportEnd",(function(){return Es})),r.d(ve,"exportFramePerSecond",(function(){return Ss})),r.d(ve,"exportSpeed",(function(){return Os})),r.d(ve,"exportSkipFrame",(function(){return Rs})),r.d(ve,"exportPaletteGenOnce",(function(){return Ts})),r.d(ve,"exportPaletteSize",(function(){return zs})),r.d(ve,"Shader",(function(){return Ps}));var he={};r.r(he),r.d(he,"n",(function(){return js})),r.d(he,"title",(function(){return As})),r.d(he,"exportSize",(function(){return ks})),r.d(he,"exportStart",(function(){return Ds})),r.d(he,"exportEnd",(function(){return Ls})),r.d(he,"exportFramePerSecond",(function(){return Ns})),r.d(he,"exportSpeed",(function(){return Ms})),r.d(he,"exportSkipFrame",(function(){return Us})),r.d(he,"exportPaletteGenOnce",(function(){return Bs})),r.d(he,"exportPaletteSize",(function(){return Fs})),r.d(he,"Shader",(function(){return qs}));var me={};r.r(me),r.d(me,"n",(function(){return Hs})),r.d(me,"title",(function(){return Vs})),r.d(me,"exportSize",(function(){return Ws})),r.d(me,"exportStart",(function(){return Xs})),r.d(me,"exportEnd",(function(){return Ks})),r.d(me,"exportFramePerSecond",(function(){return Ys})),r.d(me,"exportSpeed",(function(){return Qs})),r.d(me,"exportSkipFrame",(function(){return Zs})),r.d(me,"exportPaletteGenOnce",(function(){return Js})),r.d(me,"exportPaletteSize",(function(){return ec})),r.d(me,"Shader",(function(){return tc}));var ge={};r.r(ge),r.d(ge,"n",(function(){return oc})),r.d(ge,"title",(function(){return ic})),r.d(ge,"exportSize",(function(){return ac})),r.d(ge,"exportStart",(function(){return sc})),r.d(ge,"exportEnd",(function(){return cc})),r.d(ge,"exportFramePerSecond",(function(){return lc})),r.d(ge,"exportSpeed",(function(){return fc})),r.d(ge,"exportPaletteGenOnce",(function(){return uc})),r.d(ge,"exportPaletteSize",(function(){return pc})),r.d(ge,"Shader",(function(){return dc}));var ye={};r.r(ye),r.d(ye,"n",(function(){return hc})),r.d(ye,"title",(function(){return mc})),r.d(ye,"exportSize",(function(){return gc})),r.d(ye,"exportStart",(function(){return yc})),r.d(ye,"exportEnd",(function(){return bc})),r.d(ye,"exportFramePerSecond",(function(){return xc})),r.d(ye,"exportSpeed",(function(){return wc})),r.d(ye,"exportPaletteGenOnce",(function(){return _c})),r.d(ye,"exportPaletteSize",(function(){return Ec})),r.d(ye,"Shader",(function(){return Sc}));var be={};r.r(be),r.d(be,"n",(function(){return Rc})),r.d(be,"title",(function(){return Tc})),r.d(be,"exportSize",(function(){return zc})),r.d(be,"exportStart",(function(){return Pc})),r.d(be,"exportEnd",(function(){return Cc})),r.d(be,"exportFramePerSecond",(function(){return Ic})),r.d(be,"exportSpeed",(function(){return jc})),r.d(be,"exportPaletteGenOnce",(function(){return Ac})),r.d(be,"exportPaletteSize",(function(){return kc})),r.d(be,"Shader",(function(){return Dc}));var xe={};r.r(xe),r.d(xe,"n",(function(){return Nc})),r.d(xe,"title",(function(){return Mc})),r.d(xe,"exportSize",(function(){return Uc})),r.d(xe,"exportStart",(function(){return Bc})),r.d(xe,"exportEnd",(function(){return Fc})),r.d(xe,"exportFramePerSecond",(function(){return qc})),r.d(xe,"exportSpeed",(function(){return $c})),r.d(xe,"exportPaletteGenOnce",(function(){return Gc})),r.d(xe,"exportPaletteSize",(function(){return Hc})),r.d(xe,"nfts",(function(){return Vc})),r.d(xe,"Shader",(function(){return Wc}));var we=r("nKUr"),_e=r("rr/c");const Ee=1,Se="Hello 2020",Oe=({time:e})=>Object(we.jsx)(_e.Node,{shader:Re.day001,uniforms:{time:e}}),Re=_e.Shaders.create({day001:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
float vingt (vec2 p) {
...
}`}}),Te=2,ze="stripes",Pe=400,Ce=0,Ie=60,je=24,Ae=1,ke=({time:e})=>Object(we.jsx)(_e.Node,{shader:De.node,uniforms:{time:e}}),De=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),Le=3,Ne="zephyr",Me=({time:e})=>Object(we.jsx)(_e.Node,{shader:Ue.node,uniforms:{time:e}}),Ue=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}});var Be=r("q1tI"),Fe=r.n(Be);const qe=_e.Shaders.create({InitGameOfLife:{frag:_e.GLSL`
  precision highp float;
  uniform float seed;
  // i
  varying vec2 uv;
  ...
  }`}}),$e=Fe.a.memo((({tick:e,size:t,refreshEveryTicks:r})=>e%(r||1/0)===0?Object(we.jsx)(_e.Node,{shader:qe.InitGameOfLife,uniforms:{seed:Math.random()},width:t,height:t,backbuffering:!0,sync:!0}):Object(we.jsx)(_e.Node,{shader:qe.GameOfLife,width:t,height:t,backbuffering:!0,sync:!0,uniforms:{t:_e.Uniform.Backbuffer,size:t}}))),Ge=4,He="Ray of Life";let Ve;const We=({time:e})=>{Ve||(Ve=e);const t=e-Ve,r=Math.floor(10*t),n=r+25,o=10*(1+Math.floor(r/50)),i=10*(1+Math.floor(n/50));return Object(we.jsx)(Xe,{time:e,a:Object(we.jsx)(_e.NearestCopy,{children:Object(we.jsx)($e,{refreshEveryTicks:50,tick:r,size:o})}),b:Object(we.jsx)(_e.NearestCopy,{children:Object(we.jsx)($e,{refreshEveryTicks:50,tick:n,size:i})})})},Xe=({a:e,b:t,time:r})=>Object(we.jsx)(_e.Node,{uniforms:{a:e,b:t,time:r},shader:Ke.main}),Ke=_e.Shaders.create({main:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Ye=5,Qe="Here We Go Again",Ze=({time:e})=>Object(we.jsx)(_e.Node,{shader:Je.node,uniforms:{time:e}}),Je=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    sqrt(vec3(1. - shad));
  gl_FragColor = vec4(c,1.0);
}`}}),et=6,tt="Bestagons",rt=({time:e})=>Object(we.jsx)(_e.Node,{shader:nt.node,uniforms:{time:e}}),nt=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),ot=7,it="Worms party",at=({time:e})=>Object(we.jsx)(_e.Node,{shader:st.node,uniforms:{time:e}}),st=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    sqrt(vec3(1. - shad));
  gl_FragColor = vec4(c,1.0);
}`}}),ct=8,lt="moontains",ft=({time:e})=>Object(we.jsx)(_e.Node,{shader:ut.node,uniforms:{time:e}}),ut=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),pt=9,dt="Virus",vt=400,ht=16.3,mt=26,gt=24,yt=.8,bt=({time:e})=>Object(we.jsx)(_e.Node,{shader:xt.node,uniforms:{time:e}}),xt=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),wt=10,_t="ring",Et=({time:e})=>Object(we.jsx)(_e.Node,{shader:St.node,uniforms:{time:e}}),St=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Ot=11,Rt="magic mouse",Tt=({time:e})=>Object(we.jsx)(_e.Node,{shader:zt.node,uniforms:{time:e}}),zt=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Pt=12,Ct="floor is lava",It=({time:e})=>Object(we.jsx)(_e.Node,{shader:jt.node,uniforms:{time:e}}),jt=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),At=13,kt="chip",Dt=({time:e})=>Object(we.jsx)(_e.Node,{shader:Lt.node,uniforms:{time:e}}),Lt=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
`}}),Nt=14,Mt="seizure",Ut=({time:e})=>Object(we.jsx)(_e.Node,{shader:Bt.node,uniforms:{time:e}}),Bt=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Ft=_e.Shaders.create({blur1D:{frag:_e.GLSL`precision highp float;
varying vec2 uv;
uniform sampler2D t;
...
}`}});var qt=({width:e,height:t,pixelRatio:r,direction:n,children:o})=>Object(we.jsx)(_e.Node,{shader:Ft.blur1D,width:e,height:t,pixelRatio:r,uniforms:{direction:n,resolution:_e.Uniform.Resolution,t:o}});const $t=Math.sqrt(2)/2;var Gt=(e,t,r)=>{const n=2*t*Math.ceil(e/2)/r;switch((e-1)%4){case 0:return[n,0];case 1:return[0,n];case 2:return[n*$t,n*$t];case 3:return[n*$t,-n*$t]}};const Ht=({width:e,height:t,pixelRatio:r,factor:n,children:o,passes:i,directionForPass:a})=>{const s=c=>c<=0?o:Object(we.jsx)(qt,{width:e,height:t,pixelRatio:r,direction:a(c,n,i),children:s(c-1)});return s(i)};Ht.defaultProps={passes:2,directionForPass:Gt};var Vt=Ht;const Wt=_e.Shaders.create({blur1D:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
...
}`}});var Xt=({width:e,height:t,map:r,pixelRatio:n,direction:o,children:i})=>Object(we.jsx)(_e.Node,{shader:Wt.blur1D,width:e,height:t,pixelRatio:n,uniforms:{direction:o,resolution:_e.Uniform.Resolution,t:i,map:r}});const Kt=({width:e,height:t,map:r,pixelRatio:n,factor:o,children:i,passes:a,directionForPass:s})=>{const c=l=>l<=0?i:Object(we.jsx)(Xt,{width:e,height:t,map:r,pixelRatio:n,direction:s(l,o,a),children:c(l-1)});return c(a)};Kt.defaultProps={passes:2,directionForPass:Gt};const Yt=15,Qt="parametric",Zt=({time:e})=>Object(we.jsx)(_e.LinearCopy,{children:Object(we.jsx)(er,{persistence:.98+.02*Math.cos(e)+-.8*Math.exp(-e),children:Object(we.jsx)(Vt,{passes:4,factor:.2,children:Object(we.jsx)(Jt,{time:e})})})}),Jt=({time:e})=>Object(we.jsx)(_e.Node,{shader:tr.node,uniforms:{time:e}}),er=({children:e,persistence:t})=>Object(we.jsx)(_e.Node,{shader:tr.persistence,backbuffering:!0,uniforms:{t:e,back:_e.Uniform.Backbuffer,persistence:t}}),tr=_e.Shaders.create({persistence:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),rr=16,nr="reuleaux",or=({time:e})=>Object(we.jsx)(_e.Node,{shader:ir.node,uniforms:{time:e}}),ir=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  vec3 c =
    ...
    color(0.5 * time);
  gl_FragColor = vec4(c, 1.0);
}`}}),ar=17,sr="screws",cr=({time:e})=>Object(we.jsx)(_e.Node,{shader:lr.node,uniforms:{time:e}}),lr=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),fr=18,ur="queen",pr=({time:e})=>Object(we.jsx)(_e.Node,{shader:dr.node,uniforms:{time:e}}),dr=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
}`}}),vr=19,hr="they were six",mr=({time:e})=>Object(we.jsx)(_e.Node,{shader:gr.node,uniforms:{time:e}}),gr=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
const float PI = ${Math.PI};
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),yr=20,br="trippy tiles",xr=({time:e})=>Object(we.jsx)(_e.LinearCopy,{children:Object(we.jsx)(wr,{persistence:.85,children:Object(we.jsx)(_e.Node,{shader:_r.node,uniforms:{time:e}})})}),wr=({children:e,persistence:t})=>Object(we.jsx)(_e.Node,{shader:_r.persistence,backbuffering:!0,uniforms:{t:e,back:_e.Uniform.Backbuffer,persistence:t}}),_r=_e.Shaders.create({persistence:{frag:_e.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Er=21,Sr="HODL",Or=({time:e})=>Object(we.jsx)(_e.LinearCopy,{children:Object(we.jsx)(Rr,{persistence:Math.min(.99,.015*e),time:e,children:Object(we.jsx)(_e.Node,{shader:Tr.node,uniforms:{time:e}})})}),Rr=({children:e,persistence:t,time:r})=>Object(we.jsx)(_e.Node,{shader:Tr.shakePersistence,backbuffering:!0,uniforms:{t:e,back:_e.Uniform.Backbuffer,persistence:t,time:r}}),Tr=_e.Shaders.create({shakePersistence:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform sampler2D t, back;
uniform float time;
...
}`}}),zr=22,Pr="atoms",Cr=({time:e})=>Object(we.jsx)(_e.Node,{shader:Ir.node,uniforms:{time:e,t:"/images/einstein-tongue-out.jpg"}}),Ir=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D t;
...
void main() {
...
}`}}),jr=23,Ar="Hexacubes",kr=({time:e})=>Object(we.jsx)(_e.Node,{shader:Dr.node,uniforms:{time:e}}),Dr=_e.Shaders.create({node:{frag:_e.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform float time;
  const float PI = ${Math.PI};
  ...
  void main() {
    ...
    gl_FragColor = vec4(c, 1.0);
      ...
      `}}),Lr=24,Nr="dark cubes",Mr=({time:e})=>Object(we.jsx)(_e.Node,{shader:Ur.node,uniforms:{time:e}}),Ur=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
}`}}),Br=25,Fr="Mandelbrot",qr=({time:e})=>Object(we.jsx)(_e.LinearCopy,{children:Object(we.jsx)($r,{persistence:.9,children:Object(we.jsx)(Vt,{passes:4,factor:.1,children:Object(we.jsx)(_e.Node,{shader:Gr.node,uniforms:{time:e}})})})}),$r=({children:e,persistence:t})=>Object(we.jsx)(_e.Node,{shader:Gr.persistence,backbuffering:!0,uniforms:{t:e,back:_e.Uniform.Backbuffer,persistence:t}}),Gr=_e.Shaders.create({persistence:{frag:_e.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Hr=26,Vr="fumes",Wr=({time:e})=>Object(we.jsx)(_e.LinearCopy,{children:Object(we.jsx)(Xr,{persistence:.9,children:Object(we.jsx)(Vt,{passes:4,factor:Math.min(.6,.01*e),children:Object(we.jsx)(_e.Node,{shader:Kr.node,uniforms:{time:e}})})})}),Xr=({children:e,persistence:t})=>Object(we.jsx)(_e.Node,{shader:Kr.persistence,backbuffering:!0,uniforms:{t:e,back:_e.Uniform.Backbuffer,persistence:t}}),Kr=_e.Shaders.create({persistence:{frag:_e.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Yr=27,Qr="real burning ship",Zr=400,Jr=0,en=60,tn=12,rn=2,nn=({time:e})=>Object(we.jsx)(_e.LinearCopy,{children:Object(we.jsx)(on,{persistence:.8+.05*Math.random(),time:e,children:Object(we.jsx)(_e.Node,{shader:an.node,uniforms:{time:e}})})}),on=({children:e,persistence:t,time:r})=>Object(we.jsx)(_e.Node,{shader:an.persistence,backbuffering:!0,uniforms:{t:e,back:_e.Uniform.Backbuffer,persistence:t,time:r}}),an=_e.Shaders.create({persistence:{frag:_e.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),sn=28,cn="No, I'M Batman",ln=({time:e})=>Object(we.jsx)(_e.LinearCopy,{children:Object(we.jsx)(fn,{persistence:.5+.48*Math.min(1,e/60),children:Object(we.jsx)(_e.Node,{shader:un.node,uniforms:{time:e}})})}),fn=({children:e,persistence:t})=>Object(we.jsx)(_e.Node,{shader:un.persistence,backbuffering:!0,uniforms:{t:e,back:_e.Uniform.Backbuffer,persistence:t}}),un=_e.Shaders.create({persistence:{frag:_e.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),pn=29,dn="sdBitcoin(p)",vn=({time:e})=>Object(we.jsx)(_e.Node,{shader:hn.node,uniforms:{time:e}}),hn=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),mn=30,gn="21 millions",yn=({time:e})=>Object(we.jsx)(_e.Node,{shader:bn.node,uniforms:{time:e,numberInCirculation:18557031}}),bn=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),xn=31,wn="alien tower",_n=({time:e})=>Object(we.jsx)(_e.Node,{shader:En.node,uniforms:{time:e,numberInCirculation:18557031}}),En=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform float numberInCirculation;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Sn=32,On="GoL valley";let Rn;const Tn=({time:e})=>{Rn||(Rn=e);const t=e-Rn,r=Math.floor(12*t);return Object(we.jsx)(_e.Node,{shader:zn.node,uniforms:{time:e,t:Object(we.jsx)($e,{refreshEveryTicks:100,tick:r,size:100})}})},zn=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D t;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Pn=33,Cn="x(x+32y)%(tN+1)%n";const In=({time:e})=>Object(we.jsx)(_e.Node,{shader:jn.node,uniforms:{time:e}}),jn=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),An=34,kn="\u230a2cos(x)sin(y+t)\u230b%7";const Dn=({time:e})=>Object(we.jsx)(_e.Node,{shader:Ln.node,uniforms:{time:e}}),Ln=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
#define PI ${Math.PI}
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Nn=35,Mn="aie confiance",Un=({time:e})=>Object(we.jsx)(_e.LinearCopy,{children:Object(we.jsx)(Bn,{persistence:.6,children:Object(we.jsx)(_e.Node,{shader:Fn.node,uniforms:{time:e}})})}),Bn=({children:e,persistence:t})=>Object(we.jsx)(_e.Node,{shader:Fn.persistence,backbuffering:!0,uniforms:{t:e,back:_e.Uniform.Backbuffer,persistence:t}}),Fn=_e.Shaders.create({persistence:{frag:_e.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),qn=36,$n="crois en moi",Gn=({time:e})=>Object(we.jsx)(_e.LinearCopy,{children:Object(we.jsx)(Hn,{children:Object(we.jsx)(_e.Node,{shader:Vn.node,uniforms:{time:e}})})}),Hn=({children:e,persistence:t})=>Object(we.jsx)(_e.Node,{shader:Vn.persistence,backbuffering:!0,uniforms:{t:e,back:_e.Uniform.Backbuffer,persistence:t}}),Vn=_e.Shaders.create({persistence:{frag:_e.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Wn=37,Xn="sdBrick",Kn=({time:e})=>Object(we.jsx)(_e.Node,{shader:Yn.node,uniforms:{time:e}}),Yn=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Qn=38,Zn="Golden mandelbulb",Jn=({time:e})=>Object(we.jsx)(_e.LinearCopy,{children:Object(we.jsx)(eo,{persistence:.5,children:Object(we.jsx)(_e.Node,{shader:to.node,uniforms:{time:e}})})}),eo=({children:e,persistence:t})=>Object(we.jsx)(_e.Node,{shader:to.persistence,backbuffering:!0,uniforms:{t:e,back:_e.Uniform.Backbuffer,persistence:t}}),to=_e.Shaders.create({persistence:{frag:_e.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  clr /= 4.;
  gl_FragColor = vec4(clr, 1.0);
}`}}),ro=39,no="metaballs",oo=({time:e})=>Object(we.jsx)(_e.Node,{shader:io.node,uniforms:{time:e}}),io=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  clr /= 4.;
  gl_FragColor = vec4(clr, 1.0);
}`}}),ao=40,so="pen-o-plasma",co=({time:e})=>Object(we.jsx)(_e.Node,{shader:lo.node,uniforms:{time:e}}),lo=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(clr, 1.0);
}`}}),fo=41,uo="reflection",po=({time:e})=>Object(we.jsx)(_e.Node,{shader:vo.node,uniforms:{time:e}}),vo=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),ho=42,mo="reflection party",go=({time:e})=>Object(we.jsx)(_e.Node,{shader:yo.node,uniforms:{time:e}}),yo=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c = mix(c, reflection(p, n, 10.), glossy);
  gl_FragColor = vec4(c, 1.0);
}`}}),bo=43,xo="irreconcilable queens",wo=({time:e})=>Object(we.jsx)(_e.LinearCopy,{children:Object(we.jsx)(_o,{persistence:.4,children:Object(we.jsx)(_e.Node,{shader:Eo.node,uniforms:{time:e}})})}),_o=({children:e,persistence:t})=>Object(we.jsx)(_e.Node,{shader:Eo.persistence,backbuffering:!0,uniforms:{t:e,back:_e.Uniform.Backbuffer,persistence:t}}),Eo=_e.Shaders.create({persistence:{frag:_e.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),So=44,Oo="royal meeting",Ro=({time:e})=>Object(we.jsx)(_e.Node,{shader:To.node,uniforms:{time:e}}),To=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
#define PI ${Math.PI}
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),zo=45,Po="wood pawns army",Co=({time:e})=>Object(we.jsx)(_e.Node,{shader:Io.node,uniforms:{time:e,wood:"/images/seamless-wood-background-1.jpg"}}),Io=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),jo=46,Ao="Bank of Bicoin",ko=({time:e})=>Object(we.jsx)(_e.Node,{shader:Do.node,uniforms:{time:e}}),Do=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),Lo=47,No="glow experiment",Mo=({time:e})=>Object(we.jsx)(_e.Node,{shader:Uo.node,uniforms:{time:e}}),Uo=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),Bo=48,Fo="Starry Night",qo=({time:e})=>Object(we.jsx)(_e.Node,{shader:$o.node,uniforms:{time:e,img:"/images/seamless-wood2.jpg"}}),$o=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  gl_FragColor = vec4(clr, 1.0);
}`}}),Go=49,Ho="chinese lantern",Vo=400,Wo=0,Xo=20,Ko=24,Yo=1.1,Qo=({time:e})=>Object(we.jsx)(_e.LinearCopy,{children:Object(we.jsx)(Zo,{persistence:.8,children:Object(we.jsx)(_e.Node,{shader:Jo.node,uniforms:{time:e}})})}),Zo=({children:e,persistence:t})=>Object(we.jsx)(_e.Node,{shader:Jo.persistence,backbuffering:!0,uniforms:{t:e,back:_e.Uniform.Backbuffer,persistence:t}}),Jo=_e.Shaders.create({persistence:{frag:_e.GLSL`
    precision highp float;
    varying vec2 uv;
    uniform sampler2D t, back;
    uniform float persistence;
...
void main() {
  ...
  clr += c;
  gl_FragColor = vec4(clr, 1.0);
}`}}),ei=50,ti="jumpy rooks",ri=({time:e})=>Object(we.jsx)(_e.Node,{shader:ni.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),ni=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),oi=51,ii="symmetry chess",ai=400,si=0,ci=20,li=24,fi=1,ui=({time:e})=>Object(we.jsx)(_e.Node,{shader:pi.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),pi=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  gl_FragColor = vec4(c, 1.0);
}`}}),di=52,vi="knights dance",hi=({time:e})=>Object(we.jsx)(_e.Node,{shader:mi.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),mi=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform sampler2D wood;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  gl_FragColor = vec4(c, 1.0);
}`}}),gi=53,yi="cross waves",bi=({time:e})=>Object(we.jsx)(_e.Node,{shader:xi.node,uniforms:{time:e}}),xi=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
void main() {
  ...
  */
}`}}),wi=54,_i="chess set",Ei=({time:e})=>Object(we.jsx)(_e.Node,{shader:Si.node,uniforms:{time:e,wood:"/images/seamless-wood2.jpg"}}),Si=_e.Shaders.create({node:{frag:_e.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  c += lighting(hit, p, n, dir);
  color = vec4(c, 1.0);
}`}}),Oi=55,Ri="cube d'or",Ti=400,zi=0,Pi=20,Ci=24,Ii=1,ji=({time:e})=>Object(we.jsx)(_e.Node,{shader:Ai.node,uniforms:{time:e}}),Ai=_e.Shaders.create({node:{frag:_e.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  #endif
  color = vec4(c, 1.0);
}`}}),ki=56,Di="jade forest",Li=({time:e})=>Object(we.jsx)(_e.Node,{shader:Ni.node,uniforms:{time:e}}),Ni=_e.Shaders.create({node:{frag:_e.GLSL`#version 300 es
precision highp float;
in vec2 uv;
out vec4 color;
uniform float time;
...
void main() {
  ...
  color = vec4(c, 1.0);
}`}}),Mi=57,Ui="Virus v2",Bi=400,Fi=0,qi=20,$i=24,Gi=.8,Hi=({time:e})=>Object(we.jsx)(_e.Node,{shader:Vi.node,uniforms:{time:e}}),Vi=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}});var Wi=r("005v"),Xi=r.n(Wi);const Ki=400,Yi=0,Qi=30,Zi=20,Ji=1,ea="5M",ta=58,ra="Mandelglitch",na=[{url:"https://ethblock.art/create/17",text:"Mint on ethblock.art"},{url:"https://ghostmarket.io/asset/pha/ghost/3008841254969814369262311336331954453497120774334547905246474374493804042898/",text:"ghostmarket.io: 400 KCAL"},{url:"https://www.hicetnunc.xyz/objkt/3063",text:"hicetnunc.xyz: Mandelglitch #1 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3068",text:"hicetnunc.xyz: Mandelglitch #2 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3071",text:"hicetnunc.xyz: Mandelglitch #3 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3072",text:"hicetnunc.xyz: Mandelglitch #4 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3073",text:"hicetnunc.xyz: Mandelglitch #5 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3077",text:"hicetnunc.xyz: Mandelglitch #6 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3088",text:"hicetnunc.xyz: Mandelglitch #7 (5 XTZ)"},{url:"https://www.hicetnunc.xyz/objkt/3574",text:"hicetnunc.xyz: Mandelglitch #8 (5 XTZ)"}];const oa=e=>e<.5?2*e*e:(4-2*e)*e-1;const ia=({time:e,n:t,exporting:r})=>{const n=Object(Be.useMemo)((()=>function(e,t=0){const r=e?3:50,n=new Xi.a(t);return Array(r).fill(null).map((()=>Array(12).fill(null).map((()=>n.random()))))}(r,t)),[t,r]),o=e/10%n.length,i=Math.floor(o),a=o-i;let[s,c,l,f,u,p,d,v,h,m,g,y]=(b=n[i%n.length],x=n[(i+1)%n.length],w=oa(a),b.map(((e,t)=>e*(1-w)+x[t]*w)));var b,x,w;return l=oa(l),Object(we.jsx)(_e.LinearCopy,{children:Object(we.jsx)(sa,{persistence:r?0:.8,children:Object(we.jsx)(_e.Node,{shader:aa.main,uniforms:{aa:r?2:0,time:e,resolution:_e.Uniform.Resolution,travel:s,love:c,dark:l,rot:r?2*Math.PI/Qi:.1,s1:f,s2:u,s3:p,s4:d,s5:v,s6:h,s7:m,s8:g,s9:y}})})})},aa=_e.Shaders.create({persistence:{frag:_e.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
void main() {
  ...
  `}}),sa=({children:e,persistence:t})=>Object(we.jsx)(_e.Node,{shader:aa.persistence,backbuffering:!0,uniforms:{t:e,back:_e.Uniform.Backbuffer,persistence:t}}),ca=59,la="Pixels 256",fa="There will be only 256 patterns generated by this single fragment shader.",ua=({time:e,n:t,exporting:r})=>Object(we.jsx)(pa,{n:t+1+(r?0:Math.floor(e))}),pa=Fe.a.memo((({n:e})=>{const t=new Xi.a(e%256),r=t.random(),n=t.random(),o=t.random(),i=t.random(),a=t.random(),s=t.random();return Object(we.jsx)(_e.Node,{shader:da.node,uniforms:{s1:r,s2:n,s3:o,s4:i,s5:a,s6:s}})})),da=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),va=60,ha="Bitcoin rainbow",ma=({time:e})=>Object(we.jsx)(_e.Node,{shader:ga.node,uniforms:{time:e}}),ga=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),ya=61,ba="Binance gradients",xa=1,wa=30,_a=["/images/shaders/binance.dist.png"],Ea=({time:e})=>Object(we.jsx)(_e.Node,{shader:Sa.node,uniforms:{time:e,image:"/images/shaders/binance.dist.png"}}),Sa=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
...
`}}),Oa=62,Ra="Overgrowth",Ta=20,za=40,Pa=1,Ca=({generation:e,size:t,n:r})=>Object(we.jsx)(_e.Node,{width:t,height:t,shader:La.logic,uniforms:{generation:e,prev:_e.Uniform.Backbuffer,size:t,seed:r/100},backbuffering:!0}),Ia=Fe.a.memo(Ca),ja=({time:e,generation:t,n:r})=>Object(we.jsx)(_e.Node,{shader:La.render,uniforms:{time:e,logic:Object(we.jsx)(Ia,{generation:t,size:140,n:r})},uniformsOptions:{logic:{interpolation:"nearest"}}}),Aa=Fe.a.memo(ja),ka=1e3*Math.random(),Da=({time:e,n:t})=>Object(we.jsx)(Aa,{n:t+ka,time:e,generation:Math.floor(30*e)},t),La=_e.Shaders.create({logic:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
...
`}});var Na=r("AJhG");const Ma=63,Ua="Relics",Ba=400,Fa=2,qa=4,$a=20,Ga=1,Ha="5M",Va={colors:[.7,.55,.4],logicSize:80,amp:1,base:2,persistance:.89,delta:.5,seed:0};console.log(Object.keys(Va).map((e=>String(Va[e]))).join("_"));const Wa=({g:e,size:t,seed:r,amp:n,base:o,persistance:i,delta:a})=>Object(we.jsx)(_e.Node,{width:t,height:t,shader:Za.logic,uniforms:{amp:n,base:o,g:e,prev:_e.Uniform.Backbuffer,size:t,seed:r,persistance:i,delta:a},backbuffering:!0},t),Xa=Fe.a.memo(Wa),Ka=({g:e,colors:t,amp:r,base:n,persistance:o,delta:i,logicSize:a,seed:s})=>Object(we.jsx)(_e.Node,{shader:Za.render,uniforms:{colors:t,logic:Object(we.jsx)(Xa,{amp:r,base:n,g:e,size:a,seed:s,persistance:o,delta:i})},uniformsOptions:{logic:{interpolation:"nearest"}}}),Ya=Fe.a.memo(Ka),Qa=({time:e})=>{const{colors:t,logicSize:r,amp:n,base:o,persistance:i,delta:a,seed:s}=Object(Na.b)(Va);return Object(we.jsx)(Ya,{amp:n,base:o,g:Math.floor(20*e)%40,colors:t,persistance:i,delta:a,seed:s,logicSize:r})},Za=_e.Shaders.create({logic:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform sampler2D prev;
uniform float g;
...
`}}),Ja=64,es="Intersection",ts=8*Math.PI,rs=[{url:"https://www.hicetnunc.xyz/objkt/28592",text:"hic et nunc NFT"}],ns=({time:e})=>Object(we.jsx)(_e.Node,{shader:os.render,uniforms:{resolution:_e.Uniform.Resolution,time:e}}),os=_e.Shaders.create({render:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform float time;
uniform vec2 resolution;
...
`}}),is=65,as="Duality",ss=800,cs=4,ls=8,fs=30,us=1,ps=3,ds=!0,vs=16,hs=[{url:"https://hicetnunc.xyz/objkt/64326",text:"hic et nunc NFT"}],ms=({time:e})=>Object(we.jsx)(_e.NearestCopy,{children:Object(we.jsx)(gs,{persistence:.3,children:Object(we.jsx)(_e.Node,{shader:ys.render,uniforms:{resolution:_e.Uniform.Resolution,time:e}})})}),gs=({children:e,persistence:t})=>Object(we.jsx)(_e.Node,{shader:ys.persistence,backbuffering:!0,uniforms:{t:e,back:_e.Uniform.Backbuffer,persistence:t}}),ys=_e.Shaders.create({persistence:{frag:_e.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),bs=66,xs="hicetnunc",ws=800,_s=2,Es=_s+8,Ss=30,Os=1,Rs=7,Ts=!0,zs=16,Ps=({time:e})=>Object(we.jsx)(_e.NearestCopy,{children:Object(we.jsx)(Cs,{persistence:.5,children:Object(we.jsx)(_e.Node,{shader:Is.render,uniforms:{resolution:_e.Uniform.Resolution,time:e,freq:2}})})}),Cs=({children:e,persistence:t})=>Object(we.jsx)(_e.Node,{shader:Is.persistence,backbuffering:!0,uniforms:{t:e,back:_e.Uniform.Backbuffer,persistence:t}}),Is=_e.Shaders.create({persistence:{frag:_e.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),js=67,As="Jumping blob",ks=800,Ds=2,Ls=Ds+8,Ns=30,Ms=1,Us=7,Bs=!0,Fs=16,qs=({time:e})=>Object(we.jsx)(_e.NearestCopy,{children:Object(we.jsx)($s,{persistence:.6,children:Object(we.jsx)(_e.Node,{shader:Gs.render,uniforms:{resolution:_e.Uniform.Resolution,time:e,freq:2}})})}),$s=({children:e,persistence:t})=>Object(we.jsx)(_e.Node,{shader:Gs.persistence,backbuffering:!0,uniforms:{t:e,back:_e.Uniform.Backbuffer,persistence:t}}),Gs=_e.Shaders.create({persistence:{frag:_e.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),Hs=68,Vs="ring",Ws=800,Xs=2,Ks=Xs+10,Ys=30,Qs=1,Zs=7,Js=!0,ec=128,tc=({time:e})=>Object(we.jsx)(_e.NearestCopy,{children:Object(we.jsx)(rc,{persistence:.9,children:Object(we.jsx)(_e.Node,{shader:nc.render,uniforms:{resolution:_e.Uniform.Resolution,time:e,freq:2}})})}),rc=({children:e,persistence:t})=>Object(we.jsx)(_e.Node,{shader:nc.persistence,backbuffering:!0,uniforms:{t:e,back:_e.Uniform.Backbuffer,persistence:t}}),nc=_e.Shaders.create({persistence:{frag:_e.GLSL`
  precision highp float;
  varying vec2 uv;
  uniform sampler2D t, back;
  uniform float persistence;
...
`}}),oc=69,ic="Bananas paradize",ac=400,sc=0,cc=20,lc=20,fc=1,uc=!0,pc=128,dc=({time:e})=>Object(we.jsx)(_e.Node,{shader:vc.node,uniforms:{time:e,resolution:_e.Uniform.Resolution}}),vc=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),hc=70,mc="warp1",gc=400,yc=0,bc=20,xc=20,wc=1,_c=!1,Ec=256,Sc=({time:e})=>Object(we.jsx)(_e.Node,{shader:Oc.node,uniforms:{time:e,resolution:_e.Uniform.Resolution}}),Oc=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),Rc=71,Tc="warp2",zc=640,Pc=0,Cc=20,Ic=24,jc=1,Ac=!1,kc=256,Dc=({time:e})=>Object(we.jsx)(_e.Node,{shader:Lc.node,uniforms:{time:e}}),Lc=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
...
`}}),Nc=72,Mc="Planet Hole",Uc=640,Bc=0,Fc=20,qc=24,$c=1,Gc=!1,Hc=256,Vc=[{url:"https://hicetnunc.xyz/objkt/87918",text:"hic et nunc NFT"}],Wc=({time:e,n:t})=>{const r=new Xi.a(t),n=.2+3*r.random()*r.random(),o=.2+10*r.random()*r.random(),i=r.random(),a=[i+.2-.5*r.random(),i+.02-.1*r.random(),i-.02+.1*r.random()];return Object(we.jsx)(_e.Node,{shader:Xc.node,uniforms:{resolution:_e.Uniform.Resolution,time:e,a:n,b:o,c:a}})},Xc=_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
...
`}}),Kc=(_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
...
`}}),_e.Shaders.create({node:{frag:_e.GLSL`
precision highp float;
varying vec2 uv;
uniform vec2 resolution;
